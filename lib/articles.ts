...
「株式市場はこの報告書のハト派的な意味合いを歓迎する可能性が高いが、投資家は働く人が減った経済の将来の成長可能性に警戒すべきだ。」 — ピーター・グラフ氏、Amova Asset Management Americas 最高投資責任者。`,
  ...
  {
    id: "trump-teased-an-iran-deal-that-didn-t-co-7c55172c",
    title: "Trump teased an Iran deal that didn't come, but markets soared. Here’s why it keeps happening",
    titleJa: "トランプ大統領はイラン合意が実現しなかったとからかいましたが、市場は急騰しました。それが起こり続ける理由は次のとおりです",
    summaryJa: "石油埋蔵量と軍需品の備蓄が減少していると伝えられる中、アナリストらは、トランプ政権になったらいつまで市場が急騰するか疑問を抱いている。イランとの協定をぶら下げている。",
    bodyOriginal: `The Trump administration this week sparked enthusiasm that the U.S. and Iran could soon strike a deal on the Strait of Hormuz, driving down oil prices and sending stocks soaring — only for no deal to emerge.
...
Galimberti, of Rystad, told CNBC, "My hunch is that if they want to avoid a costly stalemate, with oil prices quickly escalating back to April levels or above and little to no Iranian flows, they will need to start bridging the differences and move their respective red lines towards the center."`,
    bodyJa: `トランプ政権は今週、米国とイランがホルムズ海峡で間もなく合意に達する可能性があるとの熱狂を引き起こし、原油価格の下落と株価の急騰をもたらしたが、結局合意は成立しなかった。
もしこれに見覚えがあると思われるなら、それは、米国が5か月以上前に始めた戦争を終わらせる合意に近づいているとドナルド・トランプ大統領が何十回も主張してきたからかもしれない。
投資家はこうした主張の多くに反応し、戦争がむしろ拡大しているように見え、トランプ大統領の主要な目標であるイランの核開発の野心を封じ込めるという目標の進展が行き詰まっているにもかかわらず、事態打開が近いとの期待から一気に買いを入れている。
RBCキャピタル・マーケッツの商品戦略グローバル責任者、ヘリマ・クロフト氏はCNBCに対し、「市場には非常に楽観的なバイアスが存在している」と語った。
市場は米国とイランの双方にとって戦争の外交的終結を支持するインセンティブがあると引き続き想定している。しかし、一部の投資家は、実現の可能性は低いものの、中東地域を戦前の現状にリセットする「タイムマシン」とみなしているようだとクロフト氏は語った。
最近の紛争は、イランにとって大きな影響力の源となっている世界の石油貿易の重要な通路であるホルムズ海峡を中心にしている。
開戦前は有料の国際水路だった海峡を効果的に閉鎖するイラン政府の能力は、世界的なエネルギー供給ショックを引き起こし、ガス価格を高騰させ、インフレを悪化させ、石油埋蔵量に対する警戒を高めた。
ホワイトハウスのアンナ・ケリー報道官はＣＮＢＣに対し、「大統領は常に外交を優先しているが、イランが核兵器を決して保有できないようにするため、あらゆる選択肢を留保している」と電子メールで語った。
外交が依然として平和への実行可能な道であると信じている人々さえも、この海峡の将来が手に負えない問題を抱えていることを認識している。
ライスタッド・エナジーのパートナー兼チーフエコノミスト、クラウディオ・ガリンベルティ氏は電子メールで、「ホルムズの運命をめぐっては、依然として根本的な相違があるようだ。イランはサービス料の賦課を望んでいるが、米国は戦前の状況の回復、つまり海峡の国際自由水域の回復を望んでいる」と述べた。
ベッセント、トランプ大統領は差し迫った合意をからかった
石油市場は海峡再開に向けた進展の兆しを熱望している。スコット・ベッセント財務長官は火曜朝、CNBCの「スコーク・ボックス」に対し、海峡での「移動の自由」を確保するための合意は数時間以内にまとまる可能性があると語り、大いに楽観的な見方を示した。
ベッセント氏は「われわれはイラン側と協議中だ」と述べた。 「今日か明日、海峡を開放し、この紛争におけるより正常化された立場に向けて合意に達する可能性がある。」
ベッセント氏の発言の直後、原油価格は急落する一方、投資家の楽観的な見方と人工知能によるハイテク株の上昇が重なり、株は急騰し、利回りは大胆に下落した。
しかし、トレーダーらは海峡の永続的な解決策への期待と米国による軍事エスカレーションへの備えの間で揺れ動いており、原油価格は依然として戦前の水準から大幅に上昇している。
ラピダン・エナジー・グループのボブ・マクナリー社長は、市場は「依然として激しい混乱の中に閉じ込められている」と電子メールでＣＮＢＣに語った。
同氏は、「イランとオマーンは狭いホルムズ管理計画で合意するかもしれないが、ホルムズ正常化に必要で原油市場が望んでいる米国とイランの間のより広範で永続的な和解は見込めない」と述べた。
それにもかかわらず、ベッセント氏のCNBCへのコメントは、トランプ大統領が日曜夕方、「合意の境界線は合意された」ためイランに対する大規模攻撃を中止すると発表したことを踏まえ、すでに明るくなりつつあった見通しを後押しした。
この主張は、トランプ大統領がイランを決定的に消滅させると脅したが、結局撤回したというこれまで何度も繰り返された主張であり、ダウ工業株30種平均が記録的な終値まで上昇した月曜日の株価上昇に貢献した。
トランプ大統領は火曜夜、「多くの進展があった」ため、早ければ水曜か木曜にも海峡再開の合意が「実現する可能性がある」と述べ、火に油を注いだ。
ベッセント氏が合意の可能性について期限を延長したにもかかわらず、トランプ大統領のコメントは水曜日も引き続き投資家の期待を高め、ダウは終値で再び過去最高値を更新し、原油価格は安定した。
イラン、トランプ大統領に反発
イランが米国と積極的に交渉していないと繰り返し主張してきたにもかかわらず、株価の急騰の勢いは続いた。
むしろ、イランは、ペルシャ湾に隣接するもう一つの地域大国であるオマーンと、海峡を通る船舶輸送に関する独自の合意を急ぐべく交渉中であると述べた。
トランプ大統領は、イランの「二枚舌」主張にも関わらず、米国とイランの交渉は継続していると怒りを込めて主張した。同氏はまた、湾岸地域のイラン港に対する海上封鎖を再発動した米国が海峡を完全に制圧していると主張し続けている。しかし、船舶の交通量は、世界の石油の 20% が水路を通過していた戦前の平均をはるかに下回ったままです。
木曜日、イラン国営メディアが米国とイスラエルの船舶の航行を阻止し、その他の制限を課す計画草案を報道したことを受け、海峡に関する合意が差し迫っているという期待は少なくとも一時的に打ち砕かれたように見えた。
トランプ政権はすぐにその草案を不着手として却下したようだ。
この報道について尋ねられた米当局者はＣＮＢＣに対し、「暫定ルートにはいかなる障害も生じない。つまり、承認や許可がなく、通行料や料金もかからない」と語った。 「ホルムズ海峡は国際水路であり、どの当事者も車線や通行能力を管理していない。」
木曜午後、トランプ大統領はホワイトハウスで海峡再開の合意に至ったかどうかとの質問に対し、「合意に達したとは言いたくない。現在はある意味開いている」と述べた。
トランプ大統領は「我々は非常にうまくやっていると思う」と付け加えた。 「私は交渉に参加している。順調に進んでいると思う。……それはすぐに起こるかもしれない。」
戦争中を通じて米国に対して積極的に反抗的な姿勢を続けてきたイランは、トランプ大統領のメッセージを嘲笑した。
「大規模な攻撃が来る…待て、気にしないで、彼らは交渉を望んでいる。」それはループ外交だ」とイラン国会議長モハマド・バガー・ガリバフは木曜午後、Xに書いた。
「いじめ＋約束破り＋フェイクニュースをてことして利用するのは失敗した戦略だ」とガリバフ氏は書いた。
「根深い楽観主義バイアス」
戦争が6カ月に突入し、石油と主要軍需品の両方の備蓄が減少していると伝えられる中、アナリストらは、市場がいつまでもぶら下がった合意の希望に飛びつくのではないかと懸念している。
RBCは7月28日の戦略ノートで、「ヘッドライン主導の価格下落サイクルは、紛争の経済的コストは抑制可能だという確信につながるかもしれない」としながらも、米国の戦略石油備蓄の減少は「世界的なバッファーの減少」を示していると書いた。
ラピダンのマクナリー氏は、「双方が軍事的エスカレーションを抑制できなかったり、在庫削減の継続により市場の深く根付いた楽観主義バイアスが払拭され、価格に消費抑制が求められたりした場合」、原油価格が最高値まで急上昇する可能性があると警告した。
リスタッドのガリンベルティ氏はCNBCに対し、「原油価格が急速に4月の水準以上に戻り、イランからの流入がほとんどないという、コストのかかる膠着状態を避けたいのであれば、両国は差異を埋め始め、それぞれのレッドラインを中央に近づける必要があるだろう」とCNBCに語った。`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/08/07/trump-iran-hormuz-deal-stocks-oil.html",
    publishedAt: "2026-08-07T17:50:12+00:00",
    category: "エネルギー",
  ...
  },
  {
    ...
    summaryJa: "ビル・キャシディ上院議員（共和党、ルイジアナ州）は金曜日、トッド・ブランチ氏を司法長官に承認するために投票するつもりだと述べ、他の上院共和党議員２名が反対を表明したことを受け、ドナルド・トランプ大統領の苦境に立たされている候補者に重要な一票を与えることになった。他に共和党議員が離反しないと仮定すると、キャシディ氏の支持によりブランチ氏の承認に必要な50票が得られるとみられる。共和党は53議席を保有しているが、スーザン・コリンズ上院議員（共和党、メイン州）とリサ・マーカウスキー上院議員（共和党、アラスカ州）はブランシュ氏に反対票を投じる意向を示している一方、ミッチ・マコネル上院議員（共和党、ケンタッキー州）は依然として上院欠席を続けており、ブランシュ氏の共和党票はちょうど50票となっている。",
    bodyOriginal: `Sen. Bill Cassidy, R-La., said Friday he will vote to confirm Todd Blanche as attorney general, giving President Donald Trump's embattled nominee a crucial vote after two other Senate Republicans announced their opposition.
Cassidy's support appears to give Blanche the 50 votes he needs for confirmation, assuming no other Republicans defect. Republicans hold 53 seats, but Sens. Susan Collins, R-Maine, and Lisa Murkowski, R-Alaska, have said they will vote against Blanche, while Sen. Mitch McConnell, R-Ky., remains absent from the Senate — leaving Blanche with exactly 50 Republican votes.
Cassidy had emerged as the pivotal vote after Murkowski announced Friday morning she would oppose Blanche, citing concerns about the politicization of the Justice Department and its handling of the Jeffrey Epstein files.
"This is not a referendum on President Trump," Cassidy said on the Senate floor Friday. "It is a decision regarding Mr. Blanche in very specific circumstances."
Blanche, Trump's former personal attorney who is serving as acting attorney general, has faced resistance from several Republicans over his leadership of the Justice Department and questions about its independence from the White House.
Sens. John Cornyn, R-Texas, and Thom Tillis, R-N.C., ultimately agreed to support Blanche after he provided assurances that a controversial $1.8 billion "anti-weaponization" fund created as part of a settlement in Trump's lawsuit over the leak of his tax records had been rescinded and clarified the scope of an agreement shielding Trump and members of his family from certain tax audits.
Tillis had also pressed Blanche to meet with Epstein survivors amid scrutiny of the Justice Department's handling of the files. Blanche later met privately with a group of survivors following his confirmation hearing.
Before Cassidy announced his decision, a group of Epstein survivors sent him a letter urging him to oppose Blanche and asking to meet with him.
The survivors accused the Justice Department under Blanche of exposing survivors' identities and images while withholding the names of alleged abusers and enablers.
Neither Cassidy nor his staff met with the group before he announced his decision, according to the survivors, MS NOW reported.
The letter, signed by more than a dozen survivors, also argued Blanche showed no remorse during his own meeting with survivors and gave them no indication that he planned to pursue additional investigative leads or accountability beyond Epstein and his associate, Ghislaine Maxwell.
Cassidy said he was "not entirely satisfied" with where matters stood and expected he could have additional concerns about the department in the future. But he argued that Trump could be "unrelenting" regardless of who held the job, making it more important to have a Senate-confirmed attorney general with greater standing to push back on the president.
Cassidy also pointed to positive reviews of Blanche's management of the department from current and former prosecutors he consulted, saying critics acknowledged that Blanche knew the law and was a hands-on administrator.
"Mr. Blanche is not perfect, and he will tell you this," Cassidy said. But, he argued, the choice was between Blanche and another acting attorney general who might not run the department as effectively.
Cassidy has his own complicated history with Trump. He was one of seven Senate Republicans who voted to convict Trump at his second impeachment trial in 2021. In May, Cassidy lost his Republican primary after Trump backed Rep. Julia Letlow, one of his challengers.
Cassidy appeared to grow emotional near the end of his speech as he announced his decision.
"All considered, I will vote for Mr. Blanche," Cassidy said. "I'll be criticized for this vote. What's new?" He added that he had "worked hard to understand the issue and to make the right decision."`,
    bodyJa: `ビル・キャシディ上院議員（共和党、ルイジアナ州）は金曜日、トッド・ブランチ氏を司法長官に承認するために投票するつもりだと述べ、他の上院共和党議員２名が反対を表明したことを受け、ドナルド・トランプ大統領の苦境に立たされている候補者に重要な一票を与えることになった。
他に共和党議員が離反しないと仮定すると、キャシディ氏の支持によりブランチ氏の承認に必要な50票が得られるとみられる。共和党は53議席を保有しているが、スーザン・コリンズ上院議員（共和党、メイン州）とリサ・マーカウスキー上院議員（共和党、アラスカ州）はブランシュ氏に反対票を投じる意向を示している一方、ミッチ・マコネル上院議員（共和党、ケンタッキー州）は依然として上院欠席を続けており、ブランシュ氏の共和党票はちょうど50票となっている。
マーカウスキー氏が金曜朝、司法省の政治化とジェフリー・エプスタインファイルの扱いへの懸念を理由にブランシュ氏に反対すると発表した後、キャシディ氏が中心票として浮上していた。
キャシディ氏は金曜日、上院議場で「これはトランプ大統領に対する国民投票ではない」と述べた。 「これは非常に特殊な状況下でのブランシュ氏に関する決定だ。」
トランプ大統領の元個人弁護士で司法長官代理を務めるブランチ氏は、司法省の指導力やホワイトハウスからの独立性をめぐる疑問を巡り、複数の共和党議員からの抵抗に直面している。
ジョン・コーニン上院議員（共和党、テキサス州）とトム・ティリス上院議員（共和党、ノースカロライナ州）は、納税記録漏えいをめぐるトランプ氏の訴訟の和解の一環として物議を醸した18億ドルの「反武器化」基金が取り消され、トランプ氏とその家族を特定の税務調査から守る協定の範囲を明確にしたことをブランシュ氏が保証したことを受け、最終的にブランシュ氏を支持することに同意した。
ティリス氏はまた、司法省によるファイルの扱いが精査される中、ブランチ氏にエプスタイン生存者と面会するよう圧力をかけていた。ブランシュ氏は承認公聴会後、生存者グループと個人的に面会した。
キャシディが決断を発表する前に、エプスタイン生存者のグループがブランシュに反対するよう促し、面会を求める手紙をキャシディに送った。
生存者らは、ブランシュ氏の下で司法省が虐待者や可能者とされる人物の名前を伏せたまま、生存者の身元や画像を暴露したと非難した。
MS NOWの報道によると、生存者らによると、キャシディ氏もスタッフも、同氏が決定を発表する前にグループと面会はしなかったという。
十数人の生存者が署名したこの書簡はまた、ブランシュ氏が生存者らと面会した際に全く反省の色を示しておらず、エプスタイン氏とその同僚のギレーヌ・マクスウェル氏以上にさらなる捜査の手がかりや説明責任を追求するつもりであることを示唆していないとも主張した。
キャシディ氏は、事態の現状に「完全に満足しているわけではない」とし、将来的に同省に関してさらなる懸念を抱く可能性があると予想していると述べた。しかし同氏は、誰がその職に就いているかに関係なく、トランプ氏は「容赦ない」可能性があるため、大統領を押し返すにはより優れた立場で上院が承認した司法長官を置くことがより重要だと主張した。
キャシディ氏はまた、相談を受けた現検事や元検事らからブランシュ氏の部門管理に対する好意的な評価も指摘し、批評家らはブランシュ氏が法律を理解し、実践的な管理者であったことを認めていると述べた。
「ブランシュ氏は完璧ではありません。彼はあなたにこう言うでしょう」とキャシディは言った。しかし、選択はブランシュ氏と、司法省をそれほど効果的に運営できない可能性のある別の司法長官代理の間でなされた、と同氏は主張した。
キャシディ氏にはトランプ氏との複雑な過去がある。同氏は、2021年の2回目の弾劾裁判でトランプ氏の有罪判決に賛成票を投じた上院共和党議員7人のうちの1人だった。5月、トランプ氏が挑戦者の1人であるジュリア・レットロー下院議員を支持したため、キャシディ氏は共和党予備選で敗北した。
キャシディ氏はスピーチの終わり近く、決断を発表した際に感情的になったように見えた。
「すべてを考慮すると、私はブランシュ氏に投票します」とキャシディ氏は語った。 「この投票では批判されるでしょう。何が新しいのですか？」同氏は「問題を理解し、正しい決断を下すために懸命に努力した」と付け加えた。`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/08/07/blanche-ag-trump-cassidy-senate-confirmation.html",
    publishedAt: "2026-08-07T16:55:42+00:00",
    category: "テクノロジー",
...
- 2 月 13 日公開`,
  ...
  },
  {
    ...
    summaryJa: "中国の輸出は7月に予想を上回ったが、ハイテク部品に対する世界的な需要が中国製品の吸収に寄与し、伸びは6月の猛烈な勢いから鈍化した。金曜の公式税関統計によると、７月の輸出は米ドルベースで前年比２３．９％増加し、ロイターがまとめたアナリスト予想の２２．２％増加を上回った。 ２０２１年１０月以来の最速ペースだった６月の２７％増からは鈍化した。",
    bodyOriginal: `China's exports rose more than expected in July, though growth eased from June's blistering pace, with global demand for high-tech components helping absorb the country's goods.
...
Retail sales eked out 1% growth in June, a thin rebound from May's 0.6% contraction. Consumer inflation cooled to 1% in June from 1.2% in May, while factory-gate prices rose 4.1%, the strongest growth since July 2022.`,
    bodyJa: `中国の輸出は7月に予想を上回ったが、ハイテク部品に対する世界的な需要が中国製品の吸収に寄与し、伸びは6月の猛烈な勢いから鈍化した。
金曜の公式税関統計によると、７月の輸出は米ドルベースで前年比２３．９％増加し、ロイターがまとめたアナリスト予想の２２．２％増加を上回った。 ２０２１年１０月以来の最速ペースだった６月の２７％増からは鈍化した。
先月の輸入は２７．５％増加したが、ロイターがまとめた予想の２７．９％をわずかに下回り、５年ぶりの速さだった６月の３６％増から鈍化した。
AI インフラの世界的な構築は、1 年間の地政学的ショックを通じて世界第 2 位の経済を支え、国内消費が低迷する中でも成長を軌道に乗せてきました。
Wind Informationがまとめた公式データによると、今年の中国の集積回路輸出額は、7月末時点で前年同期比で金額ベースでほぼ2倍となった。 7月だけでチップ輸出は前年比117％増加した。
中国税関当局によると、電気自動車、リチウム電池、風力発電設備などの需要に牽引され、今年１─７月の中国の総出荷額の６０％以上を機械・電気製品の輸出が占めた。他の急速に成長している輸出カテゴリーには、3D プリンターと産業用ロボットがありました。
中国の輸出業者も、予想される関税引き上げに先立って、米国行きの船舶に商品を競って積み込んでいた。米国政府は7月下旬、失効した一時的な10％税率に代わって、中国製品に新たに12.5％の課税を適用した。
ウインドによると、米国への出荷は前年比約17％増加し、6月の約14％から加速し、輸入は15％増加した。中国の欧州連合への輸出は引き続き増加し、7月には前年同月比16％増加したが、域内からの輸入は1％減少した。
税関統計によると、貿易黒字は１１２５億ドルで、アナリスト予想の約１０７０億ドルを上回ったものの、６月の１２５６億ドルからは縮小した。
ピンポイント・アセット・マネジメントの社長兼チーフエコノミスト、Zhiwei Zhang氏は、中国の輸出エンジンは第3四半期も好調を維持する可能性が高いと述べた。
昨年1兆ドルを超えた中国の巨額貿易黒字は、米国や欧州連合を含む貿易相手国にとって永続的な不満となっており、当局者は中国に対し、消費拡大に向けて経済のバランスを再調整するよう圧力をかけている。
張氏は、9月に予定されている米中首脳会談と10月に予定されている経済関係に関するEU・中国会議を前に、「貿易をより均衡させるために何ができるかについて、今後数カ月間に中国と主要貿易相手国との間で激しい交渉が行われると予想している」と述べた。
中国当局は7月下旬の政策決定会合で、財政出動の加速や適時な金融調整など、減速する経済への支持を再確認したが、家計支出拡大に向けた具体策の発表には至らなかった。
第２・四半期の中国経済は２０２２年第４・四半期以来の弱いペースで拡大し、４─６月期の国内総生産（ＧＤＰ）伸び率は４．３％となった。
6月の小売売上高は1％の伸びを記録し、5月の0.6％減からわずかに反発した。 6月の消費者インフレ率は5月の1.2％から1％に鈍化した一方、工場出荷時の価格は4.1％上昇し、2022年7月以来の高い伸びとなった。`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/08/07/china-july-trade-exports-imports-surplus-imbalance-tariffs-.html",
    publishedAt: "2026-08-07T06:09:26+00:00",
    category: "金融政策",
    imageUrl: "https://images.unsplash.com/photo-1611974789855-9c2a0a7236a3?w=800&q=80",
    readTime: 3,
  },
  {
    id: "oil-rises-as-iran-s-draft-plan-sees-u-s-d3ae8171",
    title: "Oil rises as Iran's draft plan sees U.S. and Israel banned from Strait of Hormuz",
    titleJa: "イランの計画草案で米国とイスラエルがホルムズ海峡から出入り禁止となり、原油が上昇",
    summaryJa: "Oil rose Friday amid worries over supply disruptions after Iran published a restrictive draft plan for the Strait of Hormuz.Futures for international benchmark Brent crude for October delivery gained 1.25% to $83.52 a barrel. U.S. West Texas Intermediate futures for September advanced 1.10% at $78.14 per barrel.",
    bodyOriginal: `Oil rose Friday amid worries over supply disruptions after Iran published a restrictive draft plan for the Strait of Hormuz.
...
"Adding to supply concerns, Ukraine struck two of Russia's major oil refineries overnight (Yaroslavl/Yanos and Bashneft's Novoil facility), and US imports of Saudi crude dropped to zero in July for the first time since 1985," according to a note by UOB.
Conflicting accounts of bilateral engagement are muddying the progress of a deal to open the Hormuz strait. While U.S. President Donald Trump said in the Oval Office that the Iran will end "pretty soon," Tehran accused him of staging "theater diplomacy."`,
    bodyJa: `Oil rose Friday amid worries over supply disruptions after Iran published a restrictive draft plan for the Strait of Hormuz.
Futures for international benchmark Brent crude for October delivery gained 1.25% to $83.52 a barrel. U.S. West Texas Intermediate futures for September advanced 1.10% at $78.14 per barrel.
ウエストパック氏はメモで「原油価格の上昇は、エネルギーと中東情勢によるさらなるインフレ衝動を無視できないことを示しており、米ドル高と国債安をもたらした」と述べた。
According to the apparent draft plan published by Iran, the country would ban U.S. and Israeli ships from transiting the Strait. Until compensation is paid, other nations that have harmed Iran would not be allowed to transit, according to the draft.
While Iran and Oman are reportedly working on an agreement to define transit routes in the Hormuz strait, a deal still has not been announced. According to media reports, inbound traffic would transit Iranian waters while outbound traffic would go through Omani waters.
ＵＯＢのメモによると、「供給懸念に加え、ウクライナがロシアの主要製油所２つ（ヤロスラブリ／ヤノスとバシネフチのノボイル施設）を一夜にして攻撃し、米国のサウジ原油輸入量は７月に１９８５年以来初めてゼロに落ち込んだ」という。
Conflicting accounts of bilateral engagement are muddying the progress of a deal to open the Hormuz strait.ドナルド・トランプ米大統領は大統領執務室で、イランは「間もなく」終焉を迎えると述べたが、イラン政府は同大統領が「劇場外交」を行っていると非難した。`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/08/07/oil-rises-supply-fears-iran-draft-plan-strait-hormuz.html",
    publishedAt: "2026-08-07T05:27:03+00:00",
    category: "エネルギー",
    imageUrl: "https://images.unsplash.com/photo-1473172367879-2dca04a4dca4?w=800&q=80",
    readTime: 3,
  },
  {
    id: "the-72-hour-crisis-that-could-upend-meta-8ac30c44",
    title: "The 72-hour crisis that could upend Meta’s business in India as firm risks losing legal protection",
    titleJa: "メタ社は法的保護を失うリスクがあり、インドでのメタ社のビジネスを一変させる可能性のある72時間の危機",
    summaryJa: "メタ・プラットフォームズがインドで立て続けに２回銃撃を受けて以来、メタ・プラットフォームズとインド規制当局との間の緊張は高まっている。テクノロジー大手の同社は、児童虐待コンテンツに関する懸念で規制当局が同社を召喚した数日後に、7月のZ世代の抗議活動中に学生に宛てたナレンドラ・モディ首相のフェイスブックへの投稿を一時的に制限した。その後、この制限は「エラー」によるものだと発表したが、当初、投稿ではコンテンツが「法的要請」によりブロックされたことを示していたと伝えられている。",
    bodyOriginal: `Tensions are high between Meta Platforms and Indian regulators after the company came under fire in the country twice in short succession.
...
"Safe harbor protection is the cornerstone of digital regulation dating back to the earliest days of the internet," Vikram Jeet Singh, partner at law firm BTG Advaya, told CNBC, adding that the loss of this immunity might expose social media companies to further civil and regulatory actions.`,
    bodyJa: `メタ・プラットフォームズがインドで立て続けに２回銃撃を受けて以来、メタ・プラットフォームズとインド規制当局との間の緊張は高まっている。
テクノロジー大手の同社は、児童虐待コンテンツに関する懸念で規制当局が同社を召喚した数日後に、7月のZ世代の抗議活動中に学生に宛てたナレンドラ・モディ首相のフェイスブックへの投稿を一時的に制限した。その後、この制限は「エラー」によるものだと発表したが、当初、投稿ではコンテンツが「法的要請」によりブロックされたことを示していたと伝えられている。
議会委員会は水曜日、モディ氏の投稿制限についてマーク・ザッカーバーグ氏に3日以内の謝罪を要求したが、それができなかった場合、同国におけるソーシャルメディア大手のセーフハーバー免責を取り消すよう勧告した。これにより、Meta はプラットフォーム上でユーザーが作成したコンテンツに対して責任を負うことになります。
インドはメタ社にとって重要な市場であり、ワッツアップ、インスタグラム、フェイスブックの最大のユーザーベースを擁しており、法律専門家らはCNBCに対し、セーフハーバー保護が撤回されればメタ社がインドで事業を行うことはほぼ不可能になると語った。
ただし、インドはプラットフォームのセーフハーバー権を削除するために、より広範な法的枠組みを修正する必要があると付け加えた。
しかしメタ氏は規制当局、特にモディ氏のポスト周辺の懸念を和らげることに熱心だ。
メタ社のジョエル・カプラン首席国際問題責任者は水曜日、インドのアシュウィニ・ヴァイシュナウ情報技術大臣と会談し、「モディ首相のポストを制限した誤り」について同大臣に「謝罪した」と同社がプレス声明で述べた。
しかし地元メディアは同日、政府関係者の話として、児童虐待コンテンツやディープフェイク素材、プラットフォーム運営上の誤りの存在について謝罪したのはメタの創設者兼最高経営責任者（CEO）のザッカーバーグ氏だと報じた。
メタ氏はCNBCと共有した公式声明の中で、これらの主張の信憑性についてはコメントしていない。
謝罪要求
水曜日のANIとのインタビューで、通信・情報技術に関する国会委員会の委員長であるニシカント・ダベイ氏は、インドの情報技術・内務省に書簡を送り、ザッカーバーグ氏自身に謝罪を要求した。
ダベイ氏は、モディ氏が学生に宛てたビデオを削除したことについて「ザッカーバーグ氏は３日以内に謝罪しなければならない」とし、同プラットフォームがセーフハーバー保護の特権を悪用していると述べ、もしそれが取り消されれば、メタ社に対する正式な警察の告訴が「全国的に殺到する可能性がある」と付け加えた。
インドで先月起きたZ世代の抗議活動中、メタ社のショートビデオアプリであるインスタグラムは、インドにおける公共の場での議論の人気プラットフォームとなった。モディ首相は若いデモ参加者にアピールするためにリールを作り始めた。
しかし、この影響力の増大により、米国企業はコンテンツ管理の怠りやユーザーのプライバシーへの懸念に対する政府の厳しい監視にもさらされている。インド政府は先月、ユーザー名機能の展開を巡るWhatsAppへの警告に続き、インスタグラムに対し、プラットフォーム上の児童虐待広告を削除するよう厳しい警告を発した。
インドの通信社ANIが木曜日に報じたところによると、メタ社のグローバルチームはインドに残り、ソーシャルメディア企業がインドの法律を遵守しているかどうかを評価する同省との追加会合を「3～4回」実施する予定だという。
一方、インドでZ世代の抗議運動を主導したゴキブリ・ジャンタ党のスポークスマン、サウラフ・ダス氏は、メタ氏がコンテンツへのアクセスを制限していると述べ、「政府からの高圧的な圧力」に屈したと主張した。
インド電子情報技術省は、メタ社のセーフハーバー免責条項を撤回する提案についてコメントを求めたCNBCの電話や電子メールに応じなかった。
安全港の喪失
セーフハーバー保護はソーシャルメディア企業に条件付き免除を与えるとアーガス・パートナーズの技術・紛争パートナーであるウディット・メンディラッタ氏は説明した。
同氏は、ソーシャルメディアプラットフォームが違法行為を幇助した場合、裁判所や政府の命令後に「迅速に」コンテンツを削除しなかった場合、児童の性的虐待素材やディープフェイク、ヘイトスピーチを削除する「デューデリジェンス義務」を怠った場合には、この免責が取り消される可能性があると付け加えた。
しかし、インドの現行法では「免責の喪失はコンテンツに特有のもの」であり、プラットフォーム全体のセーフハーバー免責を削除するには法律を改正する必要があると同氏は述べた。
インド政府はまだ正式な行動をとっていないが、専門家らは、セーフハーバーに影響を与えるいかなる決定も、責任の枠組みを変えることになるため、テクノロジー業界によって監視されるだろうと述べた。
法律事務所BTG Advayaのパートナー、ヴィクラム・ジート・シン氏はCNBCに対し、「セーフハーバーの保護は、インターネットの初期に遡るデジタル規制の基礎だ」と語り、この免除が失われるとソーシャルメディア企業はさらなる民事訴訟や規制訴訟にさらされる可能性があると付け加えた。`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/08/07/meta-india-zuckerberg-apology-genz-protest.html",
    publishedAt: "2026-08-07T04:11:09+00:00",
    category: "テクノロジー",
    imageUrl: "https://images.unsplash.com/photo-1518770660439-4636190af475?w=800&q=80",
    readTime: 6,
  },
  {
    id: "micron-s-stock-falls-but-is-spared-the-w-a93531cd",
    title: "Micron’s stock falls but is spared the worst of the memory-chip selloff",
    titleJa: "マイクロンの株価は下落するが、メモリチップの最悪の暴落は免れる",
    summaryJa: "サンディスクとウェスタンデジタルの株価は、投資家が両社の決算報告に感銘を受けなかったため大幅に下落した。",
    bodyOriginal: `Shares of Sandisk and Western Digital fell hard after investors were left unimpressed by those companies’ earnings reports.`,
    bodyJa: `サンディスクとウェスタンデジタルの株価は、投資家が両社の決算報告に感銘を受けなかったため大幅に下落した。`,
    source: "MarketWatch",
    ...
    publishedAt: "2026-08-07T02:35:00+00:00",
    category: "テクノロジー",
    imageUrl: "https://images.mktw.net/im-54177591",
    readTime: 2,
  },
  {
    id: "he-s-never-been-good-with-money-if-i-se-fad2ddb7",
    ...
    titleJa: "「彼は決してお金の使い方が上手ではありません」: 65 歳の弟のために年金を設定したら、彼の追加保障収入が危険にさらされるでしょうか?",
    summaryJa: "「彼の月々の社会保障給付金がたったの700ドルであることを知ってショックを受けました。」",
    bodyOriginal: `“I was shocked to learn that his monthly Social Security benefit will be only $700.”`,
    bodyJa: `「彼の月々の社会保障給付金がたったの700ドルであることを知ってショックを受けました。」`,
    source: "MarketWatch",
    sourceUrl: "https://www.marketwatch.com/story/hes-never-been-good-with-money-if-i-set-up-an-annuity-for-my-brother-65-would-it-jeopardize-his-supplemental-security-income-d2e9f5a0?mod=mw_rss_topstories",
    publishedAt: "2026-08-07T02:15:00+00:00",
    category: "金融政策",
    imageUrl: "https://images.mktw.net/im-16435995",
    readTime: 2,
  },
  {
    id: "iran-s-chief-negotiator-accuses-trump-of-7d20e347",
    title: "Iran's chief negotiator accuses Trump of 'theater diplomacy' with Hormuz traffic near standstill",
    titleJa: "イランの首席交渉官、ホルムズ島の交通がほぼ停止状態でトランプ大統領の「劇場外交」を非難",
    summaryJa: "ワシントンとイラン政府が数カ月にわたる敵対関係の終結を目指した二国間関与について相反する説明をしている中、イランの首席交渉官はドナルド・トランプ米大統領が「劇場外交」を演出していると非難した。「『大規模な攻撃が来る…待って、気にしないでください、彼らは交渉したいのです。』それはまさに劇場外交だ」とイラン国会議長で交渉のトップであるモハマド・バガー・ガリバフ氏は、木曜日のXへの投稿で、明らかにトランプ大統領を攻撃していると書いた。",
    bodyOriginal: `Iran's chief negotiator has accused U.S. President Donald Trump of staging "theater diplomacy," as Washington and Tehran offer conflicting accounts of bilateral engagement aimed at ending their months-long hostilities.
...
The conflict is meanwhile broadening across the region, with Gulf energy infrastructure and key shipping chokepoints under renewed threat.
Saudi Arabia is bracing for "multiple coordinated attacks" by Iraqi militia factions working with Iran-backed Houthis, a Saudi official told CNN. Intelligence reports from Saudi Arabia and regional governments reportedly indicated that the groups planned to strike the kingdom "in the very near future" under the guidance of Iran's Islamic Revolutionary Guard Corps.
The warning came a day after the Houthis claimed responsibility for attacks on two Saudi oil tankers in the Gulf of Aden, another critical shipping chokepoint. Saudi Arabia has come under Houthi missile fire and drone attacks by Iran-backed Iraqi militias in recent weeks.
Shipping through the region's two critical chokepoints has fallen sharply in recent days. Only two vessels transited the Strait of Hormuz on Wednesday, down from eight a day earlier, according to Kpler vessel-tracking data, against a pre-war baseline of roughly 130 to 140 daily transits. Traffic through the Bab el-Mandeb collapsed to a single dry bulk carrier, from 20 vessels the previous day.
Flows via Hormuz are unlikely to return to pre-war levels anytime soon, even after a deal is reached between Oman and Iran for managing traffic via the critical waterway.
U.S. and Israeli ships would be barred from the Strait of Hormuz under a draft plan involving Iran and Oman for managing the waterway, Tehran's semi-official Fars news agency reported Thursday, with restrictions extending to countries that have "caused damage" to Iran, until compensation is paid.
...
Oil jumped on signs of Tehran's hardening stance on the Hormuz traffic. Brent crude futures for October delivery gained 1.3% to $83.55 a barrel, while September futures for WTI crude rose about 1.1% to $78.17 on Friday, extending losses from a day earlier and reversing an earlier slide driven by brief optimism that a Hormuz deal was days away.
Earlier, regional officials said that Iran and Oman were close to finalizing a framework covering all inbound traffic via Iranian territorial waters as well as outbound traffic through a route closer to Oman, though the arrangement would not automatically reopen the waterway.
In a Truth Social post on Thursday, Trump pushed back on reports that U.S. munitions stocks have been depleted by the war. "The U.S. has massive amounts of 'munitions,' especially of certain types," he said, vowing to pursue "long-term jail sentences" for leakers.
CNN reported later in the day that, in the Oval Office, Trump acknowledged that certain munitions are in "tighter" supply, while insisting less-advanced weapons remain in virtually unlimited supply.`,
    bodyJa: `ワシントンとイラン政府が数カ月にわたる敵対関係の終結を目指した二国間関与について相反する説明をしている中、イランの首席交渉官はドナルド・トランプ米大統領が「劇場外交」を演出していると非難した。
「『大規模な攻撃が来る…待って、気にしないでください、彼らは交渉したいのです。』それはまさに劇場外交だ」とイラン国会議長で交渉のトップであるモハマド・バガー・ガリバフ氏は、木曜日のXへの投稿で、明らかにトランプ大統領を攻撃していると書いた。
この発言は、トランプ大統領が計画されていた攻撃を中止し、イラン政府との合意の概要はすでに合意済みだと述べた数日後に行われた。イラン当局者はこの主張を拒否し、協議は行われていないと述べた。
一方、紛争は地域全体に拡大しており、湾岸のエネルギーインフラや海運の主要な関所が新たな脅威にさらされている。
サウジアラビアは、イランが支援するフーシ派と協力するイラク民兵組織による「複数の組織的攻撃」に備えているとサウジ当局者がＣＮＮに語った。サウジアラビアと地方政府からの情報報告書によると、このグループはイラン・イスラム革命防衛隊の指導の下、「近い将来」サウジを攻撃する計画を立てていたという。
この警告は、海運のもう一つの重要な関門であるアデン湾でのサウジアラビアの石油タンカー２隻への攻撃についてフーシ派が犯行声明を出した翌日に出された。サウジアラビアはここ数週間、イラン支援のイラク民兵組織によるフーシ派のミサイル攻撃やドローン攻撃を受けている。
この地域の2つの重要なチョークポイントを通過する輸送はここ数日で急激に減少している。クプラーの船舶追跡データによると、水曜日にホルムズ海峡を通過した船舶はわずか2隻で、戦前の基準では1日約130～140隻の航行であったが、前日の8隻から減少した。バブ・エル・マンデブを通過する交通は、前日には20隻の船舶から1隻のドライバルクキャリアに崩壊した。
重要な水路を経由する交通を管理することでオマーンとイランの間で合意に達した後でも、ホルムズ経由の流れがすぐに戦前の水準に戻る可能性は低い。
テヘランの半国営ファルス通信が木曜日に報じたところによると、ホルムズ海峡の管理にイランとオマーンが関与する計画草案に基づき、米国とイスラエルの船舶はホルムズ海峡への出入りが禁止され、賠償金が支払われるまではイランに「損害を与えた」国にも規制が及ぶことになる。
ファールス通信によると、イランは合意条件に違反した者に対し、貨物の価値の最大２０％の罰金を科す予定で、現在検討中だという。
ホルムズ交通に対するイラン政府の姿勢強化の兆しを受けて原油価格が急騰した。金曜、ブレント原油先物10月渡しは1.3％上昇して1バレル当たり83.55ドル、WTI原油9月先物は金曜日に約1.1％上昇して78.17ドルとなり、前日からの下落幅が拡大し、ホルムズ協定が数日後に迫っているという一時的な楽観的な見方によって引き起こされた以前の下落を反転させた。
これに先立ち、地域当局者らは、イランとオマーンが、イランの領海を経由するすべての流入交通と、オマーンに近いルートを通る流出交通を対象とする枠組みの最終決定に近づいていると述べたが、この取り決めによって水路が自動的に再開されるわけではない。
トランプ大統領は木曜日のトゥルース・ソーシャルへの投稿で、戦争により米国の軍需品が枯渇したとの報道を否定した。同氏は「米国は、特に特定の種類の『兵器』を大量に保有している」と述べ、漏洩者には「長期の懲役刑」を課すことを明言した。
CNNはその日遅く、大統領執務室でトランプ大統領が特定の弾薬の供給が「逼迫している」ことを認めた一方、あまり先進的ではない兵器については事実上無制限の供給が続いていると主張したと報じた。`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/08/07/us-iran-war-trump-hormuz-diplomacy-oil-.html",
    publishedAt: "2026-08-07T02:08:42+00:00",
    category: "エネルギー",
    imageUrl: "https://images.unsplash.com/photo-1473172367879-2dca04a4dca4?w=800&q=80",
    readTime: 4,
  },
  {
    id: "meta-ordered-to-pay-567-million-into-aba-f71bcafe",
    title: "Meta ordered to pay $567 million into abatement fund as remedy to child harms case in New Mexico",
    titleJa: "メタ社はニューメキシコ州の児童虐待事件の救済策として、減額基金に5億6,700万ドルの支払いを命じた",
    summaryJa: "Meta は公共迷惑事件の一環として、ニューメキシコ州の削減基金に 5 億 6,700 万ドルを支払うよう命じられた。この訴訟は、同社がアプリによって引き起こされた危害の疑いに関連して直面している多くの訴訟の 1 つにすぎない。この基金は、メタ社が今年初めにニューメキシコ州の不当行為法に違反したことが判明し支払わなければならなかった民事罰金3億7,500万ドルに上乗せされるものである。 5月に始まった治験の第2段階では、メタ社の行為が公共の迷惑行為を引き起こしたかどうかが立証され、製品変更の可能性が正当化されることになる。",
    bodyOriginal: `Meta was ordered to pay $567 million into an abatement fund in New Mexico as part of a public nuisance case that's just one of many suits the company faces related to alleged harms caused by its apps.
...
A Meta spokesperson told CNBC in a statement that the company disagrees with the ruling and plans to appeal.
...
Torrez sued Meta in 2023 following an undercover operation involving the creation of a fake social media profile of a 13-year-old girl that he previously told CNBC "was simply inundated with images and targeted solicitations" from child abusers.
...
Other remedies include making it easier to report underage usage, and partnering "with schools or a child safety organization to create a reporting portal where school administrators can flag suspected accounts where users may be under 13 years of age across any social media platform."
Meta is not being forced to make any changes to its algorithms, however, as Biedscheid wrote that doing so could conflict with Section 230 and First Amendment protections. The judge added that Meta will not be required to stop supporting end-to-end encryption on Facebook.
The judge noted that Meta's WhatsApp "is not a contributing cause to the public nuisance being abated, as predators and harmful content are not recommended to adolescents on that site."
WATCH: Meta's stock pullback justified, says Needham's Laura Martin`,
    bodyJa: `Meta は公共迷惑事件の一環として、ニューメキシコ州の削減基金に 5 億 6,700 万ドルを支払うよう命じられた。この訴訟は、同社がアプリによって引き起こされた危害の疑いに関連して直面している多くの訴訟の 1 つにすぎない。
この基金は、メタ社が今年初めにニューメキシコ州の不当行為法に違反したことが判明し支払わなければならなかった民事罰金3億7,500万ドルに上乗せされるものである。 5月に始まった治験の第2段階では、メタ社の行為が公共の迷惑行為を引き起こしたかどうかが立証され、製品変更の可能性が正当化されることになる。
「この点でメタ社だけではないが、メタ社のソーシャルメディアプラットフォームは、本件の実質的な証拠によって立証されたニューメキシコ州の若者の現在のメンタルヘルス危機の重大な要因である」とブライアン・ビエドシャイト判事は木曜日の判決の中で述べた。
基金の資金のほとんど (4 億 2,000 万ドル) は、プラットフォームによって被害を受けた人々の治療に充てられます。残りは、啓発と予防、スクリーニングと評価、照会と調整、および実装、品質向上と評価です。
メタとその同業者にとって、今回の事件は専門家がソーシャルメディアの「ビッグ・タバコ」の瞬間と特徴づけた今年のいくつかの事件のうちの一つだ。 1990年代、タバコ会社は自社製品の安全性と潜在的な害について国民を誤解させた罪で数十億ドルの支払いを余儀なくされ、その後、タバコ会社の力と影響力は劇的に減少した。
メタ社は第２・四半期財務報告書の中で、「ニューメキシコ州司法長官は、この件で最大６２８億５０００万ドルの罰金を求める意向を示した」と指摘した。
原告らが主張するように、裁判所はメタのプラットフォームがニューメキシコ州で公共の迷惑行為を引き起こしたかどうかを判断するために、多くの要素を比較検討する必要があった。公共迷惑行為の申し立てに関わる訴訟は通常、インターネットではなく物理的な世界を中心に行われており、州内での被害とメタ社のアプリを関連付けるのが原告の負担となっている。
ビエドシャイト氏は、医療などの分野のさまざまな専門家による裁判証言を強調した。同州には、ソーシャルメディアアプリによって被害を受け、問題を抱える若者を支援するために必要なメンタルヘルスプログラムやサービスが適切な数不足していると指摘した。
「因果関係」
提出書類には「専門家の証言は、ソーシャルメディアとニューメキシコ州の若者のメンタルヘルス危機との因果関係を裏付けている」と述べた。
メキシコのラウール・トレス司法長官は声明で、「この判決は、当社が子どもたち、家族、学校に与えた損害に対する責任を問うものであり、ニューメキシコ州でのメタ社の運営方法に実質的な変更を強いることになる」と述べた。
メタの広報担当者はＣＮＢＣに対し、同社は判決に同意せず、控訴する予定だと声明で述べた。
「当社はプラットフォーム上で人々の安全を守るために懸命に努力しており、悪意のある人物や有害なコンテンツを特定して削除するという課題について透明性を保ってきた」と広報担当者は述べた。 「私たちはオンラインで青少年を保護してきた実績に今後も自信を持っており、事実を誤って伝える主張に対して引き続き防御していきます。」
トーレス氏は、13歳少女の偽ソーシャルメディアプロフィール作成に関わるおとり捜査を受け、2023年にメタ氏を告訴した。以前CNBCに対し、トーレス氏は児童虐待者らから「画像と的を絞った勧誘が殺到しただけだ」と語った。
裁判の第2段階が始まる前の記者会見で、トーレス被告は、効果的な年齢確認技術などの機能の実装、子どもの福祉を損なわない推奨アルゴリズムの変更、その他「メタ社が州内で事業を行うことができる方法を根本的に再構築する」結果となるその他の変更を加えることにより、メタ社に自社アプリの徹底的な見直しを強制しようとしていたと、AGが述べた。
木曜日の命令では、軽減基金に加えて、メタに対し、AIを活用した「ニューメキシコ州における年齢保証モデルとツール」の改善を継続し、「2年以内に専用の13歳未満予測モデル」の開発を試みることを求めている。
他の救済策には、未成年者の使用を報告しやすくすることや、「学校や児童安全団体と提携して、学校管理者があらゆるソーシャルメディアプラットフォームでユーザーが13歳未満である可能性のある疑わしいアカウントにフラグを立てることができる報告ポータルを作成する」ことが含まれる。
ただし、Biedscheid氏がそうすることで第230条や憲法修正第1条の保護に抵触する可能性があると書いているように、Metaはアルゴリズムの変更を強制されているわけではない。判事は、メタ社はFacebook上でのエンドツーエンド暗号化のサポートを中止する必要はないと付け加えた。
判事は、MetaのWhatsAppは「そのサイトでは略奪者や有害なコンテンツが青少年に推奨されていないため、公衆迷惑行為の軽減には貢献していない」と指摘した。
注目：メタの株価下落は正当だとニーダムのローラ・マーティン氏が語る`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/08/06/meta-to-pay-into-567-million-fund-after-child-harms-case-new-mexico.html",
    publishedAt: "2026-08-07T01:28:57+00:00",
    category: "テクノロジー",
    imageUrl: "https://images.unsplash.com/photo-1518770660439-4636190af475?w=800&q=80",
    readTime: 5,
  },
  {
    id: "trump-imposes-15-tariff-on-key-chip-mate-de6a41a3",
    title: "Trump imposes 15% tariff on key chip material to counter China",
    titleJa: "トランプ大統領、中国に対抗するため主要チップ材料に15％の関税を課す",
    summaryJa: "トランプ大統領、中国に対抗するため主要チップ材料に15％の関税を課す- 公開されました",
    bodyOriginal: `Trump imposes 15% tariff on key chip material to counter China
- Published
...
- Published1 day ago`,
    bodyJa: `トランプ大統領、中国に対抗するため主要チップ材料に15％の関税を課す
- 公開されました
ドナルド・トランプ米大統領は木曜日、半導体や太陽光パネルに使用される重要な材料であるポリシリコンで作られた輸入品に15％の関税を課す大統領令に署名した。
この命令では、ポリシリコンおよび関連製品の最低輸入価格も設定された。この素材の海外生産に関する国家安全保障上の調査を受けての発表となった。
この動きは、世界二大経済大国間の摩擦の主な原因となっている中国のチップ産業との競争激化に米国メーカーが直面している中で、米国メーカーを保護することを目的としている。
ワシントンの中国大使館は、今回の措置は両国間の貿易を「深刻に混乱させる」ものであり、中国政府は自国の企業を保護するために行動すると述べた。
同大使館は、米国は「国家権力を乱用して中国企業を追及している」と述べ、保護主義によって米国の競争力が高まるわけではないと付け加えた。
トランプ大統領は対外命令の中で、最低輸入価格とポリシリコンおよび関連輸入品に対する15％の関税を設定するというハワード・ラトニック商務長官の勧告を受け入れたと述べた。
この措置は12月に施行される予定だ。
米国は国内生産を増やすための奨励金も提供する予定だと付け加えた。
米国の雇用を守り、経済を活性化させるために関税の利用を長年主張してきたトランプ大統領は、米国は数十年にわたり「外国企業がポリシリコン分野で米国の生産者を弱体化させること」を容認してきたと述べた。
トランプ大統領は、この材料は軍需品やエレクトロニクスに不可欠だが、輸入により世界のポリシリコン生産に占める米国のシェアは２００５年の５０％から２０２４年には２％未満に低下したと述べた。
中国はポリシリコンの生産をほぼ独占している。
この注文は、米国の同材料の主要生産者であるヘムロック・セミコンダクターとワッカー・ケミーに利益をもたらす可能性が高い。
コンピューターチップの生産は、米国と中国の人工知能（AI）開発競争の中心となっている。米国と中国はまた、報復関税戦争に巻き込まれており、この戦争は2025年5月から保留されている。
中国国営メディアの環球時報が伝えたアナリストらの話として、今回の新たな関税は、重要技術サプライチェーンにおける中国の役割を制限しようとする米国の取り組みが最近さらにエスカレートしたことを示すものだと述べた。
この動きは、中国からのドローン、人型ロボット、その他のハイテク製品の輸入に対する米国の他の制限に続くものである。
中国は今週、ドローンの輸出規制強化を含む一連の対抗措置を発表した。中国政府はまた、輸入プリンターやコピー機に対する国家安全保障の見直しも開始した。
- 1 日前に公開`,
    source: "BBC",
    sourceUrl: "https://www.bbc.co.uk/news/articles/cdrvn686dljo?at_medium=RSS&at_campaign=rss",
    publishedAt: "2026-08-07T01:03:35+00:00",
    category: "テクノロジー",
    imageUrl: "https://ichef.bbci.co.uk/ace/standard/240/cpsprodpb/60dd/live/9a103bd0-91fb-11f1-952a-e58ebd1358f8.jpg",
    readTime: 3,
  },
  {
    id: "meta-fined-567m-in-largest-child-safety-74218703",
    title: "Meta fined $567m in largest child safety ruling against social media giant",
    titleJa: "メタ、ソーシャルメディア大手に対する児童安全に関する最大規模の判決で5億6,700万ドルの罰金",
    summaryJa: "ニューメキシコ州の判事は、インスタグラム、フェイスブック、ワッツアップの親会社に対し、子どもたちに危害を加えたとしてさらに5億6700万ドルを支払うよう命じた。",
    bodyOriginal: `Meta fined $567m in largest child safety ruling against social media giant
- Published
...
Meta, which owns and operates Instagram, Facebook, WhatsApp and Threads, has been contacted by the BBC for comment.
Regarding the earlier $375m verdict against in the case, Meta had said it intended to appeal the ruling. It was the first time that a state had successfully sued Meta over child safety issues.
The case stems from a 2023 lawsuit brought by attorneys for the State of New Mexico, arguing Meta should be held liable for the way in which its platforms endangered children and exposed them to sexually explicit material and contact with sexual predators.
...
- Published24 March`,
    ...
    publishedAt: "2026-08-07T00:06:17+00:00",
    category: "マクロ経済",
    imageUrl: "https://ichef.bbci.co.uk/ace/standard/240/cpsprodpb/d2d2/live/d094fb50-91ec-11f1-a12f-8b7b5ef58f56.jpg",
    readTime: 2,
  },
  {
    id: "a-weaponized-yen-how-the-u-s-japan-inter-fe74ef4e",
    title: "A 'weaponized' yen: How the U.S.-Japan intervention may reshape global currency markets",
    titleJa: "「武器化された」円：日米介入が世界の通貨市場をどのように再形成するか",
    summaryJa: "円を支援するための前例のない日米介入は、最終的に市場の行動を形作ることになるかもしれない。日本はこれまでも為替市場に介入してきたが、今回の出来事はいつもより大きかった。この計画は米国政府の支援を受けており、伝えられるところによれば、直接ドル円ではなくユーロ円クロスを使用して実行され、明確な政治的支援も伴っていた。",
    bodyOriginal: `The unprecedented U.S.-Japan intervention to support the yen may end up shaping market behavior.
Japan has intervened in currency markets before, but this episode was bigger than usual. It was backed by Washington, reportedly executed using the euro-yen cross rather than directly in dollar-yen, and accompanied by explicit political support.
Some investors consider this a major step.
"Japan's Ministry of Finance and the U.S. Treasury have successfully weaponized the yen," said Jesper Koll, expert director for Monex Group, referring to market deterrence. The intervention went beyond conventional foreign exchange management because the countries deployed public balance sheets in concert to influence market psychology, he said.
"When increasingly scarce national assets are spent in unison on the same target by two major sovereigns, markets will have to listen," he added.
...
Political tool
Koll also pointed to what he sees as unprecedented political signaling. By combining political backing and financial firepower, Washington and Tokyo sought to raise the cost of betting against the yen by putting two sovereign balance sheets on the other side of the trade.
Cornell University professor Eswar Prasad sees it as more of a defensive move, saying the operation nevertheless signals that foreign exchange policy has become increasingly intertwined with geopolitics.
"Currency market intervention has clearly taken on a geopolitical tinge," Prasad said, with Donald Trump's administration appearing more willing to support central banks of countries it views as aligned with U.S. priorities.
Some analysts drew parallels with Washington's support for Argentina's peso under President Javier Milei, when the country was battling currency instability ahead of key midterm elections. In September and October 2025, the Trump administration stepped in with a support package, using the Treasury's Exchange Stabilization Fund to provide a $20 billion currency swap with Argentina's central bank while also purchasing pesos in the open market.
"Bessent is the common thread. Same Treasury, same ESF, same playbook of using foreign-currency operations as an instrument of statecraft," said Michael Gayed, chief investment strategist at Tactical Rotation Management. "Argentina was about propping up a friend."
Similarly, Quantum Strategy's strategist David Roche said Washington's motives likely extended beyond financial stability or Treasury markets, and that political considerations could also have played a role.
"He might just want to do nice things for his buddy Takaichi."
The U.S. Treasury Department did not respond to CNBC's request for comment.
The intervention has altered the way investors will think about the currency, strategists said.
...
The yen has long been the world's preferred funding currency for carry trades, where investors borrow cheaply in yen to invest in higher-yielding assets elsewhere.
Leung added that the broader consequence is that "currency policy itself" has returned as a source of market risk after fading into the background over the past decade. If investors increasingly migrate to other funding currencies such as the euro, that could reshape positioning across major FX markets.
Masahiko Loo, senior fixed income strategist at State Street Investment, agreed the episode means traders must increasingly price in geopolitical developments.
"The biggest shift is that traders now have a new variable to price: policy reaction functions, not just macro fundamentals," he said.`,
    bodyJa: `円を支援するための前例のない日米介入は、最終的に市場の行動を形作ることになるかもしれない。
日本はこれまでも為替市場に介入してきたが、今回の出来事はいつもより大きかった。この計画は米国政府の支援を受けており、伝えられるところによれば、直接ドル円ではなくユーロ円クロスを使用して実行され、明確な政治的支援も伴っていた。
一部の投資家はこれを大きな一歩だと考えている。
「日本の財務省と米国財務省は円を兵器化することに成功した」とマネックスグループの専門ディレクター、ジェスパー・コール氏は市場の抑止力について言及した。同氏は、市場心理に影響を与えるために各国が協調して公的貸借対照表を導入したため、今回の介入は従来の為替管理を超えたものだったと述べた。
同氏はさらに、「ますます不足する国家資産が２大主権者によって同じ目標に一斉に支出される場合、市場は耳を傾ける必要があるだろう」と付け加えた。
この協調介入は、１９９８年以来初めての日米共同の円買い作戦であり、２０１１年の地震後にＧ７が円安誘導を行って以来、初めて両国が関与した協調介入となった。
政治ツール
コル氏はまた、前例のない政治的シグナルであると彼が見ているものを指摘した。政治的支援と財政力を組み合わせることにより、ワシントンと日本は2つのソブリンバランスシートを取引の反対側に置き、対円での賭けのコストを引き上げようとした。
コーネル大学のエスワル・プラサド教授は、これをむしろ防衛的な動きとみており、それでもこの作戦は為替政策が地政学とますます絡み合っていることを示していると述べた。
プラサド氏は、ドナルド・トランプ政権が米国の優先事項と一致すると見なす国の中央銀行支援に一層意欲を示しているようで、「為替市場への介入は明らかに地政学的な色合いを帯びている」と述べた。
一部のアナリストは、アルゼンチンが重要な中間選挙を控えて通貨不安定と闘っていた当時、ハビエル・ミレイ大統領の下でアルゼンチンペソに対する米国政府の支援と類似点を指摘した。 2025年9月と10月、トランプ政権は支援策に乗り出し、財務省為替安定基金を利用してアルゼンチン中央銀行と200億ドルの通貨スワップを提供すると同時に公開市場でペソを購入した。
タクティカル・ローテーション・マネジメントの首席投資ストラテジスト、マイケル・ゲイド氏は「ベッセントは共通点だ。同じ財務省、同じＥＳＦ、外貨運用を国家戦略の手段として利用するという同じ戦略だ」と述べた。 「アルゼンチンは友人を支えようとしていた。」
同様に、クォンタム・ストラテジーのストラテジスト、デビッド・ロシュ氏は、米国政府の動機は金融安定や国債市場を超えている可能性が高く、政治的配慮も影響した可能性があると述べた。
「彼はただ仲間の高市のために良いことをしたいだけなのかもしれない。」
米財務省はCNBCのコメント要請に応じなかった。
ストラテジストらは、介入により投資家の通貨に対する考え方が変わったと述べた。
グローバルＸＥＴＦの投資ストラテジスト、ビリー・レオン氏は「特に取引への資金調達の計算法が変わる」と述べた。 「投資家が介入リスクを現実的かつ組織的な脅威と見なすようになれば、大規模な円ショートポジションの運用はより慎重になり、代替資金調達通貨に方向転換する可能性が高い。」
円は長年にわたり、投資家が円で安く借り入れて他の高利回り資産に投資するキャリートレードの資金調達通貨として世界で好まれてきました。
レオン氏は、より広範な影響としては、過去10年間で背景に消え去った「為替政策そのもの」が市場リスクの源として戻ってきたことだと付け加えた。投資家がユーロなど他の資金調達通貨にますます移行すれば、主要外国為替市場全体のポジショニングが再形成される可能性がある。
ステート・ストリート・インベストメントのシニア債券ストラテジスト、マサヒコ・ルー氏は、このエピソードはトレーダーが地政学的な展開をますます織り込む必要があることを意味していると同意した。
同氏は「最大の変化は、トレーダーがマクロのファンダメンタルズだけでなく、政策反応機能という価格に対する新たな変数を手に入れたことだ」と述べた。`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/08/07/japan-us-yen-intervention-global-currency-markets.html",
    publishedAt: "2026-08-07T00:05:26+00:00",
    category: "金融政策",
    imageUrl: "https://images.unsplash.com/photo-1611974789855-9c2a0a7236a3?w=800&q=80",
    readTime: 4,
  },
  {
    id: "from-birth-to-brokerage-why-south-korea-a622ce80",
    title: "From birth to brokerage: Why South Korea is seeing a surge in infant investment accounts",
    titleJa: "誕生から証券取引まで：なぜ韓国で幼児向け投資口座が急増しているのか",
    summaryJa: "Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.",
    bodyOriginal: `South Korean parents are ramping up efforts to give their children a head start in building long-term wealth by opening investment accounts even before they learn to crawl out of their cribs.
...
Kakaopay Securities, an online brokerage linked to the Korean internet conglomerate Kakao Corp., said last month that it plans to hand out stocks worth 100,000 won per infant born next year in an effort to expand its customer base.
...
"However, it would mainly affect participation rather than the total amount invested, which will continue to depend more heavily on household wealth, market conditions and tax considerations."`,
    bodyJa: `韓国の親たちは、子どもたちがベビーベッドから這い上がることを学ぶ前から投資口座を開設し、長期的な資産形成を有利にスタートさせようとする取り組みを強化している。
時価総額で国内最大の証券会社、未来アセット証券では、1歳未満の子供の証券口座が6月時点で約1万5000件と、1年前から3倍近く増加した。
同証券会社によると、重複口座を除いた9歳未満の新規口座開設数は60％近く急増し、約18万5,000件となった。
韓国のAIを活用した市場の上昇をきっかけとしたその熱狂は、世代を超えた資産計画のトレンドを引き起こしたが、国内株式市場のボラティリティにより、投資家は国境を越えた価値も求めるようになった。
看護師として働くイ・ヘウォンさんはCNBCに対し、夫婦で貯蓄や預金口座にお金を預けておくよりも長期投資の方が良い選択だと信じていると語った。
「子供の口座の管理に関しては、投資金額よりも投資期間が重要だと感じたので、第一子の口座を4歳で開設し、第二子の口座は生後すぐに開設しました」と彼女は言いました。家族は月に約30万ウォン（210ドル）から40万ウォンを米国の上場投資信託（主にS&P500指数に連動するファンド）に投資している。
他の保護者も同様のことを行っています。
会社員のイ・ジュンヒョクさんは、「子供に時間という贈り物と、その間に複利の力を与えたかった。それが、出産直後に口座を開設した理由だ」と語った。
同氏は「私は韓国の半導体セクターや米国の物理的AI関連株にも小規模で定期的に投資しているが、どちらも高い成長の可能性があると考えている」と述べた。
デポール大学の経済学教授、ジェジュン・ウー氏はCNBCに対し、たとえ市場がより不安定になったとしても、親は子供のために投資口座を開設し続けるだろうと語った。この現象は、「韓国市場であろうと海外市場であろうと、株式投資が長期的な富を築くための信頼できる方法とみなされている限り」、この現象は続くだろうとウー氏は語った。
「これは、韓国の家計富の主要な形態であった不動産に対する伝統的な嗜好からの、徐々にではあるが意味のある変化を表している可能性がある」と彼は付け加えた。
データ統計省の調査によると、家計は資産の約4分の3を主に不動産などの物的資産に保有し、残りを金融資産に保有している。
税制上の優遇措置
金融サービス会社ノムラの韓国担当シニアエコノミスト、ジョンウ・パク氏は、特に短期保有や複数住宅所有に対する不動産に対するキャピタルゲイン税が比較的高いことも、より多くの韓国人を株式市場に引き付けるもう一つの要因だと述べた。
国税庁によると、韓国では2年以上所有する不動産のキャピタルゲインに対して6％～45％の累進税率が適用される。所有期間が2年未満の不動産の税率は40％から70％に跳ね上がります。
対照的に、ほとんどの個人投資家は、大株主でない限り、韓国上場株式を売却する際にキャピタルゲイン税の対象になりません。
贈与税も親が株式市場に群がる理由の一つだ。法制部によると、親から未成年の子への贈与は10年に1回、2000万ウォンまでは非課税となる。そのため、親はその非課税の現金贈与を株式投資に利用します。
「当初、私たちが一番心配していたのは、子供の口座でどの株を買うかということではなく、むしろ贈与税をどう扱うかということでした。関連する詳細については自分たちで調べ、税理士にも相談しました」と「leecoach_mom」さんは語る。
しかし、ほとんどの中所得世帯にとって、子供のために株に投資する主な動機は、減税ではなく、教育や経済的安全のために貯蓄することだろう、とデポール大学のウー氏は述べた。
証券会社と政府が幼児投資家を誘惑する
韓国のインターネット複合企業カカオ社と連携するオンライン証券会社カカオペイ証券は先月、顧客基盤の拡大を図るため、来年生まれる乳児１人当たり１０万ウォン相当の株式を配布する計画だと発表した。
政府も株式市場をよりアクセスしやすくするために役割を果たしています。
金融当局は2023年にガイドラインを改定し、保護者が支店に出向かずにスマートフォンから遠隔で子どもの口座を開設できるようにした。 「親がリモートで口座開設できるようにすることで、実質的な大きな障壁が取り除かれた」とノムラのパーク氏は語った。
同氏は「さらなる簡素化により、特に少額かつ定期的に投資を行う世帯において、未成年者の口座数がおそらく増加するだろう」と述べた。
「しかし、それは主に投資総額ではなく参加に影響を与えるだろう。投資総額は今後も家計の資産、市場状況、税金の考慮により大きく依存するだろう。」`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/08/07/south-korea-investment-stock-baby-accounts.html",
    publishedAt: "2026-08-06T23:42:20+00:00",
    category: "金融政策",
    imageUrl: "https://images.unsplash.com/photo-1611974789855-9c2a0a7236a3?w=800&q=80",
    readTime: 5,
  },
  {
    id: "why-airlines-are-warning-over-lithium-io-3f541424",
    title: "Why airlines are warning over lithium-ion batteries",
    titleJa: "航空会社がリチウムイオン電池に対して警告を発している理由",
    summaryJa: "航空会社がリチウムイオン電池に対して警告を発している理由- 公開されました",
    bodyOriginal: `Why airlines are warning over lithium-ion batteries
- Published
...
- Published12 June
- Published26 June`,
    bodyJa: `航空会社がリチウムイオン電池に対して警告を発している理由
- 公開されました
ベン・ウォデッキは世界中を旅することに慣れており、航空会社の乗務員が仕事をしているのを見るのにも慣れています。
しかし、6月にラスベガスに到着したテクノロジージャーナリストは、心配そうな表情の運航乗務員が飛行機の後部に駆け寄る中、これまで見たことのないものを目にした。 「一抹の恐怖がありました。彼らは気弱でした。これは誰かが病気であるという以上の何かでした。それは彼らに影響を与えたものでした。」
煙が上がり、飛行機の後部から乗客たちが現れ、何が起こったのかが明らかになった。乗客が飛行中にバッテリーパックを使用していたところ、バッテリーパックが過熱して爆発炎上し、座席に引火した。
ウォデッキ氏によると、運航乗務員は装置を水の入った容器に落としたという。その後、飛行機はラスベガスのハリー・リード国際空港に「素早くかつ積極的に」着陸し、滑走路上で消防隊員が出迎えたと同氏は説明した。
これは、定期的なフライトの劇的な終わりでした。これは、バッテリー駆動の機器、特にリチウムイオンバッテリーを機内に持ち込むことの危険性について、飛行機を利用する人々がより頻繁に、より執拗に警告する理由を説明しています。
これらには、座席に滑り込んだデバイスを取り出そうとすることについての警告や、リチウムイオンデバイスを受託手荷物に入れないでくださいという警告が含まれます。
英国民間航空局（CAA）のジョナサン・ニコルソン氏によると、航空業界にとってリチウムイオン電池は「ここ数年、ナンバーワンではないにしても、トップ3のリスクに入る」という。
米国の最近の調査によると、業界外では世界中で週に2件のリチウムイオン電池関連の事故の影響を受けていると同氏は付け加えた。そうした事件は、乗客が預け荷物の中にデバイスを忘れてきたことに遅ればせながら気づいたり、空港の手荷物ホールや飛行機内でデバイスが喫煙したり発火したりするものまで多岐にわたる可能性がある。
しかし、結果はさらに極端になる可能性があります。 2025年1月、韓国の金海空港の駐機場でエアプサン機が破壊され、捜査当局は頭上の荷物入れに残されたパワーバンクのバッテリーパックが原因であると結論づけた。
このため、国際航空運送協会 (IATA) は、乗客に「リチウム電池を使ってスマートに旅行する」ことを奨励するための世界的なキャンペーンを対外的に開始しました。
飛行に関してリチウムイオン技術をより危険にするものは何もない、とニコルソン氏は説明する。むしろ、「航空機の客室内で高度 32,000 フィートに対処するのははるかに困難です」と彼は言いました。
ニコルソン氏は、リチウムイオン関連事故の蔓延は「より多くの人、より多くの飛行機、より多くの機器」が原因であると述べた。
米国連邦航空局は、バッテリーの安全性が最優先事項であると述べています。そのデータは「確認されたインシデントの増加を示し続けており」、7 月 15 日までの 1 年間に確認されたインシデントは 51 件でした。
英国の国立物理研究所でバッテリー技術を専門とする主任エンジニアであるピエール・クビアク氏は、人々が飛行機に持ち込むポータブルデバイスとしては携帯電話、パワーバンク、タブレット、ラップトップが最も明らかだが、スマートウォッチ、スマートグラス、電子タバコがますます一般的になっていると付け加えた。
「リチウム自体は燃えません。むしろ有機材料とプラスチックがすべて燃えます」と彼は説明する。 「重要なのは、非常に高温になり、非常に早くなるということです。つまり、700 度から 1000 度以上が超高速です。」
リチウムイオン電池の危険性は、約 10 年前の携帯電話関連の一連の火災をきっかけに、一般の人々の意識に本格的に浸透しました。
クビアク氏は、これは欠陥のある設計が原因であり、メーカーはその後懸念に対処したと述べた。韓国はこの分野のリーダーであると彼は付け加えた。
しかし、品質管理に疑問があり、東アジアから安価に製造されたバッテリーパックや、電子タバコやその他の動力付きデバイスの拡散を制御するのは困難でした。 「価格がすべてです」と彼は言います。さらに同氏は、乗客が不適切なケーブルを使用したり、機器の手入れを怠ったりすることで問題を引き起こすことが多いと付け加えた。
このため航空会社には、警告を繰り返すとともに、インシデント発生時に迅速に対応できるようスタッフが確実に訓練される、実証済みの方法に固執する以外に選択肢はほとんどない。
CAAのニコルソン氏は「最も重要なことは水に放り込んで冷却することだ」と述べているが、一部の航空会社は特殊な封じ込め装置を使用していた。しかし、だからこそ、デバイスは頭上の収納棚や貨物室ではなく、客室内に保管することが重要です。
ニコルソン氏は、顧客は警告や制限によく耐えているようだと付け加えた。最大の問題は、リチウムイオン電池技術に依存しているデバイスがどれだけあるのかを彼らが認識していないことが多いということです。
クビアク氏は、現時点ではリチウムイオン技術に代わる経済的な代替手段はないと付け加えた。テクノロジー業界とパーソナルデバイス業界はテクノロジーに多額の投資を行っています。
代替手段の 1 つはナトリウム イオン電池ですが、この技術は現在消費者にとってリチウム デバイスの 2 倍のコストがかかります、とクビアク氏は言います。 「これは単なる技術的な解決策ではありません。私たちが取るべき社会的な解決策でもあります。」
同氏は、既存のテクノロジーの保護にもっと重点を置くべきだと示唆した。 「私たちは必ずしもすべての航空機からバッテリーバンクを禁止したいわけではありません。」
関連トピック
ビジネスのさらなるテクノロジー
- 7 月 3 日発行
- 6 月 12 日発行
- 6 月 26 日発行`,
    ...
    publishedAt: "2026-08-06T23:04:40+00:00",
    category: "金融政策",
