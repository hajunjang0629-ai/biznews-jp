...
Future Earth ニュースレターに登録して、BBC のジャスティン ロウラットによる気候と環境に関する最新の話題を入手してください。英国外ですか？こちらから国際ニュースレターにご登録ください。`,
  ...
  {
    id: "east-asia-braces-for-destructive-typhoon-65c5c97f",
    title: "East Asia braces for destructive typhoon as landslides kill 15 in Philippines",
    titleJa: "フィリピンで地滑りで15人死亡、東アジアは破壊的な台風に備える",
    summaryJa: "フィリピンで地滑りで15人死亡、東アジアは破壊的な台風に備える- 公開されました",
    bodyOriginal: `East Asia braces for destructive typhoon as landslides kill 15 in Philippines
- Published
...
Related topics
- Published4 days ago`,
    bodyJa: `フィリピンで地滑りで15人死亡、東アジアは破壊的な台風に備える
- 公開されました
ここ数十年で最も強い嵐の一つによって引き起こされた地滑りにより、フィリピン南部では少なくとも15人が死亡し、東アジアの一部地域では迫り来る嵐に備えている。
台風バヴィは、その幅が最も広いところで1,000キロ（620マイル）、フランスの幅にほぼ匹敵し、太平洋を台湾に向かって進んでいる。
土曜日に中国南東部に上陸する前に、台湾の北部と東部、そして一連の日本の離島に雨を降らせると予想されている。
数十の航空便がキャンセルされ、学校は地域全体で授業を中止した。台風を前に住民が物資を買いだめする中、スーパーマーケットの棚はきれいに掃除されている。
フィリピンのミンダナオ島では、地滑りによって一夜にして家族が埋もれ、救助隊が行方不明者の捜索を続けている。
当局者らによると、週末を通じて中程度から大雨が国の一部で降り続くだろう。
台湾当局は、バビでは最大1メートル（39インチ）の雨が降る可能性があると警告した。島国防省によると、救援活動のために約２万９０００人の兵士が待機している。
台湾の中央気象局はロイターに対し、バビは１９８７年以来、規模の点で同島を襲う最大の嵐となる見通しであると語った。
金曜日の早い時間から天候が続く中、この地域の農民たちは作物の収穫や保護に急ぐ一方、漁師たちは船をしっかりと固定するよう努めた。
漁師の陳明輝さん（６０）はロイターに対し、「今は穏やかで良い天気に騙されないでください。今回のような嵐は最も恐ろしいものになるかもしれません」と語った。
洪水が発生しやすい地域の住民や商店主に数千の土のうが配布された。
中国は海峡を挟んで福建省南東部に上陸した後に北上する可能性がある台風による「重大な影響」についても警告した。
「バビの規模が大きく、エネルギーが豊富であるということは、その残骸と外側の降雨帯が江蘇省と安徽省から渤海地域に向かって移動する可能性があることを意味する」と中国公共環境問題研究所のマ・ジュン所長は述べた。
同氏は、南部に比べて台風への対処の「経験が少ない」北部の州は「備えを強化する」必要があると警告した。
一部の予測では、バビが中国に2回上陸する可能性があると示唆されている。
日本でも先島諸島の住民も厳戒態勢を敷いている。オンラインで共有された写真には、自宅や店舗の窓にテープを貼り、防風ネットを掛けている人もいる。
さまざまな航空会社がこの地域でのフライトを運航停止にしています。例えば日本航空は金曜と土曜に100便以上を欠航し、2万人近くの乗客の旅行に支障をきたした。
ロイター通信によると、別の日本の航空会社である全日本空輸も日曜日までに160便以上を欠航し、約2万人に影響が出ているという。
タイ国際航空とマレーシア航空も台北発着の便を運航停止した。
中国南部の一部は、今週初めに台風メイサークがもたらした被害に今も動揺している。
メイサクでは少なくとも39人が死亡し、救助隊は依然として残骸を調べて行方不明者の捜索を続けている。広西チワン族自治区を中心に１３万人以上が避難した。
メイサクは大量の家畜を殺し、その結果、農業に大規模な損失が生じた。また、湖北省中部で珍しい竜巻が２件発生した。
関連トピック
- 4 日前に公開`,
    source: "BBC",
    sourceUrl: "https://www.bbc.co.uk/news/articles/c04y6wr03gxo?at_medium=RSS&at_campaign=rss",
    publishedAt: "2026-07-10T13:53:11+00:00",
    category: "エネルギー",
