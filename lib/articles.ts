...
ニュートン氏は目先の市場に対して依然として強気の姿勢を維持しているが、もし米国債利回りが低下しドルが再び上昇し始めれば、今月後半に上昇の勢いが失われる可能性があると警告した。ただ今のところ、韓国株とメモリー株は「短期的なリスクオン・エクスポージャーの適切な手段になりそうだ」と同氏は述べた。`,
  ...
  {
    id: "oil-rises-on-worries-over-supply-disrupt-d328e1e8",
    title: "Oil rises on worries over supply disruptions as spill near Oman worsens",
    titleJa: "オマーン近郊での流出事故悪化による供給混乱への懸念から原油高",
    summaryJa: "オマーン湾と紅海の最近の船舶への致命的な攻撃を受けて、木曜日には石油が上昇し、オマーン近郊での流出が拡大し続けたため。国際指標となるブレント原油先物（１０月渡し）は１．０１％上昇し、１バレル＝８８．０９ドルとなった。米国ウェスト・テキサス・インターミディエート先物９月限は１．１５％上昇し、１バレル＝８２．３１ドルとなった。",
    bodyOriginal: `Oil rose on Thursday recent deadly attacks on vessels in the Gulf of Oman and the Red Sea, and as a spill near Oman continued to spread.
...
Meanwhile, the International Energy Agency said Wednesday that global oil demand is set to fall further than previously expected this year, amid a deepening impact from the closure of the Strait of Hormuz.
...
"The lack of clarity over the possibility of a full reopening of the waterway could leave oil prices exposed to the upside at a time when the market remains tight," said Christopher Tahir, a senior market strategist at Exness, adding that any additional setbacks could drive oil prices further up.`,
    bodyJa: `オマーン湾と紅海の最近の船舶への致命的な攻撃を受けて、木曜日には石油が上昇し、オマーン近郊での流出が拡大し続けたため。
国際指標となるブレント原油先物（１０月渡し）は１．０１％上昇し、１バレル＝８８．０９ドルとなった。米国ウェスト・テキサス・インターミディエート先物９月限は１．１５％上昇し、１バレル＝８２．３１ドルとなった。
ロイター通信によると、オマーンの海岸線は、推定80万バレルのロシア産原油を積んで6月30日に座礁したタンカーの漏洩による大規模な原油流出の影響を受け始めており、国際制裁下にあると伝えられている。ロイター通信によると、アラビア海のザトウクジラやソコトラウなどの野生動物が生息する自然保護区付近で漏洩しているという。
一方、国際エネルギー機関は水曜日、ホルムズ海峡閉鎖の影響が深刻化する中、今年の世界の石油需要は従来の予想よりもさらに減少する見通しであると発表した。
ＩＥＡは「敵対行為の再発と海洋混乱」が世界の石油供給拡大に向けた取り組みを台無しにしていると述べた。 ７月の供給量は前年同月比日量６３０万バレル減にとどまった。
さらに、オマーン湾と紅海での船舶への致命的な攻撃により、供給混乱に対する懸念がさらに高まっています。ホルムズ海峡の再開に向けた外交努力が進行中の兆しがある一方で、5か月以上にわたる戦争によりエネルギーの流れは混乱し続けている。
エクスネスのシニア市場ストラテジスト、クリストファー・タヒル氏は「水路の全面再開の可能性が不透明なため、市場が引き締まった状態が続く中、原油価格は上昇にさらされる可能性がある」と述べ、さらなる後退があれば原油価格はさらに上昇する可能性があると付け加えた。`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/08/13/oil-spill-near-oman-worries-over-supply-.html",
    publishedAt: "2026-08-13T01:59:06+00:00",
    category: "エネルギー",
    imageUrl: "https://images.unsplash.com/photo-1473172367879-2dca04a4dca4?w=800&q=80",
    readTime: 2,
  },
  {
    id: "cisco-sees-record-results-from-an-ai-sup-ee0bbe3e",
    title: "Cisco sees record results from an AI ‘supercycle,’ but its stock pulls back",
    titleJa: "シスコ、AI「スーパーサイクル」で記録的な成果を達成、しかし株価は下落",
    summaryJa: "18% の売上高の急増と 2027 年の大暴落の予測は、シスコの株価の勢いを維持するには十分ではありませんでした。",
    bodyOriginal: `An 18% revenue surge and blowout 2027 forecast weren’t enough to sustain Cisco’s stock momentum.`,
    bodyJa: `18% の売上高の急増と 2027 年の大暴落の予測は、シスコの株価の勢いを維持するには十分ではありませんでした。`,
    source: "MarketWatch",
    sourceUrl: "https://www.marketwatch.com/story/cisco-sees-record-results-from-an-ai-supercycle-but-its-stock-pulls-back-2635b81a?mod=mw_rss_topstories",
    publishedAt: "2026-08-13T01:16:00+00:00",
    category: "テクノロジー",
    imageUrl: "https://images.mktw.net/im-55319771",
    readTime: 2,
  },
  {
  ...
  {
    id: "i-found-a-100-bill-in-the-communal-washe-dfdf07e9",
    title: "I found a $100 bill in the communal washer at my Airbnb. What should I do?",
    titleJa: "Airbnbの共同洗濯機で100ドル札を見つけました。どうすればいいですか？",
    summaryJa: "「家主は何ヶ月もここに来ていないので、前の入居者だったと思います。」",
    bodyOriginal: `“The landlord has not been here in months, so I assume it was a previous tenant.”`,
    bodyJa: `「家主は何ヶ月もここに来ていないので、前の入居者だったと思います。」`,
    source: "MarketWatch",
    sourceUrl: "https://www.marketwatch.com/story/im-dreaming-of-cocktails-at-chateau-marmont-i-found-100-in-my-airbnbs-communal-washer-what-should-i-do-9694ecca?mod=mw_rss_topstories",
    publishedAt: "2026-08-13T00:45:00+00:00",
    category: "金融政策",
    imageUrl: "https://images.mktw.net/im-43313761",
    readTime: 2,
  },
  {
    id: "inside-india-newsletter-why-global-funds-964b4c14",
    title: "Inside India newsletter: Why global funds are flocking to GIFT City in Modi’s home state",
    titleJa: "Inside India ニュースレター: なぜ世界の資金がモディ首相の故郷のギフトシティに集まるのか",
...
Need to know
The 72-hour crisis that threatened Meta's business in India
Tensions are high between Meta Platforms and Indian regulators. A parliamentary panel threatened to remove the tech giant's safe harbor protection last week, soon after after the company was pulled up over concerns about child-abuse content.
U.S. judge ends graft case against Indian billionaire Gautam Adani
A U.S. judge on Monday dismissed the bribery case against Indian billionaire Gautam Adani, while also rebuking a senior Department of Justice official's conduct related to the case as "concerning."
Coming up
...
ギフトシティとしても知られるインドのグジャラート国際金融テックシティは、中国本土にとっての香港、またはアラブ首長国連邦にとってのドバイ国際金融センターのような存在になることを目指しています。進歩は遅いものの、開始から 10 年以上が経ち、GIFT City はついに大手資産管理会社からの関心を集めています。
インド初で唯一の世界金融センターがいよいよ本領を発揮しつつあるのかどうかを知るために、私は専門家に話を聞いた。
今日のニュースレターについて何かご意見はありますか?それらをチームと共有します。
大きな話
グローバル市場に対する国内投資家の強い意欲、外貨使用に関する規制の緩和、税金の引き上げにより、立ち上げから10年以上が経った今、大手資産管理会社がインドのギフトシティに集まってきている。
専門家らによると、ナレンドラ・モディ首相の地元グジャラート州にあるギフトシティは、インドの成長機会へのアクセスを求める国際投資家や、国際的な富の解決策を求める居住インド人にとっての重要な玄関口として浮上しているという。
デロイト・インドのパートナー、ラジェシュ・ガンジー氏は、今年初めに政府はギフトシティをシンガポールなどの世界的な金融センターと同等の地位に置くために税制を改善したと述べた。
これらの税制優遇措置がインバウンド投資を促進している一方で、政府は市を通じて行われたアウトバウンド投資に対する資本規制も緩和しているとガンジー氏は述べ、彼の会社ではインド初の世界金融センターに設立されるアウトバウンドおよびインバウンドのファンドが増加していると付け加えた。
専門家らによると、世界的なファンドハウスはインド人投資家による米国などの海外市場への積もり積もった需要に目覚めており、ギフトシティは最も便利なルートを提供しているという。
世界的な関心
先週、スタンダードチャータードはギフトシティからシグネチャーCIOファンドを立ち上げる計画を発表した。
スタンダードチャータード社のウェルスソリューション、小売商品、データ、分析のグローバル責任者であるサミール・サブバーワル氏はCNBCに対し、同社は「今後数週間以内に」ファンドを立ち上げ、長期的にウェルスソリューションスイートを拡大する予定であると語った。
英国の国際銀行グループは、2020年にギフトシティで営業を開始した最初の外国銀行の1つである。また、シグネチャーCIOファンドの立ち上げにより、サブバーウォル氏が「世界で最も急速に成長している国際金融センターの1つ」と表現するこの地域でウェルスマネジメント事業を拡大する計画だ。
政府のデータによると、市内の資金管理団体は昨年11月の194社から今年5月には217社に増加した。
もう一つの世界的大手資産運用会社ブラックロックは、インドの億万長者ムケシュ・アンバニ氏のジオ・ファイナンシャル・サービスとの合弁事業を通じて、ギフト・シティから世界的なETFを立ち上げようとしている。
合弁会社の Jio BlackRock Asset Management は、5 月にギフト シティからファンドを立ち上げるための規制当局の承認を獲得しました。
同社の最高投資責任者であるリシ・コーリ氏は、アンバニ氏のリライアンス・インダストリーズが所有するネットワーク18の一部報道機関であるマネーコントロールに対し、9月末までに金融センターから2つのアウトバウンドファンド、1つは世界株式ファンド、もう1つは新興市場ファンドを開始する準備を進めていると語った。
専門家らは、強力な資本規制のため、インドの資産運用会社が海外市場に展開できる資金には制限があり、対外投資の総額上限は70億ドルで、すでに使い果たされていると指摘した。
その結果、インドの投資信託業界団体AMFIのデータによると、インド市場のパフォーマンスが世界の市場を大幅に下回っているにもかかわらず、インドの株式ファンドは65カ月連続でプラスの流入を記録した。
しかし、GIFT City で運営されているファンドには対外投資制限が適用されないため、この状況は変わる可能性があり、これらのファンドは増え続けるインドの投資家層を活用できるようになる。
先は長い
しかし専門家らは、こうした追い風にもかかわらず、ギフトシティがシンガポール、米国のデラウェア州、アラブ首長国連邦のドバイ国際金融センターなどの世界的な金融センターと競争できるようになるまでには長い道のりがあると述べた。
規制の面から見ると、ギフトシティは他の世界的な金融センターと同等だが、インド特有のセンターというイメージを払拭し、世界資本の目的地として台頭する必要がある。また、ドバイやシンガポールなどの都市に住むことで得られるライフスタイルの利点と一致する必要もあります。
開発には「もっと時間がかかる」だけだと主張する人もいる。ムンバイに本拠を置くファンド管理サービスプロバイダー、ダブテイル・キャピタルの共同創設者ヴィヴェク・シンハニア氏は、DIFCが今日の強大な企業になるまでに20年かかった、と語った。同氏はCNBCに対し、ギフトシティの規制体制は2020年頃に形成され、現在は徐々に整備されつつあると語った。
シンガニア氏は、彼の会社が米国とシンガポールに本拠を置くいくつかのファンドや、市内での事業設立に熱心なインドのファンドと協議中であると述べた。
ギフト・シティに強気な見方をしている人の中には、シュリラム・ウェルスのマネージング・ディレクター兼最高経営責任者であるヴィカス・サティヤ氏もいる。彼の会社は、インド内外の「富裕層顧客」のためにギフトシティから活動するファンドをスカウトしている。
同氏は、ギフトシティが2030年までに主要な世界金融センターになると予測し、最大の世界的ファンドハウスの1つであるブラックロックの到着は「大きな兆候」であると付け加えた。
知っておく必要がある
インドにおけるメタのビジネスを脅かした72時間の危機
メタプラットフォームとインドの規制当局の間では緊張が高まっている。議会委員会は先週、同社が児童虐待コンテンツへの懸念を理由に引き上げられた直後、同社のセーフハーバー保護を解除すると脅迫した。
米国の判事、インドの億万長者ゴータム・アダニに対する汚職訴訟を終結
米国の判事は月曜日、インドの億万長者ゴータム・アダニ氏に対する贈収賄事件を却下する一方、この事件に関連した司法省高官の行為を「懸念事項」として非難した。
もうすぐ
8月14日: 7月のインドWPIインフレ。
8月17日: インドの7月の失業率。`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/08/13/global-funds-blackrock-modi-gift-city.html",
    publishedAt: "2026-08-13T00:15:59+00:00",
    category: "金融政策",
    imageUrl: "https://images.unsplash.com/photo-1611974789855-9c2a0a7236a3?w=800&q=80",
    readTime: 7,
  },
  {
    id: "cerebras-stock-plunges-14-after-second-e-5022e2af",
    title: "Cerebras stock plunges 14% after second earnings report following IPO",
    titleJa: "IPO後の2回目の決算報告を受け、セレブラス株は14％急落",
    summaryJa: "Cerebras Systems は、5 月の新規株式公開後の第 2 回決算報告で通期見通しを引き上げました。しかし、株価は延長取引で約１４％下落した。第 2 四半期の業績と LSEG のコンセンサス予測は次のとおりです。",
    bodyOriginal: `Cerebras Systems raised its full-year guidance in the second earnings report following the chipmaker's initial public offering in May. But the stock tumbled about 14% in extended trading.
...
WATCH: Cerebras sees OpenAI's chip competing with other GPUs`,
    bodyJa: `Cerebras Systems は、5 月の新規株式公開後の第 2 回決算報告で通期見通しを引き上げました。しかし、株価は延長取引で約１４％下落した。
第 2 四半期の業績と LSEG のコンセンサス予測は次のとおりです。
- 収益: 1 億 8,000 万ドル、予想 1 億 9,400 万ドル
- 1 株当たりの損失: 調整後 5 セント、予想 17 セント
セレブラスは水曜日の声明で、今四半期の中核収益は２億１４００万─２億１６００万ドルになると予想していると述べた。
同社は通期の見通しを引き上げ、コア収益は従来の8億5,500万ドルから8億6,500万ドルの範囲から8億8,000万ドルから8億9,000万ドルになると予想している。
第 2 四半期の 1 億 8,000 万ドルの売上高は、総収益を表します。 Cerebras はまた、「パススルー収益」を含むコア収益額が 2 億 1,000 万ドルであると報告しました。
同社は前年同期に3億950万ドル（1株当たり1.91ドル）の利益を計上した後、4億5050万ドルの純損失を記録した。損失の大半は株式補償費用３億８６６０万ドルに関係している。
セレブラスの最高経営責任者（CEO）アンドリュー・フェルドマン氏はインタビューで、AIの需要は「天井知らず」であり、企業は同社の専門推論チップに資金を支払っていると語った。
Cerebras は、一部の AI タスク、特に「低レイテンシー」または対話性のための素早い応答を必要とするタスクに関して、AI チップのリーダーである Nvidia に挑戦しています。同社はこれを「高速推論」と呼んでいる。同社は、今四半期の中核粗利益率が38％から40％に拡大すると述べ、投資家の懸念に対処した。
フェルドマン氏はインタビューで「高速推論にはプレミアム価格が設定されているため、粗利益率は良好であり、伸びている」と述べ、セレブラス社は自社システムのAI出力を高めることができたと付け加えた。
セレブラスはAIモデルを実行できる半導体に対する投資家の関心を利用して5月にナスダックに上場した。公募価格は185ドルで、公募で64億ドルを調達した。株価は5月に最高値を付け、その後下落したが、水曜日の終値はIPO比42％高の262.06ドルだった。
同社は254億ドルの履行義務を残しているが、これは「将来の異常な需要」の兆しであると同社は述べた。フェルドマン氏は、セレブラスが成長するにつれ、規模が大きくなることで恩恵を受けるだろうと述べた。同社は来年度の売上高が3倍になるとの見通しも示した。
「私たちはより効率的に製造します。部品の価格も安くなります。製造組織をより多くのユニットで償却します」とフェルドマン氏は語った。 「それらはすべて上と右を向いています。」
ここ数週間、Cerebras は Nvidia のライバルである Advanced Micro Devices との提携を発表し、今年後半に製品の生産が開始され、OpenAI は同社のチップを使用して最新モデル GPT 5.6 Sol を提供できると述べました。 Cerebras はクラウド経由でチップへのアクセスも提供しており、6 月四半期の収益は 1 億 2,600 万ドルと報告されています。
注目: Cerebras は OpenAI のチップが他の GPU と競合していると見ている`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/08/12/cerebras-cbrs-q2-earnings-report-2026.html",
    publishedAt: "2026-08-12T23:49:23+00:00",
    category: "テクノロジー",
    imageUrl: "https://images.unsplash.com/photo-1518770660439-4636190af475?w=800&q=80",
    readTime: 4,
  },
  {
    id: "why-japanese-firms-are-being-so-slow-to-9eeca766",
    title: "Why Japanese firms are being so slow to use AI",
    titleJa: "日本企業のAI活用が遅れている理由",
    summaryJa: "日本企業のAI活用が遅れている理由- 公開されました",
    bodyOriginal: `Why Japanese firms are being so slow to use AI
- Published
...
Disruption may be a dirty word in Japan, but without it the productivity gains the country needs could remain elusive.`,
    bodyJa: `日本企業のAI活用が遅れている理由
- 公開されました
深刻な労働力不足、人口の高齢化、慢性的な生産性の問題に直面している日本企業は、人工知能（AI）を導入するための肥沃な土壌となるはずです。しかし、米国や英国と比較すると、多くの職場での導入は依然として鈍く、慎重です。
AIに対する日本の対応は、ゆっくりとした動きの伝統的な能劇に似てきている。
ステージ上の仮面をかぶった登場人物全員が行動が緊急であることに同意し、厳粛な同意のもとに呼びかけが繰り返される。それでも俳優たちはその場に固まったままだ。
ドラマを盛り上げるには素晴らしいが、この国の当面の困難に対処するには最悪だ。
職場での AI の使用を示すデータは、日本が遅れをとっていることを示唆しています。経済協力開発機構（OECD）が昨年末発表した外部報告書によると、仕事の一部としてAIを利用している日本の労働者はわずか8.4％だという。
対照的に、別の統計によると、米国の対外利用率は 50%、英国は 32% となっています。外部からの AI の導入率はアラブ首長国連邦に次いで 2 番目に高く、アジアでは最も多いと言われているシンガポールでは、労働者の 56% が AI を「週に複数回」使用していると言われています。
米国と日本、異例の共同行動で円を下支えする措置を講じる
- 8 月 3 日発行
では、なぜ日本は足を引っ張っているのでしょうか？米国の新興企業Kuse AIの共同創設者であるオースティン・シュー氏は、その原因は日本企業が保守的でリスク回避的であるためだと語る。彼のビジネスは最近、自社の AI システムを日本の企業に販売するために日本に事務所を設立しました。
「プロセスとコンセンサスの文化が本当に物事を遅らせている組織があります」と彼は言います。 「特にクライアントが直面するあらゆる分野において、AI のミスに対する許容度はゼロに近い。機械に任せるよりも、役割を満たさないままにしておくことを好む人もいる。」
Xu氏は、米国の状況は大きく異なり、一部の企業ではすでにAIエージェントにはるかに自由に生産性を向上させることを許可していると述べた。 「米国では、AI の同僚がヘルパーとして入ってきて、徐々にワークフローの一部になっていきます。[米国の上司の] 態度は、多くの場合、試してみてから修正するというものです。」
同氏は、日本企業がAIを十分に信頼して使用する前に、より多くの証拠が必要だと付け加えた。
京都先端科学大学の国際経営学教授パリサ・ハギリアン氏も、多くの日本企業はリスクをあまりにも回避しすぎてAIに注目できないことに同意する。
「AIを導入する際の課題は、日本企業に何らかの変化を導入する場合と同じです。これが、AIの使用が、特に職場において依然としてかなり限定的で慎重である理由です。」
ハギリアン氏はまた、これを米国のより起業家精神に富んだ文化と対比し、日本企業は誤り、不確実性、風評リスクに対して非常に敏感であると主張した。
「生成型 AI はまだ完全に信頼できるわけではないため、（日本では）主に執筆、要約、情報収集などのリスクの低いタスクに使用されていますが、中核的な業務や意思決定、プロセス全体の改善にはあまり使用されていません」と彼女は言います。
日本の医療分野はAIへの取り組みが特に遅れていると言われており、病院によっては患者ファイルを完全にデジタル化さえしていないところもある。 「紙の文書は驚くべき規模で蓄積されている」と日本の病院の職員の一人は匿名を条件に語る。 「石器時代のようだ。」
日本政府はAIの導入率が低いという広範な問題を認識しており、より多くの企業にこのテクノロジーを導入してもらおうとしている。昨年、同国の議会の外で AI 推進法が可決されました。
これは、軽い規制を利用して企業の AI への投資を促進することを目的としています。東京都は、日本が「世界で最もAIの開発と活用に優しい国」となることを約束する。
政府は、AIの利用拡大が日本の生産性向上に役立つと考えている。現在も先進国G7の中で最悪の水準が続いている。
日本の財務省は、企業による AI の導入はすでに大幅に増加しており、現在では 75% の企業がこのテクノロジーを使用しており、5 年前の 11% から増加していると述べています。
しかし、批評家たちは、これらの各企業で実際に AI を使用しているスタッフはほんの一部であり、使用しているスタッフも非常に限られた範囲でしか使用していない、と主張しています。
日本の社会システムとテクノロジーの専門家である明治大学の小笠原泰教授は、労働力の中でテクノロジーに精通した人材が十分ではないと言う。
Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.`,
    source: "BBC",
    sourceUrl: "https://www.bbc.co.uk/news/articles/cwymw4434v7o?at_medium=RSS&at_campaign=rss",
    publishedAt: "2026-08-12T23:00:47+00:00",
    category: "テクノロジー",
    imageUrl: "https://ichef.bbci.co.uk/ace/standard/240/cpsprodpb/6ede/live/9f7531a0-8f41-11f1-8c3d-6f698d2b4d1e.jpg",
    readTime: 5,
  },
  {
    id: "trump-says-karoline-leavitt-resigning-as-2f5f78bd",
    title: "Trump says Karoline Leavitt resigning as White House press secretary",
    titleJa: "トランプ大統領、キャロライン・レビット氏がホワイトハウス報道官を辞任と発言",
    summaryJa: "ドナルド・トランプ大統領は水曜日、キャロライン・レビット大統領報道官が8月末までにそのポストを離れると発表した。レビット氏の辞任は、5月1日の娘の誕生に伴い産休を経てホワイトハウスに復帰してから1カ月も経たないうちに発表された。",
    bodyOriginal: `White House Press Secretary Karoline Leavitt will leave that post by the end of August, President Donald Trump said on Wednesday.
Leavitt's departure was announced less than a month after she returned to the White House after having been on maternity leave for the birth of her daughter on May 1.
Leavitt, 28, is resigning "so she can spend more time with her beautiful young children and family, a decision I totally understand and respect!" Trump said in a Truth Social post announcing her planned departure.
The president said that Leavitt will become "one of my top outside advisors" and work with the Republican Party to win the upcoming midterm elections in November.
Leavitt, who has served as White House press secretary since Trump returned to the White House in January 2025, has two young children with her husband, real estate developer Nicholas Riccio.
She gave birth to her daughter, Viviana, on May 1, days after going on maternity leave.
Leavitt returned to the White House for a press briefing on July 16.
In a post on X on Wednesday, Leavitt said, "Being a mother and welcoming a new baby while working in one of the most demanding jobs in the world has been the most rewarding yet challenging season of my life, to say the least."
...
Trump had four White House press secretaries during his first term, from January 2017 to January 2021.
— CNBC's Ryan Ruggiero contributed to this article`,
    bodyJa: `ドナルド・トランプ大統領は水曜日、キャロライン・レビット大統領報道官が8月末までにそのポストを離れると発表した。
レビット氏の辞任は、5月1日の娘の誕生に伴い産休を経てホワイトハウスに復帰してから1カ月も経たないうちに発表された。
28歳のリービット氏は「美しい幼い子供たちや家族とより多くの時間を過ごすため、その決断を私は完全に理解し、尊重します！」と辞任する。トランプ大統領は、辞任計画を発表する真実ソーシャルへの投稿でこう述べた。
大統領は、レビット氏が「私の最高の外部顧問の一人」となり、11月に予定される中間選挙での勝利に向けて共和党と協力すると述べた。
2025年1月にトランプ大統領がホワイトハウスに復帰して以来、ホワイトハウス報道官を務めているレビット氏には、不動産開発業者の夫ニコラス・リッチョ氏との間に2人の幼い子供がいる。
彼女は産休に入った数日後の5月1日に娘のヴィヴィアナを出産した。
レビット氏は7月16日に記者会見のためホワイトハウスに戻った。
水曜日のX誌への投稿で、レビットさんは「世界で最も厳しい仕事の一つに就きながら母親となり、生まれたばかりの赤ちゃんを迎えることは、控えめに言っても私の人生で最もやりがいのある、しかし挑戦的な季節だった」と述べた。
「実のところ、娘の出産後にホワイトハウスに戻って以来、私はホワイトハウス報道官に求められる絶え間ない時間、エネルギー、配慮を費やしながら、幼い二人の子供たちにとってふさわしい最高の母親にはなれない、と心の中で感じてきたのです。だからこそ私は最終的にホワイトハウスを去り、人生の新たな章に乗り出すという苦い決断を下したのです」と彼女は書いた。
レビット氏はホワイトハウス報道官としては史上最年少である。
トランプ大統領の1期目（2017年1月から2021年1月）には4人のホワイトハウス報道官がいた。
— CNBC の Ryan Ruggiero がこの記事に寄稿しました`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/08/12/trump-white-house-karoline-leavitt-resigning-.html",
    publishedAt: "2026-08-12T22:08:51+00:00",
    category: "エネルギー",
    imageUrl: "https://images.unsplash.com/photo-1473172367879-2dca04a4dca4?w=800&q=80",
    readTime: 2,
  },
