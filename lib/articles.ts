...
"When we challenged it hard, at least it was honest," Churchman said. "It was like, 'Look, in the end, I'm better at sounding thorough than being thorough.'"`,
  ...
  {
    id: "u-s-trade-rep-greer-blames-canada-for-fa-e55242c8",
    title: "U.S. Trade Rep Greer blames Canada for failed tariff talks: 'They wanted more'",
    titleJa: "グリア米通商代表、関税交渉の失敗についてカナダを非難「彼らはもっと欲しかった」",
    summaryJa: "Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.",
    bodyOriginal: `U.S. Trade Representative Jamieson Greer on Monday said Canada was responsible for the collapse of trade-deal negotiations last week, telling CNBC that Ottawa changed its demands at the eleventh hour.
...
Greer spoke to CNBC three days after Canadian negotiators left Washington without a deal to prevent President Donald Trump from enacting new 50% tariffs on about $20 billion worth of goods, including imports of wine, hockey sticks, cement and other goods.
Those duties took effect at 12:01 a.m. ET on Saturday, stoking alarm from business groups in the U.S. and Canada alike who warn that they could raise costs and wreak havoc on exposed industries.
This is breaking news. Please refresh for updates.`,
    bodyJa: `Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/08/24/trump-canada-trade-tariffs-greer.html",
    publishedAt: "2026-08-24T12:59:00+00:00",
    category: "貿易",
    imageUrl: "https://images.unsplash.com/photo-1526304640581-d334cdbbf45e?w=800&q=80",
    readTime: 2,
  },
  {
    id: "they-asked-too-much-canadian-dollar-sli-ca2f3af2",
    title: "'They asked too much': Canadian dollar slides as Ottawa and Washington head for all-out trade war",
    titleJa: "「彼らは要求しすぎた」：オタワとワシントンが全面貿易戦争に向かう中、カナダドルは下落",
    summaryJa: "Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.",
    bodyOriginal: `The Canadian dollar fell on Monday morning after trade talks between Ottawa and Washington fell apart, leaving both sides facing higher prices on a wide array of imported goods and threatening Canada's economic growth.
...
Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/08/24/canada-us-trade-war-deal.html",
    publishedAt: "2026-08-24T12:56:17+00:00",
    category: "エネルギー",
    imageUrl: "https://images.unsplash.com/photo-1473172367879-2dca04a4dca4?w=800&q=80",
    readTime: 2,
  },
  {
    id: "bessent-could-tap-near-1-trillion-treasu-5d2eda27",
    title: "Bessent could tap near $1 trillion Treasury General Account to fund bond buybacks, sources said",
    titleJa: "Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.",
    summaryJa: "Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.",
    bodyOriginal: `The Treasury could use its near $1 trillion General Account to help fund its recently announced plans to increase purchases of government bonds, according to two senior Treasury officials.
...
He said he expected progress in the deficit when tariff revenue returns after court-mandated refunds are replaced by new tariffs. And he said that top officials would be meeting soon to forge plans that would improve the fiscal situation.`,
    bodyJa: `財務省高官２人によると、財務省は最近発表した国債買い入れ増額計画の資金調達に１兆ドル近い一般会計を活用する可能性がある。
TGAを活用すれば、財務省は長期債利回りに影響を与える大きな力を得ることができるだろう。財務省は先週、長期でのオフザラン証券の買い戻し規模を20億ドルから少なくとも40億ドルに倍増すると発表し、市場を驚かせた。スコット・ベッセント財務長官はＣＮＢＣで、こうしたオペは新たな上限よりもさらに大規模になる可能性があると述べた。
しかし、財務省は購入資金をどのように賄うかについては言及しなかった。ほとんどの市場参加者は、短期証券の売却によってそうなると予想していた。財務省高官らはその可能性を排除しなかった。ベッセン氏はCNBCのインタビューで、このオペを「財務ツイスト」と呼び、長期国債を買い取って短期発行で支払う政府や連邦準備理事会のオペに言及した。これは短期債が売却されることも示唆した。
しかし、このサプライズ発表以来、債券価格は当初の上昇から後退し、利回りが上昇している。これは、このオペがどれほど効果的か、また財務省の資金が限られすぎているのではないかと多くの市場アナリストが懐疑的な声を上げていることも一因だ。
TGA を使用すると、その認識が変わる可能性があります。 TGAは本質的には政府の当座預金口座であり、連邦準備制度が保有するある種の緊急資金である。その資金はすでに既存の税金徴収によって賄われています。ベッセント氏はTGAを現在約9,500億ドルまで積み上げているが、バイデン政権下での目標目標は約5,500億～6,000億ドルとなっている。
関係者らは、TGAが使用されるとしても、どれくらいの量が使用されるのか、またそのような発表がいつ行われるのかについては明らかにしていない。先週の発表の焦点だったオフ・ザ・ラン証券の購入以外に使用できるという意味合いはなかった。
しかし、それが利用可能であると考えられていることは明らかでした。
FRBの助けは必要ない
TGA のサイズは任意です。ジャネット・イエレン氏が財務省を運営していたとき、当局者らはTGAを「現金需要より1週間前」に設定することが目標だったと述べた。現在の財務省は、この口座を「財務省の長年にわたる現金残高政策と一致する」ものに設定していると述べている。仮にそのいずれかが使用され、ベッセント財務省が1兆ドル近い水準を維持したいと考えた場合、それを取り戻すために追加の債券を売却する必要があるだろう。
しかし、それをいくらか低く設定しても、差し迫ったリスクは生じないようだ。 TGAの削減は、新たな債務上限に行き詰まった場合に政府の手元資金が減少することを意味する。しかし、最新の予測では、新たな制限に達するのは来年の冬、おそらくは春先までではないだろう。そうすれば、必要に応じてバックアップを構築する時間が得られます。一方、債券利回りは、TGAのわずかな利用や、財務省が国債購入にTGAを利用するという認識だけでも影響を受ける可能性がある。
また、一部の債券市場参加者からも表明されている、FRBがこうした業務において財務省の支援を求められる可能性があるという懸念も抑制されるだろう。 （FRBはTGAを銀行と同様に保有していますが、金融政策ツールキットの一部とは考えていません。）
財務省当局者らは、財務省が突然の発表で、債券販売について「定期的かつ予測可能」とする長年の慣行を放棄し、市場を欺いているのではないかとの批判を押し返した。自社株買い強化の発表は、通常であればこうした情報が市場に伝えられる四半期払い戻しの発表から２週間後に行われた。
しかし高官らは、実際の公式オークションのスケジュールには変更はなかったと述べた。また、この発表は9月9日に最初のオペが行われる約3週間前に行われたため、市場に準備する時間が与えられたと付け加えた。財務省は8月19日の発表で四半期全体の計画も発表した。
また、第１回入札は９月９日まで予定されていないため、市場への影響を判断するには時期尚早だと付け加えた。
ベッセント氏は先週CNBCに対し、財務省の意図は市場に「ファンダメンタルズに集中させ、市場が低迷している閑散期にはヘッドラインを取引しないようにすることだった。そのため、我々は市場の均衡を保とうとしている」と語った。
Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/08/24/bessent-1-trillion-treasury-general-account-bond-buybacks.html",
    publishedAt: "2026-08-24T12:42:46+00:00",
    category: "金融政策",
    imageUrl: "https://images.unsplash.com/photo-1611974789855-9c2a0a7236a3?w=800&q=80",
    readTime: 5,
  },
  {
    id: "trump-media-ceo-defends-selling-faster-a-791f886b",
    title: "Trump Media CEO defends selling faster access to president's Truth Social posts, says more have signed up",
    titleJa: "Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.",
    summaryJa: "トランプ・メディア暫定最高経営責任者（CEO）ケビン・マクガーン氏は、ドナルド・トランプ大統領の真実ソーシャル投稿へのより迅速なアクセスを提供する同社を擁護した。",
    bodyOriginal: `Trump Media interim CEO Kevin McGurn on Monday defended his company offering faster access to President Donald Trump's Truth Social posts, and said more customers have signed up for the pricey and controversial service.
...
This is breaking news. Please check back for updates.`,
    bodyJa: `Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/08/24/trump-media-ceo-truth-api.html",
    publishedAt: "2026-08-24T12:35:50+00:00",
    category: "貿易",
    imageUrl: "https://images.unsplash.com/photo-1526304640581-d334cdbbf45e?w=800&q=80",
    readTime: 2,
  },
  {
    id: "santoli-why-all-the-fuss-about-bond-yiel-ebe60dc8",
    title: "Santoli: Why all the fuss about bond yields is happening now",
    titleJa: "Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.",
    summaryJa: "Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.投資家にとって、借り手のハードルレートを上げるのと同じように、国債に埋め込まれた実質利回りが増大することは、債務の所有者に支払われる補償を意味する。したがって、株式の多様化手段としての債券の役割に従来の通念が反するのと同じように、債券には価値が蓄積されているのだろうか？",
...
SUBSCRIBE TO MIKE SANTOLI'S MARKET MEMO HERE`,
    bodyJa: `Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.
投資家にとって、借り手のハードルレートを上げるのと同じように、国債に埋め込まれた実質利回りが増大することは、債務の所有者に支払われる補償を意味する。したがって、株式の多様化手段としての債券の役割に従来の通念が反するのと同じように、債券には価値が蓄積されているのだろうか？
アイアンサイズ・マクロエコノミクスのバリー・ナップ氏は、最近の利回り上昇はインフレや雇用統計の鈍化、消費者統計のばらつきに直面して起きたと指摘し、「われわれは引き続き長期債弱気派であり、財務長官の行動が大きなプラスの触媒とは考えていないが、長期債（国債）には逆トレンド上昇の余地があると依然として考えている」と述べた。
先週、債券市場が話題を独占したため、S&P 500は1.4％下落した。株式投資家は、債券市場が官民セクターへの利回り向上を通じて資本を配分することに注目している。株式関係者が最も懸念しているのは、貪欲な消費とAI向けの資本の無謀な展開であり、現在は金利を押し上げ、他の分野の成長を潜在的に抑制している。
半導体株は5％以上下落し、市場の時計仕掛けの回転に多少のズレがあったものの、その反発反発は「論理的な」抵抗水準で止まった。銀行は米国債市場の混乱を好まず、４％下落した。シャドウ AI の高価な銘柄であるインダストリアル株は 3% 以上下落しました。 S&P 500 自体は、5 月から 7 月にかけて維持されていた過去の複数か月レンジの上限に向けて後退し、その後小幅に反発しました。
現在ベンシナー・インベストメント・ストラテジーズのベテランマクロ・テクニカルストラテジストであるリック・ベンシナー氏はテープを読み上げ、テクノロジーは相対的にピークに達し、ヘルスケアと金融はより良い立場にあると述べた。同氏は、この動きの中でいくつかの技術的な警告を察知した。「S&P 500は、過去13セッションのうち10セッションが『閉じた』ローソク足で示されており、8月4日の上値ブレイクアウト日以降に実際に機関投資家が売りを出していることを示唆している。もしエヌビディアが（水曜日の結果で）新たな材料の買いをもたらさなければ、私は本当に警戒旗を掲げることになる。」
市場温度計
マクロ リスク アドバイザーズのジョン コロボス氏によるこの指標は、投資家の発言と行動の両方を反映するためにいくつかのデータ ポイントを使用しています。
コロヴォス氏は最新のデータについて「センチメントの急上昇が、今週の株価下落を部分的に説明している。懸念されるのは、インプライド・ボラティリティの低水準が続いている一方、センチメント調査では強気の回答が増え始めていることだ。私は市場に対して強気の予測をしているにもかかわらず、保険として戦術的なVIXコール・スプレッドを提唱してきた。」と述べた。
ストリートの周り
— アダム・スミスの下で出版した作家による『ザ・マネー・ゲーム』は、これまでに紙化されたウォール街の最高の年代記の一つとして正当に評価されている。 1968 年に登場したこの製品は、メインフレーム コンピューター (および宇宙および防衛技術) が刺激的な想像力を持ち、評価をつり上げていた、市場における以前のテクノロジー ブームの時代を捉えています。
大手ハードウェアメーカーによる顧客の技術購入に対する今日の「循環融資」に関する議論は、白髪交じりの退役軍人が「子供」投資家にどうやって半年で100倍の利益を上げたかを尋ねるこの逸話に反響がある。
「コンピューターリース株ですよ、先生！」彼はまるで上級生に質問される士官候補生のように言った。 「コンピューターの必要性は事実上無限です」とビリー・ザ・キッドは言いました。 「リースがそれらを販売する唯一の方法であることが証明されており、コンピュータ会社自体には資本がない。したがって、今年の利益は100％増加し、来年は2倍、再来年はさらに2倍になるだろう。まだ表面はかろうじて表面をなぞったばかりだ。上昇はまだ始まったばかりだ。」
— ウォール・ストリート・ジャーナルは、生き生きとした生涯を送り、今月初めに亡くなった悪名高きトレーダー、ヴィクター・ニーダーホッファーの魅力的な死亡記事を報じた。
私が本誌にコラムを書いているとき、ニーダーホッファーは時々私にメールを送ってきて、たいてい私の記事の一つが私が「ほぼ理解している」ことを示唆するような恩着せがましい裏返しの褒め言葉を送ってきた。
彼の最も痛烈な軽蔑は、私の当時の同僚、アラン・エイベルソンに対するものであった。彼は長年主席コラムニストを務め、聡明で文才があり、粘り強い弱気な態度で知られる元バロンズ編集者だった。ヴィックはアランを「神を信じない司祭、株式市場を嫌う株式市場ライター」に例えた。
ヴィックは決して市場を憎んだことはありませんでしたが、市場が常に彼を愛し返してくれたわけではありません。彼は 2 つの財産を築き、また失い、市場が崩壊する前にボラティリティを効果的に空売りして爆破しました。
市場はクローズ
ここ数四半期、利益の伸びが株価の上昇を上回っていることから、安易な方法で行われた評価圧縮を称賛する強気の声が許容されている。
これは、過去 10 か月で 23 倍から 20 倍に低下した標準株価収益率に注目すると当てはまります。しかし、ご存知のとおり、最大の稼ぎ手は AI の増強に資金を提供するために猛烈な勢いで再投資しています。現在、メモリチップやガスタービンと並んで不足しているのは、フリーキャッシュフローだ。
ここでは、予測FCFを使用したS&P 500の株価対フリーキャッシュフロー比率が30をわずかに下回っており、数十年ぶりの高水準となっている。
これを別の言い方で表現すると、10年国債のフリーキャッシュフロー利回りが4.74%であるのに対し、株式のフリーキャッシュフロー利回りは3.4%です。
もちろん、企業のキャッシュバーンは主に選択だが、大手ハイテクプラットフォームは、超知性を目指す軍備競争に参加するためのもっともらしい選択肢を見ているかのように振る舞っているわけではない。あるいは、少なくとも、シリコンから新たな集合意識を創造しようとする人々に貸すのに十分なデータセンターの容量を確保するためだ。
ここからマイク・サントリのマーケットメモを購読してください`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/08/24/why-all-the-fuss-about-bond-yields-is-happening-now.html",
    publishedAt: "2026-08-24T12:31:13+00:00",
    category: "エネルギー",
    imageUrl: "https://images.unsplash.com/photo-1473172367879-2dca04a4dca4?w=800&q=80",
    readTime: 7,
  },
  {
    id: "ups-is-investing-2-billion-in-internatio-bad69617",
    title: "UPS is investing $2 billion in international, healthcare and supply chain businesses",
    titleJa: "UPSは国際、ヘルスケア、サプライチェーン事業に20億ドルを投資",
    summaryJa: "Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.",
    bodyOriginal: `United Parcel Service is investing more than $2 billion into its business across its international, healthcare and supply chain solutions businesses, the company told CNBC exclusively on Monday.
...
"We're investing to give them tailored capabilities aligned to the needs of their specific industries that cover the markets they're increasingly sourcing from and distributing to, and do it in a way that they can make commitments to their customers," Szwast said.`,
    bodyJa: `Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/08/24/ups-global-logistics-investment.html",
    publishedAt: "2026-08-24T11:00:01+00:00",
    category: "テクノロジー",
    imageUrl: "https://images.unsplash.com/photo-1518770660439-4636190af475?w=800&q=80",
    readTime: 2,
  },
  {
    id: "graduate-job-vacancies-drop-by-almost-50-afa3dd0e",
    title: "Graduate job vacancies drop by almost 50% in a year, survey suggests",
    titleJa: "Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.",
    summaryJa: "Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.",
    bodyOriginal: `Graduate job vacancies drop by almost 50% in a year, survey suggests
- Published
...
Are you looking for work?`,
    ...
    publishedAt: "2026-08-24T10:55:47+00:00",
    category: "金融政策",
    imageUrl: "https://ichef.bbci.co.uk/ace/standard/240/cpsprodpb/7356/live/324f6630-9fb4-11f1-aed2-8d6da8d75094.jpg",
    readTime: 2,
  },
  {
    id: "iran-faces-greatest-financial-offensive-432862cf",
    title: "Iran faces 'greatest financial offensive ever', says US treasury secretary",
    titleJa: "Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.",
    summaryJa: "Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.",
    bodyOriginal: `Iran faces 'greatest financial offensive ever', says US treasury secretary
- Published
