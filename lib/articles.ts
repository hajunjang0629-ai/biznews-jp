...
Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.`,
  ...
  {
    id: "china-hits-out-at-illegal-new-us-sanctio-1394814e",
    title: "China hits out at 'illegal' new US sanctions on Iran and trading partners",
    titleJa: "Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.",
    summaryJa: "Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.",
    bodyOriginal: `China hits out at 'illegal' new US sanctions on Iran and trading partners
- Published
...
UK Chancellor John Healey said the British government supported "US work to secure a diplomatic solution and welcome efforts to increase pressure".
...
Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.`,
    ...
    publishedAt: "2026-08-25T11:53:36+00:00",
    category: "エネルギー",
...
トランプ政権は今年4月、イランの軍事作戦がイラン政権の降伏を引き起こしたわけではないことが明らかになった後、イランと取引のある外国銀行や企業に対する一連の制裁を開始した。`,
  ...
  },
  {
    ...
    summaryJa: "バーナム氏、秋予算での増税の可能性を排除せず- 公開されました",
    bodyOriginal: `Burnham refuses to rule out tax rises in autumn Budget
- Published
...
- Published12 August
- Published12 August`,
    bodyJa: `バーナム氏、秋予算での増税の可能性を排除せず
- 公開されました
アンディ・バーナム氏は、財政の「困難な」状況について「非現実的ではない」と述べ、次期秋予算での増税の可能性を排除することを拒否した。
首相は経済に対して「慎重なアプローチ」を取ると述べ、以前に発表した生活費の公約は財源を充てた支出の公約であると擁護した。
バーナム氏は7月に首相に就任し、人々に息抜きのスペースを与え、生活費を援助すると約束したが、社会保障改革などの主要政策にどのように資金が投入されるのかについては疑問が残っている。
専門家らは以前、同首相とジョン・ヒーリー首相が10月28日の最初の予算案で財政的に機動できる余地はほとんどないと警告していた。
バーナム氏は初のウクライナ訪問中に講演し、バス運賃の上限2ポンドや家庭用電気代の付加価値税引き下げなど、これまでに発表された政策は「実行可能だと感じた最初の一歩」であり、他国からの資金の優先順位を再設定できたため実行可能だったと述べた。
同氏はITVとのインタビューで、「デジタルIDは現時点では最優先事項ではないと早い段階で判断した。そのため、資金調達の優先順位を他の優先事項に変更した」と述べた。
バーナム氏は、新たな政策の一部は増税で賄わなければならないことを国民が受け入れる必要があるかとの質問に対し、必ずしも受け入れる必要はない、と述べた。
歳出不足を補うために増税が必要かどうかについては、「私は常に慎重に物事に取り組むつもりだ。私はグレーター・マンチェスターを10年間経営してきたが、我々は盤石な財政で非常にタイトな船を経営していた」と語った。
「私が首相としてこの役割に就いても何も変わりません。私は人々の仕事、生計、家計に関してリスクを負いません。
「私はできる限りの方法で彼らを助けようとします。私はすでに彼らを助けるためにいくつかのことをしました。」
バーナム氏は以前BBCに対し、生活費対策だけでは十分ではないとの初期の発表を受け入れ、さらなる支援を示唆したと語った。
月曜日の初の海外公式訪問で演説した同氏は、できる限りのことを行うとしながらも、「非現実的なことはしないし、人々はそれを本当に理解する必要がある」と述べた。
「私たちは難しい立場にいます。私が何をするにしても慎重に検討され、資金も提供され、秋に向けてさらに多くのことが起こるでしょう。」
先週の公式統計は、所得税収入が記録的な月となったにもかかわらず、政府が７月に予想を上回る借入を行ったことを示した。
インフレ率も7月には2.9％と4カ月ぶりの高水準に達しており、エネルギー価格や燃料費に打撃を与えているイラン戦争の影響が続いているため、さらに上昇すると予想されている。
専門家らはバーナム氏とヒーリー氏に、財政への圧力により追加借入の余地がなくなったため、増税するか他の支出を削減する必要があると警告している。
首相も首相も、レイチェル・リーブス前首相が定めた財政ルールを堅持すると誓った。
この規則は、議会終了までに日々の支出が税収によって確実に賄われ、GDPに占める債務を削減することを目的としている。
英国産業連盟のレイン・ニュートン・スミス最高経営責任者（CEO）は、経営者らは若者に機会を創出したいと考えているが、「人材の雇用コストが大幅に上昇している」と述べた。
「私が話を聞いたビジネスリーダーたちは、事業コストが上がりすぎて機会を生み出すことが妨げられていると言っています」と彼女はトゥデイ番組で語った。
同氏は、企業への的を絞った支援が「さらなる成長とより多くの機会を生み出し、政府の資金を節約し、最終的には税収の増加につながる」と述べた。
連絡する
...
- 8 月 12 日発行`,
    ...
    publishedAt: "2026-08-25T06:40:33+00:00",
    category: "エネルギー",
    imageUrl: "https://ichef.bbci.co.uk/ace/standard/240/cpsprodpb/3751/live/52c34ac0-a00f-11f1-a0ad-6fe9db05b013.jpg",
    readTime: 4,
  },
  {
    id: "trump-targets-iran-s-trade-lifelines-her-1795f5e6",
    title: "Trump targets Iran’s trade lifelines — here are the countries most exposed",
    titleJa: "トランプ大統領、イランの貿易ライフラインを標的に - 最も危険にさらされている国は次のとおり",
    summaryJa: "米国は月曜日、イランを世界経済から孤立させるための「経済Dデー」キャンペーンを発表し、イランとの取引を続ける「イネーブラー」に対する罰則を脅迫した。この動きは、約6か月にわたる戦争を通じてテヘラン経済を支えてきた貿易のライフラインを切断するというワシントンの取り組みの一環である。",
    bodyOriginal: `The U.S. announced an "economic D-Day" campaign Monday to isolate Iran from the global economy, threatening penalties against "enablers" that continue doing business with Tehran.
...
But those trades now will be tested if Washington makes good on its threat to sanction any entity, including Indian refiners, that have procured Iranian energy.`,
    bodyJa: `米国は月曜日、イランを世界経済から孤立させるための「経済Dデー」キャンペーンを発表し、イランとの取引を続ける「イネーブラー」に対する罰則を脅迫した。
この動きは、約6か月にわたる戦争を通じてテヘラン経済を支えてきた貿易のライフラインを切断するというワシントンの取り組みの一環である。
施行の詳細は不透明だが、この脅威により米国はイランの一部の主要貿易相手国と衝突する可能性がある。
中国
米国政府によると、中国はイラン石油の最大の買い手であり、イラン石油輸出の約90％を占め、テヘランにとって世界経済への重要なつながりとなっている。
米中経済安全保障検討委員会によると、中国は2025年のイランとの二国間貿易額が99億6000万ドルと報告したが、これを除く同年の未報告のイラン原油輸出額約312億ドルは含まれていない。
Kpler氏によると、中国の独立系精製業者がその大部分を引き取り、多くの場合、マレーシア産やインドネシア産原油としてブランド名を変更され、ドル制度外の仲介業者を通じて決済される。米財務省は今年、中国の金融機関を温存しながら、イラン産原油購入を理由にこれら製油所のいくつかを制裁した。
中国政府は、経済的圧力では紛争は解決しないと主張し、米国の対イラン制裁に公然と反対している。中国は5月、イラン石油取引に関連する精製業者5社に対する米国の制裁を無視するよう国内企業に命令した。
ユーラシア・グループの中国ディレクター、ダン・ワン氏は、中国政府が米国の制裁推進に直接反発する可能性は低いが、網に引っかかることを避けるために国営銀行と石油会社の間で「静かに順守を強化する」だろうと述べ、「公式声明と民間慣行の間の二項対立」を指摘した。
同氏は「中国当局は米国への資金調達や市場参入におけるドルのアクセスをより重視している」と述べた。
アラブ首長国連邦
エミレーツ航空はイランからペルシャ湾を挟んでわずか80マイルの距離にあり、長年にわたりイランの主要な貿易拠点であった。
世界貿易機関のデータによると、エミレーツが最大の輸入元であった2024年の二国間貿易は約280億ドルに達し、30％以上を占めた。 UAEはイランにとって3番目に大きな輸出先でもあり、輸出総額の12％を占め、総額70億ドル以上となっている。
先週、UAE領内に向けて2発の弾道ミサイルが発射され、うち1発がUAE所有のタンカーを標的としたことを受け、UAEがイランとの貿易・金融取引をすべて停止する措置を取ったことで、この関係は暗礁に乗り上げた。
米国に本拠を置くシンクタンク、ワシントン研究所によると、イランはUAEの銀行とその金融システムに依存し、不法でしばしば不透明な取引を通じて世界経済にアクセスしており、イランとの関係を遮断するには、不透明な金融・貿易活動を取り締まる首長国当局のより強力な行動が必要となるだろう。
元米財務省職員のマシュー・レビット氏は月曜のメモで、「イランの積み替え、密輸、影の銀行活動の大部分はドバイで行われているため、米国政府はアブダビのUAE国家指導者らがドバイの指導者たちを説得し、なだめてボールを戦わせるのを助けるためにできる限りのことをしなければならない」と述べた。
トルコ
トルコはイランとの重要な商業関係を維持しており、イランの天然ガスを輸入し、工業製品を南に輸出している。
トルコ外務省によると、トルコとイランの二国間貿易は2024年に57億ドルに達し、トルコ政府は主に機械や部品、化学製品や農産物を輸出し、テヘランからはエネルギー製品を輸入している。
一方、7月末に期限切れとなった両国間の25年間のガス供給契約に基づき、トルコによるイラン産ガス輸入は今年急増し、トルコの天然ガス総輸入量に占めるイランの割合は18.6％に上昇したと地元メディアが報じた。
トルコ政府はアゼルバイジャンやロシアからのパイプライン輸入を拡大し、他の供給国への多角化を目指しているが、これまでのところイランとの関係を遮断する意向を示していない。
イラク
イラクはイランの電力とガスに依存しており、歴史的にテヘランと数十億ドルの取引を行ってきた。
イランは2024年3月に年間最大6600億立方フィート近くの天然ガスをイラクに供給する5年契約を更新しており、米国エネルギー情報局によると、2023年にはイランからの電力輸入が発電量の30％以上を占めることになる。
ロイター通信によると、イラクとイランの貿易は２０２５年に１００億ドル以上に達し、テヘランは食料、消費財、その他の製品をイラク市場に輸出している。 2月下旬に内戦が始まって以来、地域の治安リスクの高まりと国境検問所での断続的な混乱を受けて、今年の貿易は縮小している。
イラクはイランに対し、発電用の天然ガスとして年間約40億ドルから50億ドルを支払っていると伝えられている。米国の新たな制裁により、バグダッドによるイランエネルギーへの支払いが削減される可能性がある。
インド
インド商務省によると、イランの貿易相手国トップ5に入るインドは近年、イランとの二国間貿易が2023年3月までの1年間の23億ドルから2026年3月までの1年間で約16億ドルに減少している。
ニューデリーは主に米、茶、砂糖、医薬品をイランに輸出し、乾燥果物や生の果物をイランから輸入している。
米国がイラン原油輸出に対する制裁を一時解除したことを受け、インドは4月、7年間停止していたイランからの原油輸入を再開した。
しかし、イランのエネルギーを調達しているインドの精製業者を含むあらゆる企業を制裁するというアメリカ政府の脅しを実行するかどうか、これらの取引は今試されることになる。`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/08/25/us-iran-secondary-sanctions-china-india-uae-hormuz-trade-.html",
    publishedAt: "2026-08-25T06:24:36+00:00",
    category: "エネルギー",
    imageUrl: "https://images.unsplash.com/photo-1473172367879-2dca04a4dca4?w=800&q=80",
    readTime: 6,
  },
  {
    id: "bitcoin-surges-past-80-000-as-crypto-ral-33bc2065",
    title: "Bitcoin surges past $80,000 as crypto rally gathers pace",
    titleJa: "Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.",
    summaryJa: "スポットビットコインETFへの新たな流入とリスク選好の改善により仮想通貨の最近の上昇が拡大し、ビットコインは火曜日に8万ドルの節目を超えて急騰した。主力の暗号通貨は最後に2％超急騰し、80,501ドルとなった。",
    bodyOriginal: `Bitcoin surged past the $80,000 mark on Tuesday, as renewed inflows into spot bitcoin ETFs and improving risk appetite extended the cryptocurrency's recent rally.
The flagship cryptocurrency last jumped over 2% to $80,501.
...
Still, questions remain over whether the breakout can last. Bitcoin has been in a prolonged slump since October, and BTIG noted that a similar surge in January 2023 initially faded before the cryptocurrency found support around its 200-day moving average.
...
Ether last traded 1.17% higher at $2,498.
XRP rose 2.6% to $1.52. It's up about 50% in the past seven days, according to pricing from CoinGecko.
...
Fundstrat also noted that bitcoin rallied without fresh purchases from Strategy, the world's largest corporate holder of the cryptocurrency. Strategy has not bought bitcoin for two weeks. If it starts buying again while ETF demand remains strong, that could provide another boost to prices.`,
    bodyJa: `スポットビットコインETFへの新たな流入とリスク選好の改善により仮想通貨の最近の上昇が拡大し、ビットコインは火曜日に8万ドルの節目を超えて急騰した。
主力の暗号通貨は最後に2％超急騰し、80,501ドルとなった。
今回の動きは、ビットコインが3日間で20％以上急騰し、2023年以来最大の3日間の上昇幅となった先週から始まった急騰を延長するものである。この上昇は部分的にはショートスクイーズによって促進され、価格上昇に伴って40億ドル以上の仮想通貨の弱気ポジションが清算された。
米財務省が長期国債の買い入れ額を倍増すると発表したことを受けて上昇した。この動きにより一時的に利回りが低下し、リスク資産への需要が復活する一方、インフレや政府債務に対する懸念の高まりも希少とみなされる資産への関心を高めた。
機関投資家の需要も戻ってきました。先週、米国のスポットビットコイン上場投資信託には19億2000万ドルの純流入があり、ビットコインが前回のサイクルピークに達した10月以来最大の週間流入額となった。
それでも、ブレイクアウトが持続できるかどうかについては疑問が残っている。ビットコインは10月以来長期にわたる低迷に陥っており、BTIGは、2023年1月の同様の上昇は当初、ビットコインが200日移動平均付近でサポートを見つける前に静まったと指摘した。
ファンドストラット氏は月曜日のメモで、先週のショートスクイーズに続く買いはビットコインの上昇が「戦術的な反発よりも持続性がある」可能性があることを示唆していると述べた。それは、ビットコインとイーサETFへの強い流入、取引の増加、そして投資家が仮想通貨の購入によく使用するステーブルコインの増加を指摘した。
イーサは前回1.17％高の2,498ドルで取引された。
XRPは2.6％上昇して1.52ドルとなった。 CoinGeckoの価格設定によると、過去7日間で約50％上昇した。
オプション市場の活動は、投資家が上昇相場が続くとの確信を強めていることを示唆していると調査会社は強調した。トレーダーが主に短期的な価格上昇に賭けていた以前のリバウンドとは異なり、投資家は現在、さらに将来のビットコインの上昇に対するエクスポージャーの対価を支払っている。
ファンドストラット氏はまた、仮想通貨の世界最大の企業保有者であるストラテジー社から新たに購入することなくビットコインが反発したと指摘した。ストラテジーは2週間ビットコインを購入していません。 ETF需要が依然として強いうちに再び買いを始めれば、価格がさらに押し上げられる可能性がある。`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/08/25/bitcoin-price-near-80000-cryptocurrency-ether-us-treasuries.html",
    publishedAt: "2026-08-25T04:38:30+00:00",
    category: "金融政策",
    imageUrl: "https://images.unsplash.com/photo-1611974789855-9c2a0a7236a3?w=800&q=80",
    readTime: 3,
  },
  {
    id: "porsche-inks-1-5-billion-deal-for-ai-dep-0b33b2c3",
    title: "Porsche inks $1.5 billion deal for AI deployment with India’s largest IT services firm Tata Consultancy",
    titleJa: "Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.",
    summaryJa: "ポルシェはインド最大のITサービス会社タタ・コンサルタンシー・サービシズと、人工知能に関する12億5000万ユーロ（14億6000万ドル）相当の5年契約を結んだ。契約の一環として、TCSはポルシェのITコンサルティング事業MHPを3億2000万ユーロで買収すると同社はリリースで述べた。",
    bodyOriginal: `Porsche has signed a five-year contract worth 1.25 billion euros ($1.46 billion) for artificial intelligence with India's largest IT services firm, Tata Consultancy Services.
...
AI is widely expected to hurt the business prospects of Indian IT services companies. The Nifty IT index, a benchmark for stocks of IT service companies, is down nearly 20% from the beginning of the year, as compared to the Nifty 50, which has slipped just over 7%.
The deal with Porsche will be effective once the Indian software giant completes the acquisition of MHP, which employs around 4,500 people. With this acquisition, TCS aims to "industrialize AI at scale for Porsche," said K. Krithivasan, chief executive and managing director of TCS.
It will also enhance the presence of the Indian software service company in the German market and among European automotive and industrial customers.
The sale of MHP is part of Porsche's "Sportwagenschmiede 35" strategy, which aims to improve the profitability and cash flow of the automaker. "We are firmly aligning our company with our core business," Leiters said last month, adding that the key element of the strategy would be to streamline the operations at all levels`,
    bodyJa: `ポルシェはインド最大のITサービス会社タタ・コンサルタンシー・サービシズと、人工知能に関する12億5000万ユーロ（14億6000万ドル）相当の5年契約を結んだ。
契約の一環として、TCSはポルシェのITコンサルティング事業MHPを3億2000万ユーロで買収すると同社はリリースで述べた。
これにより、ポルシェの「自動車専門知識とTCSのデジタルおよびAI能力」が統合されると、ポルシェ会長のマイケル・ライタース氏はプレスリリースで述べた。この提携により、「ますますデータとソフトウェア主導のモビリティの世界において」欧州スポーツカーメーカーの革新性、効率性、競争力が強化されることになる。
TCSは年初以来、複数のAI主導のビジネス変革契約を獲得しており、6月四半期のAI売上高は年換算で26億ドルで、前四半期比13.6％増加したと発表した。
AI はインドの IT サービス企業の業績見通しに悪影響を与えると広く予想されています。 ITサービス企業の株価のベンチマークであるニフティIT指数は年初から20％近く下落しているのに対し、ニフティ50は7％強下落している。
ポルシェとの契約は、インドのソフトウェア大手が約4,500人を雇用するMHPの買収を完了した時点で有効となる。 TCS の最高経営責任者兼マネージング ディレクターの K. クリティバサン氏は、この買収により TCS は「ポルシェ向けに AI を大規模に工業化する」ことを目指していると述べた。
また、これにより、ドイツ市場および欧州の自動車および産業顧客の間でインドのソフトウェアサービス会社の存在感が高まることになる。
MHPの売却は、自動車メーカーの収益性とキャッシュフローの改善を目的としたポルシェの「スポーツワーゲンシュミーデ35」戦略の一環である。ライターズ氏は先月、「当社は中核事業としっかりと連携している」と述べ、戦略の重要な要素はあらゆるレベルで業務を合理化することだと付け加えた`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/08/25/porsche-inks-billion-ai-deal-india-it-tcs.html",
    publishedAt: "2026-08-25T03:01:16+00:00",
    category: "テクノロジー",
    imageUrl: "https://images.unsplash.com/photo-1518770660439-4636190af475?w=800&q=80",
    readTime: 2,
  },
  {
    id: "gold-hits-over-three-month-high-on-dolla-07e714c0",
    title: "Gold hits over three-month high on dollar weakness, Treasury bond buyback plans",
    titleJa: "ドル安を受けて金は3カ月ぶりの高値を更新、米国債の買い戻し計画も",
    summaryJa: "火曜日の金価格は、米ドル安に支えられ、また米財務省の債券買い取り計画により利回りが抑制されていることから、３カ月ぶりの高値に上昇した。金スポットは0.6％上昇して1オンス当たり4,677.19ドルと、5月半ば以来の高値を付け、UOBは金が「1999年9月以来の月間上昇率」を目指す軌道に乗っていると予想した。イエローメタルは今月これまでに15％以上上昇した。",
    bodyOriginal: `Gold prices on Tuesday rose to their highest in more than three months, supported by a weaker U.S. dollar and as the U.S. Treasury's bond buyback plans keep the lid on yields.
...
The strength in the gold also spilled over to silver whose spot price gained 0.4% to $69.19 per ounce.
...
While a hawkish Warsh speech will likely bring the ongoing gold rally to a halt, a dovish surprise at Jackson Hole will be ultra-bullish for gold, "as the market will not only continue to price out Fed rate hikes but also refocus on the debasement trade amid renewed concerns on Fed independence and US debt sustainability issues," Citi said in a note.`,
    bodyJa: `火曜日の金価格は、米ドル安に支えられ、また米財務省の債券買い取り計画により利回りが抑制されていることから、３カ月ぶりの高値に上昇した。
金スポットは0.6％上昇して1オンス当たり4,677.19ドルと、5月半ば以来の高値を付け、UOBは金が「1999年9月以来の月間上昇率」を目指す軌道に乗っていると予想した。イエローメタルは今月これまでに15％以上上昇した。
金先物は0.5％上昇し4,720.3と、こちらも3カ月以上ぶりの高値となった。
金の強さは銀にも波及し、スポット価格は0.4％上昇し、オンスあたり69.19ドルとなった。
ドル安は外貨保有者にとって米ドル価格の金を魅力的にする一方、米国債利回りの低下により地金購入の機会費用が減少する。
ドル指数は今月これまでに0.8％下落しており、米国債利回りは8月の大部分にわたって上昇しているものの、政府の国債買い戻し計画によりなんとか抑制されており、今月は3ベーシスポイント低下した。
投資家らは金利見通しに関するさらなる手がかりを求めて、今週後半に開催されるジャクソンホール・シンポジウムに先立って行われるウォーシュ米連銀議長の講演にも注目している。
タカ派のウォーシュ演説は進行中の金の上昇に終止符を打つ公算が大きいが、ジャクソンホールでのハト派的なサプライズは金にとって極めて強気となるだろう、「市場は引き続きFRBの利上げを織り込むだけでなく、FRBの独立性や米債務の持続可能性問題に対する新たな懸念の中で地盤下落取引に再び注目するだろう」とシティはノートで述べた。`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/08/25/gold-hits-over-three-month-high-on-dollar-weakness-treasury-bond-buyback-plans.html",
    publishedAt: "2026-08-25T02:28:00+00:00",
    category: "金融政策",
    imageUrl: "https://images.unsplash.com/photo-1611974789855-9c2a0a7236a3?w=800&q=80",
    readTime: 2,
  },
