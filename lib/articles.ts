...
export const articles: Article[] = [
  {
    id: "u-s-to-use-economic-tactics-on-iran-that-0f9ee2bc",
    ...
    titleJa: "米国、イランに対して「前例のない」経済戦術を発動へ。海軍はトラブルに見舞われた空母エイブラハム・リンカーンの救援に取り組んでいる",
    summaryJa: "スコット・ベッセント財務長官によると、米国は「イランに対してこれまでに例のない」経済措置を適用する予定だという。ベッセント氏はニュースマックスとのインタビューで、「これは世界がこれまでに経験したことのないような経済的孤立と、イランの港への物の出入りを阻止するホルムズ海峡の継続的な封鎖の組み合わせになるだろう」と述べたが、それ以上詳しくは述べなかった。",
    bodyOriginal: `The U.S. will be applying economic measures "that have never been seen on Iran," according to Treasury Secretary Scott Bessent.
...
His statements come as U.S. Defense Secretary Pete Hegseth reportedly said late Thursday stateside that the U.S. military can keep a naval blockade of Iran going "indefinitely." The Navy will rotate ships in and out "as we have, and we'll continue to," Hegseth told reporters.
Media reports have said that the U.S. aircraft carrier USS George Washington was headed to replace the USS Abraham Lincoln, which has been deployed for over 250 days in the Middle East. Its deployment had been expected to end in May.
The George Washington strike group departed Vietnam on Aug. 12, the Navy said in a statement.
Hegseth also told reporters that reports about poor conditions aboard the Lincoln, including food shortages, declining morale, and even attempts by sailors to jump overboard, were "completely misrepresented."
...
This came after Iranian media claimed on Tuesday that seven U.S. Navy personnel have been killed and several wounded "in a violent clash" on the Lincoln.`,
    bodyJa: `スコット・ベッセント財務長官によると、米国は「イランに対してこれまでに例のない」経済措置を適用する予定だという。
ベッセント氏はニュースマックスとのインタビューで、「これは世界がこれまでに経験したことのないような経済的孤立と、イランの港への物の出入りを阻止するホルムズ海峡の継続的な封鎖の組み合わせになるだろう」と述べたが、それ以上詳しくは述べなかった。
同氏の発言は、ピート・ヘグセス米国防長官が木曜日遅く、米軍はイランに対する海上封鎖を「無期限」に継続することができると米国内で述べたと伝えられている中で行われた。ヘグセス氏は記者団に対し、海軍は「これまでと同様、今後も船舶の出入りをローテーションする」と語った。
...
ヘグセス氏はまた、食糧不足や士気の低下、さらには船員による飛び降りの試みなど、リンカーン号の劣悪な船内の状況に関する報道は「完全に誤って伝えられている」と記者団に語った。
ヘグセスのコメントの後、マイク・レビン下院議員（民主党、カリフォルニア州）はXで、ヘグセスとフン・カオ海軍長官代理に書簡を送り、リンカーン艦内の状況について深刻な懸念を表明したと述べた。
...
船員と海兵隊員は「圧倒的な仕事量」を抱えており、それが「極度の疲労と燃え尽き症候群」の一因となっているとも述べた。
米中央軍はＸへの投稿で、空母内で乱闘があったとする報道は虚偽であり、軍人は死亡していないと述べた。
これは、イランメディアが火曜日、リンカーン号での「暴力的な衝突」で米海軍関係者７人が死亡、数人が負傷したと主張したことを受けてのことだった。`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/08/14/us-iran-war-trump-hormuz-carrier-abraham-lincoln-george-washington.html",
    publishedAt: "2026-08-14T01:52:07+00:00",
    category: "金融政策",
    imageUrl: "https://images.unsplash.com/photo-1611974789855-9c2a0a7236a3?w=800&q=80",
    readTime: 2,
  },
  {
    id: "uber-partners-with-china-s-pony-ai-for-2-c75bd382",
    title: "Uber partners with China's Pony.ai for 2,000 robotaxis in Europe",
    titleJa: "ウーバー、中国のPony.aiと提携し、ヨーロッパで2,000台のロボタクシーを導入",
    summaryJa: "北京 — 米国の配車サービス大手ウーバーは、運営会社ポニー・アイ（Pony.ai）との提携により、世界的なロボタクシーのサービス範囲を拡大している。両社は、Pony.aiの自動運転タクシー2,000台をヨーロッパ全土に配備し、ロボタクシー提携を中東に拡大する計画であると金曜日に発表した。",
    bodyOriginal: `BEIJING — U.S. ride-hailing giant Uber is ramping up its global robotaxi coverage with operator Pony.ai.
...
— CNBC's Lora Kolodny contributed to this report.`,
    bodyJa: `北京 — 米国の配車サービス大手ウーバーは、運営会社ポニー・アイ（Pony.ai）との提携により、世界的なロボタクシーのサービス範囲を拡大している。
両社は、Pony.aiの自動運転タクシー2,000台をヨーロッパ全土に配備し、ロボタクシー提携を中東に拡大する計画であると金曜日に発表した。
3 月下旬、Uber と Pony.ai はクロアチアの首都ザグレブで商用ロボタクシー サービスを開始しました。これはヨーロッパ初だと彼らは主張しています。
金曜日に発表された提携では、ロボタクシーをヨーロッパの他の4都市に展開する予定だ。両社は都市名や正確な期間については明らかにしなかった。
商用化には十分な数の車両を保有することが重要です。利用可能な車両が増えれば増えるほど、より多くのデータを収集して規制当局に安全性を証明し、運用効率を高めることができます。可用性が向上すると、より多くの人がサービスを利用するようになります。
アルファベットが支援するロボタクシー運営会社ウェイモは、主に米国で約5,000台の車両を保有する世界的リーダーである。同社はロンドンで試乗を行っており、6月にはEUの主要4カ国に新しい事業体を設立したと報じられている。
ウェイモは東京でも計画を進めており、「世界的な事業の基礎を築く」ために世界中の当局者と協力しているとCNBCへの声明で述べた。
一方、中国のライバルである百度アポロゴーとウィライドは、ヨーロッパで自動運転乗り物を運行する計画とテストを強化している。
Uber は彼らの計画の多くに含まれています。
WeRideとUberは6月、スペイン初のロボタクシータクシーの試験運用を今年後半にマドリッドで開始する計画を発表した。両社はアブダビとドバイでも提携している。
ウーバーは木曜日、同社の日本法人が、今年後半に東京でロボタクシーを試験導入するため、日々の車両運行を管理するため地元のタクシー事業者と契約を結んだと発表した。
ファクトセットの決算会見記録によると、ウーバーの目標は「自動運転車の世界をリードする商業化プラットフォームになること」だと、CEOのダラ・コスロシャヒ氏が今月初めに語った。
その戦略の一環として、自動運転車の開発を加速するためにパートナーと共有できる「スーパーセットのデータ」を収集することがある、と同氏は述べた。
Pony.aiは火曜日に四半期決算を発表する予定だ。
— CNBC の Lora Kolodny がこのレポートに貢献しました。`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/08/14/uber-partners-with-chinas-ponyai-for-2000-robotaxis-in-europe.html",
    publishedAt: "2026-08-14T01:02:39+00:00",
    category: "テクノロジー",
    imageUrl: "https://images.unsplash.com/photo-1518770660439-4636190af475?w=800&q=80",
    readTime: 3,
  },
  {
    id: "reddit-is-joining-the-s-p-500-after-mont-5169c1e0",
    title: "Reddit is joining the S&P 500 after months of speculation. Analysts have these concerns.",
    titleJa: "Redditは数カ月にわたる憶測を経てS&P 500に加わることになった。アナリストはこうした懸念を抱いている。",
    summaryJa: "過去の軽視の後、ソーシャルメディアサイトレディットはS&P 500種の採用枠を獲得し、木曜日の時間外上昇で株価を上げた。",
    bodyOriginal: `After past snubs, social-media site Reddit has landed a spot on the S&amp;P 500, sending shares on an after-hours rally Thursday.`,
    bodyJa: `過去の軽視の後、ソーシャルメディアサイトレディットはS&P 500種の採用枠を獲得し、木曜日の時間外上昇で株価を上げた。`,
    source: "MarketWatch",
    sourceUrl: "https://www.marketwatch.com/story/reddit-is-joining-the-s-p-500-after-months-of-speculation-analysts-have-these-concerns-21f81f77?mod=mw_rss_topstories",
    publishedAt: "2026-08-14T00:19:00+00:00",
    category: "金融政策",
    imageUrl: "https://images.mktw.net/im-48684154",
    readTime: 2,
  },
  {
    id: "from-apple-to-ford-how-chinese-tech-is-b-391c409b",
    title: "From Apple to Ford: How Chinese tech is becoming harder for global companies to ignore",
    titleJa: "アップルからフォードまで：世界企業にとって中国のテクノロジーを無視することがいかに困難になっているか",
    summaryJa: "米国政府は中国政府の技術的野望を抑制する取り組みを強化しているが、人工知能から電気自動車のバッテリーに至るまで、中国の技術は世界最大手の企業のビジネスにますます組み込まれつつある。Appleは中国のAIに関してAlibabaとBaiduを活用し、一方Fordはバッテリー技術に関してCATLに目を向けた。フォルクスワーゲンは中国でのスマートEVの開発でXpengと提携し、ステランティスはEVの生産と共同購入でリープモーターとの提携を拡大している。",
    bodyOriginal: `Washington has been stepping up efforts to curb Beijing's technological ambitions, but from artificial intelligence to electric vehicle batteries, Chinese technology is becoming increasingly embedded in the businesses of some of the world's biggest companies.
...
Fok said the shift is already structural in batteries and electronics manufacturing, while AI is in transition and automotive software remains at an early stage.`,
    bodyJa: `米国政府は中国政府の技術的野望を抑制する取り組みを強化しているが、人工知能から電気自動車のバッテリーに至るまで、中国の技術は世界最大手の企業のビジネスにますます組み込まれつつある。
Appleは中国のAIに関してAlibabaとBaiduを活用し、一方Fordはバッテリー技術に関してCATLに目を向けた。フォルクスワーゲンは中国でのスマートEVの開発でXpengと提携し、ステランティスはEVの生産と共同購入でリープモーターとの提携を拡大している。
アナリストらは、中国企業が世界企業が容易に回避できない技術とイノベーションの源泉となり、幅広い変化が進行していると述べている。
市場調査会社IDCチャイナのマネジングディレクター、キティ・フォク氏はCNBCに対し、「5年前、中国は主にグローバル企業が売りに行く場所だった。しかし現在、特定の分野では、中国は能力を調達する場所になっている」と語った。
この発展は、米国政府が中国の技術を抑制する取り組みを拡大している中でも起こった。
2019年にファーウェイをブラックリストに登録して以来、ファーウェイは先端チップとチップ製造装置に大幅な制限を課し、中国の半導体、量子技術、AIへの米国の一部投資を制限し、受託チップメーカーのセミコンダクター・マニュファクチャリング・インターナショナル・コーポレーション（SMIC）を含む企業を禁止してきた。
市場から技術ソースまで
中国は、ますます多くのテクノロジー産業にわたって恐るべき地位を築いてきました。
カウンターポイント・リサーチの主任アナリスト、ソウメン・マンダル氏によると、BYD、長安、奇瑞などの自動車メーカーは2025年の世界の電気自動車市場の63％近くを占め、CATL、BYD、CALB、Gotionなどの電池メーカーは70％近くを占めた。
マンダル氏は、グローバル企業が中国企業との関わりを続ける強力な理由として、コスト、規模、製造の深さ、サプライチェーンの統合、イノベーションのスピードを挙げた。
マンダル氏は「中国の技術的台頭は、低コスト製造から規模、サプライチェーンの深さ、イノベーションのスピードへと移行している」と述べ、グローバル企業は地政学的リスクと商業的現実のバランスを維持していると付け加えた。
この変化は電気自動車のバッテリーで特に進んでいます。
CATL は世界の自動車産業に深く組み込まれています。たとえば、フォードはCATLと協力して、ミシガン州にある35億ドルの電池工場でそのリン酸鉄リチウム電池技術を使用している。
フォク氏は、中国のEVバッテリー技術を世界のサプライチェーンに統合することは、元に戻すのが難しい可能性があると述べた。
「EV用バッテリーでは、構造転換はすでに完了している」と同氏は語った。 「サプライヤーの切り替えは、四半期で決定する調達の決定ではありません。エンジニアリング、テスト、再認定には何年もかかります。」
しかし、一部の企業にとって、中国のテクノロジー企業との協業は依然として主に中国国内での競争に関係している。
フォク氏によると、中国での事業運営にAIサービスやクラウドインフラストラクチャを必要とする多国籍企業は、外国プロバイダーに対する制限があるため、地元プロバイダーと連携する必要があるという。
「中国国内では、こうしたことの多くは選択の余地がない」と彼女は語り、アップルとアリババやバイドゥとの協力を指摘した。
オムディアの首席アナリスト、リアン・ジェ・スー氏は、特に世界的な自動車メーカーが中国で販売するソフトウェア、AI、その他のシステムについて中国ベンダーに頼る傾向が強まっており、中国市場へのアクセスが依然として多くのこうした提携の主な原動力となっていると述べた。
しかし、ドライバーはそれだけではありません。スー氏は、バッテリー、電気自動車、エネルギー貯蔵、応用AIなどの分野でサプライチェーンとイノベーションの流れで「ゆっくりだが持続的な構造変化」が起きていると述べた。
AIは次のフロンティアになる可能性がある
この傾向は人工知能にも現れ始めており、企業が主に安価であるという理由で中国の技術に頼るという考えに対して、ますます高機能な中国製モデルが挑戦している。
今年初めにヨーロッパ企業を対象とした IDC の調査では、中国の AI モデルが広範に採用される上位 2 つの理由は、コストではなく、セキュリティとコンプライアンスの要件、および優れたパフォーマンスであることが判明しました。
「つまり、西側企業が中国製AIが安いという理由で殺到しているという一般的な説は、これを逆向きにしているのです」とフォク氏は語った。 「この決定はパフォーマンス主導であり、コンプライアンスに基づいて行われます。」
米国に本拠を置くAnthropicやOpenAIとは異なり、AlibabaやDeepSeekなどの中国企業はオープンソースモデルに焦点を当てており、世界中の開発者がオープンソースモデルを利用しやすくしている。
スー氏によると、中国のAIの進歩は、米国の規制により中国政府が最先端の半導体などの分野で制約を受けている一方で、国内のイノベーションも加速しているという。
スー氏は「米国の規制の主な影響は、中国国内の技術革新と効率化の触媒となったことだ」と述べ、中国ベンダーはAI、電池、自動車ソフトウェアの分野で競争力を維持していると付け加えた。
シフトの制限
地政学的な考慮は、中国の技術がどこでどのように採用されるかを形成し続けています。
スー氏は、中国のテクノロジーに対する抵抗が、先端半導体、サイバーセキュリティー、防衛、国家安全保障に関連するサービスなどの分野で最も強いと予想している。
アナリストらは、単純な技術ボイコットや受け入れではなく、中国の技術導入は分野によって異なるだろうと述べている。
カウンターポイントのマンダル氏は、中国技術の採用がEV、電池、家庭用電化製品、ロボット工学、ドローン、AIや半導体の一部の分野を含む分野で世界的に拡大し、同氏が言うところの「より細分化されているが実用的な世界的な技術エコシステム」につながると予想している。
フォク氏は、この変化は電池やエレクトロニクス製造においてすでに構造的なものとなっているが、AIは過渡期にあり、自動車用ソフトウェアはまだ初期段階にあると述べた。`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/08/14/china-tech-global-appeal-apple-ford-catl-deepseek.html",
    publishedAt: "2026-08-14T00:09:11+00:00",
    category: "エネルギー",
    imageUrl: "https://images.unsplash.com/photo-1473172367879-2dca04a4dca4?w=800&q=80",
    readTime: 7,
  },
  {
    id: "i-got-an-89-refund-how-to-cancel-and-avo-708c402b",
    title: "I got an £89 refund – how to cancel and  avoid unwanted subscriptions",
    titleJa: "89 ポンドの払い戻しを受けました – 不要な定期購入をキャンセルして回避する方法",
    summaryJa: "89 ポンドの払い戻しを受けました – 不要な定期購入をキャンセルして回避する方法- 公開されました",
    bodyOriginal: `I got an £89 refund – how to cancel and avoid unwanted subscriptions
- Published
...
1. Set reminders
Sophie Branscombe, 23 from Wirral, says she signed up for a free trial of a photo editor app then saw a payment of £89.99 had gone out of her bank.
...
He says a payment of £16 left his account, then another of £32 before he froze his card. "They tried to charge me seven times," he says.
...
3. Don't assume your trial will end
Rosalinda Kwafo-Akoto, 22 from the West Midlands signed up for a one-week free TV trial. After the trial, the subscription would be £9.99 a month.
...
"These companies make it as difficult as possible for you to cancel so make sure you get a confirmation email of your cancellation," she says. The BBC has contacted the firm for a response.`,
    bodyJa: `89 ポンドの払い戻しを受けました – 不要な定期購入をキャンセルして回避する方法
- 公開されました
銀行から出金されるランダムな金額に混乱し、それがキャンセルするのを忘れていた、またはサインアップするつもりはなかったサブスクリプションであると感じて沈んだことはありませんか?
テレビストリーミングから食事の配達、ビューティーボックスに至るまで、ほぼあらゆるものを定期購入できます。
多くの場合、最初の注文は無料または大幅に割引されるため、試してみて期限前にキャンセルするつもりだと自分に言い聞かせます。しかし、それは忘れられやすく、簡単ではないこともあります。
アンディ・バーナム首相によるサブスクリプションの罠の取り締まりを受けて、3 人がどのようにして罠にはまり、そしてそこから抜け出したのかを語ります。
1. リマインダーを設定する
ウィラル在住のソフィー・ブランコムさん（23）は、写真編集アプリの無料トライアルに登録したところ、銀行から89.99ポンドの支払いがあったと語った。
「それは無料トライアルであり、定期購読にサインアップしていることは明らかにされましたが、[無料期間]がいつ終了するかについての通知はありませんでした」と彼女は言います。
ソフィーさんは、会社を通じて返金を受けることができなかったと言う。代わりに、彼女は Apple の「問題を報告」を通じて返金リクエストを提出し、すべてが返金されました。 BBCは同社に回答を求めた。
ソフィーから他の人へのアドバイスは、サブスクリプションにサインアップしたらすぐに、無料トライアルが終了するときのリマインダーを設定することです。
「定期購入の期限が切れたら、定期購入をチェックする習慣をつけましょう。また、無料トライアルにサインアップした後で気に入らない点が見つかったら、すぐにキャンセルしてください」と彼女は言います。
2. 小さな文字を読む
西ロンドン在住のフセイン・ザイターさん（21）は、大学の仕事で無料ソフトウェアのトライアル版を利用していたが、キャンセルしようとした際にいくつかの問題に直面したと語る。
「常に料金を請求されていたため、オンライン チャット、電子メール、さらには電話を試したこともありました」と彼は言います。
彼は、カードを凍結する前に、16 ポンドの支払いが口座から消え、その後、さらに 32 ポンドの支払いがあったと述べています。 「彼らは7回も私を起訴しようとした」と彼は言う。
彼は返金されることを期待して、銀行に連絡して状況を説明しました。
「簡単にキャンセルできる無料お試しとして宣伝されているように感じました。
「連絡するのが難しく、キャンセルはほぼ不可能でした」と彼は言う。
フセイン氏が他の人たちにアドバイスしたのは、サブスクリプションを開始する前に利用規約を読み、注意することです。 BBCは同社に返答を求めた。
3. トライアルが終了するとは思わないでください
ウェスト・ミッドランズ出身のロザリンダ・クワフォ＝アコトさん（22）は、1週間の無料テレビトライアルに登録した。試用後のサブスクリプションは月額 9.99 ポンドになります。
「週末になる前に裁判が終了することを思い出し、請求されないように裁判をキャンセルしようとしました」と彼女は言います。
彼女は、自分のアカウントのどこにもサブスクリプションが見つからなかったため、自動的に終了して削除されたのだと思ったと言いました。
1週間後、彼女は自分の口座からお金が引き出されていることに気づきました。
彼女は、カスタマーサービスの担当者と話し、サブスクリプションを見つけるまでに 1 時間半かかったと言います。ロスさんはなんとかキャンセルし、全額返金されました。
Ros が他の人にアドバイスしたのは、自分のアカウントにサブスクリプションが見つからないからといって、サブスクリプションが自動的にキャンセルされるとは思わないことです。
「これらの会社は可能な限りキャンセルを難しくしているので、必ずキャンセルの確認メールを受け取るようにしてください」と彼女は言います。 BBCは同社に返答を求めた。`,
    source: "BBC",
    sourceUrl: "https://www.bbc.co.uk/news/articles/ckg6x3n5erpo?at_medium=RSS&at_campaign=rss",
    publishedAt: "2026-08-13T23:03:07+00:00",
    category: "金融政策",
