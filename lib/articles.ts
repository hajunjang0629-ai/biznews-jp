...
開示: CNBC とカルシには、顧客の獲得と少数出資を含む商業関係があります。`,
  ...
  {
    id: "anthropic-revenue-reportedly-jumps-to-mo-84f9dbe8",
    title: "Anthropic revenue reportedly jumps to more than $11.5 billion in second quarter",
    titleJa: "伝えられるところによると、人類の収益は第 2 四半期に 115 億ドル以上に急増",
    summaryJa: "ブルームバーグニュースが金曜日に報じた第2四半期のAnthropicの収益は前年同期比で14倍以上に急増し、大ヒットとなる可能性のある新規株式公開の準備を進めているクロードチャットボットメーカーの急速な成長を浮き彫りにした。ブルームバーグ・ニュースが閲覧した文書によると、同社は直近完了四半期の暫定収益が115億ドル以上と報告しており、前年同期の7億8,700万ドル、2026年第1四半期の47億3,000万ドルから増加した。",
    bodyOriginal: `Anthropic's revenue surged more than 14-fold in the second quarter from a year earlier, Bloomberg News reported Friday, underscoring the rapid growth of the Claude chatbot maker as it prepares for a potential blockbuster initial public offering.
...
An IPO as soon as this fall could make Anthropic one of the first major private AI companies to tap public markets. That debut would unlock access to billions of dollars in additional capital, providing the immense financial runway required to fund escalating compute infrastructure costs, secure advanced hardware, and build specialized data centers.`,
    bodyJa: `ブルームバーグニュースが金曜日に報じた第2四半期のAnthropicの収益は前年同期比で14倍以上に急増し、大ヒットとなる可能性のある新規株式公開の準備を進めているクロードチャットボットメーカーの急速な成長を浮き彫りにした。
ブルームバーグ・ニュースが閲覧した文書によると、同社は直近完了四半期の暫定収益が115億ドル以上と報告しており、前年同期の7億8,700万ドル、2026年第1四半期の47億3,000万ドルから増加した。
文書によると、アンスロピックは第２・四半期に調整後営業利益もプラスとなった。ブルームバーグによると、この数字は暫定的なものであり、まだ変更される可能性がある。
アントロピックの広報担当者はCNBCのコメント要請にすぐには応じなかった。
収益の急増は、Anthropic が企業顧客向けに OpenAI と競合し、コーディングなどのタスクに同社のソフトウェアを使用する専門家の間で注目を集めていることによるものです。
アンスロピックは5月、ランレート収益が470億ドルを超え、2025年通年の収益が約100億ドルだったと発表した。
アンスロピックの潜在的なIPOに先立って行われた見込み投資家との初期の会合はハイレベルなものであり、特定の財務内容や評価額に関する議論は含まれていなかったと関係者が木曜CNBCのデービッド・フェイバーに語った。関係者によると、Anthropic CFOのクリシュナ・ラオ氏が会議を主導しているという。
今秋にもIPOが実現すれば、アンスロピックは公開市場を開拓する最初の大手民間AI企業の1つとなる可能性がある。このデビューにより、数十億ドルの追加資本へのアクセスが可能になり、増大するコンピューティング インフラストラクチャのコストに資金を提供し、高度なハードウェアを確保し、専用のデータ センターを構築するために必要な莫大な財政滑走路が提供されます。`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/08/15/anthropic-revenue-jumps-to-over-11point5-billion-in-q2-report.html",
    publishedAt: "2026-08-15T14:45:31+00:00",
    category: "金融政策",
    imageUrl: "https://images.unsplash.com/photo-1611974789855-9c2a0a7236a3?w=800&q=80",
    readTime: 2,
  },
  {
    id: "depleted-strategic-oil-reserve-nears-lev-2fd02e73",
    title: "Depleted strategic oil reserve nears level that raises concerns about damage to caverns, operations",
    titleJa: "枯渇した戦略的石油埋蔵量は、洞窟や操業への被害が懸念されるレベルに近づいている",
    summaryJa: "在庫が40年ぶりの低水準に達する中、専門家らは今週、米国の戦略的石油埋蔵量を保管する洞窟が、イラン戦争に対応した急速な備蓄放出によって損害を受ける可能性があると警告した。専門家らは、洞窟が損傷すれば、将来のエネルギー緊急事態への対応がさらに困難になるだろうと述べた。戦略石油備蓄（SPR）の石油は、ルイジアナ州とテキサス州の湾岸沿いの主要な4か所の地下数千フィートにある60の塩の洞窟に保管されている。",
    bodyOriginal: `The caverns that hold the U.S. strategic oil reserves could get damaged by the rapid release of stockpiles in response to the Iran war, experts warned this week as inventories hit a four-decade low.
Damage to the caverns would make it more difficult to respond to future energy emergencies, the experts said. The oil in the Strategic Petroleum Reserve (SPR) is stored at 60 salt caverns thousands of feet underground at four major sites along the Gulf Coast in Louisiana and Texas.
...
Hochstein said a hurricane in Florida or Louisiana could put the U.S. in a tough position at current SPR levels. "Below 300 million, which is where we are now, it is not that we can't do it, but it slows the flow and puts us in danger," he said.`,
    bodyJa: `在庫が40年ぶりの低水準に達する中、専門家らは今週、米国の戦略的石油埋蔵量を保管する洞窟が、イラン戦争に対応した急速な備蓄放出によって損害を受ける可能性があると警告した。
専門家らは、洞窟が損傷すれば、将来のエネルギー緊急事態への対応がさらに困難になるだろうと述べた。戦略石油備蓄（SPR）の石油は、ルイジアナ州とテキサス州の湾岸沿いの主要な4か所の地下数千フィートにある60の塩の洞窟に保管されている。
エネルギー省が月曜日に発表したデータによると、SPRは1980年代初頭に埋め立てられて以来初めて3億バレルを下回った。イラン戦争による供給混乱への対応として米国が１億７２００万バレルを放出しているため、在庫は減少している。ドローダウン終了後のＳＰＲは約２億４３００万バレルとなる。
エネルギー省は、洞窟を安全に管理するには少なくとも7,000万バレルを埋蔵量に残しておく必要があると述べた。ジョー・バイデン大統領の上級エネルギー顧問エイモス・ホッホシュタイン氏は今週、この数字に異議を唱えた。
ホホシュタイン氏は木曜日、CNBCの番組「スコークボックス」で、「SPRが7000万バレルまで増量できると言っている政府関係者を信じてはいけない。ナンセンスだ」と語った。その水準に達すると、埋蔵量は「二度と復活できないほど」まで枯渇するだろうと同氏は述べた。
埋蔵量が3億バレルを下回ると、洞窟が損傷する危険があるとバイデン政権の元高官は6月に警告した。
ホホスタイン氏はアトランティック・カウンシルのイベントでCNBCのブライアン・サリバンに対し、「300人を下回る可能性があると信じている人を私は知らない」と語った。 「物理的に石油が保管されている洞窟にダメージを与えることになるため、300 に近づくことは不可能だと考えている人をたくさん知っています。」
エネルギー省報道官のベン・ディーデリヒ氏は、SPRの貯蔵洞窟が石油の採取により崩壊の危険にさらされているという主張は誤りであると述べた。
「洞窟は常に満杯だ。変化するのは洞窟を満たしている油と水の比率だけだ」とディートデリッヒ氏はCNBCに声明で語った。トランプ政権は「国家安全保障の重要資産として設計されたSPRを責任を持って管理している」と述べた。
政治界のどちらの側も、塩の洞窟の完全性について懸念を表明している。 2022年のロシアのウクライナ侵攻に対抗してバイデン政権が過去最高となる1億8000万バレルを放出した際、共和党議員らはこうした懸念を表明した。バイデン政権下の2023年にはSPRは3億5000万バレルを下回った。イラン戦争前には約４億１５００万バレルまで補充された。
政府会計検査院は5月の報告書で、「部分的なドローダウンとその後の埋め戻しを繰り返すと、空洞の単一部分が繰り返し浸出する可能性があり、望ましくない形状につながる可能性がある」と述べた。
GAOによると、SPRの洞窟の大部分は2022年の枯渇後も「非常に良好な状態」であることが判明したという。
「しかし、ドローダウンサイクルごとに空洞の容積が拡大し、塩ドーム内の空洞間の間隔が狭くなり、最終的には長期的な生存可能性が低下する」と研究報告書は述べている。
オペレーションフロア
SPR から石油を放出するために、オペレーターは空洞の底に水を汲み上げて原油を地表に移動させ、井戸を通してパイプラインに送り込みます。
テキサスA&M大学の石油工学教授シッダース・ミスラ氏によると、抽出パイプを水ではなく油に安全に浸すために洞窟の頂上で必要な物理的厳密な最低量は7000万バレルだという。
しかしミスラ氏はCNBCへの電子メールで、「原油在庫の実質的な運用フロアは2億5000万バレルから3億バレルの間だ」と述べた。現在の在庫レベルでは、「洞窟の完全性と全体的な運営能力は高いリスクにさらされている」と同氏は述べた。
在庫が3億バレルを下回ると、SPRは緊急事態に対処するために高速で石油を汲み出す能力を失う、とミスラ氏は語った。また、上部の油層が薄くなり、洞窟の天井にある取水口に向かってスラッジが上昇するため、システムのパイプとポンプが損傷する可能性があると同氏は述べた。
ミスラ氏によると、急速な水位低下の際には真水が洞窟にポンプで送り込まれることが多く、塩の壁が溶けてしまうという。これにより、「屋根がより平らになり、安定性が低くなり、隣接する洞窟を隔てる重要な塩の柱が大幅に薄くなり、構造的陥没の地質学的リスクが大幅に増加する」と同氏は述べた。
SPR は当初、5 回のフルドローダウン向けに設計されました。その代わりに、過去 40 年間に大小問わず数十のリリースを実行してきたとミスラ氏は語った。
同氏は、「このシステムはこれほど多くのサイクルを想定して設計されていないため、水の注入と石油の抽出を繰り返すことで洞窟に深刻な変形を引き起こし、天井から大量の塩が落ちる速度が加速し、老朽化し​​た埋蔵量の全体的な構造的健全性が著しく弱体化した」と述べた。
エネルギー省当局者らはGAOに対し、「SPRインフラを『絆創膏』と一緒に保管しているが、どれくらいの期間保管するかは不透明だ」と語った。 GAOの調査によると、2025年12月の時点でSPR在庫の4分の1以上が「建設の停止と洞窟の停止の組み合わせにより取り崩しができない」という。
ラピダン・エナジー社のアナリストらは、SPRの「軟弱底」は約1億7000万バレルで、それを下回ると「洞窟の完全性とポンプインフラの制限により、これ以上の汲み出しには反対する」と推定した。
ホホスタイン氏は、フロリダ州やルイジアナ州でハリケーンが発生すれば、現在のSPRレベルでは米国は厳しい立場に陥る可能性があると述べた。 「我々が現在いる3億人以下では、それができないわけではないが、流れが遅くなり、我々を危険にさらすことになる」と同氏は語った。`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/08/15/strategic-petroleum-reserve-spr-oil-iran-war-caverns.html",
    publishedAt: "2026-08-15T14:19:35+00:00",
    category: "エネルギー",
    imageUrl: "https://images.unsplash.com/photo-1473172367879-2dca04a4dca4?w=800&q=80",
    readTime: 6,
  },
  {
    id: "between-earn-nothing-cash-broken-long-te-7236e493",
    title: "Between earn-nothing cash, broken long-term bonds, these are the safety trades of 2026 market",
    titleJa: "何も得られない現金と長期債の破綻、これらが 2026 年の市場の安全な取引です",
    summaryJa: "株式市場が不可避の低迷に向かい、10年国債などの長期債券がこれまでポートフォリオ内で提供してきた分散効果が得られないという根強い懸念のなか、多くの投資家が短期投資、特に超短期債券ファンドに目を向けている。過去 10 年間の株式市場のリターンは好調で、S&P 500 指数は過去 10 年間のほとんどで 2 桁の上昇を記録しました。 「マグ7」テクノロジー株とAIブームに支えられ、ここ数年は特に堅調だった。",
...
The best ultra-short bond funds to buy in 2026 include the Baird Ultra Short Bond Fund (BUBIX) and the JPMorgan Ultra-Short Income ETF (JPST), according to Morningstar.
...
Investors shouldn't try to time the market. They should also ensure they keep a healthy percentage of equities in their portfolio, based on factors such as age, assets, liabilities and risk tolerance. "The problem with going completely to cash is that you've introduced the element of timing to your portfolio," Bisaro said. Investors sometimes say they'll reinvest in equities when things get better. "Who's to say when that will be?"`,
    bodyJa: `株式市場が不可避の低迷に向かい、10年国債などの長期債券がこれまでポートフォリオ内で提供してきた分散効果が得られないという根強い懸念のなか、多くの投資家が短期投資、特に超短期債券ファンドに目を向けている。
過去 10 年間の株式市場のリターンは好調で、S&P 500 指数は過去 10 年間のほとんどで 2 桁の上昇を記録しました。 「マグ7」テクノロジー株とAIブームに支えられ、ここ数年は特に堅調だった。
ブルックウッド・インベストメント・グループ（フェニックス）の最高投資責任者クリストファー・クーリッジ氏は「投資家は史上最も強い株式市場の一つを享受しており、下値リスクを懸念し始めている」と述べた。
投資家が資金を手放す中、銀行預金は平均利回りが1％をはるかに下回る水準でほとんど支払われず、不確実な金利環境で長期債券は損失を被っている。例えば、iシェアーズの20年以上国債ETF（TLT）は過去5年間で年平均リターンがマイナス6.7％となっている一方、7～10年国債ETF（IEF）は年平均1％の下落を記録している。
投資家はインフレに打ち勝つための他の安全取引を模索している。利回りが魅力的で下値リスクが少ないため、短期投資への注目が高まっています。
どれだけが現金同様の投資に振り込まれているか
一部の金融専門家は、顧客のポートフォリオの大部分を現金同様の投資に移しています。たとえば、ブルックウッド・インベストメント・グループのモデルポートフォリオは通常、約5％の現金で構成されている。 ６月の約２％から上昇した。クーリッジ氏は「株式市場が過去最高値を更新し続ける中、われわれはより守りの姿勢になっている」と述べた。
ブルックウッドは、ポートフォリオの現金部分について、国債エクスポージャー、変動利付証券、アクティブな信用管理とオプション強化インカム戦略を備えたETFを組み合わせた超短期ETFのバスケットを作成しています。顧客は、快適さのレベルに応じて、しばらくの間超短バスケットに 100% 投資することも、50% または 20% を投資することも選択できる、とクーリッジ氏は述べた。
カリフォルニア州ラファイエットのハイフン・ウェルス・マネジメントの最高投資責任者であるサイラス・アミニ氏も、流動性確保のために短期債券ファンドとマネーマーケットファンドを組み合わせて利用している。同氏は「この市場ではデュレーションリスクを取る必要性は感じられない」と述べた。
超短期債券ファンドが大きな勝者となる理由
多くの場合、投資家は株式市場を懸念する場合、債券ファンドに目を向けますが、ここでも最近のパフォーマンスの悪さの数字を超えた懸念があります。クーリッジ氏は、インフレ懸念や地政学的な懸念、米連邦準備理事会（ＦＲＢ）が年末までに利上げが必要になるかもしれないとの見方を背景に、債券市場の長期金利はさらに不安定になっていると述べた。しかし、最近のインフレ統計は、予想外に軟調な雇用市場データと相まって、利上げが目前に迫っているという市場の確率を低下させている。
しかし、超短期債券ファンドは短期的な資金の保管場所として人気が高まっている。これらのファンドは主に満期が通常 1 年未満の債券に投資します。これには、国債、投資適格社債、資産担保証券、コマーシャルペーパーへの投資が含まれます。
モーニングスター・ダイレクトによると、超短期債券ＥＴＦには７月に１２８億ドルの流入があった。金融ストラテジストによれば、これらのファンドは短期金融市場のETFや投資信託よりも利回りが若干高くなりますが、リスクはわずかに高いだけです。クーリッジ氏は「ウルトラショートは、同等のデュレーションと金利感応度を備えた短期金融市場ETFに比べて75〜110ベーシスポイント上昇している」と述べた。
モーニングスターによると、2026年に購入するのに最適な超短期債券ファンドには、ベアード・ウルトラショート債券ファンド（BUBIX）とJPモルガン・ウルトラショート・インカムETF（JPST）が含まれるという。
マネーマーケットファンドは金利リスクを排除します
超短期債券ファンドには依然としてある程度の金利リスクが伴います。それが投資家にとって気になる場合は、代わりにマネーマーケットETFや投資信託を購入することもできます。イリノイ州ライルにあるアドビゾン・インベストメント・マネジメントの最高投資責任者ブライアン・ハックステップ氏は、「すべては自分の快適さのレベルだ」と語る。
マネーマーケット ETF はまだ比較的新しいものですが、人気が高まっています。モーニングスター・リサーチ・サービシズの北米向けETFおよびパッシブ戦略調査アソシエートディレクター、ダニエル・ソティロフ氏によると、これらのETFの最初のものは2024年に取引が開始され、米国には9つしかないという。同業の投資信託と比較すると規模は小さい。モーニングスターのデータによると、7月末時点で9つのETF全体の資産総額は240億ドルだったのに対し、マネーマーケット・ミューチュアルファンドの保有資産は7兆7000億ドルだった。
それにもかかわらず、モーニングスター・ダイレクトによると、短期金融市場ETFへの純流入額は2026年6月と7月を除き、開始以来毎月プラスとなっており、勢いを増しているという。 1月から7月までのマネーマーケットETFの純流入額は187億ドルで、マネーマーケットミューチュアルファンドの純流入額は28億ドルだった。
最大のマネーマーケットETFはProShares GENIUS Money Market ETF (IQMM)です。モーニングスター・ダイレクトによると、同ファンドの7月末時点の資産は174億ドルだった。
リバランスに重点を置き、株価が大幅に上昇した後のリスクを軽減
アミニ氏は、株式の急騰は多くの投資家の目標資産配分がずれていることを意味しており、ポートフォリオのリスクを軽減するためのリバランスについて慎重になる良い時期だと付け加えた。アミニ氏は、これは、投資収益がインフレをわずかに上回っていれば勝ちだという考えのもと、短期債券や短期金融市場への投資を増やすことを意味する可能性があると述べた。同氏は、利益の確定について顧客と話す時間を増やしており、株式利益の一部を段階的にテーブルから外し、マネーマーケットファンドや超短期債券ファンドに移している。同氏は「潜在的な下落が起きてから心配するよりも、事前に慎重になりたい」と述べた。
顧客が株式からのシフトを希望するもう 1 つの理由は、目標が変化したことです。ミシガン州トロイの投資顧問会社ストレートラインの社長兼最高経営責任者マイク・ビサロ氏は、「8カ月以内に住宅の頭金を支払うつもりなら、そのお金は株式市場に出すべきではない」と語る。ただし、投資家は超短期債券ファンドやマネーマーケットファンドに安心して投資できるはずです。 「少なくとも事実上損失を被っている銀行よりも、彼らは購買力を維持するという点でうまく機能している」と同氏は語った。
決して「現金に行く」だけではない
ソティロフ氏によると、投資家はより安全な投資に目を向けているが、新型コロナウイルス感染症パンデミック（世界的大流行）の余波以来、マネーマーケットファンドの資産に占める割合は株式や債券ファンドに比べて比較的安定しているという。過去数年間、短期金融市場に投資される資金の割合は約18％から20％であった。モーニングスターのデータによると、６月末時点で資金の約６４％が株式ファンド、１８％が債券ファンド、１７．５％が短期金融市場に投じられていた。
投資家は市場のタイミングを計ろうとすべきではありません。また、年齢、資産、負債、リスク許容度などの要素に基づいて、ポートフォリオ内の株式の健全な割合を維持する必要もあります。 「完全に現金化する場合の問題は、ポートフォリオにタイミングの要素を持ち込んでいることだ」とビサロ氏は言う。投資家は時々、状況が良くなったら株式に再投資すると言います。 「それがいつになるか誰が言えるでしょうか？」`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/08/15/cash-money-market-funds-bonds.html",
    publishedAt: "2026-08-15T12:30:01+00:00",
    category: "金融政策",
    imageUrl: "https://images.unsplash.com/photo-1611974789855-9c2a0a7236a3?w=800&q=80",
    readTime: 8,
  },
  {
    id: "ballet-flats-are-so-popular-that-even-br-2cb3c6ab",
    title: "Ballet flats are so popular that even brands like Birkenstock and Crocs are cashing in on the trend",
    titleJa: "バレエシューズは非常に人気があり、ビルケンシュトックやクロックスなどのブランドもトレンドを利用しています。",
    summaryJa: "ノスタルジックな一因として、バレリーナ シューズが再び流行しています。さらに、Z 世代の買い物客もランニング ショーツと合わせています。",
    bodyOriginal: `Ballerina shoes are back in style thanks in part to nostalgia — plus Gen Z shoppers who are even pairing them with running shorts.`,
    bodyJa: `ノスタルジックな一因として、バレリーナ シューズが再び流行しています。さらに、Z 世代の買い物客もランニング ショーツと合わせています。`,
    source: "MarketWatch",
    sourceUrl: "https://www.marketwatch.com/story/ballet-flats-are-so-popular-that-even-brands-like-birkenstock-and-crocs-are-cashing-in-on-the-trend-3d44997c?mod=mw_rss_topstories",
    publishedAt: "2026-08-15T12:30:00+00:00",
    category: "金融政策",
    imageUrl: "https://images.mktw.net/im-55318236",
    readTime: 2,
  },
  {
    id: "eleven-killed-in-israeli-strikes-on-sout-36042447",
    title: "Eleven killed in Israeli strikes on southern Lebanon, authorities say",
    titleJa: "イスラエル軍によるレバノン南部攻撃で11人死亡、当局発表",
    summaryJa: "イスラエル軍によるレバノン南部攻撃で11人死亡、当局発表- 公開されました",
    bodyOriginal: `Eleven killed in Israeli strikes on southern Lebanon, authorities say
- Published
...
On Friday, Hezbollah leader Naim Qassem criticised the Lebanese authorities over the implementation of the framework, accusing them of putting pressure on the Lebanese army while Israeli attacks continued.
...
- Published6 August`,
    bodyJa: `イスラエル軍によるレバノン南部攻撃で11人死亡、当局発表
- 公開されました
当局によると、レバノン南部でのイスラエル軍の攻撃で11人が死亡、6月に敵対関係の縮小を目的とした合意が発表されて以来、最も死者数の多い攻撃となった。
レバノン首相は、ナバティエ地区のアンサール郊外の家屋へのストライキで７人が死亡し、国営メディアの報道によると、その中には子供３人と女性２人が含まれていたと述べた。
レバノン保健省によると、土曜遅くに別の空爆がデリ・アル・ザフラニの町を襲い、４人が死亡、５人が負傷した。
イスラエル軍は、兵士に対する以前の行為と称する行為に対抗して「ヒズボラのテロインフラ」を攻撃したと発表した。
当局によると、アンサールでのストライキは午前４時３０分（日本時間午後１時３０分）ごろ、避難民の家族が住んでいる場所で発生した。ソーシャルメディア上の映像には、サイレンが鳴り響く中、村の通りに大きな煙が立ち込める様子が映っている。
レバノンのナワフ・サラーム首相は、殺害された民間人７人は「軍事インフラ」ではないと述べ、攻撃を非難した。
「イスラエルはこのエスカレーションを止めなければならない」と彼は言った。 「なぜなら、我が国民の安全とその土地で生きる権利は交渉や交渉の対象ではないからです。」
イスラエル国防軍（IDF）は、アンサール攻撃のきっかけとなった事件は、レバノン南東部の大部分と戦争で最も激戦となった陣地を見下ろす戦略的な高台であるアリ・アル・タヘル尾根で発生したと発表した。
レバノン国営通信社（NNA）も尾根周辺での一連の攻撃を報じた。
ＮＮＡによると、国境近くのビント・ジュベイルでは数軒の家が破壊され、イスラエル軍は家に向けて重機関銃を発砲したという。
3月2日、イラン系武装組織ヒズボラがイラン最高指導者を殺害した攻撃への報復としてイスラエルにロケット弾を発射し、レバノンはイスラエル、米国、イラン間の戦争に巻き込まれた。
イスラエルはレバノン全土で爆撃作戦を開始し、同国の南部の大部分を侵攻することでこれに応じた。同軍はレバノン領土の約５％を占領し続けている。
６月の停戦枠組みでは、ヒズボラの武装解除、イスラエル軍の南レバノンからの段階的撤退、レバノン軍の地域全域への展開が求められている。
レバノンのジョセフ・アウン大統領は、アンサールで一家全員を殺害したイスラエルの空爆と枠組みへの「度重なる違反」を非難し、これは米国主導の交渉に「明確なメッセージ」を送ったと述べた。
ヒズボラは合意には関与しておらず、直接交渉を拒否している。
イスラエル国防軍は、イスラエルが占領するレバノン南部の深さ10キロメートルの軍事緩衝地帯である安全地帯で活動するイスラエル国民と兵士に対する脅威を除去し続けると述べた。
6月の合意を受けて戦闘は減少したにもかかわらず、レバノン南部でのイスラエルによる攻撃と破壊は続いている。
金曜日、ヒズボラ指導者ナイム・カセムは枠組みの実施をめぐりレバノン当局を批判し、イスラエルによる攻撃が続く中レバノン軍に圧力をかけていると非難した。
「レバノン軍を保護者として振る舞わず、砲撃やイスラエルの圧力にさらし続けているレバノン軍の屈辱をどうして受け入れることができるのか？」彼は言い​​ました。
レバノンとイスラエルの交渉担当者は９月に第８回交渉に向けて会合する予定だが、最終日はまだ決まっていない。
- 8 月 6 日発行`,
    source: "BBC",
    sourceUrl: "https://www.bbc.co.uk/news/articles/c4gjygx4gjeo?at_medium=RSS&at_campaign=rss",
    publishedAt: "2026-08-15T12:25:11+00:00",
    category: "貿易",
    imageUrl: "https://ichef.bbci.co.uk/ace/standard/240/cpsprodpb/387d/live/b67daca0-9893-11f1-a7ab-8b30adf0800a.jpg",
    readTime: 4,
  },
  {
    id: "a-decade-of-internal-ai-battles-is-final-4d504fc2",
    title: "A decade of internal AI battles is finally catching up to Google",
    titleJa: "10年にわたる社内AIの戦いがついにGoogleに追いつきつつある",
    summaryJa: "2014 年に Google に買収された DeepMind は、同社の AI 戦略の基礎であり、組織内の摩擦の慢性的な原因でもありました。",
    bodyOriginal: `DeepMind, acquired by Google in 2014, has been a cornerstone of the company’s AI strategy — and also a chronic source of organizational friction.`,
    bodyJa: `2014 年に Google に買収された DeepMind は、同社の AI 戦略の基礎であり、組織内の摩擦の慢性的な原因でもありました。`,
    source: "MarketWatch",
    sourceUrl: "https://www.marketwatch.com/story/a-decade-of-internal-ai-battles-is-finally-catching-up-to-google-7b3358a1?mod=mw_rss_topstories",
    publishedAt: "2026-08-15T12:00:00+00:00",
    category: "テクノロジー",
    imageUrl: "https://images.mktw.net/im-67567044",
    readTime: 2,
  },
  {
    id: "this-old-school-way-of-investing-money-i-45fb7194",
    title: "This old-school way of investing money is better than ever — even in the age of AI and mega-IPOs",
    titleJa: "この昔ながらの資金投​​資方法は、AI や巨大 IPO の時代においても、これまで以上に優れています。",
    summaryJa: "ポートフォリオ構築の「黄金比」 — 株式 60%、債券 40% — は再び機能しますが、いくつかの調整の後、",
    bodyOriginal: `The “golden ratio” for portfolio construction — 60% stocks, 40% bonds — works again, but after a few tweaks,`,
    bodyJa: `ポートフォリオ構築の「黄金比」 — 株式 60%、債券 40% — は再び機能しますが、いくつかの調整の後、`,
    source: "MarketWatch",
    sourceUrl: "https://www.marketwatch.com/story/this-old-school-way-of-investing-money-is-better-than-ever-even-in-the-age-of-ai-and-mega-ipos-3e1142f7?mod=mw_rss_topstories",
    publishedAt: "2026-08-15T11:30:00+00:00",
    category: "テクノロジー",
    imageUrl: "https://images.mktw.net/im-86474821",
    readTime: 2,
  },
];
