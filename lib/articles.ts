...
この地域の激化により、火曜日にはブレント原油が２％上昇して１バレル＝８５ドルとなった一方、紛争前に世界の石油とガスの５分の１を運んでいたホルムズ水道を通る商業輸送を巡る不確実性が再び高まる中、米国ウェスト・テキサス・インターミディエイトは２．３％上昇して８０ドルとなった。`,
  ...
  {
    id: "australian-police-reveal-unseen-photos-2-fb8cfeaa",
    title: "Australian police reveal unseen photos 25 years after British backpacker murder",
    titleJa: "英国人バックパッカー殺害から25年、オーストラリア警察が未公開の写真を公開",
    summaryJa: "英国人バックパッカー殺害から25年、オーストラリア警察が未公開の写真を公開- 公開されました",
    bodyOriginal: `Australian police reveal unseen photos 25 years after British backpacker murder
- Published
...
- Published16 July 2025`,
    bodyJa: `英国人バックパッカー殺害から25年、オーストラリア警察が未公開の写真を公開
- 公開されました
オーストラリアの警察は、25年前の英国人バックパッカー、ピーター・ファルコニオ殺害事件の捜査で未公開の写真を公開した。
ハダースフィールド出身のファルコニオは、2001年7月14日にアリススプリングスの北約186マイル（300km）にあるノーザンテリトリーの町バロークリーク近くの人里離れた高速道路で射殺された。
彼の遺体はまだ発見されておらず、警察は画像が記憶を呼び起こし、密告につながる可能性があることを期待している。ファルコニオを殺害したブラッドリー・マードックは昨年、咽頭がんのため刑務所内で67歳で亡くなったが、ファルコニオの遺体がどこにあるのかは明らかにされなかった。
画像には、警察の捜査中にカメラをまっすぐに見つめるマードック氏の全身写真が含まれている。
ファルコニオさんのガールフレンド、ジョアン・リーズさんはマードックから逃亡し、トラックを運転する男２人を振り切るまで数時間低木地に隠れた。
警察が撮影した写真の1枚には、襲撃から数時間後に心に傷を負った様子のリーさんが写っている。手首を結束バンドで縛られた後など、彼女が負った傷を示すものもある。
ノーザンテリトリー警察のマーティン・ドール長官は、25年は「重要な節目」であり、新たな画像の公開が思い出を呼び起こしたり、密告につながることを期待していると述べた。
「これはリーズさんにとっても、そしてふさわしい答えも得られずに長い年月を経てきたピーターさんの家族にとって、衝撃的で恐ろしい出来事だった」とドールさんは語った。
「殺人犯はその犯罪の責任を問われているが、ピーターの遺体が発見され、家族が彼を安置できるまで、この捜査が終了したとは決して考えられない。」
ノーザンテリトリー警察が公開した他の写真には、夫妻がオーストラリア中を旅行中に運転していたオレンジ色のフォルクスワーゲン・コンビバンが写っている。攻撃が行われた場所に近いスチュアート・ハイウェイのすぐそばに放置されているのが発見された。犯罪現場の写真も一連の写真の中に含まれています。
2005年12月の公判中、裁判所は当時43歳のマードックが車の横に停車し、ファルコニオが運転していたキャンピングカーから火花が出ているのを目撃したと主張したと主張した。
その後、車を点検していたファルコニオさんの頭を撃ち、その後、28歳のリーズさんを車に連れ込み、結束バンドで手首を縛ったが、彼女はなんとか逃走した。
マードックは陪審員全員一致の評決でファルコニオ殺害で有罪判決を受け、リーズへの暴行と誘拐未遂でも有罪となった。
DNA証拠が犯罪との関連性を示しているにもかかわらず、彼は常に無実を主張し、有罪判決を覆すよう2度控訴したが失敗に終わった。
数日前、警察はマードック氏が死亡する1週間前に遺体の位置を明らかにさせようとしてマードック氏と面談したボディーカメラの映像を公開した。
ドール長官は火曜日の声明で、「我々が知る限り、マードック氏がピーターさんの遺体の所在を一切明らかにすることなく亡くなったことは非常に残念だ。マードック氏の卑劣な沈黙は、家族、友人、愛する人たちにふさわしい閉鎖を拒否したものだ」と述べた。
ノーザンテリトリー警察は引き続き「この捜査を最大限の結論に導くことに尽力」し、「利用可能なあらゆる手段を追求し続ける」と付け加えた。
ファルコニオ氏の遺体発見につながる情報には、最大５０万豪ドルの報奨金が用意されている。
関連トピック
- 2025 年 7 月 16 日公開`,
    source: "BBC",
    sourceUrl: "https://www.bbc.co.uk/news/articles/crlwln0gkzlo?at_medium=RSS&at_campaign=rss",
    publishedAt: "2026-07-14T02:26:45+00:00",
    category: "自動車",
    imageUrl: "https://ichef.bbci.co.uk/ace/standard/240/cpsprodpb/2c72/live/5ee73240-7f2a-11f1-a2d1-357b5800ed69.jpg",
    readTime: 4,
  },
  {
...
米国とイスラエルが2月28日にイラン攻撃を開始するまで、世界の石油供給量のおよそ5分の1がホルムズ海峡を通過していた。イランが3月初旬に同水路の船舶を標的にし始めてから海運は低迷したが、米国とイランの暫定合意を受けて回復し始めていた。`,
  ...
  },
  {
    ...
    publishedAt: "2026-07-13T23:30:00+00:00",
    category: "金融政策",
...
- 5 日前に公開`,
  ...
  {
    id: "why-a-borrowing-binge-by-investors-is-a-9f7e8841",
    title: "Why a borrowing binge by investors is a warning sign for the stock market",
    titleJa: "投資家による借り入れが株式市場にとって危険信号である理由",
    summaryJa: "投資家は株を買うために借り入れをするケースが増えており、これは証拠金債務で利益を増幅させようとする株式市場の貪欲さを反映している。増え続ける借入金の山に、ウォール街の一部の人たちは神経質になっている。",
    bodyOriginal: `Investors are increasingly borrowing to buy stocks, a reflection of greed in the stock market as they seek to amplify returns with margin debt. The growing pile of borrowed money has some on Wall Street nervous.`,
    bodyJa: `投資家は株を買うために借り入れをするケースが増えており、これは証拠金債務で利益を増幅させようとする株式市場の貪欲さを反映している。増え続ける借入金の山に、ウォール街の一部の人たちは神経質になっている。`,
    source: "MarketWatch",
    ...
    publishedAt: "2026-07-13T22:19:00+00:00",
    category: "金融政策",
    imageUrl: "https://images.mktw.net/im-23957069",
    readTime: 2,
  },
  {
    id: "spacex-s-stock-threatens-to-fall-below-t-92220bad",
    title: "SpaceX’s stock threatens to fall below the IPO price. Do investors face a ‘crisis’ if it does?",
    titleJa: "スペースXの株価はIPO価格を下回る恐れがある。もしそうなった場合、投資家は「危機」に直面するでしょうか?",
    summaryJa: "同社は1カ月足らずで時価総額2兆6700億ドルのピークから8000億ドル以上を減らした。",
    bodyOriginal: `The company has shed more than $800 billion in market value from its $2.67 trillion peak in less than a month.`,
    bodyJa: `同社は1カ月足らずで時価総額2兆6700億ドルのピークから8000億ドル以上を減らした。`,
    source: "MarketWatch",
    ...
    publishedAt: "2026-07-13T22:08:00+00:00",
    category: "金融政策",
    imageUrl: "https://images.mktw.net/im-22186155",
    readTime: 2,
  },
  {
