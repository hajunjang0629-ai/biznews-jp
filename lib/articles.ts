...
export const articles: Article[] = [
  {
    ...
    summaryJa: "見る: 捜査が続くベルリン・プライド襲撃現場ベルリンでは、混雑したプライドイベントに車が突っ込み、1人が死亡、16人が負傷した事件を受け、捜査が進められている。",
    bodyOriginal: `Watch: At the scene of Berlin Pride attack as manhunt continues
A manhunt is underway in Berlin after a vehicle drove into a crowded pride event, killing one person and injuring 16.
Police have named the suspect as 21-year-old Abdul B and have released an image of him.
A vehicle suspected of being used in the attack has been located by police inside the city's Tiergarten park.
Related topics
- GermanyUpdates from your News topics will appear in My News and in a collection on the News homepage.
- BerlinUpdates from your News topics will appear in My News and in a collection on the News homepage.
- PrideUpdates from your News topics will appear in My News and in a collection on the News homepage.
- EuropeUpdates from your News topics will appear in My News and in a collection on the News homepage.`,
    bodyJa: `見る: 捜査が続くベルリン・プライド襲撃現場
ベルリンでは、混雑したプライドイベントに車が突っ込み、1人が死亡、16人が負傷した事件を受け、捜査が進められている。
警察は容疑者を21歳のアブドゥルBと名付け、画像を公開した。
襲撃に使用されたとみられる車両が市内のティーアガルテン公園内で警察によって発見された。
関連トピック
- ドイツ ニュース トピックからの更新は、マイ ニュースおよびニュース ホームページのコレクションに表示されます。
- ニュース トピックからのベルリン更新は、マイ ニュースおよびニュース ホームページのコレクションに表示されます。
- ニュース トピックからの PrideUpdates は、マイ ニュースおよびニュース ホームページのコレクションに表示されます。
- ニュース トピックからのヨーロッパ更新は、マイ ニュースおよびニュース ホームページのコレクションに表示されます。`,
    source: "BBC",
    sourceUrl: "https://www.bbc.co.uk/news/videos/c74gzknyyz2o?at_medium=RSS&at_campaign=rss",
    publishedAt: "2026-07-26T08:14:55+00:00",
    category: "自動車",
    imageUrl: "https://ichef.bbci.co.uk/ace/standard/240/cpsprodpb/b81f/live/5ba2aae0-88c8-11f1-b2ab-0dd01740f9f6.jpg",
    readTime: 2,
  },
  {
    id: "france-battles-fire-whirlwinds-as-anothe-0308a7a1",
    title: "France battles fire 'whirlwinds' as another 55,000 evacuated",
    titleJa: "フランス、さらに5万5千人が避難、火災の「旋風」と戦う",
    summaryJa: "フランス、さらに5万5千人が避難、火災の「旋風」と戦う- 公開されました",
    bodyOriginal: `France battles fire 'whirlwinds' as another 55,000 evacuated
- Published
A further 55,000 people have been evacuated from six towns in France, as wildfires which have caused devastation across the country pick up pace.
...
In an interview published on Sunday by La Tribune, French Interior Minister Laurent Nunez said it "will take a long time to bring under control" and until it is contained "there will be no return" for evacuated residents and tourists.
...
Late on Saturday, at least eight municipalities near Toledo were also ordered to evacuate, though it was unclear how many people were involved.
...
- Published20 hours ago`,
    bodyJa: `フランス、さらに5万5千人が避難、火災の「旋風」と戦う
- 公開されました
フランス全土に甚大な被害をもたらしている山火事がペースを速める中、フランスの6つの町からさらに5万5000人が避難している。
最近の避難はボルドー南部のジロンド地方の町で行われた。
山火事はここ１週間、フランスとスペインを中心にヨーロッパ全土で猛威を振るっており、３３万人以上が避難している。
最も大きな被害を受けたのはフランスで、4万2000ヘクタールの面積が焼かれ、第二次世界大戦以来最大規模の森林火災の一つとなった。今年初め以来、全国で約9万8000ヘクタールが焼失した。
消防活動のリーダーの一人であるニコラス・ブラズ大尉は、火災が「旋風を伴う独自の風」を引き起こしたと述べ、火災は「不安定で手に負えない」ものだったと付け加えた。
乾燥した草木と強風が火災の延焼を引き起こしており、スペインにつながる高速道路A63号線の60キロメートル（37マイル）が通行止めとなっている。
日曜日にラ・トリビューン紙に掲載されたインタビューの中で、フランス内務大臣ローラン・ヌニェスは、感染症が「収束するには長い時間がかかる」と述べ、感染が収まるまでは避難した住民や観光客は「戻れない」と述べた。
フランスはこの対応を支援するために軍を動員し、藪を刈ったり防火帯を設けたりする消防士を支援するために軍からの追加援軍が派遣された。
エマニュエル・マクロン大統領は、フランスは「再建」し、政府は「必要な限り存続する」と述べた。
一方、スペインでは火災が広がり続けており、マドリードやアビラ周辺地域から9万人以上が避難している。
土曜日遅く、トレド近郊の少なくとも8つの自治体にも避難命令が出たが、巻き込まれた人数は不明だ。
日曜日は高温と低湿度が予想されており、火災がさらに拡大する可能性がある。
マドリッドの地域会長イザベル・ディアス・アユソは、この状況を「地域史上最悪の火災」と表現した。
スペインのペドロ・サンチェス首相は「今後は複雑な時代」が来ることを認めた。一方、バレンシア当局は火災による男性の死亡を確認した。
連絡する
...
- 20 時間前に公開`,
    ...
    publishedAt: "2026-07-26T07:21:11+00:00",
    category: "貿易",
    imageUrl: "https://ichef.bbci.co.uk/ace/standard/240/cpsprodpb/d055/live/c69c5bb0-88b5-11f1-b7ca-b5f2b9ce39f1.png",
    readTime: 2,
  },
  {
    id: "cocoa-prices-are-easing-so-why-is-chocol-66dad471",
    title: "Cocoa prices are easing. So why is chocolate still so expensive?",
    titleJa: "カカオの価格は下落している。では、なぜチョコレートは依然として高価なのでしょうか？",
    summaryJa: "記録的な高騰の後、カカオの価格は落ち着き始めているが、世界最大手のチョコレートメーカーが買い物客を取り戻すためにソーシャルメディアにインスピレーションを受けた商品やその他の戦略に目を向けているため、まだ安価なキャンディーを期待しないでください。悪天候とカカオ不作によりチョコレートの価格が上昇し、消費者心理が冷え込んだため、カカオ価格は過去2年間で記録的な高値に達した。",
    bodyOriginal: `Cocoa prices are beginning to ease after a record-breaking rally, but don't expect cheaper candy just yet as the world's biggest chocolate makers turn to social media-inspired products and other strategies to win shoppers back.
...
As cocoa prices are expected to recover, chocolatiers are looking to win back their core customer base by innovating their premium product formats, as well as keeping a closer eye on social media trends that young people are engaging with.
...
Instead, Barry Callebaut is also leaning into premium chocolate, growing its Gourmet business, which supplies chefs and bakers, while expanding higher-end specialty chocolate products.`,
    bodyJa: `記録的な高騰の後、カカオの価格は落ち着き始めているが、世界最大手のチョコレートメーカーが買い物客を取り戻すためにソーシャルメディアにインスピレーションを受けた商品やその他の戦略に目を向けているため、まだ安価なキャンディーを期待しないでください。
悪天候とカカオ不作によりチョコレートの価格が上昇し、消費者心理が冷え込んだため、カカオ価格は過去2年間で記録的な高値に達した。
しかし、現在カカオの価格は下落しているようです。
カカオ先物の前回取引価格は１トン当たり５３２７ドルで、過去１年間で３４％下落した。この商品は、2024 年末には 1 トンあたり約 12,000 ドルまで高騰しました。カカオの価格は、過去 20 年間、通常、2,000 ドルから 3,000 ドル付近で推移していました。
スイスのチョコレート大手バリー・カレボー、リンツ、ネスレはいずれもカカオ価格の高騰が収益の足かせになっていると指摘した。
リンツ氏は月曜日、グループ全体で11.8％の値上げがあり、今年上半期にチョコレートを購入する買い物客が減り、チョコレートの販売量が7.5％減少したと述べた。
同グループのアダルベルト・レヒナー最高経営責任者（CEO）はアナリストとの電話会見で、「記録的なカカオ価格により、業界全体で前例のない値上げが必要となったが、地政学的な不確実性、インフレ、消費者心理の弱さが需要を圧迫した」と述べた。 「中東危機により、アジアや中東からヨーロッパへの観光客の流れが弱まり、さらなる逆風が加わった。」
世界最大のチョコレートとココアの供給会社バリー・カレボーは、世界の消費者が第3四半期にチョコレートを購入する量は前年同時期に比べて4.4％少ないものの、同社の全体的な販売量は同四半期に5.7％増加し、2年ぶりにプラスに転じたと述べた。さらに、今年初めの市場調整により、世界のカカオ売上は18%加速しました。
一方、食品・飲料会社ネスレは、カカオとコーヒーの価格上昇が今年上半期の基礎的な営業利益に打撃を与え、２．８％減少したと述べた。同社の菓子事業は総売上高の9.7％を占める。ネスレはカカオ価格の下落により利益が得られると予想している。
ココアに何が起こっているのでしょうか？
カカオ価格の変動の主な原因は、西アフリカでのカカオ不作で、エルニーニョや気候変動に関連した気象パターンによってさらに悪化し、供給が逼迫した。
エルニーニョは、太平洋で 2 ～ 7 年ごとに発生する、平均気温よりも高い気象現象です。オックスフォード・マーティン・スクール・プログラムの食の未来に関する研究者、ターニャ・ランダー博士の12月の分析によると、2024年のカカオ価格の高騰は主に、西アフリカでのより乾燥した暑い気候と異常な降雨をもたらした「強い」エルニーニョによるものであるという。
「したがって、エルニーニョ現象がコートジボワールとガーナ（世界のカカオ豆の60～70％が生産されている）の両方でのカカオ不作に関係しているのは驚くべきことではない」とランダー氏は書いた。
気候変動と気温上昇も影響しており、2024年は観測史上最も暑い年となる。 UBSのアナリストらは、リンツに関する7月初旬のメモの中で、ヨーロッパ全土での最近の熱波も消費者のチョコレートに対する熱意を弱める可能性があると述べた。
アナリストらによると、リンツの中核となる欧州市場の一部では熱波と気温上昇がチョコレート需要に影響を与える可能性があり、東欧を除く欧州の売上高は６月１４日までの４週間で減少するという。
しかし、バリー・カレボー氏は、2026年と2027年には強いエルニーニョが確認されており、供給の下振れリスクが生じる一方、2025年から2026年の大幅な黒字が緩衝材として機能し、その結果2023年から2024年とは大きく異なる状況になると述べた。
UBSのアナリストらは、リンツが2027年に有利なカカオ豆価格でヘッジを行っていると予想しており、これによりコストが最大5億スイスフラン削減される可能性があると分析している。
一方、ドナルド・トランプ米大統領の相互関税も短期間ではあるが重大な影響を及ぼし、価格高騰やサプライチェーンの混乱を引き起こしている。最近では、中東紛争により観光客の流れが減少し、リンツの旅行小売事業も世界中で打撃を受けました。
プレミアムチョコレート、ソーシャルメディアトレンド
カカオ価格の回復が見込まれる中、ショコラティエ各社は高級商品のフォーマットを刷新するとともに、若者が関心を寄せるソーシャルメディアのトレンドに注視することで、中核となる顧客ベースを取り戻そうとしている。
リンツは、バイラルなソーシャルメディアのトレンドを利用するために、2024年12月にドバイスタイルのチョコレートバーを発売した。ウォルマートからトレーダージョーズ、シェイクシャック、ハロッズに至るまでの世界的な小売業者も現在ではドバイチョコレートも販売しています。
リンツの最高経営責任者（CEO）レヒナー氏は、同社はインスピレーション、発見、購入の間のシームレスな旅を生み出すために「ソーシャルメディアでの存在感」を拡大する計画だと語った。
「ドバイ スタイル チョコレートの発売の並外れた成功は、当社ブランドの認知度、エンゲージメント、需要を構築する上でソーシャル メディアの力が増大していることを証明しました」とレヒナー氏は決算会見で述べた。
「この戦略は、新しい視聴者を獲得し、若い消費者との関係を強化するのに役立ちます。」
ネスレの最高経営責任者（CEO）フィリップ・ナブラティル氏もこの見方に同調し、木曜日のアナリストとの電話会見で、同社はインフルエンサーマーケティングにさらに投資する計画であり、ブランド自体の宣伝方法にも変化が訪れると述べた。
「よりデジタル、よりソーシャル、よりオーガニック、より楽しい。若い消費者が世界とどのように関わるかを活用する」とナブラティル氏は語った。
バリー・カレボー氏とリンツ氏は両社とも、今年の残り半年間はプレミアム製品に対する消費者の関心に注力しているが、価格を上げるのではなく製品の提供方法に工夫を凝らしている。
「価格体系を拡大することで、当社のプレミアムなポジショニングを損なうことなく、新しい消費者を引き付け、購入頻度を高め、リンツブランドとのより多くのタッチポイントを提供することができます」とレヒナー氏は述べた。
レヒナー氏は、リンツが最も重要な時期の消費者需要をサポートするため、特にクリスマス期間中、ドイツやスイスなどの主要市場で選択的に価格を引き下げたと指摘した。一方、バリー・カレボーとネスレは価格引き下げには言及していない。
その代わり、バリー・カレボーも高級チョコレートに力を入れており、シェフやパン職人に商品を供給するグルメ事業を成長させながら、高級な特製チョコレート製品を拡大している。`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/07/26/cocoa-prices-chocolate-lindt-barry-callebaut-nestle.html",
    publishedAt: "2026-07-26T05:00:01+00:00",
    category: "金融政策",
    imageUrl: "https://images.unsplash.com/photo-1611974789855-9c2a0a7236a3?w=800&q=80",
    readTime: 7,
  },
  {
    id: "primark-s-new-supermarket-tactic-to-woo-a16cd702",
    title: "Primark's new 'supermarket tactic' to woo customers in online price war",
    titleJa: "オンライン価格競争で顧客を魅了するプライマークの新たな「スーパーマーケット戦略」",
    summaryJa: "オンライン価格競争で顧客を魅了するプライマークの新たな「スーパーマーケット戦略」- 公開されました",
    bodyOriginal: `Primark's new 'supermarket tactic' to woo customers in online price war
- Published
...
For student Eshal, part of the reason Primark feels more expensive is because she knows how low prices are at Shein. She says she buys going-out tops for less than £10.
Temu and Shein have been able to undercut traditional retailers like Primark because they do not pay for physical locations, most of their packages are exempt from import duties – though this exemption is set to end in October 2028, external - and they have an efficient operating model that leaves them with little unsold stock, says Berg.
...
In its latest annual report, it said that about 85% of its products are £10 or less.
...
- Published17 August 2025`,
    bodyJa: `オンライン価格競争で顧客を魅了するプライマークの新たな「スーパーマーケット戦略」
- 公開されました
「プライマークはもうそれほど安くない。」
ファストファッションの巨人で買い物をするかどうかを買い物客に尋ねると、私はこう言うのをよく聞きます。
友人とプライマークでジュエリーを見ながら、19歳の学生エシャル・マリクさんは「間違いなく高くなっています」と言う。
しかし、それは変わろうとしているかもしれない。プライマークは月曜日、ジーンズ、ジャンパー、靴下など数百点の衣料品の価格を引き下げると発表した。
小売アナリストのナタリー・バーグ氏は、「これはM&Sやネクストに予想されるような見出しだ」と述べ、このような低価格小売業者によるこのような値下げは驚くべきことだと説明する。
「最下位への競争には参加したくないのです」と彼女は言う。 「でも、シェインがドレスを 3 ポンドで売っているのなら、それに応えなければなりませんよね？」
英国に190以上の店舗を展開するプライマークは、小売業界の重要な指標である同一売上高の減少に見舞われている。
値下げの発表は、親会社アソシエイト・ブリティッシュ・フーズが来年ロンドン株式市場に事業を分離する計画に先立って行われた。
ファッション小売業者間の競争のレベルはここ数年で「劇的に進化」しており、中国のオンラインマーケットプレイスであるSheinとTemuは現在、Primarkの顧客をめぐって競争している、とバーグ氏は言う。
しかし、TikTok ShopやVintedなどの他のオンライン小売業者との競争もある、と彼女は言う。
バーグ氏によると、プライマークは、一部の主力商品の価格を引き下げることで、スーパーマーケットが安い牛乳やバナナで客を引きつけるのと同じように、低価格の定番商品で買い物客を惹きつけようとしている可能性が高いという。
Tasneem Jafar さんが新しい服を買おうと思ったとき、最初に探すのは Primark です。
サルフォード在住の 32 歳の彼女は、16 歳の頃からこのファッション小売店でジーンズ、T シャツ、美容製品などを買ってきました。
しかしここ数年、タスニームさんもテムから服を買うようになった。
彼女は、およそ 6 週間ごとに、その小売店に新しい衣類を 3 ～ 4 着注文しているといいます。
学生のエシャルにとって、プライマークがより高価に感じられる理由の 1 つは、シェインの価格がいかに安いかを知っているからです。彼女は外出用のトップスを 10 ポンド未満で購入すると言います。
TemuとSheinは、Primarkのような伝統的な小売業者を損なうことができた。なぜなら、彼らは物理的な場所に対して料金を支払っておらず、パッケージのほとんどが輸入関税を免除されている（ただし、この免除は対外的には2028年10月に終了する予定だが）、そして売れ残り在庫がほとんどない効率的な運営モデルを持っているからだとバーグ氏は言う。
現在のシャイン価格の安値が新たな基準とみなされている、とバーグ氏は言う。そして、彼らは若い買い物客を惹きつけている。
2025 年 7 月のミンテルの調査によると、オンラインで衣類を購入する 16 ～ 34 歳の女性の 32% が、前年中に Shein で買い物をしたと回答しました。
低価格、豊富な割引コード、果てしなく続く商品ページすべてがその魅力につながっています。
対照的に、Primark はクリック アンド コレクト サービスを提供していますが、配達は提供していません。
買い物客の中には、ハイ ストリートの他の場所にもっとコストパフォーマンスの良い店があると考える人もいます。
スタッフォードシャー出身のイザベル・ガフィックさん（30）は、セインズベリーのTuシリーズのほうが、同じような価格でより高品質の服が揃っていると感じている。それは「基本的には本当に良い」と彼女は言います。
お金を節約するために、彼女はチャリティー ショップ、車のトランクの販売、Vinted などのサイトから、可能な限り中古の服も購入しています。
彼女は毎週チャリティー ショップを訪れ、掘り出し物を見つける「宝探し」のような感覚が大好きです。
プライマークは、価格を引き下げるだけでなく、衣服の品質、フィット感、スタイルも改善していると述べている。
ミンテルのアナリスト、ブリジット・マカスカー氏は、生活費危機は人々が衣服に費やす額にも影響を与えていると語る。
ミンテルの調査によると、衣料品購入者の約 3 分の 1 が、過去 12 か月に比べて衣料品を購入する頻度が減ったと言っています。
マカスカー氏によると、買い物客は、着用ごとのコストを考えるなど、購入から価値を得ることにより重点を置いているという。プライマークの最新の取引最新情報では、「厳しい消費者環境」について言及した。
ジャンパーやジーンズから数ポンドの利益を得るのは、顧客にとっては大したことではないように思えるかもしれませんが、プライマークのような利益率が厳しい店にとって、これはビジネスにどのような影響を与えるでしょうか?
プライマークの広報担当者はBBCニュースに対し、「当社のビジネスモデルと、大量購入とコストの抑制に重点を置いているため、適正な価格を提供することができているが、そのために品質や倫理に妥協はしていない」と語った。
最新の年次報告書では、同社製品の約85％が10ポンド以下であると述べた。
重要なのは、新たな低価格は、Primark が販売するすべてをカバーするわけではありません。マカスカー氏は、値下げはより多くの買い物客を呼び込むためのマーケティング活動であると説明し、たとえジーンズやジャンパーの低価格に惹かれたとしても、最終的には他の商品もカゴに入れることになるだろうと言う。
「プライマークはその衝動的な性質で知られています」と彼女は説明する。
一部のファッション小売業者にとって大きな問題の 1 つは、大量の在庫が大量に残っていることです。在庫を大幅に値下げして、それをシフトする必要があります。 AJ Bellのアナリスト、ラス・モールド氏は、プライマークは価格変更が「在庫の移動に役立つだろう。つまり、これ以上大幅な値引きをする必要がなくなる」と期待しているだろう。
最終的にアナリストらは、プライマークの新しい価格設定は競争の激しい小売環境に対応したものだと考えている。
「今日の顧客との関連性を維持するには、金額に見合った価値を提供する必要があります」とバーグ氏は言います。
「特に英国で価値あるファッション小売業者になるつもりなら、その約束を果たさなければなりません。」
その他の週末のおすすめ
- 2025 年 1 月 12 日公開
- 2025 年 8 月 16 日公開
- 2025 年 8 月 17 日公開`,
    ...
    publishedAt: "2026-07-26T00:17:50+00:00",
    category: "自動車",
    imageUrl: "https://ichef.bbci.co.uk/ace/standard/240/cpsprodpb/a888/live/501dd8b0-86b2-11f1-8c61-e72dd81a46e3.jpg",
    readTime: 7,
  },
  {
...
- 4 月 30 日発行`,
  ...
  },
  {
    ...
    summaryJa: "2026 年に最も注目を集めるハイテク取引が大打撃を受けました。賢明な投資家はとにかく買っています。",
    bodyOriginal: `The hottest tech trades of 2026 just got slammed — smart investors are buying anyway.`,
    bodyJa: `2026 年に最も注目を集めるハイテク取引が大打撃を受けました。賢明な投資家はとにかく買っています。`,
    source: "MarketWatch",
    ...
    publishedAt: "2026-07-25T18:59:00+00:00",
    category: "テクノロジー",
    imageUrl: "https://images.mktw.net/im-10664338",
    readTime: 2,
  },
  {
    id: "college-kids-are-moving-into-retirement-36118b13",
    title: "College kids are moving into retirement communities for reasons beyond ‘cheap rent’",
    titleJa: "大学生が「家賃の安さ」以外の理由で退職者コミュニティに移住している",
    summaryJa: "学生たちは試合の計画を立てたり、体育の授業を教えたりしながら、世代間の絆を築いていますが、「ここでは7時半か8時になると、かなり静かになります。」",
    bodyOriginal: `Students are forging intergenerational bonds while planning game nights and teaching gym classes, but “by 7:30 or 8, things get pretty quiet here.”`,
    bodyJa: `学生たちは試合の計画を立てたり、体育の授業を教えたりしながら、世代間の絆を築いていますが、「ここでは7時半か8時になると、かなり静かになります。」`,
    source: "MarketWatch",
    ...
    publishedAt: "2026-07-25T18:54:00+00:00",
    category: "金融政策",
    imageUrl: "https://images.mktw.net/im-85769550",
    readTime: 2,
  },
  {
    id: "is-your-index-fund-an-accidental-bet-on-36335312",
    title: "Is your index fund an accidental bet on AI? These two massive ETFs show why it might be.",
    titleJa: "あなたのインデックスファンドは偶然AIに賭けたものですか？これら 2 つの大規模な ETF は、その理由を示しています。",
    summaryJa: "新興国ファンドにとって韓国株は大したことはなかった。人工知能がそれを変えました。",
    bodyOriginal: `South Korean stocks weren’t a big deal in emerging-markets funds. Artificial intelligence changed that.`,
    bodyJa: `新興国ファンドにとって韓国株は大したことはなかった。人工知能がそれを変えました。`,
    source: "MarketWatch",
    ...
    publishedAt: "2026-07-25T18:45:00+00:00",
    category: "テクノロジー",
    imageUrl: "https://images.mktw.net/im-84895671",
    readTime: 2,
  },
  {
    id: "oil-prices-may-fall-but-gasoline-prices-34b7ebd4",
    title: "Oil prices may fall, but gasoline prices won’t. Look at the trap we’re in.",
    titleJa: "原油価格は下がるかもしれませんが、ガソリン価格は下がりません。私たちが陥っている罠を見てください。",
    summaryJa: "イラン戦争のせいで光熱費が高騰しているわけではありません。それはウォール街のせいだ。",
    bodyOriginal: `The Iran war isn’t causing your energy bill to soar. Blame Wall Street for that.`,
    bodyJa: `イラン戦争のせいで光熱費が高騰しているわけではありません。それはウォール街のせいだ。`,
    source: "MarketWatch",
    ...
    publishedAt: "2026-07-25T18:34:00+00:00",
    category: "エネルギー",
    imageUrl: "https://images.mktw.net/im-81565111",
    readTime: 2,
  },
  {
    id: "here-s-the-net-worth-you-need-to-start-g-37d13df4",
    title: "Here’s the net worth you need to start getting ahead in your 20s, 30s, 40s and beyond in the U.S.",
    titleJa: "米国で20代、30代、40代、そしてそれ以降に成功し始めるために必要な純資産は次のとおりです。",
    summaryJa: "アスペン研究所が開発した新しいベンチマークによると、アメリカ人の約4分の3は今日の経済で繁栄するために必要な富が不足しているという。",
    bodyOriginal: `About three-fourths of Americans lack the wealth needed to prosper in today’s economy, according to a new benchmark developed by the Aspen Institute.`,
    bodyJa: `アスペン研究所が開発した新しいベンチマークによると、アメリカ人の約4分の3は今日の経済で繁栄するために必要な富が不足しているという。`,
    source: "MarketWatch",
    ...
    publishedAt: "2026-07-25T18:15:00+00:00",
    category: "マクロ経済",
...
- 14 時間前に公開`,
  ...
  },
  {
    ...
    titleJa: "フランスとスペインの山火事で25万人以上が避難",
    summaryJa: "フランスとスペインの山火事で25万人以上が避難- 公開されました",
    bodyOriginal: `More than 250,000 flee wildfires in France and Spain
- Published
Firefighters are struggling to contain wildfires in south-west France as strong winds push flames towards the city of Bordeaux, with one official saying they "are far from having the fire under control."
...
Additional reporting by Mary Litchfield, BBC Your Voice and Srosh Khan, BBC Newsbeat
Related topics
- Published5 hours ago
- Published7 hours ago
- Published16 hours ago`,
    bodyJa: `フランスとスペインの山火事で25万人以上が避難
- 公開されました
強風により火がボルドー市に押し寄せる中、フランス南西部の山火事の鎮火に消防士らが苦戦しており、ある当局者は「鎮火には程遠い」と述べた。
フランスとスペインでは、風と高温により鎮火努力が妨げられる中、数日間続いている火災から25万人以上が避難している。一夜にして、ボルドー西側の7つの町は住民に避難するよう命じられた。
非常事態が宣言されているスペインでは、気象状況の変化によりマドリード郊外の消防士らが救援されている。
スペインのペドロ・サンチェス首相は「今後は複雑な時代」が来ることを認めた。一方、バレンシア当局は火災による男性の死亡を確認した。
地元メディアの報道によると、男性は70代とみられ、マニセスのサルト・デ・リーグア渓谷で火災を消火していた消防士によって車の中で死亡しているのが発見された。
フランスでは、南西部のジロンド州とランド州で約２０万人が避難している。
フランスは対応を支援するために軍を動員し、藪を刈ったり防火帯を設けたりする消防士を支援するために軍からの追加援軍が派遣された。
土曜日朝の時点で、山火事はボルドーから約40キロから50キロ（25マイルから30マイル）離れたところにあった。それでも、風が市に向かって煙を吹き飛ばしており、人々は空気中に刺激的な臭いが漂っていると報告した。
ボルドー近郊で迫りくる山火事から家族とともに避難したある観光客は、火災の規模が「恐ろしい」と述べた。
スペンサー・ランダルさんはBBCに対し、家族は土曜日の早朝に160マイル東の地域に避難したが、「ここからはまだ山火事の匂いがする」と語った。
「非常に強い風が炎をあおっていて、ただただ恐ろしいです」と彼は言った。
ボルドーで休暇を過ごしていた英国人夫婦は、金曜日の夜、火災が近づくにつれて炎が悪化していることに気づいたと語った。
「7時ごろから煙の匂いが漂ってきました。誰かがバーベキューをしているのではないかと思いました」とメイジーさんは貸別荘からBBCニュースビートに語った。
パートナーのケイレブさんは、今では灰が家の中のプールを覆い、外を歩いていると足が真っ黒になってしまったと語った。
煙は「本当にすぐに肺に当たる」と彼らは付け加えた。
近くのサントーバン・ド・メドックでは、避難中の住民らは状況が「ストレスフル」だと述べ、地元住民の１人は「災害」だと述べた。
日曜日に開催予定のツール・ド・フランスの最終区間は、山火事の影響を受けた地域に治安部隊を再配置できるようにするため、距離が133キロ（83マイル）から89キロ（55マイル）に短縮されたと主催者と警察が発表した。
フランス全土で30件ほどの火災が発生している中、エマニュエル・マクロン大統領は閣僚らと緊急会合を開く予定だが、政府はこれはまったく前例のない状況だとしている。
スペインではマドリード近郊で火災が続いているが、地方政府はある程度の進展があったと発表した。
「風が少なく、湿度が高く、気温が低いという気象条件の変化は、森林火災との闘いに大きな恩恵をもたらした。森林火災はほとんど進行しておらず、規模も減少している」とX紙に書いた。
マドリード南西部のセニシエントスで講演したサンチェス首相は、「今、私たちには山火事に立ち向かい、人命を守り、命を守り、効果的に火災の鎮火を試みる好機が与えられている」と述べた。
「気温が少し下がったのは事実です。それでも風が強いので、雷雨になる可能性もあります。」
スペイン内務省によると、スペインで山火事が発生して以来、マドリードとアビラ地域から６万人近くが避難し、２万８千人以上が自宅に閉じ込められたままだ。
マドリッドの地域会長イザベル・ディアス・アユソは、この状況を「地域史上最悪の火災」と表現した。
サンチェス氏は、スペインでは今年これまでに13万ヘクタールの土地が焼かれており、過去10年間の同国の年間平均10万ヘクタールを上回っていると述べた。
フランスの内務大臣ローラン・ヌニェスは、2026年初め以来フランス全土で9万8000ヘクタールが焼失したと述べた。
一方、イタリアでは、シチリア島で10件の大火災を含む350件以上の火災が発生し、避難を促したとシチリア国民保護局長が水曜日に発表した。
ケアンゴームズ国立公園で10日間燃え続けている山火事への取り組みを続けているスコットランドの緊急サービスも、金曜夜に重大な事件が発生したと宣言した。
EUのハジャ・ラービブ危機管理担当委員は、欧州の山火事による被害は過去の記録を上回る可能性が高いと述べた。
同氏は、火災は今年の初めに発生し、オランダが4月にEUの国民保護メカニズムを発動し、他国からの支援や援軍が始まったと述べた。
ラービブ氏はBBCに対し、「昨年の夏には100万ヘクタールが焼失し、今年の早い時期にシーズンが始まったため、また歴史的で悲しい記録に直面することが予想されている」と語った。
同氏はまた、夏が進むにつれてさらに感染が拡大する可能性があると警告した。
「残念ながら、予報官らは再び熱波が来ると予測しているため、他の山火事も予想される」とラービブ氏は付け加えた。
フランスは国民保護メカニズムを発動し、クロアチアからカナダ航空3機、ポルトガルからエアトラクター2機で構成される水爆撃機、さらにチェコ共和国とスロバキアからブラックホークヘリコプター、ルーマニア森林消防隊隊員40名を受け入れる予定である。
欧州委員会のウルズラ・フォンデアライエン委員長は、EUの消防隊から11機の飛行機とヘリコプターもフランスとスペインに派遣されたと述べた。
BBC Your Voice の Mary Litchfield と BBC Newsbeat の Srosh Khan による追加レポート
関連トピック
- 5 時間前に公開
- 7 時間前に公開
- 16 時間前に公開`,
    ...
    publishedAt: "2026-07-25T17:13:40+00:00",
    category: "自動車",
    imageUrl: "https://ichef.bbci.co.uk/ace/standard/240/cpsprodpb/8783/live/30d9e7b0-880f-11f1-afbe-b9a38c21b1d6.jpg",
    readTime: 6,
  },
  {
    id: "trump-takes-swipes-at-press-during-white-10aed7e0",
    title: "Trump takes swipes at press during White House Correspondents' Dinner",
    titleJa: "トランプ大統領、ホワイトハウス特派員夕食会中に報道陣を強襲",
    summaryJa: "トランプ大統領、ホワイトハウス特派員夕食会中に報道陣を強襲- 公開されました",
    bodyOriginal: `Trump takes swipes at press during White House Correspondents' Dinner
- Published
...
Since his second term began, Trump has repeatedly suggested he would run for a third term, despite the 22nd Amendment of the US Constitution mandating a two-term limit. The amendment was ratified in 1951 after President Franklin D Roosevelt served four consecutive terms. Trump has campaigned for president three times, and won two of the elections.
...
Related topics
- Published27 April`,
    bodyJa: `トランプ大統領、ホワイトハウス特派員夕食会中に報道陣を強襲
- 公開されました
ドナルド・トランプ米大統領は、報道の自由を祝うホワイトハウス特派員協会（WHCA）の晩餐会で、最初のイベントが3カ月前の銃撃事件で中止になったことを受けてメディアを激しく非難した。
ニューヨーク・タイムズ、CNN、ウォール・ストリート・ジャーナルなど、彼がスパーリングをし、さらには訴訟を起こしたこともある報道機関の記者たちが、賞を授与されるために登場する中、大統領は座っていた。
通常、大統領は年次晩餐会では気楽な口調になるが、トランプ大統領は「二回目のほうがずっと良い」と冗談を飛ばし、メディアを称賛し、「ほとんどのメディア」を尊重していると述べた。
しかし、彼が「フェイクニュース」に辛辣な言葉を向け、会場にいた多くの人が「トランプ錯乱症候群」に陥っていると非難したことで、その論調は変化した。
CBSニュースのWHCA会長、ジャン・ウェイジア氏は発言の中で、イベントは来年4月に銃乱射事件が起きたワシントン・ヒルトンで開催される予定だと述べた。ヒルトンの警備が不十分だとの批判を受け、金曜日に延期されたイベントは、会場から数マイル離れたウォルドーフ・アストリアで開催された。
退任するWHCA長官は、4月の最初の夕食会で銃撃犯がタックルを受けたことに触れ、「暴力行為に最終決定を下すことを拒否する」と述べた。
現場で射殺された米国秘密情報局のビクター・ゴンザレス将校は、銃撃の夜の行動が評価され、トランプ大統領から賞を授与された。
トランプ大統領は「３カ月前に言ったように、ショーは続けなければならない」と語った。
トランプ大統領は「私の大統領就任と同じように、2回目は常に良くなる。そして3回目はさらに良くなるだろう…冗談だよ」と冗談めかして3期目の大統領選に出馬するつもりだと語った。
トランプ大統領は立ち上がって受賞者たちと握手を交わしたが、その中には不名誉な投資家ジェフリー・エプスタインとのトランプ大統領の関係報道で賞を受賞したウォール・ストリート・ジャーナルのチームも含まれていた。
イベントに先立ち、ホワイトハウス記者団の多くは、トランプ大統領が、わずか数メートル離れた席に座っている記者の多くを批判することが多いが、メディアを厳しく叱責するだろうと理論立てていた。
トランプ大統領の演説には、同席していた数人のジャーナリストに対する鋭い侮辱が含まれていた。同氏の1時間にわたる演説は身近な標的にも向けられており、より厳しい口調と個人攻撃は民主党の政治家や著名人にも及んだ。
しかし、米国大統領はまた、米国人に言論の自由を尊重するよう呼び掛けた。
トランプ大統領は「われわれは意見の相違を銃弾で解決するのではなく、オープンかつ精力的な議論で解決する」と述べた。 「そして、銃を持った狂気の敗者がこの状況を変えることは絶対にありません。私たちはそんなことが起こることを決して許すことはできません。」
トランプ大統領はイベント中ずっとご機嫌だったようで、「皆さんの中には私のことを嫌いな人もいると時々本当に思う」とメディアに冗談めかして語った。
「この場所（夕食会）は、まさに『トランプ錯乱症候群』の人々が一度に集まった最大のグループだ」と同氏は語った。 「最後の夕食が短くなって幸運だった人もいると思います...私はあなたを追いかけるつもりでした。」
大統領は、トランプ2028の帽子をかぶって次期出馬するつもりだと語った前に、「報道する人がいなくなる」ため、退任後は報道業界が「破産する」だろうと冗談を言った。
トランプ大統領は「米国大統領として4期目に出馬する意向を発表できてうれしいが、これはちょっとしたスクープだ」と冗談を飛ばし、明らかに4度目の出馬を意味しているようだ。
2期目の任期が始まって以来、合衆国憲法修正第22条で任期は2期までと定められているにもかかわらず、トランプ大統領は繰り返し3期目に出馬する考えを示唆してきた。この修正案は、フランクリン・D・ルーズベルト大統領が連続4期務めた後の1951年に批准された。トランプ氏はこれまでに3回大統領選に出馬し、うち2回の選挙で勝利した。
ガラディナーは、ホワイトハウスとメディアの関係が依然として険しい中で開催された。
先週、トランプ大統領は、選挙の安全に関するゴールデンタイムの演説を放送しなかった米国の複数のネットワークのライセンスを取り消すと脅した。
このイベントは、最初の特派員夕食会から大幅に規模を縮小し、4月には2,000人以上が参加したが、出席者は約700人となった。
警備も厳重になりました。ホテル周辺のいくつかのブロックは封鎖され、警察と州兵が厳重に配備された。ゲストはQRコードとIDによる検査を2回受け、リストバンドが渡された。
ある時点で、訪問者はライフルを持った2人のシークレットサービス職員の前を一列に並んで歩くよう促された。
4月の銃撃事件の容疑者は31歳のコール・トーマス・アレンと特定され、米国大統領暗殺未遂の罪で起訴された。
彼は、夕食会が始まっていた宴会場に続く階段の手前でエージェントらにタックルされた。
土曜の夜にはピート・ヘグセス国防長官、トッド・ブランシュ司法長官代理、カシュ・パテルFBI長官、スコット・ベッセント財務長官、ハワード・ラトニック商務長官も出席した。
関連トピック
- 4 月 27 日公開`,
    source: "BBC",
    sourceUrl: "https://www.bbc.co.uk/news/articles/cd7le4ylev2o?at_medium=RSS&at_campaign=rss",
    publishedAt: "2026-07-25T13:51:07+00:00",
    category: "金融政策",
...
同氏は、「ビジネスの観点から見ると、これは企業が関税がすぐに撤回されたり変更されたりすると想定するのではなく、現在存在する関税を中心に計画を立てる必要があることを意味する」と述べた。`,
  ...
  {
    id: "ten-killed-in-russian-attack-on-drone-ex-8633dd45",
    title: "Ten killed in Russian attack on drone exhibition near Kyiv",
    titleJa: "キエフ近くのドローン展示会へのロシアの攻撃で10人死亡",
    summaryJa: "キエフ近くのドローン展示会へのロシアの攻撃で10人死亡- 公開されました",
    bodyOriginal: `Ten killed in Russian attack on drone exhibition near Kyiv
- Published
At least 15 people have been killed in Russian attacks on Ukraine, including 10 dead in ballistic missile strikes on an exhibition near Kyiv showcasing drone technology.
Ukrainian President Volodymyr Zelensky said some 100 people had been injured in the daytime attack on the exhibition, attended by prominent members of the defence sector.
Five people were also killed by Russian glide bombs in the eastern city of Sloviansk. Early on Saturday, military officials confirmed the deaths of two men in the northern city of Sumy.
On Friday evening, Zelensky said he had received intelligence that Russia was preparing another massive missile strike, which could happen "within the next 48 hours".
A Ukrainian strike on Friday killed six people and wounded 26 in the Russian city of Kirov, more than 1,000km (600 miles) behind the front line. Ukraine also attacked warehouses of Wildberries - Russia's biggest online retailer.
After the attacks near Kyiv, there were initially fears for the safety of Defence Ministry adviser Serhiy Beskrestnov, also known as Flash, and Lyuba Shypovych, who has been involved in developing technology for the Ukrainian army.
Following the incident, both took to social media to confirm they were unharmed, and Beskrestnov said he had stayed away from the event because of security concerns.
Ukrainian air force spokesman Yuri Ihnat told Ukrainian TV the attack involved three ballistic missiles, only one of which was intercepted.
Russia confirmed the attack. Its Defence Ministry said high-precision long-range weaponry had been used on a site where drones for use in targeting civil sites in Russia were being demonstrated.
It said producers of drones, as well as representatives of Ukraine's drone forces and security services "directly planning and carrying out strikes on Russian territory" were present.
This is at least the third time since Russia's full-scale invasion in 2022 that an exhibition of this kind has been hit.
There has been widespread outrage that a public event of this kind was being held at all and had, apparently, been widely advertised.
President Zelensky said the incident was being investigated, while Ukraine's prosecutor-general said efforts were under way to establish who decided to hold the event and what safety measures were in place.
The attack came hours after the Ukrainian strikes on a factory in the city of Kirov and warehouses in north-west Russia.
Zelensky said "one of the most important military facilities" in Kirov supplying "components for aircraft and missile equipment" used in strikes against Ukraine had been hit.
Friday's attacks on at least two Wildberries facilities in the St Petersburg area were the latest of several over the past week.
The attacks on the retailer have dealt a blow to a large number of small and medium-sized businesses within Russia.
After months of drone attacks on oil depots and refineries, Kyiv says it is targeting logistics hubs - such as those run by Wildberries - because they can be used to buy military equipment, in order to disrupt supplies to the Russian army.
Meanwhile Zelensky is expected to travel to the US next week, and is slated to meet President Donald Trump on Tuesday, a White House official said, as Washington seeks to revive peace talks between Ukraine and Russia.
Trump ally Laura Loomer, who is in Kyiv and on Friday interviewed Zelensky, quoted him as saying he intends to go to the funeral of US Senator Lindsey Graham on the same day.
...
The Romanian authorities had earlier issued alerts across several eastern and south-eastern areas.
Related topics
- Published2 days ago`,
    bodyJa: `キエフ近くのドローン展示会へのロシアの攻撃で10人死亡
- 公開されました
ロシアによるウクライナ攻撃で少なくとも15人が死亡し、その中にはキエフ近くのドローン技術を展示する展示会への弾道ミサイル攻撃で10人が死亡した。
ウクライナのウォロディミル・ゼレンスキー大統領は、防衛部門の著名なメンバーらが参加した展示会への昼間の攻撃で約100人が負傷したと述べた。
スロビアスク東部の都市でもロシアの滑空爆弾により５人が死亡した。土曜日早朝、軍当局は北部スーミ市で男性２人の死亡を確認した。
ゼレンスキー大統領は金曜夜、ロシアがさらなる大規模なミサイル攻撃を準備しており、「今後48時間以内に」起こる可能性があるとの情報を受け取ったと述べた。
金曜日のウクライナ空爆により、前線から1,000キロ以上後方にあるロシアのキーロフ市で6人が死亡、26人が負傷した。ウクライナはまた、ロシア最大のオンライン小売業者であるワイルドベリーの倉庫を攻撃した。
キエフ近郊での攻撃後、当初はフラッシュとしても知られる国防省顧問セルヒー・ベスクレストノフ氏と、ウクライナ軍の技術開発に携わってきたリュバ・シポビッチ氏の安全が懸念された。
事件後、2人はソーシャルメディアで無傷であることを確認し、ベスクレストノフさんは安全上の懸念からイベントに参加しなかったと述べた。
ウクライナ空軍報道官ユーリ・イナト氏はウクライナテレビに対し、攻撃には３発の弾道ミサイルが使われたが、迎撃できたのは１発だけだったと語った。
ロシアは攻撃を確認した。国防省は、ロシアの民間施設を標的とするドローンの実証実験が行われていた現場で、高精度の長距離兵器が使用されたと発表した。
無人機の生産者のほか、「ロシア領土への攻撃を直接計画し、実行している」ウクライナの無人機部隊と治安機関の代表者も出席したと発表した。
この種の展示会が打撃を受けるのは、2022年のロシアによる全面侵攻以来、少なくとも3回目となる。
この種の公的イベントがそもそも開催されており、明らかに広く宣伝されていたことに対して、激しい怒りが広がっている。
ゼレンスキー大統領は、この事件は捜査中であると述べ、一方、ウクライナの検事総長は、誰がイベントの開催を決定したのか、どのような安全対策が講じられていたのかを明らかにする取り組みが進められていると述べた。
この攻撃は、ウクライナ軍がキーロフ市の工場とロシア北西部の倉庫を攻撃した数時間後に起きた。
ゼレンスキー大統領は、ウクライナへの攻撃で使用される「航空機やミサイル装備の部品」を供給するキーロフの「最も重要な軍事施設の１つ」が攻撃されたと述べた。
サンクトペテルブルク地域にある少なくとも2つのワイルドベリー施設に対する金曜日の攻撃は、過去1週間に起きたいくつかの攻撃のうちの最新のものであった。
この小売店への攻撃はロシア国内の多数の中小企業に打撃を与えた。
石油貯蔵所や製油所に対する数か月にわたる無人機攻撃を受けて、キエフ政府は、ロシア軍への物資供給を妨害するため、軍事装備品の購入に利用できるため、ワイルドベリー社が運営する物流拠点などを標的にしていると述べた。
一方、米政府がウクライナとロシアの和平交渉の再開を目指している中、ゼレンスキー氏は来週訪米する予定で、火曜日にはドナルド・トランプ大統領と会談する予定だとホワイトハウス当局者が明らかにした。
キエフを訪れ金曜日にゼレンスキー氏と面談したトランプ大統領の盟友ローラ・ルーマー氏は、ゼレンスキー氏が同日にリンゼー・グラハム上院議員の葬儀に出席するつもりだと述べたと伝えた。
一方、ルーマニアのニクソール・ダン大統領は金曜日、ルーマニアのF-16戦闘機が領空を侵犯したロシアの無人機を撃墜したと述べた。
ルーマニア当局はこれに先立ち、東部と南東部の複数の地域に警報を発令していた。
関連トピック
- 2 日前に公開`,
    source: "BBC",
    sourceUrl: "https://www.bbc.co.uk/news/articles/cj637zd1k1ko?at_medium=RSS&at_campaign=rss",
    publishedAt: "2026-07-25T00:06:53+00:00",
    category: "エネルギー",
...
この話で提起された問題によってあなたは個人的に影響を受けていますか?`,
  ...
  {
    id: "zelensky-tries-to-fix-crisis-over-remova-99ae8eb2",
    title: "Zelensky tries to fix crisis over removal of defence minister and counts the cost",
    titleJa: "ゼレンスキー氏、国防相解任をめぐる危機解決に努め、そのコストを計算",
    summaryJa: "ゼレンスキー氏、国防相解任をめぐる危機解決に努め、そのコストを計算- 公開されました",
    bodyOriginal: `Zelensky tries to fix crisis over removal of defence minister and counts the cost
- Published
With an acting defence minister in place and a new commander-in-chief in charge of the military, Ukraine's recent political crisis is over, right?
Not so fast.
...
"If you don't have a ministry under you, you don't have a budget," ex-deputy defence minister Alina Frolova said, "and you don't actually have the authority to do something."
Fedorov's reference to the presidency did not go unnoticed. Was this the first public sign that the ousted minister sees himself as a rival to Zelensky?
One former defence official suggested he became a real candidate for the presidency the moment he was dismissed.
But with the country at war and no elections scheduled – Ukraine's constitution still prevents them in wartime – how useful is it to put your head above the political parapet so far in advance?
"He's being childish," one opposition MP told me, on condition that he remained anonymous.
"He's looking to further his political career, which I think is just stupid in the circumstances where we are."
The president's supporters say Zelensky has gone to great lengths to resolve the crisis, especially over the question of who to replace the unpopular commander-in-chief, Oleksandr Syrskyi.
Eventually he decided on Maj Gen Mykhailo Drapatyi, 43, a highly respected former commander of Ukraine's land forces.
"He consulted pretty much every significant figure in the Ukrainian army," former government adviser Yuriy Sak told the BBC earlier this week.
"So the decision that he has taken now is very well informed, and I support it because General Drapatyi is a young, battle-proven, modern general who will take our defences to a new level, hopefully."
But while Drapatyi's appointment has been generally welcomed, it only represents a partial fix by a president scrambling to repair the damage caused by his removal of Fedorov.
Ironically, for a president whose youth and apparent dynamism propelled him to power in 2019, Zelensky seems to have misjudged the mood of young Ukrainians, eager for their leaders – political and military – to represent their values and aspirations.
"It's quite natural that people want to see someone who is a warrior against corruption, who is very modern, who is young," Oleksandr Merezhko, an MP from Zelensky's Servant of the People party, said.
"People want to see something like that in politics, which they consider to be dirty and full of hypocrisy. They need heroes."
...
- Published3 days ago
But Merezhko agrees that Fedorov's ambitions and almost mythic, popular status may have brought about his downfall, especially for a president with a track record of sidelining those he sees as potential rivals.
"Don't outshine your master," Merezhko says, quoting from Robert Greene's 1998 self-help book, The 48 Laws of Power.
Most analysts agree that last week's reshuffle had one overarching purpose: to cut Fedorov down to size. But Zelensky's strategy appears to have backfired.
"His removal has led to the opposite result," Merezhko says. "His rating soared. Just soared."
Few doubt Fedorov's commitment, imagination and drive, but some question whether his outsized reputation is fully justified.
They point out that he inherited a situation in which Ukraine had already successfully built up its medium- and long-range strike capabilities, something over which the defence minister has little day-to-day influence.
"The energy and clarity he brought to the job was impressive and he showed immense personal courage," a former European defence official said. "But the thing that will carry on regardless is the innovation culture. It's 2,000 companies, not a single individual."
One opposition MP, who asked not to be identified, put it more bluntly.
"Ninety-nine per cent of these young people on the street have no clue how the ministry of defence is operating, how the general staff is operating," he said.
"They think Fedorov is good because he wants to fight with drones and Syrskyi was bad because he was looking for people to fight. It's a dramatic simplification which is totally wrong."
But understandable, perhaps, in a country exhausted by 12 years of war with Russia. Who would not want to believe that drones and robots can do the job, rather than a member of your own family, roughly conscripted on the streets of your own hometown?
Everyone agrees that Ukraine needs to put this politically toxic episode behind it before summer gives way to autumn and the country braces itself for another Russian assault on its energy grid.
"We need to prepare for how we will get through the winter," Zelensky said on the Telegram messaging app on Thursday.
Politicians and experts interviewed for this piece mostly agree that while the political damage of this episode continues to undermine President Zelensky's authority and reputation, Ukraine is unlikely to experience significant setbacks on the battlefield.
What Zelensky calls his "long-range sanctions" campaign against Russia is in full swing, causing mounting damage to the Russian economy.
Ukraine's long front lines, meanwhile, remain largely static, thanks to a 15-30km (9-18-mile) wide "kill zone" where anything or anyone who moves is observed and attacked by drones.
As a young, still relatively immature democracy, Ukraine's institutions have been put under colossal strain by Russia's full-scale invasion. But, many argue, the country remains resilient and resourceful.
"The secret of Ukraine's success is that we are much stronger horizontally than vertically," opposition MP Andrii Osadchuk told me.
"I hope the damage will be minimal."`,
    bodyJa: `ゼレンスキー氏、国防相解任をめぐる危機解決に努め、そのコストを計算
- 公開されました
国防大臣代理が就任し、軍を統括する新しい最高司令官が誕生したことで、最近のウクライナの政治的危機は終わった、そうですよね？
それほど速くはありません。
7月15日、内閣改造の一環としてミハイロ・フェドロフを国防大臣に再任しないというウォロディミル・ゼレンスキー大統領の決定による政治的影響は、空襲警報が鳴り響き、ロシアの無人機やミサイルが頭上で迎撃される中でも、キエフとその周辺に反響を呼び続けている。
若者を中心とするフョードロフ氏の支持者らは今も毎日街頭抗議活動を強化しており、最近のウクライナの技術革新の多くを推進したと広く認められている人気の若い革新者をゼレンスキー氏に復帰させるよう要求している。
木曜日、フョードロフ氏は、ゼレンスキー氏による政府内での代替ポストの申し出を拒否したと述べ、戦争の行方に影響を与える価値のあるポストは国防大臣、軍司令官、ウクライナ大統領の３つだけだと述べた。
元国防副大臣アリーナ・フロロワ氏は、「管轄省庁がなければ予算もない。実際に何かをする権限もない」と語った。
フョードロフ氏の大統領職への言及は注目を集めなかった。これは、追放された大臣が自分自身をゼレンスキー氏のライバルだと考えていることを初めて公に示したものだったのだろうか？
ある元国防当局者は、解任された瞬間に彼が真の大統領候補になったと示唆した。
しかし、この国は戦争状態にあり、選挙は予定されていない――ウクライナ憲法は依然として戦時中の選挙を禁止している――事前に政治的欄干に頭を上げておくことがどれほど役に立つだろうか？
「彼は子供じみている」と野党議員の一人は匿名を条件に私に語った。
「彼は政治家としてのキャリアをさらに深めようとしているが、私たちが置かれている状況ではそれは愚かなことだと思う。」
大統領の支持者らは、ゼレンスキー氏が危機解決に向けて多大な努力を払っており、特に不人気なオレクサンドル・シルシキー最高司令官の後任を誰にするかという問題をめぐって、多大な努力を払ってきたと主張している。
最終的に彼は、ウクライナ陸軍の元司令官で非常に尊敬されているミハイロ・ドラパティ少将（43）に決定した。
「彼はウクライナ軍のほぼすべての重要人物と相談した」と元政府顧問ユーリー・サク氏は今週初めにBBCに語った。
「したがって、彼が今下した決断は非常に十分な情報に基づいており、私はそれを支持します。なぜならドラパティ将軍は若い、戦いで実績のある現代の将軍であり、願わくば私たちの防衛を新たなレベルに引き上げてくれるでしょう。」
しかし、ドラパティ氏の任命はおおむね歓迎されているものの、フョードロフ氏の解任によって生じた損害の修復に奔走する大統領による部分的な解決策にすぎない。
皮肉なことに、若さと見かけのダイナミズムが2019年に権力の座についた大統領にしては、ゼレンスキー大統領は、政治的・軍事的指導者たちに自分たちの価値観や願望を代表してもらうことを切望する若いウクライナ人の気分を見誤ったようだ。
ゼレンスキー氏率いる国民の奉仕党の国会議員オレクサンドル・メレシュコ氏は、「汚職と闘う戦士、非常に現代的で若い人物を人々が求めるのはごく自然なことだ」と語った。
「人々は、政治が汚くて偽善に満ちていると考えているので、そのようなものを政治の中に見たいと思っています。彼らは英雄を必要としています。」
追放されたウクライナ国防相、復職を主張
- 1 日前に公開
ウクライナの新しい最高司令官ミハイロ・ドラパティとは誰ですか?
- 2 日前に公開
ウクライナで軍司令官の将来を巡り争い激化
- 3 日前に公開
しかしメレジコ氏は、特に潜在的なライバルと見なす人々を脇に追いやってきた実績を持つ大統領にとって、フョードロフ氏の野心とほとんど神話的ともいえる人気の高い地位が彼の失脚をもたらした可能性があることに同意する。
「主人を超えてはいけない」とメレシュコは、ロバート・グリーンの1998年の自己啓発本『力の48の法則』から引用して言う。
ほとんどのアナリストは、先週の人事異動には、フョードロフ氏の規模を縮小するという1つの重要な目的があったことに同意している。しかし、ゼレンスキー氏の戦略は裏目に出たようだ。
「彼の解任は逆の結果をもたらした」とメレシュコ氏は言う。 「彼の評価は急上昇した。まさに急上昇した。」
フョードロフの献身性、想像力、意欲を疑う人はほとんどいないが、彼の並外れた評判が完全に正当であるかどうかを疑問視する人もいる。
彼らは、ウクライナがすでに中長距離攻撃能力の構築に成功しており、国防大臣が日常的にほとんど影響力を持たない状況を同氏が引き継いだと指摘している。
「彼が仕事にもたらしたエネルギーと明晰さは印象的であり、彼は計り知れない個人的な勇気を示した」と元欧州国防当局者は語った。 「しかし、関係なく引き継がれるのはイノベーション文化です。それは 2,000 社の企業であり、1 人の個人ではありません。」
ある野党議員は匿名を条件に、もっと率直に語った。
「街頭にいる若者の99％は、国防省がどのように機能しているのか、一般参謀がどのように機能しているのか全く分かっていない」と同氏は語った。
「彼らは、フョードロフは無人機で戦いたいので善人であり、シルシキーは戦う人を探していたので悪者だと考えている。これは劇的な単純化であり、完全に間違っている。」
しかし、ロシアとの12年にわたる戦争で疲弊した国では、おそらく理解できることだろう。自分の故郷の路上で乱暴に徴兵された自分の家族の一員ではなく、ドローンやロボットがその仕事をしてくれると信じたくない人がいるだろうか？
夏が秋に変わり、エネルギー網に対するロシアの新たな攻撃に備える前に、ウクライナはこの政治的に有害なエピソードを棚上げする必要があることに誰もが同意する。
ゼレンスキー氏は木曜、メッセージアプリ「テレグラム」で「冬をどう乗り越えるかについて準備する必要がある」と述べた。
この記事のためにインタビューした政治家や専門家らは、このエピソードによる政治的ダメージがゼレンスキー大統領の権威と評判を傷つけ続けているものの、ウクライナが戦場で重大な後退を経験する可能性は低いとほぼ同意している。
ゼレンスキー大統領がロシアに対する「長期制裁」と呼ぶキャンペーンは本格化しており、ロシア経済へのダメージは増大している。
一方、ウクライナの長い前線は、幅15〜30キロ（9〜18マイル）の「キルゾーン」のおかげで、ほとんど動かないままである。そこでは、移動するあらゆるものや人が監視され、ドローンによって攻撃される。
若い、まだ比較的未熟な民主主義国家であるウクライナの制度は、ロシアの全面的な侵略によって多大な負担にさらされている。しかし、この国は依然として回復力と資源に恵まれていると多くの人が主張している。
「ウクライナの成功の秘密は、我々が垂直方向よりも水平方向にはるかに強いことだ」と野党議員アンドリー・オサチュクは私に語った。
「被害が最小限に抑えられることを願っています。」`,
    source: "BBC",
    sourceUrl: "https://www.bbc.co.uk/news/articles/c1d1gz3n99ro?at_medium=RSS&at_campaign=rss",
    publishedAt: "2026-07-24T23:01:06+00:00",
    category: "エネルギー",
