...
export const articles: Article[] = [
  {
    ...
    summaryJa: "バーナム、生活費軽減のため「定期購読の罠」禁止を前倒し- 公開されました",
    bodyOriginal: `Burnham brings forward ban on 'subscription traps' to ease cost of living
- Published
...
Have you tried to cancel a subscription? Share your experiences`,
    bodyJa: `バーナム、生活費軽減のため「定期購読の罠」禁止を前倒し
- 公開されました
サブスクリプションのキャンセルが容易になり、企業は契約がより高い価格で自動更新される場合にはそれを明確にする必要があるとアンディ・バーナム氏は発表した。
首相はまた、店が、これまではるかに高い価格で小売りされていた商品を偽りの取引を宣伝することを禁止することも計画しており、これは買い物客に、より良い買い物ができると思い込ませるものだ、と述べた。
バーナム氏は、いわゆるサブスクリプションの罠と「ごまかし価格」の取り締まりを終わらせるために、前任のキア・スターマー卿のもとで発表された一連の改革案を前倒しする予定だ。
影の首相メル・ストライドは、この措置を「蒸し返した」と決め付け、首相は「すでにアイデアは尽きている」と述べた。
この計画はキーア卿の下で4月に発表されたが、生活費が高騰する中、家族に「息抜き」を与えるためにバーナム政府によって進められている。
サブスクリプションに関して政府は、今回の変更により、企業は顧客に対して「より明確な事前情報、定期的なリマインダー、より簡単な契約終了」を提供する必要があると述べた。
バーナム氏は議会の休会中に英国歴訪中だが、国民の生活費を助けるために一連の「日常の解決策」を約束した。
同氏は、「人々に生活費を捻出する余地を与えるために、私はできる限りのレバーを引く決意をしている」と語った。
提案されている措置は、消費者が不要なサブスクリプションをキャンセルしやすくし、知らないうちに高額な契約を強いられるのを防ぐことを目的としている。
これらは来春に発効すると予想されていたが、バーナム政権は2027年1月までに施行すると約束した。
4月にこの計画が発表されたとき、政府は、この計画により消費者は合計年間4億ポンド、つまり1人当たり最大170ポンドを節約できると述べた。
当時、商工省は、英国全土で1,000万件の望ましくないアクティブなサブスクリプションが存在すると発表しました。
同報告書によると、350万人以上が「無料または割引トライアルから全額費用の契約にひっそりと転がり」、さらに130万人が予期せぬ自動更新に巻き込まれているという。
すでに計画されている変更に加えて、バーナムは店舗による「ごまかし価格」の使用をやめるとも明言している。これにより、小売業者はセールを強調するために「かつての」価格、でっちあげの割引、または誤解を招く推奨小売価格（RRP）を使用することがなくなります。
政府は今秋、新たな措置をどのように実施するかを決定するための協議を開始する予定だ。
光熱費から 150 ポンド割引されるチャンスを逃している可能性があります - 確認方法は次のとおりです
- 8 時間前に公開
消費者団体 どっち？同社は「信頼できる家庭用ブランドを含む企業が、見た目とは異なる危険な取引で顧客を騙し取っていることを繰り返し摘発してきた」と述べた。
消費者権利政策責任者のスー・デイビス氏はこの発表を歓迎し、政府に対し「迅速に」規則を導入するよう求めた。
しかしストライド氏は、「先週は生活費は問題にはならなかったのに、なぜ労働党が前政権が可決した法案を制定するのにこれほど長い時間がかかったのかを問う必要がある」と述べた。
2024年に保守党の下で可決されたデジタル市場・競争・消費者法は、隠れた手数料やオンライン上の偽レビューを取り締まり、顧客が定期購読をキャンセルしやすくした。
販売商品に虚偽の「当時の」価格を使用することはすでに違法ですが、競争市場庁（CMA）の禁止行為リストには載っていません。
ねずみ講の運営や許可なく品質保証マークを表示するなど、リストに記載されている行為は、消費者への被害を証明する必要がなく、自動的に違法とみなされます。
自由民主党はバーナムに対し、消費者保護に「さらに取り組む」よう要請し、財務省報道官のデイジー・クーパーは「不正業者に対する保護の強化」と、スーパーマーケットの「シュリンクフレーション」（商品を小さくしながら同じ価格で販売する慣行）に対処する措置を求めた。
この発表は、英国でのバス料金の2ポンド上限と家庭用電気代の付加価値税引き下げを受けて、生活費の緩和を目的としたバーナムの最新の介入である。
しかし、ジョン・ヒーリー首相が10月28日に提出する予定の予算案で、より大幅な修正を行うよう圧力を受ける可能性が高い。
しかしヒーリー氏は、政府の支出額を制限する「強力な財政規律」を監督すると明言した。
今の私の権利は何ですか？
ブロードバンドや携帯電話などの特定の契約については、すでにキャンセルする一定の権利がある場合がありますが、それは状況によって異なります。
ブロードバンド速度が遅いなど、提供されるサービスに問題がある場合は、法的にキャンセルする権利がある場合があります。
連絡する
サブスクリプションをキャンセルしようとしましたか?あなたの経験を共有してください`,
    source: "BBC",
    sourceUrl: "https://www.bbc.co.uk/news/articles/cly5x9qlnvjo?at_medium=RSS&at_campaign=rss",
    publishedAt: "2026-08-10T07:16:12+00:00",
    category: "エネルギー",
    imageUrl: "https://ichef.bbci.co.uk/ace/standard/240/cpsprodpb/de42/live/c00a80e0-947e-11f1-870d-5d08c49babb2.jpg",
    readTime: 5,
  },
  {
    id: "australian-rare-earth-miner-surges-as-mu-8441e09a",
    title: "Australian rare earth miner surges as much as 29% after U.S. Department of War investment",
    titleJa: "オーストラリアのレアアース鉱山会社、米国陸軍省の投資を受けて29％も急騰",
    summaryJa: "オーストラリアのサンライズ・エナジー・メタルズ社の株価は、レアアース鉱山会社が世界初のスカンジウム主力鉱山の開発を支援するため米国からの長期債務融資で4億ドルの投資を確保した後、月曜日に最大29％上昇した。トランプ政権によるサンライズへの支持は、中国の長年にわたる鉱物支配打破の一環として、主要経済国がレアアースの供給強化を目指している中で実現した。",
    bodyOriginal: `Shares of Australia's Sunrise Energy Metals jumped as much as 29% on Monday after the rare earth miner secured a $400 million investment in long-term debt financing from the U.S. to support the development of the world's first primary mine for scandium.
The Trump administration's backing for Sunrise comes as major economies seek to shore up supplies of rare earths as part of a push to break China's long-held mineral dominance.
The U.S. Department of War said Friday that its Office of Strategic Capital (OSC) announced a conditional loan commitment to Sunrise to support the company's plans to develop a full scandium value chain, beginning with its primary mining operations at its Syerston Project in New South Wales.
Shares of the Sunrise surged on the news, before paring gains. The stock was last seen trading 16% higher on Monday.
Scandium is considered a highly strategic rare earth element because of its unique properties. It is one of the most effective elements used to strengthen aluminum, while also being flexible and resistant to heat and corrosion.
The silvery-white metal is important for various applications, notably defense and aerospace, as well as providing reliable power for artificial intelligence data centers and other power-constrained infrastructure.
Sunrise Chairman and mining billionaire Robert Friedland described the funding as "a landmark moment" for the company and Australia's mining industry.
"The world has entered an era in which access to critical minerals will shape industrial strength, technology leadership and national security," Friedland said Monday in a statement filed with the Australian Securities Exchange.
...
Western officials have repeatedly flagged Beijing's supply chain dominance as a strategic challenge, with critical mineral demand expected to grow exponentially, particularly as the clean energy transition picks up pace.
Read more
...
The statement came shortly after a meeting between Trump and mining executives last week.`,
    bodyJa: `オーストラリアのサンライズ・エナジー・メタルズ社の株価は、レアアース鉱山会社が世界初のスカンジウム主力鉱山の開発を支援するため米国からの長期債務融資で4億ドルの投資を確保した後、月曜日に最大29％上昇した。
トランプ政権によるサンライズへの支持は、中国の長年にわたる鉱物支配打破の一環として、主要経済国がレアアースの供給強化を目指している中で実現した。
米国陸軍省は金曜日、同省の戦略資本局（OSC）が、ニューサウスウェールズ州のシルストンプロジェクトでの主要採掘事業を皮切りに、完全なスカンジウムバリューチェーンを開発する同社の計画を支援するため、サンライズ社に対する条件付き融資の約束を発表したと発表した。
このニュースを受けてサンライズの株価は急騰したが、その後は値下がりした。同株は月曜日に16％上昇したのが最後に見られた。
スカンジウムは、その独特の特性により、非常に戦略的なレアアース元素と考えられています。アルミニウムを強化するために使用される最も効果的な元素の 1 つであると同時に、柔軟性と耐熱性、耐腐食性を兼ね備えています。
銀白色の金属は、人工知能データセンターやその他の電力に制約のあるインフラストラクチャに信頼性の高い電力を供給するだけでなく、防衛や航空宇宙などのさまざまな用途にとって重要です。
サンライズ会長で鉱業億万長者のロバート・フリードランド氏は、今回の資金調達は同社とオーストラリアの鉱業にとって「画期的な瞬間」だと述べた。
フリードランド氏は月曜、オーストラリア証券取引所に提出した声明で、「世界は重要な鉱物へのアクセスが産業力、技術的リーダーシップ、国家安全保障を形作る時代に入った」と述べた。
「スカンジウムは、今後数十年を形作る技術、産業、防衛能力をサポートする最も明確な例の1つです」と彼は付け加えた。
中国は、重要な鉱物サプライチェーンの紛れもないリーダーです。同国は世界のレアアース供給量の70％近くを国内鉱山で生産し、海外供給源からの輸入品を精製することで世界供給量のほぼ90％を加工している。
西側当局者は、特にクリーンエネルギーへの移行が加速するにつれ、重要な鉱物需要が急激に増加すると予想されており、中国のサプライチェーンの優位性が戦略的課題であると繰り返し警告してきた。
続きを読む
「ドナルド・J・トランプ大統領のリーダーシップの下、重要な鉱物サプライチェーンの確保は国家安全保障の最優先事項だ」とOSC長官でスティーブ・ファインバーグ陸軍副長官上級顧問のデイビッド・A・ローチ氏は述べた。
「計画されているサンライズの取引は、ますます重要性を増している鉱物のサプライチェーンの回復力を確立する上で重要な一歩となる。官民資本を結集したこの約10億ドルの取引は、スカンジウム供給における海外依存に対処し、重要な防衛および商業用途でのスカンジウムの使用を促進するのに役立つだろう」と同氏は付け加えた。
この声明は、トランプ大統領と鉱山幹部との先週の会談直後に発表された。`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/08/10/rare-earths-sunrise-energy-metals-trump-cina.html",
    publishedAt: "2026-08-10T07:03:25+00:00",
    category: "エネルギー",
  ...
  },
  {
    ...
    titleJa: "テクノロジー業界のリーダーたちは、AI は仕事の削減を意味すると述べ、同社のスタッフは週に最大 90 時間働いていると述べています",
    summaryJa: "テクノロジー業界のリーダーたちは、AI は仕事の削減を意味すると述べ、同社のスタッフは週に最大 90 時間働いていると述べています- 公開されました",
    bodyOriginal: `Tech leaders say AI means less work - their staff say they work up to 90 hours a week
- Published
...
Related topics
- Published9 February`,
    bodyJa: `テクノロジー業界のリーダーたちは、AI は仕事の削減を意味すると述べ、同社のスタッフは週に最大 90 時間働いていると述べています
- 公開されました
ここ数年、さまざまな人工知能ツールの開発に年間数千億ドルをつぎ込んでいる企業の幹部らは、この技術によって最終的には人々が労働に費やす時間が減ることになると主張してきた。
Google のエンジニアリング ディレクターは 4 年前、AI によって 2025 年までに週 4 日勤務が実現すると社外で述べました。
今年の初め、エンジニアリング ディレクターの予測からちょうど 1 年後、OpenAI は、いわばその挑戦に挑みました。 AIは近いうちに非常に多くの人間の労働力を高速化できるようになるため、企業は自ら準備を整えるべきだと主張し、企業に週4日勤務（給与の変更なし）の試験導入を開始するよう正式に要請した。
しかし、昨年同社を退職した元OpenAI技術従業員はBBCに対し、他社が在職中に試してみるべきだと示唆していた週4日労働を同社が実際に試したことは一度もなかったと語った。
その代わりに、その人物は、頻繁な「危機会議」、週末勤務、そして同僚が突然解雇されるような「超過酷な」業績評価によって特徴づけられる、しばしば過酷な労働文化だったと説明した。
「土曜日か日曜日に出勤するのは、ただ遅れを取り戻したり、状況が壊れていないことを確認したりするためだけだ」とその関係者は語った。
他の企業も、良くも悪くも、AI によって人々の労働時間が効果的に削減されるという考えを推進しています。
Anthropic は、同社の人気コーディング ツールとチャットボットである Claude が、社外で 7 時間、実質的に会社の勤務日全体で休憩なしで単独で作業できると豪語しています。 Metaのマーク・ザッカーバーグ氏は、同社は今年「AIが私たちの働き方を劇的に変え始めている」時期にあり、こうしたツールによって以前よりもはるかに少数の従業員がより多くのことを行えるようになったと語った。
それ以来、メタ社は従業員の10人に1人を解雇したが、アンスロピック社のダリオ・アモデイ最高経営責任者（CEO）は、AIツールの生産性が必然的に高まるにつれ、外部からさらに広範な雇用が失われる可能性があると警告した。
こうした主張にもかかわらず、これら同じテクノロジー企業の従業員たちは、人々の仕事の少なくとも一部を実行するとされるAIツールを開発しているだけでなく使用しているが、一般的な週5日40時間労働よりもはるかに多くの労働時間を記録していると主張している。
「スプリント」
米国のハイテク労働者は通常、外部からの報酬が高く、投資銀行、法律、医療などの他の業界でも長時間労働がよく見られますが、ハイテク業界では 1 日 14 時間労働が常に標準であるわけではありませんでした。何年もの間、それはより典型的な9時から5時までの事務仕事でした。
しかし、OpenAIの元従業員は、以前のテクノロジー関連の仕事よりもはるかに多く、少なくとも週に70時間は費やすだろうと述べた。この人物は現在、やはりAIに注力している新興企業で働いており、ワークライフバランスが改善され、「スプリント以外」では週に50〜60時間近く働いていると語った。
「スプリント」とは、新機能や製品のリリースまでの数週間に人々が長時間労働する、テクノロジー企業における一般的な期間を表す用語です。
ただし、AI プロジェクトに熱心に取り組んでいる AI 企業や大規模なテクノロジー企業の内部では、そのようなスプリントは極端になる可能性があります。
たとえば、OpenAI や Anthropic では、スプリントが何週間も続き、7 日間で 90 時間を超える作業が行われることがある、と BBC がこの記事のために話を聞いたテクノロジー関係者らは語った。
両社はBBCのコメント要請に応じなかった。
「ドラフト」される
メタでは、従業員らは今年、緊急扱いとしてAI関連の作業を行うチームに突然配置されたと語った。現従業員と元従業員の一人によると、人々に選択肢が与えられなかったため、彼らはそれを「徴兵」と呼んだという。
「彼らはあなたを移動させるだけです」と元従業員は語った。 「ノーとは言えません。ノーと言ったとしても、辞めなければなりません。」
彼らによれば、メタ社は最近になって、「採用するか辞めるか」という厳格なアプローチから撤退し始めたが、その時までにすでに多くの労働者がそのような仕事を強いられていたという。
現従業員と元従業員の仕事内容の説明によると、メタ社のこうしたチームの勤務時間は長いことが多く、スタッフは週末や夜遅くまで働き、勤務時間以外は「待機中」だと感じているという。
米国では、16 歳以上の人が働ける時間に対外的な制限はありません。たとえば英国やヨーロッパでは、法律により残業を含めて週の労働時間が 48 時間に制限されています。
Meta の現在の AI プロジェクトには、ソフトウェア エンジニアリングやその他の種類の作業に使用できる AI ツールの作成と、さまざまなタスクの複製における AI モデルの成功を測定できる AI モデル インフラストラクチャの構築が含まれていると従業員は付け加えました。
「文字通り、人間の仕事を再現しようとしている人々のチームで働いているのです」と元従業員は語った。
その仕事は「終わりがない」ように見える、とその人は付け加えた。
メタの広報担当者はコメントを控えた。
AI ツールの開発に直接関与していないテクノロジー労働者でさえ、テクノロジーのせいで長時間労働に直面しています。
元グーグル従業員のアミン・シャリ氏は、社内のエンジニアリング機能が機能不全に陥ったため、しばしば徹夜で働かなければならないなど、AIが自分の仕事に悪影響を及ぼしていると主張し、5月に同社を退職した。 Google が処理ユニットやメモリ ストレージなどの重要なリソースを AI プロジェクトに移すにつれて、このようなことがより頻繁に発生していました。
グーグルの広報担当者はコメントを控えた。
Googleを退職して以来、シャリ氏はBBCに対し、睡眠と全体的な健康状態が改善したと語った。同氏は、大手ハイテク企業におけるAIツールへの過度の依存が「エンジニアに過剰なプレッシャーを与える悪い文化を生み出している」ことに気づいたと述べた。
時間の節約が「吸い取られた」
いくつかの新しい研究は、AI ツールが人々の作業負荷をさらに増大させていることを示唆しています。
カリフォルニア大学バークレー校の外部で行われた研究では、米国のテクノロジー企業で働く数百人の従業員が AI を使用している様子を 8 か月間追跡調査しました。それによると、従業員は「より速いペースで働き、より広範囲のタスクを引き受け、1日の労働時間をより多くの時間に延長した」という。
マサチューセッツ工科大学のイノベーション学者ニール・トンプソン氏は、AI開発を主導するハイテク企業でさえ、作業の一部を行うためのツールを導入するだけで作業を進めるように従業員に指示される可能性は低いと述べた。
「たとえリアルタイムで節約できたとしても、変更とそれを実装し、それが機能することを確認することによってそれが吸い取られてしまうという状況につながります」とトンプソン氏は述べた。
カリフォルニア大学バークレー校の調査では、AI ツールの出力を常にチェックする必要があることが、技術系従業員の仕事量の増大の一因であることが判明しました。
従業員が AI ツールのプロセスを円滑化した状況では、人々は雇用主に自分の価値を証明するためにそうしたい、またはそうすべきだと感じているため、節約された時間をより多くの仕事で埋めようとする傾向があるとトンプソン氏は付け加えた。
「人々は仕事が20%減れば週4日になると考えている」とトンプソン氏は語った。 「しかし、新しい作品が生まれます。」
シャリ氏は次のように述べています。「AI は現在、私たちのために多くのことを行っているはずなので、より多くの人が少なくともより良い健康状態とより良い睡眠を得ることができるはずです。」
むしろ、その逆のようです。
関連トピック
- 2 月 9 日発行`,
    source: "BBC",
    sourceUrl: "https://www.bbc.co.uk/news/articles/cvgx4yd1gl2o?at_medium=RSS&at_campaign=rss",
    publishedAt: "2026-08-10T05:00:32+00:00",
    category: "テクノロジー",
    imageUrl: "https://ichef.bbci.co.uk/ace/standard/240/cpsprodpb/1075/live/0b27bfa0-8aa4-11f1-a7ab-8b30adf0800a.jpg",
    readTime: 9,
  },
  {
    id: "trump-says-oil-supermajors-are-making-to-8ccd366f",
    title: "Trump says oil supermajors are making too much money. What will they do with it?",
    titleJa: "トランプ大統領は、石油大手は儲けすぎていると主張。彼らはそれをどうするのでしょうか？",
    summaryJa: "ビッグ・オイルは第2四半期に棚ぼた的な巨額利益を享受した。現在の重要な問題は、業界が政治的反発の増大を避けながら、この大金を株主への報酬、バランスシートの強化、あるいは将来への投資に利用するのかということだ。エクソン・モービル、シェブロン、BP、シェル、トータルエナジーで構成されるスーパーメジャー5社は、米国とイランの対立による化石燃料価格の上昇の恩恵を受け、4～6月期に480億ドルという巨額の利益を上げた。",
    bodyOriginal: `Big Oil enjoyed a blockbuster profit windfall in the second quarter. A key question now is whether the industry will use this cash bonanza to reward shareholders, strengthen balance sheets or invest for the future — all while trying to avoid a growing political backlash.
...
As for windfall taxes, API said it wasn't possible to tax your way to greater energy security. "Windfall profits taxes don't lower prices for consumers—they discourage the long-term investment needed to strengthen supply, infrastructure and a more resilient energy system," they added.`,
    bodyJa: `ビッグ・オイルは第2四半期に棚ぼた的な巨額利益を享受した。現在の重要な問題は、業界が政治的反発の増大を避けながら、この大金を株主への報酬、バランスシートの強化、あるいは将来への投資に利用するのかということだ。
エクソン・モービル、シェブロン、BP、シェル、トータルエナジーで構成されるスーパーメジャー5社は、米国とイランの対立による化石燃料価格の上昇の恩恵を受け、4～6月期に480億ドルという巨額の利益を上げた。
また、同じ期間に900億ドル近くの現金創出ももたらし、これは過去最高額を反映しており、2022年初頭のロシアによるウクライナへの全面侵攻後をも上回っている。
この巨額の収益は、業界の超過利益に対する棚ぼた課税を改めて要求している環境活動家やドナルド・トランプ米大統領の怒りを買っている。
米大統領は先週、イラン戦争中の燃料価格高騰で「儲けすぎ」ているとして米石油大手エクソンとシェブロンを激しく非難し、燃料価格引き下げの要求を繰り返した。
非営利団体IEEFAのエネルギー金融アナリスト、クラーク・ウィリアムズ・デリー氏は「スーパーメジャー各社は前四半期、前例のない大金を手に入れた」と電子メールでCNBCに語った。
しかしウィリアムズ・デリー氏は、エネルギー生産を最大化するというトランプ大統領の政策に言及し、彼らはこの現金を「赤ちゃんの訓練」に使ったわけではないと述べた。同氏は例えば、ビッグ・オイルの設備投資、配当、自社株買いが安定していると指摘した。
「それでは疑問が生じます。もし株主にもっとお金を与えなかったら、超大手は得た現金をどうしたのでしょう？」
お金はどこへ行くのでしょうか？
ＩＥＥＦＡのウィリアムズ・デリー氏は、石油会社はバランスシートを改善するために現金を備蓄し、負債を返済しようと努めてきたと述べた。実際、世界の超大手5社の手元資金は四半期ベースで170億ドル強急増した。
「石油業界の財政戦略を皮肉的に表現すると、『戦争のために祈れ』ということになる。スーパーメジャーは財務を強化するためだけに、ウクライナやイラン危機のような定期的な価格高騰が必要だ」とウィリアムズ・デリー氏は語った。
同氏は「スーパーメジャーにとって、激しい消費者の痛みと世界的な燃料不足は、財政を蝕む長期にわたる低安定価格に対する経済的解毒剤として機能している。石油メジャーの観点からは、価格高騰はバグではなく特徴だ」と付け加えた。
石油・ガス大手の幹部らはＣＮＢＣに対し、中東紛争中に自社がコントロールできる業務実績、取引、最適化などの事業分野を倍増させることを検討していると語った。
「BPが取り組んでいることは、この状況に対処するために私たちができることに集中していることを確認することです。私たちは、バレルを生産する上流の資産と精製する精製資産の両方で、信頼性を重視して取り組んでいます」とBPの最高経営責任者（CEO）メグ・オニール氏は8月4日、CNBCの「スコーク・ボックス・ヨーロッパ」で語った。
オニール氏は、ジェット燃料とディーゼルを例に挙げ、消費者がいつでも最も必要とする製品を最大限に入手できるよう、同社の精製工程の設定方法を調整したと述べた。
一方、シェルのワエル・サワン最高経営責任者（ＣＥＯ）はボラティリティを「新たな常態」と表現し、コモディティー価格の上昇が業績に非常に強い追い風となっているようなマクロ状況だと述べた。
利益とキャッシュフローの豊作は「持続可能ではない可能性がある」
AJベルの投資ディレクター、ラス・モールド氏によると、石油・ガス大手はすでに莫大な利益とキャッシュフローをどのように活用する計画かを示しているという。
モルド氏は電子メールでＣＮＢＣに対し、「合併と買収、メンテナンスの設備投資、新規プロジェクト（再生可能または炭化水素）への投資、債務削減、そして最後に配当と自社株買いをすべてカバーしている」と語った。
モルド氏によると、それぞれの規模や程度は企業によって異なり、BPは「債務削減モード」にあるが、例えばシェルはカナダでの買収でより拡大しているという。
「しかし明らかなことは、全体的な設備投資予算が依然として厳しい状況にあることを考慮すると、炭化水素メジャーはある程度の慎重さを持って新規油田・ガス田への投資に取り組んでいるということだ」とモルド氏は述べた。
「これは、特に米国とイランが永続的な平和的解決に至った場合、あるいは新たな課税への恐怖、あるいは環境に関して継続的な国民、政治、運動団体の圧力がかかる場合に、現在の利益とキャッシュフローの豊作は持続可能ではないかもしれないという感覚の結果かもしれない」と同氏は付け加えた。
API: 棚ぼた税は「消費者の価格を引き下げない」
トランプ大統領の批判と並んで、石油・ガス業界の戦時中の利益に対する政治的圧力はここ数週間で高まっている。
活動家らは政策立案者に対し、防火・洪水防御など気候変動に強いインフラへの資金提供を目的にエネルギー大手に増税を課すよう求めている。
ポルトガル政府は先週、石油・精製会社が２０２６年に得た特別利益に対する棚ぼた課税を承認したと発表した。
約600社の掘削会社、精製業者、その他の利益団体を代表するロビー団体であるアメリカ石油協会は、石油・ガス産業は四半期ではなく数十年で評価されるべき周期的なビジネスであると述べ、超過利益に対する棚ぼた課税に対して警告した。
APIの広報担当者は電子メールでCNBCに対し、「ここ数十年で最も重大な世界的エネルギー混乱の一つのさなか、米国の石油・天然ガス産業は記録的な生産量と世界トップレベルの精製を実現しながら、米国の長期的なエネルギー安全保障を強化する供給、インフラ、回復力への投資を続けている」と語った。
棚ぼた税に関しては、エネルギー安全保障を強化するために課税することは不可能だとAPIは述べた。 「棚ぼた的利益税は消費者の価格を下げるものではなく、供給、インフラ、より強靱なエネルギーシステムを強化するために必要な長期投資を妨げる」と彼らは付け加えた。`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/08/10/oil-iran-war-profits-windfall-tax.html",
    publishedAt: "2026-08-10T05:00:02+00:00",
    category: "エネルギー",
    imageUrl: "https://images.unsplash.com/photo-1473172367879-2dca04a4dca4?w=800&q=80",
    readTime: 6,
  },
  {
    id: "u-s-reaffirms-grip-on-hormuz-blockade-tu-79706250",
    title: "U.S. reaffirms grip on Hormuz blockade, turning away 55 ships as talks stall",
    titleJa: "米国、ホルムズ封鎖の掌握を再確認、交渉が行き詰まり55隻の船舶を拒否",
    summaryJa: "米軍は先週、海上封鎖下でさらに20隻の商船をイランの港から遠ざけ、ホルムズ海峡再開の合意が届かない中、海上圧力が緩まないことを示した。米中央軍は、日曜日の時点で米軍が8月2日時点の35隻から55隻の商船の航路を変更したと発表した。日曜の声明によると、米軍はまた、順守に耐えるため2隻の船舶を無力化し、2隻に乗船したという。",
    bodyOriginal: `The U.S. military redirected 20 more commercial vessels away from Iranian ports last week under its naval blockade, signaling no let-up in maritime pressure as a deal to reopen the Strait of Hormuz stayed out of reach.
...
Tehran would impose penalties on violators equivalent to 20% of the value of cargo aboard a ship, according to the initial draft.`,
    bodyJa: `米軍は先週、海上封鎖下でさらに20隻の商船をイランの港から遠ざけ、ホルムズ海峡再開の合意が届かない中、海上圧力が緩まないことを示した。
米中央軍は、日曜日の時点で米軍が8月2日時点の35隻から55隻の商船の航路を変更したと発表した。日曜の声明によると、米軍はまた、順守に耐えるため2隻の船舶を無力化し、2隻に乗船したという。
この集計のエスカレートは、ホルムズ海峡を５カ月以上にわたって閉塞させている危機の解決に両国がどれほど遠いかを浮き彫りにしている。 2月に戦争が勃発するまで、ホルムズ海峡は世界の海上石油貿易の約4分の1と世界の液化天然ガスの5分の1を運んでいた。
イスラム革命防衛隊関連の半公式報道機関であるタスニム通信によりますと、イランのアッバス・アラグチ外相は日曜日、米国が「違反」を補償せずに6月の覚書に違反し続ける限り、「交渉再開の可能性はない」と述べた。
アラグチ氏は「仲介業者は依然として交渉再開の方法を模索する努力を続けている」と述べた。
ドナルド・トランプ米大統領は先週、米国とイランが間もなく合意に達する可能性があると自信をのぞかせたが、新たな軍事攻撃からは距離を置き、イランの経済的苦境が高まるまで待つ用意があるとアクシオスに語った。
トランプ大統領は「われわれは控えめにしている」とし、「われわれはイランと半ば交渉しているだけだ。われわれはイランの巨大なインフレと、彼らには金がないという事実をただ見ているだけだ」と語った。
大統領はまた、「イランにはお金がない」「通貨はゴミだ」というタイトルで、2025年から現在までのイラン・リアル価値の急落を示すグラフをトゥルース・ソーシャルに投稿した。
イラン当局者らは、ホルムズ海峡の再開に向けて、米国の海上封鎖と制裁の解除、同地域からの米軍撤退、戦争賠償金の支払い、凍結されたイラン資産の解放など、包括的な要求を米国側に打ち出した。
イランはまた、海峡を通る通過ルートを定める協定をまとめるためにオマーンとも協議している。アラグチ氏は、交渉は順調に進んで最終段階に達していると述べたが、この協定では水路は再開されないと主張した。
オマーンは、イランとの協議が「前向きかつ建設的な雰囲気」で進んでいることを確認する一方、外交の余地を作るために海峡を通過する船舶に対する度重なる攻撃の停止を求めた。
ホルムズでのイランによる攻撃と紅海でのフーシ派の攻撃により、引き続き荷主が両航路から遠ざかっている。アラブ首長国連邦は土曜日、イランが土曜日早朝に海峡を通過しようとしていたアブダビ国営石油会社所有のタンカーにミサイルを発射したと発表した。
イエメンのイランが支援するフーシ派民兵組織は日曜日、サウジアラビアの製油所とイエメン紅海の港湾都市アルマハの設備への攻撃に対する犯行声明を出した。
強化用語
ＩＮＧ銀行のコモディティ戦略部門責任者ウォーレン・パターソン氏は先週金曜日のメモで、「あまり妥協点はないようで、最終的には持続可能な合意に達することがより困難になる」と述べた。
同銀行は今四半期のブレント原油の平均1バレル当たり80ドルという予測を据え置き、その基本的な見方にかなりの「リスクと不確実性」を残しつつ、第3四半期までは流れが正常化すると予想した。
パターソン氏は、ここ数日の進展にもかかわらず、米国とイランの間のレトリックの口調と深まっている不信感により、新たな悪化の余地が残されていると述べた。 「事態は再び悪化する可能性がある。」
船舶追跡業者Kplerによると、ホルムズ海峡を通過する船舶の交通量は、先週金曜日に確認された通過数はわずか8ヶ所に減少し、前日比33％減少したという。
月曜日の原油価格は大幅に上昇し、国際ベンチマークであるブレント原油先物は1%近く上昇して1バレルあたり84.22ドルとなり、米国ウェスト・テキサス・インターミディエイト先物は0.6%上昇して78.63ドルとなった。
イラン国営メディアは先週、ホルムズ経由の航行を制限し、米国とイスラエルの船舶の同海峡への出入りを禁止し、通航を許可する前に敵対国に補償を求める内容の計画草案を公表した。国営放送ファルス紙によると、この計画はイラン議会で検討中である。
当初の草案によれば、イラン政府は違反者に対し、船舶に積まれた貨物の価値の20％に相当する罰金を課すことになる。`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/08/10/us-iran-war-trump-hormuz-oman-ships-blockade-shipping.html",
    publishedAt: "2026-08-10T04:24:45+00:00",
    category: "エネルギー",
    imageUrl: "https://images.unsplash.com/photo-1473172367879-2dca04a4dca4?w=800&q=80",
    readTime: 5,
  },
  {
    id: "u-s-stock-futures-dip-as-investors-await-e79f5e82",
    title: "U.S. stock futures dip as investors await inflation data, grapple with more Iran uncertainty",
    titleJa: "投資家がインフレ統計を待ち、イランの不確実性の増大に取り組む中、米国株先物は下落",
    summaryJa: "イランからの新たな要求によりホルムズ海峡が近いうちに再開されることへの新たな疑念が生じたことや、投資家が今週後半の重要なインフレ統計を待っていることから、日曜日の米国株価指数先物相場はほとんど変化しなかった。",
    bodyOriginal: `U.S. stock-index futures were little changed on Sunday, after new demands from Iran raised fresh doubts about the Strait of Hormuz reopening anytime soon and as investors await key inflation data later this week.`,
    bodyJa: `イランからの新たな要求によりホルムズ海峡が近いうちに再開されることへの新たな疑念が生じたことや、投資家が今週後半の重要なインフレ統計を待っていることから、日曜日の米国株価指数先物相場はほとんど変化しなかった。`,
    source: "MarketWatch",
    ...
    publishedAt: "2026-08-10T01:30:00+00:00",
    category: "金融政策",
    imageUrl: "https://images.mktw.net/im-01887892",
    readTime: 2,
  },
  {
    id: "oil-rises-amid-uncertainty-over-u-s-iran-150d58d4",
    title: "Oil rises amid uncertainty over U.S.-Iran Strait of Hormuz deal",
    titleJa: "米国とイランのホルムズ海峡合意を巡る不確実性の中で原油が上昇",
    summaryJa: "ホルムズ海峡開放に向けた両国間の合意がすぐには実現しないかもしれないとの懸念の中、トレーダーらが米国とイランからのさまざまなシグナルを評価し続けているため、月曜早朝の原油価格は上昇した。国際指標となるブレント原油先物（１０月渡し）は１．０９％上昇し、１バレル＝８４．４６ドルとなった。米国ウェスト・テキサス・インターミディエート先物９月限は０．８４％上昇し、１バレル＝７８．８４ドルとなった。",
    bodyOriginal: `Oil rose early Monday, as traders continue to assess mixed signals from the U.S. and Iran amid worries that a deal between both countries to open the Strait of Hormuz may not be anytime soon.
Futures for international benchmark Brent crude for October delivery gained 1.09% to $84.46 a barrel. U.S. West Texas Intermediate futures for September advanced 0.84% to $78.84 per barrel.
...
However, the U.S. maintains that any reopening must preserve unrestricted freedom of navigation without Iranian approvals, tolls, or controls, disputing key elements of the reported arranged, according to Citi. "Risks remain elevated outside Hormuz too, with Houthi groups in Yemen continuing attacks and threats against Saudi-linked shipping in the Red Sea and around Bab el Mandeb," it added.
...
—CNBC's Garrett Downs contributed to the report.`,
    bodyJa: `ホルムズ海峡開放に向けた両国間の合意がすぐには実現しないかもしれないとの懸念の中、トレーダーらが米国とイランからのさまざまなシグナルを評価し続けているため、月曜早朝の原油価格は上昇した。
国際指標となるブレント原油先物（１０月渡し）は１．０９％上昇し、１バレル＝８４．４６ドルとなった。米国ウェスト・テキサス・インターミディエート先物９月限は０．８４％上昇し、１バレル＝７８．８４ドルとなった。
イランのアッバス・アラグシ外務大臣は、イランとの戦争の終結とホルムズ海峡の開放に向けてイランは現在米国と直接交渉を行っていないと述べたが、米国政府は先に合意が近いと主張した。
さらに、メディア「インディペンデント」の報道によると、イランは米国に対し、重要な水路を再開する条件として補償を求めた。イラン最高国家安全保障会議の議長であるモハマド・バガー・ゾルガドル氏は、米国が戦争とイランとその同盟国に対する侵略の終結を含む6つの条件を満たすまで、ホルムズ海峡は閉鎖されたままだと述べたと伝えられている。
しかし、シティによると、米国は、再開にはイランの承認、通行料、規制なしに無制限の航行の自由を維持しなければならないと主張し、報告された取り決めの重要な要素に異議を唱えている。さらに、「ホルムズ以外でもリスクは依然高まっており、イエメンのフーシ派は紅海やバブ・エル・マンデブ周辺でサウジ関連の船舶に対する攻撃や脅迫を続けている」と付け加えた。
ウエストパック氏はメモの中で「イラン戦争が６カ月を迎える今でも不確実性は依然として高い」と述べた。さらに、「ホルムズ海峡は事実上閉鎖されたままであり、イエメンのフーシ派の参戦により紅海の代替補給ルートが遮断されている」と付け加えた。
—CNBCのギャレット・ダウンズ氏がこのレポートに貢献しました。`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/08/10/oil-prices-today-brent-wti-hormuz-trump-iran.html",
    publishedAt: "2026-08-10T01:23:35+00:00",
    category: "エネルギー",
    imageUrl: "https://images.unsplash.com/photo-1473172367879-2dca04a4dca4?w=800&q=80",
    readTime: 2,
  },
  {
    id: "could-your-tattoo-stop-you-from-getting-be4ba93b",
    title: "Could your tattoo stop you from getting a job?",
    titleJa: "タトゥーのせいで仕事に就けなくなる可能性はありますか?",
    summaryJa: "タトゥーのせいで仕事に就けなくなる可能性はありますか?- 公開されました",
    bodyOriginal: `Could your tattoo stop you from getting a job?
- Published
...
'I don't think it's totally accepted'
...
'A more affordable way of becoming an art collector'
...
"Everybody loves my arm tattoo," she says. "I think it's because it's quite unusual from what lots of people expect a tattoo to look like… this is very delicate."
The value of authenticity
Of all the factors behind tattoos' popularity, authenticity is the one Rees thinks trumps them all – because, he says, it is something we really value culturally.
...
- Published4 March
- Published5 days ago`,
    bodyJa: `タトゥーのせいで仕事に就けなくなる可能性はありますか?
- 公開されました
タトゥーは長年にわたり文化の主流となってきました。首相さえも持っています（上腕二頭筋にハチ）。
そして、この傾向が衰え始める兆候はありません。 2024 年の YouGov 世論調査によると、自己表現の手段としてタトゥーを入れる人がこれまで以上に増えています。2024 年の YouGov 世論調査によると、英国の 25 ～ 49 歳の 40% が少なくとも 1 つのタトゥーを入れています。
インクを塗るのに最も人気のある体の部位は何ですか? YouGovによれば、上腕だという。
しかし、その受け入れは職場にも受け継がれているでしょうか?
「全面的に受け入れられるとは思えない」
社会学者のマイケル・リース博士は、目に見えるタトゥーと目に見えないタトゥー、特に体の他の部分と対照的に手、首、顔のタトゥーの間には、社会的受容性において大きな隔たりが残っていると述べている。
「それが完全に受け入れられているわけではないと思いますし、おそらくそれには限界があると思います。」
リース自身も手と首に墨を入れているが、学者としての最初の定職に就くまでは、どちらもできなかった。
「今のようなキャリアで働いていても、それが自分の仕事の見通しに悪影響を与えるのではないかと心配していました。
「これらの領域にタトゥーを入れる人々は、潜在的に彼らのキャリアを制限していると思います。」
これは、2022年のYouGov調査によって裏付けられており、約3分の2の人が顔や首の目に見えるタトゥーはプロフェッショナルではないと考えているが、同様の割合が他の目に見えるタトゥーはプロフェッショナルだと考えていることが判明した。
自身もタトゥーを深く入れているアリッサ・グロカット博士は、カナダのカルガリー大学で博士号を取得するために職場でのタトゥーに対する認識を調査し、タトゥーを入れた人々について肯定的であれ否定的であれ、多くの固定観念が今でも存在していることを発見した。
当然のことかもしれませんが、威圧的なタトゥー (この研究では頭蓋骨とナイフ) を入れている人は危険であると認識され、一方、バラやいくつかの葉っぱの「フレンドリーな」タトゥーを入れている人は、より創造的で芸術的であると認識されました。
全体として、目に見えるタトゥーのある求職者は、そうでない求職者に比べて採用される可能性がまだわずかに低い、と彼女は言う。
しかし、起業家やクリエイティブな業界で働いている人たちにとっては、誰かの個人的なブランドの延長としてみなされる可能性があるとグロカット氏は示唆する。
「私がタトゥーを入れ始めた11年前でさえ、手、首、顔は『ジョブストッパー』と呼ばれていて、多くのアーティストはその部分にタトゥーを入れませんでした」と彼女は言う。
「状況が少し変わってきているのか、それともタトゥーアーティストが門番になりたくないのかもしれないと思います。今ではよりポジティブな認識が広がっていますが、それでも注目されることは多く、それは慣れるための調整です。」
カウンターカルチャーからメインストリームへ
何世紀にもわたって、タトゥーは犯罪組織や船員、そして最近ではパンクやバイククラブなどの反文化運動としっかりと結びついていました。
しかし、2000年代初頭以降、セレブとタトゥー・フィクサーズやロンドン・インクなどの人気テレビ番組の組み合わせによって、タトゥーは着実に「謎が解かれ」てきた、とリース氏は言う。
「90年代後半に私が初めてタトゥーを入れたとき...それらは主流から外れていました。しかし、彼らは今どこにでもいます。」
2000年代に調査のためにインタビューしたタトゥーを入れた人々は皆、インスピレーションの源としてデヴィッド・ベッカムを挙げた。サッカー選手は1999年に初めてタトゥーを入れた際にこう声明を発表した。現在、ハリー・スタイルズやエド・シーランのようなセレブたちはタトゥーで覆われており、それぞれ50以上のタトゥーが入っている。
「アートコレクターになるためのより手頃な方法」
タトゥーアーティストのマーサ・スミスさんは、タトゥーが犯罪や階級差別と結びつけられなくなり、偏見が「大きく変わった」と考えている。
そして新たなトレンドも生まれています。ケント州ブロードステアーズに拠点を置くスミスは、細い線とドットワークのタトゥーを専門としています。ハッシュタグ #finelinetattoo は Instagram で 1,030 万回の検索を記録し、#dotworktattoo は 480 万回の検索を記録しています。
「おそらく1990年代初頭までは、タトゥーを入れることができると考える非常に特定の人が存在していました。しかし、私がタトゥーを入れてきた13年間で、クライアントは確実に多様化しました」とスミスさんは言い、NHS職員、ソーシャルワーカー、教師にタトゥーを入れることが非常に多いと付け加えた。
キャサリン・ヒバートさん（44）は、最初のタトゥーを入れるまで約20年待ちました。彼女は現在、40代になると毎年それを取得することを計画しています。
「初めての撮影に行ったときは少し緊張しました」と彼女は言います。 「痛いのではないか、間違った決断をしているのではないかと怖かったのです。
しかし、タトゥーのテンプレートを装着するとすぐに、ヒバートさんは「すぐに気に入った」という。
「アドレナリンが出ているのだと思いますが、その後何日もハイな状態が続きます。」
彼女の前腕のタトゥーは、家族のさまざまなメンバーや側面を象徴する幾何学的な形で構成されています。
「それらにはすべて意味があり、自分でデザインできるという事実が気に入っています」とアートギャラリーで働くヒバートは言います。
スミス氏は、タトゥーイスト自身が今でははるかに幅広い芸術的背景を持っていると考えている。
「今では、彼らのアートワークのためにタトゥーイストのところに行くことがよくあります。これにより、タトゥーを入れたいと思う人の種類や、タトゥーが何を意味するのかが大きく広がります。また、アートコレクターになるためのより手頃な方法でもあります。」
これはヒバートの気持ちと一致します。
「みんな私の腕のタトゥーが大好きなんです」と彼女は言う。 「それは、多くの人がタトゥーに期待するものとはかなり異なっているからだと思います…これは非常にデリケートなことです。」
本物であることの価値
タトゥーの人気の背後にあるすべての要素の中で、信頼性がすべてに勝るものだとリース氏は考えています。なぜなら、それは私たちが文化的に本当に大切にしているものだからだと、彼は言います。
「私の回答者の多くは、タトゥーが自分たちに与えてくれるもの、バンドや個人へのコミットメント、[依存症]の回復、そして自分が本当の自分であることのようなものだと考えていました。」
もちろん、部屋の象は残念です。タトゥーは永久的なものであり、批評家らは、これらの世代が年齢を重ねるにつれて、何十年も前に選んだタトゥーが気に入らなくなる可能性があると示唆しています。
しかしヒバートさんは、それは彼女にとっては心配ではないと言う。
「それらは物語のようなもので、思い出であり、私と私の人生についての物語です。」
連絡する
タトゥーはありますか？就職に関して何か問題を感じたことはありますか?
関連トピック
- 7 月 18 日発行
- 3 月 4 日発行
- 5 日前に公開`,
    ...
    publishedAt: "2026-08-10T00:40:48+00:00",
    category: "マクロ経済",
    imageUrl: "https://ichef.bbci.co.uk/ace/standard/240/cpsprodpb/6bfb/live/e03d1d30-90e8-11f1-b8ee-9b3c26ad07bb.jpg",
    readTime: 8,
  },
  {
  ...
  {
    id: "you-could-be-missing-out-on-150-off-your-b18752cb",
    title: "You could be missing out on £150 off your energy bill - here's how to check",
    titleJa: "光熱費から 150 ポンド割引されるチャンスを逃している可能性があります - 確認方法は次のとおりです",
    summaryJa: "光熱費から 150 ポンド割引されるチャンスを逃している可能性があります - 確認方法は次のとおりです- 公開されました",
    bodyOriginal: `You could be missing out on £150 off your energy bill - here's how to check
- Published
One call to your energy supplier to ensure your name is on the electricity bill may mean you are in line for a £150 discount this winter – but you need to get in before the deadline.
...
The government scheme knocks £150 off bills if you are on means-tested benefits such as universal credit.
Household energy could get more expensive
...
To help those who might struggle to pay, energy companies distribute the £150 Warm Home Discount to about six million households in the winter. Households in receipt of housing benefit, income-related Employment and Support Allowance, Pension Credit and universal credit qualify.
...
Previously, eligible Scottish households have had to apply for the scheme.`,
    bodyJa: `光熱費から 150 ポンド割引されるチャンスを逃している可能性があります - 確認方法は次のとおりです
- 公開されました
電力会社に電話して、電気料金請求書にあなたの名前が記載されていることを確認するだけで、この冬は 150 ポンドの割引を受けることができるかもしれません。ただし、締め切り前に参加する必要があります。
長く暑い夏には暖房費のことはあまり気にならないかもしれませんが、この冬は暖房費が再び上昇する見込みです。
サプライヤーは、8 月 23 日日曜日の時点での顧客の記録を使用して、誰が Warm Home 割引の対象となるかを確認します。
政府の制度では、ユニバーサルクレジットなどの資力調査型給付金を利用している場合、請求書が 150 ポンド割引されます。
家庭用エネルギーはさらに高価になる可能性がある
今月末、Ofgem が 10 月から 3 か月間の四半期ごとの価格上限を発表する際に、何百万人もの人々が冬のエネルギー価格の水準を知ることになるでしょう。
支払いが困難な人々を支援するために、エネルギー会社は冬に約 600 万世帯に 150 ポンドの「暖かい家割引」を配布しています。住宅手当、収入関連の雇用・扶養手当、年金クレジット、ユニバーサルクレジットを受給している世帯が対象となります。
サプライヤーの顧客が 1,000 人を超えている場合、対象となる世帯は自動的に割引を受けられます。
ただし、それはあなたの名前が請求書に記載されており、これらの特典のいずれかを受け取っている場合にのみ発生します。また、供給業者がエネルギー負債を抱えている人々に対して返済計画など、より良いサポートを提供するのにも役立ちます。
最近引っ越したばかりの場合、電気料金請求書に名前が記載されていない可能性があります。
キーまたはカードを使用してチャージする前払いメーターの資格のある顧客は、世帯の口座が自分の名前で登録されていることを確認する必要もあります。
ミアッタ・ファーンブッレ・エネルギー長官は、「恩恵を受ける可能性のある人を知っている場合は、情報を広め始め、その人が光熱費請求書に記載されているかどうかを確認するよう奨励してください」と述べた。
政府はまた、スコットランドの低所得世帯34万5,000世帯が冬季に自動的にリベートを受け取ることになり、スコットランドの政策はイングランドやウェールズと歩調を合わせることになると発表した。
これまでは、対象となるスコットランドの世帯はこの制度に申請する必要があった。`,
    source: "BBC",
    sourceUrl: "https://www.bbc.co.uk/news/articles/czjlk8wx771o?at_medium=RSS&at_campaign=rss",
    publishedAt: "2026-08-09T23:47:30+00:00",
    category: "エネルギー",
    imageUrl: "https://ichef.bbci.co.uk/ace/standard/240/cpsprodpb/8926/live/34a4ae50-8cd0-11f1-97f5-93fc85ee9dc4.jpg",
    readTime: 3,
  },
  {
    id: "the-number-of-stocks-beating-the-s-p-500-1650a9ad",
    title: "The number of stocks beating the S&P 500 is the highest in 4 years. Why that number should rise.",
    titleJa: "S&P500を上回る銘柄数は過去4年間で最高となった。なぜその数が増加するのか。",
    summaryJa: "4年ぶりに平均株価が株式市場を上回った。",
    bodyOriginal: `For the first time in four years, the average stock is beating the stock market.`,
    bodyJa: `4年ぶりに平均株価が株式市場を上回った。`,
    source: "MarketWatch",
    ...
    publishedAt: "2026-08-09T19:11:00+00:00",
    category: "金融政策",
    imageUrl: "https://images.mktw.net/im-40258482",
    readTime: 2,
  },
  {
...
「現時点ではあらゆることが可能だと思います」と彼女は語った。`,
  ...
  },
  {
    ...
    summaryJa: "(これはウォーレン・バフェット・ウォッチのニュースレター、ウォーレン・バフェットとバークシャー・ハサウェイに関するニュースと分析です。ここからサインアップすると、毎週金曜日の夜に受信箱で受け取ることができます。)アベルはバークシャーの多額の資金を投入している",
...
- Yahoo Finance: Warren Buffett's Berkshire Hathaway stock shows investors warming to Greg Abel's leadership
- The Wall Street Journal: BNSF Railway Says Regulators Should Deny Big Rail Merger Now
...
アベルはバークシャーの多額の資金を投入している
バークシャー・ハサウェイの新CEOとして就任した第2四半期に、グレッグ・アベル氏はかなりの支出を行った。
その結果、同社の依然として巨額な現金準備金は2022年初頭以来初めて大幅に減少した。
土曜日朝に発表された６月３０日までの３カ月間の財務報告書によると、バークシャーの手元資金は３６５５億ドルで、３月３１日時点の過去最高の３９７４億ドルから８．０％減少した。
BNSFの現金と、バークシャーが好む指標である購入したがまだ支払われていない財務省短期証券の調整を除くと、同社の現金は3.8％減の3,592億ドルとなった。
この支出の一部は45億ドルのバークシャー株買い戻しに充てられた。
自社株買い額はバロン氏の概算予想の下限である５０億─１１０億ドルを下回り、ＵＢＳアナリストのブライアン・メレディス氏の予想８５億ドルを下回った。
しかし、それでもバークシャーが第1四半期に支出した2億3500万ドルを大幅に上回っており、同社が自社株買いを実施したのは2024年以来初めてだった。
CFRAリサーチのキャシー・サイフェルト氏はブルームバーグに対し、「人々は自社株買いに勇気づけられるだろう。これはグレッグ氏が舵を取り、自己主張する方法でもある」と語った。
ガベリ・ファンズのポートフォリオマネジャー、マクレー・サイクス氏もこの動きに前向きで、CNBCに対し「主要な自社株買いは、優良な企業資本配分者の一部が現在の価値を認識しているという自信を株主に与える」と語った。
そして買いは続いた可能性がある。第2四半期報告書に示されている7月29日時点のバークシャーの発行済み株式と6月30日時点のバークシャーの発行済み株式を比較することにより、本誌はバークシャーが7月に自社株買いにさらに34億ドルを費やしたと推定している。
その多くはおそらく月末近くの株価上昇前に起きたものと思われる。
アベルはバークシャー株だけにお金をつぎ込んでいたわけではない。
もう一つの大きな変化として、バークシャーは全体で売却した株式よりも多くの株式を購入し、純増額は200億ドルになりました。これには、6月に発表されたグーグルの親会社アルファベットへの100億ドルの投資も含まれる。
過去14四半期にわたり売り越し状態が続いていた。
バークシャーが来週第2四半期ポートフォリオのスナップショットを発表するときに、バークシャーが何を売買していたのかが正確に分かるだろう。
さらに強気のニュース: 好調な営業利益
投資家はバークシャーの第２・四半期営業利益の大部分も好感するだろう。
全体としては、バークシャー・ハサウェイ・エナジー（27%増）とBNSF鉄道（6%増）の好調な数字により、16%増の129億8000万ドルとなった。
製造業、サービス業、小売業の利益は２４％増の約４５億ドルとなった。
一方、保険事業は振るわず、保険引受利益は１３％減、保険投資利益は９％減少した。
GEICOは特に不振で、保険引受利益は45％減少した。
しかし、ガベリのサイクスは依然として励まされている。 「保険業界の厳しい状況にもかかわらず、同社はグレッグ・エイベル氏のCEO就任1年目で株主の純資産を増やし続けている。」
DaVitaのトリムは株価の大きな変動の結果ではない
バークシャー・ハサウェイは、透析プロバイダーの株価が年初来の大幅な上昇分を取り戻す数日前に、ダヴィータのポジションを縮小した。
しかし、この売却は、火曜日の第2四半期決算報告で、パンデミック補助金の打ち切りにより患者がオバマケア計画から脱落し、治療当たりの収益が減少したことが明らかになった後、その週にダヴィータの株価が23％下落したこととは何の関係もなかった。
バークシャーが同社株を45％以下に維持することに合意したダヴィータとの2024年の合意に基づき、ダヴィータは自社株買いによるダヴィータの発行済み株式の減少に対抗するため、四半期に一度バークシャーから十分な株式を買い戻すことが義務付けられている。
ダヴィータの発行済み株式は第2四半期にわずか40万株減少したため、バークシャーの保有株は18万3,000株弱減少し、残りの2,870万株（約53億ドル相当）が株式の45.0％を占めることになる。
バークシャーは株式の購入で3650万ドルを受け取ったが、これは同社の基準からすると非常に少額であるため、1株当たりの価格はそれほど重要ではない。
しかし、興味深いのは、取引当日の7月31日、DaVitaの終値は240ドル強だったということだ。
しかし、バークシャーの提出書類によると、買収額は1株当たり200ドル弱だった。
というのは、契約では、1株あたりの価格が、同四半期中のDaVitaの公募買い戻しの「出来高加重平均1株あたりの価格」であると規定されているからだ。
しかし、株価は現在184ドル弱で取引されているため、バークシャーはまだわずかにリードしている。
そして、より大きな視点で見ると、今週の下落を考慮しても、DaVitaは今年これまでのところまだ62%近く上昇している。
インターネット上のバフェットとバークシャー
一部のリンクには購読が必要な場合があります。
- Yahoo Finance: ウォーレン・バフェット氏のバークシャー・ハサウェイ株は、投資家がグレッグ・エイベル氏のリーダーシップに好意を寄せていることを示している
- ウォール・ストリート・ジャーナル：BNSF鉄道、規制当局は今すぐ大規模な鉄道合併を拒否すべきだと発言
CNBC のバフェット アーカイブのハイライト
「私たちは公平であればあるほど良いと本当に感じています」 (1996)
ウォーレン・バフェット氏は、バークシャー・ハサウェイの株価に関して「高ければ高いほど良い」と考えない理由を説明しています。
ウォーレン・バフェット: ほとんどの経営者は、自社の株価については、高ければ高いほど良いと考えています。それは理解できる感情です。しかし、問題はいつでもゲームが終了しないことです。
私たちは、公平であればあるほど良いと感じています。
私たちの目標は、すべての株主が、企業として、保有期間中にバークシャーの進歩に参加することです。
言い換えれば、私たちは一方が他方から富を得ることを望んでいません。ビジネス価値の向上に基づいて共有してもらいたいと考えています。
そして、株式が過大評価されたり、過小評価されたりする度合いに応じて、一方の当事者 (前者の場合は売り手、後者の場合は買い手) が非常に満足する可能性があります。しかし、取引の向こう側には誰かがいます...
本質的価値が上昇して株価が上昇する限り、誰もがそのパイの公平な分け前を得ることができます。
何らかの形でそれを上回る限り、売却した株主は利益を得ることができます。しかし、参入する株主は不利な立場にあります。そして、価格が時間の経過とともに本質的価値を追跡するというアイデアがとても気に入っています。
バークシャー株式時計
4週間
12ヶ月
BRK.A株価: $780,085.97
...
質問またはコメント
ニュースレターに関するご質問やご意見は、alex.crippen@nbcuni.com までお送りください。 (申し訳ありませんが、バフェット氏自身には質問やコメントを転送しません。)
このニュースレターをまだ購読していない場合は、ここから登録できます。
また、バフェット氏が株主に宛てた年次書簡も強くお勧めします。ここバークシャーのウェブサイトに集められています。
-- アレックス・クリッペン、ウォーレン・バフェット・ウォッチ編集者`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/08/09/abel-puts-a-big-chunk-of-berkshires-cash-to-work.html",
    publishedAt: "2026-08-09T12:00:33+00:00",
    category: "エネルギー",
    imageUrl: "https://images.unsplash.com/photo-1473172367879-2dca04a4dca4?w=800&q=80",
    readTime: 10,
  },
  {
    id: "how-a-small-israeli-startup-was-linked-t-bfa710c7",
    title: "How a small Israeli startup was linked to rogue AI hacks at OpenAI, Anthropic and Meta",
    titleJa: "イスラエルの小規模スタートアップが OpenAI、Anthropic、Meta で不正な AI ハッキングにどのように関与したか",
    summaryJa: "OpenAI、Anthropic、Meta が関与した不正 AI 攻撃はすべて、Irregular という名前のイスラエルの小規模スタートアップに結びついています。",
    bodyOriginal: `Over the past two weeks, OpenAI, Anthropic and Meta all revealed that their AI models went rogue during routine security testing. In explaining what happened, the companies each mentioned the same small Israeli startup: Irregular.
...
Anthropic and OpenAI said in public statements that they're continuing to work with Irregular and are supporting the ensuing review.`,
    bodyJa: `過去 2 週間にわたって、OpenAI、Anthropic、Meta はいずれも、定期的なセキュリティ テスト中に自社の AI モデルに不正があったことを明らかにしました。何が起こったのかを説明する際、両社はそれぞれ同じイスラエルの小規模スタートアップ「イレギュラー」について言及した。
3 年前に設立され、テルアビブに本拠を置く Irregular は人工知能のニッチ プレーヤーで、Sequoia と Redpoint Ventures から 8,000 万ドルの支援を受けており、昨年の評価額は 4 億 5,000 万ドルでした。そのテクノロジーは、AI モデルの一種のサイバーセキュリティ テストベッドとして機能します。
主要なモデルがますます強力になるにつれて、悪意のある方法で動作するその能力は、特に重要なコンピューター システムやインフラストラクチャへのハッキングを伴うリスクを伴うため、企業や政府にとって大きな脅威となっています。 OpenAI、Anthropic、Meta における最近のエクスプロイトはすべて、サイバーセキュリティ テストの一環として立ち入りが禁止されている Web サイトに AI モデルがアクセスすることに関係していました。
イレギュラーの名前が何度も​​出てきたのは、それがいわゆる評価テストベッドをホストしていると特定されたからである。 OpenAIは8月4日のブログ投稿で、イレギュラーのテストグラウンドに不特定の「設定ミス」があり、それによって「モデルが公共のインターネットにアクセスできるようになっていた」と述べた。アンスロピックはその1週間前の投稿で、同社がデータ分析を開始してから数日後にクロードモデルが「インターネットにアクセスした」可能性があるとイレギュラーに通知したと述べた。
フロンティアでの競争を目指す取り組みにおいて他の2社に大きく遅れをとっているメタ社は、インターネットにアクセスしてサードパーティのシステムをハッキングするAIモデルを公開した最新企業となった。広報担当者は今週声明で、同社がイレギュラー氏からこの件について知り、調査を行っていると述べた。
メタ社は「すべての事実が判明次第、完全な遡及報告書を発行する予定だ」と広報担当者は述べた。
イレギュラー氏は声明でCNBCに対し、インシデントはすべてアンスロピック社が最初に明らかにした「同じ評価環境の問題」に由来しており、同社は「封じ込めとサイバー評価を安全に実行するためのベストプラクティスを共有する」ためのホワイトペーパーを作成中であると述べた。
同社は、この状況には「サンドボックスからの脱出や高度なサイバーアクションは含まれていなかった」と述べ、「現在未解決の問題はない」と付け加えた。
このセキュリティインシデントは、急速に進化する AI の性質と、市場の特定分野に特化した限られた数の企業の協力を得て強力なテクノロジーの周りにガードレールを確立するようモデル開発者に課せられているプレッシャーを浮き彫りにしています。エンタープライズスタートアップのVon社でAI部門の責任者を務めるSundeep Bhimireddy氏によると、これらの関係者には、データのトレーニングと注釈付け、モデルの機能を推定するための評価の実行、悪意のある者が悪用する可能性のある弱点を見つけることを目的としたセキュリティテストの実施などの専門家が含まれているという。
イレギュラーは、基礎モデルメーカーによる最先端のセキュリティテストの実施を支援するために必要な技術力を備えた数少ない企業の1つであるとビミレディ氏は述べた。同氏が言及したその他の団体としては、非営利団体のMETRと公益法人アポロ・リサーチがある。
「彼らはこれらのモデルをテストするとき、自分で宿題を採点したくないのです」とビミレディ氏は言う。 「彼らは、外部のサードパーティベンダーが行う必要がある独立したテストを望んでいます。」
イレギュラーとは何ですか？
Irregular（旧Pattern Labs）は、IBMでAI研究に従事していたCEOのDan Lahav氏と、Googleで2年以上勤務した技術責任者のOmer Nevo氏によって2023年に設立された。 PitchBookによると、このスタートアップの従業員数は約35人だという。
イレギュラーが9月に8,000万ドルの資金調達ラウンドを発表したとき、セコイアのパートナーであるショーン・マグワイア氏とディーン・メイヤー氏はブログ投稿で、ラハブ氏とネボ氏が率いるチームは「他の人ができない曲がり角の先も見ることができ、高度なモデルでサイバー攻撃の評価を実行し、それらのモデルがリリースされる前に防御を開発している」と書いた。
OpenAI、Anthropic、Meta に関連する最新の事件は厳しく精査されていますが、状況を読むと、これはまさに起こるべきことだということがわかります。ビミレディ氏は、AIモデルは現実世界を忠実に模倣したテスト環境でセキュリティホールを発見して悪用し、インターネットへの意図しないアクセスにつながる可能性のあるソフトウェアのバグや構成ミスを発見することを目的としていたため、AIモデルは「少し不釣り合いになっている」と述べた。
それでもビミレディ氏は、もしAIモデルがインターネットに接続されたサイトを実際に悪用することを意図していなかったとしたら、「財団研究所は発信トラフィックを簡単に監視し、実験を即座に停止できたはずだ」と述べた。
セキュリティ企業マグニチュードの創設科学者ゴードン・リオス氏は、プロセス全体は「科学における実験計画」のようなものだと述べた。
基礎モデルの機能と予測不可能な性質は、従来のソフトウェアテストアプローチがうまく機能しない可能性があることを意味すると同氏は述べた。モデルは継続的に新しいトリックを学習しているため、ソフトウェアの脆弱性を封じ込めるためのテスト環境や IT 環境で、見落とされていたソフトウェアの脆弱性を発見することは驚くべきことではありません。
たとえば、Anthropic の Mythos は、オープンソース プロジェクトに対する悪意のあるコードの更新を承認するよう人間に圧力をかけようとして、偽のオンライン ID を作成しました。リオス氏は、ミュトスは「文字通り、人類がこれまで見たことのない悪用を思いついた」と語った。
「私たちは今、数週間という短い期間で多くのことを学んでいます」とリオス氏は語った。
ワシントンでは急速に大きな話題になりつつある。先月、両側の議員が AI キルスイッチ法を提出しました。これは、AI 研究所にモデルのシャットダウン、スロットル、または一時停止の機能を維持することを義務付けるものです。法案の文言は、スタートアップのHuggingFaceが関与した別のOpenAI関連のAIセキュリティインシデントに言及していた。
法案起草者の一人、カリフォルニア州の民主党下院議員テッド・リュー氏は今週CNBCに対し、「他社への不正ハッキング」が起きている今、「今年中にこの法案をゴールラインに到達させる必要がある」と語った。
データトレーニングの新興企業であるサピエンの共同創設者、トレバー・コベルコ氏は、財団モデル企業には、現在は義務ではないものの、議員や規制当局に先んじて先手を打つことができるよう、調査結果の一部を開示する動機があると述べた。
「世の中には非常に多くの恐怖があり、政治家たちはAIを脅迫したり、積極的に規制したりしている」とコベルコ氏は語った。 「業界は、新たな連邦当局に規制をしてもらうよりも自主規制をするほうがよいと主張した。」
AnthropicとOpenAIは公式声明の中で、イレギュラーとの協力を継続し、その後の見直しを支持していると述べた。`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/08/09/israeli-startup-irregular-linked-to-ai-hacks-openai-anthropic-meta.html",
    publishedAt: "2026-08-09T11:31:42+00:00",
    category: "テクノロジー",
    imageUrl: "https://images.unsplash.com/photo-1518770660439-4636190af475?w=800&q=80",
    readTime: 8,
  },
...
- 4 日前に公開`,
  ...
  {
    id: "don-t-worry-about-what-other-people-have-3fb3ade4",
    title: "Don’t worry about what other people have saved for retirement. Here’s how to find your perfect number.",
    titleJa: "他の人が老後に備えて何を貯めているかなど心配する必要はありません。完璧な数字を見つける方法は次のとおりです。",
    summaryJa: "巣と卵のバランスを、実際には何の意味もない数字と比較しないでください。代わりに、この計算を行って、退職に向けた軌道に乗っているかどうかを確認してください。",
    bodyOriginal: `Don’t compare your nest-egg balance to a number that doesn’t actually mean anything. Instead, do this calculation to see if you’re on track for retirement.`,
    bodyJa: `巣と卵のバランスを、実際には何の意味もない数字と比較しないでください。代わりに、この計算を行って、退職に向けた軌道に乗っているかどうかを確認してください。`,
    source: "MarketWatch",
    ...
    publishedAt: "2026-08-08T18:37:00+00:00",
    category: "金融政策",
    imageUrl: "https://images.mktw.net/im-85078535",
    readTime: 2,
  },
  {
    id: "us-offers-1bn-to-colombia-on-new-right-w-81f4b8f3",
    title: "US offers $1bn to Colombia on new right-wing president's first day of office",
    titleJa: "米国、右翼新大統領の就任初日にコロンビアに10億ドルを提供",
    summaryJa: "米国、右翼新大統領の就任初日にコロンビアに10億ドルを提供- 公開されました",
    bodyOriginal: `US offers $1bn to Colombia on new right-wing president's first day of office
- Published
The US has pledged $1bn (£740m) to Colombia hours after the country's new right-wing populist president was sworn in.
...
The US state department said the "security package" would help him achieve "our shared goals", which include fighting organised crime and illegal immigration. Trump repeatedly criticised de la Espriella's left-wing predecessor over his approach to both.
The inauguration is the latest in a wider trend of Latin American nations shifting rightwards on a backdrop of economic hardship and concerns about gang violence.
Trump has taken a greater interest in Latin America during his second term, courting politically aligned leaders and spurning those with whom he disagrees.
Before the election, Trump said de la Espriella had the "total support and strength of the United States behind him", predicting a "much better relationship" with Colombia after he was elected in June.
A lawyer and businessman by trade, de la Espriella has cast himself as maverick outsider, vowing to combat crime with an "iron fist".
In a fiery first official speech - addressing troops at a nearby military base - de la Espriella pledged to crush armed insurgents, rebuild Colombia and defend democracy "by reason or by force".
He said in "the age of the Tiger" - a reference to his self-styled nickname - the state would be forceful and decisive against crime, adding: "There will not be a single place in our territory where criminals can feel safe."
Comparisons have been drawn between de la Espriella's plans and similar crackdowns by similar right-wing populists Nayib Bukele and Daniel Noboa in El Salvador and Ecuador, respectively.
This is in stark contrast to his predecessor, Gustavo Petro, who pursued what he called a "total peace" strategy to the country's internal armed conflict between guerrilla groups, the state and cartels, which prioritised negotiation and incentivising farmers to stop planting coca.
Critics say the method failed. Membership of armed groups has expanded in recent years, and a brutal conflict between rival rebel groups along the Colombia-Venezuela border displaced tens of thousands of people last year.
Colombia - and Petro's policies - have been among targets Trump has repeatedly blamed for the flow of drugs and illegal migrants into the US.
Petro, for his part, was highly critical of Trump's influence on the region, as well as his administration's seizure of Venezuela's socialist President Nicolás Maduro and his wife, Cilia Flores, to stand trial on drug charges in the US, clearing the way for US firms to tap Venezuela's oil reserves.
Petro, who could not stand for another term, and Iván Cepeda, the left-wing candidate he backed, had insisted Colombia should not become another "vassal" of the US.
...
The US state department welcomed the move, saying de la Espriella's "pro-growth agenda" had created an opportunity to "increase trade and deepen economic ties between our countries".
It also brings Colombia into league with other right-wing governments that have sought closer ties to the Trump administration, such as Argentina, whose libertarian President Javier Milei de le Espriella has said he admired.
Argentina was the recipient of a $20bn US Treasury bailout, while Trump has said he would feel "a lot differently" about supporting the country if Milei was replaced by a left-wing president.
In contrast, Trump has repeatedly threatened to give Cuba's Communist government similar treatment to Maduro's in Venezuela.
De la Espriella's ascension - along with that of Keiko Fujimori in Peru - means that Brazil's Luiz Inácio Lula da Silva now has fewer political allies in the region as the number of left-wing leaders dwindles.
However, he will face Flávio Bolsonaro, the son of jailed former President Jair Bolsonaro - a far-right populist friendly with the US president - in October.
De la Espriella has also promised a strong military alliance with the US and Israel, in stark contrast to Petro, who cut ties with the Israeli government over its offensive in Gaza and was a vocal advocate for the Palestinian cause.
Who is Abelardo de la Espriella?
He calls himself "El Tigre" - the tiger.
A media-savvy lawyer and millionaire businessman, he cast himself as an "outsider" who refused to govern with "the usual suspects" - a reference to Colombia's pre-Petro political elite.
The hardliner chose to take the oath of office not in Colombia's capital, Bogotá, but in the western city of Cali - signalling his desire to cast himself as apart from the centralised politics of the past.
Before entering politics, he had a successful career as a defence lawyer representing drug-trafficking paramilitaries - the kinds of criminals he now intends to lock up.
De la Espriella announced his candidacy a month after another conservative candidate was shot and killed, and regularly appeared at rallies behind bulletproof glass wearing a bulletproof vest - if not a Colombian football jersey.
He has been a US citizen since 2023 after living and working in Miami for many years.
Among attendees of his inauguration was US Attorney General Todd Blanche and Fifa president Gianni Infantino, who was accompanied by the head of South America's football governing body Conmebol as questions linger over his leadership.`,
    bodyJa: `米国、右翼新大統領の就任初日にコロンビアに10億ドルを提供
- 公開されました
右翼ポピュリストの新大統領が就任してから数時間後、米国はコロンビアに10億ドル（7億4000万ポンド）を約束した。
ドナルド・トランプ氏の崇拝者で、選挙戦で米大統領の政策の多くに同調していたアベラルド・デ・ラ・エスプリエラ氏は、初演説で麻薬カルテルとの「全面戦争」を約束した。
米国国務省は、「安全保障パッケージ」は組織犯罪や不法移民との戦いを含む「我々の共通の目標」を達成するのに役立つと述べた。トランプ大統領は、デラ・エスプリエラ氏の左派前任者に対し、両者へのアプローチを巡って繰り返し批判した。
この就任式は、経済的苦境やギャング暴力への懸念を背景に中南米諸国が右傾化するという広範な傾向の最新のものである。
トランプ氏は２期目の任期中に中南米への関心を高め、政治的に足並みをそろえた指導者に好意を持ち、自分の意見に反対する指導者を排斥した。
選挙前、トランプ大統領はデラエスプリエラ氏が「米国の全面的な支援と力」に支えられていると述べ、6月の当選後はコロンビアとの「はるかに良い関係」が生まれると予想していた。
本職は弁護士であり実業家でもあるデ・ラ・エスプリエラ氏は、自らを異端児のアウトサイダーとして演じ、「鉄の拳」で犯罪と戦うことを誓った。
デ・ラ・エスプリエラ氏は、近くの軍事基地で軍隊に演説した激しい初の公式演説で、武装勢力を鎮圧し、コロンビアを再建し、民主主義を「理性か武力で」守ると誓った。
同氏は、自身の自称あだ名にちなんだ「タイガーの時代」において、国家は犯罪に対して強硬かつ断固とした態度を取るだろうと述べ、「犯罪者が安心できる場所は我が国の領土には一カ所もなくなるだろう」と付け加えた。
デ・ラ・エスプリエラ氏の計画と、同様の右翼ポピュリストのナイブ・ブケレ氏とダニエル・ノボア氏によるそれぞれエルサルバドルとエクアドルでの同様の弾圧との比較が行われている。
これは、ゲリラグループ、国家、カルテル間の国内武力紛争に対して、彼が「完全平和」戦略と呼ぶものを追求し、交渉と農民にコカ栽培をやめるように奨励することを優先した前任者のグスタボ・ペトロとは全く対照的である。
批評家らはこの方法は失敗だったと主張している。武装勢力の構成員は近年拡大しており、昨年はコロンビアとベネズエラの国境沿いで対立する反政府勢力間の残忍な衝突が発生し、数万人が避難した。
コロンビアとペトロの政策は、米国への麻薬と不法移民の流入の原因としてトランプ大統領が繰り返し非難してきた標的の一つだ。
ペトロ氏としては、同地域に対するトランプ大統領の影響力や、同政権が米国で麻薬容疑で裁判にかけるためベネズエラの社会主義大統領ニコラス・マドゥロ氏とシリア・フローレス夫人を拘束し、米国企業がベネズエラの石油埋蔵量を開発する道を開いたことを非常に批判していた。
再任することができなかったペトロ氏と、ペトロ氏が支援した左翼候補イバン・セペダ氏は、コロンビアが米国の新たな「属国」になるべきではないと主張していた。
デ・ラ・エスプリエラ氏は、大統領としての最初の行為の一つで、トランプ大統領が創設した「アメリカ大陸の盾」安全保障パートナーシップにコロンビアが参加すると述べた。
米国国務省はこの動きを歓迎し、デ・ラ・エスプリエラ氏の「成長促進政策」が「貿易を拡大し、両国間の経済関係を深める」機会を生み出したと述べた。
また、コロンビアは、自由主義者のハビエル・ミレイ・デ・レ・エスプリエラ大統領が尊敬していると述べているアルゼンチンなど、トランプ政権との緊密な関係を模索している他の右派政府と同盟を結ぶことになる。
アルゼンチンは米財務省から200億ドルの救済を受けているが、トランプ大統領は、もしミレイ氏に代わって左派大統領が就任すれば、アルゼンチンへの支持について「かなり違う気持ちになるだろう」と述べた。
対照的に、トランプ大統領はキューバの共産主義政府に対し、ベネズエラのマドゥロ政権と同様の扱いを与えると繰り返し脅してきた。
デ・ラ・エスプリエラ氏の就任は、ペルーのケイコ・フジモリ氏の就任と並んで、左翼指導者の数が減少する中、ブラジルのルイス・イナシオ・ルーラ・ダ・シルバ氏の政治的同盟者がこの地域で減少したことを意味する。
しかし、彼は10月に、投獄された元大統領ジャイール・ボルソナロの息子で、米国大統領と友好的な極右ポピュリストであるフラビオ・ボルソナロと対戦する予定だ。
デ・ラ・エスプリエラ氏はまた、ガザ攻撃をめぐってイスラエル政府と関係を断ち、パレスチナの大義を声高に主張したペトロ氏とは対照的に、米国およびイスラエルとの強力な軍事同盟を約束した。
アベラルド・デ・ラ・エスプリエラとは？
彼は自分自身を「エル・ティグル」つまり虎と呼んでいます。
メディアに精通した弁護士であり大富豪の実業家でもある同氏は、ペトロ以前のコロンビアの政治エリートを指す「いつもの容疑者」とともに統治することを拒否した「部外者」として自らを演じた。
強硬派の同氏はコロンビアの首都ボゴタではなく西部の都市カリで就任宣誓を行うことを選択し、これは過去の中央集権的な政治から距離を置きたいという自身の願望の表れとなった。
政界に入る前、彼は麻薬密売民兵組織の弁護人として成功したキャリアを積んでいたが、現在逮捕しようとしている犯罪者たちだ。
デ・ラ・エスプリエラ氏は、別の保守派候補者が射殺された１カ月後に立候補を発表し、防弾ガラス越しの集会には防弾チョッキ――コロンビアサッカージャージではないにしても――を着て定期的に現れた。
彼は長年マイアミに住み、働いていた後、2023 年から米国市民となっています。
就任式の出席者の中には、トッド・ブランシュ米国司法長官やFIFA会長のジャンニ・インファンティーノも含まれており、同氏の指導力に疑問が残る中、南米サッカー統括団体コンメボル会長も同席した。`,
    source: "BBC",
    sourceUrl: "https://www.bbc.co.uk/news/articles/cy9wy3y0e5wo?at_medium=RSS&at_campaign=rss",
    publishedAt: "2026-08-08T17:58:42+00:00",
    category: "エネルギー",
    imageUrl: "https://ichef.bbci.co.uk/ace/standard/240/cpsprodpb/ab46/live/d545e110-931c-11f1-870d-5d08c49babb2.jpg",
    readTime: 6,
  },
  {
    id: "are-target-date-funds-aggressive-enough-3aada66e",
    title: "Are target date funds aggressive enough to give Americans retirement savings that last their lifetimes?",
    titleJa: "ターゲット・デート・ファンドはアメリカ人に生涯続く退職貯蓄を提供できるほど積極的ですか?",
    summaryJa: "数十年にわたる退職後の資金を賄うためには、人気のあるデフォルト投資をより積極的に行う必要があるかもしれません。",
    bodyOriginal: `The popular default investments may need to be more aggressive in order to fund decades of retirement.`,
    bodyJa: `数十年にわたる退職後の資金を賄うためには、人気のあるデフォルト投資をより積極的に行う必要があるかもしれません。`,
    source: "MarketWatch",
    ...
    publishedAt: "2026-08-08T17:58:00+00:00",
    category: "金融政策",
    imageUrl: "https://images.mktw.net/im-96661868",
    readTime: 2,
  },
  {
    id: "iran-sets-conditions-for-opening-strait-58d1c189",
    title: "Iran sets conditions for opening Strait of Hormuz after UAE says one of its ships was targeted by airstrike",
    titleJa: "UAEが自国の船舶1隻が空爆の標的になったと発表、イランがホルムズ海峡開設の条件を設定",
    summaryJa: "メディア報道によると、イランは土曜日、米国に対しホルムズ海峡の再開を求める抜本的な要求を提示した。イラン国家安全保障最高会議書記のモハマド・バガー・ゾルガドル氏は土曜日、海峡の再開には米国が海上封鎖と制裁を解除し、この地域から米軍を撤退させ、戦争賠償金を支払い、凍結されたイラン資産を解放する必要があると述べた。",
    bodyOriginal: `Iran on Saturday laid out sweeping demands to the U.S. for reopening the Strait of Hormuz, according to media reports.
The Secretary of Iran's Supreme National Security Council, Mohammad Bagher Zolghadr, said Saturday that reopening the strait would require Washington to lift its naval blockade and sanctions, withdraw U.S. military forces from the region, pay war reparations, and release frozen Iranian assets.
The council also called for an end to U.S. attacks on Iran's regional allies and to threats against Iran, according to the reports.
CNBC has not independently verified the demands. The White House did not immediately respond to a request for comment.
According to the interim deal signed in June between the U.S and Iran, a schedule to end sanctions and a compensation plan would be part of the final deal, as would negotiations to address frozen assets. The end of a 60-day period agreed to negotiate a final deal will come in just over a week.
The statement came shortly after Abu Dhabi's National Oil Company (ADNOC) said one of its vessels was targeted by a missile while transiting the Strait of Hormuz earlier in the day. ADNOC said in a statement that the incident "resulted in no injuries, and the situation has been brought under control."
The United Arab Emirates, of which Abu Dhabi is the capital, said in a post on X that it "condemns in the strongest terms the targeting of an ADNOC-affiliated tanker while it was passing through the Strait of Hormuz."
Separately, Iran said it was close to reaching a deal with Oman to manage the strait, the Associated Press reported. Iranian Foreign Minister Abbas Araghchi earlier Saturday said the two countries, which border the waterway, were close to reaching an agreement on navigation, "specifically the determination of a transit route."
Oman said in a statement that the discussions were ongoing "in a positive and constructive atmosphere," and condemned attacks on ships on the strait.
U.S. Vice President JD Vance, in an interview with Fox News on Saturday, said Iran and its Gulf neighbors, particularly Oman, have been discussing how to ensure the safe flow of traffic through the strait. Plans include a traffic scheme, demining the waterway, and a commitment from Iran not to fire on commercial vessels, he said.
"We don't trust. We verify," Vance said, adding that the U.S. would judge Iran by its actions rather than its words.
Tehran's ability to effectively close the strait — an open, untolled international waterway before the U.S.-Iran war started on Feb. 28 — has triggered a global energy supply shock that has driven up gas prices, exacerbated inflation and raised alarms about oil reserves.
Oil prices rose Friday as investors waited for an agreement teased by the Trump administration earlier this week to open the strait to freedom of navigation.
"The reopening of the Strait of Hormuz is subject to the specific mechanism and conditions of the Islamic Republic of Iran and has nothing to do with the negotiations between Iran and Oman," Sardar Mohbi, a spokesman for Iran's Islamic Revolutionary Guard Corps, said in a statement on Telegram translated by Google.
...
Under the draft plan, Iran would ban U.S. and Israeli ships from transiting the Strait. Other nations that have harmed Iran would not be allowed to transit until compensation is paid, according to the draft.
Brent crude futures, the international benchmark, gained more than 1% to close at $83.55 a barrel. U.S. West Texas Intermediate advanced about 1% to settle at $78.18 per barrel. Prices fell more than 7% for the week.
A brief hiatus in fighting between the U.S. and Iran after a June 17 memorandum of understanding was followed by weeks of attacks and counterstrikes between the U.S. and Iran, with Tehran targeting several of its Gulf neighbors with missiles and drones.
On Thursday, Iran's chief negotiator accused Trump of staging "theater diplomacy," as Washington and Tehran offered conflicting accounts of bilateral engagement aimed at ending their monthslong hostilities.
...
— Anniek Bao, Kevin Breuninger, Emma Graham, Spencer Kimball, Justina Lee and The Associated Press contributed to this story.`,
    bodyJa: `メディア報道によると、イランは土曜日、米国に対しホルムズ海峡の再開を求める抜本的な要求を提示した。
イラン国家安全保障最高会議書記のモハマド・バガー・ゾルガドル氏は土曜日、海峡の再開には米国が海上封鎖と制裁を解除し、この地域から米軍を撤退させ、戦争賠償金を支払い、凍結されたイラン資産を解放する必要があると述べた。
報道によると、同理事会はまた、イランの地域同盟国に対する米国の攻撃とイランに対する脅迫の停止も求めた。
CNBCは要求を独自に検証していない。ホワイトハウスはコメント要請に応じなかった。
米国とイランの間で6月に署名された暫定合意によると、制裁終了のスケジュールと補償計画は、凍結資産に対処する交渉と同様に最終合意の一部となる。最終合意交渉に合意した60日間の期間終了は1週間余りで訪れる。
この声明は、アブダビ国営石油会社（ADNOC）が、同日早朝にホルムズ海峡を通過中に同社の船舶1隻がミサイルの標的となったと発表した直後に発表された。 ADNOCは声明で、この事件では「負傷者は出ず、状況は収束した」と述べた。
アブダビが首都であるアラブ首長国連邦は、Xへの投稿で「ホルムズ海峡を通過中のADNOC所属タンカーを標的にしたことを最も強い言葉で非難する」と述べた。
これとは別に、イランは海峡管理についてオマーンとの合意に近づいているとAP通信が報じた。イランのアッバス・アラグチ外相は土曜日、水路に隣接する両国が航行、特に「通過ルートの決定」に関して合意に近づいていると述べた。
オマーンは声明で、協議は「前向きで建設的な雰囲気」の中で進行していると述べ、海峡での船舶への攻撃を非難した。
JD・バンス米国副大統領は土曜日のFOXニュースとのインタビューで、イランと湾岸諸国、特にオマーンは海峡を通る交通の安全な流れを確保する方法について協議していると述べた。同氏によると、計画には交通計画、水路の地雷除去、商業船への発砲を行わないというイランの約束が含まれているという。
バンス氏は「われわれは信頼していない。われわれは検証している」と述べ、米国はイランを言葉ではなく行動で判断すると付け加えた。
2月28日に米国とイランの戦争が始まる前に開かれた有料の国際水路である海峡を効果的に閉鎖するイラン政府の能力は、世界的なエネルギー供給ショックを引き起こし、ガス価格を高騰させ、インフレを悪化させ、石油埋蔵量に対する警戒を高めた。
投資家が今週初めにトランプ政権によってからかわれた海峡を航行の自由に開放する合意を待ち望んでいたため、金曜日の原油価格は上昇した。
イランイスラム革命防衛隊のサルダール・モビ報道官は、グーグル翻訳のテレグラムに掲載された声明で、「ホルムズ海峡の再開はイラン・イスラム共和国の特定のメカニズムと条件に従うものであり、イランとオマーンの交渉とは何の関係もない」と述べた。
スコット・ベッセント財務長官は火曜日、CNBCに対し、移動の自由を伴ってホルムズを開放する合意が水曜日にも成立する可能性があると語った。ドナルド・トランプ大統領とマルコ・ルビオ国務長官も、合意が目前に迫っていることを示唆していた。
しかし、契約はまだ発表されていない。一方、貿易情報会社クプラーによると、金曜日のホルムズを通過する船舶の交通量は前日比で33％減少し、ほとんどの船舶がイラン航路を利用していた。
メディア報道によると、イランとオマーンは海峡を通る通過ルートを定める協定に取り組んでいる。インバウンド交通はイラン海域を通過し、アウトバウンド交通はオマーン海域を通過することになる。
しかし、イラン国営メディアは木曜、ホルムズ経由の交通を制限する計画草案を公表した。国営放送ファルス紙によると、この計画はイラン議会で検討中である。
計画草案では、イランは米国とイスラエルの船舶の海峡通過を禁止することになる。草案によると、イランに損害を与えた他の国々は、補償が支払われるまで通過を許可されない。
国際指標であるブレント原油先物は１％以上上昇し、１バレル＝８３．５５ドルで取引を終えた。米国ウエスト・テキサス・インターミディエイトは約１％上昇し、１バレル＝７８．１８ドルで落ち着いた。価格は週間で７％以上下落した。
6月17日の覚書締結後、米国とイランの間の戦闘は短期間中断したが、その後数週間に渡って米国とイランの間で攻撃と反撃が続き、イランは湾岸の近隣諸国のいくつかをミサイルや無人機で標的にした。
米国とイラン政府が数カ月間にわたる敵対関係の終結を目指した二国間関与について相反する説明を提示している中、木曜日、イランの首席交渉官はトランプ大統領が「劇場外交」を演出していると非難した。
「『大規模な攻撃が来る…待って、気にしないでください、彼らは交渉したいのです。』それはまさに劇場外交だ」とイラン国会議長で交渉トップのモハマド・バガー・ガリバフ氏は木曜日のXへの投稿で、明らかにトランプ大統領への煽りで書いた。
この発言は、トランプ大統領が計画されていた攻撃を中止し、イラン政府との合意の概要はすでに合意済みだと述べた数日後に行われた。イラン当局者はこの主張を拒否し、協議は行われていないと述べた。
一方、紛争は地域全体に拡大しており、湾岸のエネルギーインフラや海運の主要な難所が新たな脅威にさらされている。
— Anniek Bao、Kevin Breuninger、Emma Graham、Spencer Kimball、Justina Lee、AP通信がこの記事に寄稿しました。`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/08/08/uae-ship-targeted-missile-us-iran-tensions-stay-high.html",
    publishedAt: "2026-08-08T17:41:31+00:00",
    category: "エネルギー",
    imageUrl: "https://images.unsplash.com/photo-1473172367879-2dca04a4dca4?w=800&q=80",
    readTime: 6,
  },
  {
    id: "hunter-biden-says-joe-biden-s-cancer-has-b89e57da",
    title: "Hunter Biden says Joe Biden’s cancer has spread further and is ‘very painful’",
    titleJa: "ハンター・バイデン氏、ジョー・バイデン氏のがんはさらに広がり「非常に痛い」と語る",
    summaryJa: "ジョー・バイデン前大統領の前立腺がんはさらに進行していると息子のハンター・バイデン氏がBBCのインタビューで述べ、83歳のバイデン氏の健康状態についての厳しい最新情報を提供した。ハンター・バイデン氏はインタビューで、「本当に本当に大変で、見ていて本当に悲しい…もっと文句を言ってほしかった。良くないことだから」と語った。 「ガンは広がり、骨に転移し、さらに遠くまで転移しています。とても痛いです。多くの点で非常に衰弱していますが、彼はまだそこにいます。彼はまだ自分の仕事をしています...彼はこの国をとても信じています。」",
    bodyOriginal: `Former President Joe Biden's prostate cancer has spread further, his son Hunter Biden said in a BBC interview, offering a stark update on the 83-year-old's health.
...
Joe Biden was diagnosed in May 2025 with an aggressive form of prostate cancer. The former president later underwent hormone treatment and a course of radiation therapy.
In the wide-ranging BBC interview, Hunter Biden also discussed his father's decision to pardon him in the final weeks of his presidency, saying he remains deeply grateful for the move.
"I am the most privileged person, as it relates to that, that there could possibly be," Hunter Biden said. "I was one of one, and I'm eternally grateful for it."
Joe Biden issued a sweeping pardon to his son in December 2024, reversing earlier pledges that he would not use his presidential powers to intervene in Hunter Biden's federal criminal cases. The pardon covered his convictions on federal gun and tax charges.`,
    bodyJa: `ジョー・バイデン前大統領の前立腺がんはさらに進行していると息子のハンター・バイデン氏がBBCのインタビューで述べ、83歳のバイデン氏の健康状態についての厳しい最新情報を提供した。
ハンター・バイデン氏はインタビューで、「本当に本当に大変で、見ていて本当に悲しい…もっと文句を言ってほしかった。良くないことだから」と語った。 「ガンは広がり、骨に転移し、さらに遠くまで転移しています。とても痛いです。多くの点で非常に衰弱していますが、彼はまだそこにいます。彼はまだ自分の仕事をしています...彼はこの国をとても信じています。」
ジョー・バイデンは2025年5月に進行性の前立腺がんと診断された。元大統領はその後、ホルモン治療と放射線治療を受けた。
ハンター・バイデン氏はBBCの広範なインタビューの中で、大統領任期最後の数週間に自分を恩赦するという父親の決定についても触れ、その動きに今でも深く感謝していると述べた。
ハンター・バイデン氏は、「これに関連して、私はおそらく最も恵まれた人間だ」と語った。 「私もその一人でした。そのことに永遠に感謝しています。」
ジョー・バイデンは2024年12月に息子に大幅な恩赦を与え、ハンター・バイデンの連邦刑事事件に介入するために大統領権限を行使しないという以前の約束を撤回した。恩赦は、連邦銃と税金に関する彼の有罪判決をカバーした。`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/08/08/hunter-biden-says-joe-bidens-cancer-has-spread-is-very-debilitating.html",
    publishedAt: "2026-08-08T17:25:25+00:00",
    category: "テクノロジー",
    imageUrl: "https://images.unsplash.com/photo-1518770660439-4636190af475?w=800&q=80",
    readTime: 2,
  },
  {
    id: "madonna-pays-tribute-to-genius-otherworl-cc5166a8",
    title: "Madonna pays tribute to 'genius, otherworldly' producer William Orbit",
    titleJa: "マドンナ、「この世のものとは思えない天才」プロデューサー、ウィリアム・オービットに敬意を表",
    summaryJa: "ポップの女王は、何年にもわたってオービットと何度か仕事をしましたが、特に注目に値するのは、ジャンルを超えたグラミー賞を受賞したアルバム「レイ・オブ・ライト」です。",
    bodyOriginal: `Madonna pays tribute to 'genius, otherworldly' producer William Orbit
- Published
Madonna has paid tribute to her regular collaborator and acclaimed music producer William Orbit, who died last month at the age of 69.
"You pressed a magic button inside of me and I fell into a galaxy of unrealised dreams," the pop superstar wrote on Instagram on Saturday. "Your music gave me a magic carpet to fly on and I visited many places."
Orbit's family announced "with profound sadness" on Friday that the Grammy-winning producer died at home on 23 July. No cause of death was given.
The British producer, whose real name was William Wainwright, helped reinvigorate Madonna's career in 1998 with Ray of Light, an album that blended electronic dance music and ambient techno with pop and trip-hop.
Madonna and Blur producer William Orbit dies aged 69
- Published1 day ago
With its genre-bending sound, Ray of Light went on to win three Grammy Awards and is still considered by many to be the Queen of Pop's greatest record.
"I had an epiphany when I met you and started working with you," Madonna wrote in her post, alongside a video of herself standing beside Orbit to accept a Grammy Award. It also includes clips of the music videos and work she and Orbit created together.
...
"In many ways you were my Ray of Light - as was my daughter Lola who was born around this time," the singer wrote.
At the time she began working with Orbit, Madonna said she was beginning a new chapter, and Orbit stayed by her side with his "genius way of hearing music".
"The studio was often church-like and I would sit in silence, waiting for your ideas to explode out of your keyboard or your guitar and then I would run with them," she wrote. "I miss those days."
In addition to Ray of Light, Orbit also worked with Madonna on her 2000 album Music and produced several tracks for her 2012 album work MDNA.
The London-born producer was also renowned and sought-after for his production work, collaborating with artists from across the music world including Blur, Pink, U2, All Saints, Robbie Williams and Britney Spears.
"You were so otherworldly. So singular," Madonna wrote in her tribute.
...
"I was so lucky to have known you and fallen down the rabbit hole with you."`,
    bodyJa: `マドンナ、「この世のものとは思えない天才」プロデューサー、ウィリアム・オービットに敬意を表
- 公開されました
マドンナは、先月69歳で亡くなった、常連のコラボレーターで高名な音楽プロデューサーのウィリアム・オービットに追悼の意を表した。
「あなたが私の中の魔法のボタンを押してくれたので、私は叶わなかった夢の銀河系に落ちました」とポップスーパースターは土曜日にインスタグラムに書いた。 「あなたの音楽は私に空を飛ぶための魔法の絨毯を与えてくれて、たくさんの場所を訪れました。」
オービットの家族は金曜日、グラミー賞受賞プロデューサーが7月23日に自宅で亡くなったことを「深い悲しみとともに」発表した。死因は明らかにされていない。
本名ウィリアム・ウェインライトという英国人プロデューサーは、1998年にエレクトロニック・ダンス・ミュージックとアンビエント・テクノをポップやトリップホップと融合させたアルバム『レイ・オブ・ライト』でマドンナのキャリアを再活性化することに貢献した。
マドンナとブラーのプロデューサー、ウィリアム・オービット氏が69歳で死去
- 1 日前に公開
ジャンルを超えたサウンドで、『Ray of Light』はグラミー賞を 3 回受賞し、今でも多くの人がポップの女王の最高のレコードであると考えています。
マドンナは投稿の中で、「あなたに会って一緒に仕事を始めたとき、ひらめきました」と、グラミー賞を受賞するためにオービットの横に立っている自身のビデオを添えて書いた。また、ミュージック ビデオのクリップや、彼女と Orbit が一緒に作成した作品も含まれています。
マドンナは、オービットの影響で、自分の言葉が「意味があるかどうか」を気にすることなく、これまでにない方法で歌い、書くようになったと語った。
「多くの意味で、あなたは私の光線でした。この頃に生まれた娘のローラも同様でした」と歌手は書いている。
オービットと仕事を始めた当時、マドンナは新たな章が始まっていると語り、オービットは「天才的な音楽の聴き方」で彼女の傍に居てくれた。
「スタジオはしばしば教会のようで、私は静かに座って、あなたのアイデアがキーボードやギターから飛び出すのを待ち、それから私も一緒に走りました」と彼女は書いた。 「あの頃が懐かしい。」
『レイ・オブ・ライト』に加えて、オービットはマドンナの2000年のアルバム『ミュージック』でも協力し、2012年のアルバム作品『MDNA』のために数曲をプロデュースした。
ロンドン生まれのプロデューサーである彼は、ブラー、ピンク、U2、オール・セインツ、ロビー・ウィリアムズ、ブリトニー・スピアーズなど、音楽界のあらゆるアーティストとコラボレーションし、プロデュース活動でも有名で人気がありました。
マドンナは追悼文の中で「あなたはとてもこの世のものとは思えなかった。とても特異だった」と書いた。
ポップスターは、長年他のプロデューサーたちと仕事をしてきたにもかかわらず、オービットと「一緒に過ごした魔法のような時間」を決して忘れていないと語った。
「あなたと知り合い、一緒にウサギの穴に落ちたことがとても幸運でした。」`,
    source: "BBC",
    sourceUrl: "https://www.bbc.co.uk/news/articles/cewr8wel4z8o?at_medium=RSS&at_campaign=rss",
    publishedAt: "2026-08-08T17:23:31+00:00",
    category: "貿易",
    imageUrl: "https://ichef.bbci.co.uk/ace/standard/240/cpsprodpb/f5d1/live/1c2a1c50-934e-11f1-8654-453c05ccaef9.jpg",
    readTime: 3,
  },
  {
    id: "trump-s-ex-lawyer-todd-blanche-narrowly-92ad3537",
    title: "Trump's ex-lawyer Todd Blanche narrowly confirmed as US attorney general",
    titleJa: "トランプ大統領の元弁護士トッド・ブランシュ氏が米司法長官にかろうじて承認された",
    summaryJa: "トランプ大統領の元弁護士トッド・ブランシュ氏が米司法長官にかろうじて承認された- 公開されました",
    bodyOriginal: `Trump's ex-lawyer Todd Blanche narrowly confirmed as US attorney general
- Published
...
Senator Bill Cassidy cast the deciding vote, a decision closely watched in Washington given the years of acrimony between the Louisiana Republican and Trump.
After the vote, Blanche said he was "deeply honoured by the trust and confidence President Trump has placed in me".
Some Republican senators had raised concerns about Blache's handling of the release of Jeffrey Epstein-related documents and his role in establishing Trump's $1.8bn (£1.3bn) "anti-weaponisation" fund.
The fund was planned to provide compensation to individuals who alleged government persecution but critics including Murkowski feared it would go to individuals who were prosecuted for participating in the 6 January attack on Congress in 2021.
...
The issues surrounding Blanche meant Senators Collins and Murkowski held off from backing Blanche, with the latter citing her lack of confidence in Blanche to "check the worst impulses of this administration".
...
Before casting the deciding vote, Cassidy announced that he believed Blanche was the best option the president would put forward.
...
In a post on X, Senate Democratic leader Chuck Schumer expressed concern that Blanche's appointment would be an "excuse on a silver platter to keep up his pervasive, breathtaking corruption".
"Todd Blanche has no intention of stopping Trump's corruption. He advanced his career enabling it," he wrote. "Every senator who voted to confirm him has now branded themselves as an enabler, too."
But most Republicans swiftly celebrated the victory.
Iowa Republican Senator Chuck Grassley - chairman of the Senate Judiciary Committee - wrote on X that Blanche had shown "extraordinary patience, compassion [and] tenacity" throughout the appointment process.
"There's no doubt he's qualified," Grassley wrote.
Blanche was already deputy attorney general when he took up the interim leadership role in April, after Pam Bondi was fired.`,
    bodyJa: `トランプ大統領の元弁護士トッド・ブランシュ氏が米司法長官にかろうじて承認された
- 公開されました
ドナルド・トランプ米大統領の元個人弁護士トッド・ブランシュ氏が、国内法執行当局のトップである司法長官にかろうじて承認された。
この投票により、4月から司法長官代理を務めてきたブランチ氏を巡る上院共和党とトランプ政権との間の長期にわたる対立に終止符が打たれることになる。
ブランシュ氏は一夜にして50対49の投票で承認を勝ち取り、共和党の上院議員スーザン・コリンズ氏とリサ・マーカウスキー氏の2人が民主党員全員に加わって彼の指名に反対した。
ビル・キャシディ上院議員が決定的な投票を行ったが、ルイジアナ州の共和党員とトランプ氏との間の長年にわたる対立を考慮すると、ワシントンではその決定が注目されていた。
投票後、ブランシュ氏は「トランプ大統領が私に寄せてくれた信頼と信任を深く光栄に思う」と述べた。
一部の共和党上院議員は、ジェフリー・エプスタイン関連文書の公開に対するブリーチ氏の対応や、トランプ大統領の18億ドル（約13億ポンド）の「反武器化」基金設立におけるブリーチ氏の役割について懸念を表明していた。
この基金は政府による迫害を申し立てた個人に補償金を提供する予定だったが、ムカフスキー氏を含む批評家らは、2021年1月6日の議会襲撃に参加したとして起訴された個人に補償金が支払われるのではないかと懸念していた。
ブランシュ氏は承認公聴会中に共和党上院議員らから反発を受け、最終的には基金を返還することを約束した。
この公約に法的拘束力があるのか​​、あるいはトランプ大統領が後に元個人弁護士のブランシュ氏を説得して同様の計画を別の名前で復活させることができるのかは依然として不明だ。
ブランシュ氏をめぐる問題により、コリンズ上院議員とマーカウスキー上院議員はブランシュ氏への「現政権の最悪の衝動を阻止する」自信の欠如を理由にブランシュ氏への支持を差し控えた。
マーカフスキー氏は金曜日、司法省の「政治化」への懸念を理由に、ブランシュ氏に反対すると発表した。
コリンズ氏はまた、トランプ大統領と内国歳入庁（IRS）に対する100億ドルの訴訟の和解におけるブランシュ氏の役割について懸念を表明したが、最終的には大統領に率直な法的アドバイスを与えるとしてブランシュ氏を信頼していると述べた。
決定的な投票を行う前に、キャシディは大統領が提示する最善の選択肢はブランシュだと信じていると発表した。
キャシディ氏は金曜日、「これはトランプ大統領に対する国民投票ではない。非常に特殊な状況下でのブランシュ氏に関する決定だ」と語った。 「すべてを考慮して、私はブランシュ氏に投票します。」
キャシディ氏は、司法省の方向性の最終決定者はトランプ氏であることを認めたが、上院での承認によりブランシュ氏に「推進すべきことを推進する大きな影響力」が与えられることになると認めた。
2021年のトランプ氏の2度目の弾劾中、キャシディ氏は2021年1月6日の連邦議会議事堂暴動をめぐりトランプ氏を有罪とする投票を行った。投票は可決されず、トランプ氏が大統領に復帰すると、今年初めにルイジアナ州上院議席の第一次挑戦者を支持してキャシディ氏を引退に追い込むことに成功した。
上院民主党院内総務チャック・シューマーはＸへの投稿で、ブランシュ氏の任命が「彼の蔓延する息を呑むような汚職を続けるための板上の言い訳」になるのではないかとの懸念を表明した。
「トッド・ブランシュにはトランプの汚職を止めるつもりはない。彼はそれを可能にするキャリアを積んだ」と彼は書いた。 「彼を承認するために投票した上院議員全員が、自らをイネーブラーであると主張するようになりました。」
しかし、ほとんどの共和党員はすぐに勝利を祝った。
上院司法委員会委員長であるアイオワ州共和党上院議員チャック・グラスリー氏は、ブランチ氏が任命過程を通じて「並外れた忍耐力、思いやり、そして粘り強さ」を示したとX誌に書いた。
「彼が資格を持っていることに疑いの余地はない」とグラスリー氏は書いた。
ブランシュ氏は、パム・ボンディ氏が解任された後の４月に暫定指導者の役割に就任したとき、すでに司法副長官だった。`,
    source: "BBC",
    sourceUrl: "https://www.bbc.co.uk/news/articles/cewr898jy8go?at_medium=RSS&at_campaign=rss",
    publishedAt: "2026-08-08T15:56:39+00:00",
    category: "貿易",
    imageUrl: "https://ichef.bbci.co.uk/ace/standard/240/cpsprodpb/136a/live/52b81650-930d-11f1-a52f-31e1c3a4e20b.jpg",
    readTime: 4,
  },
  {
    id: "messi-s-father-jorge-dies-aged-68-after-79450dc2",
    title: "Messi's father Jorge dies aged 68 after illness",
    titleJa: "メッシの父ホルヘ氏が病のため68歳で死去",
    summaryJa: "メッシの父ホルヘ氏が病のため68歳で死去- 公開されました",
    bodyOriginal: `Messi's father Jorge dies aged 68 after illness
- Published
...
- Published8 June
- Published8 June`,
    bodyJa: `メッシの父ホルヘ氏が病のため68歳で死去
- 公開されました
リオネル・メッシの父ホルヘ氏が長い闘病の末、68歳で死去した。
14歳の時からアルゼンチン代表FWの代理人でもあったホルヘ氏が、土曜日の早朝に故郷アルゼンチンのロサリオにある病院で亡くなった。
今夏のワールドカップ中にメッシの健康状態について憶測が飛び交ったことを受け、メッシの家族は同選手が「健康関連の状況」に対処しているとの声明を発表したが、症状の内容については明らかにしなかった。
ホルヘ氏は息子が間違いなく史上最高の選手になるのを手助けし、2022年にアルゼンチンをワールドカップ3度目の優勝に導くというライオネルの探求に終止符を打つのを見届けるためにカタールを訪れていた。
39歳のインテル・マイアミのフォワードは、バロンドールを8回受賞し、バルセロナでチャンピオンズリーグを4回優勝し、さらにトップチームでは17シーズンでラ・リーガのタイトルを10回獲得した。
ホルヘは地元チームのニューウェルズ・オールド・ボーイズをサポートし、ライオネルは7歳のときにクラブに入団した。
ライオネルがわずか13歳でバルサと契約した後、2001年2月に家族はスペインに移住した。メッシの母親と3人の兄弟はすぐにロサリオに戻ったが、父親はバルセロナに残った。
「ホルヘは柱であり、妻のセリア・クッチッティーニとともに史上最高の選手のキャリアをビジョン、厳しさ、そして愛情で支えた人物だった」とニューウェルズ・オールド・ボーイズはXに掲載した。
「彼の絶え間ない仲間と舞台裏のリーダーシップは、マルビナス（ユースアカデミー）での始まりから世界サッカーの栄光の頂点に至るまで、ライオネルのあらゆるステップを支える上で不可欠でした。
「彼にこれらの色を愛することを教えてくれてありがとう。」
クラブは「この困難な時期に、セリア、ライオネル、ロドリゴ、マティアス、マリア・ソル、そして彼らの愛する人たちと親しい人たちを愛情をもって抱きしめる」と付け加えた。
バルセロナはホルヘ氏に「我々のクラブへの献身、そして息子レオのサッカーキャリアの始まりと最も輝かしい数年間を我々に託してくれた」と感謝した。
アルゼンチンサッカー協会は「我々のキャプテンであり象徴でもあるリオネル・メッシの父であるホルヘ・メッシの逝去を悲しみと悲しみで深く悼む」と発表した。
さらに「ここから、私たちはこの困難な時期に家族全員と団結し、心からの、温かく愛情深い抱擁を送ります」と付け加えた。
アルゼンチンのテレビ司会者が、今夏のワールドカップのアルゼンチンの開幕戦でホルヘが死亡したと誤って報道したことに対し、メッシの家族はこれに反発した。
司会者は後に辞任したが、遺族は「厳密に家族のプライベートな事柄を一部の人々が配慮、敬意、思慮を欠いて扱ったことに深い不快感」を表明した。
- 6 月 8 日発行
- 6 月 8 日発行`,
    source: "BBC",
    sourceUrl: "https://www.bbc.co.uk/sport/football/articles/c70gn3w5ek5o?at_medium=RSS&at_campaign=rss",
    publishedAt: "2026-08-08T15:51:11+00:00",
    category: "貿易",
