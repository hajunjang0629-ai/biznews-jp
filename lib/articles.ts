...
- 公開されました
乗客らによると、ライアン航空の旅客機で男性が空中で客室の窓から頭から吸い込まれそうになったという。
追跡データによると、同機は高度9,000フィート（約2,700メートル）急降下した際、約10分間空中にいたことが示されており、乗客らは地元メディアに対し「何らかの爆発音を聞いた」と語った。
ギリシャの病院関係者は、61歳のセルビア人が摩擦熱傷の治療を受けていると述べた。 「彼の妻は、彼が吸い出されるのを防ぐために、約5分間彼の足をつかんだ」とミカリス・ジャンナコスさんは語った。
ライアンエアは声明で、ギリシャのテッサロニキ市発ドイツのメミンゲン行き金曜朝の便が「離陸直後、飛行中に乗客の窓が外れたため」引き返したと発表した。
アイルランドの格安航空会社は「航空機は正常に着陸し、乗客はターミナルに戻った。乗客１人はテッサロニキの地上で医療支援を要請し、受けた」と発表した。
数時間後には「代替機が乗客をメミンゲンに運ぶために手配された」と付け加えた。
乗客らが地元メディアに語ったところによると、男性は頭から肩まで窓の外にぶら下がったまま放置され、その後、他の乗客がなんとか窓の中に引き戻したという。
乗客らは、窓がジェット機のエンジンの破片で割られたとも述べているが、ライアンエアーはこれについてコメントしていない。
...
別の乗客ソフィアさんはラジオ・テッサロニキに対し、「酸素マスクが落ちたとき、何が起こるか全く分かりませんでした。無事に戻れるかどうかも分かりませんでした。私たちは飛行機の後部に座っていましたが、何らかの爆発があったことに気づきました。」
「私たちは飛行機が墜落すると思った。減圧は極端でした。息ができないような感じでした。負傷した男性は出血し、数回意識を失ったが、おそらく酸素不足とショックが原因だろう」とソフィアさんは付け加えた。
全ギリシャ公立病院職員連盟のミカリス・ジャンナコス会長は後に、61歳のセルビア人男性が摩擦熱傷で病院で治療を受けていると語った。
「彼はショック状態にあり、意識はまだ残っている」と付け加えた。
この航空機は18年前の飛行機とみられ、ライアンエアの子会社マルタ航空が運航していた。
テッサロニキ空港の運営会社フラポート・ギリシャは、「この事件は現在、ギリシャ航空・鉄道安全調査局によって調査中である」と述べた。
フラポート・ギリシャは「すべての関係者と全面的に協力しており、航空機の強制帰還後に確立された緊急対応手順を発動した」と付け加えた。
アイルランド航空局（IAA）は先にBBCに対し、この事件を認識しており、捜査員にあらゆる支援を提供すると述べた。
元航空パイロットのクリス・ブレイディさんはBBCに対し、シートベルトが締められていなかったら事故は「さらに悪化していた可能性がある」と語った。
「機長が乗客にいつも言っているように、飛行中は予防措置として、たとえベルト着用サインを消灯している場合でもシートベルトを締めたままにしてください。
「そして、それはまさにこの種のこと、または乱気流に遭遇したときなどに備えてのものです。したがって、シートベルトを着用したままにすることをお勧めします」と彼が言いました。
2018年、米国のサウスウエスト航空便で、破損したエンジンの破片で窓が割れ、一部が吸い出された乗客が死亡した。
Mark Allison と Nikos Papanikolaou による追加レポート
連絡する
この物語の問題の影響を受けましたか?お知らせください。
- 6 月 11 日発行`,
    source: "BBC",
    sourceUrl: "https://www.bbc.co.uk/news/articles/cgk65knkyzdo?at_medium=RSS&at_campaign=rss",
    publishedAt: "2026-07-10T16:42:24+00:00",
    category: "マクロ経済",
...
イージージェットは、アポロの提案は一株当たり7.15ポンドの価値があると述べたが、キャッスルレイクからの提案は1株当たり6.90ポンドであり、現時点では「もはや受け入れる気はない」としている。
キャッスルレイクは短い声明で、イージージェットとアポロの声明に注目し、「提案の可能性に関して選択肢を検討している」と述べた。
...
ブルームバーグ・インテリジェンスのシニア消費者アナリスト、コンロイ・ゲイナー氏は、アポロ社はイージージェットの成長モデルを「より明確に」支持しているが、「航空会社のマージンを改善する必要性は、コスト削減の成功が必ずしも運賃引き下げにつながるわけではないことを示唆している」と述べた。
...
しかしイージージェットは日曜、約52億ポンド相当の買収提案の可能性についてキャッスルレイクと大筋合意に達したと発表した。
イージージェット、52億ポンドの買収契約に「大筋」合意
- 5 日前に公開
ナプキンに名前: EasyJet 30 周年を祝う
- 2025 年 11 月 10 日発行
...
アポロは、この合意をめぐるEUの条件を満たすために「あらゆる必要な措置を講じる」と述べた。
...
「現在、スポットライトは最初の求婚者（キャッスルレイク）に戻り、アポロを倒すためにさらに深く掘り下げるかどうかが確認されています。株主は脚を上げて乗り心地を楽しむでしょう。」`,
    ...
    publishedAt: "2026-07-10T15:02:45+00:00",
    category: "マクロ経済",
