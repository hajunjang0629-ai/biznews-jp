...
— CNBCのルーク・ファウンテン氏とヒュー・リースク氏もこのレポートに貢献しました。`,
  ...
  },
  {
    ...
    summaryJa: "米国とイランの間の紛争継続により、米国による再度の攻撃と米軍の死傷を受けて、ホルムズ海峡を通るエネルギー輸送の中断に対する懸念が高まっているため、月曜日の原油価格は上昇した。国際指標となるブレント原油（9月渡し）は約2.77％上昇して1バレル当たり90ドルを超え、8月渡しの米国ウェスト・テキサス・インターミディエイト原油は約2.4％上昇して84.49ドルとなった。",
    bodyOriginal: `Oil prices rose Monday as continued conflict between the United States and Iran has heightened concerns over disruptions to energy shipments through the Strait of Hormuz, following another round of U.S. strikes and American military casualties.
...
The renewed hostilities have revived concerns about the security of one of the world's most important oil transit routes.
U.S. Centcom said has targeted Iranian coastal surveillance and air defense systems, maritime assets, as well as missile and drone storage facilities in its strikes. American forces have also struck Islamic Revolutionary Guard Corps units linked to the July 17 attack on U.S. personnel in Jordan.
Quantum Strategy's David Roche highlighted in a note on Monday that the global crude market has become significantly tighter as Gulf exports dwindle.
"At this rate of depletion oil inventories get tight in September and even the U.S. gets stressed. That will up the TACO pressure on President Trump. Stay long Brent with a target of $95 to $105 a barrel."`,
    bodyJa: `米国とイランの間の紛争継続により、米国による再度の攻撃と米軍の死傷を受けて、ホルムズ海峡を通るエネルギー輸送の中断に対する懸念が高まっているため、月曜日の原油価格は上昇した。
国際指標となるブレント原油（9月渡し）は約2.77％上昇して1バレル当たり90ドルを超え、8月渡しの米国ウェスト・テキサス・インターミディエイト原油は約2.4％上昇して84.49ドルとなった。
今回の事態拡大は、米軍が最近の作戦で３人目の米軍人が死亡したことを確認したことを受けて起きたもので、以前に米軍人２人が死亡、１人が行方不明となっていたヨルダンでのイランによる攻撃現場近くで捜査当局が身元不明の遺体を回収した。
アメリカ軍はイラン目標に対する9夜連続の攻撃を完了した。米中央軍はX通信の声明で、「今回の攻撃は、ホルムズ海峡を通過する商船や民間船員への攻撃に使用されるイランの軍事能力を低下させ続けるだろう」と述べた。
新たな敵対関係により、世界で最も重要な石油輸送ルートの一つの安全に対する懸念が再燃している。
米セントコムは、イランの沿岸監視・防空システム、海洋資産、ミサイルや無人機の保管施設を攻撃の標的にしていると発表した。米軍はまた、7月17日のヨルダン米軍人襲撃事件に関連したイスラム革命防衛隊部隊を攻撃した。
クオンタム・ストラテジーのデビッド・ロシュ氏は月曜のメモで、湾岸輸出の減少に伴い世界の原油市場が大幅に逼迫していると強調した。
「このペースで枯渇すると、9月には石油在庫が逼迫し、米国さえもストレスを感じることになる。それはトランプ大統領に対するTACOの圧力を高めることになるだろう。1バレル95ドルから105ドルを目標にブレントを長く維持するだろう。」`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/07/20/oil-prices-today-brent-wti-crude-us-iran-centcom-hormuz.html",
    publishedAt: "2026-07-20T03:27:10+00:00",
    category: "エネルギー",
    imageUrl: "https://images.unsplash.com/photo-1473172367879-2dca04a4dca4?w=800&q=80",
    readTime: 2,
  },
  {
    id: "samsung-biologics-makes-1-8-billion-all-ad797865",
    title: "Samsung Biologics makes $1.8 billion all-cash offer for Switzerland's PolyPeptide Group",
    titleJa: "サムスンバイオロジクス、スイスのポリペプチドグループに全額現金18億ドルのオファーを提示",
    summaryJa: "韓国のサムスンバイオロジクスは月曜日、ペプチドベースの医薬品原薬を専門とするスイスのポリペプチドグループに対し、全額現金14億6000万スイスフラン（18億ドル）で入札したと発表した。公開買い付けの条件に基づき、株主は１株当たり４４．３１スイスフランを受け取ることになる。この取引は今年末までに完了する予定です。",
    bodyOriginal: `South Korea's Samsung Biologics said on Monday that it had made an all-cash bid of 1.46 billion Swiss francs ($1.8 billion) for Switzerland's PolyPeptide Group, which specializes in peptide-based active pharmaceutical ingredients.
Under the terms of the public tender offer, stockholders will receive 44.31 Swiss franc per share. The transaction is expected to close by the end of this year.
The acquisition will be the largest biopharmaceutical M&A deal in the country's history, Samsung Biologics said, as it aims to diversify its portfolio by expanding into peptide therapeutics, one of the fastest-growing segments in the biopharmaceutical industry due to surging demand for obesity treatment.
Peptide therapeutics are medicines made from short chains of amino acids, including some GLP-1 obesity and diabetes drugs that mimic a natural hormone to reduce appetite and regulate blood sugar.
"After a comprehensive review of strategic options, the Board is convinced that Samsung Biologics' offer is compelling for our shareholders, delivering an attractive cash price and immediate, certain value today," said Peter Wilden, chairman, PolyPeptide.
Samsung Biologics said that the acquisition will broaden the scope of its existing offerings centered on antibody drugs and antibody-drug conjugates. The South Korean firm also seeks to meet growing client demand across a broader range of therapeutic modalities, driven by peptide-based GLP-1 therapies for obesity and diabetes.
The deal will also expand Samsung Biologics' global footprint by securing PolyPeptide's global network across Sweden, Belgium, France, the U.S. and India, encompassing its R&D, development, and commercial manufacturing capabilities.
Headquartered in Baar, Switzerland, PolyPeptide Group, which was spun off in 1996 from global pharmaceutical company Ferring, has a track record of developing and producing more than 1,000 therapeutic peptides.
Samsung Biologics shares slipped 1.3% early Monday.`,
    bodyJa: `韓国のサムスンバイオロジクスは月曜日、ペプチドベースの医薬品原薬を専門とするスイスのポリペプチドグループに対し、全額現金14億6000万スイスフラン（18億ドル）で入札したと発表した。
公開買い付けの条件に基づき、株主は１株当たり４４．３１スイスフランを受け取ることになる。この取引は今年末までに完了する予定です。
サムスンバイオロジクスによると、この買収は国内史上最大のバイオ医薬品M&A取引となり、肥満治療の需要急増によりバイオ医薬品業界で最も急速に成長している分野の一つであるペプチド治療薬に拡大することでポートフォリオを多様化する狙いがあるという。
ペプチド治療薬は、天然ホルモンを模倣して食欲を抑え、血糖値を調節する一部の GLP-1 肥満薬や糖尿病薬など、アミノ酸の短鎖から作られる薬です。
「戦略的選択肢を包括的に検討した結果、取締役会はサムスンバイオロジクスの提案が当社の株主にとって魅力的であり、魅力的な現金価格と即時的かつ確実な価値を今日提供できると確信している」とポリペプチドのピーター・ワイルデン会長は述べた。
サムスンバイオロジクスは、この買収により、抗体医薬品および抗体-薬物複合体を中心とする既存の製品の範囲が拡大すると述べた。同社はまた、肥満と糖尿病に対するペプチドベースのGLP-1療法を推進する、より幅広い治療法にわたる顧客の需要の高まりに応えようとしている。
この契約により、スウェーデン、ベルギー、フランス、米国、インドにわたるポリペプチドの研究開発、開発、商業生産能力を含む世界的ネットワークを確保することにより、サムスンバイオロジクスの世界的な拠点も拡大することになる。
スイスのバールに本社を置くポリペプチド グループは、世界的製薬会社フェリングから 1996 年に独立して設立され、1,000 を超える治療用ペプチドの開発と生産の実績があります。
サムスンバイオロジクス株は月曜初めに１．３％下落した。`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/07/20/samsung-biologics-polypeptide-group-deal-switzerland.html",
    publishedAt: "2026-07-20T03:19:36+00:00",
    category: "テクノロジー",
    imageUrl: "https://images.unsplash.com/photo-1518770660439-4636190af475?w=800&q=80",
    readTime: 2,
  },
  {
    id: "u-s-hits-iran-for-ninth-consecutive-nigh-68a85dcd",
    title: "U.S. hits Iran for ninth consecutive night as American casualties rise",
    titleJa: "米国、9夜連続でイランを攻撃、米軍死傷者増加中",
    summaryJa: "米軍は日曜、ホルムズ海峡で商業船舶を攻撃するイラン政府の能力を破壊することを目的とした作戦を継続した。米中央軍は午後10時にイランに対する9夜連続の攻撃を完了した。東部時間日曜日、CentcomはXに関する投稿を発表した。",
    bodyOriginal: `The U.S. military on Sunday continued its campaign aimed at destroying Tehran's ability to attack commercial shipping in the Strait of Hormuz.
The U.S. Central Command completed the ninth consecutive evening of strikes against Iran, at 10 p.m. ET on Sunday, Centcom said a post on X.
The three-hour exercise targeted Iranian military command centers, air defense and coastal surveillance sites, maritime capabilities, missile and drone launch sites, aimed at further diminishing Tehran's capabilities to attack commercial vessels and civilian mariners transiting the strait, Centcom said.
The warring powers have intensified their attacks in the region, stoking fears of a return to full war, with Washington and Tehran accusing each other of violating a memorandum of understanding reached in June.
The waterway, which handled around 20% of the world's oil traffic before the war, has become the central battleground of the war that began on Feb. 28, when the U.S. and Israel launched strikes on Iran. Oil rose on the escalation, with Brent crude futures climbing almost 3% to about $90.7 a barrel, while U.S. WTI futures rose 2.5% to $84.6.
The human toll continued to climb over the weekend. U.S. forces said Sunday that a third American service member was killed in recent fighting with Iran, and that it had located unidentified remains in Jordan after a service member was listed as missing in action, bringing the number of U.S. personnel killed in the nearly five-month war to 17.
Iranian authorities said Sunday that at least 50 people were killed and more than 500 wounded in the renewed U.S. strikes this month.
"The memorandum said little about how disputed incidents would be investigated or how a breach in one area would affect obligations elsewhere," said Michael Feller, chief strategist at Geopolitical Strategy. The memorandum's ambiguity meant the incident quickly became a dispute over whether the agreement still existed, he noted.
U.S. strikes have widened in recent days to target civilian infrastructure, including the Bonji desalination plant that cut off water supplies to about 10,000 people.
Tehran has also retaliated across the Gulf with fresh attacks on targets in neighboring countries, including Bahrain, Saudi Arabia, and Jordan. The Kuwaiti army said Monday that its air defense systems were intercepting "hostile" drone attacks from Iran.
The U.S. embassy in Bahrain's capital, Manama, said Monday that it has information suggesting that Iran may seek to target unspecified locations in the city. Sirens sounded across Bahrain as authorities urged residents to take shelter.
Iran's Islamic Revolutionary Guard Corps said Monday that two oil tankers "exploded" attempting to travel through the "unsafe and dangerous route south of the Strait of Hormuz." The Iranian authority has warned vessels against using the U.S. and Oman-backed southern corridor, insisting that only Iranian-designated routes are permitted.
Hormuz traffic has slowed to the lowest level in three weeks amid renewed hostilities, according to maritime intelligence firm Kpler, with only eight passings on Thursday compared to 15 a day earlier.
U.S. officials, however, insisted that flows were still holding up. Energy Secretary Chris Wright said Sunday that about two-thirds of pre-conflict traffic — roughly 14 million barrels a day — is moving through the chokepoint. Around 20 million barrels of crude oil and refined products passed through the waterway before the conflict.
In an interview with ABC on Sunday, Wright said that public reports indicating that most shipping traffic has stopped in recent days are just not true, estimating it was at about two-third of normal flow.`,
    bodyJa: `米軍は日曜、ホルムズ海峡で商業船舶を攻撃するイラン政府の能力を破壊することを目的とした作戦を継続した。
米中央軍は午後10時にイランに対する9夜連続の攻撃を完了した。東部時間日曜日、CentcomはXに関する投稿を発表した。
セントコムによると、この３時間の演習はイラン軍司令部、防空・沿岸監視拠点、海洋能力、ミサイル・無人機発射場を対象とし、イラン海峡を通過する商船や民間船員を攻撃するイランの能力をさらに低下させることを目的としている。
交戦大国はこの地域での攻撃を強めており、全面戦争に戻るのではないかとの不安を煽っており、米国とイランは6月に合意した覚書に違反しているとして互いに非難している。
戦前、世界の石油輸送の約20％を扱っていたこの水路は、米国とイスラエルがイラン攻撃を開始した2月28日に始まった戦争の中心戦場となった。これを受けて原油相場は上昇し、ブレント原油先物は約３％上昇して１バレル＝約９０．７ドル、米ＷＴＩ先物は２．５％上昇して８４．６ドルとなった。
人的被害は週末も増え続けた。米軍は日曜、最近のイランとの戦闘で３人目の米軍人が死亡し、軍人１人が戦闘中に行方不明としてリストアップされていたため、ヨルダンで身元不明の遺体を発見したと発表し、約５カ月にわたる戦争で死亡した米軍人の数は１７人となった。
イラン当局は日曜日、米国による今月の再攻撃で少なくとも50人が死亡、500人以上が負傷したと発表した。
地政学戦略の首席ストラテジスト、マイケル・フェラー氏は「覚書には、係争中の事件がどのように調査されるのか、ある地域での違反が他の地域の義務にどのような影響を与えるかについてはほとんど触れられていない」と述べた。覚書の曖昧さにより、事件はすぐに合意がまだ存在するかどうかをめぐる論争になったと同氏は指摘した。
米国のストライキはここ数日、約１万人への給水を遮断したボンジ淡水化プラントを含む民間インフラを標的に拡大している。
イラン政府はまた、湾岸全域でバーレーン、サウジアラビア、ヨルダンなど近隣諸国の標的を新たな攻撃で報復している。クウェート軍は月曜日、同軍の防空システムがイランからの「敵対的な」ドローン攻撃を迎撃していると発表した。
バーレーンの首都マナマの米国大使館は月曜、イランが市内の不特定の場所を標的にしようとしている可能性を示唆する情報があると発表した。当局が住民に避難を呼び掛ける中、バーレーン全土でサイレンが鳴り響いた。
イランイスラム革命防衛隊は月曜、石油タンカー２隻が「ホルムズ海峡南の安全でなく危険なルート」を通過しようとして「爆発」したと発表した。イラン当局は船舶に対し、米国とオマーンが支援する南回廊を利用しないよう警告し、イランが指定した航路のみが許可されると主張した。
海事情報会社クプラーによると、ホルムズの交通量は、敵対行為の再燃を受けてここ３週間で最低水準に減速しており、木曜日の通過件数は前日の１５件に比べて８件にとどまった。
しかし、米国当局者らは、流れは依然として維持されていると主張した。クリス・ライト・エネルギー長官は日曜日、紛争前の交通量の約3分の2（日量約1,400万バレル）がチョークポイントを通過していると述べた。紛争前、約2,000万バレルの原油と精製製品がこの水路を通過した。
ライト氏は日曜日のABCとのインタビューで、ここ数日ほとんどの輸送量が停止しているという公的報道は全くの誤りであり、通常の輸送量の約3分の2であると推定していると述べた。`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/07/20/us-iran-strait-of-hormuz-hostilities-casualties-.html",
    publishedAt: "2026-07-20T03:00:28+00:00",
    category: "エネルギー",
    imageUrl: "https://images.unsplash.com/photo-1473172367879-2dca04a4dca4?w=800&q=80",
    readTime: 4,
  },
  {
    id: "tsmc-is-accelerating-arizona-factory-bui-d2d6d0d8",
    title: "TSMC is accelerating Arizona factory buildout to capitalize on AI 'megatrend,' CFO says",
    titleJa: "TSMCはAIの「メガトレンド」を活用するためにアリゾナ工場の建設を加速しているとCFOが語る",
    summaryJa: "TSMCは顧客からの「数年にわたる需要の巨大トレンド」を継続的に見ているため、アリゾナ工場の生産能力を急ぐべく急いでいる、とウェンデル・ファン最高財務責任者（CFO）がCNBCに語った。TSMC（台湾積体電路製造会社）は、AIに対する構造的需要が数年にわたって急増する中、米国のチップ製造拠点を積極的に拡大するために追加1000億ドルを投入し、アリゾナ州への巨大投資を拡大している。",
    bodyOriginal: `TSMC is racing to accelerate capacity at its Arizona factory as the company continues to see a "multi-year demand mega trend" from its customers, Chief Financial Officer Wendell Huang told CNBC.
...
— CNBC's Arjun Kharpal helped contribute to this story.`,
    bodyJa: `TSMCは顧客からの「数年にわたる需要の巨大トレンド」を継続的に見ているため、アリゾナ工場の生産能力を急ぐべく急いでいる、とウェンデル・ファン最高財務責任者（CFO）がCNBCに語った。
TSMC（台湾積体電路製造会社）は、AIに対する構造的需要が数年にわたって急増する中、米国のチップ製造拠点を積極的に拡大するために追加1000億ドルを投入し、アリゾナ州への巨大投資を拡大している。
この新たなコミットメントにより、TSMCのアリゾナ州における総投資パイプラインは2,650億ドルに増加し、AIを活用した大規模な能力増強が強調され、これが同社の通期資本支出を600億ドルから640億ドルの間で上方修正することにも拍車をかけた。
CNBCのエミリー・タンとの独占インタビューでTSMCのフアン氏は、今回の新たな投資は米国市場での堅調な顧客需要と政府の強力な支援を背景にしていると述べた。
「私たちはこの強固な構造の複数年にわたる需要を目の当たりにしており、他の誰かのために食べ物を残しておくつもりはありません」とファン氏はCNBCに語った。同氏は「メガトレンドが正しい限り、当社は利益を伴う成長を株主に提供し続けることができる」と述べた。
需要の急増
急増する顧客の需要に応えるため、TSMCは顧客をサポートするために5ナノメートルの容量を高度な3ナノメートルのノードに高速変換するなど、最先端の容量を積極的に最適化しているとフアン氏は述べた。
ナノメートルという数字は、チップ上の個々のトランジスタのサイズを指します。トランジスタが小さくなればなるほど、より多くのトランジスタを 1 つの半導体上に詰め込むことができます。通常、ナノメートルサイズの縮小により、より強力で効率的なチップが得られます。
TSMCの米国での事業拡大に関しては、4ナノメートル技術を使用した第1段階がすでに稼働しており、CFOはCNBCに語った。
「今後数四半期でますます大きくなるだろう」とフアン氏は述べ、2ナノメートル技術が第2四半期の最初の収益創出に続き、第3四半期に向けた同社の最新の収益原動力となると述べた。
米国のファブ建設コストは台湾の4～5倍であるが、黄氏は、海外事業の規模が拡大するにつれて初期の希薄化はさらに拡大するものの、拡大は最終的には米国の半導体エコシステムの発展をさらに促進すると述べた。
フアン氏は、新たな1,000億ドルの投資の展開について、「フロントエンドのウェーハ工場とバックエンドの高度なパッケージング工場の両方になるだろう」と述べた。
TSMC株は決算発表を受けてその日は1％超上昇して終了したが、金曜日には7％下落した。株価は年初から約48％上昇している。
フアン氏は、同社の株価動向に対し、TSMCには金融市場に対するいかなる支配権もないと述べた。同氏は、「我々にできることは、本当にビジネスの基礎に注力することだ」と述べ、この分野は部品の大幅な価格上昇に直面しているが、同社はハイエンド市場に戦略的に重点を置いているため、影響は最小限に抑えられると付け加えた。
市場要因とは別に、TSMC は規制上の影響も管理しています。中国についてフアン氏は、TSMCは総収益の約8％を占めている中国の顧客にサービスを提供しながら、引き続きすべての輸出規制を順守していると述べた。
チップメーカーは、将来の拡大推進要因に向けて焦点を拡大しています。物理AIの見通しに関して、同氏は、同社が最近イメージセンサーに関してソニーと合弁事業を行ったことは、特殊技術における顧客の長期的な成長をサポートするという同社の戦略的取り組みの一環であると付け加えた。
— CNBC の Arjun Kharpal がこの記事の寄稿に協力しました。`,
    ...
    publishedAt: "2026-07-20T01:01:17+00:00",
    category: "テクノロジー",
    imageUrl: "https://images.unsplash.com/photo-1518770660439-4636190af475?w=800&q=80",
    readTime: 4,
  },
  {
    id: "world-cup-2026-final-in-photos-spain-tri-356ec62f",
    title: "World Cup 2026 final in photos: Spain triumphs as football crowns a new champion",
    titleJa: "写真で見るワールドカップ 2026 決勝: サッカーが新たなチャンピオンを獲得し、スペインが勝利",
    summaryJa: "ピッチ内外で激しいドラマが繰り広げられた緊迫したワールドカップ決勝で、スペインは日曜、延長戦の末にアルゼンチンを1-0で破り、サッカー界の最高の賞金を取り戻した。フェラン・トーレスの決定的な一撃で勝負は決着し、アルゼンチンのタイトル防衛に終止符が打たれ、スペインにワールドカップ2度目の栄冠をもたらした。",
    bodyOriginal: `Spain reclaimed football's biggest prize on Sunday, defeating Argentina 1-0 after extra time in a tense World Cup final that delivered high drama both on and off the pitch.
...
U.S. President Donald Trump joined FIFA President Gianni Infantino for the medal and trophy presentation, while the leaders of fellow co-hosts Canada and Mexico attended the final. Trump and Infantino were booed during the ceremony.
Beyond the game, one of the evening's biggest talking points was a Super Bowl-inspired halftime show. Shakira, Madonna, BTS, Justin Bieber and Burna Boy took the stage during an extended break curated by Coldplay's Chris Martin.`,
    bodyJa: `ピッチ内外で激しいドラマが繰り広げられた緊迫したワールドカップ決勝で、スペインは日曜、延長戦の末にアルゼンチンを1-0で破り、サッカー界の最高の賞金を取り戻した。
フェラン・トーレスの決定的な一撃で勝負は決着し、アルゼンチンのタイトル防衛に終止符が打たれ、スペインにワールドカップ2度目の栄冠をもたらした。
この敗戦はリオネル・メッシにとって特に痛ましいものだった。メッシは最後のワールドカップ出場となると予想され、準優勝のメダルを獲得した後、涙を流しながらフィールドを去った。
ドナルド・トランプ米国大統領もジャンニ・インファンティーノFIFA会長とともにメダルとトロフィーの授与式に出席し、共同開催国であるカナダとメキシコの首脳も決勝戦に出席した。式典中、トランプ氏とインファンティーノ氏にはブーイングが起きた。
試合以外にも、この夜の最大の話題のひとつは、スーパーボウルをイメージしたハーフタイムショーだった。シャキーラ、マドンナ、防弾少年団、ジャスティン・ビーバー、バーナ・ボーイは、コールドプレイのクリス・マーティンが監修した延長休憩中にステージに登壇した。`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/07/20/world-cup-2026-final-spain-argentina-messi-bts-shakira.html",
    publishedAt: "2026-07-20T00:09:27+00:00",
    category: "テクノロジー",
    imageUrl: "https://images.unsplash.com/photo-1518770660439-4636190af475?w=800&q=80",
    readTime: 2,
  },
  {
    id: "this-farmer-wanted-to-quit-the-cocaine-i-267873e5",
    title: "This farmer wanted to quit the cocaine industry - he couldn't",
    titleJa: "この農家はコカイン産業を辞めたかったが、辞められなかった",
    summaryJa: "この農家はコカイン産業を辞めたかったが、辞められなかった- 公開されました",
    bodyOriginal: `This farmer wanted to quit the cocaine industry - he couldn't
- Published
...
- Published9 July`,
    bodyJa: `この農家はコカイン産業を辞めたかったが、辞められなかった
- 公開されました
ペレアは、コカインの原料であるコカの栽培をやめたとき、二度とコカを植えないと誓った。
彼はコロンビアのメタ県の人里離れた片隅にある小さな農場の緑の茂みを根こそぎ引き取り、その代わりにキャッサバやプランテンなどの合法作物を植えた。
ペレアさんは、農家がコカを放棄するのを支援することを目的とした政府運営の作物代替プログラムに参加した数千人の一人だった。
しかし、約束された援助の多くは届かず、道路不足と度重なる洪水により農産物を売ることが困難になった。
2024年、幻滅した彼は再びコカの植え付けを始めた。
「それは悲劇です」とペレアさんは言う。 「しかし、子供がいて仕事がない場合、どのような選択肢があるでしょうか。助けが来なければ、また育てることに戻ります。」
コカの葉は、先住民コミュニティで伝統的にお茶や薬として使用されてきた祖先作物です。しかし、今日ではそのほとんどがコカインに加工されています。この違法薬物の世界供給量の推定 70% はコロンビアから来ています。
「コカには他の作物に比べていくつかの大きな利点があります」と、コカの経済と代替戦略に焦点を当てているコロンビア人の研究者ルーカス・マリン・リャネスは言う。 「収穫は早いです。農家は年間 3 ～ 4 個収穫できます。輸送も簡単で、農家はどのくらいの価格で買えるか知っています。」
マリン氏が取り組んだ研究では、コカ栽培が地域経済を促進し、2014年から2019年の間に一部の地域では自治体のGDPが10％も増加する可能性があることが示されている。
代替プログラムは、コロンビアのコカ農家がコカ作物から離れ、合法的な生計を立てるのを支援するために設計されました。
しかし現在、コカの作付面積は25万ヘクタール以上で記録的な水準に達しており、代替プログラムに参加している多くのコロンビア人は期待を裏切っていると述べている。
エレナ・エルナンデスは、1990 年代のコカ栽培好況の最中に、より良い給料に惹かれてコカ栽培地域のグアビアレに移住しました。
「当時はもっとお金があったのです。どこにでもお金があったのです」と彼女は言う。 「なんとかお金を貯めて、小さな家を買いました。」
しかし、コカ産業は暴力と治安不安ももたらしました。武装勢力が統制をめぐって争う一方、政府は人手による駆除や空中燻蒸、逮捕などを通じて生産量を抑制しようとした。
こうした取り組みにより家族の収入は途絶えたが、栽培を阻止することはできなかった。
そのため、2017年に当時の政府によって全国規模の代替プログラムが導入されたとき、エルナンデスさんは熱心に登録し、コカから離れる代わりに経済的援助を約束された約10万家族に加わった。
各世帯には2年間で3600万コロンビアペソ（1万1000ドル、8000ポンド）が支給される予定だった。
「私たちに提示された方法を見ると、私たちの領土の発展にとって非常に有望に思えました」とエルナンデス氏は言います。
違法作物代替国家包括計画（PNIS）として知られるこの計画は、政府とコロンビア最大のゲリラ組織Farcとの間の2016年の和平合意から生まれた。
コカ植物を根こそぎにする代わりに、農家は農学者などからの技術支援や土壌管理に関するアドバイスも得られることになる。
代替プログラムは以前から存在していましたが、規模は限られていました。 PNIS はこれまでで最も野心的な試みであり、最初はうまくいっているように見えました。
南部メタとグアビアの一部では、コカ畑がレモンの木、バナナ作物、小規模な畜産場に置き換えられました。ヘルナンデスのように、多くの農家はコカを避けていました。
しかし、それは彼らがそれを成功だと考えていることを意味するものではありません。
「政府は私たち農民に対してあまり熱心ではありませんでした。私たちはひどい扱いを受けました」とヘルナンデス氏は説明し、初期に生じた問題を指摘した。
支払いは遅れ、技術サポートも頻繁に受けられませんでした。地方における州の存在感が弱く、各機関間の連携が不十分なため、支援が地域社会に届かないことがよくありました。
政治的な優先事項が変化するにつれて、このプログラムの勢いは弱まりました。 2018年にコロンビア大統領に就任したイバン・ドゥケ氏は、撲滅と安全保障戦略に政府のアプローチを改めて焦点を当てた。
現大統領グスタボ・ペトロが2022年に就任するまでに、PNISは予定より遅れており、地域社会への働きかけに苦労していた。
しかし、一部の農家は改善を報告しました。メタ南部のプエルトリコ出身のドラルバ・ベハラノさんの場合、停滞していた支援が到着し始めたため、状況は改善した。
「プログラムの前、私たちはとても怖かったです」と彼女は言います。 「警察や軍が私たちを刑務所に入れるだろうから、コカペーストを隠さなければならなかった。」コカペーストは、コカインの製造に使用されるコカをより濃縮したもので、生産者は生の葉を販売するよりも多くの収入を得ることができます。
今では心の平安があると彼女は言います。「行きたいところへはどこへでも行きます。隠す理由はありません。」
彼女のコミュニティの多くは現在、コカ以外の作物やその他の食料品の宣伝と販売のために政府の支援を受けていると彼女は言います。
代替品が直面する課題は、コロンビアの国境を越えた勢力によっても引き起こされており、米国やヨーロッパ、さらには他の新興市場でもコカインに対する膨大な需要が続いています。
コロンビアの首都ボゴタに本拠を置くアンデス大学の安全保障と薬物研究センターの共同所長、マイケル・ワイントラウブ氏は、「現在、需要が拡大しているため、それに見合った供給があるだろう」と語る。 「つまり、コロンビアは近い将来にコカを栽培することになるでしょう。」
ワイントラウブ氏はまた、コロンビアの治安情勢は「脆弱」であり、多くの農村地域で代替プログラムを効果的に運用することが困難になっていると述べている。
2016年の和平合意によりFarcの大部分が解散したが、その空白を埋めるために他の武装グループが参入し、しばしば人身売買ルートや地域経済を支配している。
現政府は、さまざまな武装組織や犯罪組織すべてと和平交渉を行う「完全平和」政策を通じて、この問題に対処しようとしている。しかしアナリストは、進歩は限られていると指摘する。
昨年、政府は、PNIS の欠点に対処しながら PNIS を構築することを目的とした代替プログラムである RenHacemos を試験分野で展開し始めました。
農家は引き続き財政的支援を受けられるが、このプログラムは作物の代替を超えた地域経済の多角化にも焦点を当てている。幅広い支援には、道路改善、大学教育へのアクセス、デジタル接続、住宅の改善などが含まれる。
「コカはビジネスだ」とコロンビアの違法作物代替品を担当する政府機関の局長グロリア・ミランダは言う。
「これは犯罪的企業だが、他のビジネスと同じように機能している。RedHacemosはコカ工場だけでなく、加工や農業産業から輸送や物流に至るまで、コカ工場を取り巻く経済全体を置き換えることを目指している。」
しかし、多くのアナリストにとって、そのようなアプローチが永続的な変化をもたらすことができるかどうかについては疑問が残っています。リャネス氏は、コカ栽培の成長が続いていることは、度重なる介入がうまくいっていないことを示していると語る。
ペレアさんは、コカからの脱却に対する政府の支援が彼や近隣住民に近いうちに提供されるかどうか懐疑的だ。
「国家は我々を完全に見捨てた」と風化した木造小屋を囲むコカの木に囲まれながら彼は言う。 「私たちはその日その日を生きており、時には食べ物がなくなることもあります。」
今のところ、彼はコカの栽培を続けるつもりだ、と彼は言う。彼が犯罪者だからではなく、それが彼の唯一の選択肢だからだ、と彼は言う。 「私たちは麻薬密売人ではありません。もし私が麻薬密売人だったら、今のように生きていないでしょう。」
グローバル ビジネス ストーリーをもっと読む
- 7 月 9 日に公開`,
    source: "BBC",
    sourceUrl: "https://www.bbc.co.uk/news/articles/c0kyml1zxz4o?at_medium=RSS&at_campaign=rss",
    publishedAt: "2026-07-19T23:18:03+00:00",
    category: "マクロ経済",
    imageUrl: "https://ichef.bbci.co.uk/ace/standard/240/cpsprodpb/b142/live/ab70ef20-7f5c-11f1-bee8-53ce494e1abc.jpg",
    readTime: 9,
  },
  {
    id: "are-you-a-parent-missing-out-on-27-a-wee-acd7dc38",
    title: "Are you a parent missing out on £27 a week? Here's how to check",
    titleJa: "あなたは週 27 ポンドを逃している親ですか?確認方法は次のとおりです",
    summaryJa: "あなたは週 27 ポンドを逃している親ですか?確認方法は次のとおりです- 公開されました",
    bodyOriginal: `Are you a parent missing out on £27 a week? Here's how to check
- Published
Thousands more parents could receive £27 a week by remembering some paperwork shortly after their baby is born.
...
In Scotland, Freya replaced Olivia as the most popular name for girls, according to data from National Records of Scotland, while Noah held the top spot for boys.`,
    bodyJa: `あなたは週 27 ポンドを逃している親ですか?確認方法は次のとおりです
- 公開されました
赤ちゃんが生まれた直後にいくつかの事務手続きを覚えておけば、さらに何千人もの親が週に27ポンドを受け取ることができる。
児童手当は、子どもの養育費を補助する手当です。現在、最初の子供には週27.05ポンド、2人目以降の子供には週17.90ポンドの価値があります。
公式データによると、児童手当の受給資格のある子どもの 3 分の 1 近くの親は、赤ちゃんの 1 歳の誕生日までに請求を行っていません。
支払いは 3 か月間しか遡ることができないため、一部の家族は新しい子育ての霧の中で数百ポンドを逃す可能性があります。
最も人気のある赤ちゃんの名前が毎年発表されることは、一部の親たちに、完了すべき公式書類が他にもあることを思い出させるのに役立つ可能性がある。
4 週間ごとに支払われる児童手当を受け取るには、どちらかの親が外部に請求を行う必要があります。その親は、国民年金に加えて国民保険のクレジットも受け取ることになります。
請求するには、次のものが必要です。
お子様の出生証明書または養子縁組証明書
銀行の詳細情報
あなたとあなたのパートナーの国民保険番号（お持ちの場合）
児童手当は、赤ちゃんの出生が登録されてから 48 時間後に請求できますが、歳入関税局 (HMRC) が請求を受け取った日から最長 3 か月までしか遡ることができません。
HMRC社外データによると、2025年8月までの1年間に680万人以上の親が児童手当を受け取った。
しかし、赤ちゃんの1歳の誕生日前に支援を申請したのはわずか69％であり、何千もの家族が受け取る資格のあるものを受け取っていない可能性があることを意味する。
税務当局は、高所得者の親の給付金受け取りには制限があるため、多くの保護者が請求しないことを選択した可能性があると述べた。
高所得児童給付費の下では、一方の親の年収が 60,000 ポンドの場合、外部の支払い額が減額され始めます。どちらかが8万ポンドを稼ぐと、完全に停止します。
国家統計局によると、昨年イングランドとウェールズで生まれた赤ちゃんの数は58万5,396人で、2025年の女の子の赤ちゃんの名前では「オリビア」が10年連続でトップの座を維持し、男の子の名前では「ムハンマド」が3年連続でトップとなったという。
スコットランド国立記録のデータによると、スコットランドではフレイヤがオリビアに代わって女の子に最も人気のある名前となり、一方男の子ではノアがトップの座を維持した。`,
    source: "BBC",
    sourceUrl: "https://www.bbc.co.uk/news/articles/cz9l993wj5ko?at_medium=RSS&at_campaign=rss",
    publishedAt: "2026-07-19T23:16:47+00:00",
    category: "金融政策",
    imageUrl: "https://ichef.bbci.co.uk/ace/standard/240/cpsprodpb/2958/live/13ecab20-805c-11f1-a10f-077d9cf2208e.jpg",
    readTime: 3,
  },
  {
    id: "my-fitness-tracker-knew-i-was-pregnant-b-89900785",
    title: "My fitness tracker knew I was pregnant before I did",
    titleJa: "私のフィットネストラッカーは私が妊娠していることを私が妊娠する前に知っていました",
    summaryJa: "私のフィットネストラッカーは私が妊娠していることを私が妊娠する前に知っていました- 公開されました",
    bodyOriginal: `My fitness tracker knew I was pregnant before I did
- Published
Ravika was celebrating her birthday on holiday with her husband when she got an unusual alert from her fitness tracker.
...
When the stats hadn't improved a week later, the 34-year-old solicitor from the West Midlands did some research online and found a community of women who all said their fitness trackers had been giving them signs they were pregnant, based on the data the trackers had collected. It was another week before Ravika had a positive pregnancy test.
But following some cramping and a notification on her phone telling her that her body appeared to be under significant strain, she went to the doctor and was told she'd need to return 10 days later for further testing to find out if the pregnancy was healthy.
...
- Published17 September 2024`,
    bodyJa: `私のフィットネストラッカーは私が妊娠していることを私が妊娠する前に知っていました
- 公開されました
ラヴィカさんは休暇中に夫と誕生日を祝っていましたが、フィットネストラッカーから異常なアラートを受け取りました。
彼女のオウラリングは、彼女の健康スコアが低いことを示していました。彼女の心拍数は上昇し、体温は上昇し、心拍数変動 (HRV) は低下しました。それでも、ラヴィカはまったく大丈夫だと感じた。
1週間経っても統計が改善されなかったとき、ウェスト・ミッドランズの34歳の弁護士はオンラインで調査を行ったところ、フィットネス・トラッカーが収集したデータに基づいて、フィットネス・トラッカーが妊娠の兆候を示していたと全員が主張する女性のコミュニティを見つけた。ラヴィカさんの妊娠検査薬が陽性反応を示すまでにはさらに1週間かかった。
しかし、少しけいれんがあり、体に大きな負担がかかっているようだと携帯電話に通知があったため、医師の診察を受けたところ、妊娠が健康であるかどうかを確認するため、さらに検査を受けるために10日後に来院する必要があると言われました。
待つのは苦痛で、彼女は毎晩午前4時に起きて、心配そうにフィットネストラッカーの統計をチェックするようになった。「アプリを更新して、統計がまだ低いかどうか、体温がまだ高いかどうかを確認するためだった。私は妊娠が可能であることを祈り続けていた」。
彼女によれば、その統計は「強迫観念」になったが、「私にとってそれは本当に生死にかかわる状況のように感じられた」という。
多くの女性にとって、妊娠の可能性を示す最初の兆候は、予定通りに生理が来ないことです。妊娠検査薬が受けられるのもこの頃です。妊娠を早期に発見できると主張する一部の検査を除いて、ほとんどの検査は、生理が遅れた初日までホルモンの変化を見つけることができません。
しかし、ラヴィカさんは、フィットネストラッカーのデータを通じて、これよりも早く兆候が見られるとオンラインで報告している何百人もの女性のうちの1人です。
スマートリング、スマートウォッチ、胸に取り付けるトラッカーなどのフィットネストラッカーの人気が英国で急増しています。 YouGov の調査によると、2026 年 1 月時点で英国の成人の 36% がフィットネス トラッカーを所有および使用していました。これは、2019 年 7 月の割合のほぼ 2 倍です。
フィンランドと米国の企業である Oura は、インドに拠点を置く Ultrahuman や香港に拠点を置く RingConn も含まれるスマート リング市場で最大の売上高を誇っています。
妊娠だけでなく流産も予測する
妊娠の重要な兆候の 1 つは体温の変化です。つまり、体温を監視できるトラッカーが妊娠を望んでいる人々に人気があることを意味します。
一般的な周期では、女性の体温は生理が来る直前まで上昇しますが、その後急激に下がります。妊娠初期は通常、体温が高い状態が続きます。フィットネストラッカーで体温を測定すると、この初期症状を検出できる可能性があります。
ラヴィカさんは統計情報だけでなく、Oura リングの「重大な兆候」通知を通じて、Oura リングが妊娠だけでなく流産も予言していたという女性たちの Reddit の投稿を読み始めた。
32歳のソフィアもその1人だった。彼女は2度の妊娠を失ったが、そのどちらもオウラリングのデータで発見されたが、3度目の妊娠で現在生後5カ月の息子を妊娠している。
昨年初めに初めて妊娠したとき、彼女は毎朝アプリをチェックし続けました。
「朝起きて[体温]の線が進んでいるのを見て、ある朝アプリで体温が下がっているのを見たとき、何かがおかしいと気づいたのです」と彼女は語った。
「実際に流産したとき、目にしたデータのおかげで、私はすでに心の準備ができていました。」
3か月後、同じことが再び起こり、ソフィアと夫は妊活を休止することに決めたが、その休止中に指輪から「軽い緊張の兆候」の通知を受け、体温が再び上昇していることに気づいた。彼女は検査を受けたところ、陽性反応が出た。
今回の妊娠は順調でしたが、ソフィアさんは初期の数週間を通じて不安を感じ、データを繰り返しチェックしていることに気づきました。
「『なんてことだ、またこんなことが起こるの？』と思いました。朝の4時か5時に起きて、アプリをチェックして体温が下がったかどうかを確認していたのを覚えています」と彼女は語った。
「私はそのデータを非常に意識していたので、（妊娠）7、8週目に達したとき、指輪を外さなければならず、最初の学期の間ずっと指輪を着けていませんでした。」
高まる不安
ロンドンのユニバーシティ・カレッジ病院の生殖医療コンサルタントであるスチュアート・ラベリー博士は、「妊娠を計画している場合、妊娠を計画している場合、このテクノロジーは人生に非常に大きな影響を与えるため、人々がこのテクノロジーをより深く理解しようとして、できるだけ早く問題を解決しようとするために利用しているのは当然です。」と述べた。
しかし、「私たちは歩く前に走ってしまうかもしれない」と彼は警告した。
「おそらく、信頼性に関してさらに多くのデータが必要であり、さらに多くの研究が必要です…そうしないと、何が起こるかというと、不安のレベルが急上昇するだけです」と彼は言いました。
「より多くの人がテクノロジー、アプリベースのアプローチ、またはウェアラブルベースのアプローチを利用して、これらのものを手に入れようとすることは間違いありません。しかし、それは、正確さに関して私たちがどれだけ信頼できるかについて、かなり大きな健康上の警告を伴うべきだと思います。」
オウラの女性健康臨床部長であるクリス・カリー博士は、指輪のデータをチェックした結果、妊娠初期に女性が感じたと報告された不安について尋ねられたところ、BBCニュースに次のように語った。「生体追跡の有無にかかわらず、妊娠中は不確実な時期となり、多くの女性、特に初めて妊娠する女性にとって、何が正常なのかが分からない状態です。」
彼女は、女性が圧倒されていると感じた場合、同社は「Oura Ring がデータ収集と洞察の収集を続ける一方で、会員にはアプリ体験から休憩するよう奨励している」と付け加え、「リングはサポートツールであり、ケアチームの代わりではない」と付け加えた。
ラヴィカさんは残念ながら流産してしまいました。彼女は、すぐに再び妊娠を始めたいと考えています。そして、実際に妊娠したとき、彼女の経験が彼女にトラッカーの着用をもう一度考え直させました。
「私は自分が心配性の人間であるとはあまり思っていませんでしたが…今後、もし妊娠していると感じていて統計値が低かった場合、妊娠検査薬で陽性反応が出たらすぐに指輪を外すのが私にとって最善のことだと思います。」
関連トピック
- 2025 年 12 月 6 日公開
- 2025 年 1 月 29 日発行
- 2024 年 9 月 17 日公開`,
    ...
    publishedAt: "2026-07-19T23:09:18+00:00",
    category: "金融政策",
    imageUrl: "https://ichef.bbci.co.uk/ace/standard/240/cpsprodpb/96bf/live/356d4010-7f8b-11f1-bee8-53ce494e1abc.png",
    readTime: 7,
  },
];
