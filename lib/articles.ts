...
- 2025 年 10 月 22 日発行`,
  ...
  {
    id: "don-t-get-too-comfortable-wall-street-s-3b997f69",
    title: "'Don't get too comfortable': Wall Street’s ‘fear gauge’ hits 2026 low — here's why it's unlikely to last",
    titleJa: "「安心しすぎないでください」: ウォール街の「恐怖ゲージ」は 2026 年の最低水準に達する - これが、それが長続きしそうにない理由です",
    summaryJa: "Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.",
    bodyOriginal: `Wall Street's so-called "fear gauge" has fallen to its lowest level of 2026 so far, reflecting relative market tranquility in a year marked by geopolitical turbulence — but the calm appears unlikely to last.
...
"Three straight weeks of gains is impressive, but with volatility so low and risks still building, investors may be underestimating just how vulnerable this rally is to a fresh bout of bad news."`,
    bodyJa: `Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/08/17/stock-market-volatility-vix-wall-street.html",
    publishedAt: "2026-08-17T12:41:58+00:00",
    category: "金融政策",
    imageUrl: "https://images.unsplash.com/photo-1611974789855-9c2a0a7236a3?w=800&q=80",
    readTime: 2,
  },
  {
    id: "trump-threatens-to-bomb-oman-if-it-gets-f42a1e44",
    title: "Trump threatens to 'bomb' Oman if it 'gets in the way' as U.S.-Iran ceasefire expires",
    titleJa: "トランプ大統領、米国とイランの停戦期限切れでオマーンが「邪魔」ならオマーンを「爆撃する」と脅迫",
    summaryJa: "米国によるイランとの60日間の停戦が正式な交渉や合意の見通しが立たないまま期限切れとなる中、ドナルド・トランプ大統領は月曜日、湾岸諸国が「邪魔」をした場合、米国はオマーンを「爆撃する」と述べた。米国がイランの港湾封鎖を維持する中、オマーンはホルムズ海峡を巡り、戦略的に重要な水路を商業輸送に再開するためイランと協議している。",
    bodyOriginal: `President Donald Trump on Monday said the U.S. would "bomb" Oman if the Gulf nation "gets in the way," as Washington's 60-day ceasefire with Iran expires with no official negotiations or deal in sight.
...
Talks and negotiations between the U.S. and Iran have stalled as a fragile ceasefire between the two countries is due to expire on Monday.
Iran's Foreign Minister Seyed Abbas Araghchi said the two sides do "not have anything like a ceasefire," per quotes from Iranian news outlet Shahrara News on Saturday.
"No negotiations have been held between the United States and us at this time...Qatar and Pakistan are exchanging messages between the parties and are in contact with us, but this does not mean negotiations," Araghchi said, according to the quotes.
However, Iran's Deputy Foreign Minister Kazem Gharibabadi insisted in a post on X on Friday that the Strait will remain "Iranian" and only be closed and opened "under Iran's command."`,
    bodyJa: `米国によるイランとの60日間の停戦が正式な交渉や合意の見通しが立たないまま期限切れとなる中、ドナルド・トランプ大統領は月曜日、湾岸諸国が「邪魔」をした場合、米国はオマーンを「爆撃する」と述べた。
米国がイランの港湾封鎖を維持する中、オマーンはホルムズ海峡を巡り、戦略的に重要な水路を商業輸送に再開するためイランと協議している。
イランは米国との直接交渉を否定し続けているが、トランプ大統領は月曜日、イラン革命防衛隊と非公式協議が行われていると述べたが、米国は合意を急ぐ必要はないと主張した。
トランプ大統領は影響力のあるイラン軍部について言及し、「彼らは優れたポーカープレイヤーだが、死につつある」とFOXニュースに語った。 「タイムスケジュールはありません。急いでいません。」
さらに、「オマーンが邪魔をするなら、我々は彼らを爆撃するだろう」と付け加えた。
また月曜日、トランプ大統領は、イランは核兵器保有の放棄に同意しなければならないという米国の立場を改めて表明した。
トランプ大統領はトゥルース・ソーシャルへの投稿で、「第一の目標は、イランがいかなる形であっても核兵器を保有できないことだ、そして今後もそうである」と述べた。
ホルムズの交通が寸断される
これは、米国とイラン間の60日間の停戦期限を月曜に控え、ホルムズ海峡を通る船舶交通が先週末に停滞したことを受けたもので、正式な交渉や合意の見通しは立っていない。
Kplerのデータによると、日曜日に重要な石油通路を通過したのはわずか3隻だけだった。 ５日間の通過の平均は１２隻。２月２８日に戦争が始まる前には毎日約１３０隻の船舶がホルムズを通過していた。
HSBCの海運専門家パラシュ・ジェイン氏は月曜朝、CNBCのスコーク・ボックス・ヨーロッパに対し、投資家は業界にとって「混乱は常態」であることを理解し、それを基本的な想定に織り込むべきだと語った。
米国とイランの間の交渉と交渉は、両国間の脆弱な停戦が月曜日に期限切れを迎えるため行き詰まっている。
土曜日のイラン報道機関シャハラ・​​ニュースの引用によると、イランのセイエド・アッバス・アラグチ外務大臣は、両国には「停戦のようなものはない」と述べた。
引用文によると、アラグチ氏は「現時点では米国と我々の間で交渉は行われていない。…カタールとパキスタンは当事者間でメッセージを交換しており、我々と連絡を取り合っているが、これは交渉を意味するものではない」と述べた。
しかし、イランのカゼム・ガリババディ外務次官は金曜日のＸへの投稿で、海峡は「イランのもの」のままであり、「イランの指揮下」でのみ閉鎖・開放されると主張した。`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/08/17/us-iran-war-trump-hormuz.html",
    publishedAt: "2026-08-17T12:34:07+00:00",
    category: "エネルギー",
    imageUrl: "https://images.unsplash.com/photo-1473172367879-2dca04a4dca4?w=800&q=80",
    readTime: 3,
  },
  {
    id: "meta-faces-astronomical-consequences-as-c7597700",
    title: "Meta faces ‘astronomical’ consequences as legal fight reaches critical moment in California",
    titleJa: "カリフォルニア州での法廷闘争が正念場を迎える中、メタは「天文学的な」結果に直面する",
    summaryJa: "ニューメキシコ州がメタに対抗するための青写真を作成した場合、FacebookとInstagramの重大な変化に関してはカリフォルニア州が同社の運命を決定する可能性がある。メタ社が十代の若者や子供たちの依存症行動を助長したという一連の疑惑を受けて、カリフォルニア州司法長官ロブ・ボンタ氏がメタ社に対して共同代表を務める裁判で、火曜日に冒頭弁論が始まる。陪審員は先週オークランドの連邦裁判所で着席した。",
    bodyOriginal: `If New Mexico created the blueprint for taking on Meta, California could determine the company's fate when it comes to critical changes at Facebook and Instagram.
...
WATCH: Meta's federal trial moves forward, accused of violating children's privacy laws.`,
    bodyJa: `ニューメキシコ州がメタに対抗するための青写真を作成した場合、FacebookとInstagramの重大な変化に関してはカリフォルニア州が同社の運命を決定する可能性がある。
メタ社が十代の若者や子供たちの依存症行動を助長したという一連の疑惑を受けて、カリフォルニア州司法長官ロブ・ボンタ氏がメタ社に対して共同代表を務める裁判で、火曜日に冒頭弁論が始まる。陪審員は先週オークランドの連邦裁判所で着席した。
この裁判には、2023年に起こされたメタに対する統一訴訟における29人の州司法長官の連合が関与しており、カリフォルニア州、コロラド州、ニュージャージー州、ケンタッキー州を代表する弁護士が弁論を行うことになる。全米の主要政府当局者が、児童オンラインプライバシー保護法（COPPA）やさまざまな消費者保護法を含む連邦法や州法に違反した疑いでメタ社の責任を追及するよう求めており、その賭け金は莫大である。
業界の専門家らは、メタが目玉となるソーシャルメディアの「ビッグ・タバコ」の瞬間を呼んでいる。 1990年代、タバコ会社は自社製品の安全性と潜在的な害について国民を誤解させた罪で数十億ドルの支払いを余儀なくされ、その後、タバコ会社の力と影響力は劇的に低下した。
今月初め、メタ社はニューメキシコ州で敗訴し、同社はサービスに一部変更を加え、10億ドル近くを支払う必要がある。しかし、カリフォルニア州は非常に大きな力と影響力を持っているため、メタ氏の本拠地で悪い結果が出た場合には、主要なアルゴリズムに根本的な変更を強いる広範な見直しを含む、より厳しい罰則が課せられる可能性がある。
UCLA技術法政策研究所のエグゼクティブディレクター、ジュリア・パウレス氏は、「カリフォルニア州は米国の他のどの管轄区域よりも重要だ」と述べた。 「それは彼らが最も大きな法的影響を受ける場所であり、世界中で監視されている管轄区域です。」
ニューメキシコ州AGのラウル・トーレス氏は、法廷での勝利を収めたばかりで、収益の98％をオンライン広告から得ている企業にとって、その結果は「天文学的」になる可能性があるとCNBCに語った。メタの最高経営責任者（CEO）マーク・ザッカーバーグ氏は、今年1450億ドルもの費用がかかる可能性がある人工知能への巨額の投資資金を、同社の支配的な広告事業から生み出される現金に頼っている。
ニューメキシコ州の判事は、児童の性的搾取疑惑に関する訴訟の第2段階の一環として、メタに対し、減額基金に5億6,700万ドルを支払うよう命じた。同州の陪審は３月、裁判の第１段階で、州の不当行為法に違反したとしてメタ社に３億７５００万ドルを支払わなければならないとの判決を下した。メタ社はニューメキシコ州の判決に同意せず、控訴する予定だと述べた。
トーレス氏はこれを「かなり実質的な判決」と称したが、今後起こり得るものと比較するといかに見劣りするかについてすぐに指摘した。
「ここは人口約200万人の州だ」とトレズ氏は語った。 「同じ議論をカリフォルニア、フロリダ、テキサス、ニューヨークに当てはめると、それは潜在的に巨大で市場を変える力となる可能性があるということです。」
セクション 230 の回避
訴訟の詳細の多くはさまざまですが、いずれも Facebook や Instagram などのアプリの有害なデザインの疑いに焦点を当てています。
ニューメキシコ州ではメタに対し、AIを活用した「年齢保証モデルとツール」を改善し、「2年以内に13歳未満専用の予測モデルの開発」を試みることを求められている。他の救済策には、未成年者の使用を報告しやすくすることや、「学校や児童安全団体と提携して、学校管理者があらゆるソーシャルメディアプラットフォームでユーザーが13歳未満である可能性のある疑わしいアカウントにフラグを立てることができる報告ポータルを作成する」ことが含まれる。
トレズ氏は、原告らがアプリのデザイン機能に焦点を当てていることと、安全性に関する虚偽表示の申し立ては、「他州に責任を問う青写真を実際に提供している」と述べた。これは、各州が通信品位法第 230 条を回避できるようにするアプローチであり、同法は通常、プラットフォーム上のサードパーティのコンテンツによる法的摘発からテクノロジー企業を守ってきた。
メタとグーグル傘下のユーチューブは３月、ロサンゼルスの陪審が両社に過失があり、プラットフォームの使用に伴う危険性をユーザーに警告しなかったと判断して敗訴した。
ギャビン・ニューサム知事によって2021年に行政長官の役割に任命されたボンタ氏は、先週月曜日の声明で、最も重要な仕事の一つは「子どもたちを危害から守ること」だと述べた。
「メタは若いユーザー向けに危険な製品を設計し、それが危険であることを知っていて、それがいかに危険であるかについて子供たち、家族、地域社会に嘘をついた」と同氏は述べた。 「私たちは、アメリカの子供たちの精神的健康危機を煽ったメタ社の役割について責任を問う用意があり、裁判を楽しみにしています。」
メタ氏は声明で、AG連合の「限定的な主張には根拠がなく、資金需要は著しく不釣り合いだ」と述べた。
「AGは、各州の誰かが誤解されたという証拠を何ら提示しておらず、追加のInstagramアカウントを持つなどの無害な機能が何らかの形で住民に損害を与えたと主張し、年齢認証などの業界全体の課題でMetaを罰しようとしている」とMeta氏は述べた。
メタ氏の弁護士らはこれまで、州立AGの統合裁判により1兆4000億ドルもの損害賠償が発生する可能性があると述べていた。各州を代表する弁護士らは先週、イボンヌ・ゴンザレス・ロジャーズ連邦判事裁判長に対し、2000億ドルの方が可能性が高い金額だと述べた。
「目が覚めると、私が言ったように、天文学的な判決が下される可能性があります」とトーレス氏は語った。
国防訴訟専門家でニューヨークの法律事務所コフィー・モディカの設立パートナーであるマイケル・コフィー氏は、これは州行政長官のキャリアを決定づける類の事件であり、一方で被害者は最終的にほんのわずかしか支払われない可能性があると述べた。
「それはすべて政府に渡され、政府は補助金を支給し、原告側の弁護士がその一部を差し押さえることになるだろう」とコフィー氏は語った。
資金はさておき、メタがカリフォルニア州で負けた場合に実施しなければならない潜在的な設計変更は、はるかに大きな損害をもたらす可能性がある、とソーシャルメディア被害者法律センターの弁護士ローラ・マルケス＝ギャレット氏は語る。
最近のロサンゼルス訴訟を担当したマルケス・ギャレット氏は金曜日のメディアブリーフィングで、「民間の原告は通常、裁判所制度を通じてこれらの企業にビジネスモデルや設計上の決定、そのすべての変更を実際に強制する必要がない能力を持っている」と述べた。
州AGは裁判所への提出文書で、COPPAに関連するあらゆる違反について「メタ社の不法行為や慣行を抑制するため、州ごとではなく全国ベースでの恒久的な差し止めによる救済」を求めていると述べた。メタ社が連邦法に違反したことが判明した場合、各州は同社に対し、13歳未満の子供の個人データと、その情報を使って訓練された「アルゴリズムとモデル」をすべて削除するよう求めている。
州の消費者保護法の違反に関して、各州の代理人弁護士らは提出書類の中で、無限スクロール、自動再生、一時的なコンテンツ、ビューティーフィルター、「エンゲージメントに最適化されたアルゴリズム」など「特定の中毒性のあるデザイン機能」の削除をメタ社に強制することを求めていると述べた。
Torrez 氏は、無限スクロールの廃止や会社の推奨アルゴリズムの変更など、チームが求めていた設計変更のすべてが実現できなかったことを認めました。この訴訟の判事は、こうした変更の一部は第230条や憲法修正第1条の保護に抵触する可能性があり、TikTokやYouTubeなどのライバル企業が引き続き機能を保持するため、変更を課すことは不公平であると述べた。
トーレス氏は、「デジタル経済で一般的であるあらゆる商慣行を把握する」ことを目的としたソーシャルメディア法案と消費者保護法の更新を立法プロセスに移行する予定であると述べた。
メタとそのソーシャルメディアのライバル企業は、来年北カリフォルニアで複数の学区を巻き込んだ大規模な連邦裁判が開始される予定であるなど、全米各地で他にも複数の訴訟に直面している。複数の統合学区の最初の裁判は今夏始まる予定だったが、Meta、YouTube、TikTok、Snapはいずれも和解した。
トーレス氏の見方では、ウォール街はカリフォルニア州での損失の潜在的な重要性を過小評価しており、ニューメキシコ州を「孤立して」見ているだけだ。メタの株価は年初から11％下落しているが、アナリストが表明している懸念のほとんどは、広告事業の潜在的な悪化に対する懸念ではなく、同社のAIインフラストラクチャーに対する巨額の設備投資に関係している。
トレズ氏は「アナリストは現時点でこれを正しく見積もっていない」と述べた。 「カリフォルニア州のこの判決は、それだけでこの会社の将来の資金調達に必要なことを行う能力を変えるほど重大なものになる可能性がある。」
注目：児童プライバシー法違反で告発されたメタの連邦裁判が進む。`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/08/17/meta-attorneys-general-california-federal-trial-astronomical-consequences.html",
    publishedAt: "2026-08-17T12:00:01+00:00",
    category: "テクノロジー",
    imageUrl: "https://images.unsplash.com/photo-1518770660439-4636190af475?w=800&q=80",
    readTime: 10,
  },
  {
    id: "what-will-tv-look-like-in-three-years-me-a4eec19b",
    title: "What will TV look like in three years? Media insiders share their predictions",
    titleJa: "3年後のテレビはどうなっているでしょうか？メディア関係者が予測を共有",
    summaryJa: "テレビ業界は流動的です。取引、スピンアウト、パートナーシップはすべて、従来のテレビの状況を再構築しています。業界は混乱に慣れているわけではありませんが、最近の急速な変化はメディア投資家や傍観者を警戒させています。",
    bodyOriginal: `The television industry is in flux.
...
Disclosure: Versant is the parent company of CNBC.`,
    bodyJa: `テレビ業界は流動的です。
取引、スピンアウト、パートナーシップはすべて、従来のテレビの状況を再構築しています。業界は混乱に慣れているわけではありませんが、最近の急速な変化はメディア投資家や傍観者を警戒させています。
これは CNBC の「テレビの将来」調査の背景です。これは、メディア関係者や幹部にテレビ業界の今後 3 年間を予測するよう求める 2023 年の調査からの最新情報です。
誰に尋ねるかによっては、テレビ業界は危機に瀕しているかもしれません。ケーブルテレビの加入者数は10年以上減少し続けている。ストリーミング サービスは現在利益を上げていますが、加入者の増加はほとんどの場合頭打ちです。
テレビの将来について考えることは、単なる思考実験ではありません。それは数千億ドル相当の合併・買収を支えている。
パラマウント・スカイダンスは2月、ネットフリックスがWBDの映画スタジオとHBOマックスをほぼ買収するという売却プロセスを経て、ワーナー・ブラザース・ディスカバリーの買収に合意した。この協定は現在、政治家の独占禁止法への懸念により保留されている。
Foxは6月、ストリーミングプラットフォームのRokuを220億ドルで買収すると発表した。コムキャストは、CNBCを含む同社のケーブルTVネットワークのポートフォリオであるVersantのスピンアウトに続く迅速なフォローアップとして、2027年にNBCUniversalを分離する予定だ。そしてチャーターコミュニケーションズは最近、米国最大のケーブル会社を創設するコックス・コミュニケーションズとの345億ドルの合併について規制当局の最終承認を受けた。
ケーブルテレビのエコシステムが衰退を続けるなか、メディア企業も収益を生み出す提携を検討している。 NBCユニバーサルはすでに、同社のPeacockとYouTubeとの提携を発表している。
ディズニーは新しいCEOを迎え、ESPN、ABC、FX、Disney+、Huluなど幅広いメディア資産を統合することに注力している。
そして、10年以上前に、一気見、パスワード共有、広告なしなどの有料テレビモデルをひっくり返したNetflixは、投資家を満足させるために、これまでの戦略の多くを方針転換した。それにもかかわらず、同社の株価は過去1年間で35％以上下落した。
その間、他のメディア業界が若い視聴者がコンテンツをどのように消費したいかに合わせて調整する中、YouTube は視聴シェアを獲得し続けています。
これらの大きなイベントは、エコシステム内のすべての企業の戦略を再定義しています。
テレビが今後どうなるのかを知るために、CNBC は 10 人のメディア幹部に同じ 5 つの質問をしました。前回の調査で明らかになった 2023 年の予測の一部は、非常に正確であることが判明しました。ほとんどの経営陣は、顧客は減っているものの、リニア有料テレビはまだ存在すると正しく予測していました。いくつかのストリーミング サービスを正しくバンドルすることは困難であると予測されました。特に、Paramount+ と HBO Max が統合されると予測したものさえ複数ありました。
2026 年から 2029 年までのテレビの見通しは次のとおりです。
3 年以内に、ケーブル TV の加入者数は底値に達するでしょうか?
チャーターコミュニケーションズの社長兼CEO、クリス・ウィンフリー氏：無料の無線（再送信）のコストは現在、本質的に無料のもので顧客1人あたり30ドルを超えているため、劇的に下がると思います。しかし、皆さんがすでに目にしているのは、放送コンテンツやケーブル コンテンツのすべてがこれらのアプリ内で実際に利用可能であり、時間の経過とともに開発されると思われる大きなストリーミング バンドル内で利用可能であり、それには Netflix も含まれると思います。よく考えてみると、Netflix は本質的に大手ケーブル プログラマーであり、最終的には他のストリーミング アプリとバンドルされ、顧客により多くの選択肢、価値、実用性を提供することになる可能性があります。
RedBird IMI CEO、元NBCUniversal CEO、WarnerMedia News and Sports会長のジェフ・ザッカー氏: 発言権はないと思います。私は、今後も衰退していくだろうと考えており、最終的にはスポーツの権利がケーブルテレビから消えるまで、おそらく毎年衰退していくだろう。しかし、それは少なくとも10年はずれていると思います。
Roku Media 社長、チャーリー・コリアー氏: そうですね、本当にゼロになるものはありません。おそらくアメリカのどこかで、AOL ダイヤルアップの料金を払ったり、前回のブロックバスター (ちなみにオレゴン州ベンドにあります) の DVD をレンタルしたりしている人がいるでしょう。しかし、進行方向は間違いありません。
無修正 CEO で元 MSNBC 社長のラシダ・ジョーンズ氏: 消費者が地上波テレビ以外のプラットフォームでコンテンツを消費することを選択するという傾向を逆転させるのは難しいと思います。その傾向は続いていると思います。どのくらい速いですか？率直に言って、これまで私たちは業界として正しくありませんでした。おそらく私たちが4、5年前に予想していたほどのスピードや積極性はありません。
現在存在しないテレビ業界の標準となるものは何ですか?
ジミー ピタロ、ESPN 会長: ユビキタスなパーソナライゼーション。パーソナライゼーションは現在存在しますが、3 年後には、ほぼどこでもパーソナライゼーションが見られるようになるでしょう。つまり、ネットワークは適切なコンテンツを適切なユーザーに適切なタイミングで提供し、ユーザーの好みに基づいてコンテンツが宣伝されるのを見ることになるだけでなく、ユーザーの好みに合わせてコンテンツが作成され調整されるのを見ることになるでしょう。
Tubi CEO、Anjali Sud: ソーシャル メディアと同じように、広告もより便利で関連性が高まっていくのがわかると思います。今日のテレビでの体験を考えてみると、依然として広告がパーソナライズされていないように感じられますが、そのようなハイパーパーソナライゼーションが実際に見られる世界を想像できるでしょう。広告として見ているものが邪魔になったり、摩擦を感じたりすることさえなくなるのです。あなたは私のことをよく知っているので、実際には、「わあ、それは本当に役に立ち、役に立った」と感じています。
ぴたろう: コマースの統合、そしてそれは今後さらに多くなると思います。ご存じのとおり、現在、強化された ESPN アプリ内で購入エクスペリエンスとコマース エクスペリエンスを提供していますが、今後数年間でスムーズなコマースが実際に出現することを期待しています。製品の配置が増え、顧客が購入のためにパートナー サイトに直接ディープ リンクする機会が増えます。
ジョン・ランドグラフ氏、FX コンテンツおよびスタジオ会長: 私たちにとって、日々の世界的なリリースは、テレビのエコシステムにおける非常に重要な進化であるように思えます。もちろん、北米、アジア、ヨーロッパなど、主に 1 つの市場、1 つの地域で初公開される番組は今後も存在するでしょうが、最大の番組が世界中のあらゆる場所で同時に初演されるようになってきていると私は思います。
ザッカー: ケーブル ネットワーク (おそらくは放送ネットワーク) にライセンス供与されるポッドキャスターやライブストリーミング番組がますます増えていくと思います。そして、それがテレビ業界の標準になると思います。
Starz 社長兼 CEO のジェフリー・ハーシュ氏: 今後も言語の大きな進歩が見られるでしょう。そして、国境のないコンテンツの世界が実現すると思います。そこでは、[人工知能] プラットフォームにより、消費者が母国語でコンテンツを視聴できるようになります。字幕と吹き替えはなくなりますが、フランス語で見たい、スペイン語で見たい、英語で見たいというボタンを切り替えるか押すことができます。国境のないコンテンツは、3 年以内に業界の本当の標準になります。 (注: これは 3 年前の Hirsch の答えでもありました。)
ウィンフリー: 特に 8K [テレビ] を使用したスポーツ関連の没入型プログラミングは、有料テレビ業界を引き続き活性化させる機能、または利用可能な新しい製品やコンテンツのセットになると思います。 NBA および Apple Vision Pro との協力である Spectrum Front Row で私たちが行っていることを見てみると、これがどのような方向に向かうのかがわかります。国内のすべての家庭のリビングルームにコートサイドの体験を持ち込めるということは、ユニークで新しい体験になると思います。
エンターテイメント業界でビッグテック企業の成長を阻止するために、政府による大規模な措置が講じられるのでしょうか?
ザッカー: ビッグテック企業が左派と民主党の間で多くの好意を失っていることは秘密ではないし、誰も驚かないと思う。したがって、これらのビッグテック企業は多くの監視にさらされ、その先はさらに困難になるだろうが、それは次の2つの選挙、2026年と28年の選挙で何が起こるかによると思う。
ジョーンズ: 目標は大きくて良いということではありません。したがって、私たちが目にするのは、これらの取引の一部に対する消費者と業界の反発であり、それが方向性を変えることになると思います。最近でも、ハリウッドの専門家1,000人がパラマウント[-WBD]との契約を反対するために提出した書簡で、その一部が見え始めていると思う。
Sud: シリコンバレーのテクノロジーとハリウッドの融合は、すでに起こっています。変化が起こりました。費やした時間と注目の割合が最も高いプラットフォームに注目すると、それはテクノロジー プラットフォームです。リビングルームでのテレビ視聴のシェアが最も高いのは誰かというと、それは YouTube です。私たちはこの収束、つまり衝突をさらに多く見ています。 Instagram はテレビで縦型動画を放映し、オスカー賞は YouTube で上映され、劇場で映画を公開して興行収入を得るクリエイターがいます。つまり、私の見解は、ある意味、これは消費者の好みや好みがどこに向かうのかということです。消費者はすでにテクノロジーとエンターテイメントの融合に慣れてきているので、魔神を瓶に戻すことはできないと思います。
スポーツ視聴率バブルに陥っているのか？
ぴたろう：答えは即答で「ノー」です。まず、[評価] の測定が改善され、より正確になってきています。これには、もちろん、家庭外での使用や、現在ではストリーミングの使用も考慮されています。業界が景気後退を予測するたびに、数字は右肩上がりに上昇し続けます。
ジョーンズ: 飽和点に達すると思います。これが真実かどうかはわかりませんが、これは私にとって少し隣接した業界です。しかし、どの業界にも上限と利用可能な聴衆があると思います。最近の配信契約により、このコンテンツが配信されるプラットフォームの数が拡大しているため、限界に達していると思います。ピークに達すると、その一部が低下し始めると思います。
ニールセン製品戦略およびソートリーダーシップ担当シニアバイスプレジデントのブライアン・フューラー氏: ニールセンがスポーツやあらゆるもの全般に影響を与える方法論的な改善を行ったことを理解することが非常に重要ですが、特にスポーツに影響を及ぼします。一番重要なことは、私たちが自宅外での測定を拡大したことです...自宅市場はスポーツ料金にとって非常に重要です。したがって、その強化に直接起因する増加が見られ、今後も継続すると予想されますが、年ごとに大きな増加は見られません。
ウィンフリー: 今後も視聴率は上がっていくと思います。もしかしたら、それは短編コンテンツ、長編コンテンツ、スタジアムに連れて行く没入型機能を少し組み合わせたものかもしれません...しかし、私は、それが実際に表示される唯一の領域が、事後的に視聴できるものと同じではないと思います。そして、それがシステム内の評価を押し上げ続けると思います。
ザッカー: 現実には、ライブは機能します。人々はライブ イベント、ライブ ニュース、特にライブ スポーツを望んでいます。彼らはAIが再現できないものを望んでいます。ライブスポーツは今後も非常に好調な状況が続くだろう。評価が上がるか下がるかは、対戦やチャンピオンシップによって異なりますが、全体として、スポーツは非常に強力であり続けると思います。
コリアー氏: ライブ スポーツは、依然として私たちの文化における最後の真の大衆体験の 1 つです。分断された世界においても、スポーツは依然として共通の瞬間を生み出します。家族は一緒にそれらを視聴し、友人はリアルタイムでお互いにテキストメッセージを送り合い、私たちが見ているように、結果に基づいて街全体の雰囲気が変わります。したがって、プレミアムスポーツは依然として非常に価値があり、おそらく現在よりもさらに価値があるのではないかと思います。
最大手のストリーミングサービスはおそらく3年後も最大手であり続けるだろうということで大方の合意が得られている。他に大きな市場シェアを獲得すると思われるサービスは何ですか?
デブラ・オコネル氏、ディズニー・エンターテインメント・テレビ会長：テレビ形式に関するインスタグラムの最近の発表を見てください。おそらく、今日私たちが考えていないサービスであると思いますが、今日ここに存在し、視聴者と関わり、接続する方法の機能を拡張し、それらのエクスペリエンスを拡張する、より広範なサービスである可能性があります。
ウィンフリー: 実際のところ、本当のチャンスは、ケーブル TV がもともと価値と実用性を提供するために作られたのと同じように、さまざまなサービスをすべてまとめてまとめて、割引料金でサービスを提供できる人になることだと思います。新規参入者にとってはチャンスだと思います。
ザッカー: TikTokビデオはますます長くなっており、この傾向は今後も続くと思います。また、ニッチ キャスティングも今後も続くと思います。多くの非常に小さなコミュニティがこれらすべてのサービスにわたって非常に大きな役割を果たしていることがわかります。
総統: Roku Channel、Tubi、Pluto などのプラットフォームは、これらのサービス全体で驚異的な導入と使用量の増加が見られました。サービスの強化が続き、さまざまな企業がより多くのコンテンツ (オリジナル コンテンツ) を追加し、これらの [無料の広告付きストリーミング テレビ] チャンネルの人気が高まるにつれ、その勢いが衰える気配はありません。私たちは、この分野が本当に注目すべき分野であると考えています。
ぴたろう：私はエピックゲームズです。明らかに、ウォルト・ディズニー・カンパニーがここに投資しています。私たちは Epic Games に 15 億ドルの投資を行いましたが、私の観点から見ると、ゲーム体験をエンターテインメントとスポーツ コンテンツ (潜在的にはライブ イベントを含む) に結び付ける可能性は無限です。
Landgraf: 聞いたこともないストリーマーが 3 年後、長編動画で有意義な競争力を発揮できると本当に思いますか?いいえ、そうではないと思います。
ハーシュ: Starz が私の答えです。
開示情報: Versant は CNBC の親会社です。`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/08/17/tv-media-insiders-predictions.html",
    publishedAt: "2026-08-17T11:00:01+00:00",
    category: "金融政策",
    imageUrl: "https://images.unsplash.com/photo-1611974789855-9c2a0a7236a3?w=800&q=80",
    readTime: 10,
  },
  {
    id: "santoli-earnings-bonanza-that-lifted-mar-8e14d913",
    title: "Santoli: Earnings bonanza that lifted market to record may not be all that it appears to be",
    titleJa: "サントリ：市場を記録に押し上げた利益は、見かけどおりのすべてではないかもしれない",
    summaryJa: "まず、Mike Santoli のマーケット メモを受信箱で入手してください。ここから購読してください株価を新記録に押し上げる元気な回復から3週間が経ち、祝福された安堵感が本物の信念に取って代わられることを市場が証明する時が来た。",
    bodyOriginal: `Get Mike Santoli's Market Memo in your inbox first. SUBSCRIBE HERE
Three weeks into a perky rebound that pushed stocks to fresh records, it's time for the market to prove that blessed relief can give way to genuine belief.
...
株価を新記録に押し上げる元気な回復から3週間が経ち、祝福された安堵感が本物の信念に取って代わられることを市場が証明する時が来た。
S&P 500指数が12営業日で6％以上上昇した7月下旬以来の回復は、私が「すべての恐怖を取り除いた」上昇と呼んでいるものだ。
数週間前、これらの懸念が指数を圧迫した。大手テクノロジープラットフォームは、エスカレートし続けるAI投資に対してさらに罰を受けるだろうという懸念。半導体の熱狂的な買い占めはバブルの崩壊に変わった。そして連邦準備制度はより高い金利でインフレを追求する必要があるだろう。
ハイパースケーラーの収益で明らかになったクラウドサービスの力強い成長は、株価評価の低下に見舞われ、マグニチュード7での緊張緩和の上昇を推進した。半導体企業はウォッシュアウトの技術的条件に反応し、5週間で30％の暴落の半分弱を取り戻した。また、インフレ指標が良好であることと、雇用者数や小売売上高が不安定であることも相まって、FRBの利上げに対する市場の期待は後退している。
したがって、安心感と、個人と専門家の両方の資金による株式リスクの追加を急ぐことになります。
マクロ・リスク・アドバイザーズの技術調査責任者であるジョン・コロボス氏は、センチメントゲージを以下に紹介するが、先月は市場崩壊の可能性に警戒していた。しかし同氏は、大手テック企業の利益が数週間前に指数に「キックセーブ」をもたらしたと指摘する。同氏は現在、S&P 500指数が来年初めまでに8300（6～7％上昇）まで「針を伸ばす」可能性があり、夏の終わりには一部が下落する可能性があると予想している。コロヴォス氏は、モメンタム株は戦術的な上昇幅を拡大する可能性があり、中国株はその飛躍を望む人にとって買いの材料であると考えている。
収益急増は本当なのか？
アナリストやストラテジストたちは現在、第2四半期予想を覆した企業利益の間欠泉の報告について絶え間なく噴出しており、強気派はファンダメンタルズによって償還されて非常に高潔な気分になっている。
けっこうだ;これは確かにテープをサポートしており、他のすべては同じです。
しかし、この大当たりが企業の「稼ぎすぎ」になる可能性という、やっかいな可能性からは逃れられない。それは単に、この結果が OpenAI や Anthropic (AI インフラストラクチャ関連企業の注文を膨らませているすべての支出約束を満たすために、はるかに多くの資金を必要とする企業) に対するハイテク大手の株式の値上がりによってお世辞になったというだけではない。
この派手な数字は、ハイパースケーラーの過去の収益と現在失われたフリー キャッシュ フローを資金源とするデータセンター建設の計上収益も表しており、その収益に対して費用は将来の四半期でのみ認識されます。さらに、戦時中の供給中断で一時的にエネルギー部門の収益が急上昇したことや、多くの企業が2025年第2四半期の「解放記念日」の混乱で厳しい業績をたたき出しているという事実もある。
もちろん、現時点での利益予測は上昇を続けているため、決算の瞬間はここにはない可能性が高い。それでも、指数レベルの頂点ではないにしても、指数の評価額のピークが見られたという前提で話を進めたいと思います。
Ｓ＆Ｐは昨年１０月、ＡＩによる包括的な楽観主義、米国債利回りの低下、大型株の優位性などに支えられ、予想利益は２３倍に達した。この PER は、市場がそれ以来の利益の加速を期待していることも反映しています。
現在、PERは約20ですが、AI競争のゼロサム的側面が認識されていること、予測可能な限り技術系のフリーキャッシュフローがあまりないこと、そしてビジネスの新たな「資産重視」の性質を考慮すると、PERは大幅に上昇するのは難しいかもしれません。
ああ、S&P 工業セクターはすでに 25 倍の PER で取引されており、コロナ禍で利益が暴落したときを除けば、今世紀のどの時期よりもはるかに高く、そこにさらなる上昇の助けを求めるのは少々厳しい状況となっています。
雄牛のどの段階ですか?
これらの星印は、すべてのポジティブな要素を消し去るわけではないし、堅実なテープアクション自体を否定するわけでもない。S&P 500 は新高値への突破を維持しており、調和的なセクターのローテーション、適度な市場幅、地方銀行株が新高値を更新し、民間資本がいくつかの先導者の名前を嗅ぎ回っているとの報道を受けてソフトウエアが堅調となっている。
シタデル・セキュリティーズの株式および株式デリバティブ戦略の責任者であるスコット・ラブナー氏は、広く研究されている8月のフロー報告書を発表し、いくつかの需要源が集中しており、現時点では建設的な状況であると同氏が見ている状況を詳述した。7月下旬の安値で大量に売った後、個人トレーダーがエクスポージャーを再構築していること、抑制されたボラティリティの数値をキーオフするシステマティックなファンド、企業株の買い戻しである。
同氏は、「1年の大半を売り圧力の吸収に費やしてきた市場は、今月にかけて購買力を再構築し始める可能性がある」と結論づけた。 「9月は話が変わるかもしれない。季節性が増し、ポジショニングがより充実する可能性がある。8月が追撃戦になれば、今日の買い余力の一部はすでに消化されているだろう。」
スリーフォーティーン・リサーチの共同創設者ウォーレン・パイズ氏は先週、自身の推奨モデルにおいて株式のウェイトを中立に引き下げた。同氏は4月中旬にオーバーウェイトのポジションに転じ、S&P500指数が4カ月で10％上昇するタイミングに間に合った。同氏は現在、FRB利上げの可能性に対する市場価格は低すぎるとみている。
そのような警戒感は時期尚早である可能性があります。サイクル中盤の蛇行とサイクル後半のスパッタリングを区別するのは本質的に困難です。そして、フェイ・ミラー博士が「マッドメン」のドン・ドレイパーについて言ったように、市場回復の回復に関しては、私は気質的に「物事の始まりだけが好き」であることを認めます。
それでも、この信頼できる信条に従うことは決して悪いことではありません。「関与し続けるが、期待は抑制する」です。
市場温度計
マクロ リスク アドバイザーズのジョン コロボス氏によるこの指標は、投資家の発言と行動の両方を反映するためにいくつかのデータ ポイントを使用しています。
コロヴォス氏は最新の見解について、「センチメントの観点から見ると、そのような降伏的な売りにはならなかったが、6月に向けて市場を支配していた過度に強気なセンチメントは中和されており、これは市場を上昇させるのに十分だ」と述べた。
ストリートの周り
—私は何年も前から、S&P 500指数の下落が異常な頻度で発生し、終値ベースで完全に20％を失う手前で止まっていること、つまり強気相場の単純な定義に注目してきました。 Pie Funds の Mike Taylor による LinkedIn の有益な投稿に記載されているように、19% の下落 (または日中ベースで少なくとも 20% の下落があったもの) を数えると、史上最長の強気相場の一部がより短いものに短縮されます。
それでも、数か月で4歳になる現在の車にどれだけ残っているかについて結論を出すのは難しい。何十年にもわたって市場が生み出したデータはどれだけ多くても、真に信頼できる統計サンプルを取得するには十分なサイクルがありませんでした。
— 1989年の映画で使用されたアイオワ州のトウモロコシ畑ダイヤモンドで先週開催されたメジャーリーグベースボールの毎年恒例のフィールド・オブ・ドリームスの試合は、面白い新しい伝統であり、巧妙で人気のあるシーズン中のマーケティング機会を作り出しているMLBの稀な例である。
また、これは私にとってあまり人気のない作品を放送するチャンスでもあります。「フィールド・オブ・ドリームス」はトップ 5 に入る野球映画ではありません。
確かにセンチメンタルなお気に入りですが、心を温めるためにはシロップが多すぎます。 W.P.の原作小説『シューレス・ジョー』を読みました。キンセラ、10代の頃、私は父と息子の関係を、ブーマー世代とその両親の間の文化衝突やその他の反対を正当化する口実にするやり方を決して乗り越えることができませんでした。
私の野球映画トップ5：『エイト・メン・アウト』、『ザ・ナチュラル』、『ブル・ダーラム』、『メジャーリーグ』、『Bang the Drum Slowly』。
キンセラはまた、本当に奇妙で魅力的で、やや魔術的リアリズムの小説「アイオワ野球連盟」を書きましたが、これは時間を費やす価値があります。それが、昨年公開され高く評価されたインディーズ野球映画「イーファス」の少なくとも部分的なインスピレーションとなったことは間違いありません。
市場はクローズ
なぜ社会主義が台頭しているのか?: 先に示唆したように、企業アメリカが「稼ぎすぎ」である可能性があるとすれば、それは長い間その方向に向かって構築されてきました。
企業全体の利益率は四半世紀にわたり持続的に上昇し、かつては不可能だと考えられていた水準に達しました。減税、借入の軽減、技術効率のすべてが影響します。しかし、国民所得に占める労働分配率も急激に低下している。
BCA Researchのこのグラフは、労働に対する資本の優位性を完璧に表している。株式評価に直接影響を与え、おそらくは民主社会主義における現在の政治的上昇にも影響を与えます。
このデータは、BCAを長年務めた（そして現在は半ば引退している）チーフエコノミスト、マーティン・バーンズ氏による徹底的かつ挑発的な新しい報告書から得たものである。それは、かつては考えられなかった、数十年にわたる連邦政府の借入、ドル支配、そして企業の収益性の拡大が同時に起こっていることを描いている。
同氏の結論は、「高騰する連邦債務、回復力のあるドル、記録的な利益率は持続不可能である。今後5年以内に、債券自警団が復活し、ドルが大幅に下落し、AI主導の利益率バブルが崩壊すると予想される。後者は来年以内に起こるかもしれない。」としている。
ここからマイク・サントリのマーケットメモを購読してください`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/08/17/santoli-earnings-bonanza-that-lifted-market-to-record-may-not-be-all-that-it-appears-to-be.html",
    publishedAt: "2026-08-17T10:31:33+00:00",
    category: "エネルギー",
    imageUrl: "https://images.unsplash.com/photo-1473172367879-2dca04a4dca4?w=800&q=80",
    readTime: 10,
  },
  {
    id: "china-s-economy-slows-further-in-july-as-092690d6",
    title: "China's economy slows further in July as retail sales barely grow, investment slump steepens",
    titleJa: "中国経済は7月にさらに減速、小売売上高はほとんど伸びず、投資不振が深刻化",
    summaryJa: "7月の中国経済は、個人消費が失速し、失業率が上昇する一方で都市投資がより速いペースで縮小したため、全面的に勢いを失い、下半期に中国への支援強化を求める圧力が強まった。国家統計局が月曜日に発表した小売売上高は前年比0.6％増で、ロイター調査の予想1.5％増には及ばず、6月の1％から鈍化した。",
    bodyOriginal: `China's economy lost momentum across the board in July, as consumer spending stalled and urban investment contracted at a faster pace while unemployment ticked higher, adding to pressure on Beijing to step up support in the second half.
...
Beijing's massive trade surplus has become a standing grievance for its trading partners, raising the risk of fresh trade restrictions aimed at forcing a trade rebalancing from Beijing, analysts say. China's trade surplus reached $687.4 billion in the January-to-July period, putting it on track for another trillion-dollar-plus surplus in 2026.`,
    bodyJa: `7月の中国経済は、個人消費が失速し、失業率が上昇する一方で都市投資がより速いペースで縮小したため、全面的に勢いを失い、下半期に中国への支援強化を求める圧力が強まった。
国家統計局が月曜日に発表した小売売上高は前年比0.6％増で、ロイター調査の予想1.5％増には及ばず、6月の1％から鈍化した。
不動産やインフラを含む中国の都市固定資産投資は今年、7月末時点で前年比6.7％減少し、調査結果の推定6％減よりも悪化した。落ち込みも今年上半期の５．７％減からさらに加速した。
７月の鉱工業生産は４．５％増加し、予想の４．８％増加を下回り、６月の５．３％増加から鈍化した。
7月の都市部失業率は5.2％となり、6月の5％から上昇した。
データは午後3時に発表された。通常の午前10時ではなく、午前10時に開始されたことで、深刻化する需給不均衡に直面している世界第2位の経済の健全性に対する懸念が強まった。
長引く不動産不況と不安定なエネルギー価格の中で消費と民間投資が低迷する中でも、世界的なAI投資ブームに関連した堅調な鉱工業生産と輸出が総合成長を牽引した。
７月の統計は、経済が第２・四半期に２０２２年後半以来の低い成長率を記録し、前年比でわずか４．３％の伸びとなった後に発表された。中国の上半期のＧＤＰ成長率は４．７％で、同経済は中国政府の成長目標範囲である４．５─５％の達成に向けた軌道に乗っている。
減速の拡大
ゴールドマン・サックスによると、中国の小売売上高の伸びは過去1年間で急激に鈍化し、今年上半期の名目成長率は前年同期の5％からわずか1.3％に鈍化した。
同銀行は、景気減速の主な原因は、購入を前倒しする政府の下取り補助制度によるものであり、その後足かせとなっているとしている。ゴールドマンのエコノミストらは先週金曜日のノートで、「ＣＰＩインフレ率の上昇を考慮すると、実際の勢いはさらに弱かった可能性が高い」と述べた。
下取り制度による支援の薄れが引き続き消費を低迷させているため、売上高の伸びはおそらく下半期も弱いままで、通年の成長率は約1.5％にとどまるとゴールドマンは予想している。
中国人民銀行が先週金曜日に発表した公式データに基づいたバークレイズの計算によると、支出の持続的な弱さを示すもう一つの兆候として、通常は融資が低迷する月である7月の新規銀行融資が月間で過去最大の減少を記録したという。
CNBCの公式統計によると、住宅ローンを含む家計融資は、住宅活動の低迷と労働市場の低迷を背景に、6月に一時回復した後、7月には縮小した。
数年にわたる不動産不況で住宅ローン需要が弱まる一方、借り手の返済能力に警戒する銀行は融資に消極的となっている。
雇用情勢は公式統計が示唆するよりも悪いかもしれない。清華大学の経済学教授、李道偉氏のチームが実施した民間調査によると、7月時点で中国の広範な失業率は10.2％で、約5％という公式数値を大幅に上回っている。
この調査では、過去2年間失業中で公式の労働力調査の対象から外れた人もカウントされており、約2,400万人の長期失業者の半数以上が16歳から24歳であることも明らかになった。
雇用低迷の背景には投資の低迷がある。都市投資は昨年、数十年ぶりに前年比3.8％減と減少したが、不動産の低迷と地方政府の借り入れ制限強化が中国の伝統的な成長原動力の一つを妨げたため、今年はさらに悪化した。
投資の落ち込みの激しさは「前例がない」とリー氏は述べ、投資の縮小と若者の高い失業率が中国の成長目標達成への最大の障害であると述べた。李首相は、政府借入を大幅に拡大し、今年の新規国債発行予定額の2倍以上となる12兆元（1兆7000億ドル）を超えるよう求めた。
工場や建設活動も7月には勢いを失い、国内受注が低迷し、先月は台風や豪雨などの異常気象により港湾活動や事業運営が混乱したため、公式の製造業購買担当者景気指数（PMI）は2月以来初めて予想外に低下した。
世界的なAIの増強が中東紛争による逆風を相殺するのに役立っており、輸出は依然として冷え込む経済においてまれな明るい材料である。 7月の輸出は前年同月比23.9％増と予想を上回った。前月は27％増と2021年以来の大幅な伸びとなった。輸入は27.5％増で予想を下回った。
アナリストらによると、中国政府の巨額の貿易黒字は貿易相手国にとって永続的な不満となっており、中国政府に貿易バランスの調整を強制することを目的とした新たな貿易制限のリスクが高まっているという。中国の貿易黒字は１─７月に６８７４億ドルに達し、２０２６年にはさらに１兆ドル以上の黒字となる軌道に乗っている。`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/08/17/china-economy-sales-investment-july-.html",
    publishedAt: "2026-08-17T07:03:55+00:00",
    category: "エネルギー",
    imageUrl: "https://images.unsplash.com/photo-1473172367879-2dca04a4dca4?w=800&q=80",
    readTime: 5,
  },
  {
    id: "ukrainian-strikes-kill-six-in-russia-act-cdaac145",
    title: "Ukrainian strikes kill six in Russia, acting governor says",
    titleJa: "ウクライナ空爆でロシア6人死亡、知事代理が発言",
    summaryJa: "ウクライナ空爆でロシア6人死亡、知事代理が発言- 公開されました",
    bodyOriginal: `Ukrainian strikes kill six in Russia, acting governor says
- Published
...
Related topics
- Published4 days ago`,
    bodyJa: `ウクライナ空爆でロシア6人死亡、知事代理が発言
- 公開されました
ウクライナがロシアのベルゴロド地域を一晩中ミサイル攻撃し、6人が死亡、4人が負傷したと同州知事代理が発表した。
負傷者の中には14歳の子供も含まれていたとアレクサンダー・シュバエフ氏は月曜テレグラムに書いた。
この空爆は、ロシア当局が今年ウクライナによって少なくとも7人が死亡した「最大規模」と呼ぶ攻撃の翌日の夜に行われた。
土曜夜にもロシアによるウクライナ攻撃で少なくとも７人が死亡、３９人以上が負傷した。
ロシアは２０２２年２月にウクライナへの本格侵攻を開始し、現在はウクライナ領土の約５分の１を支配している。
シュバエフ氏によると、最近のウクライナの攻撃により、ロシアとウクライナの国境に近いヴァルイスキー地区のコロスコヴォ村で建物が焼かれ、車が損傷した。
負傷した子供は病院に送られ、他の2人は医療援助を受けたと付け加えた。
キエフはここ数週間、ロシア奥深くへの無人機攻撃を強化している。
同地方知事によると、ウクライナは土曜夜、約822機の無人機をロシアに向けて発射し、うち600機がモスクワを目指したと発表し、ロシアの首都は「最近の記憶の中で最も大規模な無人機攻撃の一つ」を受けたと述べた。
土曜夜のストライキで、ロシア南西部ロストフ州で５人が死亡したと知事が発表した。当局者らによると、ベルゴロド市では民間バスへの攻撃で女性が死亡し、モスクワ地方では無人機攻撃で83歳の男性が死亡した。
ロシアのオンライン小売業者ワイルドベリーズの倉庫も被害を受けた。
ウクライナは7月以降、ロシア版アマゾンとして知られる同社を繰り返し標的にしている。ウクライナ国防省は、今回の攻撃により、ワイルドベリーの最大規模物流センター10施設のうち7施設が「機能停止」になったと発表した。
ロシアはここ数週間、ウクライナ全土でミサイル攻撃を強化している。
ウクライナのエネルギー会社ナフトガスは月曜日、ロシアが過去1週間に自社施設を13回攻撃したと発表した。
土曜夜にロシアがウクライナを攻撃した際、ザポリージャ地方で民家が誘導空爆を受け、男女が死亡したと当局者が発表した。全国各地での攻撃で他に5人が死亡した。
ロシアは、土曜日の夜のキエフへの攻撃は、ウクライナのフラミンゴミサイルの部品を製造するファイアポイント施設と無人機の部品を製造する工場を標的にしたと発表した。
ロシアによる攻撃は、同市ポチャイナ地区の書籍市場も襲った。地面には焼けた本が落ちていた。
ウクライナのウォロディミル・ゼレンスキー大統領は、今週13の地域が攻撃を受けており、ロシアは1,550機以上の攻撃用無人機、1,560発近くの誘導航空爆弾、62発のミサイルを発射したと述べた。
双方は民間人を標的にしたとして互いを非難している。
関連トピック
- 4 日前に公開`,
    source: "BBC",
    sourceUrl: "https://www.bbc.co.uk/news/articles/cn7n4lm11vro?at_medium=RSS&at_campaign=rss",
    publishedAt: "2026-08-17T06:57:23+00:00",
    category: "エネルギー",
    imageUrl: "https://ichef.bbci.co.uk/ace/standard/240/cpsprodpb/46f4/live/ddb0b5f0-99fc-11f1-ad4f-c7824f9e4997.jpg",
    readTime: 3,
  },
  {
    id: "ferrari-luce-polarizing-ev-becomes-a-40-faf4601d",
    title: "Ferrari Luce: Polarizing EV becomes a $40 million collector’s item",
    titleJa: "フェラーリ・ルーチェ：偏光EVが4,000万ドルのコレクターズアイテムに",
    summaryJa: "フェラーリ初の完全電気自動車のパーソナライズされたモデルがチャリティーセールで4,000万ドルで落札され、市場の懐疑を無視してオークションで落札された新車の記録を樹立した。カリフォルニアのモントレー・カー・ウィークで行われたサザビーズの「テーラーメイド」ルーチェのオークションは、このロットが、ユニークな半光沢仕上げやその他の特注パーツを特徴とするルーチェ・プログラムの最初の量産シャシーを獲得する「またとない機会」となったと述べた。",
    bodyOriginal: `A personalized model of Ferrari's first fully electric vehicle has sold for $40 million in a charity sale, defying market skepticism and setting a record for a new car sold at auction.
The Sotheby's auction of the Luce "tailor made" at Monterey Car Week in California said the lot marked an "unrepeatable opportunity" to acquire the first production chassis of the Luce program, which featured a unique semi-gloss finish and other bespoke parts.
The auction house did not name the winning buyer of the luxury car and said the proceeds would be donated to Ferrari's foundation of educational programs. Ferrari's "tailor made" program is an exclusive initiative for cars customized to a buyer's precise specifications.
The blockbuster auction comes nearly three months after Ferrari unveiled its first fully electric car, which was priced at 550,000 euros (roughly $640,000). The move marked a departure from the aesthetic of typical Ferraris and came despite other sports car manufacturers, notably Porsche and Lamborghini, scaling back on plans to launch their own EVs due to weak demand.
The unveiling of the Luce sparked a negative market reaction, with analysts citing a mix of "design hate" and the classic market adage of "travel and arrive," noting that Ferrari's stock price had risen significantly ahead of launch.
Read more
Ferrari CEO Benedetto Vigna said at the time that the Maranello, Italy-based company respected the different needs and wishes of its customers, adding that existing clientele would be interested in the Luce and the carmaker would welcome new buyers thanks to the fully electric model.
Ferrari raised its full-year guidance last month, citing stronger personalization demand than initially expected, as it beat Wall Street's second-quarter expectations. Milan-listed shares of Ferrari are up nearly 12% so far this year.`,
    bodyJa: `フェラーリ初の完全電気自動車のパーソナライズされたモデルがチャリティーセールで4,000万ドルで落札され、市場の懐疑を無視してオークションで落札された新車の記録を樹立した。
カリフォルニアのモントレー・カー・ウィークで行われたサザビーズの「テーラーメイド」ルーチェのオークションは、このロットが、ユニークな半光沢仕上げやその他の特注パーツを特徴とするルーチェ・プログラムの最初の量産シャシーを獲得する「またとない機会」となったと述べた。
オークションハウスは高級車の落札者の名前は明らかにせず、収益はフェラーリの教育プログラム財団に寄付されると述べた。フェラーリの「オーダーメイド」プログラムは、購入者の正確な仕様に合わせてカスタマイズされた車のための独占的な取り組みです。
この大ヒットオークションは、フェラーリが55万ユーロ（約64万ドル）で落札された初の完全電気自動車を発表してからほぼ3カ月後に行われた。この動きは典型的なフェラーリの美学からの逸脱を示すもので、他のスポーツカーメーカー、特にポルシェやランボルギーニが需要の低迷を理由に自社EVの発売計画を縮小しているにもかかわらず行われた。
ルーチェの発表は市場の否定的な反応を引き起こし、アナリストらは「デザイン嫌い」と古典的な市場の格言「旅行して到着」の組み合わせを挙げ、フェラーリの株価が発売前に大幅に上昇したことを指摘した。
続きを読む
フェラーリのベネデット・ヴィーニャ最高経営責任者（CEO）は当時、イタリアのマラネッロに本拠を置くフェラーリは顧客のさまざまなニーズや希望を尊重していると述べ、既存の顧客はルーチェに興味を持ち、自動車メーカーは完全電気モデルのおかげで新規購入者を歓迎すると付け加えた。
フェラーリは先月、ウォール街の第2四半期予想を上回ったため、パーソナライゼーション需要が当初予想よりも強かったとして、通期業績見通しを引き上げた。ミラノ上場フェラーリ株は年初から12％近く上昇している。`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/08/17/ferrari-luce-electric-car-autos.html",
    publishedAt: "2026-08-17T06:52:23+00:00",
    category: "自動車",
    imageUrl: "https://images.unsplash.com/photo-1560958089-b8a1929cea89?w=800&q=80",
    readTime: 2,
  },
  {
    id: "if-meta-loses-this-trial-instagram-and-f-0d232b36",
    title: "If Meta loses this trial, Instagram and Facebook could change forever",
    titleJa: "もしメタがこの裁判に負ければ、インスタグラムとフェイスブックは永久に変わってしまうかもしれない",
    summaryJa: "もしメタがこの裁判に負ければ、インスタグラムとフェイスブックは永久に変わってしまうかもしれない- 公開されました",
    bodyOriginal: `If Meta loses this trial, Instagram and Facebook could change forever
- Published
...
- Published11 June`,
    bodyJa: `もしメタがこの裁判に負ければ、インスタグラムとフェイスブックは永久に変わってしまうかもしれない
- 公開されました
メタ社は、自社のプラットフォームが若いユーザーをターゲットにし、危害を加えてきたことを巡り、法廷で連続敗訴しているが、火曜日に始まる予定の陪審裁判は、同社の事業にとってこれまでで最大の脅威となる可能性がある。
この裁判は、カリフォルニア州やニューヨーク州を含む米国の30の州が2023年に起こした訴訟に端を発しており、この訴訟では連邦および州の児童プライバシー法に多数の違反があったとして訴えられている。
各州はメタ社外に1兆ドル以上を求めているだけでなく、インスタグラムやフェイスブックに「いいね」数や無限スクロールの廃止などの変更をメタ社に要求している。
この規模の訴訟でメタ社が最終的に敗訴した場合、若者のソーシャルメディア体験方法に根本的な変化を強いられる可能性がある。
メタ社を訴えている州は、若者向けのインスタグラムとフェイスブックの運営方法にもさらに多くの変更を求めている。
彼らはメタに次のことを望んでいます。
10代のユーザーに対して保護者認証のプロセスを実装する
「ドーパミンを操作する推奨アルゴリズム」を変更する
写真の見た目を変える多くの画像フィルターを削除する
ビデオコンテンツの自動再生を終了する
複数のアカウントの作成を禁止する
Instagram ストーリーなど、消える投稿や「一時的な」投稿を終わらせる
これらの機能はすべて、Meta のプラットフォームにおける現在のユーザー エクスペリエンスの中心となっています。
これらの機能は、ティーンエイジャーや子供を含むユーザーをできるだけ頻繁に、そしてできるだけ長くプラットフォームに留まらせるように設計されているとも各州は主張している。彼らは、メタは、若者をアプリに戻すために設計された頻繁な通知などを通じて、若者がプラットフォームを利用することを困難にさえしていると主張している。
伝えられるところによると、メタは児童ユーザーをターゲットにすることで、若者を自社のプラットフォームに引き付けるために「搾取することを選択」し、ユーザーベースを拡大し、事業を拡大できるようにした。現在、株式市場におけるメタの価値は約1.5兆ドルです。
メタはそのような主張を一貫して否定している。
同社の広報担当者は声明で「われわれはこうした主張に強く反対しており、若者支援に対する当社の長年にわたる取り組みが証拠によって示されると確信している」と述べた。
各州はカリフォルニア州の首席連邦判事イボンヌ・ゴンザレス・ロジャーズ判事に請求を提出している。彼女は注目を集めたイーロン・マスク対サム・アルトマン裁判の裁判官を務め、20年近くにわたり裁判官から鋭く率直な裁判官としての評判を築いてきた。
ソーシャルメディアは「公共迷惑」になった
最近のメタに対する判決で、ニューメキシコ州の判事は同社に総額9億4,200万ドルの罰金を科し、現在追加の州が要求しているのと同様の変更を行うよう命じた。
ブライアン・ビエドシャイト判事が命じた変更には、インスタグラムとフェイスブックにおける18歳未満のユーザーの「いいね！」数の廃止、ティーンエイジャーによるプラットフォームを通じたヌードの送受信の禁止、アプリからのプッシュ通知を1日の特定の時間帯に制限するなどが含まれる。
判事はまた、メタは人々が呼吸する空気を汚染し、全人口に影響を与える「有害な影響」を引き起こしている工場と同様の「公共迷惑行為」であると宣言した。メタ社は判決に対して控訴すると述べた。
ビエドシャイト判事の命令はメタに対しニューメキシコ州での変更のみを要求しているが、30州がメタに対する個別の訴訟で勝訴すれば、ほぼ確実に全米でプラットフォームの変更を制定する必要があるだろう。
訴訟に関与している州は、国の人口のほぼ3分の2を代表している。
もしメタがそのような変更を実施した場合、それはプラットフォームのエクスペリエンスに重大な変化をもたらすことになるでしょう。
たとえば、「いいね！」の数は、Meta がまだ Facebook と呼ばれ、それが唯一のプラットフォームだった初期の頃から、Meta の一部でした。
今日、「いいね！」はソーシャル メディア プラットフォーム上に遍在しています。これは、人々がオンラインで見るテキスト、写真、ビデオと関わる主な方法です。
しかし、「いいね！」は、特に若者の間で、否定的な感情を助長する方法であると見なされることが増えています。
今年初めにメタに対する訴訟で勝訴した若い女性、ケイリーさんは法廷証言で、どのようにしてユーチューブやインスタグラムに数十のアカウントを作成したかを語った。
彼女はアカウント システムを使用して自分の投稿に「いいね！」を作成し、他のユーザーとの関わりや、自分の正当性や自尊心の感情を促進することを望んでいた。ケイリーは当時わずか9歳でした。彼女は、後に10歳のときにうつ病と診断されたことを覚えていると語った。
過去数年間の研究では、「いいね！」の数などのエンゲージメント指標が、十代の若者たちの外部にある拒絶感や憂鬱感を引き起こす可能性があることが示されています。
メタ社が200万件以上の文書を提出したと発表したメタ社に対する州の訴訟で、弁護士らは、同様のカウントが「社会的比較」、つまり他人の画像に対して自分の価値をマークするという精神的行為を引き起こすことを示したメタ社自身の研究を指摘した。
メタ社の内部調査によると、インスタグラムによって引き起こされた社会的比較は、「孤独感の増加、身体イメージの悪化、否定的な気分や感情」に関連していたという。
ビエドシャイト判事が命令文で述べたように、ソーシャルメディア企業が「公共迷惑行為」とみなされたのは初めてのことであり、メタ社のプラットフォームの10年以上にわたる運営方法は、ニューメキシコ州などで拡大する「若者のメンタルヘルス危機」の一部だった。
現在、さらに30州の弁護士がゴンザレス・ロジャース判事に同じ結論に達するよう迫っている。
- 6 月 11 日発行`,
    source: "BBC",
    sourceUrl: "https://www.bbc.co.uk/news/articles/clyqpx6xk69o?at_medium=RSS&at_campaign=rss",
    publishedAt: "2026-08-17T05:00:25+00:00",
    category: "マクロ経済",
    imageUrl: "https://ichef.bbci.co.uk/ace/standard/240/cpsprodpb/078d/live/f51173c0-97c1-11f1-9963-d1f200dff659.jpg",
    readTime: 6,
  },
  {
    id: "ebola-outbreak-in-dr-congo-becomes-deadl-52991b80",
    title: "Ebola outbreak in DR Congo becomes deadliest in its history",
    titleJa: "コンゴ民主共和国でのエボラ出血熱流行、史上最悪の死者数に",
    summaryJa: "コンゴ民主共和国でのエボラ出血熱流行、史上最悪の死者数に- 公開されました",
    bodyOriginal: `Ebola outbreak in DR Congo becomes deadliest in its history
- Published
...
The outbreak is the 17th to have emerged in DR Congo since Ebola was discovered 50 years ago. Years of conflict and a highly mobile population have added to the country's challenges in controlling the spread of the disease.
The WHO has said it hopes to reverse the spread of the disease within three months but warned that this meant bringing transmission under control and not ending the outbreak entirely.
...
The jab is being created by a team from the University of Oxford based on the same technology used in the Oxford-AstraZeneca Covid vaccine. Three other groups are also developing different vaccines for Bundibugyo.
...
- Published3 days ago
- Published6 days ago`,
    bodyJa: `コンゴ民主共和国でのエボラ出血熱流行、史上最悪の死者数に
- 公開されました
公衆衛生当局によると、コンゴ民主共和国におけるエボラ出血熱の流行は現在、史上最悪の死者数となっている。
5月15日にこのウイルスが宣言されて以来、このウイルスによる死者は計2,325人となり、2018年から2020年に国内で発生した感染症の死者数を上回った。
国連の人道支援責任者トム・フレッチャー氏は先週、流行はすでに記録上最も急速に拡大していると述べ、「流行により30分ごとに誰かが亡くなっている」と警告した。
現在の流行を引き起こしているブンディブギョ種に対して利用できる承認されたワクチンは現時点ではありませんが、アストラゼネカの新型コロナウイルス感染症ワクチンの開発に使用された技術に基づくものなど、いくつかのワクチンが開発中です。
コンゴ民主共和国公衆衛生研究所は日曜日、過去24時間の101人を含む4,945人の確認症例を記録したと発表した。
国外で確認された感染者は比較的少ない。8月12日現在、隣国ウガンダで20人の感染者が確認され、ドイツで2人が治療を受け、フランスで1人の感染者が申告された。
しかし、コンゴ民主共和国でのウイルス感染のペースは26州のうち6州に広がっており、世界保健機関は「異例」と表現している。
ロイター通信によると、2014年から2016年に西アフリカで発生した世界最悪の流行では、死者数が1,000人に達するまでに5か月近くかかったが、今回の流行では3か月足らずで死者2,000人に達した。
50年前にエボラ出血熱が発見されて以来、この流行はコンゴ民主共和国で発生した17回目となる。長年にわたる紛争と人口の流動性の高さにより、病気の蔓延を制御する上でこの国の課題はさらに増大しています。
WHOは3カ月以内に感染拡大を逆転させたいと述べたが、これは感染を制御下に置くことを意味し、発生を完全に終わらせることではないと警告した。
エボラ出血熱はまれではあるが致死性のウイルス性疾患であり、ブンディブギョ種はさらにまれで、これまでに発生したことが知られているのはわずか 2 件だけです。
エボラ出血熱の症状はインフルエンザやマラリアに似ており、発熱、頭痛、倦怠感などがあり、感染後 2 ～ 21 日以内に突然始まることがあります。
病気が進行すると、嘔吐や下痢が起こり、臓器不全に至ることがあります。血液や嘔吐物などの感染した体液と接触すると、ウイルスが広がります。
英国の医薬品規制当局であるMHRAは、ブンディブギョに対するワクチンの初の人体臨床試験の実施を許可した。
このジャブは、オックスフォード・アストラゼネカの新型コロナウイルスワクチンで使用されているのと同じ技術に基づいて、オックスフォード大学のチームによって開発されている。他の3つのグループもブンディブギョ向けに異なるワクチンを開発している。
WHOはまた、既存の2つの抗ウイルス療法が生存率を改善できるかどうかを確認するために、コンゴ民主共和国で別の臨床試験を後援している。
関連トピック
- 4 日前に公開
- 3 日前に公開
- 6 日前に公開`,
    ...
    publishedAt: "2026-08-17T04:41:31+00:00",
    category: "貿易",
    imageUrl: "https://ichef.bbci.co.uk/ace/standard/240/cpsprodpb/6968/live/176af9c0-99f5-11f1-8ffd-896dfa12c5fd.jpg",
    readTime: 3,
  },
  {
    id: "ferrari-s-first-ever-electric-car-sold-f-14dbf26d",
    title: "Ferrari's first ever electric car sold for record $40m",
    titleJa: "フェラーリ初の電気自動車、記録的な4,000万ドルで落札",
    summaryJa: "フェラーリ初の電気自動車、記録的な4,000万ドルで落札- 公開されました",
    bodyOriginal: `Ferrari's first ever electric car sold for record $40m
- Published
...
Related topics
- Published27 May`,
    bodyJa: `フェラーリ初の電気自動車、記録的な4,000万ドルで落札
- 公開されました
フェラーリ初の電気自動車がチャリティーセールで4000万ドル（2950万ポンド）で落札され、オークションで落札された新車の記録を樹立した。
イギリスのiPhoneデザイナー、サー・ジョニー・アイブの発案であるフェラーリ・ルーチェの販売は、カリフォルニアのRMサザビーズでのイベントで通常の車の価格の35倍以上に跳ね上がった。
ルーチェは5月に発売された際に反発に直面した。一部の解説者は、バッテリー駆動で座席が5つあることでブランドの伝統的なデザインから逸脱し、ブランドのアイデンティティの一部を失ったと述べた。
サザビーズによると、販売収益はすべてフェラーリ財団の教育プログラムに寄付されるという。
サザビーズは、ユニークな仕上げと特注パーツを特徴とするカスタム・ルーチェの購入者の名前は明らかにしていない。
BBCはオークションハウスとフェラーリにコメントを求めた。
ルーチェの発表は、近年の新車発表の中で最大規模の発表の一つとみられていた。
これは、イーロン・マスク氏率いるテスラと中国の自動車メーカーが独占する電気自動車（EV）市場への跳ね馬の初参入となった。
イタリアのセルジオ・マッタレッラ大統領とローマ法王レオが高級ブランドの新車を視察するために招待された。
しかし、ルーチェに対する反発を受けて、フェラーリの株価はルーチェ発売の翌日に下落した。
この車を批判した者の中には、イタリアのマッテオ・サルビーニ副首相やフェラーリの元会長ルカ・コルデロ・ディ・モンテゼモロも含まれており、この車は「伝説が破壊される危険がある」と述べた。
フェラーリの最高デザイン責任者のフラヴィオ・マンゾーニ氏は5月のインタビューで、批評家もイノベーションのプロセスの一部であり、人々はルーチェを高く評価するようになるだろうと信じていると語った。
同社はLuceの売上目標を明らかにしていないが、フィナンシャル・タイムズの報道によると、中国からの強い需要のおかげで今年の売上目標を達成したという。
サザビーズは社外向けの声明で、このオークションに出品された車両は、ルーチェの最初の量産車を所有する「またとない機会」となったと述べた。
この車には特別なホイール、カスタマイズされたブレーキ、そして白い仕上げが施されています。
サザビーズは、このチャリティーセールは「革新性、責任、将来世代への長期ビジョンの具体的な表現」であると述べた。
フェラーリは自動車オークションで最高額で落札されることがよくあります。
特注のフェラーリ デイトナ SP3 スーパーカーは、2025 年のオークションで自動車メーカーの教育活動のために 2,600 万ドルを集めました。当時、この車は新車に支払われた最高価格のオークション記録を樹立しました。
現在のオークションでの最高価格記録は、超希少な1955年製メルセデス・ベンツ300 SLRウーレンハウト・クーペで、2022年に1億4,200万ドルで落札された。
関連トピック
- 5 月 27 日公開`,
    source: "BBC",
    sourceUrl: "https://www.bbc.co.uk/news/articles/c77ggpgrp2do?at_medium=RSS&at_campaign=rss",
    publishedAt: "2026-08-17T02:22:04+00:00",
    category: "自動車",
    imageUrl: "https://ichef.bbci.co.uk/ace/standard/240/cpsprodpb/e2f6/live/27d57b00-99d2-11f1-8bfd-8bbe460b94a0.jpg",
    readTime: 3,
  },
  {
    id: "u-s-stock-futures-little-changed-as-inve-7d20f025",
    title: "U.S. stock futures little changed as investors ponder the Fed’s next move",
    titleJa: "投資家がFRBの次の行動を思案する中、米国株先物はほとんど変化なし",
    summaryJa: "Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.",
    bodyOriginal: `U.S. stock-index futures were little changed on Sunday after a quiet week on Wall Street, as investors await hints from the Fed concerning the outlook for interest rates.`,
    bodyJa: `投資家が金利見通しに関するFRBからのヒントを待っているため、ウォール街では閑散とした一週間を経て、日曜日の米国株価指数先物相場はほとんど変化しなかった。`,
    source: "MarketWatch",
    sourceUrl: "https://www.marketwatch.com/story/u-s-stock-futures-little-changed-as-investors-ponder-the-feds-next-move-27bcbea4?mod=mw_rss_topstories",
    publishedAt: "2026-08-17T00:55:00+00:00",
    category: "金融政策",
    imageUrl: "https://images.mktw.net/im-86215320",
    readTime: 2,
  },
  {
    id: "japan-second-quarter-gdp-grows-1-1-on-an-737bcfed",
    title: "Japan second-quarter GDP grows 1.1% on an annualized basis, missing expectations",
    titleJa: "日本の第2四半期GDPは年率換算で1.1%成長、予想を下回る",
    summaryJa: "第２・四半期の日本経済は年率換算で１．１％拡大し、内需の低迷が好調な輸出を相殺したため、期待の２％成長には届かなかった。この数字は前四半期の2.1%と比較された。",
    bodyOriginal: `Japan's economy expanded 1.1% in the second quarter on an annualized basis, missing expectations for 2% growth as softer domestic demand offset strong exports.
...
— This is breaking news, please check back for updates.`,
    bodyJa: `第２・四半期の日本経済は年率換算で１．１％拡大し、内需の低迷が好調な輸出を相殺したため、期待の２％成長には届かなかった。
この数字は前四半期の2.1%と比較された。
前年同期比では、同国の経済成長率は第１四半期の０．５％から０．７％増加した。
これは、企業や家庭のエネルギー価格を上昇させたイラン戦争の影響を含む初めての四半期となる。
データ発表後、日経平均株価は0.43％上昇し、指標となる10年日本国債の利回りは2.88％となった。円は対ドルで若干上昇し、159.1円で取引された。
輸出が成長の主な原動力であり、同国からの出荷額は同四半期の３カ月すべてで予想を上回った。ただし、これは単に出荷量が増加しただけではなく、円安によってもたらされました。
今月初め、日本銀行は経済活動見通しを発表し、2026年度（2027年3月まで）のGDP成長率見通しを0.5％から0.6％に小幅引き上げた。
中東紛争による原油価格の高騰を指摘し、中銀は「日本経済は減速しながらも緩やかな成長を続けると予想される」と述べた。
しかし、これは、家計向けの原油高を抑制するための政府の措置や、世界的なAI関連需要の増加によって部分的に相殺される可能性が高い。半導体のサプライチェーンには多くの日本企業が関わっています。
— これは最新ニュースです。最新情報を確認してください。`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/08/17/japan-gdp-misses-estimates-trade-exports-yen-nikkei.html",
    publishedAt: "2026-08-17T00:50:18+00:00",
    category: "エネルギー",
    imageUrl: "https://images.unsplash.com/photo-1473172367879-2dca04a4dca4?w=800&q=80",
    readTime: 2,
  },
  {
    id: "trump-says-us-to-scale-back-military-dri-18e36077",
    ...
    summaryJa: "トランプ大統領、米国はイラン戦争に参加しなかったことを受け、韓国との軍事演習を縮小すると発言- 公開されました",
    bodyOriginal: `Trump says US to scale back military drills with South Korea after it stayed out of Iran war
- Published
...
- Published1 day ago`,
    bodyJa: `トランプ大統領、米国はイラン戦争に参加しなかったことを受け、韓国との軍事演習を縮小すると発言
- 公開されました
ドナルド・トランプ大統領は、北朝鮮の指導者金正恩氏との「非常に良好な関係」を理由に、米国は韓国との合同軍事演習を「大幅に縮小する」と述べた。
同氏はまた、Truth Socialで、韓国が最近、イランの「非核化」における米国への参加を拒否したと指摘した。
トランプ大統領は「これらの演習は費用がかかるだけでなく、その費用の多くは（いつものように！）米国が負担しているだけでなく、全く不適切で敵対的なシグナルを送るものだ」と投稿した。
韓国政府は、米国との訓練は「予定通り」行われると述べた。北朝鮮はまだコメントしていない。北朝鮮が今月、国連が禁止している弾道ミサイル実験を実施したことを受けてのことだ。
トランプ大統領は日曜、ソーシャルメディアへの投稿で、米国と韓国が月曜に年次軍事演習を開始する予定だったため、「中止するには遅すぎる」と述べた。
さらに、「少し関係ないが（？）、私は最近、韓国大統領にイラン・イスラム共和国の非核化に参加してくれないかと尋ねたが、彼らは『ノー・サンクス！』と答えた」と付け加えた。
トランプ大統領の発表は、2018年に自身と金氏の古い写真を投稿してから24時間も経たないうちに行われ、「この特定の写真では無愛想な表情にもかかわらず」2人は素晴らしい友人だったと記した。
先週、米国と韓国の軍事指導者は共同記者会見を開き、乙支フリーダムシールドを発表した。
１１日間のイベントは例年と同規模で、約１万８０００人の韓国軍兵士が参加すると発表した。
記者会見で軍指導者らは、ロシアの対ウクライナ戦争を支援するための北朝鮮の軍隊派遣にも言及した。
米軍報道官ライアン・ドナルドは、戦場から帰還した北朝鮮兵士について言及し、「我々の訓練がその脅威の説明になっている」と述べた。韓国には約２万８５００人の米軍人が駐留している。
金曜日、北朝鮮外務省は合同軍事演習を「侵略戦争の予行演習」であると非難した。
この合同演習は、韓国、米国、日本が数日で２回目の北朝鮮のミサイル実験を探知した数日後に行われる。
2019年に金氏のホワイトハウス一期目の任期中のトランプ氏との大々的な外交が破綻して以来、北朝鮮は核・ミサイル計画を拡大する取り組みを加速させている。
同氏は7年前に北朝鮮を訪問した際、現職の米国大統領として初めて北朝鮮の土を踏んだ。
トランプ大統領のソーシャルメディアへの投稿での韓国に関する鋭い発言は、米国のイランとの敵対行為への直接的な軍事的または兵站的貢献を拒否する韓国への不満の可能性をほのめかしているようだった。
同氏はまた、日本、フランス、英国など他の同盟国が紛争への関与をためらっていることに不快感を表明した。
トランプ大統領が韓国との合同軍事演習を縮小する動きには前例がないわけではない。
同氏は金氏との非核化交渉中の2018年に演習を完全に中止した。
演習は新型コロナウイルス感染症（Covid-19）パンデミック下の2020年に再び縮小された。
先週、韓国大統領は、1953年に休戦協定が結ばれて以来、厳密には現在も続いている両国間の戦争を正式に終わらせるために、北の隣国との協議を提案した。
- 1 日前に公開`,
    source: "BBC",
    sourceUrl: "https://www.bbc.co.uk/news/articles/cx2lll7zvn0o?at_medium=RSS&at_campaign=rss",
    publishedAt: "2026-08-17T00:06:05+00:00",
    category: "貿易",
    imageUrl: "https://ichef.bbci.co.uk/ace/standard/240/cpsprodpb/8304/live/fde5dbb0-99c6-11f1-b604-2bfb19ba7385.jpg",
    readTime: 3,
  },
  {
    id: "how-switching-your-bank-account-could-ea-d8e975a4",
    title: "How switching your bank account could earn you up to £220",
    titleJa: "銀行口座を切り替えると最大 220 ポンド獲得できる仕組み",
    summaryJa: "銀行口座を切り替えると最大 220 ポンド獲得できる仕組み- 公開されました",
    bodyOriginal: `How switching your bank account could earn you up to £220
- Published
Many of us have been with the same bank for years, potentially missing out on hundreds of pounds that rivals are offering us to move to them.
...
- Published18 June 2018`,
    bodyJa: `銀行口座を切り替えると最大 220 ポンド獲得できる仕組み
- 公開されました
私たちの多くは何年も同じ銀行に勤めており、ライバルが私たちに移籍を勧めてくる数百ポンドを逃す可能性があります。
それが忠誠心であれ、怠惰であれ、あるいはそれが面倒なことになるのではないかという恐怖であれ、私たちの乗り換えを阻むものは何であれ、銀行は私たちの考えを変えようと競い合っている。
現在、5 行以上の銀行が切り替えのインセンティブを提供しており、最大額のボーナスは 220 ポンドです。
さらに、貯蓄がある場合は、より良い金利が得られるため、より大きな収益が得られます。
ハーグリーブス・ランズダウンの新たな調査によると、英国の貯蓄者のほぼ3分の2が10年以上銀行に勤務していることが示唆されている。
8月に英国の成人3,000人を対象に実施した調査では、34％が過去12カ月間に資金を移動したことが判明した。
同報告書は、金融行為監視機構のデータ分析に基づいて、英国の貯蓄者が現状維持を続けることで利息を逃し、毎年約120億ポンドの損害を被っていると試算している。
留まる代償
ハーグリーブス・ランズダウン社の最高顧客責任者であるサイモン・ベルシャム氏は、何もしないのは簡単かもしれないが、「多くの場合、収益が低い」と語る。
「何百万もの人々がデフォルトで同じ銀行に現金を預けており、その惰性は銀行にとっては巨額の価値がある一方、英国の貯蓄者は年間数十億ポンドの損失を被っている。
「貯蓄者が金利を気にしているのは明らかです。彼らがお金を移動するときの圧倒的な理由は、より良いリターンを確保することです。
「彼らを妨げているのは、さまざまな口座を繰り返し見つけ、開設し、やりくりするという労力です。」
銀行、電力会社、ブロードバンドプロバイダーを変更してお金を節約する方法
- 7 月 13 日発行
AJベルのパーソナル・ファイナンス責任者サラ・コールズ氏は、人々は自分の銀行に対して「信じられないほど忠誠心がある」ため、競合他社は甘味料を提供する必要があると語る。
「銀行にとっては価値がある。なぜなら、銀行は聴衆を虜にし、他の商品を取り上げてくれる可能性が高くなるからである。」
彼女は、ボーナスは「一番上のチェリー」であるべきであり、人々は銀行のサービスの評判、当座貸越手数料、銀行が提供する貯蓄率などの他の側面を見逃してはいけないと述べています。
知っておくべきこと
多くの取引は、最初の数週間にアカウントに入金される最低金額や口座から引き落とされる最低口座数などの条件に依存します。
銀行を変更すると信用報告書に記載されます。
これは、金融機関が住宅ローンで借りることができる金額を決定するときに考慮するものです。
立て続けに多くのアカウントを開設すると記録が傷つく可能性がありますが、古いアカウントを閉鎖するとスコアが上がる可能性があります。
「今後 12 か月以内にローンや住宅ローンを申請する予定がある場合は、契約が完了するまで待ったほうがよいでしょう」とコールズ氏は言います。
切り替えることに決めた場合は、無料の当座預金口座切り替えサービス (CASS) のおかげで、口座振替や請求書の支払いを個別に転送することを心配する必要はありません。英国の 50 を超える銀行および住宅金融組合が登録しています。
新しい銀行に選択した切り替え日 (7 営業日以内) と古い口座の詳細を伝えると、舞台裏で支払いが転送され、残高が移動され、福利厚生や給与などの入金がリダイレクトされます。古い銀行があなたの口座を閉鎖します。
何か問題が発生した場合は、古いアカウントまたは新しいアカウントに発生した利息と料金が返金されます。
定期購入などの定期的なカード支払いは手動で転送する必要があります。
移行後は古い銀行取引明細書などの情報にアクセスできなくなるため、移行前にダウンロードしておくとよいでしょう。
関連トピック
- 2018 年 6 月 18 日公開`,
    source: "BBC",
    sourceUrl: "https://www.bbc.co.uk/news/articles/c5y3ex8ry82o?at_medium=RSS&at_campaign=rss",
    publishedAt: "2026-08-16T23:14:47+00:00",
    category: "エネルギー",
    imageUrl: "https://ichef.bbci.co.uk/ace/standard/240/cpsprodpb/4a01/live/cc8b5e60-9628-11f1-adec-3f90c109009f.jpg",
    readTime: 4,
  },
  {
    id: "top-u-s-commander-acknowledges-mental-he-ecb8d45d",
    title: "Top U.S. commander acknowledges mental health issues on USS Lincoln",
    titleJa: "米国トップ司令官、USSリンカーンの精神的健康問題を認める",
    summaryJa: "米中央軍司令官ブラッド・クーパー海軍大将は日曜日、空母リンカーンが長期にわたる中東展開中に船員が船外に飛び降りたとの報告を受け、同艦内に精神的健康上の問題があることを認めた。「ここに重要な事実がある。リンカーンは現在、現役の空母11隻の中で、メンタルヘルス関連の感染者数が最も少ないものの一つだ」とクーパー氏は土曜日の同艦訪問後にXに投稿した声明の中で述べた。 「これは、すべてが完璧だという意味ではありません。現在アメリカにいる400万人近くの海軍退役軍人を見つければ、おそらく海上での長期間の勤務は誰にでも向いているわけではないと言うでしょう。」",
    bodyOriginal: `U.S. Central Command Commander Adm. Brad Cooper on Sunday acknowledged mental health challenges aboard the USS Lincoln after reports that a sailor jumped overboard amid the aircraft carrier's long Middle East deployment.
...
Cooper, the top U.S. commander in the war with Iran, said his visit to the ship was "awe-inspiring" and lauded the crew for "stepping up and making mental health and crew resilience a leadership priority."
...
"I demand hearings, accountability, and a clear plan to protect our service members and prioritize American families," she said.`,
    bodyJa: `米中央軍司令官ブラッド・クーパー海軍大将は日曜日、空母リンカーンが長期にわたる中東展開中に船員が船外に飛び降りたとの報告を受け、同艦内に精神的健康上の問題があることを認めた。
「ここに重要な事実がある。リンカーンは現在、現役の空母11隻の中で、メンタルヘルス関連の感染者数が最も少ないものの一つだ」とクーパー氏は土曜日の同艦訪問後にXに投稿した声明の中で述べた。 「これは、すべてが完璧だという意味ではありません。現在アメリカにいる400万人近くの海軍退役軍人を見つければ、おそらく海上での長期間の勤務は誰にでも向いているわけではないと言うでしょう。」
クーパー氏の訪問と声明は、8カ月以上配備されているリンカーン艦内で士気と精神衛生上の問題が蔓延しているとの報告を受けてのことだ。ネイビー・タイムズ紙は先週、数人の船員が船外へ出ようとしたと報じ、星条旗紙も広範な精神的健康問題について報じた。
イランとの戦争における米国の最高司令官であるクーパー氏は、同船への訪問は「畏敬の念を抱かせる」ものであったと述べ、乗組員が「精神衛生と乗組員の回復力をリーダーシップの優先事項として取り組みを強化している」と称賛した。
しかし、ドナルド・トランプ大統領とピート・ヘグセス国防長官は、リンカーン艦内の士気の低下に関する報道を軽視しようとしている。
金曜日、トランプ大統領は、リンカーンの配備が長すぎるのではないかと記者団に質問され、「いや、いや、いや」と答え、「十分な長さではない」と付け加えた。大統領はまた、この地域では間もなくリンカーンが別の航空会社に置き換えられるだろうとも述べた。
ヘグセス氏は、報道は「完全に誤って伝えられている」と述べた。
USSジョージ・ワシントンは現在中東に向かっており、リンカーンの代わりになると予想されているとMS Nowが報じた。
一方、議員らはリンカーン号の船内の状況について国防総省に疑問を呈し、批判してきた。
上院軍事委員会および情報委員会の委員を務めるカーステン・ギリブランド上院議員（民主党、ニューヨーク州）は土曜日の声明で、「正当性も戦略もなく、終わりの見えないまま始まった無謀な戦争に従事している軍人たちが耐えていると報告されている状況の悪化について責任を負わなければならない」と述べた。
「公聴会、説明責任、そして軍人を守り、アメリカ人の家族を優先するための明確な計画を要求します」と彼女は述べた。`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/08/16/top-us-commander-acknowledges-mental-health-issues-on-uss-lincoln.html",
    publishedAt: "2026-08-16T19:58:32+00:00",
    category: "テクノロジー",
    imageUrl: "https://images.unsplash.com/photo-1518770660439-4636190af475?w=800&q=80",
    readTime: 3,
  },
  {
    id: "trump-envoy-kushner-meets-hamas-leader-t-0af7cc59",
    title: "Trump envoy Kushner meets Hamas leader to push Gaza peace plan",
    titleJa: "トランプ特使クシュナー氏、ガザ和平計画推進のためハマス指導者と会談",
    summaryJa: "トランプ特使クシュナー氏、ガザ和平計画推進のためハマス指導者と会談- 公開されました",
    bodyOriginal: `Trump envoy Kushner meets Hamas leader to push Gaza peace plan
- Published
...
- Published17 January
- Published20 July`,
    bodyJa: `トランプ特使クシュナー氏、ガザ和平計画推進のためハマス指導者と会談
- 公開されました
ドナルド・トランプ米大統領の中東特使ジャレッド・クシュナーは、米国が支援するガザ和平計画の実施について話し合うためハマスと異例の会談を行った。
パレスチナ当局者はＢＢＣに対し、トランプ大統領の娘婿が日曜、エジプトでハマスの新指導者ハリル・アルハヤ率いる代表団と面会したと語った。
トランプ大統領の平和委員会は先月、ガザ地区のハマスや他の武装勢力の「完全な武装解除」で合意に達したと発表した。先週、イスラエルはトランプ大統領の15項目の計画を拒否したが、この計画にはイスラエル軍の撤退とパレスチナの新たな文民政権によるガザの再建も求められている。
イスラム教８カ国は日曜日、イスラエルの拒否を非難する声明を発表した。
トランプ氏は平和委員会を率いている。この委員会は当初ガザに平和をもたらすことを目的とした国際組織として設立されたが、後に世界中の紛争を対象に拡大された。
クシュナー氏とハヤ氏の会談は、昨年のガザ地区の停戦合意以来、このレベルでの会談は初めてと言われている。
報道によると、和平努力を仲介したエジプト、カタール、トルコの代表とともに、平和委員会のニコライ・ムラデノフ特使と英国のトニー・ブレア元首相も会議に参加した。
伝えられるところによると、ハマスの兵器の廃棄に向けた具体的な行動や、イスラエル軍の撤退や人道的取り組みに焦点を当てているとされるこの会談については、公式声明は発表されていない。
エジプト滞在中、クシュナー氏はエジプトのアブドルファッタハ・アル・シシ大統領とも会談した。イスラエルメディアの報道によると、クシュナー氏、ムラデノフ氏、ブレア氏はトランプ大統領の計画推進を目指し、月曜日にネタニヤフ首相と会談する予定。
イスラエル首相は、合意履行のためにはまずハマスの完全武装解除を望むと述べた。
「イスラエルはガザに関する平和委員会の15項目の文書を拒否する。ハマスが真に武装解除されるまでイスラエル国防軍はいかなる撤退も実行しない」とネタニヤフ首相は先週、イスラエルの最も緊密な同盟国に反抗して述べた。
日曜の共同声明では、エジプト、ＵＡＥ、カタール、サウジアラビア、ヨルダン、トルコ、パキスタン、インドネシアは、イスラエルによる米国の計画の拒否がトランプ大統領の和平への努力を脅かすと述べた。
昨年10月10日に発効した停戦は今も維持されている。
しかし、イスラエル国防軍はそれ以来、ガザ地区で数回の攻撃を実施しており、今回はガザ地区のハーンユニス地区とヌセイラット地区の「テロリスト」に対する攻撃で、ハマスが停戦を破ったと非難している。
この戦争は2023年10月7日のハマス主導のイスラエル南部攻撃によって引き起こされ、約1,200人が死亡、他251人が人質となった。
イスラエルはガザ攻撃に対抗し、ガザ地区で軍事行動を開始し、同地域の保健省によると、その間に7万3000人以上が死亡し、その数字は国連によって信頼できると考えられている。
国連は、戦争が始まって以来、ガザ人口の90％に当たる約190万人が避難を強いられたと推定している。
- 1 月 17 日公開
- 7 月 20 日発行`,
    source: "BBC",
    sourceUrl: "https://www.bbc.co.uk/news/articles/c77gg5vn44yo?at_medium=RSS&at_campaign=rss",
    publishedAt: "2026-08-16T19:58:14+00:00",
    category: "貿易",
    imageUrl: "https://ichef.bbci.co.uk/ace/standard/240/cpsprodpb/6b3a/live/65ee2c30-99a4-11f1-a10a-71ff76b28954.jpg",
    readTime: 3,
  },
  {
    id: "russia-says-at-least-seven-killed-in-lar-bd488c85",
    title: "Russia says at least seven killed in largest Ukrainian attack of 2026",
    titleJa: "ロシア、2026年最大規模のウクライナ攻撃で少なくとも7人死亡と発表",
    summaryJa: "Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.長い前線に沿った消耗戦の地上戦でどちらの側もわずかな勝利を収めたため、戦争は主に航空戦となり、各国の戦闘能力を低下させることを目的としたミサイルや無人機の交換が行われた。",
    bodyOriginal: `Russia says at least seven killed in largest Ukrainian attack of 2026
- Published
...
Ukraine's defence ministry said the latest attack meant that seven out of 10 of the largest Wildberries logistics centres had been "disabled".
...
But the US has used many of its stockpiles during its war with Iran and is reluctant to give up more.
After initially offering Ukraine the licence to make Patriots in early July, President Donald Trump later denied the US had agreed to "give away that kind of technology".
Throughout the war, as well as relying on Western partners, Ukraine has had to innovate - its home-made drones are responsible for the attacks deep into Russian territory.
And it will be able to strike Russia with domestically-made ballistic missiles within three to six months, the former Ukrainian Defence Minister Mykhailo Fedorov told CBS News, the BBC's US partner.
Russia launched its full-scale invasion of Ukraine in February 2022, and currently controls approximately a fifth of Ukrainian territory.
...
- Published2 days ago`,
    bodyJa: `Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.
長い前線に沿った消耗戦の地上戦でどちらの側もわずかな勝利を収めたため、戦争は主に航空戦となり、各国の戦闘能力を低下させることを目的としたミサイルや無人機の交換が行われた。
関連トピック
- 3 日前に公開
- 5 日前に公開
- 2 日前に公開`,
    ...
    publishedAt: "2026-08-16T19:03:04+00:00",
    category: "テクノロジー",
