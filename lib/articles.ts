...
"If we get a bounce in the Treasury market soon (and thus a drop in yields)…and even if it can last through the mid-term election…it's not something that can be softened over the longer-term…without some serious changes on the fiscal front," he said.`,
  ...
  {
    id: "volcano-eruption-disrupts-hundreds-of-fl-6449bb8e",
    title: "Volcano eruption disrupts hundreds of flights at Southeast Asia's second-busiest airport",
    titleJa: "火山噴火により、東南アジアで2番目に利用客の多い空港で数百便が運航に混乱",
    summaryJa: "インドネシアのアナク・クラカタウ山の噴火による降灰は、週末にかけてこの地域周辺の航空便に大混乱をもたらした。火山の噴火により、東南アジアで2番目に利用客の多いジャカルタの主要国際空港で数百便のフライトが混乱し、欠航は月曜まで続いた。",
    bodyOriginal: `Ash from the eruption of Indonesia's Mount Anak Krakatau wreaked havoc for aviation around the region over the weekend.
...
The volcano began a period of continuous eruption at 11:07 p.m. local time on Friday, according to a CNBC translation of a press release from Indonesia's Ministry of Energy and Mineral Resources. The continuous eruption lasted about 25 hours before ending at 12:04 a.m. on Sunday.
Volcanic ash forced authorities to temporarily suspend operations at Soekarno-Hatta International Airport, Jakarta's main airport, with the closure extended several times on Sunday, according to a translation from Indonesia's Directorate General of Civil Aviation.
At least 373 flights were affected as of 10:35 a.m. Sunday. At Soekarno-Hatta alone, 202 flights were affected, including 167 cancellations.
Soekarno-Hatta is Southeast Asia's second-busiest airport by scheduled airline seat capacity this month, with 3.24 million seats, according to aviation data provider OAG.
Flight disruptions extended into Monday, with Singapore Airlines canceling flights between Singapore and Jakarta due to the volcanic activity, including nine on that route scheduled for Monday. Its budget carrier Scoot also canceled flights between Singapore and Jakarta scheduled for Monday, according to a separate travel advisory.
Indonesia's meteorological agency said volcanic ash was detected at altitudes of up to 20,000 feet moving east and up to 50,000 feet moving west, according to a CNBC translation. Volcanic ash was detected over Jakarta and several surrounding regions, extending as far as the Indian Ocean.
Indonesia's Ministry of Energy and Mineral Resources said the continuous eruption had ended but volcanic activity remained elevated. The ministry said the potential for further eruptions in the coming period remained high, with possible hazards including incandescent rock, heavy ashfall and potential lava flows if continuous eruptions resume.
Anak Krakatau remains at Level III, or "Alert," and authorities have maintained a 3-kilometer exclusion zone around the volcano.`,
    bodyJa: `インドネシアのアナク・クラカタウ山の噴火による降灰は、週末にかけてこの地域周辺の航空便に大混乱をもたらした。
火山の噴火により、東南アジアで2番目に利用客の多いジャカルタの主要国際空港で数百便のフライトが混乱し、欠航は月曜まで続いた。
火山は午後11時7分に継続的な噴火を開始した。 CNBCがインドネシア・エネルギー・鉱物資源省のプレスリリースを翻訳したところによると、現地時間金曜日。継続的な噴火は日曜日午前０時４分に終わるまで約２５時間続いた。
インドネシア民間航空総局の翻訳によると、火山灰により当局はジャカルタの主要空港であるスカルノハッタ国際空港の運営を一時停止し、日曜日には閉鎖が数回延長されたという。
日曜日午前10時35分の時点で、少なくとも373便に影響があった。スカルノハッタ空港だけでも、キャンセル167便を含む202便が影響を受けた。
航空データ提供会社ＯＡＧによると、スカルノハッタ空港は今月の定期航空座席数で東南アジアで２番目に利用客の多い空港で、座席数は３２４万席となっている。
航空便の乱れは月曜まで続き、シンガポール航空は火山活動のため、月曜に予定されていた同路線の9便を含め、シンガポールとジャカルタ間の便をキャンセルした。別の渡航勧告によると、同社の格安航空会社スクートも月曜日に予定されていたシンガポールとジャカルタ間の便をキャンセルした。
CNBCの翻訳によると、インドネシアの気象機関は、東に移動すると最大2万フィート、西に移動すると最大5万フィートの高度で火山灰が検出されたと述べた。ジャカルタとその周辺のいくつかの地域で火山灰が検出され、その範囲はインド洋にまで及んでいた。
インドネシアのエネルギー・鉱物資源省は、継続的な噴火は終了したが、火山活動は依然として活発であると発表した。同省は、今後もさらなる噴火が起こる可能性は依然として高く、継続的な噴火が再開した場合、白熱岩、大量の降灰、潜在的な溶岩流などの危険が生じる可能性があると述べた。
アナク・クラカタウ山は依然としてレベルIII、つまり「警戒」にあり、当局は火山の周囲3キロメートルの立ち入り禁止区域を維持している。`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/09/07/flights-canceled-jakarta-airport-anak-krakatau-eruption-disrupts-regional-travel-volcano.html",
    publishedAt: "2026-09-07T01:31:03+00:00",
    category: "エネルギー",
    imageUrl: "https://images.unsplash.com/photo-1473172367879-2dca04a4dca4?w=800&q=80",
    readTime: 2,
  },
  {
    id: "five-dead-after-amazon-cargo-plane-crash-27ef146c",
    title: "Five dead after Amazon cargo plane crashes at Miami airport",
    titleJa: "Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.",
    summaryJa: "Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.",
    bodyOriginal: `Five dead after Amazon cargo plane crashes at Miami airport
- Published
...
About 60% of all international visitors to Florida arrive at this airport, it says.`,
    ...
    publishedAt: "2026-09-07T00:57:38+00:00",
    category: "テクノロジー",
    imageUrl: "https://ichef.bbci.co.uk/ace/standard/240/cpsprodpb/d8f2/live/4a70f2d0-aa39-11f1-9023-2129273d2865.jpg",
    readTime: 2,
  },
  {
    id: "data-centers-in-space-four-big-obstacles-6e19be97",
    title: "Data centers in space: Four big obstacles and Elon Musk's ambitious timeline",
    titleJa: "宇宙のデータセンター: 4 つの大きな障害とイーロン・マスクの野心的なスケジュール",
    summaryJa: "軌道データセンターは大規模な AI の構築に役立つでしょうが、実際に実用化される前に、多くの大きな進歩が必要です。SpaceXのCEO、イーロン・マスク氏は2027年後半の打ち上げを目指しているが、他の業界関係者らは、大規模な打ち上げは2030年代になる可能性が高いと述べている。",
    bodyOriginal: `Orbital data centers would be a help to the massive AI buildout, but a number of major advancements need to come before they're really practical.
...
Jha also said orbital data centers could take another five to seven years to reach hyperscale, a level that would likely require nuclear power.`,
    bodyJa: `軌道データセンターは大規模な AI の構築に役立つでしょうが、実際に実用化される前に、多くの大きな進歩が必要です。
SpaceXのCEO、イーロン・マスク氏は2027年後半の打ち上げを目指しているが、他の業界関係者らは、大規模な打ち上げは2030年代になる可能性が高いと述べている。
ニューバーガーのポートフォリオマネージャー、エブリン・チョウ氏は、「これは次の10年の出来事だ」と語る。同氏は水曜日、「Squawk Box Asia」で「軌道上のデータセンターの真の規模を検討し始める前に、今後4～5年間で大規模な衛星の打ち上げと、それに伴う接続の強化を確認する必要がある」と語った。
オービタル・ゲートウェイ・コンサルティングの創設者ブレイン・クルシオ氏は、2030年代のタイムラインは「公正な評価」だとしながらも、スペースXは以前にも投資家が間違っていることを証明していると警告している。 「2010年代後半に衛星業界の専門家に、スペースXが2025年までに1万基の衛星を打ち上げられるかどうか尋ねていたら、私を含め、どの衛星も『チャンスはない』と答えていただろう」と同氏は語った。
克服する必要がある問題のいくつかを次に示します。
冷却
「冷却は大きな問題です」とチョウ氏は言う。地上データセンターは熱を管理するために液体冷却に依存できますが、真空の宇宙では冷却の仕組みが大きく異なります。 「放射線に対する耐性も必要です。」
すぐに時代遅れになる
クルシオ氏は、技術進歩の速度に関連したハードルがあると考えています。
同氏は、「GPUは急速に進化しているため、莫大なコストをかけて最先端のデータセンターを宇宙に打ち上げると、数年後には時代遅れになる可能性がある」と述べた。
大容量データ転送
レーザーベースの通信を専門とする企業である Transcelestial は、大量のデータを地球に持ち帰るという重要な課題の解決に取り組んでいます。
「誰でもデータセンターを構築できますが、これらのAIシステムと通信できなければ、それらのデータセンターは役に立ちません」とCEO兼共同創設者のRohit Jha氏は述べた。
ハイパースケールの強化
ジャ氏はまた、軌道データセンターがハイパースケールに達するにはさらに5～7年かかる可能性があり、そのレベルにはおそらく原子力が必要になるだろうと述べた。`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/09/07/data-centers-space-elon-musk-obstacles.html",
    publishedAt: "2026-09-07T00:06:18+00:00",
    category: "金融政策",
    imageUrl: "https://images.unsplash.com/photo-1611974789855-9c2a0a7236a3?w=800&q=80",
    readTime: 3,
  },
  {
    id: "chancellor-to-say-uk-economy-turning-a-c-fa945318",
    title: "Chancellor to say UK economy 'turning a corner' despite debt concerns",
    titleJa: "Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.",
    summaryJa: "Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.",
    bodyOriginal: `Chancellor to say UK economy 'turning a corner' despite debt concerns
- Published
...
- Published5 days ago`,
    ...
    publishedAt: "2026-09-06T23:34:18+00:00",
    category: "金融政策",
    imageUrl: "https://ichef.bbci.co.uk/ace/standard/240/cpsprodpb/a295/live/6f3c1770-aa2f-11f1-bdbb-8bb5df16290b.jpg",
    readTime: 2,
  },
  {
    id: "the-70-refund-letter-that-isn-t-a-scam-83527619",
    title: "The £70 refund letter that isn't a scam",
    titleJa: "Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.",
    summaryJa: "Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.",
    bodyOriginal: `The £70 refund letter that isn't a scam
- Published
...
HMRC says it will run an awareness campaign using social media and other channels.`,
    ...
    publishedAt: "2026-09-06T23:16:05+00:00",
    category: "金融政策",
    imageUrl: "https://ichef.bbci.co.uk/ace/standard/240/cpsprodpb/2ff9/live/508ded00-a78a-11f1-9bb7-af8e8fd3d806.jpg",
    readTime: 2,
  },
  {
...
WATCH: Dartmouth's Paul Argenti says, 'I fear the real interest here is political'`,
  ...
  },
  {
    ...
    titleJa: "Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.",
    summaryJa: "Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.",
    bodyOriginal: `Sugar is getting a lot less sweet for buyers.
...
Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/09/06/sugar-is-outperforming-the-stock-market-this-year-whats-driving-it.html",
...
- Published30 December 2025`,
  ...
  {
    id: "aviation-faces-hotter-stormier-skies-and-8a97ce9a",
...
Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.`,
    ...
    publishedAt: "2026-09-05T23:20:00+00:00",
    category: "エネルギー",
...
Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.`,
  ...
  },
  {
    ...
    titleJa: "Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.",
    summaryJa: "スーパースターアスリートのレブロン・ジェームズは土曜日のソーシャルメディア投稿で、予測市場プラットフォームPolymarketとの今後の提携をからかった。ジェームズは、ポリマーケットの広告と思われる14秒の動画をソーシャルメディアプラットフォームXに投稿した。 「Polymarket 本社へようこそ。近日公開予定です。@Polymarket と提携しています」と James 氏は書いています。",
    bodyOriginal: `Superstar athlete LeBron James teased an upcoming partnership with prediction market platform Polymarket in a social media post on Saturday.
...
James, who is the NBA's all-time scorer, announced in July he would join the Philadelphia 76ers for his record-extending 24th season — and final chapter of his career. While James didn't disclose terms of the deal, ESPN previously reported he signed a two-year, $8 million contract with a player option — a significant pay cut from the more than $50 million he made with the Los Angeles Lakers last season.
...
The company recently hired Travis VanderZanden — formerly of Uber Technologies and Lyft, and the founder of E-Scooter startup Bird — as its chief growth officer. He is expected to oversee Polymarket's marketing, CNBC reported.
Disclosure: CNBC and Kalshi have a commercial relationship that includes customer acquisition and a minority investment.
WATCH: Josh Harris on signing LeBron James and rebuilding the Commanders`,
    bodyJa: `スーパースターアスリートのレブロン・ジェームズは土曜日のソーシャルメディア投稿で、予測市場プラットフォームPolymarketとの今後の提携をからかった。
ジェームズは、ポリマーケットの広告と思われる14秒の動画をソーシャルメディアプラットフォームXに投稿した。 「Polymarket 本社へようこそ。近日公開予定です。@Polymarket と提携しています」と James 氏は書いています。
ビデオでは、バスケットボール界のレジェンドがポリマーケット本社のエレベーターに現れ、同社のスポーツフロアへ向かう。
公に話す権限がなかったため匿名を条件にCNBCに取材した関係者によると、この投稿はジェームズとポリマーケットの間でフットボールに焦点を当てた大規模なキャンペーンをからかっているという。さらなる詳細は来週中に発表される予定だ、と同関係者は付け加えた。
ジェームズとポリマーケットとの契約条件は明らかにされていない。 NBAの規則は、所有権の制限を含め、リーグ関連の賭博や同様の商品を提供する企業に対するプレーヤーの金銭的利益を制限している。
ジェイムズとポリマーケットの代表者は、ジェイムズの土曜日の投稿以外のコメントは控えた。
NBAの歴代得点王であるジェームズは7月、記録を伸ばす24シーズン目、そしてキャリアの最終章に向けてフィラデルフィア・セブンティシクサーズに加入すると発表した。ジェームズは契約条件を明らかにしていないが、ESPNは以前、ジェームズがプレーヤーオプション付きの2年800万ドル契約を結んだと報じていたが、昨シーズンにロサンゼルス・レイカーズで稼いだ5,000万ドル以上からは大幅な減俸となっている。
2026-2027年のNBAシーズンは10月中旬に開幕する予定だ。
4度のNBAチャンピオンは、PolymarketやKalshiなどの予測市場プラットフォームと提携するスターアスリートやスポーツリーグの増え続けるリストに加わることになる。予測市場を使用すると、ユーザーはスポーツの結果を含む将来のイベントが発生するかどうかに関連付けられた契約を取引できます。
今年初め、マイアミ・ヒートのスター選手、ヤニス・アデトクンボがカルシの株主となり、マーケティングやライブイベントに参加することに同意した。カルシ氏は、自身の株式はパッシブであり、その規則によりNBA関連市場での取引は禁止されていると述べた。アスリート、チーム、リーグもカルシと契約を結んでいる。
一方、ポリマーケットは、メジャーリーグサッカー、メジャーリーグベースボール、ナショナルホッケーリーグなどのトップリーグのほか、MLBのニューヨークヤンキースやNHLのニューヨークレンジャーズのようなプロチームと提携を結んでいる。
ポリマーケットは秋の多忙なスポーツカレンダーに先立ち、新たなリーダーシップの下でマーケティング業務を再構築しているとCNBCが以前報じた。
同社は最近、元Uber TechnologiesとLyftでE-ScooterスタートアップBirdの創設者であるTravis VanderZandenを最高成長責任者として採用した。 CNBCの報道によると、同氏はポリマーケットのマーケティングを監督する予定だという。
開示: CNBC とカルシには、顧客の獲得と少数出資を含む商業関係があります。
注目：ジョシュ・ハリスがレブロン・ジェームズとの契約とコマンダーズの再建について語る`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/09/05/lebron-james-polymarket-partnership.html",
    publishedAt: "2026-09-05T19:40:11+00:00",
    category: "貿易",
    imageUrl: "https://images.unsplash.com/photo-1526304640581-d334cdbbf45e?w=800&q=80",
    readTime: 4,
  },
  {
    id: "trump-turns-up-the-heat-on-warsh-as-fed-80f64858",
    title: "Trump turns up the heat on Warsh as Fed rate hike looms",
    titleJa: "FRBの利上げが迫る中、トランプ氏はウォーシュ氏への批判を強める",
    summaryJa: "Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.政権は成長とインフレの関係を否定することで、生産能力を超えて経済が成長するとインフレを引き起こすリスクがあるという経済学の中心的な概念に挑戦している。これらの考え方の中で最も有名なフィリップス曲線は、労働市場の逼迫と賃金の上昇がインフレの主要な導管であると考えています。金曜の好調な雇用統計を受けて市場がFRB利上げの確率を高めたのはこのためだろう。しかし、賃金は報告書にしっかりと含まれており、8月の平均時給は0.3％、前年比で3.1％上昇したが、失業率は4.1％にとどまった。",
    bodyOriginal: `Ten days ahead of a meeting in which the Federal Reserve will likely consider raising interest rates, the Trump administration looks to be in a full-court press to halt the hike in its tracks.
...
Markets will be focused on the Friday CPI report, which Fed officials have said will be a critical gauge of whether inflation is easing or still accelerating — and it could decide whether the Fed hikes or holds. No FOMC member has recently discussed rate cuts publicly.`,
    bodyJa: `Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.
政権は成長とインフレの関係を否定することで、生産能力を超えて経済が成長するとインフレを引き起こすリスクがあるという経済学の中心的な概念に挑戦している。これらの考え方の中で最も有名なフィリップス曲線は、労働市場の逼迫と賃金の上昇がインフレの主要な導管であると考えています。金曜の好調な雇用統計を受けて市場がFRB利上げの確率を高めたのはこのためだろう。しかし、賃金は報告書にしっかりと含まれており、8月の平均時給は0.3％、前年比で3.1％上昇したが、失業率は4.1％にとどまった。
経済の供給側を拡大することで生産能力が高まり、インフレ圧力が相殺されるという政権の主張は正確かもしれないが、タイミングの問題がある。人工知能への投資が殺到し、最終的には生産性が向上すると予測されています。しかし、現在のデータによると、AI インフラストラクチャの構築に必要な機器の需要が価格を上昇させています。
市場の注目は金曜の消費者物価指数（CPI）報告に集中するが、FRB関係者らはこの報告書がインフレが緩和しているのか、それとも依然として加速しているのかを判断する重要な指標となり、FRBが利上げするか据え置くかを決定する可能性があると述べている。最近、利下げについて公に議論したFOMCメンバーはいない。`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/09/05/trump-warsh-fed-september-rate-hike.html",
    publishedAt: "2026-09-05T19:12:53+00:00",
    category: "エネルギー",
    imageUrl: "https://images.unsplash.com/photo-1473172367879-2dca04a4dca4?w=800&q=80",
    readTime: 2,
  },
  {
    id: "think-you-maxed-out-your-401-k-the-real-8bfb80f4",
    title: "Think you maxed out your 401(k)? The real limit is actually almost $50,000 higher.",
    titleJa: "401(k) を最大限に使い果たしたと思いますか?実際の制限額は実際には 50,000 ドル近く高くなります。",
    summaryJa: "ほとんどの人が無視しているこの文書を読むことで、より大きな退職後の資産を手に入れることができます。",
    bodyOriginal: `You can unlock greater retirement wealth by reading this document that nearly everyone ignores.`,
    bodyJa: `ほとんどの人が無視しているこの文書を読むことで、より大きな退職後の資産を手に入れることができます。`,
    source: "MarketWatch",
    sourceUrl: "https://www.marketwatch.com/story/think-you-maxed-out-your-401-k-the-real-limit-is-actually-almost-50-000-higher-217a89ee?mod=mw_rss_topstories",
    publishedAt: "2026-09-05T18:59:00+00:00",
    category: "金融政策",
    imageUrl: "https://images.mktw.net/im-30294956",
    readTime: 2,
  },
  {
    ...
    publishedAt: "2026-09-05T18:42:00+00:00",
    category: "金融政策",
    imageUrl: "https://images.mktw.net/im-54831986",
    readTime: 2,
  },
  {
    id: "why-the-jobs-report-will-actually-be-goo-d94841e2",
    title: "Why the jobs report will actually be good for bonds",
    titleJa: "雇用統計が債券にとって実際に良い影響を与える理由",
    summaryJa: "ウォール街のおしゃべりからすると、労働環境がこれほど好調だったことはかつてなかったと思うだろう。働くアメリカ人にとって悲しいことに、これは実際には当てはまりません。",
    bodyOriginal: `Based on the chatter on Wall Street, you’d think labor has never had it so good. Sadly for working Americans, this isn’t actually the case.`,
    bodyJa: `ウォール街のおしゃべりからすると、労働環境がこれほど好調だったことはかつてなかったと思うだろう。働くアメリカ人にとって悲しいことに、これは実際には当てはまりません。`,
    source: "MarketWatch",
    sourceUrl: "https://www.marketwatch.com/story/why-the-jobs-report-will-actually-be-good-for-bonds-eb062fda?mod=mw_rss_topstories",
    publishedAt: "2026-09-05T18:26:00+00:00",
    category: "マクロ経済",
...
「大規模なエコシステムが存在しており、それらのコンポーネントにはすべてトラック輸送の需要がある」とロバーツ氏は語った。 「これは非常に良い影響だ」とロバーツ氏は語った。`,
  ...
  {
    id: "this-enhanced-geothermal-project-aims-to-a8d3015b",
    title: "This enhanced geothermal project aims to unlock gigawatts of power to fuel the data center boom",
    titleJa: "Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.",
    summaryJa: "米国の電力需要は増加しています。 Fervo Energy は、ユタ州でのプロジェクトが、強化された地熱が将来の電力構成の一部になり得ることを証明することに賭けています。",
...
"We have project sites throughout the entire Western United States. We now have the capital to pursue it, and we want to repeat these GeoBlocks all over the West and then all over the world until we realize a more reliable, affordable, and sustainable electric grid," Latimer said.`,
    bodyJa: `Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.
ラティマー氏は、ファーボ社の当初からの使命は科学と技術の最先端を推進することであったと述べた。彼の見解によれば、後者は伝統的な地熱産業において後れを取っている。掘削時間が長くなるとコストが高くなるため、同社は操業を最適化するために常にデータを収集しています。リグの頂上にある掘削機のキャビンでは、地下センサーから送り返されたリアルタイムの測定値がスクリーンに表示されます。これらのデータは、ヒューストンにある本社から同時に監視されています。現場の地質学者は、最適な掘削条件を最大化することを目的として、地面から出てくる花崗岩の変化する特性を分析します。
コスト削減
ファーボはより多くの油井を掘削することでコストを削減した。しかし、地熱発電は、ドナルド・トランプ大統領の「One Big Beautiful Bill Act」の下で地熱発電のために温存されていた連邦税額控除を考慮しても、依然として他の電力源よりも高価である。
ネバダ州のパイロット施設での同社の最初の井戸は、測定深さ 11,220 フィートまで掘削するのに 70 日かかりました。ケープ基地フェーズ I では、平均は 21 日、測定深さ 14,483 フィートに低下し、kW あたり約 7,000 ドルのコストがかかりました。現在、ケープステーションのフェーズ II は 1 kW あたり 5,500 ドルが目標であり、これまでで最も深い井戸は 19,448 フィートです。その過程で気温が上昇し、パイプが大型化し、その両方により各井戸で生成される電力が増加しました。
それでも、地熱発電が他の発電形態と競争できるようにするには、コストをさらに下げる必要がある。ラティマー氏によると、長期的には同社は1kW当たり3000ドルで生産できるという。 「一貫して掘削できるため…長年にわたって地熱を悩ませてきた不確実性と探査リスクの多くを取り除くことができました」と彼は述べた。 「[当社は]、他の業界で劇的なコスト削減をもたらしたような学習曲線に地熱を導入しました。そのモジュール性と標準化を通じて、事業の掘削側と発電所側の両方で劇的なコスト削減が期待されています。」
ファーボの費用は地下掘削と井戸に隣接する発電所で分担されており、費用も下がっている。最初の発電所 (33 MW) 用の部品は個別に納品されました。第 2 段階のプラントでは部品と設計が標準化され、出力は 50 MW で、建設時間の 30% 以上の短縮に向けて順調に進んでいます。
Fervo の長期的な目標は、データセンターのメーターの裏側を含め、あらゆる場所にこれらのプラントを設置できるようにすることです。メーターのビハインドとは、顧客の敷地内にエネルギー生産および貯蔵システムを設置することを指します。 「私たちは、より迅速な配送を望む顧客だけでなく、適切な場所で送電および送電網接続プロジェクトを追求するモデルを開発中です。そこではビハインド・ザ・メーターが大きなチャンスです」とラティマー氏は語った。
持続可能な送電網に向けた取り組み
Googleとの合意により、Fervo社の総契約電力量は約1GWとなり、ラティマー氏は同社が複数の潜在的な買い手と商業交渉を進めていると述べた。南カリフォルニア・エジソン、シェル・エナジー、NVエナジーも同社の電力を購入する予定だ。
同社は電力購入契約の条件を明らかにしていないが、ハイパースケーラーは気候変動対策の目標もあり、市場価格を上回る電力料金を喜んで支払うことにしている。 Fervo はまた、その迅速なタイムラインが他の発電源とは一線を画すものであると述べた。同社は石油・ガス業界によって確立された既存のサプライチェーンに依存しているが、同社の発電所で使用している有機ランキンサイクルタービンは、GEベルノバなどの企業が今後何年にもわたって完売しているとしているガスタービン市場で見られるような受注残に直面していない。
ファーボは5月に待望のIPOで上場し、応募超過の募集で20億ドル近くを調達した。株価は5月15日に過去最高値を記録したが、その後株価は約57％下落している。
ファーボは、IPOで得た資金を事業拡大に活用する計画だと述べた。
「私たちは米国西部全域にプロジェクトの現場を持っています。現在、私たちはそれを推進するための資本を持っています。そして、より信頼性があり、手頃な価格で持続可能な電力網を実現するまで、これらのジオブロックを西部全域、さらには世界中で繰り返したいと考えています」とラティマー氏は述べた。`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/09/05/fervo-energys-enhanced-geothermal-project-aims-to-power-data-center-boom.html",
    publishedAt: "2026-09-05T12:20:42+00:00",
    category: "エネルギー",
    imageUrl: "https://images.unsplash.com/photo-1473172367879-2dca04a4dca4?w=800&q=80",
    readTime: 5,
  },
...
Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.`,
  ...
  },
  {
    ...
    summaryJa: "デトロイト — ゼネラルモーターズとフォードモーターは、レース、自動車販売、その他多くの自動車関連活動において、1世紀以上にわたって互いにライバル関係にある。しかし、彼らの最近の戦場は実際の戦場と米国のエネルギー網に移った。",
    bodyOriginal: `DETROIT — General Motors and Ford Motor have rivaled each other for more than a century in racing, vehicle sales and many other automobile-related activities.
...
"We already dominate in that market in the commercial world. We want to offer the U.S. government the same advantages that our commercial customers get," Farley told investors in July. "It's a great opportunity for us. … We are discussing, continue to discuss, additional defense-related projects with the U.S. government."`,
    bodyJa: `デトロイト — ゼネラルモーターズとフォードモーターは、レース、自動車販売、その他多くの自動車関連活動において、1世紀以上にわたって互いにライバル関係にある。
しかし、彼らの最近の戦場は実際の戦場と米国のエネルギー網に移った。
トランプ政権が米企業に大量生産の専門知識で軍を支援するよう打診したことを受け、フォードは今年ＧＭに加わり米軍との契約を求めた。自動車メーカーのこれまでの取り組みは主に軍用車両に焦点を当てているが、時間の経過とともに拡大する可能性がある。
同時に、両社は、消費者のエネルギーコストとデータセンターの上昇に関連したニーズの増大が予想される中、エネルギー貯蔵システム（ESS）市場に参入している。エネルギー貯蔵システムは、家庭、企業、さらには公共事業用の電力を貯蔵するために、電気自動車のバッテリーと同じ基盤技術を多く使用しています。
ウォール街のアナリストは、両市場を自動車メーカーにとって新たな潜在成長分野とみている。一時は完全電気自動車から新たなチャンスが生まれるのではないかと考えられていたが、フォードとGMはその後、こうした取り組みで数十億ドルの損失を被った。
「彼らは新たな分野を探している」とモーニングスターのシニア株式アナリスト、デービッド・ウィストン氏はCNBCに語った。 「フォードはGMの後を追って防衛分野に参入しており、エネルギーは非常に理にかなっています。なぜなら、今は必要のないEVの生産能力をすべて持っているからです。ですから、それらの工場を売却する代わりに、データセンターのブームに乗じようとする方法なのです。」
両市場は当面、両社の注力と収益に占める割合は小さいとみられるが、米国で新車販売が低迷する中、自動車メーカーが事業を多角化し、中核事業を補完するのに役立つ可能性がある。
「自動車事業の収益を考えると、ここで大きく舵を切るのは難しいだろうが、確かに役に立つかもしれない」とホイストン氏は語った。
エネルギー貯蔵
調査・コンサルティング会社グローバル・マーケット・インサイツによると、世界のESS市場は2024年の6,687億ドルから2034年までに5兆1,200億ドルに成長すると推定されている。その一環として、同社は米国での大幅な拡大を期待している。
LGエネルギーソリューションの米国エネルギー貯蔵部門の営業・マーケティング担当副社長デボン・ウィルソン氏は、最近のイベントで「この大きな成長予測を我々は見ており、すでに成長が始まっている」と語った。 「国内には基礎的な電力だけでも膨大な量の電力が必要です。」
GMとフォードは、こうした期待される成長を利用して穴を埋めようとしている。両社は、実現しなかったEV需要に応えるため、バッテリーセルを生産する工場に数十億ドルを投資した。
GMのエネルギー事業は現在、自社のESSを提供していないが、軍事部門は提供しており、テネシー州にある合弁会社ウルティアム・セルズはパートナーであるLGエネルギー・ソリューション向けに貯蔵用のセルを生産している。
長期的には、GMはデンバーに本拠を置く新興企業ピーク・エナジーとの次世代ナトリウムイオン電池の開発など、ESSへの参入をさらに進める可能性がある。 GMのバッテリーおよび持続可能性担当副社長、カート・ケルティ氏は、テクノロジーによってグリッド規模のエネルギー貯蔵を再構築できると信じていると述べた。
「私たちは現在セルを開発中です。これらのセルの性能は驚異的です」とケルティ氏は語った。 「ESS市場は非常に魅力的な市場です。大きな市場です。非常に急速に成長しており、私たちが貢献できるものです。」
GMはまた、同社の大型EVバッテリーをエネルギー貯蔵システムに再利用するためにレッドウッド・マテリアルズと提携している。 GMは、エネルギーユニットを通じて住宅用のEV充電とESSも提供している。
一方、フォードは12月、パートナーのSKオンと最近建設したケンタッキー州の電池工場を2027年末までにエネルギー貯蔵用のユニットを製造するために転換することを含め、エネルギー事業の立ち上げに20億ドルを投じる計画であると発表した。また、ミシガン州マーシャルの工場で住宅貯蔵用の電池を製造するために工場スペースの一部を充てる計画もある。
モルガン・スタンレーのアナリスト、アンドリュー・パーココ氏は6月の投資家向けノートで、「投資家はフォードのESS事業に価値を見出している」と述べた。同氏はまた、フォードのモデルe電気自動車事業の収益性への道を「過小評価されている原動力」とも呼んでいる。
フォード・エナジーは同社のモデルe電気自動車部門の一部であり、2029年までに損益分岐点に達するまでに、2026年に40億ドルの損失を見込んでいる。重要な転換点は、同社のESS事業が2027年に稼働することになると予想されている。
フォードのジム・ファーリー最高経営責任者（CEO）は、7月の自動車メーカーの第2四半期決算会見で投資家に対し、再生可能エネルギーサービスプロバイダーのEDFパワー・ソリューションズ・ノース・アメリカとの5年間の枠組み契約を発表した後、ESSの20ギガワット時の生産能力を売り切る「3回目」に入っていると語った。
防衛産業
米国の防衛産業に関しては、GMはフォードより何年も先を行っている。 GMは14年間の休止期間を経て、2017年に防衛部隊を復活させた。
同社は多くのプロジェクトで米軍と協力してきたが、最近米陸軍から歩兵分隊車両（ISV）製造の契約を獲得しており、議会の予算次第では10億ドルを超える可能性があるという。
第2四半期の同社の売上高480億ドルと比べると契約額は小さいが、米軍作戦における自動車業界の機会は拡大すると予想されている。
米陸軍戦闘能力開発司令部地上車両システムセンターの研究・技術統合担当エグゼクティブディレクター、アルフレッド・グレイン氏は「すべての自動車会社とその階層化されたサプライヤーが持つ能力、拡張性、製造能力を活用することは大きなメリットだ」とCNBCに語った。
GMは、2026年の防衛収入がほぼ7億ドルに増加すると予想しており、将来の事業の未処理分も積み上げながら、今年は利息・税引き前利益でプラスの結果を目指すと述べた。
ＧＭのメアリー・バーラ最高経営責任者（ＣＥＯ）は７月、投資家に対し「われわれは防衛産業基盤のスピード、規模、回復力を拡大するためにロッキード・マーティンや他の大手企業とも協力している」と語った。 「時間が経つにつれて、これらすべてがGMディフェンスをより有意義で多様な収益への貢献者にするはずです。」
米陸軍全体で有人および無人地上システムの技術を管理するグレイン氏は、トランプ政権により自動車メーカーを含む新規企業がそのような契約を獲得しやすくなったと述べた。同氏はまた、米国内での製造が重要だと述べた。
「明らかに、特に国防総省製品への外国企業の関与に対する懸念はますます重大になっている」とグレイン氏は述べた。
GMとフォードは、両社が以前に取り組んできたものの大型バージョンである重歩兵分隊車両を生産するプロトタイプ契約を獲得した企業グループに含まれていた。
フォードは米国の防衛努力について多くの詳細を明らかにしていない。しかし同社は水曜日、英国国防省の小型モビリティ・ビークル・プログラム向けの次世代車両を争うため、ゼネラル・ダイナミクス・ランド・システムズおよびエンジニアリング会社リカルドと提携すると発表した。
GMとフォードの防衛への取り組みは、そのような一連の取り組みの最新のものであり、その中には最も注目すべきは、第二次世界大戦中に両社が米国および連合国と協力してナチス・ドイツと戦うための軍事物資を提供した「民主主義の兵器庫」が含まれる。
ファーリー氏は7月に投資家に対し、「われわれはすでに商業世界の市場で優位に立っている。われわれは商業顧客が得られるのと同じ利点を米国政府に提供したいと考えている」と語った。 「これは私たちにとって素晴らしい機会です。…私たちは追加の防衛関連プロジェクトについて米国政府と協議しており、今後も協議を続けます。」`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/09/05/gm-ford-defense-energy.html",
    publishedAt: "2026-09-05T12:00:01+00:00",
    category: "エネルギー",
    imageUrl: "https://images.unsplash.com/photo-1473172367879-2dca04a4dca4?w=800&q=80",
    readTime: 9,
  },
  {
    id: "meet-the-ciso-a-new-front-line-star-in-t-2821b540",
    title: "Meet the CISO: A new front line star in the AI cybersecurity war",
    titleJa: "CISO の紹介: AI サイバーセキュリティ戦争の新たな最前線スター",
    summaryJa: "一流企業のサイバーセキュリティ上級リーダーにとって、そのリスクはかつてないほど高まっています。世界的な教育・人材ソリューション会社ETSの最高セキュリティ責任者ウォーリー・ダルリンプル氏は、「私の仕事は2倍か4倍になったような気がする」と語った。",
    bodyOriginal: `The stakes have never been higher for senior cybersecurity leaders at top companies.
...
"I feel the weight of the world of figuring out how to do it myself," he said.`,
    bodyJa: `一流企業のサイバーセキュリティ上級リーダーにとって、そのリスクはかつてないほど高まっています。
世界的な教育・人材ソリューション会社ETSの最高セキュリティ責任者ウォーリー・ダルリンプル氏は、「私の仕事は2倍か4倍になったような気がする」と語った。
「それは非常に速く、そして非常に大量に私たちに向かって来ています」と彼は言いました。
人工知能の登場により、最高情報セキュリティ責任者はサーバー ルームから取締役会に突然現れ、リーダーは予算とビジネス ニーズの変化に対処しながら、急速に変化する脅威の状況に対処する必要に迫られています。
オープンソース開発者プラットフォーム「Hugging Face」に対する不正な OpenAI 自律エージェントによる 7 月のハッキングは、その変化を加速させ、高度な AI ハッキングの時代が到来したことを証明しました。また、エージェントが目標を達成するまでにどれくらいの距離を費やすのかも示しました。
それ以来数週間で、エージェント主導の攻撃のリストは膨れ上がり、ロイター通信は金曜日、5月にOpenAIエージェントの別の群れが封じ込めを突破し、ドイツのWebサイトを乗っ取ったと報じた。
このスタートアップは、Hugging Face攻撃の後、AIの研究とトレーニングの一部を一時停止したが、セキュリティインシデントによってOpenAIが新製品をリリースすることは止められていない。同社は今週、「重大な」サイバー能力について以前に警告していたにもかかわらず、最新のGPT-6 Astraモデルの展開を発表した。
そして、特化したサイバー機能を備えたモデルのリリースのペースは衰えておらず、GoogleはGemini 3.8 Flash Cyber​​をデビューさせ、Anthropicは今週もFable 5.1とMythos 5.1を公開している。
「私たちの足元の地面は変化しつつある」とデルのセキュリティ責任者、ジョン・シモーネ氏は語った。 「それは、私たちが何十年にもわたって拠り所とすることができた変数、つまり安全な前提を完全に変えようとしています。」
「金の重みに値する」
あらゆる追加のストレスに対して、大きな希望の兆しが 1 つあります。それは、AI の世界に取り組むための才能と技術スキルを備えた CISO にとって、採用市場が活気づいているということです。
サイバーセキュリティ調査会社エグゼクティブ・パートナーズで共同創設者兼マネージング・パートナーのマイケル・ピアセンテ氏は、チェックボックスにチェックを入れた資格のある候補者は簡単に7桁を超える給与パッケージを獲得しているが、採用担当者は迅速に行動する必要があると述べた。
ピアセンテ氏は、彼のチームは1日18時間から20時間働くことが多いが、それでも1週間に1回の検索で候補者を他のオファーに奪われていると語った。彼は、クラウドの導入以来、これに匹敵するダイナミクスを見たことがありません。
「どちらかというとゆっくりとした漂流だった」とピアセンテは語った。 「AIのように、すべてが一度に集まったわけではありません。」
企業は長年にわたり、サイバーセキュリティに関する深い専門知識と政府やコンプライアンスの経験が CISO にとって切望されるスキルであると考えていました。 AI の時代において、これらの資格は最低限のものにすぎません。
AI の普及に伴い、CISO は悪者を締め出す責任だけでなく、社内の AI エージェントとデータ管理を管理するという任務も負っています。
大手エグゼクティブ人材紹介会社クリスチャン・アンド・ティンバースの社長、JCクリスチャン氏は、AIセキュリティ構築の経験やリスクなどの技術的背景は企業にとって交渉の余地のないものになっていると語る。
「数年前には業務を担当できた多くの CISO は、おそらく今日の世界に対応する準備ができていないでしょう」とクリスチャン氏は述べた。
AI で実証された CISO には、取締役会でプレゼンテーションをしたり、合併や買収などの主要なビジネス上の決定に意見を述べたりするための、強力なコミュニケーション スキルと自信も必要です。
これにより組織構造が変化し、多くのセキュリティ責任者が最高情報責任者ではなくCEOに直通できるようになったと、FTIコンサルティングのサイバーセキュリティおよびデータプライバシーコミュニケーションのグローバル責任者であるメレディス・グリファンティ氏は述べた。
例えば、バークレイズのアナリスト、サケット・カリア氏は今週CNBCに対し、CEOとの面会が月1回から週3回になったCISOから聞いたと語った。
危機管理の経験、優れたビジネス洞察力、そしてBlack Hatのような業界カンファレンスのステージでプレゼンテーションを行う能力を備えたCISOは「非常に価値がある」とグリファンティ氏は述べた。
「スパイダーセンス」
CISO には、AI 防御を迅速に展開するというプレッシャーがかかっていますが、緊急の需要があるからといって、必ずしも予算やツールが追い付いているわけではありません。
Gartner のデータによると、サイバーセキュリティ予算は 2026 年に 6% 増加すると予想されており、これは主に AI を保護して実装するための新しいツールによるものです。 IDCのアナリスト、クレイグ・ロビンソン氏によると、世界の一部の地域では支出額が高く、中東とアフリカでは前年比16％増加のペースで推移しているという。
金融、製薬、エネルギー、ヘルスケアなどのミッションクリティカルなセクターは、攻撃者が最新の AI ツールを導入する前にサイバー防御を強化しようと躍起になっています。
ウーバーとフェイスブックの元最高情報責任者（CISO）でサイバーコンサルティング事業を運営するジョー・サリバン氏は、テクノロジーがあまりにも新しいため、「一部のセキュリティチームは圧倒されすぎてどこから始めればいいのか分からず、セキュリティ製品に関してはゴールデンタイムに間に合わない」と述べた。
トップのサイバーセキュリティベンダーが主要な勝者として浮上しており、CrowdStrikeとOktaの最近の収益はAI防御の需要の急増を示しています。 AIの破壊に対する広範な懸念の中で年初は低迷したが、株価は急反発した。クラウドストライクとパロアルトネットワークスは今年約80％上昇し、オクタ株は約2倍となった。
長年にわたるオールインワンの既存企業がバンドル化を通じて顧客にアピールしている一方で、AI 問題に取り組むことを約束するスタートアップ企業が爆発的に増加しています。
このため、多くの CISO は「スパイダーの感覚」を試して、勝者を洗い出すか、明確に優れたソリューションが現れるまでいくつかのソリューションを支持する必要があると AppLovin の情報セキュリティ担当グローバル責任者、ジェレミア・クン氏は述べています。
ダルリンプル氏は、意思決定の範囲と実行へのプレッシャーがこれまで以上に困難なものだと語った。
「自分でどうやってやるかを考える世界の重みを感じています」と彼は言う。`,
    source: "CNBC",
