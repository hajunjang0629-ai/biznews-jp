...
- 4 日前に公開`,
  ...
  },
  {
    ...
    summaryJa: "水曜日の米国債利回りは、カーブの長期端での売りが投資家の不安を和らげたため、前日に見られた数年ぶりの高値からわずかに低下した。米政府借入の主要指標である10年米国債利回りは1ベーシスポイント以上低下し4.69％となった。",
    bodyOriginal: `Treasury yields pulled back slightly on Wednesday from multi-year highs seen in the previous day, as a sell-off at the long end of the curve eased investor jitters.
...
— CNBC's Sarah Min contributed to this report.`,
    bodyJa: `水曜日の米国債利回りは、カーブの長期端での売りが投資家の不安を和らげたため、前日に見られた数年ぶりの高値からわずかに低下した。
米政府借入の主要指標である10年米国債利回りは1ベーシスポイント以上低下し4.69％となった。
米連邦準備理事会（FRB）の短期金利政策とより密接に連動する2年物国債利回りは1ベーシスポイント以上低下し4.16％となった。
30年長期国債利回りは、火曜日に5.33％以上と19年ぶりの高値を更新した後、1ベーシスポイント以上低下し、5.274％となった。
1 ベーシス ポイントは 0.01% に相当し、利回りと価格は相互に反比例します。
この動きは、火曜日に世界の長期債券がさらに幅広く下落したことの一環だった。日本の10年債利回りは過去30年間で最高水準に達した。ドイツの３０年債利回りは２０１１年以来の最高水準に達し、フランスの３０年債金利も２００８年以来の最高値に達した。
7月の米国の財政赤字は4,323億ドルに急増し、月間総額としては2021年3月以来最高となり、年初からの財政赤字は1兆8,000億ドル近くに達した。約40兆ドルの国債をファイナンスするために支払われた利息は、今年連邦政府に約1兆2000億ドルの損失をもたらした。
一方、戦争終結に向けた米国とイラン政府間の交渉は行き詰まっており、交渉が再開される兆しはほとんどない。
AJベルの財務分析部門責任者ダニー・ヒューソン氏は火曜日、「投資家は中東情勢の展開を注視しており、これまで予想されていたよりもさらに激しく長期にわたるインフレ急騰の可能性を織り込んでいる」と述べた。
水曜日の別の場所では、最新の連邦公開市場委員会議事録が午後に発表される予定だ。中銀内の意見の対立が激しくなっていることから、投資家は議事録に注目することになるだろう。 ７月の会合では３人の反対派が利上げに賛成票を投じたが、投資家はこの区分についてさらに詳細を求めることになる。
— CNBC のサラ・ミン氏がこのレポートに寄稿しました。`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/08/19/treasury-yields-multi-decade-highs-bonds-inflation.html",
    publishedAt: "2026-08-19T13:00:30+00:00",
    category: "金融政策",
    imageUrl: "https://images.unsplash.com/photo-1611974789855-9c2a0a7236a3?w=800&q=80",
    readTime: 2,
  },
  {
    id: "treasury-announces-upscaled-buyback-oper-ed0b950e",
    title: "Treasury announces upscaled buyback operation for longer-term debt, sending yields lower",
    titleJa: "財務省が長期債の買い戻しオペの規模拡大を発表、利回り低下につながる",
    summaryJa: "財務省は水曜日、政府国債の買い戻し規模を2倍以上に拡大し、利回りが大幅に低下すると発表した。債券市場が圧力にさらされ、利回りが約20年ぶりの水準に急上昇するなか、今回の発表は国債市場の敏感な部分をターゲットにしている。",
    bodyOriginal: `The Treasury Department on Wednesday said it will more than double the size of its government debt repurchases, sending yields sharply lower.
...
This is breaking news. Please refresh for updates.`,
    bodyJa: `財務省は水曜日、政府国債の買い戻し規模を2倍以上に拡大し、利回りが大幅に低下すると発表した。
債券市場が圧力にさらされ、利回りが約20年ぶりの水準に急上昇するなか、今回の発表は国債市場の敏感な部分をターゲットにしている。
買い戻しの加速の下で、財務省は市場の10年から20年と20年から30年の部分をターゲットにする予定だが、この部分では6月下旬から買い手のストライキが起きている。同省の発表によると、政府は自社株買い事業の最大規模を20億ドルから「少なくとも」40億ドルに「少なくとも2倍」にする。
発表後、利回りは急上昇した。
指標となる１０年債は６ベーシスポイント低下して４．６４７％、３０年「長期」債は９ベーシスポイント低下して５．１９６％となった。ベーシス ポイントは 0.01% に相当します。利回りと価格は逆方向に動きます。
この変更は9月9日に開始され、11月4日まで有効となる。
同省は声明で「今回の自社株買いオペの規模拡大は、財務省が長期間の自社株買いオペで日常的に大量の質の高いオファーを受けていることからも分かるように、市場参加者から一貫して強力なスポンサーが存在する長期の名目セクターにおいて、より大きな流動性支援を提供したいという財務省の意向を反映している」と述べた。
これは速報です。更新を確認するには更新してください。`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/08/19/treasury-announces-upscaled-buyback-operation-for-longer-term-debt-sending-yields-lower.html",
    publishedAt: "2026-08-19T12:59:35+00:00",
    category: "金融政策",
    imageUrl: "https://images.unsplash.com/photo-1611974789855-9c2a0a7236a3?w=800&q=80",
    readTime: 2,
  },
  {
    id: "moderna-merck-cancer-vaccine-shows-promi-59b56c26",
    title: "Moderna, Merck cancer vaccine shows promise in late-stage trial; Moderna stock soars 90%",
    titleJa: "モデルナとメルクのがんワクチンは後期試験で有望性を示す。モデルナ株が90％急騰",
    summaryJa: "メルクとモデルナの実験用個別化がんワクチンが、史上初の後期試験で良好な初期結果を示し、治療選択肢の承認申請に一歩近づいたと両社は水曜日に発表した。メルクの免疫療法キイトルーダと組み合わせたmRNAベースのショットは、検出可能ながんが手術で完全に除去された高リスクまたは進行性黒色腫患者1,100人以上を対象とした第3相試験で重要な目標を達成した。",
    bodyOriginal: `An experimental personalized cancer vaccine from Merck and Moderna showed positive initial results in its first-ever late-stage trial, the companies announced Wednesday, bringing them one step closer to filing for approval of the treatment option.
The mRNA-based shot in combination with Merck's immunotherapy Keytruda met key goals in the phase three trial in more than 1,100 patients with higher-risk or advanced melanoma whose detectable cancer had been completely removed through surgery.
Merck shares climbed more than 8% in premarket trading, while Moderna's stock soared about 90%. The size of those moves reflect the companies' relative size entering Wednesday: Merck's market cap was around $333 billion, while Moderna's sat near $25 billion.
The combination regimen met the main study goal of significantly extending the time patients lived without their melanoma returning, compared with Keytruda alone. The treatment also reduced the risk of the cancer spreading to distant parts of the body. Those results build on positive phase two trial data on the same regimen earlier this year.
...
The phase three study will continue to assess other outcomes, including the overall survival benefit of the regimen. The drugmakers plan to present the data at an upcoming international medical meeting, but it's unclear when they plan to submit applications for approval in the U.S.
...
The initial data suggests that the combo could serve as a new treatment option for melanoma, which accounts for only about 1% of skin cancers but causes the large majority of deaths among them. Most recurrences of melanoma develop in the first two to three years after initial treatment and removal.
Melanoma patients are "stuck having to deal with the new gravity of that diagnosis and then undergo uncomfortable treatments like surgery, and after that, they're worried about their cancer coming back," Dr. Jane Healy, Merck's head of oncology early development, said in an interview.
She called it "very exciting" that the therapy led to a "clinically meaningful improvement" over Keytruda – the standard of care for melanoma – and was well tolerated by patients. Side effects were similar to other vaccines that people typically get for other diseases, Healy noted.
The results also validate a personalized treatment approach that Merck and Moderna have been developing for decades, she added.
...
In a June note ahead of the results, Leerink Partners analyst Mani Foroohar said the phase three results are a make-or-break event for Moderna's stock.
Analysts said the company's valuation already reflected expectations that the personalized cancer vaccine could eventually work across multiple types of cancers – not just melanoma — before Wednesday's stock move.
Merck and Moderna are studying the vaccine in several trials across other tumors, such as non-small cell lung cancer, bladder cancer and renal cell carcinoma.`,
    bodyJa: `メルクとモデルナの実験用個別化がんワクチンが、史上初の後期試験で良好な初期結果を示し、治療選択肢の承認申請に一歩近づいたと両社は水曜日に発表した。
メルクの免疫療法キイトルーダと組み合わせたmRNAベースのショットは、検出可能ながんが手術で完全に除去された高リスクまたは進行性黒色腫患者1,100人以上を対象とした第3相試験で重要な目標を達成した。
メルク株は市場前の取引で８％以上上昇し、モデルナ株は約９０％急騰した。こうした動きの規模は水曜日に参入する企業の相対的な規模を反映しており、メルクの時価総額は約3,330億ドルであるのに対し、モデルナの時価総額は250億ドル近くにとどまっている。
この併用療法は、キイトルーダ単独療法と比較して、患者の黒色腫が再発せずに生存できる期間を大幅に延長するという主な研究目標を達成しました。この治療により、がんが体の離れた部分に広がるリスクも軽減されました。これらの結果は、今年初めに行われた同じレジメンに関する肯定的な第 2 相試験データに基づいています。
モデルナのステファン・バンセル最高経営責任者（CEO）はCNBCの番組「スコークボックス」のインタビューで、「医療にとっても患者にとっても大きな瞬間だ」と語った。
第 3 相試験では、レジメンによる全生存期間の利益を含む他の結果の評価が継続されます。製薬会社は今後開催される国際医学会議でデータを発表する予定だが、米国での承認申請をいつ提出する予定なのかは不明だ。
メルク研究所所長のディーン・リー博士は「スコークボックス」に対し、製薬会社は「今後数カ月以内に」この治療法とその安全性について規制当局と協議を始める可能性が高いと語った。
初期のデータは、この組み合わせが、皮膚がんの約1%にすぎないが、皮膚がんの死亡の大部分を占める黒色腫の新たな治療選択肢となる可能性があることを示唆している。黒色腫の再発のほとんどは、最初の治療と切除後最初の 2 ～ 3 年以内に発生します。
メルク社の腫瘍学初期開発責任者であるジェーン・ヒーリー博士はインタビューで、黒色腫患者は「その診断の新たな重大性に対処しなければならず、その後手術などの不快な治療を受けなければならず、その後、がんが再発するのではないかと心配している」と語った。
同氏は、この治療法が黒色腫の標準治療であるキイトルーダよりも「臨床的に意味のある改善」につながり、患者にも十分に許容されたことを「非常に興味深い」と述べた。副作用は他の病気のために通常接種される他のワクチンと同様だったとヒーリー氏は指摘した。
この結果は、メルクとモデルナが数十年にわたって開発してきた個別化された治療アプローチを検証するものでもある、と彼女は付け加えた。
ヒーリー氏によると、同じ種類のがん患者であっても、すべての腫瘍には独自の一連の変異が存在するという。メルクとモデルナの個別化ワクチンは、画一的なアプローチを使用するのではなく、各患者の腫瘍の特定の変異を標的とするように設計されている。そのアイデアは、免疫系を訓練して、これらの固有のがんマーカーを認識して殺すようにし、その反応をキイトルーダと組み合わせることで、体がより効果的にがんを攻撃できるようにするというものです。
「我々は、（結果は）この病気の患者にとって非常に意味のあるものであり、この特定の新しい種類の治療法を用いた将来の試験において、他のがん患者にとってどのような意味を持つ可能性があると考えています」と彼女は述べた。
リーリンク・パートナーズのアナリスト、マニ・フォルーハー氏は決算発表に先立つ6月のメモで、第3段階の決算はモデルナ株にとって勝敗を分ける出来事だと述べた。
アナリストらは、同社の評価額は水曜日の株価変動前に、個別化がんワクチンが最終的には黒色腫だけでなく複数の種類のがんに効果があるという期待をすでに反映していると述べた。
メルクとモデルナは、非小細胞肺がん、膀胱がん、腎細胞がんなど他の腫瘍を対象としたいくつかの試験でワクチンを研究している。`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/08/19/moderna-merck-cancer-vaccine-shows-initial-late-stage-melanoma-data.html",
    publishedAt: "2026-08-19T12:57:32+00:00",
    category: "テクノロジー",
    imageUrl: "https://images.unsplash.com/photo-1518770660439-4636190af475?w=800&q=80",
    readTime: 4,
  },
  {
    id: "sk-hynix-suggests-its-stock-is-too-cheap-b72e551b",
    title: "SK Hynix suggests its stock is too cheap as it embarks on $29 billion buyback",
    titleJa: "SKハイニックス、290億ドルの自社株買いに乗り出し、自社株が安すぎると示唆",
    summaryJa: "ここ数カ月の急落を受けて、韓国のメモリーチップ会社は、現在の株価は同社の「本質的価値」を反映していないと述べた。",
    bodyOriginal: `Following a sharp selloff in recent months, the South Korean memory-chip company says current share prices don’t reflect the business’s “intrinsic value.”`,
    bodyJa: `ここ数カ月の急落を受けて、韓国のメモリーチップ会社は、現在の株価は同社の「本質的価値」を反映していないと述べた。`,
    source: "MarketWatch",
    sourceUrl: "https://www.marketwatch.com/story/sk-hynix-suggests-its-stock-is-too-cheap-as-it-embarks-on-29-billion-buyback-c8b35d4f?mod=mw_rss_topstories",
    publishedAt: "2026-08-19T12:46:00+00:00",
    category: "テクノロジー",
    imageUrl: "https://images.mktw.net/im-18931762",
    readTime: 2,
  },
  {
    id: "target-hikes-outlook-as-sales-rebound-an-0c996368",
    title: "Target hikes outlook as sales rebound and huge tariff refund boosts bottom line",
    titleJa: "売上の回復と巨額の関税還付により収益が押し上げられるため、目標は見通しを引き上げる",
    summaryJa: "ターゲットは水曜日、関税還付によって押し上げられた四半期利益を発表し、小売業者が業績回復が定着する兆候を示していることから、通期見通しを引き上げた。同社によると、純売上高は前年比５．３％増加した。ストリートアカウントによると、比較対象の売上高は3.8％増加し、ウォール街予想の2.4％を上回った。ターゲットはリリースの中で、カテゴリー全体で「広範な」強みがあると見ていると付け加えた。",
    bodyOriginal: `Target on Wednesday posted quarterly earnings that were boosted by tariff refunds and raised its full-year guidance, as the retailer shows more signs its turnaround is taking hold.
...
Despite the results, Target shares slid 1% in premarket trading.
...
- Earnings per share: $4.11, it was not immediately clear if it was comparable to the $2.33 per share expected
...
Target's stock is up more than 55% this year.`,
    bodyJa: `ターゲットは水曜日、関税還付によって押し上げられた四半期利益を発表し、小売業者が業績回復が定着する兆候を示していることから、通期見通しを引き上げた。
同社によると、純売上高は前年比５．３％増加した。ストリートアカウントによると、比較対象の売上高は3.8％増加し、ウォール街予想の2.4％を上回った。ターゲットはリリースの中で、カテゴリー全体で「広範な」強みがあると見ていると付け加えた。
マイケル・フィデルケ最高経営責任者（ＣＥＯ）は記者団との電話会談で、「これまでの進展に励まされており、今後の重要な取り組みについても明確な目で見ている」と述べた。 「第2四半期は、ターゲットの成長の新たな章を開くために今年初めに策定した計画の重要な前進です。この四半期に当社から見たものは、当社の戦略を実行するために必要であると当社が認識していた変化のレベルを反映しています。」
ターゲットの第２・四半期決算には、関税還付による純利益の７億５２００万ドル（１株当たり１．６５ドル）押し上げも含まれている。同社は、第2四半期の粗利益と営業利益には、その返済による税引前利益9億9,400万ドルが含まれていると述べた。
ターゲットは、販売傾向の堅調さと収益の一時的な押し上げの両方を理由に、通期見通しを引き上げた。同社は通年の純売上高の伸び率見通しを１％ポイント引き上げ約５％に引き上げた。
関税還付を含む通年のEPSは9.90ドルから10.90ドルになると予想している。返済を除くと、その範囲は１株当たり８．２５ドルから９．２５ドルとなり、これまでの見通しは１株当たり７．５０ドルから８．５０ドルだった。
ターゲットは２四半期連続で有望な業績を発表しているが、フィデルケ氏は同社の業績回復については依然として慎重だと述べた。
「はっきり言っておきますが、我々にはやるべきことがまだまだたくさんあります」と同氏は記者団に語った。 「より強力な実行とゲストからのフィードバックの改善の組み合わせは、当社が戦略を推進し続ける際に構築するための強固な基盤を提供します。」
この結果にもかかわらず、ターゲット株は市場前の取引で１％下落した。
以下は、LSEGによるアナリスト調査に基づいた、小売業者の第2四半期会計報告とウォール街の予想との比較です。
- 1株当たり利益：4.11ドル、予想される1株当たり2.33ドルに匹敵するかどうかはすぐには明らかではない
- 収益: 265.4億ドル対予想261.4億ドル
8月1日終了の3カ月間で、ターゲットは純利益が18億8000万ドル（1株当たり4.11ドル）と報告したが、前年同期は9億3500万ドル（1株当たり2.05ドル）だった。この比較には、ターゲットが関税還付金を回収することで得た恩恵も含まれている。
「2四半期好調を維持することが目標ではない」とフィデルケ氏は記者団に語った。 「私たちが求めているのは、長期にわたる持続的かつ持続的な売上高と最終利益の成長です。」
同社によれば、同四半期のデジタル比較売上高は8.7％増加し、同日配送サービスは25％以上増加したという。
ターゲットは、主要6カテゴリーすべてが成長し、食品および美容事業全体に力強さが見られると述べた。しかし、アパレルと家庭用品のカテゴリーは他の部門に比べて遅れをとっており、企業幹部らはこの矛盾を修正することに熱心だと述べた。
フィデルケ氏は記者団に対し、「家庭のようなカテゴリーは数年にわたる旅になるだろうと分かっていた。家庭のようなカテゴリーで変化を加えたゲストの反応に勇気づけられた」と語った。 「私たちは装飾用アクセサリーの品揃えの 75% を変更しました。そして、その変更に伴って（同等の売上が）好調に推移していることがわかりました。率直に言って、これら 2 つのカテゴリーでは、この種の改善がさらに必要です。」
ターゲットはまた、顧客を店舗に呼び戻すために、パイプラインのさらなる削減を含め、1万点以上の商品の価格を引き下げたと述べた。第2四半期には17店舗を新規オープンした。
同社は、一貫した成長への回帰と中核顧客の再誘致に向けて、正しい道を進んでいることを投資家に証明しようと努めてきた。この収益は、多くの消費者がマクロ経済状況の圧力を受けて支出を減らし続けることで得られる。
ターゲットは前四半期、既存店売上高が5四半期ぶりにプラスとなり、5.6％増加したと報告した。
ターゲットの株価は今年５５％以上上昇している。`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/08/19/target-tgt-q2-2026-earnings.html",
    publishedAt: "2026-08-19T11:41:43+00:00",
    category: "貿易",
    imageUrl: "https://images.unsplash.com/photo-1526304640581-d334cdbbf45e?w=800&q=80",
    readTime: 5,
  },
  {
    id: "inflation-is-heating-up-but-don-t-expect-88863bcf",
    title: "Inflation is heating up but don't expect another crisis",
    titleJa: "インフレは加速しているが、危機が再び起こるとは思わない",
    summaryJa: "インフレは加速しているが、危機が再び起こるとは思わない- 公開されました",
    bodyOriginal: `Inflation is heating up but don't expect another crisis
- Published
...
- Published3 hours ago`,
    bodyJa: `インフレは加速しているが、危機が再び起こるとは思わない
- 公開されました
先月、イラン戦争の余波で光熱費が上昇し、家計への暑さがさらに厳しくなったが、ここからインフレはどれほど不快なものになるだろうか？
まず覚えておいていただきたいのは、多少の価格上昇は正常であるということです。それは経済が健全に機能していることのしるしです。
しかし、ウクライナ戦争初期のインフレ急騰の影響で食料品だけでも4年前の3分の1に値上がりしており、やりくりするのが大変な状況にあるかもしれない。
良いニュースは、イラン戦争勃発以来のインフレが、エコノミストが当初懸念していたよりも実際には抑制されていることだ。
その理由の一部は、エネルギー価格がそれほど積極的ではなかったということです。また、食品などの品目ではエネルギーコストの上昇は顕在化しておらず、インフレ率は1.3％で、実際にはここ5年近くで最低となっている。
一方、今年は賃金と福利厚生が例年インフレを上回っており、これまでのところ多くの人にとっての圧迫は軽減されている。
しかし、既存のエネルギーコスト圧力により、サプライチェーンを通過するまでに何か月もかかるため、食品やその他の価格が今後数カ月でさらに速いペースで上昇する可能性がある。
実際、エコノミストはインフレ率がさらに上昇し、年内には約3.5％に達すると予想している。
このことは、アンディ・バーナム新首相とジョン・ヒーリー首相に対し、予算案の準備段階ですでに与えられているものに加えてさらなる支援を提供するよう圧力を強めることになりそうだ。
しかし、いかなる支援も、税金の増加や公共部門の一部への財源の減少という形で影響を及ぼします。
それが価値があるのか​​と疑問を抱く人もいる。
10月には光熱費がさらに上昇する可能性が高いが、現在の予測では、ウクライナ戦争開始後に到達したピークよりも1,000ポンド安くなるという最高の部分を示唆している。
紙幣について言えば、住宅ローンはどうなるでしょうか。これはイングランド銀行にどのような影響を与えるのでしょうか?
金利の変更が価格に影響を与えるまでには時間がかかることに注意してください。イングランド銀行は将来のインフレに影響を与える金利を設定します。
これらの数字からは、インフレ率は中期的に２％の目標まで低下するとの世銀の考えを変えるものはほとんどない。
実際のところ、食料品のインフレなどが依然として抑制されているという事実は、物価圧力が引き続きかなり抑制されているという期待をイングランド銀行に与えているのかもしれない。
一方、雇用統計の横ばいや賃金の伸びが緩やかなことから、企業が物価引き上げを回避する機会はほとんどないと考えられる可能性がある。
そのため、一部のアナリストは、今年は金利が上昇しない可能性があると考えているが、特にインフレが予想外の量で加速した場合には、上昇するリスクは依然として存在する。
サービスなど他の分野でも物価圧力が続いており、年末にインフレがアナリストの予想を超えて上昇する危険性が常にある。
何よりも最大のリスクは、中東紛争が長引き、エネルギー市場がさらに混乱し、インフレが予想よりも高くなる恐れがあることだ。
ウクライナ戦争開始時のペースに比べれば数分の一にとどまる可能性が高いが、バーナム、イングランド銀行、そしてほとんどすべての家庭は新たな頭痛の種に悩まされることになるだろう。
関連トピック
- 3 時間前に公開`,
    source: "BBC",
    sourceUrl: "https://www.bbc.co.uk/news/articles/cj63jr5r09zo?at_medium=RSS&at_campaign=rss",
    publishedAt: "2026-08-19T11:27:39+00:00",
    category: "エネルギー",
    imageUrl: "https://ichef.bbci.co.uk/ace/standard/240/cpsprodpb/71fb/live/6988a5c0-9bcd-11f1-aed2-8d6da8d75094.jpg",
    readTime: 4,
  },
  {
    id: "trainline-virgin-atlantic-and-red-drivin-2ed5a127",
    title: "Trainline, Virgin Atlantic and RED Driving School investigated over 'drip pricing'",
    titleJa: "トレインライン、ヴァージン・アトランティック航空、REDドライビングスクールが「点滴価格設定」を巡り調査される",
    summaryJa: "トレインライン、ヴァージン・アトランティック航空、REDドライビングスクールが「点滴価格設定」を巡り調査される- 公開されました",
    bodyOriginal: `Trainline, Virgin Atlantic and RED Driving School investigated over 'drip pricing'
- Published
...
- Published10 August`,
    bodyJa: `トレインライン、ヴァージン・アトランティック航空、REDドライビングスクールが「点滴価格設定」を巡り調査される
- 公開されました
トレインライン、ヴァージン・アトランティック航空、レッド・ドライビング・スクールは、顧客に事前に正規の価格を提示していないという懸念から、消費者監視団体によって調査を受けている。
競争・市場庁（CMA）は、3社が顧客に提示する最高価格に義務的な手数料を含まない違法行為である、いわゆる「ドリッププライシング」を行ったかどうかを調査している。
CMAは、企業が法律に違反したと結論付けた場合、罰金を科したり、顧客への賠償を命じたりすることができる。
3社は顧客の透明性を重視し、CMAと全面的に連携すると述べた。
トレインラインの場合、CMAは、主要鉄道運賃に最大2.79ポンド、バスの予約には最大1.50ポンドの手数料が上乗せされているのを観察したと述べた。
CMAは、「どちらも、頻繁に旅行する人にとっては、かさむ可能性のある費用だ」と述べた。
トレインラインは以前にも点滴価格設定で告発されたことがある。 2023年、鉄道道路局と他の第三者鉄道切符販売会社6社が手数料について率直に説明していないと発表した。
ヴァージン アトランティック航空は、パッケージ旅行を購入する顧客に表示される前払い料金に、必須のリゾート料金と地方税が含まれているかどうか調査されています。 CMAによると、これらの料金はさまざまだが、最大で数百ポンドに達する可能性があり、休暇の費用が大幅に増加するという。
そして、監視機関は、REDドライビングスクールが、運転レッスンを購入する人に提示される前払い料金に、必須の予約手数料とデジタル手数料を含んでいたかどうかを調査している。 CMAは、授業料は1レッスンあたり7ポンド以上になる可能性があると述べた。
今年初め、CMAは他の2つの自動車教習所に対して、オンライン予約手続き中に事前に教習料金の総額を開示しなかったため、8万人以上の顧客に返金するよう命令した。
CMAの消費者保護担当エグゼクティブディレクター、エマ・コクラン氏は、「顧客が最初に目にするのは、彼らが支払う価格であるべきだ。
「多くの家庭が自分の出費に気を配っている現在、人々が電車や長距離バスのチケット、休日や運転のレッスンを予約する際に追加料金に驚かないことが重要です。」
ヴァージン アトランティック ホリデイズの広報担当者は、顧客に対する責任を「信じられないほど真剣に」受け止めていると述べ、「我々は常に、顧客が当社での休暇を予約する際に、十分な情報に基づいた決定ができるようにしたいと考えている」と付け加えた。
「必須の料金は、予約手続き全体の複数の段階で示されています。私たちはCMAから指摘された点を慎重に検討しており、その調査に全面的に協力するつもりです。」
トレインラインの広報担当者は、同社は「明確な価格設定と真の価値を備えた透明性の高い予約体験を顧客に提供することに尽力している」と述べた。
「私たちは数カ月にわたってCMAと積極的に連携し、顧客に対する特定の料金の提示方法を強化するための積極的な措置を講じています。」
レッド・ドライビング・スクールは、広範な調査の対象となったことに失望していると述べた。
「レッドドライバートレーニングは、顧客とのあらゆるやり取りにおいて常に透明性と消費者の満足度の両方を重視している」と広報担当者は述べた。
「私たちは消費者法に基づくあらゆる義務を最大限の焦点と真剣に受け止めます。」
昨年以来、CMAは企業を法廷に訴えることなく、消費者法違反を裁定する権限を持っている。
消費者権利団体 どっち? CMAは「特に各企業がすでに警告勧告書を受け取った後では」これらの権限を行使することを躊躇すべきではないと述べた。
「Which?」の消費者権利政策責任者、スー・デイビス氏は、「先週の首相の、我が国の経済に不当な価格設定の余地はないという発言を受けて、この措置は他の企業にルールに従うよう明確なメッセージを送ることになる」と述べた。
「家計が逼迫している今、消費者は企業が消費者を騙し取るつもりはなく、規制当局が自らの権利を守るために積極的に介入してくれると確信する必要がある。」
連絡する
この話で提起された問題の影響を受けましたか?
- 8月10日発行`,
    source: "BBC",
    sourceUrl: "https://www.bbc.co.uk/news/articles/cwyjqe62574o?at_medium=RSS&at_campaign=rss",
    publishedAt: "2026-08-19T11:08:42+00:00",
    category: "マクロ経済",
    imageUrl: "https://ichef.bbci.co.uk/ace/standard/240/cpsprodpb/6404/live/b3e6ea00-9ba5-11f1-a4e6-dfdb59e74cb0.jpg",
    readTime: 5,
  },
  {
    id: "jump-in-energy-bills-drives-uk-inflation-8d1e7c37",
    title: "Jump in energy bills drives UK inflation to highest rate for four months",
    titleJa: "光熱費の高騰で英国のインフレ率は4カ月ぶりの最高水準に",
    summaryJa: "光熱費の高騰で英国のインフレ率は4カ月ぶりの最高水準に- 公開されました",
    bodyOriginal: `Jump in energy bills drives UK inflation to highest rate for four months
- Published
...
- Published3 hours ago
- Published6 days ago`,
    bodyJa: `光熱費の高騰で英国のインフレ率は4カ月ぶりの最高水準に
- 公開されました
新しい統計によると、光熱費の高騰で英国のインフレ率は７月までの１年間で２．９％に達し、４カ月ぶりの高水準となった。
国家統計局（ＯＮＳ）によると、ガソリン価格は約４年ぶりの急激なペースで高騰し、７月の家庭用光熱費の上限引き上げにつながった。米国・イスラエルとイランの戦争が始まり、世界の石油供給が制限されてからエネルギーコストが高騰した。
７月の統計は３月以来の高水準となったが、物価の伸びは一部鈍化した。食料インフレ率は1.3％で、ここ5年近くで最低の水準にある。
専門家らは、インフレ率の数字がイングランド銀行（中央銀行）の次回９月理事会で主要金利の変更に影響を与える可能性は低いとの見方を示した。
エネルギー規制当局のOfgemがガスと電気料金の価格上限を13%引き上げたことにより、7月1日に家庭のエネルギーコストが上昇し、通常の請求額に年間221ポンドが追加された。
コーンウォール・インサイトによると、住宅の光熱費は10月から4％上昇すると予想されており、これは2023年7月以来の高水準となるだろう。
米国とイランの紛争をめぐる不確実性は続いており、石油、液化天然ガス、その他の商品を運ぶ船舶の重要な通商路であるホルムズ海峡が事実上閉鎖されている。
独立系エネルギーコンサルタント会社コーンウォール・インサイトは、ヨーロッパ全土で続いている熱波によって「空調や冷房の需要を満たすために発電用のガス需要が増加している」ため、エネルギー価格の圧力がさらに高まっていると付け加えた。
ＯＮＳの価格ディレクター、マイク・ハーディ氏は、家具価格の下落が例年よりも低く、インフレ上昇圧力が強まったと述べた。
同氏によると、衣料品はそれほど値引きされていなかったという。
ジョン・ヒーリー財務相は、イラン戦争が英国の物価に影響を及ぼし続けているとしながらも、英国経済は底堅いと主張した。
「負担を感じている人たちに一息つける空間を与えるために、電気代の付加価値税を引き下げ、バス料金の上限を2ポンドに設定した」と同氏は語った。
「希望を取り戻し、英国全土で繁栄がより公平に共有される強力な経済を構築するには、やるべきことはまだある。」
影の首相メル・ストライド氏は、この国は労働党の「失政」による世界的ショックに対する備えが整っておらず、一般国民が「代償を支払わされた」ままになっていると述べた。
ペニー・キービル氏は、生活費危機は今後も続くと語った。
彼女は、週に 2 日、割引フード パントリーを運営する危機サポート センターであるセカンド チャンス メドウェイを設立し、現在では給付金受給者だけでなく、働いている人々も診察しています。
「手頃な価格の食料の必要性は今、地域社会のあらゆる場所に広がっています」と彼女は言う。 「光熱費は依然として高すぎて、賃金と収入が追いついていません。」
インフレは加速しているが、危機が再び起こるとは思わない
- 1 時間前に公開
英国小売業コンソーシアムの主任エコノミスト、ハービル・ディロン氏は、食品インフレが鈍化する中、消費者にとって朗報があると述べた。
同氏は、パスタ、オリーブオイル、生の果物の価格が7月にすべて下落し、「食料品店間の激しい競争が人々の毎週の買い物にしっかりと蓋をしていることを示している」と述べた。
一方、自動車燃料価格の上昇は、6月までの12か月間で21.3％上昇したのに比べて15.5％に鈍化したが、依然として2025年に比べてはるかに高い。
地平線に昇る
ＫＰＭＧのチーフエコノミスト、ヤエル・セルフィン氏は、７月は緩やかなインフレ上昇の始まりとなったとしながらも、水曜日の数字はイングランド銀行の金利設定決定の変更を促すには十分ではないと述べた。
同氏は、エネルギー関連コストによりインフレが今後数カ月で上昇し、ピークの約３．５％に達すると予想されていると付け加えた。
インフレ率は世銀の目標である２％を依然として上回っており、世銀はこの水準で物価が安定し、国民と企業が将来に向けた計画を立てることができると主張している。
キャピタル・エコノミクスの首席エコノミスト、ルース・グレゴリー氏は、エネルギー価格がこれ以上上昇しなければ、インフレは「来年末までに」目標まで低下すると予想している。
同氏は「イングランド銀行は今年金利を３．７５％に据え置き、来年は３％に引き下げる」と述べた。
しかし、イングランド・ウェールズの公認会計士協会の首席エコノミスト、スレン・ティルー氏は、物価の安定は依然としてとらえどころのないものだと述べた。
同氏は「インフレ上昇は必需品の価格上昇により家計を圧迫するため、今後数カ月で英国の成長にとって最大の脅威となる可能性が高い」と述べた。
同氏は、干ばつによる食料価格の上昇も目前に迫っている可能性があると付け加えた。
関連トピック
- 3 時間前に公開
- 6 日前に公開`,
    source: "BBC",
    sourceUrl: "https://www.bbc.co.uk/news/articles/cdrv7jr8n74o?at_medium=RSS&at_campaign=rss",
    publishedAt: "2026-08-19T09:02:03+00:00",
    category: "エネルギー",
