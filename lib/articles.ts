...
Since the Mideast conflict began in February, the U.S. implemented a series of economic measures against Iran, including sanctions. However, the Trump administration escalated its pressure last month via what Bessent called "Operation Economic Outcast," which imposed sanctions on almost 60 entities, vessels and individuals. The scope of secondary sanctions were also expanded on those involve in business with Iran in industries including shipping and technology.`,
  ...
  {
    id: "chinese-ai-labs-secretly-used-millions-o-fad3dd05",
    title: "Chinese AI labs secretly used millions of Claude exchanges to train their models, Anthropic says",
    titleJa: "Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.",
    summaryJa: "Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.",
    bodyOriginal: `Anthropic said it detected and disrupted unauthorized large-scale efforts by China-based AI labs including Alibaba, Moonshot and DeepSeek to train their models using Claude.
...
Alibaba, Moonshot, DeepSeek, Xiaomi and Anthropic did not immediately respond to CNBC's requests for comment.`,
    bodyJa: `Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/09/11/chinese-ai-labs-moonshot-deepseek-alibaba-anthropic.html",
    publishedAt: "2026-09-11T00:59:45+00:00",
    category: "テクノロジー",
    imageUrl: "https://images.unsplash.com/photo-1518770660439-4636190af475?w=800&q=80",
    readTime: 2,
  },
  {
    id: "can-europe-recharge-its-battery-industry-adb3fd93",
    title: "Can Europe recharge its battery industry?",
    titleJa: "Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.",
    summaryJa: "Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.",
    bodyOriginal: `Can Europe recharge its battery industry?
- Published
...
Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.`,
    ...
    publishedAt: "2026-09-10T23:05:47+00:00",
    category: "エネルギー",
    imageUrl: "https://ichef.bbci.co.uk/ace/standard/240/cpsprodpb/ac3e/live/cd5970d0-acf2-11f1-a540-61c3f7fc4e6c.jpg",
    readTime: 2,
  },
  {
    id: "i-asked-my-husband-to-pay-into-my-pensio-6bc8ba6e",
    title: "I asked my husband to pay into my pension when we had a child - here's why",
    titleJa: "子どもが生まれたとき、私は夫に年金を払ってくれるように頼みました - その理由は次のとおりです",
    summaryJa: "子どもが生まれたとき、私は夫に年金を払ってくれるように頼みました - その理由は次のとおりです- 公開されました",
    bodyOriginal: `I asked my husband to pay into my pension when we had a child - here's why
- Published
...
Related topics
- Published24 July`,
    bodyJa: `子どもが生まれたとき、私は夫に年金を払ってくれるように頼みました - その理由は次のとおりです
- 公開されました
モリーとテイラー・ヘイレットが家族を始めたとき、それが経済的にどのような意味を持つかについてはまったく計画していませんでした。
「私たちの最初の子供は私たちを驚かせたので、私たちはそれに対する準備ができていませんでした」とエセックス州のファイナンシャルアドバイザー、モリーさん（30）は言います。
モリーと電車の運転士であるテイラーの収入は同程度だったが、モリーが赤ちゃんと家で過ごす時間が増えるとバランスが変わった。
「テイラーのキャリアは前進したが、私のキャリアは後退した」と彼女は言う。 「子供たちと家でより多くの時間を過ごす人には、予期せぬ影響が生じます。」
夫婦が決めたことの一つは、モリーが仕事を休んでいる間、テイラーに彼女の年金を拠出してもらうことであった。
「私たちはテイラーだけでなく、自分たちの将来も考えていました」とモリーは言う。
それは、はるかに多くのカップルが子供を産む前に話し合うべきだと彼女は考えている。
「彼に聞いてみればいいよ」
彼女は、子供ができたら仕事をやめるつもりなので、最近このことについて友人と話し合ったと説明しました。
「私の友人は言いました、『どうやって彼にそんなことを頼むの？』そして私は、「彼に聞いてみればいいよ」と言いました。
「人々は現在のことと請求書を支払うことだけを考えますが、仕事を休むと、将来的にははるかに少ない収入になる可能性があります。」
33歳のテイラーさんは、それは自分が知っていたことではなかったが、モリーさんの提案に乗っていたことを認めた。
「私たちは一緒に生活することを約束しました。私が手伝うことができるなら、そうしますし、そうすることができてうれしかったです」と彼は言います。
彼は、計画と予算編成に関しては、モリーのほうが二人よりも組織的だが、それでも二人のお金がどこに使われているのか理解したいと思っていると付け加えた。
「私は彼女にお金を与えて、彼女がやりたいようにやらせるだけではありません。私たちはオープンな会話をしており、彼女はそれについて私に話してくれます。」
オクトパス・マネーの調査によると、親の3分の1以上が育児休暇中に年金拠出金を減額または一時停止したが、63％はパートナーが自分に代わって年金拠出できることを知らなかった。
パートナーは、いわゆる第三者年金拠出を行うことができます。無収入または低所得者の場合、各課税年度に最大 2,880 ポンドを支払うことができ、基本税率の減税により 3,600 ポンドまで増加します。
まだ収入がある人の場合は、受給者の年金限度額に応じて、そのパートナーも拠出することができます。
金融界のナゲット・セービングズの共同創設者であるケイティ・ギルド氏は、給料が下がると従業員自身の拠出金も減り、無給休暇期間中は拠出金が完全に打ち切られる可能性があるため、年金格差は産休中に始まる可能性があると語る。
彼女は、カップルはパートナーが仕事を続けることでその不足分を補うことができるかどうかを検討すべきだと言う。
彼女は、赤ちゃんを産む前に、いくつかの重要な質問に取り組むことを勧めています。
ギルドによると、こうした会話は、両親が睡眠不足で新生児との生活に慣れているときよりも、赤ちゃんが生まれる前のほうがやりやすいという。
モリーとテイラーには現在、2歳と5歳の2人の子供がいるが、2回目のときはずっと準備ができて、家計の費用を常にちょうど半分に分ける必要があるという考えをやめたと言う。
夫婦はそれぞれ約6万ポンドの収入を得ており、請求書用の共同口座と並行して自分たちの銀行口座を持っているが、状況が変わった場合にはそれぞれの拠出額を柔軟に調整している。
たとえば、モリーさんの産休中、夫婦は分割を調整し、彼女は「家計を家計として見る」ことが役立つことに気づいた。
夫婦は子どもたちに幼い頃からお金について教えているという。
彼らは二人の子供が生まれたときに年金を設定し、毎月の口座振替で支払っています。
モリーは、「彼らは60代になるまでそのお金に触れることができないので、それは将来への贈り物のようなものです。そして私たちはそれを見るためにそこにいるつもりはありません。」と説明します。
彼らはジュニアISAも利用しているが、モリー氏は、子どもたちが十分な年齢に達すれば、そのお金は自分たちのものになり、「その気になれば、そのお金を持ってきてイビサで使い果たすことができる」と指摘する。
テイラーさんによると、5歳の息子はただ単に欲しいものをすべて買ってもらうのではなく、数ポンド稼ぐために小さな仕事を与えられているという。
また、彼らは彼女に、今 1 ポンド使ってもいいし、それを我慢して後でもっと使えるかもしれないと伝えて、節約するという考えを導入し始めています。
ギルドは、カップルは資金提供された保育時間、外部の非課税保育、外部の非課税保育など、どのようなサポートが受けられるかを確認する必要があると述べています。
彼女は、育児休暇が始まってもお金に関する会話をやめるべきではないと付け加え、赤ちゃんが生まれたら、カップルには次のことをすべきだとアドバイスしています。
関連トピック
- 7 月 24 日発行`,
    source: "BBC",
    sourceUrl: "https://www.bbc.co.uk/news/articles/cde02k65427o?at_medium=RSS&at_campaign=rss",
    publishedAt: "2026-09-10T23:04:30+00:00",
    category: "金融政策",
    imageUrl: "https://ichef.bbci.co.uk/ace/standard/240/cpsprodpb/a593/live/bd412620-a7a2-11f1-a7ad-37a1f7dc081c.jpg",
    readTime: 6,
  },
  {
    id: "are-interest-rates-on-the-way-up-again-c7ec9881",
    title: "Are interest rates on the way up again?",
    titleJa: "Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.",
    summaryJa: "Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.",
    bodyOriginal: `Are interest rates on the way up again?
- Published
...
The government said the investment of almost £1bn would help support more than 350 jobs at Alstom and a further 6,000 jobs across the UK supply chain.
...
The DfT added that journey times will be cut by up to 10 minutes between Manchester and Leeds and up to 14 minutes between Manchester and York.
