...
現在の競争環境をどう見ているか尋ねられたマークス氏は、オーティスはこの問題を規制当局に任せ、顧客の判断に委ねるつもりだと述べた。`,
  ...
  {
    id: "how-can-we-minimize-taxes-in-retirement-004e0f86",
    title: "How can we minimize taxes in retirement with a $2.3 million nest egg — while buying homes in Florida and New England?",
    titleJa: "フロリダとニューイングランドで住宅を購入しながら、230万ドルの巣ごもりで退職後の税金を最小限に抑えるにはどうすればよいでしょうか?",
    summaryJa: "退職金の分配のバランスをとり、州境を越えて移動する場合はタイミングがすべてです。",
    bodyOriginal: `Timing is everything when balancing retirement distributions and moving across state lines.`,
    bodyJa: `退職金の分配のバランスをとり、州境を越えて移動する場合はタイミングがすべてです。`,
    source: "MarketWatch",
    ...
    publishedAt: "2026-08-08T12:00:00+00:00",
    category: "金融政策",
    imageUrl: "https://images.mktw.net/im-76384451",
    readTime: 2,
  },
  {
