...
export const articles: Article[] = [
  {
    id: "why-dell-s-stock-stands-to-gain-from-dev-9f7ddfef",
    title: "Why Dell’s stock stands to gain from developments at Nvidia and SpaceX",
    titleJa: "Nvidia と SpaceX の開発でデルの株価が上昇する理由",
    summaryJa: "デルは火曜日の決算発表で大幅な成長を報告すると予想されており、アナリストらは来年の決算にプラスとなる可能性のある業界の動向に楽観的だ。",
    bodyOriginal: `Dell is expected to report sharp growth when it posts earnings on Tuesday, and analysts are upbeat about industry developments that could benefit financial results into next year.`,
    bodyJa: `デルは火曜日の決算発表で大幅な成長を報告すると予想されており、アナリストらは来年の決算にプラスとなる可能性のある業界の動向に楽観的だ。`,
    source: "MarketWatch",
    sourceUrl: "https://www.marketwatch.com/story/why-dells-stock-stands-to-gain-from-developments-at-nvidia-and-spacex-7978fcaf?mod=mw_rss_topstories",
    publishedAt: "2026-09-01T11:26:00+00:00",
    category: "テクノロジー",
    imageUrl: "https://images.mktw.net/im-71759971",
    readTime: 2,
  },
  {
    id: "apple-enters-john-ternus-era-as-ai-chall-4f41457f",
    title: "Apple enters John Ternus era as AI challenges and memory crunch intensify",
    titleJa: "AI の課題とメモリ不足が激化する中、Apple はジョン・ターナス時代に突入",
    summaryJa: "Appleの次期CEOジョン・ターナス氏が2023年後半にCNBCで語ったとき、彼はテクノロジーについてすべてを語った。カスタム チップ、デバイスのバッテリー寿命、メモリ アーキテクチャが彼の主な関心の 1 つでした。2年前にハードウェア責任者に就任したターナス氏は、「適切なコンポーネント、適切なシリコン、その他のテクノロジーを搭載した適切な製品を作れば、人々はその製品を気に入ってくれる」とインタビューで語った。",
    bodyOriginal: `When incoming Apple CEO John Ternus spoke to CNBC in late 2023, he was all about the technology. Custom chips, device battery life and memory architecture were among his primary interests.
...
"From the very beginning, we're thinking about how are all these pieces going to come together to make the best possible product for our customers," he said.`,
    bodyJa: `Appleの次期CEOジョン・ターナス氏が2023年後半にCNBCで語ったとき、彼はテクノロジーについてすべてを語った。カスタム チップ、デバイスのバッテリー寿命、メモリ アーキテクチャが彼の主な関心の 1 つでした。
2年前にハードウェア責任者に就任したターナス氏は、「適切なコンポーネント、適切なシリコン、その他のテクノロジーを搭載した適切な製品を作れば、人々はその製品を気に入ってくれる」とインタビューで語った。
火曜日、ターナス氏の仕事はさらに大きくなり、ティム・クック氏の後任となり、スティーブ・ジョブズ氏が死去する直前の2011年に退任して以来、アップルの2人目のCEOとなる。同社に25年間勤務するベテランは、ソフトウェアやデバイスから財務、法務まであらゆる責任を負う一方、人工知能分野での戦略をまだ完全には実行していない4兆7000億ドル規模の企業のビジョンを明確にする必要もある。
アップルの代表者らは、65歳のクック氏から51歳のターナス氏への移行は「思慮深く」かつ「スムーズ」になるだろうと述べた。ターヌス氏は4月に後継者が発表された際、アップルの「価値観とビジョン」を引き継ぐと述べた。
それは声明の中で述べられていました。それ以来、投資家や顧客は実際の生活で同氏からほとんど何も聞いていない。1カ月前の最後の決算会見でさえ、クック氏は依然として同社の表の顔であり続けているからだ。テルヌス氏は電話会議にはほとんど姿を現さず、アナリストから競争情勢について直接質問されると、「ティム氏の言ったことを繰り返す」と答えた。
「この分野で起こっていることはすべて、私たちにとって非常に多くのチャンスがあります」とテルヌス氏は語った。 「私たちは自分たちの計画に本当に集中しており、とても興奮しています。」
ターナスには、昇進時にクックには与えられなかった大きな贅沢がひとつあるだろう。 4月の声明によると、クック氏は退社するわけではないが、会長職に就き、今後も「世界中の政策立案者」などとの関わりを続ける予定だという。アメリカ国民が頑固なインフレに苦戦する中、アップルは世界的なメモリ危機に対処し、消費者向け機器の値上げを余儀なくされており、同氏はテルナス氏にとって極めて重要な同盟者だ。
指揮官としての最後の日に、クック氏は「次の章に興奮している」と述べた。
「私の肩書きは明日変わるが、Appleコミュニティに対する私の愛は決して変わらない」とクック氏は月曜日のXへの投稿で書いた。
リーダーシップの変更と移行に重点を置いているコンサルティング会社コッターの最高経営責任者（CEO）、キャシー・ガーシュ氏は、同氏の退任はアップルにとって、船を導く人物として誰が見られるかという点で難しいバランスを取ることになると述べた。ターナス氏には、株主、従業員、顧客に対し、自分なら会社を未来に導くことができる、そして昔の上司がやっていたようなことだけをやっているわけではない、と説得することが使命とされている。
ガーシュ氏はインタビューで、「ティム・クック氏にうまくいったことは、ジョン・ターナス氏にもうまくいくとは限らない」と語った。 「会社は新しい環境にいます。進化し続け、競争し続けなければなりません。」
iPhoneの発売に向けて準備中
世界の多くの人が初めて Ternus のことを知ることになるのは、9 月 9 日の Apple の年次発表イベントであり、そこで同社は新しい iPhone と Apple Watch を発表すると予想されています。クック氏はジョブズ氏の足跡をたどり、アップルの主要製品発表会のたびに登壇し、世界中で見出しを飾り、何百万人もの視聴者を集めた。
Appleは6月、AIチップとサーバーに対する飽くなき需要によるメモリ不足を理由に、MacBookとiPadの値上げを発表した。同社はまだiPhoneの価格を引き上げていないが、多くのアナリストはそのような発表がテルナス氏の任期中のかなり早い段階で行われると予想している。クック氏はMacBookとiPadに関する発表の直前にウォール・ストリート・ジャーナルに対し、Appleはより高いコストを顧客に転嫁しなければならないだろうと語った。
それは短期的な問題ではありません。メモリとコンポーネントの供給不足は収まる兆しがほとんどなく、ガジェットが今後さらに高価になる可能性があり、需要パターンと競争が恒久的に変化する可能性がある。
一方、生成AIブームにより、OpenAIやSpaceXなどの他の企業も新たなコンピューティングデバイスを模索するようになっている一方、MetaやGoogleはスマートグラスの取り組みを進めており、いずれスマートフォンが置き換えられるのかという疑問が生じている。
Appleの株価は2026年現在までに約17％上昇しており、強力なデバイスサイクルと、メモリ不足への対応に苦戦しているAndroidのライバルに対する市場シェアの拡大のおかげで、ほとんどの超大型株の同業他社を上回っている。それでも一部のアナリストは、端末価格の上昇が販売台数の低迷をカバーし、その不足分が最終的にはアップルのサービス部門など他の主要分野に現れるのではないかと懸念している。
「成長が出来高によってもたらされるなら、それは素晴らしいことだ」と、ウォール街で株の売却を推奨する数少ないアナリストの一人であるキーバンクのアナリスト、ブランドン・ニスペル氏はインタビューで語った。 「投資家は、物価上昇による成長にプレミアムを支払わない。なぜなら、それは持続可能ではないからだ。」
Appleは、ハードウェアの価格の値上げに加えて、Apple TVと、iCloudストレージ、Apple Music、その他のサービスも含まれるバンドルサブスクリプションであるApple Oneの価格も引き上げた。また、一部のアナリストは、今秋予想されるアップルの折りたたみ式携帯電話の価格は最大2,500ドルになる可能性があると予測している。
ディープウォーター・アセット・マネジメントのマネジング・パートナー、ジーン・マンスター氏は、テルナス氏のハードウェア専門知識と数十年かけてエンジニアリング人材の採用に費やしたことは、デバイスの新時代を迎える可能性のあるアップルにとって恩恵となる可能性があると述べた。
「彼らは製品担当者と同行しましたが、それが重要だと思います」とマンスター氏は語った。マンスター氏は、今後数年間でテルナスは「人材採用に力を入れ、素晴らしい人材を呼び込む必要がある。彼らはまだ自らを改革する必要があるからである」と語った。
Appleはクック氏の任期中にAirPodsやApple Watchなどいくつかの新製品をリリースしたが、業界に革命を起こすようなものは何もなかった。同社の複合現実ヘッドセット「Vision Pro」はあまり売れていない。
報道や最近MacOSのベータ版で見つかったスニペットによると、同社はスマートホームガジェット、ロボット、AIカメラを搭載したAirPods、その他の新しいカテゴリーのデバイスに取り組んでいるという。テルナスが成功するには、大きな新ヒットが必要になるだろう。
これは彼が何年も考え続けてきた課題であり、2023年にCNBCで話し合った課題だ。
「私たちは最初から、これらすべての要素をどのように組み合わせて顧客にとって最高の製品を作るかを考えています。」と彼は言いました。`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/09/01/apple-enters-ternus-era-as-ai-challenges-and-memory-crunch-intensify.html",
    publishedAt: "2026-09-01T11:00:01+00:00",
    category: "金融政策",
    imageUrl: "https://images.unsplash.com/photo-1611974789855-9c2a0a7236a3?w=800&q=80",
    readTime: 8,
  },
  {
    id: "livestream-shopping-is-gaining-steam-in-3bf0043a",
    ...
    summaryJa: "シカゴのすぐ北にある倉庫から、セレブのヘアスタイリストであり、話題のヘアアイロン「Beachwaver」の CEO であるサラ・ポテンパは、TikTok ライブで商品を売りながら何時間も何千人もの視聴者を魅了し続けています。過去10年間中国でブームとなってきたこの種のライブストリームショッピングは、ソーシャルメディア大手TikTokと、評価額が200億ドルに達したばかりのライブコマースプラットフォームWhatnotのおかげで、米国でも勢いを増している。",
    bodyOriginal: `From a warehouse just north of Chicago, Sarah Potempa – celebrity hairstylist and CEO of the viral Beachwaver hair curling iron – keeps thousands of viewers hooked for hours selling products on TikTok live.
...
The U.S. live shopping industry is forecasted to reach nearly $20 billion in sales in 2026, about 35% higher year-over-year, according to eMarketer industry estimates.
...
Live shopping has been increasingly integrated into Chinese "super apps," which are utilized by millions of users and combine features like social media and messaging in the case of WeChat or AI assistance, food delivery and travel booking on Alibaba's Qwen.
...
TikTok Shop launched in 2023. The company shared exclusively with CNBC that live shopping sales more than doubled in the first half of 2026 compared to the same timeframe in 2025.
...
"The biggest challenge really is visibility," said Globaldata's Saunders. "You have to make sure that your feed is aligned with the algorithm and that it's putting you in front of the right people."`,
    bodyJa: `シカゴのすぐ北にある倉庫から、セレブのヘアスタイリストであり、話題のヘアアイロン「Beachwaver」の CEO であるサラ・ポテンパは、TikTok ライブで商品を売りながら何時間も何千人もの視聴者を魅了し続けています。
過去10年間中国でブームとなってきたこの種のライブストリームショッピングは、ソーシャルメディア大手TikTokと、評価額が200億ドルに達したばかりのライブコマースプラットフォームWhatnotのおかげで、米国でも勢いを増している。
Beachwaver は、CNBC が立ち会った 7 月下旬の TikTok ライブストリームの最初の 4 時間で約 8,000 ドルの売上を上げました。 10代の息子が彼女の後ろでDJをしている中、彼女は限定版のヘアアイロンを競売にかけた。ヘアケア製品のデモ。そして、500個の注文が売れたら、カメラの前で義理の弟の頭を生で剃ると視聴者に約束した。
これは、ビーチウェイバーが毎年行っている何百ものライブストリーミング番組のうちの 1 つでした。 2026年までのTikTokショップの売上高100万ドルのうち約4分の1はライブストリームによるもので、同社は独自の販売ショーを主催し、人気のソーシャルメディアアプリでアフィリエイトクリエイターと協力している。
過去数十年の QVC ブームを彷彿とさせるライブストリーム ショッピングでは、消費者はリアルタイムで商品を販売するホストの前に立つことができます。
同社によれば、QVCは最近破産から脱却した後、デジタルを優先しているため、現在、7つのチャンネルで週に200時間以上TikTokでライブを行っているという。
「QVCは、TikTokショップの競合相手と見られていたかもしれない、老舗の大手小売業者の良い例です…しかし実際には、彼らは本当に成功した販売者であることが判明しました」と、アメリカ大陸におけるTikTokショップ戦略イニシアチブ担当プレジデントのパトリック・ノメンセン氏は述べた。
Beachwaver は QVC から始まりました。 TikTok と Whatnot は車輪を再発明しました。
「誰も、『分かった、午後7時に10分あるから準備をしなさい、そして10分で終わりだ』とは言いません」とポテンパ氏は語った。 「デジタル プラットフォームをより長く使用する必要があるのは間違いありませんが、実際には収益をよりコントロールできるようになります。」
中国の足跡をたどる
eMarketer業界の推計によると、米国のライブショッピング業界は2026年に売上高が200億ドル近くに達し、前年比約35％増となると予測されている。
それでも、中国でのライブショッピングの急速な成長とは程遠い。
アリババは 2016 年に中国でタオバオ ライブを導入しました。eMarketer によると、市場は 5 年以内に 500 億ドルを超え、2026 年には 1 兆 1,000 億ドルを超えると予測されています。
ライブショッピングは中国の「スーパーアプリ」にますます統合されており、何百万人ものユーザーが利用しており、ソーシャルメディアやWeChatのメッセージング、アリババのQwenでのAI支援、食品配達や旅行予約などの機能を組み合わせている。
グローバルデータのマネジングディレクター、ニール・サンダース氏は「（中国の消費者は）依然として店舗が好きだが、デジタル体験のライブストリーム部分をエンターテイメント、エンゲージメント、インスピレーションとして利用している」と述べた。 「米国では、その役割を果たすために伝統的に店舗に依存する傾向が強かった。」
サンダース氏は、若い消費者が商品を見つけるためにライブコマースにさらに傾いているため、状況は変わりつつあると述べた。
米国のライブ ショッピングの優勝者
TikTok Shopは2023年にローンチした。同社はライブショッピングの売上が2026年上半期に2025年の同時期と比べて2倍以上になったとCNBCに独占的に共有した。
TikTokによると、同期間中にライブショッピングセッションの数は60％以上増加し、ライブの合計時間は80％以上増加したという。
2019 年に設立された Whatnot は、ノベルティや収集品を中心に視聴者を構築しました。過去1年間で急速に成長し、10月以来評価額が2倍になった。 Whatnot は、最も有望なベンチャー支援企業を特定する今年の CNBC Disruptor 50 リストで 8 位にランクされました。
ワトノットは、同社が米国最大のライブショッピングプラットフォームであるとしているが、国内売上高については明らかにしなかった。同社はCNBCに対し、2025年に報告した世界売上高80億ドルの大部分が米国であったと語った。
「Whatnot や TikTok では、一度に 5,000 人、10,000 人があなたの番組を視聴することができます」と、両プラットフォームでブランドの販売を担当するエリック・ペイガン氏は 8 月中旬のインタビューで語った。 「先週末、TikTokでショーを行ったのですが、その興行収入は6桁に達しました…ブランドがまだ気づいていないのは、そういう存在があるということだと思います。」
Whatnot の主な焦点は、視聴者がリアルタイムで商品に入札できるオークションです。 TikTokは1月にライブオークションを開始した。
Whatnot の最高収益責任者である Armand Wilson 氏は、「物事が本当に本当に順調に進んでおり、ライブ ショッピングがもう少し主流になりつつあると感じています」と述べています。 「1 年目は、ほとんどが収集品でした。今では、ほぼ誰でも Whatnot をダウンロードして、自分に合ったものを見つけることができます。」
Amazon、Walmart、eBay などの従来のオンライン マーケットプレイスにも、販売者がライブ ショッピング ストリームをホストするためのネイティブ プラットフォームがありますが、これらのプラットフォームはソーシャル メディア サイトほど本質的にビデオファーストではありません。
アマゾンとウォルマートはライブショッピング事業についてコメントを控えたが、イーベイライブの代表者は、このサービスによりショッピングが「より人間的」になると説明した。 3社ともCNBCとのライブストリーム売上高の共有を拒否した。
eBayのライブショッピング部門の元事業開発責任者で、現在は電子商取引コンサルティング会社And Luxeのオーナーであるマーク・ユアン氏は、従来のマーケットプレイスはその存在期間の長さに伴う消費者の信頼から恩恵を受けていると述べた。
「それらはお金で買えないものだが、残念なことに、彼らに利点をもたらすものは同時に障壁でもあるのかもしれない」と彼は言う。 「構造的に、発見優先またはコンテンツ優先のプラットフォームに変革することは非常に困難です。」
ショッピングの未来は？
新規参入者が成功しているのは、同じ考えを持つ消費者のためのフォーラムを作成することです。
収集品で特に人気のあるWhatnot社は、コミュニティを優先しており、Funko Popのフィギュア、ポケモンカード、​​スニーカー、ファッションなどの分野で成功を収めていると述べている。
「コミュニティに参加し、彼らの問題を深く理解し、それに基づいて製品を構築するという精神が、私たちを今日の地位に導いたものであり、私たちを本当に差別化するものであると私は考えています。」とウィルソン氏は述べています。
ライブストリームのホストであるペイガン氏は、視聴者の信頼がなければ「ライブをすることすら意味がない」と語った。
「あの人たちは私の友達です」と彼は付け加えた。 「彼らは、路上にいる普通の人が知らない私のことを知っていると信じています。そして、私たちはライブストリームでそれらの会話をしました。」
サーカナ社のチーフ小売アナリスト、マーシャル・コーエン氏は、ライブストリームショッピングは電子商取引と従来の小売業の間のギャップを埋めるのに役立つと述べた。
「製品に触れて感じることはできませんが、他の人から製品についての意見を聞くことはできます」とコーエン氏は語った。 「（ライブショッピングは）触れて感じることができないという欠点を補ってくれます。そして、それは常にオンラインの最大の課題でした。」
しかし、プラットフォームにはそれぞれ独自の課題があります。 WhatnotとTikTokは、偽造品や盗難品の問題と闘わなければならなかった。
売り手にとって、大規模なプラットフォームを活用するにはコストがかかります。Whatnot では商品に応じて売上の 4% から 8% の手数料がかかり、TikTok では 6% に加えて追加の支払い処理手数料がかかります。
そして、ライブショッピングの人気の高まりにより、目玉を争うのは難しくなってきています。
「最大の課題は実際のところ可視性です」と Globaldata の Saunders 氏は言います。 「自分のフィードがアルゴリズムに沿っていて、適切な人に表示されていることを確認する必要があります。」`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/09/01/tiktok-whatnot-livestream-shopping.html",
    publishedAt: "2026-09-01T11:00:01+00:00",
    category: "テクノロジー",
  ...
  {
    id: "onerail-launches-ai-platform-with-nvidia-57656631",
    title: "OneRail launches AI platform with Nvidia for retailers to make faster delivery decisions",
    titleJa: "OneRail が小売業者向けに Nvidia と共同で AI プラットフォームを立ち上げ、配達の意思決定を迅速化",
    summaryJa: "ラストワンマイル配送会社 OneRail は、AI を使用して小売業者がより迅速かつ効率的に配送を決定できるようにするため、Nvidia と共同で新しいプラットフォームを立ち上げています。",
    bodyOriginal: `Logistics company OneRail is launching a platform using Nvidia's artificial intelligence software to help retailers make faster decisions on the most efficient delivery options at scale, CNBC has learned.
...
"We're kind of doing for delivery what ChatGPT and Anthropic have done for words – it all works the same way," Daeschler said. "They give people more access to knowledge. We're giving people access to being able to do delivery in a way that's affordable. … That's all done based on original models, training on data that we have, just like words on the internet."`,
    bodyJa: `物流会社OneRailは、小売業者が最も効率的な配送オプションを大規模に迅速に決定できるよう、Nvidiaの人工知能ソフトウェアを使用したプラットフォームを立ち上げていることがCNBCでわかった。
OmniStar と呼ばれる新しいプラットフォームを使用すると、小売業者は OneRail 独自のデータを使用して、AI を使用してすべての配送オプションを評価し、個々の注文に最適な配送オプションを特定できます。
ラストワンマイル配送会社はCNBCに対し、新しいプラットフォームにより小規模な企業が大規模な配送を可能にし、アマゾンやウォルマートなど世界の小売大手と競争するためのマージンを改善できると語った。
電子商取引が成長するにつれて、小売業者は需要の急増に対応し、効率を最適化するために機敏なサプライチェーンに投資する必要がありました。しかし、こうした手動プロセスは小売業者や物流事業全体で細分化されていることがよくあります。
OneRail CEOのBill Catania氏はCNBCに対し、「電光石火の決断を下す能力がなければ、マージンを放棄することになる」と語った。 「ラストワンマイルのフルフィルメントには費用がかかります。」
パッケージに最適なルーティングを選択するのに以前は 20 分かかっていたかもしれないが、OneRail のプラットフォームでは AI を活用して 2 分半でそれができると述べた。カターニア氏は、時間が節約されたということは、小売業者がより大規模で、より速く、より正確なサプライチェーンを運営できることを意味すると述べた。
OneRail の AI 責任者である David Daeschler 氏は、「そこで人工知能の出番です。人工知能はそのような意思決定を非常に迅速に行っており、そのために Nvidia のハードウェアとソフトウェアが登場し、これを実際に大規模に機能させることができます」と述べています。
Daeschler 氏によると、同社は物流プロセスに AI を組み込む方法を模索するために 3 年前に Nvidia と提携し始めたという。
「その結果、静的なルールや手動の計画に依存するのではなく、適切なコストで適切な配送業者と配送モードに注文をルーティングできるリアルタイムの意思決定層が実現しました」と Nvidia の副社長兼小売および消費者向けパッケージ製品担当ゼネラルマネージャーの Azita Martin 氏は述べています。
カターニア氏は、1,200万人を超えるドライバーと1,000社を超える物流パートナーのネットワークを含むOneRailの独自データが、最も効率的なルートと配送オプションについてAIをトレーニングするために使用されていると述べた。
「これは彼らと私たちの利益のためです。私たちはより効率的に運営できます。彼らはコストを節約し、より良い顧客体験を提供します」とDaeschler氏は述べた。
同社はCNBCに対し、自社のプラットフォームはすでに一部の顧客に導入されており、その中には大手タイヤ販売会社も含まれており、オムニスターのおかげでリソースをより効率的に利用できるため、3年間でランレートが4,000万ドル節約できると考えていると語った。
また、同プラットフォームの第4四半期の流通総額は60億ドルを超えるだろうと推定している。
Nvidiaのマーティン氏は、このプラットフォームにより小売業者はより迅速な意思決定が可能になると述べた。
「小売業者にとって、より大きな価値は、サービスを犠牲にすることなく、より多くのシナリオを評価し、状況の変化により迅速に対応し、配送の経済性を改善できることです」とマーティン氏は述べた。
OneRail は、このプラットフォームにより、小規模小売業者が配送速度と効率性においてより効果的に競争できるようになると述べています。
OneRail は今年初めに、すべての顧客に同日配達サービスを提供するための FedEx との提携を発表し、顧客に最良かつ最速の配達オプションを提供しようとする小売業者の競争に加わりました。この提携により、OneRail は中小企業との連携も強化できるようになるとカターニア氏は付け加えた。
「私たちは、ChatGPT や Anthropic が単語に対して行ってきたことを、配信に対して行っているようなものです。すべて同じように機能します。」と Daeschler 氏は言います。 「それらは人々に知識へのより多くのアクセスを提供します。私たちは人々に手頃な方法で配信できるアクセスを提供しています。…それはすべてオリジナルのモデルに基づいて行われ、インターネット上の言葉と同じように、私たちが持っているデータに基づいてトレーニングされています。」`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/09/01/onerail-nvidia-ai-delivery-platform.html",
    publishedAt: "2026-09-01T11:00:01+00:00",
    category: "金融政策",
    imageUrl: "https://images.unsplash.com/photo-1611974789855-9c2a0a7236a3?w=800&q=80",
    readTime: 5,
  ...
  {
    id: "india-rejects-court-order-to-uphold-deca-ff878746",
    title: "India rejects court order to uphold decades-old water-sharing treaty with Pakistan",
    titleJa: "インド、パキスタンとの数十年にわたる水共有協定を支持する裁判所命令を拒否",
    summaryJa: "インド政府は、パキスタンとの数十年にわたる水共有協定を遵守し、係争中のカシミール地方での水力発電プロジェクトの建設を制限しなければならないとした仲裁裁定を断固として拒否した。ハーグの常設仲裁裁判所（PCA）は月曜日、1960年のインダス水協定についてパキスタンに有利な判決を下し、この歴史的な協定には依然として完全な拘束力があり、インドには協定を終了または停止する正当な理由はないと述べた。",
    bodyOriginal: `The Indian government has categorically rejected an arbitration ruling which said the country must uphold a decades-old water-sharing treaty with Pakistan and limit construction on a hydroelectric project in the disputed Kashmir region.
...
The Indus basin supplies about 80% of the country's irrigated agriculture, a sector that employs 65% of the labor force and represents roughly 25% of Pakistan's gross domestic product, according to data compiled by Chatham House.`,
    bodyJa: `インド政府は、パキスタンとの数十年にわたる水共有協定を遵守し、係争中のカシミール地方での水力発電プロジェクトの建設を制限しなければならないとした仲裁裁定を断固として拒否した。
ハーグの常設仲裁裁判所（PCA）は月曜日、1960年のインダス水協定についてパキスタンに有利な判決を下し、この歴史的な協定には依然として完全な拘束力があり、インドには協定を終了または停止する正当な理由はないと述べた。
インドは昨年協定の「停止」に動いたが、その決定は依然として有効であると述べた。
インド外務省は月曜日の声明で、「このいわゆる仲裁裁判所にはインドの主権的決定について宣告する権限は一切ない」と述べた。
「その声明は、現在も将来も、インドが実施しているプロジェクトに関連したインドの行動に影響を与えることはない」と付け加えた。
PCAはまた、インドに対し、カシミール地方のラトル水力発電所の建設を制限し、ダムの壁や一定レベルを超える電力取水構造の工事を禁止するよう命じた。この判決は、世界銀行が任命した中立専門家が最終決定を下してから90日後まで適用される予定で、決定は2027年7月までに行われる予定である。
この仲裁裁定は、核武装した隣国同士の間で長くくすぶっている水問題に新たなストレスを加えている。
続きを読む
世界銀行が仲介するインダス水条約は、インド、パキスタン、アフガニスタン、中国にまたがるインダス流域の河川の利用を管理している。この協定に基づき、インドは流域東部の河川への無制限のアクセスを得る一方、パキスタンは西部の河川への権利を得る。
この条約は3度の戦争と長期にわたる外交的緊張に耐えてきたが、近年は緊張が高まっている。
水の安全保障
インドは昨年4月、カシミール地方での武装勢力による攻撃を受けて、この条約の停止に動いたが、デリーはパキスタンを非難したが、イスラマバードは関与を否定した。
パキスタンのイシャク・ダル外相はソーシャルメディアを通じて、イスラマバードはPCAの裁判所の判決を歓迎すると述べた。
「この賞は、拘束力のある国際条約を一方的に停止したり破棄したりすることはできないというパキスタンの一貫した立場を証明するものである。インドは条約に基づく義務と紛争解決メカニズムの拘束力のある決定を完全に遵守しなければならない」とダル氏は月曜日に述べた。
パキスタンは下流国としてインダス水条約に大きく依存しており、何千万人もの人々が生計と生存を川の水に依存している。
チャタム・ハウスがまとめたデータによると、インダス川流域はパキスタンの灌漑農業の約80％を供給しており、この部門は労働力の65％を雇用し、パキスタンの国内総生産の約25％を占めている。`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/09/01/india-hague-ruling-pakistan-water-treaty.html",
    publishedAt: "2026-09-01T10:58:31+00:00",
    category: "金融政策",
    imageUrl: "https://images.unsplash.com/photo-1611974789855-9c2a0a7236a3?w=800&q=80",
    readTime: 3,
  },
  {
    id: "10-year-yield-hits-highest-since-january-6e23a898",
    title: "10-year yield hits highest since January 2025 as Middle East tensions return to focus",
    titleJa: "中東の緊張再び焦点となり、10年債利回りは2025年1月以来の高水準に",
    summaryJa: "中東情勢の新たな緊張により世界の政府借入コストが昨年初めに遡って最高値に達したことを受け、火曜日の米国債利回りは上昇した。住宅ローン、自動車ローン、クレジットカード債務の主要指標である10年米国債利回りは2ベーシスポイント以上上昇し4.784％となり、2025年1月14日以来の高水準となった。",
    bodyOriginal: `U.S. Treasury yields increased on Tuesday, as renewed tensions in the Middle East drove global government borrowing costs to their highest point going back to early last year.
...
Investors are also monitoring the G20 finance ministers' meeting in Asheville, North CarolinaN.C., which is set to conclude later Tuesday, as well as a raft of domestic economic data, including the ISM Manufacturing PMI print and the Job Openings and Labor Turnover Survey, with nonfarm payrolls figures expected Friday.`,
    bodyJa: `中東情勢の新たな緊張により世界の政府借入コストが昨年初めに遡って最高値に達したことを受け、火曜日の米国債利回りは上昇した。
住宅ローン、自動車ローン、クレジットカード債務の主要指標である10年米国債利回りは2ベーシスポイント以上上昇し4.784％となり、2025年1月14日以来の高水準となった。
地政学的な出来事に連動する傾向がある長期の３０年米国債利回りも５．２７１％と２ベーシスポイント以上上昇した。
通常、米連邦準備理事会（FRB）の短期金利決定に連動して変動する２年国債利回りは横ばいの４．３５％となった。
1 ベーシス ポイントは 0.01%、つまり 1% の 100 分の 1 に相当し、利回りと価格は相互に反比例します。
米軍が先にイランに対して新たな攻撃を開始し、オマーン沖のホルムズ海峡でタンカーが未知の飛翔体に衝突されたことを受け、トレーダーらが中東情勢の動向を引き続き検討しており、借入コストが上昇した。
このエスカレーションにより原油価格が上昇した。ウェスト・テキサス・インターミディエイト先物は直近で1.49%高の1バレル当たり87.04ドル、国際原油価格の指標であるブレント原油は1.34%上昇して91.71ドルとなった。
投資家はまた、ノースカロライナ州アッシュビルで火曜遅くに閉幕する予定のノースカロライナ州アシュビルで開催されるG20財務大臣会合や、金曜日に予想される非農業部門雇用者数を含むISM製造業PMI統計や求人・離職率調査など多数の国内経済データにも注目している。`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/09/01/bonds-treasury-yields-middle-east-tensions.html",
    publishedAt: "2026-09-01T10:47:52+00:00",
    category: "エネルギー",
    imageUrl: "https://images.unsplash.com/photo-1473172367879-2dca04a4dca4?w=800&q=80",
    readTime: 2,
  },
  {
    id: "i-climbed-the-career-ladder-and-got-my-d-a086f5d2",
    title: "I climbed the career ladder and got my dream job at 30 - then I hit burnout",
    titleJa: "キャリアのはしごを登り、30歳で夢の仕事に就いたが、その後燃え尽き症候群に陥った",
    summaryJa: "キャリアのはしごを登り、30歳で夢の仕事に就いたが、その後燃え尽き症候群に陥った- 公開されました",
    bodyOriginal: `I climbed the career ladder and got my dream job at 30 - then I hit burnout
- Published
...
- Published3 hours ago`,
    bodyJa: `キャリアのはしごを登り、30歳で夢の仕事に就いたが、その後燃え尽き症候群に陥った
- 公開されました
ジョー・フーパーは、キャリアのはしごを登ろうと 20 代を過ごし、昇進と昇給で急速に階級を上げました。
「私はそれが得意でした」と、元コミュニケーションの専門家であるジョーは言いました。
しかし、30歳で夢の役を獲得した直後、ジョーは燃え尽き症候群に苦しみ、仕事を休まなければならなかった。
燃え尽き症候群は、世界保健機関 (WHO) によって身体的および精神的な疲労の状態として認識されています。
最近の統計によると、英国では2024年から2025年にかけて仕事関連のストレスにより2,200万労働日が失われている。
現在39歳で、グラモーガンの谷のペナースに拠点を置くジョーは、「30歳までにコミュニケーション部門の責任者になりたかった。そのためには、皆さんが期待するすべてのことを実行し、長時間労働し、上司の子供たちを学校に連れて行くなどのおかしなことも含め、すべてにイエスと答えた」と語った。
「すべて良いチャンスだと心から思ったので、両手で掴むつもりだった」とジョーは語った。
「バスルームで泣きながら過呼吸になったのを覚えていますが、『これは持続可能ではない』と思ったことは一度もありませんし、『もうこれ以上できない』と思ったこともありませんでした。
「転職する必要があるし、大丈夫だと思っていたんです。修正するには別の組織が必要だと思ったが、私の振る舞い方、私に期待されていると思っていたことはどこでも同じだった。」
ジョーは管理職に就いてから 1 年で燃え尽き症候群に陥り、1 年以内に 2 回の故障につながりました。
「間違いなく、体と心に無理を強いられたのだと思います」と彼女は語った。
「脳の働きが遅くなったように、意思決定をするのが本当に難しいと感じました。誰かがスイッチを入れて、脳が壊れてしまったような感覚を覚えています。」
慈善団体メンタルヘルス UK の報告によると、2025 年には 18 ～ 24 歳の社外の若い従業員の 5 人に 2 人がストレスによるメンタルヘルス不良のため休暇をとりました。
しかし、人々が仕事をどのように承認されるかについて懸念が提起されています。
今年初め、数百人の一般医がBBCに対し、精神的健康上の問題を理由に患者の仕事を休むことを拒否したことは一度もないと語った。
オリンピック選手のラヴィアイ・ニールセン氏は最近BBCに対し、2024年パリオリンピック後に燃え尽き症候群に気づくのが遅すぎたと語った一方、緑の党のカーラ・デニエ議員は5月に燃え尽き症候群のため休暇を取ると発表した。
ウェールズ北部の心理学者兼ビジネスコーチであるジル・ウィリアムズ博士は、燃え尽き症候群に悩む人々への協力を専門としています。
彼女は、「実際、このようなことを経験する可能性が高いのは、完璧主義者や余分な努力をする人です。
「残念なことに、あなたを昇進させる同じ特性は、あなたを燃え尽きさせるものでもあります。」
ウェールズ公衆衛生局のエイミー・デイビス氏は、燃え尽き症候群という言葉はストレスと同じ意味で使われる可能性があるが、この2つは別のものだと述べた。
「ストレスは溺れるように感じますが、燃え尽き症候群は泳ぐものが何もなくなったように感じます」と彼女は言いました。
両専門家は、BBC ニュースが燃え尽き症候群に関する神話や誤解を打ち破るのに貢献してくれました。
燃え尽き症候群は常に仕事に関連しているのでしょうか?
「これは必ずしも仕事だけではありません。介護者や学生、長期的なストレスがかかるあらゆる状況で非常に多く見られます」とウィリアムズ氏は言う。
これは長期にわたる管理されていないストレスによって引き起こされるため、持続的で厳しい役割や責任から生じる可能性があります。
燃え尽き症候群はうつ病や不安症とは違いますか?
燃え尽き症候群とうつ病は別個の状態であり、WHO は燃え尽き症候群を精神的健康状態や病気とはみなしていません。
「燃え尽き症候群の経験に対処しないと、そのような症状が進行する可能性があります」とデイビス氏は言う。
休暇を取れば燃え尽き症候群は治るでしょうか？
「時には役立つこともありますが、苦痛を引き起こしている状況を変える必要もあります」とデイビス氏は言う。
「多くの人にとって休息は必要ですが、それだけでは必ずしも十分ではありません。仕事に戻っても、仕事に対する姿勢が同じであれば、結果は同じでしょう。ですから、何かを変える必要があります」とウィリアムズ氏は付け加えた。
ジョーさんは、それが持続可能ではないと悟り、キャリアを辞めることになりました。彼女は不安症とうつ病と診断されました。
「休んでも燃え尽き症候群は治らないということを、私は苦労して学びました。もちろん、休んでも燃え尽き症候群は治りませんでした。燃え尽き症候群や衰弱の原因となったものを実際に変えることが、それを乗り越える唯一の方法なのです。」
「今、私は女性として、他の人たちに仕事を減らすよう説得するという使命を担っています。なぜなら、10年間そうせずに過ごしてきたからです。そのせいで心が折れそうになったのです。」
ジョーは、他の人が燃え尽き症候群に陥るのを避けるために、経営者や雇用主をサポートするために人前で講演したりコーチングを行っています。
「私は自分のビジネスをコントロールし、自分のビジネスを経営し、それがどのように機能するかを決めることができ、何をするか、誰と働くかを決めることができます。それが私にとってプロセスの大きな部分を占めています」と彼女は語った。
「私は、可能な限り生産性を高めようとするこの最適化の文化が大嫌いです。自分自身と生産性を常に最適化する必要があると感じると、私たちはより多く働き、より少ない生活を強いられるだけです...それはゴミ箱に捨てるべきだと思います。」
一部の労働者は、助産師や教師などのスタッフが燃え尽き症候群で離職するのではないかと懸念を表明している。
英国王立助産師大学組合のハンナ・レナード氏は、「助産師は並外れた仕事をしている。彼らは資格を得てから数年で燃え尽きてしまうのではなく、自分の職業に誇りを感じるのが当然だ」と語った。
教組NASUWTのニール・バトラー氏は、「教育に喜びを取り戻すためには変化を起こさなければならない。容赦ない苦労ではあるが、ウェールズの教室からは優秀な教師を失い続けるだろう。」と語った。
労働組合会議CymruのLaura Doel氏は、「私たちの調査によると、職場での最大のリスクはストレスであり、化学物質への暴露、高所での作業、危険な機械などの従来の危険よりも高い」と述べた。
同氏は、福利厚生措置を提供する雇用主の行動は歓迎されるが、「低賃金、不安定な契約、不可能な仕事量」といったストレスの根本原因に取り組むことが鍵だと述べた。
英国の職場の健康と安全に関する国家規制当局である健康安全執行局の報道官は、「雇用主には、仕事の主要な分野を評価し、適切に管理することによって、仕事関連のストレスを引き起こす危険因子から労働者を守る法的義務がある」と述べた。
ウェールズ政府は、雇用主や労働組合と協力してプレッシャーを軽減し、職員の健康を支援し、適切なメンタルヘルス支援が確実に受けられるように取り組んでいると述べた。
あなたまたはあなたの知り合いがこの記事で提起された問題の影響を受けている場合は、利用可能なヘルプとサポートに関する情報を BBC Action Line で見つけることができます。
関連トピック
その他のトップ記事
- 1 日前に公開
- 1 日前に公開
- 3 時間前に公開`,
    ...
    publishedAt: "2026-09-01T05:23:56+00:00",
    category: "貿易",
    imageUrl: "https://ichef.bbci.co.uk/ace/standard/240/cpsprodpb/b28d/live/b62f7fb0-a222-11f1-bd6a-3d72a7f54a3e.jpg",
    readTime: 8,
  },
  {
...
ソスニック氏は、「意識しているか、そうありたいかにかかわらず、私たちは今、少なくともある程度は石油トレーダーになっている」と語った。`,
  ...
  {
    id: "feeling-nostalgic-for-summer-how-to-beat-b5ddb038",
    title: "Feeling nostalgic for summer? How to beat the back-to-work blues",
    titleJa: "夏を懐かしみませんか？仕事復帰後のブルースを克服する方法",
    summaryJa: "夏を懐かしみませんか？仕事復帰後のブルースを克服する方法- 公開されました",
    bodyOriginal: `Feeling nostalgic for summer? How to beat the back-to-work blues
- Published
...
- Published20 June
- Published9 February`,
    bodyJa: `夏を懐かしみませんか？仕事復帰後のブルースを克服する方法
- 公開されました
アラームが鳴るとショックで目が覚めます。夏休みも終わり、未読メールでいっぱいの受信箱に直面する時が来ました。
先週の今頃、生活は大きく変わっていました。あなたは、家族の楽しみと自分の時間をバランスよくとりながら、夜遅くまで、のんびりとした朝を楽しんでいたのです。
仕事が楽しくても、休日から仕事への移行は、特に日が短くなり始める9月には大変になることがあります。
移行を少し簡単にする方法をいくつか紹介します。
小さなタスクにチェックを入れる
最初に最も困難なタスクにすぐに取り組みたくなるかもしれません。
しかし、キャリアコーチのサラ・ロビンソン氏は、小さくて扱いやすいタスクから始めて「すぐに勝てる」ように「楽に戻って」いく方が良いと言う。
「大量の受信トレイがあると、時には圧倒されてしまうことがあると思うので、勢いをつけようとしているのです」と彼女は言います。
スーザン・カー顧問も同意する。彼女は、それがすべての業界で可能というわけではないが、実行可能な場合は「オフィスに戻った最初の日に何をする必要があるかについて、もう少し親切に考えてください」と述べています。
そうなると、一日中会議を繰り返すのではなく、メールのやり取りに一日を費やすことになるかもしれません。
プライマリ・ケアのリーダーシップ・コンサルタントであるタラ・ハンフリーさんは、復帰初日は会社を休むことを推奨しています。
「それは、できることなら隠れて、少しだけ自分に余裕を与えることです。」
また、彼女は、社外メッセージを明確に書いて、オフィスに戻ったときにフォローするように人々に奨励することで、仕事への復帰が容易になるとも述べています。これにより、休暇中に何か重要なことを見逃しているのではないかというストレスが軽減されます。
代替手段があります。彼女は、休暇中に送信されたすべての電子メールを単純に削除していた同僚のことを思い出しました。
「彼はこう言いました、『人々が私を必要とするなら、彼らは私のところに戻ってくるでしょう』。」
観光客気分を満喫 - でも家にいるように
カー氏は、休暇中に何が楽しかったのか、そしてそれを「日常生活にもっと組み込む方法はないか」を思い出すことも価値があると言う。
毎日シエスタをとるのは現実的ではないかもしれないが、スペイン料理を作ってみるのもいいかもしれない、と彼女は提案した。
彼女はまた、新しい場所に行っても好奇心を持ち続け、自分の地域の観光客になれるよう努めることを勧めています。
「もし私たちがどこか別の場所に行ったら…私たちは建築を見たり、建物を訪れたりするかもしれません。そして私は思うのですが、マンチェスターでこれを犯していることはわかっていますが、私たちは目の前にあるものに常に感謝しているわけではありません。」
ウェルビーイングコーチングサービス「Alive 365」を運営する心理療法士のジョイ・コンロン博士もこれに同意する。
「休暇中の家でリフレッシュできる部分を 1 つ持っていきましょう。それは、夜の散歩、画面を見ずに食事をする、画面を見ずに寝る前に読書する、または単に屋外で過ごす時間を増やすなどです。
自分の役割を振り返る
症状を治療するのではなく、仕事復帰後のブルースの根本原因を検討する価値があるかもしれません。
以前、彼女はカウンセラーであり、カーは弁護士として働いていました。
「休暇に行く前から、物事がうまくいっていないことに漠然と気づいていて、かなりストレスを感じていました」と彼女は言います。
「休暇で出かけて戻ってくると、突然毎日涙が溢れてきました。それはただ適応するのに時間が必要だったというだけではなく、再考が必要だというサインだった。」
しかし、長い間横になっていたことへの一時的な郷愁と、仕事に対する本物の不満をどうやって見分けることができるのでしょうか?
「それはおそらく非常に明白に聞こえるかもしれません」とカーは言う、「しかし、その兆候の1つはそれがどれだけ長く続くかであると思います。」
「それは時間の長さだけでなく、おそらく感情の激しさでもあるのでしょう。」
サンベッドに横たわっていると、すべてをやめてスキューバダイバーのインストラクターやヨガの先生として再訓練することを空想するのは簡単ですが、カー氏は「突然の反応」をしないように警告します。
「時間をかけて、どのように変化を起こすかを考えることが大切です。」
次の休暇を予約して、アクティブに過ごしましょう
慈善団体「アクション・フォー・ハピネス」の最高経営責任者マーク・ウィリアムソン博士は、休暇そのものが楽しくて有益であるだけではなく、旅行への期待も重要な役割を果たしていると語る。
そして、どのような種類の休暇を過ごすか、どのくらいの期間旅行するかによって、全体的な影響が変わる可能性があります。
ウィリアムソン氏は、「本当に驚くべき」研究結果を指摘しており、単にプールサイドで横になるよりも、身体的に活動的な休日の方が健康によい可能性を示唆する外部の研究であると指摘している。
「ウォーキング、サイクリング、水泳、探検などを取り入れると、リフレッシュした気分になれる可能性が高くなります」と彼は付け加えた。
考慮すべきもう1つの要素は、次の休憩の長さだ、と彼は言います。
「休憩を長くすると刺激は大きくなりますが、より大きな山に戻ることもあり、効果が弱まるのが早くなるようです。
「短くても定期的な休憩がより多くの健康上の利益をもたらすという証拠がいくつかあります。 5 日離れてからリフレッシュするのは、10 日もそう遠くないように感じるかもしれませんが、2 倍の頻度で行うことができます。」
連絡する
...
- 2 月 9 日発行`,
    ...
    publishedAt: "2026-08-31T23:37:35+00:00",
    category: "マクロ経済",
    imageUrl: "https://ichef.bbci.co.uk/ace/standard/240/cpsprodpb/6542/live/43e361e0-9702-11f1-beff-6d9a50bab282.jpg",
    readTime: 6,
  },
  {
...
Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.`,
  ...
  },
  {
    ...
    titleJa: "Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.",
    summaryJa: "Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.",
    bodyOriginal: `Amazon rigged billions in ad pricing, lawsuit from states and US watchdog alleges
- Published
...
Sign up for our Tech Decoded newsletter to follow the world's top tech stories and trends. Outside the UK? Sign up here.`,
    bodyJa: `アマゾンが数十億ドル規模の広告価格を不正操作、州と米国の監視機関から訴訟
- 公開されました
米連邦取引委員会（FTC）と22州の超党派グループは、アマゾンが広告価格設定に利用するオンラインオークションを操作し、密かに100万人以上の広告顧客から過大な料金を請求したとして訴訟を起こした。
FTCと各州は月曜日に起こした訴訟の中で、この疑惑のスキームにより同社は2019年以降、広告顧客から200億ドルの利益を得た可能性が高いと述べている。
同社の地元ワシントン州に提出された訴状には、「アマゾンは利益を増やすために実際のオークション結果を上書きし、アマゾンが設定したより高い価格に置き換えている」と述べられている。
アマゾンはBBCへの声明で、広告主を誤解させ、訴訟は「誤った」ものであるとする前提に「強く反対」した。
広告主に加えて、米国の消費者監視機関であるFTCと各州は、追加費用が買い物客に転嫁されることでAmazonの顧客も被害を受けていると述べている。
訴状には「消費者は苦しんでおり、これまで苦しんできており、その結果、今後も重大な損害を被り続けるだろう」と述べられており、アマゾン側は即座に反発した。
アマゾンは声明で、「FTCはこの訴訟が消費者への価格引き上げに関するものであると国民に信じてもらいたいと考えているが、そうではない」と述べた。
訴訟の発表を受けて同社株は下落し、月曜日は２．５％安で取引を終えた。
多くのブランドや販売者は、消費者が Amazon の e コマース プラットフォームでキーワードを使用して商品を検索する際に、スポンサー プロダクト広告とスポンサー ブランド広告を掲載するために Amazon 上で競合しています。
これらの掲載枠はオークションで最高額入札者に競売にかけられます。
告訴状では、アマゾンが、いわゆる「セカンドプライス」オークションで密かに広告主に高額な料金を請求していると非難している。このオークションでは、広告主候補者は、落札するたびに次に高い入札者よりも1セント多く支払うことを期待している。
しかし訴状によれば、実際にはアマゾンはスポンサープロダクト広告主に対し、80％近くの確率で自社の落札価格を請求しているという。
訴状では、アマゾンの手法に拍車がかかったのは「広告オークションが生み出している収益の多さに同社が不満を抱いていた」ためだと述べている。
アマゾンはこれに対し、FTCは「広告主の運営方法を根本的に誤解している」と述べた。
アマゾンは声明で「広告主はオークションの仕組みの説明ではなく、実際のパフォーマンスに基づいて入札を調整している」と述べた。
「スポンサープロダクト検索広告では、2019年から2025年にかけて平均落札価格が50％減少し、掲載された広告の約92％が最高入札価格で落札されなかった」と同社は付け加えた。
アマゾンは過去にも消費者監視機関と対立したことがある。
同社は昨年、数百万人の消費者を同意なしにプライム会員サービスに登録し、意図的に消費者のキャンセルを困難にさせたとしてFTCとの訴訟で和解した。
アマゾンは民事罰金と消費者への返金を含む25億ドルで訴訟を解決した。
アマゾン、プライム顧客を騙したとして25億ドル支払うことに同意
- 2025 年 9 月 25 日発行
なぜアマゾンには欧米のライバルがいないのか？
- 5 月 18 日公開
Tech Decoded ニュースレターに登録して、世界のトップのテクノロジー ストーリーやトレンドをフォローしてください。英国外ですか？ここからサインアップしてください。`,
    ...
    publishedAt: "2026-08-31T21:28:49+00:00",
    category: "テクノロジー",
...
ここからマイク・サントリのマーケットメモを購読してください`,
  ...
  },
  {
    ...
    summaryJa: "フランスの財政悪化と政治的行き詰まりは債券投資家の懸念を強めており、再び厳しい予算闘争が迫り、借入コストは金融危機時代の最高水準に近づいている。欧州連合第2位の経済大国は、近年、度重なる政情不安と増大する財政負担に耐えている。財政赤字や債務制限に関する欧州委員会の規則に繰り返し違反しており、状況を収束させるための改革、歳出削減、増税の試みが失敗し、歴代首相が追放されている。",
    bodyOriginal: `France's deteriorating public finances and political deadlock are becoming a growing concern for bond investors, with borrowing costs near financial-crisis-era highs as another difficult budget battle looms.
...
The question for investors now, she said, is whether policymakers can muster the political will to put public finances on a more sustainable path before market pressures intensify.
"French government bonds already trade more cheaply than their Italian equivalents, which would have been unthinkable not that long ago — but they could get even cheaper in a negative scenario," she said.`,
    bodyJa: `フランスの財政悪化と政治的行き詰まりは債券投資家の懸念を強めており、再び厳しい予算闘争が迫り、借入コストは金融危機時代の最高水準に近づいている。
欧州連合第2位の経済大国は、近年、度重なる政情不安と増大する財政負担に耐えている。財政赤字や債務制限に関する欧州委員会の規則に繰り返し違反しており、状況を収束させるための改革、歳出削減、増税の試みが失敗し、歴代首相が追放されている。
フランスはEUの過剰赤字手続きの対象となっており、理事会は2029年までに過剰赤字を解消するよう勧告しているが、その道のりは長い。
EUの条約では、政府赤字の基準値をGDP比3％、政府債務の基準値を60％と定めている。昨年、フランスの財政赤字はGDPの5.1％に達し、債務の対GDP比は115％を超えた。
IMFは7月、フランスの政府総債務が2026年にはGDPの約118.5％に達し、2027年には120％を超え、2030年までその水準を上回る状態が続くと予想した。
同時に、経済は成長に苦戦しており、今年の最初の3か月は前四半期比で0.2％縮小し、第2四半期には停滞した。
この混乱は同国の債券市場に深刻なストレスを引き起こしており、フランス国債の利回りは過去1年間で劇的に上昇しており、米国とイランの戦争が世界の借入コストに与えた影響によりさらに悪化しており、フランスはG7の中で最も高い政府借入コストの一部となっている。
フランス１０年国債利回りは先週、４．１３％超と２００８年以来の高水準を付け、金曜日も４．１％付近で推移した。債券の利回りと価格は逆方向に動きます。
フランス国民議会はイデオロギー的に亀裂が生じており、不信任投票、政府の崩壊、国家予算の行き詰まりにつながっている。
フランスは２０２７年度予算案を１０月初旬までに議会に提出する予定。昨年の予算案は膠着状態に陥り、数カ月の遅れを経てセバスティアン・レコルヌ首相が法案を議会で強行採決した。
レコルヌ氏は2025年に任命され、わずか2年間でこの役職に就いた5人目の人物となった。政治的不一致により実行可能な政府プログラムを構築することが非常に困難になっているとして、就任わずか27日で辞任した。レコルヌ氏は辞任から数日後に再任された。
フランス国債を圧迫するもう一つの不確実要因は、極右候補マリーヌ・ルペン氏が現在エマニュエル・マクロン氏後継の最有力候補となっている2027年の大統領選挙だ。
借金問題の「看板児」
ナインティワンのマルチアセット収入責任者、ジョン・ストップフォード氏はＣＮＢＣに対し、新型コロナウイルス感染症のパンデミック、戦争、相次ぐエネルギー危機を受けて、財政赤字の膨張と成長鈍化が世界的な問題となっているが、フランスは「際立っている」と語った。
同氏は電話会議で、「これはフランスだけの問題ではないが、多くの点でフランスは代表的な国の一つであると言えるだろう」と語った。 「ですから、これはフランスに限ったことではないと思いますが、フランスの財政は間違った方向に進んでいます。」
同氏は、先進国政府が帳尻を合わせ、債務をより持続可能な軌道に乗せる方法を見つけるという広範な課題があると述べた。そうしなければ、ある時点で「債券市場の反乱」が起こる可能性が高いとストップフォード氏は付け加えた。
同氏はフランスについて「人々が懸念する理由が分かる」と語った。 「これがどのように良い形で終わるかは明らかではありません。」
OAT市場に立ちはだかる大きな不確実性は来年の大統領選挙だ、とストップフォード氏は語った。
ルペン氏は木曜日の候補者討論会で、政府は「歳出を大幅に削減しなければならない」と述べ、パリの債務水準の推移について「非常に懸念している」と付け加えた。
しかしストップフォード氏はＣＮＢＣに対し、市場はルペン氏に財政をより持続可能な基盤に置くことにそれほど意欲があるかどうかについて懐疑的だったと語った。
同氏は「来年５月以降に政権や政策の優先順位が変更される可能性があるのは明らかだが、実質的な財政健全化への意欲がそれほどあるのかどうかを人々は疑っている」と述べた。 「そうですね、私たちは危機に直面しているかもしれないと思います。ただ、それが今日なのかどうかはわかりません。」
改善の兆しはほとんどない
ナティクシスCIBの金利ストラテジスト、テオフィル・ルグラン氏はCNBCに対し、同氏のチームはすでにOATが「プレストレス」であると見ていると語った。
同氏は「回復を遅らせる可能性があるのは国内政治だけでなく、より広範なマクロ背景もある」と述べた。 「市場はフランスが早ければ2027年にも3％の財政赤字に戻るとは予想していないが、2027年の予算が公的債務安定化に向けた信頼できる中期的道筋と一致する兆しを探している。その道筋を実現するのはますます困難になっている。戦争関連の背景と長期金利の上昇によりすでに財政方程式が複雑になっているが、今夏の熱波と山火事でさらに不確実性が高まっている。」
予算審議と大統領の力学がより密接に絡み合っているため、今年の最後の数カ月間と2027年の第1四半期は、OATのボラティリティが再び高まる可能性が最も高い時期だとルグラン氏は付け加えた。
「とはいえ、われわれは2024年／2025年のショックパターンが繰り返されるとは予想していない。OATのバリュエーションはすでにかなり強調されているようだ。当社の公正価値モデルは、政治的プレミアムを加える前であってもOATが約15ベーシスポイント割安であることを示唆しており、われわれの年末予想は、予算が可決されれば10年OATと独国債のスプレッドが約75ベーシスポイントとなるのに対し、予算が可決されずフランスが特別予算法に移行した場合は約80ベーシスポイントとなる」と述べた。
インサイト・インベストメントの投資スペシャリスト責任者、エイプリル・ラルース氏は、フランス経済に関連した暗い見出しが増えているにもかかわらず、「フランスが債務動向に必要と思われる種類の財政調整を準備しているという兆候は驚くほどほとんどない」と述べた。
同氏は「成長期待は下方修正されており、債務は増加を続ける見通しで、債券利回りは現在、金融危機以来見られない水準にある」と述べた。 「しかし、意味のある支出抑制は依然として政治的に難しい。年金改革は2027年の選挙後まで事実上延期され、議会は大きく分裂しているため、政府は根本的な財政問題に取り組むよりも政治の安定を維持することに重点を置いているようだ。」
同氏は、投資家にとって今の問題は、政策立案者が市場の圧力が強まる前に財政をより持続可能な軌道に乗せる政治的意志を結集できるかどうかだ、と述べた。
「フランス国債はすでにイタリア国債よりも安く取引されているが、少し前までは考えられなかったが、マイナスのシナリオではさらに安くなる可能性がある」と同氏は述べた。`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/08/31/france-debt-bond-yields-budget.html",
    publishedAt: "2026-08-31T05:08:47+00:00",
    category: "エネルギー",
    imageUrl: "https://images.unsplash.com/photo-1473172367879-2dca04a4dca4?w=800&q=80",
    readTime: 7,
  },
  {
    id: "jackson-hole-analyst-roundup-warsh-s-spe-73eaf0bb",
    title: "Jackson Hole analyst roundup: Warsh's speech sends hike chances higher, may put Fed `at odds' with Treasury",
    titleJa: "ジャクソンホールのアナリストまとめ：ウォーシュ氏の講演で利上げの可能性が高まり、FRBは財務省と「対立」する可能性がある",
    summaryJa: "ジャクソンホール会合でのケビン・ウォーシュ連邦準備制度理事会議長の演説でのスタンスが予想外にタカ派的で、来月の利上げに対する市場の期待が高まった。月曜日は金が下落し、アジア株も下落した。 ＣＭＥのフェドウォッチツールによると、フェデラルファンド先物トレーダーらは９月に１５％ポイント利上げの確率が６０．４％とみており、金曜日の約５６％から上昇している。",
    bodyOriginal: `Federal Reserve Chair Kevin Warsh's stance in his speech at the Jackson Hole meeting was unexpectedly hawkish, boosting market expectations for a rate hike next month.
...
—CNBC's Joanna Ossinger contributed to this report.`,
    bodyJa: `ジャクソンホール会合でのケビン・ウォーシュ連邦準備制度理事会議長の演説でのスタンスが予想外にタカ派的で、来月の利上げに対する市場の期待が高まった。
月曜日は金が下落し、アジア株も下落した。 ＣＭＥのフェドウォッチツールによると、フェデラルファンド先物トレーダーらは９月に１５％ポイント利上げの確率が６０．４％とみており、金曜日の約５６％から上昇している。
市場関係者らはウォーシュ氏の講演について次のように述べている。
タカ派の驚き
ドイツ銀行は「ウォーシュ議長のジャクソンホール演説は、経済と見通しに関する具体性と、明らかにタカ派的な方向への傾きにわれわれを驚かせた」と述べた。同社は引き続き、FRBが今年50ベーシスポイント（ｂｐ）利上げを実施し、９月と12月の連邦公開市場委員会で利上げすると予想している。
ＵＯＢはメモで、「インフレリスクの強調は、ウォーシュ氏の物価安定達成への明確なコミットメントや将来の政策行動への事前コミットメントへの消極的姿勢と相まって、今年の政策引き締めのリスクの高まりを強めているが、行動を伴わずに話している場合もあり得る」と述べた。
短期的なデータ重視
野村氏はメモで「短期的なインフレ統計に対する感応度は高い」と述べた。 「ウォーシュ氏はジャクソンホールの経済シンポジウムでタカ派的な発言をし、インフレ目標の重要性を強調し、インフレ解消が急速に進まない場合には政策が対応する必要がある可能性があることを示唆した。」
独立性の強化
タイガー・ブローカーズの市場ストラテジスト、ジェームス・オイ氏によると、米国の経済状況は堅調であるというウォーシュ氏の評価は「短期的な利下げの可能性を減らすものとみられている」という。同氏の「2％のインフレ目標の強調は、金融政策が財政圧力に屈しないことを市場に安心させ、FRBの独立性と信頼性を強化する取り組みと解釈される可能性がある」。
懐疑論をハイキングする
しかし、ミラー・タバック社の首席市場ストラテジスト、マシュー・Ｊ・メイリー氏は「利上げの実証的根拠は依然として存在しない」と考えている。
メイリー氏は「ウォーシュ氏は、総合政策が必然的に下振れする際に、インフレを抑制した功績を主張するために、インフレを話題にしているようだ」と述べ、前回のFOMC会合以降、インフレ統計は予想よりも良かったが、労働市場統計は弱いと付け加えた。
FRB対財務省
ガベカル・リサーチはノートで、ウォーシュ氏が短期金利が引き続き金融政策の主要手段であるべきだと繰り返し述べたことは、同氏がＦＲＢのバランスシートの平均デュレーションを引き続き短縮することを示唆していると述べた。
ガベカル氏は「これはFRBと米財務省との対立を生むようだ。米財務省は8月初旬、長期金利のさらなる上昇を阻止する目的で長期国債の買い戻しを強化すると発表した」と付け加えた。
金にはマイナス
サスケハナ氏によると、「ウォーシュ氏はインフレ率を目標の2％に戻すと約束し、金利がさらに上昇してドルが上昇し、8月に金を約14％押し上げた地盤下落の一部が反転する可能性があると示唆した。これは今世紀最大の月間上昇率となった」と述べた。
—CNBC の Joanna Ossinger がこのレポートに寄稿しました。`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/08/31/jackson-hole-fed-chair-kevin-warsh-hawkish-rate-hikes-analysts.html",
    publishedAt: "2026-08-31T03:47:28+00:00",
    category: "金融政策",
    imageUrl: "https://images.unsplash.com/photo-1611974789855-9c2a0a7236a3?w=800&q=80",
    readTime: 3,
  },
  {
    id: "trump-threatens-to-blow-up-iran-s-kharg-633f50af",
    title: "Trump threatens to blow up Iran's Kharg Island oil hub as hostilities escalate once again",
    titleJa: "敵対行為が再び激化する中、トランプ大統領はイランの石油ハブであるカールグ島を爆破すると脅迫",
    summaryJa: "ドナルド・トランプ米大統領は、イランに対する軍事的脅迫を同国の主要石油輸出ターミナルであるカーグ島にまで拡大し、「木っ端微塵に吹き飛ばされるだろう！」と述べた。このコメントは、両国間の敵対関係が再燃する中、週末に米国とイランが攻撃を交わした後に発表された。",
    bodyOriginal: `U.S. President Donald Trump extended his military threats against Iran to Kharg Island, the country's main oil export terminal, saying it's "going to be blown to smithereens!"
The comments came after the U.S. and Iran traded attacks over the weekend, as hostilities flared anew between the two countries.
American forces struck two Iranian rocket launchers on Larak Island on Sunday after the military said Revolutionary Guard forces were preparing rockets carrying sea mines for launch into the Strait of Hormuz, U.S. Central Command confirmed to MS NOW.
...
Sunday's attack was the first publicly acknowledged U.S. strike on Iranian positions since late July, according to The Associated Press. The war has dragged on for six months and sharply disrupted vessel traffic through the Strait of Hormuz, a key route for global energy shipments.
Iran's Revolutionary Guards Corps said the U.S. attack on Larak Island killed and wounded several Iranian soldiers, and it has responded with attacks on American military bases in Jordan, according to Iranian media reports.
The IRGC said the combined missile and drone operation targeted the King Hussein and Al Azraq bases, according to media reports.
...
Larak, a small Iranian island in the Strait of Hormuz, has become a key military and shipping-control point for Tehran, used by the Revolutionary Guards to monitor vessel traffic through one of the world's most important maritime routes.
...
Another tanker was struck by an unknown projectile while transiting inbound in the Strait of Hormuz on Saturday, using the southern lane along the Omani coast, according to the UK Maritime Trade Operations. The agency reported no casualties, while advising vessels to navigate the Strait with caution.`,
    bodyJa: `ドナルド・トランプ米大統領は、イランに対する軍事的脅迫を同国の主要石油輸出ターミナルであるカーグ島にまで拡大し、「木っ端微塵に吹き飛ばされるだろう！」と述べた。
このコメントは、両国間の敵対関係が再燃する中、週末に米国とイランが攻撃を交わした後に発表された。
米中央軍がMS NOWに確認したところ、革命防衛隊がホルムズ海峡への発射に向けて機雷を搭載したロケット弾を準備していると軍が発表したことを受け、日曜、米軍はララク島でイラン製ロケット砲2基を攻撃したと明らかにした。
米中央軍報道官のティム・ホーキンス海軍大佐は声明で、「本日未明、米軍はララク島でイランの発射台２基を攻撃した。イスラム革命防衛隊部隊が機雷を搭載したロケット弾をホルムズ海峡に発射する準備をしているのが目撃された」と述べた。
同氏は、「先週、セントコムは海峡の国際航路から機雷の除去を完了した。米軍はこの地域を注意深く監視しており、この重要な水路を通る自由な通商を守る準備を続けている」と述べた。
AP通信によると、日曜の攻撃は7月下旬以来、米国によるイラン陣地への攻撃が公的に認められた初めてのことだった。戦争は6か月間続き、世界のエネルギー輸送の重要なルートであるホルムズ海峡を通る船舶の交通は大幅に混乱した。
イランメディアの報道によると、イラン革命防衛隊は、米国によるララク島攻撃で複数のイラン兵士が死傷し、ヨルダンの米軍基地への攻撃で対抗したと発表した。
メディア報道によると、革命防衛隊は、ミサイルと無人機の複合作戦が国王フセイン基地とアル・アズラク基地を標的にしたと発表した。
伝えられるところによると、イラン軍は空爆により「技術インフラや修理インフラ、さらには敵の戦闘機配備場所が破壊され」、「重大な損害」を与えたと伝えられる一方、ますます強硬な対応をすると表明した。
ホルムズ海峡にあるイランの小さな島ララクは、テヘランの軍事および船舶管制の重要な拠点となっており、革命防衛隊が世界で最も重要な海路の一つを通る船舶交通を監視するために使用されている。
米海軍はイランの港湾封鎖を維持し、イラン政権に水路の再開を圧力をかけるつもりだ。イランは、自国の海岸に近い北部航路を利用しない船舶を標的にし続けている。
英国海事貿易業務局によると、土曜日、オマーン沿岸の南側航路を利用してホルムズ海峡を航行中、別のタンカーが未知の飛翔体に衝突された。同庁は死傷者は出ていないと報告したが、船舶に対し海峡を慎重に航行するよう勧告した。`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/08/30/us-iran-strikes-strait-hormuz.html",
    publishedAt: "2026-08-31T02:48:30+00:00",
    category: "エネルギー",
    imageUrl: "https://images.unsplash.com/photo-1473172367879-2dca04a4dca4?w=800&q=80",
    readTime: 3,
  },
  {
    id: "how-the-us-canada-trade-war-is-being-fel-2a87053c",
    title: "How the US-Canada trade war is being felt on both sides of the border",
    titleJa: "Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.",
    summaryJa: "Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.",
    bodyOriginal: `The US-Canada trade war in 5 charts
- Published
...
Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.`,
    ...
    publishedAt: "2026-08-31T00:05:22+00:00",
    category: "金融政策",
    imageUrl: "https://ichef.bbci.co.uk/ace/standard/240/cpsprodpb/4b95/live/4a224cf0-a4af-11f1-aed2-8d6da8d75094.png",
    readTime: 2,
  },
  {
    id: "my-parents-won-t-lend-me-10k-but-helped-45261769",
    ...
    bodyOriginal: `'My parents won't lend me £10k but helped my brother': When families play financial favourites
- Published
...
Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.`,
    ...
    publishedAt: "2026-08-30T23:22:24+00:00",
    category: "マクロ経済",
    imageUrl: "https://ichef.bbci.co.uk/ace/standard/240/cpsprodpb/bbd9/live/fc8d0a40-9bba-11f1-aed2-8d6da8d75094.jpg",
    readTime: 2,
  },
  {
    id: "aon-nears-17-billion-deal-to-buy-insuran-1f1fffc5",
    title: "Aon nears $17 billion deal to buy insurance broker USI, WSJ reports",
    titleJa: "エーオン、保険ブローカーUSI買収で170億ドルの合意に近づいているとWSJが報じた",
    summaryJa: "ウォール・ストリート・ジャーナル紙が日曜日に報じたところによると、エーオンはプライベートエクイティ会社KKRから保険仲介会社USIを買収するため、負債を含め約170億ドルの契約に近づいているという。同紙は関係者の話として、早ければ月曜日にも合意が発表される可能性があると報じた。",
    bodyOriginal: `Aon is nearing a roughly $17 billion deal, including debt, to acquire insurance brokerage USI from private-equity firm KKR, The Wall Street Journal reported Sunday.
...
Aon reported second-quarter adjusted earnings of $3.81 per share on July 29, topping Wall Street analysts' estimates. The stock has since fallen by 5.6%, closing at $355.40 on Friday.`,
    bodyJa: `ウォール・ストリート・ジャーナル紙が日曜日に報じたところによると、エーオンはプライベートエクイティ会社KKRから保険仲介会社USIを買収するため、負債を含め約170億ドルの契約に近づいているという。
同紙は関係者の話として、早ければ月曜日にも合意が発表される可能性があると報じた。
USI は、ニューヨーク州ヴァルハラに拠点を置く保険仲介およびコンサルティング会社で、リスク管理、従業員福利厚生、退職コンサルティングを専門としています。同社のウェブサイトによると、同社の年間収益は約30億ドルだという。
KKRは2017年にプライベートエクイティ会社OnexからUSIを買収し、その後出資比率を高め、2023年には同社の筆頭株主となる。
USIとの取引の可能性は、今年初めのデータセンター冷却会社CoolITやCircorの商業・防衛航空宇宙事業の売却など、KKRの一連の著名な撤退に続くものとなるだろう。 KKRは、6月に終了した四半期の資産売却額が12億9000万ドルという記録的な額を報告した。
USIとの契約は、時価総額750億ドルの大手保険ブローカー兼コンサルティング会社であるエーオンにとって、早ければ2028年にも中堅企業へのリーチを拡大し、一株利益を押し上げるのに役立つだろうと、関係者の話として同誌が報じた。
エーオンは7月29日、第2四半期の調整後1株当たり利益が3.81ドルとウォール街アナリストの予想を上回ったと報告した。その後株価は5.6％下落し、金曜日の終値は355.40ドルとなった。`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/08/30/aon-usi-17-billion-deal-talks.html",
    publishedAt: "2026-08-30T20:46:12+00:00",
    category: "テクノロジー",
    imageUrl: "https://images.unsplash.com/photo-1518770660439-4636190af475?w=800&q=80",
    readTime: 2,
  },
  {
    id: "eight-killed-and-others-missing-after-fe-b5813a13",
    title: "Eight killed and others missing after ferry capsizes off northern Cyprus",
    titleJa: "キプロス北部沖でフェリー転覆、8人死亡、1人行方不明",
    summaryJa: "キプロス北部沖でフェリー転覆、8人死亡、1人行方不明- 公開されました",
    bodyOriginal: `Eight killed and others missing after ferry capsizes off northern Cyprus
- Published
...
Mustafa Koc saved around 65 people with his boat after the vessel capsized. He told the BBC that he felt the crew should have waited until the sea was calm.
...
Additional reporting by Sherie Ryder`,
    bodyJa: `キプロス北部沖でフェリー転覆、8人死亡、1人行方不明
- 公開されました
キプロス北部沖で旅客船が転覆し、少なくとも8人が死亡、十数人が依然として行方不明であると、同国のトルコ政府トップが発表した。
キプロスにある自称トルコ共和国のウナル・ウステル首相は、フェリーがキレニアの海岸沿いの町を出発した後、入水を開始したとき、乗客259名と乗組員8名を乗せていたと述べた。
ウステル氏はソーシャルメディアで、「この悲劇がどのように起こったのか」に関する捜査の一環として、船長と乗組員7人が拘束されたと述べた。
現在も行方不明の乗客を発見するための捜索救助活動が行われており、トルコ当局もこれに参加している。
私有フェリーは現地時間12時30分（グリニッジ標準時09時30分）頃に人気の休暇リゾート地キレニアを出発した。
ウステル氏は、ボートは土曜日にトルコに向かう予定だったが、悪天候のため遅れたと語った。
同氏はトルコメディアＴＲＴに対し、ボートは転覆する前に２度の波にさらされたと語った。
船長が第一波から回復しようとしていたところ、第二波が襲来し、水が浸み始めたと同メディアに語った。
ヘリコプターと沿岸警備隊のボートが現場に出動し、救急車もビーチに配備され、救助された乗客の受け入れに備えている。
ウステルさんはソーシャルメディアに「今の優先事項は人命だ」と書き、治安部隊、救助チーム、保健当局がすべて現場に出動していると付け加えた。
同氏は、災害は徹底的に調査され、「わずかな過失さえも明らかにされるだろう」と付け加えた。
「誰であろうと、過失や責任があると判明した人は誰も救われない」とウステル氏は語った。
トルコのみが承認している自主宣言北キプロス・トルコ共和国（TRNC）のエルハン・アリクリ運輸大臣は、地元メディアに対し、乗客100人が岸に連行されたと語った。
トルコのレジェップ・タイイップ・エルドアン大統領はキプロス系トルコ人に哀悼の意を表し、行方不明者に連絡する取り組みは「中断されることなく続く」と述べた。
同氏は日曜日の軍事式典で、「事故直後、我々は北キプロス・トルコ共和国当局と協力して大規模な捜索救助活動を開始した」と述べた。
船が転覆した後、ムスタファ・コックさんはボートで約65人を救出した。同氏はBBCに対し、乗組員は海が静まるまで待つべきだったと感じたと語った。
「彼らにとっては安全ではなかった」と彼は語った。 「海はかなり波立っていた。」
コッチ氏は「人々が亡くなった。それは正しくない」と付け加えた。
同氏は、ボートは土曜日にキレニアに到着したが、「前部に多少の損傷があった」と述べた。
マリン・トラフィックによると、フェリーは長さ40メートル、幅10メートルの高速船フィロ・ジェットで、トルコの旗を掲げて航行している。
日曜日の夕方、アリクリ氏はTRTに対し、船は完全に沈没したと語った。
転覆した旅客船を運航する会社フィロ・デニズチリク氏は、「悲劇的な事故に深く悲しんでいる」と述べた。
乗客の親族に情報を提供するホットラインが設置されている。乗っていた人の国籍や負傷者の状況は不明。
地元テレビは、船体の上に救命胴衣を着た人々がいる、逆さまのフェリーが水中に沈む映像を放送した。
TRNCはトルコのみが承認しており、1974年以来分割されているキプロス島の北3分の1を支配している。
Sherie Ryder による追加レポート`,
    source: "BBC",
    sourceUrl: "https://www.bbc.co.uk/news/articles/c770jyd4l7lo?at_medium=RSS&at_campaign=rss",
    publishedAt: "2026-08-30T20:02:43+00:00",
    category: "貿易",
    imageUrl: "https://ichef.bbci.co.uk/ace/standard/240/cpsprodpb/b564/live/7bd43000-a492-11f1-a291-b542ee92de7c.jpg",
    readTime: 4,
  },
  {
    id: "trump-criticizes-nbc-over-election-comme-f28fbe2f",
    title: "Trump criticizes NBC over election comment as Treasury denies some NYT, WSJ and Bloomberg reporters G20 credentials",
    titleJa: "財務省がNYT、WSJ、ブルームバーグ記者の一部G20資格を否定、トランプ大統領、選挙コメントでNBCを批判",
    summaryJa: "トランプ大統領のNBCへの攻撃は、財務省がニューヨーク・タイムズ紙、ウォール・ストリート・ジャーナル紙、ブルームバーグ紙の記者らのG20への出席を禁止した後に起きた。",
    bodyOriginal: `President Donald Trump on Sunday lashed out at NBC News "Meet the Press" host Kristen Welker, suggesting she would be reported to the Federal Communications Commission over her alleged characterization of election results.
...
The president stormed out of an interview with Welker earlier this year after being pressed on his controversial "weaponization" fund and on evidence of his persistent claims of election fraud.`,
    bodyJa: `ドナルド・トランプ大統領は日曜日、NBCニュース「ミート・ザ・プレス」の司会者クリステン・ウェルカー氏を激しく非難し、彼女が選挙結果を特徴づけた疑いがあるとして連邦通信委員会に報告されるだろうと示唆した。
トランプ大統領が、「ミート・ザ・プレス」の司会者が、今回の選挙期間中に自身が支持した候補者たちと「まちまちの結果」をもたらしたと発言したことを受け、大統領はウェルカー氏を非難した。ミネソタ州知事候補でマイピローCEOのマイク・リンデル氏やアイオワ州知事候補のランディ・フェーンストラ下院議員（共和党、アイオワ州）など、トランプ氏が選んだ少数の候補者が今年の予備選で敗れた。
「無償で与えられた公共放送のために働いている人が、どうしてこんなことを言えるのでしょうか?」トランプ大統領は真実ソーシャルへの投稿でこう語った。 「この意図的な不正確さのため、彼女は叱責または懲罰のためにFCCに報告されるだろう。」
ウェルカー氏のコメントは日曜日の放送「ミート・ザ・プレス」では行われなかった。その代わり、NBC司会者は地元ワシントンD.C.の系列局WRC-TVの番組前のコーナーで発言したとCNNのブライアン・ステルター氏がXに関する投稿で述べた。
「彼は中間選挙で大きな存在となるだろう。それについては疑いの余地はない。もちろん、彼は予備選挙で候補者リストを支持している」とウェルカー氏はそのコーナーで語った。 「彼の成績はまちまちだが、最近では彼が選んだダーリン・グラハム上院議員（もちろん故リンジー・グラハム上院議員の妹）が予備選で勝利を収め、現在はサウスカロライナ州でアニー・アンドリュース博士と対戦している。」
NBCニュースの広報担当者は声明で「クリステンはこの業界で最高の人物の一人であり、我々は彼女を支持する」と述べた。
同紙によると、大統領のウェルカー氏への攻撃は、財務省がニューヨーク・タイムズ紙、ウォール・ストリート・ジャーナル紙、ブルームバーグ紙の経済記者らの今週ノースカロライナ州で開催されるG20会議への出席を禁止した後に発端となった。
記者らには財務省から資格が与えられていなかった。
財務省報道官は声明で、タイムズ記者１人を含むメディア関係者３００人近くがイベント期間中、政策立案者らと高レベルの接触ができると述べた。
この除外は、報道機関へのアクセスを制限しようとするトランプ政権の最新の例である。昨年、国防総省は厳格な新たな報道政策を課し、ほぼすべての報道機関がその政策を遵守するための協定に署名することなく撤退した。
トランプ大統領は長年報道機関を「フェイクニュース」と嘲笑し、記者たちを激しく非難してきたが、連邦通信委員会のブレンダン・カー委員長は２期目の任期中に偏見の疑いに対してより積極的に行動する姿勢を見せている。カー氏は昨年、ジミー・キンメル氏のABC深夜番組での発言を巡り、同氏に対する行動を呼びかけた。 ABCはその後、番組を一時的に放送から外し、その後復活させた。
トランプ大統領はソーシャルメディアへの投稿でカー氏にNBCを標的にするよう指示したとみられる。
「報道は我が国の恥であり、ブレンダン・カー委員長と委員会の優秀な人々が我が国に対するこの脅威を真剣に受け止めてくれることを期待する」と述べた。
トランプ氏は以前のトゥルース・ソーシャルへの投稿で、報道機関が選挙結果を予測するために利用する世論調査に不快感を表明し、カー氏のFCCも調査するつもりだと示唆した。
「私たちの不正なメディアが使用する偽の世論調査は制御不能になっており、これについて何かをしなければなりません。FCC が救助します!」と大統領は言いました。
大統領は今年初め、物議を醸している自身の「武器化」資金と選挙不正の執拗な主張の証拠について追及された後、ウェルカー氏との会見を突然打ち切った。`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/08/30/trump-nbc-election-comment-treasury-g20-reporter-access.html",
    publishedAt: "2026-08-30T19:40:52+00:00",
    category: "金融政策",
    imageUrl: "https://images.unsplash.com/photo-1611974789855-9c2a0a7236a3?w=800&q=80",
    readTime: 4,
  },
  {
    id: "a-giant-leap-forward-nasa-launches-powe-1c627734",
    title: "'A giant leap forward': Nasa launches powerful new space telescope",
    titleJa: "「大きな飛躍」：NASAが強力な新型宇宙望遠鏡を打ち上げ",
    summaryJa: "「大きな飛躍」：NASAが強力な新型宇宙望遠鏡を打ち上げ- 公開されました",
    bodyOriginal: `'A giant leap forward': Nasa launches powerful new space telescope
- Published
...
Jackie Townsend, a project manager on Nasa's Roman telescope, described it as "glorious" at a news conference afterwards. "The ride was magnificent. It put us right where we wanted to be."
...
Fox said Roman "is going to discover tens of thousands, maybe even 100,000 new exoplanets" - referring to planets located outside of our solar system.
"Why do we care so much about exoplanets? Because one of our main goals at Nasa is answering the question, 'Are we alone in the universe'?" she added.
US President Donald Trump dialled in to the space agency's news conference to congratulate the scientists working on the project.
...
Related topics
- Published26 July`,
    bodyJa: `「大きな飛躍」：NASAが強力な新型宇宙望遠鏡を打ち上げ
- 公開されました
NASA の強力な次世代望遠鏡は、暗黒エネルギー、ブラック ホール、その他の宇宙の謎を探索するという使命を帯びて、フロリダの発射台から宇宙に飛び立ちました。
ナンシー・グレース・ローマン望遠鏡は、ハッブル宇宙望遠鏡とジェームズ・ウェッブ宇宙望遠鏡の両方よりも100倍大きい視野で、宇宙の広大なパノラマの景色を捉えることができるとNASAは述べています。
このミッションは、地球から約100万マイル離れた有利な地点までの100日間の旅から始まり、そこで望遠鏡は太陽系の外にある系外惑星として知られる惑星の地図を作成し始める。
NASAの管理官ニッキー・フォックス氏は、「ローマンは宇宙に対する私たちの見方を変えることになるだろう」と語った。
望遠鏡の打ち上げは現地時間日曜日の朝、フロリダ州のケネディ宇宙センターから打ち上げられました。
NASAのローマン望遠鏡のプロジェクトマネージャーであるジャッキー・タウンゼント氏は、その後の記者会見でそれを「素晴らしい」と述べた。 「乗り心地は素晴らしかった。行きたかった場所にたどり着くことができた。」
打ち上げから約30分後、ローマンはスペースXロケットから分離し、現在約100万マイル離れた周回点に向かって進んでいる。
フォックス氏は、ローマン氏が「数万個、もしかしたら10万個もの新たな系外惑星を発見する予定だ」と述べた。これは太陽系の外にある惑星のことを指す。
「なぜ私たちは系外惑星のことをそこまで気にするのでしょうか? NASA での主な目標の 1 つは、『宇宙で私たちだけなのか?』という質問に答えることだからです。」彼女は付け加えた。
ドナルド・トランプ米大統領は宇宙機関の記者会見に電話し、このプロジェクトに取り組んでいる科学者たちを祝福した。
トランプ大統領は「あなた方は宇宙で最もホットな存在であり、我が国は世界中で最もホットな国だ。だから、このまま進めていこう。あなた方はその重要な役割を担っている」と語った。
天文学者のジェニファー・ミラード氏は、この望遠鏡は月よりも地球から4倍離れたところにあり、そこでは彼女が「熱光」と呼ぶものを捕捉するために作られた多くの赤外線宇宙カメラが稼働していると述べた。
彼女はBBCに対し、これは月と地球からの赤外線がカメラに干渉しないようにするためだと語った。
2021年に打ち上げられたNASAのジェームズ・ウェッブ宇宙望遠鏡も、地球から約100万マイル離れた太陽の周りを周回しているが、その視野はそれほど広くない。 1990 年に打ち上げられた NASA のハッブル宇宙望遠鏡は、地表から約 300 マイル上空を周回しています。
ローマンは宇宙の外に目を向けるが、科学者たちは私たちの銀河系内に何千もの新しい世界が発見されることも期待している、とミラード氏は語った。
この望遠鏡は、1960年代にNASAの初代主任天文学者であり、初の女性幹部でもあった物理学者ナンシー・グレース・ローマンにちなんで名付けられました。
彼女はそのキャリアの中でハッブル宇宙望遠鏡を米国議会に承認させるのに尽力し、後にその最も興味深い発見はダークエネルギーであると語った。
新しい望遠鏡も同様に、暗黒エネルギーの調査などを通じて、宇宙に対する私たちの理解に革命をもたらすことが期待されています。一次耐用年数は 5 年で、10 年間の稼働が目標です。
NASAは、「その鮮明で広範囲にわたる調査は、科学者が暗黒エネルギーと暗黒物質を調査し、系外惑星を発見して特徴づけ、何十億もの銀河の地図を作成し、ブラックホールを研究し、私たちの太陽系から観測可能な宇宙の果てまで物体を探索するのに役立つだろう」と述べている。
目に見えない暗黒物質は一種の重力接着剤として機能しますが、暗黒エネルギーは宇宙の膨張を引き起こす斥力であると考えられています。これらを合わせると、宇宙の約 95% を構成すると考えられています。
「NASA​​ での私たちの主な目標の 1 つは、宇宙には私たちだけなのか? という質問に答えることです。」フォックス氏は日曜朝の記者会見で語った。
「ローマンとともに、私たちはこの大きな飛躍を遂げるつもりです...それによって、私たちはこれらの遠く離れた世界に目を向け、それらを取り巻く大気を実際に解決し始めて、私たちに知らせることができます：それらは居住可能である可能性がありますか？」
ミラード氏は、ローマンのような望遠鏡の働きを通じて、科学者たちはさまざまな段階で宇宙の「巨大な宇宙地図」を作成したいと考えていると述べた。
「それらはほとんどタマネギのようなものなので、層を一枚ずつ剥がしていき、宇宙時間の経過とともに銀河の分布がどのように変化するかを観察することができます」と彼女は語った。
「私たちがやりたいのは、この分布を使って暗黒物質と暗黒エネルギーを解明しようとすることです。なぜなら、暗黒物質と暗黒エネルギーが存在することはわかっていて、その影響も観察できるからです。しかし、それらが何なのかは本当の謎なのです。」
関連トピック
- 7 月 26 日発行`,
    source: "BBC",
    sourceUrl: "https://www.bbc.co.uk/news/articles/ce87e55vgpjo?at_medium=RSS&at_campaign=rss",
    publishedAt: "2026-08-30T18:53:53+00:00",
    category: "エネルギー",
    imageUrl: "https://ichef.bbci.co.uk/ace/standard/240/cpsprodpb/206f/live/de2a7590-a48b-11f1-b109-879e35c24276.jpg",
    readTime: 5,
  },
  {
    id: "he-beat-big-tobacco-will-the-same-playbo-010895c5",
    title: "He beat Big Tobacco. Will the same playbook work against Meta and social media?",
    titleJa: "Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.",
    summaryJa: "Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.",
    bodyOriginal: `As a central figure who helped negotiate the blockbuster $246 billion tobacco master settlement in 1998, Mike Moore sees the writing on the wall for Meta and its social media rivals like TikTok and Google's YouTube.
Moore was the Mississippi attorney general leading the charge against Big Tobacco. He's long since retired from public office, but is using his experience to help inform state AGs in the crafting of a potential sweeping settlement with the social media industry, which has been similarly accused of knowingly fostering addiction and harming America's youth.
Meta this week agreed to pay almost $17 billion in a landmark settlement with a coalition of state AGs that had sued the company for misrepresenting the extent of child mental health damage caused by Facebook and Instagram. It's by far the biggest deal yet in the massive litigation wave facing social media companies, but experts say the matter is far from over as a bundle of cases remain open.
As co-leader of Attention Initiative, a newly created nonprofit, Moore told CNBC he sees the opportunity for a grand settlement that involves a wider swath of companies and impactful remedies, including a permanent national public education fund to "reduce the number of young people who fall prey to the addiction and the many harms it has caused."
Meta agreed to changes including daily usage limits and "nighttime blocks" for teenagers who use the company's apps, "enhanced age assurance measures" that would prevent children from using them, and the creation of additional tools for parents and guardians. An independent auditor will monitor and report on whether Meta is complying with the settlement's terms over a five-year period.
"The settlement with the states is a great first step in helping protect our children from the dangers on social media," Moore said, in his first public comments on the matter. "The attorneys general have done a great job with their investigations and lawsuits in exposing the bad practices of Meta and the social media industry and now providing a template of corrective actions the industry must take."
While Moore sees major parallels to the tobacco battle almost three decades ago, the universe of Big Tech and social media presents an array of challenges that may limit the viability of the old playbook. Unlike tobacco, a static product with no real defensible qualities outside of recreation, consumer technology is ever evolving, and the lines between harmfully addictive and beneficial to society can be extremely blurry.
"Cigarettes are cigarettes," said Jonathan Caulkins, a professor of public policy at Carnegie Mellon University's Heinz College. By contrast, he said there are stark differences between apps like Facebook and TikTok and, "in the world of AI and social media, it is simply impossible to know what those technologies are going to be doing for good and ill five and 10 and 15 years into the future."
Caulkins said he's not convinced that a "single settlement" can resolve all the alleged health-related concerns, given the rapid advancements in technology.
Still, Moore said it's important to develop proposed settlement language to ensure that litigators are going after the most significant fixes. In his view, that includes a public education fund, though there are dozens of states along with cities, counties and school districts that will all be pursuing various remedies.
The Attention Initiative's goal, he said, is to "make sure everybody hears loud and clear" that "we need a remediation public education program, prevention program, whatever you might want to call it."
"It's best done on a national scale rather than piece by piece, city by city, county by county, state by state, which just wastes a lot of money," he said.
The Meta settlement came just over a week into a federal trial in Oakland, California, that was co-led on the plaintiff side by California AG Rob Bonta. The case was brought in 2023, and accused Meta of violating federal and state laws, including the Children's Online Privacy Protection Act, or COPPA, and various consumer protection statutes.
After the agreement was announced, Bonta called it, "a floor conceptually, not a ceiling," and said it "gives notice to others in the industry that we're not done, and we expect similar outcomes from them as well."
Meta didn't comment on whether a bigger settlement is in the works to clear its remaining legal hurdles. The company made clear in its statement after the announcement that part of its payout is contingent on YouTube and TikTok implementing similar changes to their services.
Google and TikTok didn't respond to requests for comment. Snap, which also faces a number of lawsuits, declined to comment.
Assuming 'nothing will change'
The Attention Initiative was created by 22-year-old Josh Jacobs. He modeled the Colorado nonprofit in part after the public health group Truth Initiative, which was started as part of the tobacco settlement and is chaired by Moore.
Jacobs previously co-founded an online ad and e-commerce startup with college friends and became disenchanted with what he characterized as the social media industry's "perverse incentives of maximizing for engagement over all else."
He started researching the similarities between social media and tobacco, an endeavor that led to him cold-calling Moore. He felt the need to take action while the topic is hot.
"Most people my age aren't following this trial through the news," Jacobs said. "They're seeing it on social media, and the comments under those posts are almost entirely cynical. The assumption is that nothing will change."
Many techies, however, fear too much change.
It's an industry that's long been concerned about regulations and laws infringing on free speech, and experts say there are nuances that make social media hard to regulate. Age verifications and parental controls come with notorious loopholes. Teenagers in Australia are reportedly using social media apps more now despite a ban late last year, in part because they can use virtual private networks (VPNs) and bypass local laws.
Then there's the emergence of artificial intelligence chatbots and companions that create a host of other concerns for underage usage, but that aren't generally considered part of the social media industry.
...
"It's the hardest thing in modern society to get right," Ball said. "Where to limit freedoms and who to hold accountable, that's super difficult for the government to get right."
She agreed that education is important but that "it's just not going to solve the whole problem."
From tobacco to social media
Among those who were deeply engaged in the tobacco case, Moore isn't alone in recognizing the similarities to social media.
Lawyers Joe Rice and Steve Berman were two of the key architects of the tobacco settlement and, like Moore, were also heavily involved in opioid-related litigation. Berman speculates that Meta will next settle the school districts case, which stemmed from some 1,200 districts across the country accusing the Facebook parent and other social media companies of spreading intentionally addictive features.
"They're going to have to take care of this problem, or they're just going to be litigated forever," Berman said.
Rice, whose law firm Motley Rice is involved in multiple social media trials, said that in order for a master settlement to take place, the tech companies have to come together in a way that's unfamiliar to them given how much they compete with one another.
"At some point in time, it's possible that the two or three largest platforms can say, 'Look, we should all agree to this,'" he said. "They're not in lockstep right now."
Moore said that he's initiated potential master settlement language with AGs, but he declined to comment further. He's enlisting his colleagues at the Truth Initiative to work with Jacobs and representatives from the AGs' offices.
Until there's broader resolution, court cases remain on the calendar.
Among them is a case involving Snap in New Mexico, where state AG Raul Torrez, a board member with the Truth Initiative, is leading a child-sexual exploitation lawsuit. It's similar to a case that Meta lost in New Mexico earlier this year. The trial there is scheduled for about a year from now.
WATCH: Meta's post settlement challenges: Here's what to know.`,
    bodyJa: `Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.
Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/08/30/mike-moore-ag-social-media-settlement-big-tobacco.html",
    publishedAt: "2026-08-30T15:48:10+00:00",
    category: "テクノロジー",
    imageUrl: "https://images.unsplash.com/photo-1518770660439-4636190af475?w=800&q=80",
    readTime: 2,
  },
  {
    ...
    publishedAt: "2026-08-30T13:30:00+00:00",
    category: "自動車",
    imageUrl: "https://images.mktw.net/im-87399340",
    readTime: 2,
  },
  {
    id: "what-new-tariff-walls-in-u-s-canada-trad-5e076977",
...
Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/08/30/us-canada-trade-war-tariffs-steel-aluminum-metals-economy.html",
    publishedAt: "2026-08-30T13:00:01+00:00",
    category: "エネルギー",
    imageUrl: "https://images.unsplash.com/photo-1473172367879-2dca04a4dca4?w=800&q=80",
    readTime: 2,
  },
