...
- 6 月 25 日発行`,
  ...
  },
  {
    ...
    summaryJa: "石油ショックが長期化すれば、消費者物価の上昇が続き、すでに困難な政策環境を乗り越えている中央銀行の道筋が複雑になる可能性がある。",
    bodyOriginal: `A prolonged oil shock could keep consumer prices elevated and complicate the path for central banks already navigating a difficult policy environment.`,
    bodyJa: `石油ショックが長期化すれば、消費者物価の上昇が続き、すでに困難な政策環境を乗り越えている中央銀行の道筋が複雑になる可能性がある。`,
    source: "MarketWatch",
    sourceUrl: "https://www.marketwatch.com/story/brent-crude-reaches-100-as-war-in-iran-intensifies-b73832e2?mod=mw_rss_topstories",
    publishedAt: "2026-09-09T20:36:00+00:00",
    category: "エネルギー",
    imageUrl: "https://images.mktw.net/im-77918704",
    readTime: 2,
  },
  {
    id: "bessent-s-political-turn-in-gop-speech-t-8aae8a57",
    title: "Bessent’s political turn in GOP speech tests his bond-market credibility",
    titleJa: "ベッセント氏の共和党演説での政治的転向は、債券市場でのベッセント氏の信頼性を試す",
    summaryJa: "スコット・ベッセント財務長官がダラスで予定している共和党大会演説で、政治が同財務長官に対する市場の信頼にどのような影響を与える可能性があるかについて疑問が生じている。",
    bodyOriginal: `Treasury Secretary Scott Bessent's push to calm the bond market is colliding with a more political role, as his planned Republican convention speech raises questions about the credibility he needs to manage U.S. debt markets.
...
Although all Cabinet officials are political actors to a degree — they report to and are appointed by the elected president — some Treasury secretaries have been careful to avoid overt politics.
"I was never asked to speak at an explicitly political event and was careful not to do so to avoid violating the Hatch Act," former Treasury Secretary Janet Yellen said, referring to the law that limits the political activities of most executive branch employees. She served under President Joe Biden until Trump took office in 2025.
The 1939 law puts some restrictions on certain executive branch officials' engagement in partisan politics, but political activity is permissible in some cases so long as officials don't use their official title or public resources. "Other Biden appointees did speak at political events observing these rules," Yellen said.
Other Treasury secretaries have been involved in political conventions. Treasury Secretary James Baker appeared in a video at the 1988 Republican National Convention. He resigned effective that day to run George W. Bush's presidential campaign. Robert Rubin spoke at the 2000 Democratic convention, a year after he stepped down as Bill Clinton's Treasury secretary.
Bessent has been aggressive in using his public profile to pursue the administration's political adversaries.
"I say sometimes I feel like an emergency room doctor," Bessent said at the Breitbart event Tuesday. "The Biden economy just was like American people got hit by a truck." But workers are doing much better under Trump, Bessent said. The bottom 25% of earners has seen greater wage gains than the top 25%, he said.
The Treasury Department didn't respond to requests for comment about the political nature of Bessent's speech Thursday. He has waved off questions about his political ambitions beyond his current job.
Bessent is from South Carolina, home of the late Republican Sen. Lindsey Graham. Bessent told students at Southern Methodist University on Tuesday that he had fielded calls in the wake of Graham's sudden death in July.
"They said, 'Oh, you should run for his seat,' and I said, 'you know what, I have one very demanding boss right now. I do not need 5.5 million South Carolinians as boss,'" Bessent said.
Bessent isn't a natural orator. His delivery is sometimes considered awkward, and he tends to fall into financial jargon.
And yet Bessent has risen to the top of an administration where the president is constantly assessing his underlings for their loyalty and the aggression of their defense of his policies, whatever they may be.
"We don't have a typical, traditional president. So we wouldn't expect to have a traditional Treasury secretary," Myrow said.
But if the markets don't trust Bessent, perhaps because they see him as putting politics first, Bessent could be stuck in a downward spiral of escalating demands from the president and weakening effectiveness, Myrow said.
...
— Steve Liesman contributed to this report.`,
    bodyJa: `債券市場の沈静化を目指すスコット・ベッセント財務長官の取り組みは、より政治的な役割と衝突している。同氏が計画している共和党大会での演説が、米国債券市場の管理に必要な同氏の信頼性に疑問を投げかけているからだ。
水曜日にダラスで開催される共和党中間大会でのベッセント氏のゴールデンタイム演説は、現職財務長官が全国政治大会で演説するのは50年ぶりとなる。ダラス会議は共和党が中間党大会を開催するのは初めて。しかし、1976年にウィリアム・E・サイモン財務長官が共和党全国大会で講演して以来、財務長官を全国大会の舞台から遠ざけてきた原則は同じである。
ビーコン・ポリシー・アドバイザーズのマネジング・パートナーで、ハンク・ポールソン財務長官の元顧問スティーブン・マイロー氏は、「財務省は一般に、財務長官の市場での信頼性以外には絶大な権力を持っていない」と語る。財務省は連邦準備制度とは異なり、紙幣を印刷することができません。
ベッセント氏はトランプ大統領の前で演説する予定の最後の政府高官で、アリゾナ州とミシガン州の下院候補者と、大会の議題に「平凡なアメリカ人でワーキングマザーで経済政策の擁護者」として名を連ねている女性の間に挟まれている。
同氏の講演は、財務省が今週、年内のオペの上限を少なくとも40億ドルとし、最大60億ドルの長期国債を買い戻すと発表したことを背景に行われることになる。同省は、一部の長期債務の取引が薄くなる可能性があるという十分に文書化された問題を解決するために、2024年に買い戻しプログラムを開始した。
しかし、64歳の元ヘッジファンドトレーダーは、これらの業務をより広範な観点から説明した。保守系報道機関ブライトバートが火曜日に主催したイベントでベッセント氏は、市場では「熱が高まっている」と述べた。彼はそれを阻止するために行動したと述べた。
この介入は、ベッセント氏が8月19日に自社株買いの強化を発表した後、最初は機能した。このニュースが米国債利回りの低下を促したのは、世界的な国債の下落を懸念する見出しが数日続いた後であった。
しかし、その効果は短命でした。水曜日、同省が予想されていた自社株買いの規模を明らかにしたことを受けて、長期国債利回りが上昇した。水曜日の午後半ばの10年米国債利回りは4.84％と、トランプ大統領の任期中のどの時点よりも高かった。財務省債の利回りの上昇は、借金を保有することで収入を得られる貯蓄者にとっては助けになるが、新たな住宅ローンや自動車ローンのコスト増に直面する借り手は圧迫される可能性がある。
広大で重要な国債市場の管理を支援するという財務長官の役割は、内閣内でその立場を特にデリケートなものにしている。財務長官は、2007年から2008年の金融危機や2020年のパンデミックなどの市場危機の際に、経済の安定化において重要な役割を果たしてきました。
すべての閣僚はある程度政治的主体であるが、彼らは選挙で選ばれた大統領に報告し、大統領によって任命されるが、一部の財務長官はあからさまな政治を避けるよう注意している。
ジャネット・イエレン元財務長官は、ほとんどの行政府職員の政治活動を制限する同法に言及し、「私は明らかに政治的なイベントでの講演を求められたことは一度もなかったし、ハッチ法に違反しないように注意していた」と語った。彼女は2025年にトランプ大統領が就任するまでジョー・バイデン大統領の下で勤務した。
1939年の法律は、特定の行政府職員の党派政治への関与に一定の制限を設けているが、公務員がその官職や公的な資源を利用しない限り、政治活動は場合によっては許容される。イエレン氏は「バイデン氏に任命された他の人たちも、これらの規則を守って政治行事で講演した」と述べた。
他の財務長官も政治大会に参加している。ジェームズ・ベイカー財務長官は1988年の共和党全国大会でビデオに出演した。同氏はジョージ・W・ブッシュ大統領の選挙運動を率いるため、その日付けで辞任した。ロバート・ルービンは、ビル・クリントン政権の財務長官を辞任した翌年、2000年の民主党大会で講演した。
ベッセント氏は、政権の政敵を追及するために自らの公的なプロフィールを積極的に利用してきた。
ベッセント氏は火曜日のブライトバートのイベントで、「時々救急治療室の医師のような気分になると言う」と語った。 「バイデン経済はまさにアメリカ国民がトラックに轢かれたようなものだった。」しかし、トランプ政権下で労働者の業績ははるかに良くなっているとベッセント氏は語った。同氏によると、所得の下位25％の賃金上昇率は上位25％よりも大きかったという。
財務省は木曜日のベッセント氏の演説の政治的性質についてのコメント要請に応じなかった。彼は現在の仕事を超えた政治的野心についての質問をはねつけた。
ベッセント氏は共和党の故リンジー・グラハム上院議員の故郷であるサウスカロライナ州出身。ベッセント氏は火曜日、南メソジスト大学の学生に対し、7月にグラハム氏が急死したことを受けて電話対応を行ったと語った。
「彼らは『ああ、君は彼の議席に立候補すべきだ』と言ったので、私は『ご存知のとおり、今、非常に要求の厳しい上司が一人います。550万人のサウスカロライナ州人を上司にする必要はありません』と言いました」とベッセント氏は語った。
ベッセント氏は生来の雄弁家ではない。彼の話し方は時々ぎこちないと思われ、経済用語に陥る傾向がある。
それにもかかわらず、ベッセント氏は、大統領が部下たちの忠誠心や政策擁護の攻撃性を常に評価している政権のトップに上り詰めた。
マイロー氏は「われわれには典型的な伝統的な大統領がいない。したがって、伝統的な財務長官がいることは期待できない」と語った。
しかし、おそらく市場がベッセント氏を政治を第一に考えているとみなしているためか、市場が信頼しなければ、ベッセント氏は大統領からの要求がエスカレートし、実効性が弱まるという下向きのスパイラルに陥る可能性があるとマイロウ氏は述べた。
「ベッセント氏がトランプ氏に持つ本当の価値は、市場における彼の信頼性だ」とマイロー氏は語った。 「もし彼が市場の信頼を十分に失うことになれば、彼がトランプと国に提供する価値を燃やしてしまうことになる。」
— Steve Liesman 氏がこのレポートに貢献しました。`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/09/09/bessent-treasury-yields-buybacks-republican-convention.html",
    publishedAt: "2026-09-09T20:22:42+00:00",
    category: "金融政策",
    imageUrl: "https://images.unsplash.com/photo-1611974789855-9c2a0a7236a3?w=800&q=80",
    readTime: 7,
  },
  {
    id: "republicans-to-tout-congressional-stock-83efc8ae",
    title: "Republicans to tout congressional stock-trading ban at midterm convention as Trump trades",
    titleJa: "共和党、トランプ氏の取引に伴う議会の株式取引禁止を中間党大会で宣伝へ",
    summaryJa: "共和党は、ドナルド・トランプ大統領自身の投資口座が何百万ドルもの活発な取引を続けているにもかかわらず、中間党大会を利用して議会での株式取引禁止を汚職撲滅の売り込みの一環としている。アンナ・パウリナ・ルナ下院議員（共和党、フロリダ州）は、ダラス大会開幕日の水曜日に「政府の誠実さ」に重点を置く議会株取引の制限を要求すると予想される少なくとも２人の講演者のうちの１人である。",
    bodyOriginal: `Republicans are using their midterm convention to make a congressional stock-trading ban part of their anti-corruption pitch — even as President Donald Trump's own investment accounts continue actively trading millions of dollars.
Rep. Anna Paulina Luna, R-Fla., is one of at least two speakers expected to call for restrictions on congressional stock trading during the Dallas convention's opening day Wednesday, which includes a focus on "Government Integrity."
Since returning to office, Trump has maintained an unusually large and active investment portfolio.
Across eight accounts, he disclosed at least $858 million in assets and more than 21,000 trades in 2025, according to an earlier CNBC analysis of his annual financial disclosure. During his entire first term, he reported roughly 500 trades.
The activity has continued this year.
Trump disclosed 1,051 transactions in June alone, totaling between $78.1 million and $263.1 million. His accounts bought and sold stocks, bonds and exchange-traded funds, including multimillion-dollar moves involving Meta, Berkshire Hathaway, Visa and Mastercard and as much as $50,000 in newly public SpaceX.
Some of those investments are in industries directly affected by presidential decisions.
CNBC reported Wednesday that Trump's nine largest disclosed oil and gas holdings gained an estimated $1.5 million to $4.4 million from the eve of the Iran war through Aug. 31, while his accounts continued buying and selling energy stocks during the conflict.
CNBC found no evidence Trump directed those trades, traded on advance knowledge of government decisions or shaped policy to benefit his investments.
The Trump Organization has said outside financial institutions have full discretion over investment decisions and rely heavily on automated strategies. The White House has said Trump cannot direct individual transactions and that "there are no conflicts of interest."
Trump nevertheless remains the beneficiary of the assets and benefits when they increase in value.
Meanwhile, Luna's Wednesday convention billing also comes less than two months after House Republicans passed the first major congressional stock-trading restrictions in years.
The GOP-led Stop Insider Trading Act cleared the House 232-198 in July. It would bar members of Congress from buying individual stocks while in office, but allow them to retain existing holdings and sell shares after publicly disclosing their intent at least seven days in advance. The restrictions would not apply to the president.
A congressional stock-trading ban has broad public support, fueled by years of scrutiny over lawmakers' well-timed trades and rapidly growing portfolios. However, critics say the House bill still leaves potential conflicts intact.
"It's a stock trading ban that still allows stock trading," Rep. Seth Magaziner, D-R.I., who has worked with Republicans on a more sweeping proposal, told CNBC in July.`,
    bodyJa: `共和党は、ドナルド・トランプ大統領自身の投資口座が何百万ドルもの活発な取引を続けているにもかかわらず、中間党大会を利用して議会での株式取引禁止を汚職撲滅の売り込みの一環としている。
アンナ・パウリナ・ルナ下院議員（共和党、フロリダ州）は、ダラス大会開幕日の水曜日に「政府の誠実さ」に重点を置く議会株取引の制限を要求すると予想される少なくとも２人の講演者のうちの１人である。
大統領に復帰して以来、トランプ氏は異例に大規模で活発な投資ポートフォリオを維持している。
同氏の年次財務開示に関する以前のCNBC分析によると、同氏は8つの口座にわたって、2025年に少なくとも8億5,800万ドルの資産と2万1,000件以上の取引を開示したという。最初の任期全体で、彼はおよそ 500 件の取引を報告しました。
今年も活動は継続されました。
トランプ氏は6月だけで1,051件の取引を明らかにし、総額は7,810万ドルから2億6,310万ドルに達した。彼の口座では株、債券、ETFの売買が行われ、その中にはメタ、バークシャー・ハサウェイ、ビザ、マスターカードに関わる数百万ドルの動きや、新たに公開されたスペースX社の5万ドルもの資金も含まれていた。
そうした投資の中には、大統領の決定によって直接影響を受ける業界への投資もある。
CNBCは水曜、トランプ大統領が公表した9大石油・ガス保有資産は、イラン戦争前夜から8月31日までに推定150万ドルから440万ドルの利益を得たが、同氏の口座は紛争中もエネルギー株の売買を続けていたと報じた。
CNBCは、トランプ氏がこれらの取引を指示したり、政府の決定を事前に知って取引したり、自身の投資に利益をもたらす政策を形成したりする証拠は見つからなかった。
トランプ・オーガニゼーションは、外部の金融機関が投資決定に関して完全な裁量権を有しており、自動化された戦略に大きく依存していると述べた。ホワイトハウスは、トランプ大統領が個別の取引を指示することはできず、「利益相反は存在しない」と述べた。
それにもかかわらず、トランプ氏は資産とその価値が上昇した際の恩恵の受益者であり続ける。
一方、ルナ氏の水曜党大会の請求も、下院共和党がここ数年で初めての大規模な株式取引制限を議会で可決してから２カ月も経たないうちに提出された。
共和党主導のインサイダー取引停止法は7月に下院232対198で可決された。これにより、議員が在任中に個別株を購入することは禁じられるが、少なくとも7日前までに意向を公表した上で既存の保有株を保持し、株式を売却することは認められる。この制限は大統領には適用されない。
議会による株式取引の禁止は、議員らのタイミングの良い取引と急速に成長するポートフォリオに対する長年の監視に支えられ、幅広い国民の支持を得ている。しかし、批評家らは、下院法案は依然として潜在的な紛争をそのまま残していると主張している。
共和党と協力してより抜本的な提案に取り組んできたセス・マガジンジャー下院議員（民主党、ロードアイランド州）は7月、CNBCに対し、「これは株式取引を依然として許可する株式取引禁止措置だ」と語った。`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/09/09/trump-republicans-congress-stock-trading-ban-midterm-convention.html",
    publishedAt: "2026-09-09T20:16:44+00:00",
    category: "エネルギー",
    imageUrl: "https://images.unsplash.com/photo-1473172367879-2dca04a4dca4?w=800&q=80",
    readTime: 3,
  },
  {
    id: "apple-s-new-boss-starts-with-big-gamble-dc3fa3c1",
    title: "Apple's new boss starts with big gamble on costly first folding iPhone",
    titleJa: "Appleの新社長、高価な初の折りたたみiPhoneへの大きな賭けから始まる",
    summaryJa: "Appleの新社長、高価な初の折りたたみiPhoneへの大きな賭けから始まる- 公開されました",
    bodyOriginal: `Apple's new boss starts with big gamble on costly first folding iPhone
- Published
...
Related topics
- Published7 days ago`,
    bodyJa: `Appleの新社長、高価な初の折りたたみiPhoneへの大きな賭けから始まる
- 公開されました
ジョン・ターナス氏がアップルの最高経営責任者に就任して2週間目に入り、同社は約20年前にiPhoneが発売されて以来初めてとなるiPhoneへの大きな変更を明らかにした。
ティム・クック氏の辞任後、アップルのトップの座を引き継いだターナス氏は水曜日、同社の年次製品発表イベントのステージに初の折りたたみ式iPhoneの巨大な画像の前で登壇した。
Duo と呼ばれる新しい iPhone はブックスタイルのフォーマットで、これまでの製品の中で最大のサイズです。また、米国での開始価格は 1,999 ドル (1,475 ポンド) から 3,200 ドルまでと、最も高価でもあります。英国での価格は1,999ポンドから。
Ternus 氏は、Duo は「iPad からインスピレーションを得た」ものであると述べたが、折りたたみ機能は「流動的で完全に直感的」であると述べた。
この折りたたみ式スマートフォンは、Apple 社内で数年間にわたって開発が進められてきました。
新しい Duo を広げると、小さな iPad のような外観になります。半分に折りたたむと、幅広のiPhoneのように見えます。
ターヌス氏はイベント中に、アップルは市場にある他の折りたたみ式スマートフォンの外観と操作感を避けたかったと述べ、「2台の携帯電話をくっつけたような感じ…大きな画面がずっと小さく感じられる」と語った。
同氏は、Duo は「折りたたみ式携帯電話の使用体験を再定義すると考えられる一連の驚くべきイノベーションの結果」であると述べた。
ターナス氏は、今年初めにクック氏の後継者に抜擢されるまで、アップルのハードウェア部門のトップとして長年務め、折り畳み式iPhoneの開発に直接関わった。
テクノロジー調査会社FDMの首席アナリスト、ベン・ウッド氏は、ターナスのプロモーションは「おそらくここ数年で最大規模のiPhoneの発売の1つとなるであろうiPhoneの発売に合わせて」特別にタイミングを合わせられた可能性が高いと述べた。
「アップルでは偶然に起こることは何もない」とウッド氏は付け加えた。
水曜日のプレゼンテーションに出席したクリエイティブ・ストラテジーズのアナリスト、カロリナ・ミラネシ氏は、テルヌスにスポットライトが当たったことで「まるで彼自身が商品になったかのような気分になった」と語った。
iPhoneのデザインを変更することで、2007年に初代iPhoneが発売されて以来、Appleはまだ大ヒット商品や本当にエキサイティングなイノベーションを生み出していないという一部の批判に対処できるかもしれない。
フォレスター社のアナリスト、ディパンジャン・チャタジー氏は「折り畳み式製品はポートフォリオの中で高級な装飾品となり、バッジの価値をもたらすものの、意味のある成長にはならない恐れがある」と述べた。
以前は、最新の iPhone の最高開始価格は 900 ドル (664 ポンド) でした。 Appleは水曜日に、それぞれ1,200ドル（885ポンド）と1,300ドル（959ポンド）からの新しいiPhone 18と18 Proも発表した。
チャタジー氏は、この折りたたみ式iPhoneは、同社の価格が3,699ドル（2,729ポンド）で購入者に人気のなかったAppleのVision Proヘッドセットに代わる可能性があると述べた。あるいは、iPhoneほど人気はないものの、毎年何百万人もの人が購入する同社の次期Apple Watchになる可能性もある、と同氏は語った。
人々がiPhoneの操作方法に慣れてしまっていることも、Appleが新デザインの大量販売を目指す上での潜在的なハードルとなる。
「折りたたみ式デバイスは興味深いデバイスです」とミラネージ氏は述べた。 「多くの人がこれに興味を持っていますが、従来の携帯電話から折りたたみ式携帯電話に移行する際にソフトウェアと学習曲線が必要になるのは現実です。」
ウッド氏は、サムスンやファーウェイなどの折りたたみ式スマートフォンの現在の市場がスマートフォンの売上高に占める割合はわずか2％に過ぎないと指摘した。データ分析会社FDMによると、Appleのバージョンが関心と需要を促進している可能性が高いにもかかわらず、今後10年間の売上高は市場全体の4％にとどまると予想されている。
iPhone は Apple の最も売れている製品であり、毎年同社の売上高の半分以上を占めています。
同社はここ数四半期、iPhoneの需要がこれまで以上に高まっており、同デバイスの最新バージョンが最も成功した製品発売になったと豪語してきた。
同社はまた、現在「Siri AI」と呼ばれているオーディオおよびチャットアシスタント「Siri」の今後の再発売についてもさらに明らかにした。
iPhone 18 以降、ボットはメッセージや電子メールなど、ユーザーの携帯電話上の情報を横断して情報を検索し、質問に答え、ユーザーに代わってアクションを実行できるようになります。
装着者がその機能を有効にすれば、会話をメモして文字に起こす機能など、一部の Siri AI 機能も新しい Apple Watch で利用できるようになります。
Ternus氏は、iPhoneのAIを活用した新しい機能を「インテリジェントな個人ハブ」と呼び、Appleが「日常生活の最もプライベートな詳細」を利用することを認めた。
同氏は、AI機能は多くの場合「デバイス上」で実行され、サードパーティ企業を介さないことを意味し、すべてが非公開のままになると主張した。また、機能にサードパーティが必要な場合、その機能はリモート サーバーまたはクラウド内で非公開のままになると Ternus 氏は述べています。
「他の人たちは、データを収集して保存するものだと考えています」とテルナス氏は言う。 「ここでは、Apple ですらあなたのものにはアクセスできません。」
関連トピック
- 7 日前に公開`,
    source: "BBC",
    sourceUrl: "https://www.bbc.co.uk/news/articles/clyjd1jnd03o?at_medium=RSS&at_campaign=rss",
    publishedAt: "2026-09-09T20:00:33+00:00",
    category: "テクノロジー",
    imageUrl: "https://ichef.bbci.co.uk/ace/standard/240/cpsprodpb/569e/live/3eec7030-ac80-11f1-994b-c7df927931ed.png",
    readTime: 6,
  },
  {
    id: "trump-says-oil-and-gas-prices-won-t-fall-6fd91617",
    title: "Trump says oil and gas prices won't fall until 'right after' midterm election",
    titleJa: "トランプ大統領、石油・ガス価格は中間選挙「直後」まで下落しないと発言",
    summaryJa: "ドナルド・トランプ大統領は水曜日、イラン戦争で上昇したエネルギー価格は約2カ月後に迫った中間選挙が終わるまでは下がらないだろうと述べた。トランプ大統領は共和党中間党大会に出席するためテキサス州に向かう前、アンドリュース統合基地で記者団に対し「選挙直後、原油価格は下落するだろう」と語った。",
    bodyOriginal: `President Donald Trump on Wednesday said energy prices that have been elevated due to the Iran war will not come down until after the midterm elections, which are nearly two months away.
...
"I don't see any guarantees at all of that happening," De Haan said on X.`,
    bodyJa: `ドナルド・トランプ大統領は水曜日、イラン戦争で上昇したエネルギー価格は約2カ月後に迫った中間選挙が終わるまでは下がらないだろうと述べた。
トランプ大統領は共和党中間党大会に出席するためテキサス州に向かう前、アンドリュース統合基地で記者団に対し「選挙直後、原油価格は下落するだろう」と語った。
同氏は、原油価格が戦争初期の数週間以来見られない高値まで急騰した理由を米国人にどのように説明するつもりかと尋ねられていた。水曜日の世界のベンチマークであるブレント原油先物は7月以来初めて1バレル当たり101ドルを超え、米国のウェスト・テキサス・インターミディエイト先物は取引高値で1バレル当たり96ドルを超えた。
トランプ大統領は「米国に説明するのは非常に簡単だと思う」と述べた。 「あなたがしなければならないことは、『イランに核兵器を持たせますか？』と言うだけです。」そして答えはノーだ。」
トランプ大統領はまた、イランとの戦争は現在7カ月目に入っているが、明確な解決の見通しは立っておらず、「選挙直後」に終わると主張した。
現在進行中の戦争で勝利を繰り返し主張してきたトランプ氏は、自身の予測について説明を求められた際、「彼らはこれ以上持ちこたえることはできない」と述べた。
しかし同氏は、イランがトランプ大統領にとって不利な選挙結果から利益を得ようとしていると示唆した。
「彼らは選挙に影響を与えようと躍起になっている。そうすれば、われわれは弱い立場の人々をそこに引き入れ、彼らを放っておいて核兵器を持たせることができる」と大統領は語った。
このコメントは、戦争も、それによって生じた物価上昇も、近い将来には終わらない可能性が高いというトランプ大統領の異例の認識を示したものだ。
彼らはまた、インフレと手頃な価格に対する懸念が支配的な選挙サイクルの中で、長引く紛争がいかにトランプ大統領と共和党の重荷となっているかを強調している。
トランプ大統領は戦時中、テヘランとの和平合意が近づいていると何十回も主張してきたが、結局何も合意には至らなかった。しかし彼は最近、外交勝利の可能性を諦め、軍事力を破壊し経済を飢えさせることでイランを倒すことを支持しているようだ。
米軍は火曜日、自軍が先週イランのタンカー10隻を破壊したと発表し、一方イラン革命防衛隊はペルシャ湾で石油タンカーを破壊した功績を称えた。
トランプ大統領は「攻撃は我々によって引き起こされたと言えるだろう」と述べ、「今後もさらに多くのことが起こるだろう」と付け加えた。
トランプ大統領は水曜日、記録的なガソリン価格は1ガロン当たり2ドルを下回るが、それは11月初めの中間選挙後になるだろうと主張し、救済はまだ少なくとも8週間先であることを示唆している。
同氏は「中間期よりももう少し時間がかかると思う」と述べた。
この発言は、米国が戦争に勝てば原油価格は「急激に下落する」というトランプ大統領の最近の真実ソーシャル番組での確信を若干和らげるものだ。 「すべてはすぐに起こるだろう」と彼は書いた。
しかし、ガスバディの燃料アナリスト、パトリック・デ・ハーン氏は、中間選挙後に石油・ガス価格が下落するというトランプ大統領の最新の予測には依然として懐疑的だと述べた。
デ・ハーンは『X』で「そのようなことが起こるという保証はまったくない」と語った。`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/09/09/trump-oil-gas-prices-midterm-elections.html",
    publishedAt: "2026-09-09T19:52:11+00:00",
    category: "エネルギー",
    imageUrl: "https://images.unsplash.com/photo-1473172367879-2dca04a4dca4?w=800&q=80",
    readTime: 4,
  },
  {
    id: "canadian-whisky-on-the-rocks-crown-royal-485cec46",
    title: "Canadian whisky on the rocks? Crown Royal is set to avoid Trump’s new ban.",
    titleJa: "カナディアンウイスキーオンザロック？クラウン・ロイヤルはトランプ大統領の新たな禁止を回避するつもりだ。",
    summaryJa: "カナダのトップ酒類ブランドは、米国の顧客向けに米国で瓶詰めされているため、猶予の見通しとなっている。",
    bodyOriginal: `Canada’s top liquor brand looks on track for a reprieve because it’s bottled in the U.S. for American customers.`,
    bodyJa: `カナダのトップ酒類ブランドは、米国の顧客向けに米国で瓶詰めされているため、猶予の見通しとなっている。`,
    source: "MarketWatch",
    sourceUrl: "https://www.marketwatch.com/story/canadian-whisky-on-the-rocks-crown-royal-is-set-to-avoid-trumps-new-ban-2953bea3?mod=mw_rss_topstories",
    publishedAt: "2026-09-09T19:40:00+00:00",
    category: "金融政策",
    imageUrl: "https://images.mktw.net/im-71236137",
    readTime: 2,
  },
  {
    id: "what-a-historic-summer-box-office-reveal-708835b8",
    title: "What a historic summer box office reveals about massive shifts in the theatrical industry",
    titleJa: "歴史的な夏の興行収入が明らかにする演劇業界の大規模な変化について",
    summaryJa: "ハリウッドが夏の新記録を樹立した。5月1日から9月7日までの国内興行収入は47億6000万ドルで、映画史上最高額となった。",
    bodyOriginal: `Hollywood has a new summer record.
...
In addition to the dual release of "Dune: Part Three" and "Avengers: Doomsday," dubbed "Dunesday," the final four months of the 2026 slate include a slew of horror films — "Resident Evil," "Clayface" and "Other Mommy" — as well as smaller-budget genre films like "Practical Magic 2," "Digger," "Wicker" and "Verity" alongside bigger-budget movies like "The Hunger Games: Sunrise on the Reaping," "Hexed" and "Jumanji: Open World."`,
    bodyJa: `ハリウッドが夏の新記録を樹立した。
5月1日から9月7日までの国内興行収入は47億6000万ドルで、映画史上最高額となった。
5 月の最初の週末に始まり、レイバーデーの週末まで続く重要な映画シーズンは、劇場カレンダーの極めて重要な部分であり、通常、国内の年間興行収入総額の 40% を占めます。
前回の夏の記録は、ディズニーとマーベルの『アイアンマン3』、イルミネーションの『怪盗グルーの月泥棒2』、ワーナー・ブラザースの映画などが公開された2013年に確立された。 「マン・オブ・スティール」、ピクサーの「モンスターズ・ユニバーシティ」、ユニバーサルの「ワイルド・スピード 6」がこの期間を47億5000万ドルに導いた。
2026年シーズンはソニーの『スパイダーマン：ブランニュー・デイ』とユニバーサルの『オデッセイ』が後押しし、合わせて夏の累計に15億ドル以上、つまり30％以上を貢献した。
チケット販売が1週間延長されたことも助けとなった。 2013 年の夏は 5 月 3 日に始まり、9 月 2 日に終わりましたが、その期間は 7 日短かったです。
レントラックのマーケットプレイストレンド責任者、ポール・ダーガラベディアン氏は「これは将来の夏に向けた青写真となるはずだ」と語った。 「1 つの映画がシーズン全体を担当する必要はありません。イベントの写真、家族向けの映画、ブレイクアウトのサプライズ、そして人々を再び呼び戻すために連携する独立した映画が必要です。この夏は、その組み合わせが何をもたらすことができるかを示しました。」
Rentrakのデータによると、2026年夏の興行収入は2019年よりも10％近く早く終了した。この前年は、新型コロナウイルスの影響でチケット販売が停止され、ストリーミングが映画鑑賞に本格的に影響を与える前の年だった。
この好調な成績により、2026年の年初来の興行収入はパンデミック前の指標をわずか7.5％、つまり5億9,500万ドル下回る水準となり、通年の興行収入が7年ぶりに100億ドルを超える可能性があるという興行アナリストの予測が再確認された。
レントラックによると、夏の映画シーズンに向けて、2026年の売上高は2019年に比べ24％、約8億3000万ドル遅れた。
今年の興行収入は増加しているが、数字がすべてを物語っているわけではない。
移り変わる映画の風景
映画館経営者、スタジオ、アナリストらはパンデミック前の正常な状態に戻ったと言って好調な夏を祝っているが、業界の力関係は変化している。
劇場業界におけるパンデミック後の時代は、スクリーンの減少、映画観客の減少、映画の減少によって定義されています。
S&P グローバル マーケット インテリジェンスのデータによると、劇場は依然として混雑しているように見えますが、講堂の数は減り、入場者数は 2019 年の水準から 2 億 5 億人近く減少したままです。
そして、大スクリーンで観られる映画も少なくなっている。レントラックのデータによると、2026年のこれまでに大々的に公開された映画はわずか68本、つまり2,000以上の劇場で公開されたか、最終的には上映されたということだ。これは、79本の映画が広範囲に公開された2019年の同時期と比べて14％減少した。
こうした下落は、特にZ世代やミレニアル世代に人気の高いプレミアム・ラージフォーマット（PLF）体験による映画チケット価格の高騰によって隠蔽されてきた。
展示業界団体シネマ・ユナイテッドによると、2019年の映画チケットの平均価格は9.16ドルだった。 EntTelligence の市場調査によると、2026 年の航空券の平均価格は 12.75 ドルです。そしてそれはあくまで標準的な審査の場合です。
EntTelligenceのデータによると、PLFのチケットは平均約18.26ドルだが、Imaxの平均チケット価格は20.57ドルでこの数字を歪めている。
視聴者はこうしたより高価な PLF 上映を選択する傾向にありますが、まだその価格に躊躇することはありません。 Imax の 70 mm 上映『オデッセイ』や今後公開予定の『デューン: パート 3』などの専門上映のチケットは常に売り切れています。
プレミアム上映に対する需要が非常に高いため、スタジオは映画をマーケティングする際に工夫を凝らしています。
例えばディズニーは、12月に第3弾『デューン』と同じ日に『アベンジャーズ／ドゥームズデイ』が公開されると、Imaxスクリーンから締め出される。これに応えて、同社は「Infinity Vision」と呼ぶPLF劇場向けの認証を作成した。基本的に、ディズニーは大スクリーン、「明るい映像と優れた音響」を備えた映画館を推進しています。
同社は認定専用ウェブサイトで「Infinity Visionバッジを見れば、素晴らしい劇場体験が待っていることが分かる」と宣伝している。
ディズニーは水曜日、ゴールドマン・サックスのコミューンカピア＋テクノロジー・カンファレンスで、この映画はすでに5,000万ドル以上の前売り金を集めていると述べた。同社は、売上の70％以上がInfinity Visionのチケットによるものだと指摘した。
映画ファンは何を観ているのでしょうか？
観客が最大のスクリーンで大ヒット作を鑑賞するのと同時に、演劇業界でも低予算のジャンル映画を求める映画ファンが戻ってきています。
注目すべきは、この夏の映画シーズンは、巨額の予算をかけてアクション映画やスーパーヒーローのチームアップで始まったわけではないことだ。その代わりに、今シーズン最初の大ヒットはディズニーの「プラダを着た悪魔 2」の公開でした。続いて、ユニバーサルの『Obsession』と A24 の『Backrooms』という、YouTube クリエイターから映画製作者に転身した 2 本の低予算ホラー映画が公開されました。
4月に公開されたライオンズゲートのマイケル・ジャクソン伝記映画「マイケル」の残りのチケット販売がさらに勢いを増した。そして6月中旬に『トイ・ストーリー5』が登場しました。これら 5 本の映画は、夏の興行収入に合わせて 14 億ドル以上を生み出しました。
シネマークのグローバルコンテンツ担当シニアバイスプレジデント、ジャスティン・マクダニエル氏は、レイバーデーの週末を前にシネマークが過去の夏の興行収入記録を上回ったことを受け、先週の声明で「この夏は、映画館が提供する実物よりも広大で没入型の環境という独特の魅力と相まって、幅広い映画ファンにアピールする魅力的なコンテンツの一貫した流れの重要性を証明した」と述べた。
北米で 4 番目に大きい劇場であるマーカス シアターも、記録的な夏の期間を記録しました。同社は、夏の収益が過去最高を記録しただけでなく、売店、商品、食品および飲料の売上も過去最高を記録したと指摘した。また、2019年以来最高の夏の観客動員数を記録し、プレミアム大判スクリーンへの観客動員数も夏としては最高を記録したとマーカス氏は述べた。
マーカス・シアターズの社長ジェフ・トマチェック氏は火曜日の声明で、「多種多様な映画に対する驚異的な観客動員数は、涙から笑い、スリルやゾクゾクに至るまで、すべての観客にユニークな思い出作りの瞬間を生み出した。それは家庭では再現できないものだ」と述べた。 「今年の残りの期間に目を向けると、いくつかの新作の非常に期待されている映画が待っており、映画ファンには友人や家族と映画で素晴らしい時間を楽しむさらなる理由が与えられます。」
「デューン：パート 3」と「アベンジャーズ：ドゥームズデイ」（「デューンズデイ」と呼ばれる）の 2 本の公開に加え、2026 年の最後の 4 か月には、「バイオハザード」、「クレイフェイス」、「アザー マミー」など多数のホラー映画が含まれるほか、「プラクティカル マジック 2」、「ディガー」、「ウィッカー」、「ヴェリティ」などの低予算ジャンルの映画も上映されます。 「ハンガー・ゲーム：サンライズ・オン・ザ・リーピング」、「ヘキシード」、「ジュマンジ：オープンワールド」などのより大きな予算の映画。`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/09/09/summer-box-theatrical-shifts.html",
    publishedAt: "2026-09-09T19:21:58+00:00",
    category: "貿易",
    imageUrl: "https://images.unsplash.com/photo-1526304640581-d334cdbbf45e?w=800&q=80",
    readTime: 9,
  },
  {
    id: "bond-sell-off-stock-boom-why-rebalancing-3feb196a",
    title: "Bond sell-off, stock boom: Why rebalancing is a good strategy right now",
    titleJa: "債券の下落と株のブーム: なぜ今リバランスが良い戦略なのか",
    summaryJa: "ファイナンシャル・アドバイザーらによると、世界的に債券が売られ、株価が過去最高値付近で推移し、投資家が地政学的な不確実性と格闘している中、今は投資家にとってポートフォリオのリバランスを検討する特に良い時期かもしれないという。ニューオーリンズを拠点とする認定ファイナンシャル・プランナーであり、CNBCのファイナンシャル・アドバイザー・カウンシルのメンバーでもあるジュード・ブードロー氏は、「これは世の中で最もセクシーではないが、おそらく最も有益な投資アイデアの1つだと思う」と語った。",
    bodyOriginal: `As global bonds sell off, stocks hover near all-time highs and investors grapple with geopolitical uncertainty, it may be a particularly good time for investors to consider rebalancing their portfolios, according to financial advisors.
...
"Rebalancing doesn't necessarily mean getting to a target allocation all at once," Curtis said. "New cash flows, withdrawals and tax-aware trades can also be used to move a portfolio back towards a desired allocation."`,
    bodyJa: `ファイナンシャル・アドバイザーらによると、世界的に債券が売られ、株価が過去最高値付近で推移し、投資家が地政学的な不確実性と格闘している中、今は投資家にとってポートフォリオのリバランスを検討する特に良い時期かもしれないという。
ニューオーリンズを拠点とする認定ファイナンシャル・プランナーであり、CNBCのファイナンシャル・アドバイザー・カウンシルのメンバーでもあるジュード・ブードロー氏は、「これは世の中で最もセクシーではないが、おそらく最も有益な投資アイデアの1つだと思う」と語った。
リバランスとは何ですか?
投資家がリバランスを行うと、資産配分が目標レベルに戻ります。
たとえば、投資家は、市場リスクに対する許容度と引退までの年数を考慮すると、株式 60%、債券 40% の組み合わせ (古典的な 60/40 ポートフォリオ) が適切であると判断している可能性があります。
しかし、市場は時間の経過とともにこれらの配分が自然に狂ってしまいます。
ポートフォリオの伝統的な成長エンジンである株式は、近年急成長しています。
S&P 500 株価指数のリターンは、テクノロジー企業や人工知能に対する高揚感などの要因により、2023 年に 24%、2024 年に 23%、2025 年に 16% となり、長期平均の約 10% を大きく上回りました。
S&P500種株価指数は8月の過去最高値からは若干下落したが、株価は2026年現在までに11％以上上昇している。
一方、２月末のイラン戦争開始以来、債券は広範囲に売られる中、急落している。
一般に、債券価格は利回りと逆の動きをしており、世界中の国債利回りは数年ぶりの高水準にまで上昇している。インフレと債務に対する投資家の懸念により、世界の政府の借入コストが圧迫されている。
水曜日の10年米国債利回りは2023年以来の高水準を記録した。
その結果、長期債の価格に連動する投資ファンドの価値が下落した。例えば、水曜日午後の時点で、iシェアーズ7-10年国債ETF（IEF）は、配当を除くと年初から4％以上下落している。フィデリティ長期国債インデックスファンド（FNBGX）は５％以上下落した。
これらを総合すると、投資家の資産配分が株式偏重になり、ポートフォリオが意図したよりもリスクが高くなっている可能性が高い。
カリフォルニア州オークランドに拠点を置く認定ファイナンシャル・プランナーであり、CNBCのファイナンシャル・アドバイザー評議会のメンバーでもあるキャシー・カーティス氏は、「テクノロジー中心のポートフォリオだけでなく、ほとんどのポートフォリオにおいて株式が大きな部分を占めているのは間違いない」と語る。 「市場全体でかなり幅広い利益が得られました。」
リバランスのメリット
アドバイザーらによると、リバランスには、目標とするポートフォリオのリスクに戻すだけでなく、さらに多くのメリットがあるという。
たとえば、投資家が利益をポートフォリオの別の部分に移すことで、成功した投資からの利益を確定するのに役立ちます。
「安く買って高く売るという規律ある方法であり、歴史的には（金融）市場で何をすべきかについての基本的な考え方だ」とブードロー氏は語った。
今日の市場では、投資家は株式からの利益をポートフォリオの債券側に移す可能性が高く、同時に株式の配分を減らし、債券の配分を増やすことになるでしょう。
アドバイザーらによると、価格が低迷している現在、投資家は債券ファンドの購入に慎重かもしれないが、わずかな割引価格で債券ファンドを購入できるチャンスだという。これは、株価が下落したときによく推奨される「押し目買い」としても知られています。
リバランスはまた、取引のフレームワークを提供することで、投資から感情を取り除き、市場のタイミングを計りたいという誘惑（しばしば悪い結果をもたらす行動）を取り除くのにも役立ちます。
これは、イラン戦争のような不確実性の中で株を手放したくなるかもしれない投資家にとって、今日の環境では重要だ。水曜日、原油価格が1バレル＝100ドルを突破し、インフレ懸念が高まる中、株価は下落した。
カーティス氏は「現在、投資家は懸念すべきことがたくさんある。複数の地政学的な紛争、（連邦準備制度の）新議長、選挙サイクル、財政赤字の増大、AIの混乱などだ」と述べた。 「投資家は、これらの問題のどれが最終的に市場にとって重要になるかを見極めようとするのではなく、リバランスを利用してリスクをより合理的なレベルまで減らすことができる。」
アドバイザーらによると、何年にもわたる急成長を遂げた後の誤った安心感に誘われて、株式中心のポートフォリオに乗りたがる人々にも同様のことが当てはまるという。
アトランタに本拠を置くコレクティブ・ウェルス・パートナーズの共同創設者であり、CNBCのファイナンシャル・アドバイザー評議会のメンバーであるCFPカミラ・エリオット氏は、「市場が上昇しているとき、人々は市場が下落する可能性があることを忘れている」と語った。
「これは投げ売りではありません」
投資家はこのリバランスを、保有株をすべて売却して完全に現金に移行することと混同すべきではないと同氏は述べた。
「私たちは人々に株式をすべて売り飛ばすように言っているわけではありません。これは投げ売りではありません」とエリオット氏は語った。
むしろ、投資家がリスク許容度（投資ポートフォリオの潜在的な損失に対してどの程度安心しているかを示す尺度）に再調整する時期が来ていると同氏は述べた。
エリオット氏によると、退職を間近に控えた投資家は、現在の環境を株式ポートフォリオからの利益をリバランスし、現金口座に追加する機会として利用する可能性があり、保有株の価値が下がった場合、退職後の初期の収入源として利用できるという。
エリオット氏によると、投資家は、バンガード・グループ、フィデリティ・インベストメンツ、T・ロウ・プライスなど、ほとんどの大手資産運用会社のウェブサイトで入手できるリスク許容度アンケートに記入することで、損失に対する許容度や損失に対処する能力を判断できるという。
401(k) プランに登録している人も、自分のアカウントにログインして、管理者の Web サイトでアンケートに回答できる可能性が高いと彼女は言いました。
もちろん、リバランスは特定の投資家、特に課税対象の証券口座を持つ投資家にとって税務上の影響を与える可能性があることを覚えておくことが重要だとアドバイザーらは述べた。
401(k) や IRA などの税制上の有利な退職金口座とは異なり、課税口座内で売買すると税金が発生する可能性があります。
投資家は、時間の経過とともに徐々に配分を変更したり、他の部分を売らずにポートフォリオの一方の配分を強化したりできる可能性があります。
カーティス氏は「リバランスは必ずしも一度に目標配分に達することを意味するわけではない」と述べた。 「新たなキャッシュフロー、引き出し、税金を意識した取引を利用して、ポートフォリオを望ましい配分に戻すこともできます。」`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/09/09/bond-selloff-stock-boom-rebalancing.html",
    publishedAt: "2026-09-09T18:55:18+00:00",
    category: "エネルギー",
    imageUrl: "https://images.unsplash.com/photo-1473172367879-2dca04a4dca4?w=800&q=80",
    readTime: 7,
  },
  {
    id: "coreweave-ceo-chalks-up-public-ai-pushba-65ee9be3",
    title: "CoreWeave CEO chalks up public AI pushback to the speed of change: 'And that is frightening'",
    titleJa: "CoreWeave CEO、AIによる公共の反発を変化のスピードに言及：「それは恐ろしいことだ」",
    summaryJa: "CoreWeave CEOのMike Intrator氏は今週、ゴールドマン・サックスのCommunacopia + Technology ConferenceでCNBCに語った。",
    bodyOriginal: `The public opposition to artificial intelligence and data centers is front and center at the Goldman Sachs Communcacopia + Technology Conference.
...
"Do not underestimate the power of this technology. These will soon be superhuman systems that can hack anything, revolutionize any field overnight, and acquire real power and resources. We have all witnessed the progress in each of these domains, and progress is not slowing," Coxon wrote in a post on X announcing his resignation.`,
    bodyJa: `人工知能とデータセンターに対する国民の反対は、ゴールドマン・サックス・コミューンカコピア + テクノロジー・カンファレンスの中心にあります。
CoreWeaveの最高経営責任者（CEO）Mike Intrator氏はCNBCのDavid Faberに対し、企業はこのテクノロジーの利点を国民に十分に説明していないと語った。
イントレーター氏は水曜日に放映されたコメントの中で、「AI企業がデータセンターによって人々や政府、意思決定に提供できることの利点について、私たちが特にうまく話してきたとは思えない」と述べた。
この年次カンファレンスには最大手のテクノロジー企業やメディア企業のリーダーが一堂に会し、AIの導入は、その構築に対して多くの地域社会が示している反発と同様に、おそらくあらゆる種類の企業が直面する最大のチャンスであり、リスクの1つである。
イントレーター氏は、変革を巡る不安は特にデータセンターに関するものではなく、物事の変化の速さに関するものだと主張した。
「それはまさに、『ねえ、世界は変化していることを知っているだろう、そしてそれは非常に急速に変化している、そしてそれは私にも影響を与えるだろう。それは私の子供たちにも影響を与えるだろう、そしてそれはどのようなものになるだろうか？そしてそれは恐ろしいことだ』と彼は付け加えた。
ゴールドマンのカンファレンスが始まると、AI研究者がアンスロピック・チューズデイでの仕事を辞め、急速に進化するテクノロジーが「10年代の終わりまでに我々全員を滅ぼす可能性がある」と警告したことで、テクノロジー業界の別のコメントが注目を集めた。
Anthropic とその最大の競合企業である OpenAI の両方で働いていたジェイコブ・コクソン氏は、両社が AI の超知能化を目指す競争で「命を賭けている」と非難した。
「このテクノロジーの力を過小評価しないでください。これらは間もなく、あらゆるものをハッキングし、あらゆる分野を一夜にして革命を起こし、真の力とリソースを獲得できる超人的なシステムになるでしょう。私たちは皆、これらの各領域の進歩を目撃しており、進歩は減速していません」とコクソン氏は辞任を発表するXへの投稿で書いた。`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/09/09/goldman-sachs-communcacopia-technology-conference-ai.html",
    publishedAt: "2026-09-09T16:24:03+00:00",
    category: "テクノロジー",
    imageUrl: "https://images.unsplash.com/photo-1518770660439-4636190af475?w=800&q=80",
    readTime: 2,
  },
  {
    id: "fed-rate-hike-hinges-on-two-key-inflatio-00e8aa79",
    title: "Fed rate hike hinges on two key inflation reports in the next two days",
    titleJa: "FRBの利上げは今後2日間の2つの重要なインフレ報告次第",
    summaryJa: "消費者物価と卸売物価は再び上昇している。 FRBが行動するにはどの程度の事態が悪化する必要があるだろうか？",
    bodyOriginal: `Consumer and wholesale prices are rising again. Just how bad does it have to get for the Fed to act?`,
    bodyJa: `消費者物価と卸売物価は再び上昇している。 FRBが行動するにはどの程度の事態が悪化する必要があるだろうか？`,
    source: "MarketWatch",
    sourceUrl: "https://www.marketwatch.com/story/fed-rate-hike-hinges-on-two-key-inflation-reports-in-the-next-two-days-09d63bd9?mod=mw_rss_topstories",
    publishedAt: "2026-09-09T16:18:00+00:00",
    category: "金融政策",
    imageUrl: "https://images.mktw.net/im-93514665",
    readTime: 2,
  },
  {
    id: "air-traffic-failure-was-avoidable-says-t-804698a5",
    title: "Air traffic failure was avoidable, says Transport Secretary",
    titleJa: "航空交通の失敗は避けられたと運輸長官が語る",
    summaryJa: "航空交通の失敗は避けられたと運輸長官が語る- 公開されました",
    bodyOriginal: `Air traffic failure was avoidable, says Transport Secretary
- Published
...
- Published8 hours ago`,
    bodyJa: `航空交通の失敗は避けられたと運輸長官が語る
- 公開されました
運輸長官によると、広範な飛行混乱を引き起こした英国の航空交通管制システムの技術的障害は回避可能だった。
ハイジ・アレクサンダーさんは下院に対し、火曜日に4時間にわたってダウンしたナッツ社が運営するシステムについて、航空監視機関に独立した調査を指示したと語った。
英国への出入国に乗客が苦労し、混乱が２日も続き、２０００便以上が欠航となった。
アレクサンダー氏は、ナショナルズの監督マーティン・ロルフ氏と面会した後、サイバー攻撃の可能性は否定できないが、「この問題が避けられなかったとは思わない」とも付け加えた。
ナッツは、この3年間で3度目となる重大な技術的欠陥について謝罪した。
アレクサンダー氏は、政府が49％出資するナッツが「混乱をできるだけ早く解決し、最小限に抑えるためにどのように対応するか」についてロルフ氏と話し合ったと述べた。
同氏は「Natsシステムの回復力について厳しい質問」が必要だと述べ、「消費者救済の問題についても考える必要がある」と付け加えた。
ウィズエアやライアンエアなどの航空会社がロルフ氏の辞任を要求する中、政府は水曜日初め、11年間ナショナルズを率いてきたロルフ氏に信頼を置いていると述べた。
ナッツは事件を調査し、1週間以内に報告するよう求められている。しかし、アレクサンダー氏は民間航空局に対し、独立した調査を実施し、6か月以内に最新情報を提示するよう要請したとも述べた。
同国の航空会社を代表する英国航空は、「英国の航空ネットワーク全体に大きな混乱を引き起こした、昨日のナッツの技術的障害（ここ3年間で3度目となる大規模なシステム障害）について深刻な懸念を表明する」ようアレクサンダーに書簡を送ったと発表した。
英国航空のティム・アルダースレイド最高経営責任者（CEO）は、「その結果、航空会社が他人のミスのツケを受け取る一方、責任を負う組織は財務上の影響をほとんど、またはまったく受けないというシステムができ上がった」と述べた。
「責任の所在には説明責任が求められるべきであり、民間航空法案はこれに対処する機会を提供するものである。」
混乱によってナッツの管理システムが破壊されたのはこれが初めてではない。 2023 年、8 月の銀行休業日の週末にコンピューターがシャットダウンし、70 万人の乗客に混乱が生じました。
自宅から障害を修正できなかったエンジニアは、職場に行くまでに 3 時間かかりました。
2025 年にも小規模な Nats 障害が発生し、150 件のキャンセルが発生しました。
Nats は官民パートナーシップであり、政府が過半数の株式を保有しています。残りは、BA、イージージェット、ヴァージン・アトランティック航空を含む英国の航空会社グループと、ヒースロー空港とナッツのスタッフの間で分割される。
この不具合について今のところわかっていることは何でしょうか?
ナッツは火曜日の英国標準時13時46分に「飛行機の出発に多少の混乱を引き起こしている」「技術的問題」を調査していることを初めて認めた。
この不具合は、2か所ある航空交通管制センターのうちの1つが置かれているハンプシャー州のナッツのスワンウィック・センターで発生した。もう 1 つはエアシャー州プレストウィックにあります。
約90分後、同社は問題が自社の飛行処理システムにあることを特定したと発表した。
これは、管制官が航空交通を管理するために使用する飛行計画やその他の運航情報を処理します。
航空機が英国の空域を通過するたびに飛行情報を継続的に更新し、管制官が安全で秩序ある交通の流れを維持できるように支援します。
ナット氏は、システムの問題は19時30分までに解決され、滞空便の解消に取り組んでいると述べた。
しかし、航空分析会社シリウムによると、水曜夕方までに、最初に障害が発生して以来欠航または離陸できなかった航空機の数は2,000便以上に増加した。
関連トピック
- 8 時間前に公開`,
    source: "BBC",
    sourceUrl: "https://www.bbc.co.uk/news/articles/c5y42v5n05do?at_medium=RSS&at_campaign=rss",
    publishedAt: "2026-09-09T16:13:40+00:00",
    category: "金融政策",
    imageUrl: "https://ichef.bbci.co.uk/ace/standard/240/cpsprodpb/7de8/live/6b39d570-ac66-11f1-80f0-9795d1a5edbc.jpg",
    readTime: 4,
  },
  {
    id: "investors-worried-about-rising-bond-yiel-e7220124",
    title: "Investors worried about rising bond yields are keeping a close eye on this corner of the market",
    titleJa: "債券利回りの上昇を懸念する投資家は、市場の一角に注目している",
    summaryJa: "来週の連邦準備理事会（FRB）の待望の政策会合を前に債券市場の金利が上昇する中、米国の小型株は重要なポイントに達し、主要な水準を下回って取引されている。",
    bodyOriginal: `U.S. small-cap stocks have hit a pivotal point, trading below a key level as interest rates in the bond market climb ahead of the Federal Reserve’s highly anticipated policy meeting next week.`,
    bodyJa: `来週の連邦準備理事会（FRB）の待望の政策会合を前に債券市場の金利が上昇する中、米国の小型株は重要なポイントに達し、主要な水準を下回って取引されている。`,
    source: "MarketWatch",
    sourceUrl: "https://www.marketwatch.com/story/investors-worried-about-rising-bond-yields-are-keeping-a-close-eye-on-this-corner-of-the-market-aa4096c8?mod=mw_rss_topstories",
    publishedAt: "2026-09-09T16:09:00+00:00",
    category: "金融政策",
    imageUrl: "https://images.mktw.net/im-94711622",
    readTime: 2,
  },
  {
    id: "treasury-department-to-buy-back-up-to-6-4beb8838",
    title: "Treasury Department to buy back up to $6 billion in longer-term debt, triple the normal level",
    titleJa: "財務省、通常の3倍となる最大60億ドルの長期国債を買い戻す",
    summaryJa: "財務省は水曜日、債券市場の機能維持を目的としたオペで最大60億ドルの国債を買い戻すと発表した。待望の発表は、通常の自社株買い業務の額を3倍に増やすもので、8月19日のスコット・ベッセント財務長官の、同省が発行済証券の通常額を少なくとも2倍にするという発表に続くものだ。",
    bodyOriginal: `The Treasury Department on Wednesday said it will buy back up to $6 billion of government debt in an operation aimed at keeping bond markets functioning.
...
Treasury's maneuvering, which also has included a parallel move to support the Japanese yen, come as Federal Reserve Chairman Kevin Warsh has preached less involvement in financial markets. The Fed has a rate decision coming in a week, with traders pricing in a rate hike.
"Actions not words are what matter, and action in this case mean changes in the direction of fiscal policy or interest rates," said Anil Kashyarp, a University of Chicago economist.
—CNBC's Steve Liesman contributed.`,
    bodyJa: `財務省は水曜日、債券市場の機能維持を目的としたオペで最大60億ドルの国債を買い戻すと発表した。
待望の発表は、通常の自社株買い業務の額を3倍に増やすもので、8月19日のスコット・ベッセント財務長官の、同省が発行済証券の通常額を少なくとも2倍にするという発表に続くものだ。
財務省はまた、今後の運用額は少なくとも４０億ドルになると述べた。
このオペは表面上、国債市場（今回の場合は10年債と20年債）の流動性を維持することを目的としているが、この異例の措置は、2008年の世界金融危機以前以来の高値を付けていた米国債利回りに歯止めをかけるための措置ともみられている。
しかし、市場の反応は否定的でした。米国債利回りはさらに上昇したが、長期債は緩和前にそれぞれ最大５ベーシスポイント上昇するなど不安定だった。
基準となる１０年債は東部時間午前１１時半ごろに４．８４１％に達した。 20年債は5.314％に上昇し、30年債も5ベーシスポイント上昇し、重要とみられていた5.3％水準を突破し、直近の利回りは5.307％となった。 1 ベーシス ポイントは 0.01% に相当します。
ポトマック・リバー・キャピタルの債券ファンドマネジャー、マーク・スピンデル最高投資責任者は、金融危機時の元財務長官の行動に言及し、「ハンク・ポールソンのバズーカではない」と述べた。 「そして、その危機において議会の行為が必要でした。」
水曜日の発表には買い戻し水準が当初発表の何倍にもなる可能性があるとの憶測が流れており、財務省はその額が通常の20億ドルのオペの「少なくとも」2倍になると述べた。
ライトソンICAPのアナリストらは今週初め、「規模を60億ドルに引き上げることは自社株買いの規模が3倍になることになり、意味のある拡大にはなるが、『少なくとも2倍』という文言の精神から大きく外れるものではない」と書いている。
さらに「規模を４倍、さらには５倍の８０億─１００億ドルの範囲に拡大することは不可能ではないが、わずか２週間で財務省の債務戦略における２度目の大きな転換となるだろう」と付け加えた。 「それは財務省が8月19日の性急な発表を最初から熟慮していなかったということを認めることになるだろう。」
実際の買い戻しは木曜日の午後２時に終了する２０分間のオペレーションで行われる。 ET。
米国債利回りの上昇には、最近40兆ドルを超えた政府債務の急増、関税やイラン戦争によるインフレ懸念の高まり、それに対応して水曜日に原油価格が1バレル＝100ドルを突破したエネルギー価格の復活といった要因が重なったことが背景にある。
同時に、国債カーブの長い端は、世界で最も深く、最も流動性が高いと考えられている市場の中で、あまり活発ではない部分です。
今年の国債発行額は２０２５年から１１．８％増加し、３１兆８０００億ドルの公的債務は８．２％増加した。
みずほのエコノミスト、アレックス・ペレ氏は「財務省が発表した自社株買いは期待（見方によっては懸念）ほどではなかった」と書いた。 「リスクは、市場の反応を考慮して、財務省が何らかの形でこれを加速させることだ。しかし、標準的な業務手順に反する圧力は、中間選挙の反対側には多少弱まるだろう。」
自社株買いの加速は批判者に直面しており、その額がこのような大規模な市場にどのような影響を与えるのかを疑問視する人もいるほか、この動きは財務省がプロセスを予測可能な形で進めていることからの中断であるとの見方もある。
著名な批評家の一人は、デュケイン・ファミリー・オフィスの所長でベッセント氏の元指導者であるスタンリー・ドラッケンミラー氏だった。
ドラッケンミラー氏はウォール・ストリート・ジャーナルの論説で「財務省が価格を守っていると市場が信じると、利回りの上昇はすべて公式の決意を試すものとなり、試練に耐えるためにはオペを拡大する必要がある」と述べた。
同氏は「ファンダメンタルズに反して物価を守る政府は常に負ける。唯一の変数は、譲歩するまでにどれだけの支出をするかだ」と付け加えた。
米連邦準備制度理事会（FRB）のケビン・ウォーシュ議長が金融市場への関与を減らすと説いている中で、財務省のこの策略には日本円を支援するという並行した動きも含まれている。 FRBは1週間以内に金利決定を予定しており、トレーダーらは利上げを織り込んでいる。
シカゴ大学の経済学者アニル・カシャープ氏は「重要なのは言葉ではなく行動であり、この場合の行動とは財政政策や金利の方向性の変更を意味する」と述べた。
—CNBCのスティーブ・リースマン氏が寄稿しました。`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/09/09/treasury-department-to-buy-back-6-billion-in-longer-term-debt-triple-the-normal-level.html",
    publishedAt: "2026-09-09T15:57:05+00:00",
    category: "エネルギー",
    imageUrl: "https://images.unsplash.com/photo-1473172367879-2dca04a4dca4?w=800&q=80",
    readTime: 5,
  },
  {
    id: "treasury-will-buy-more-government-bonds-20045cc0",
    title: "Treasury will buy more government bonds than previously announced. The market remains ‘underwhelmed.’",
    titleJa: "財務省はこれまで発表したよりも多くの国債を購入する予定だ。市場は依然として「圧倒されている」。",
    summaryJa: "財務省は、債券利回り抑制に向けてこれまでに発表した金額を上回る60億ドルの米国債を買い戻すと発表した。",
    bodyOriginal: `The Treasury Department said it would buy back $6 billion in U.S. government debt, exceeding the amount previously announced in its effort to contain bond yields.`,
    bodyJa: `財務省は、債券利回り抑制に向けてこれまでに発表した金額を上回る60億ドルの米国債を買い戻すと発表した。`,
    source: "MarketWatch",
    sourceUrl: "https://www.marketwatch.com/story/treasury-to-buy-back-more-government-bonds-than-previously-announced-940363ee?mod=mw_rss_topstories",
    publishedAt: "2026-09-09T15:53:00+00:00",
    category: "金融政策",
    imageUrl: "https://images.mktw.net/im-60416201",
    readTime: 2,
  },
  {
    id: "brent-crude-oil-tops-101-for-first-time-596865c2",
    title: "Brent crude oil tops $101 for first time since July as fighting escalates in Persian Gulf",
    titleJa: "ペルシャ湾での戦闘激化でブレント原油が7月以来初めて101ドルを突破",
    summaryJa: "ペルシャ湾で米国とイランの戦闘が激化し、ホルムズ海峡を通じたエネルギー輸出が減少するのではないかとの投資家の懸念が高まるなか、水曜日、原油価格は３％以上上昇した。北海ブレント先物は東部時間午前１１時１２分までに３．４％上昇し１バレル＝１０１．２５ドルとなった。国際指標が１０１ドルを超えたのは７月以来初めて。米国ウェスト・テキサス・インターミディエート先物は３．６％高の９６．３８ドルで取引された。",
    bodyOriginal: `Crude oil prices jumped more than 3% on Wednesday as fighting between the U.S. and Iran escalates in the Persian Gulf, raising investors' fears that energy exports through the Strait of Hormuz will fall.
Brent futures were up 3.4% at $101.25 a barrel by 11:12 a.m. ET. It is the first time the international benchmark has crossed $101 since July. U.S. West Texas Intermediate futures traded 3.6% higher to $96.38.
...
The escalation in the U.S.-Iran conflict, now in its seventh month, is raising the risk of oil prices surging above $120 a barrel as attacks on shipping intensify, said Daan Struyven, co-head of global commodities research at Goldman Sachs, in an interview with CNBC's "Squawk Box Asia."
Goldman's base case remains for Persian Gulf exports to gradually recover as producers adapt to disruptions, including through alternative shipping routes and eventually additional pipeline capacity.
...
The U.S. and Iran largely refrained from fighting for about a month after an outburst of violence in July. Washington has pivoted to applying economic pressure on Tehran. But fighting has erupted again as Iran continues to attack commercial traffic in anda round Hormuz.`,
    bodyJa: `ペルシャ湾で米国とイランの戦闘が激化し、ホルムズ海峡を通じたエネルギー輸出が減少するのではないかとの投資家の懸念が高まるなか、水曜日、原油価格は３％以上上昇した。
北海ブレント先物は東部時間午前１１時１２分までに３．４％上昇し１バレル＝１０１．２５ドルとなった。国際指標が１０１ドルを超えたのは７月以来初めて。米国ウェスト・テキサス・インターミディエート先物は３．６％高の９６．３８ドルで取引された。
米軍は火曜日、米軍艦への攻撃未遂への報復としてイランの原油タンカー５隻を破壊した。米中央軍によると、米軍艦はイランの攻撃を回避することに成功し、米軍関係者に被害はなかった。
ゴールドマン・サックスの世界商品調査共同責任者、ダーン・ストルイベン氏はCNBC「スコーク・ボックス・アジア」とのインタビューで、米国とイランの紛争激化は現在7カ月目に入り、海運業への攻撃が激化するにつれ、原油価格が1バレル＝120ドルを超えて急騰するリスクを高めていると述べた。
ゴールドマンの基本シナリオは、生産者が代替輸送ルートや最終的にはパイプライン能力の追加などを通じて混乱に適応するにつれて、ペルシャ湾の輸出が徐々に回復するとの見通しを維持している。
しかし、最近の事態の激化により、タンカーへの攻撃により今後数カ月間輸出が回復しないという、より強気なシナリオの可能性が高まったとストルイベン氏は述べた。
米国とイランは、7月に暴動が勃発してから約1か月間、戦闘をほぼ控えた。米国政府はテヘランに経済的圧力をかけることに方針を転換した。しかし、イランがホルムズ周辺の商業交通を攻撃し続けているため、戦闘が再び勃発している。`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/09/09/oil-prices-today-wti-brent-us-iran-hormuz-attacks.html",
    publishedAt: "2026-09-09T15:45:15+00:00",
    category: "エネルギー",
    imageUrl: "https://images.unsplash.com/photo-1473172367879-2dca04a4dca4?w=800&q=80",
    readTime: 2,
  },
  {
    id: "robinhood-ceo-says-companies-can-t-contr-fd0e560d",
    title: "Robinhood CEO says companies can't control how their stock is tokenized as AMC clash escalates",
    titleJa: "ロビンフッドCEO、AMC衝突激化で企業は自社株のトークン化方法を制御できないと発言",
    summaryJa: "ロビンフッドのヴラド・テネフ氏は、トークン保有者が議決権を持たないことを認めながらも、上場企業は自社株を中心に構築された金融商品をコントロールすることはできないと述べた。",
    bodyOriginal: `Robinhood CEO Vlad Tenev defended the company's push into tokenized stocks on Wednesday, saying public companies can't control the financial products built around their shares once they go public, after AMC recently slammed Robinhood's tokenization efforts.
...
When asked whether Robinhood would vote those underlying shares, he said the company "hasn't really announced plans for the voting aspect of that."`,
    bodyJa: `最近AMCがロビンフッドのトークン化への取り組みを非難したことを受け、ロビンフッドの最高経営責任者（CEO）ヴラド・テネフ氏は水曜日、同社のトークン化株への取り組みを擁護し、上場企業は一度上場すると自社株を中心に構築された金融商品をコントロールすることはできないと述べた。
トークン化とは、ブロックチェーン ネットワーク上で、上場証券、現実世界の資産、またはその他の形式の価値のデジタル表現を発行するプロセスです。トークン化された資産の所有者は、資産自体の完全な所有権を持ちません。
テネフ氏は、上場株式のテクノロジー中立な金融ラッパーとしてのロビンフッドのトークン化の取り組みについて語った。同氏はCNBCの「スコーク・ボックス」に対し、企業の株式が公開されれば、株主は譲渡可能な資産を所有しており、他の金融機関は発行者の許可を求めずにそれらの株式を参照する商品を作成できるはずだと語った。
同氏は「発行体は発行する株式の権利と義務を管理すべきであり、実際に管理しているが、それは発行体がすべてを管理するという意味ではない」と述べた。 「特に、それらの株式を参照する独自の証券を発行する他の企業を支配していません。」
同氏はさらに、「発行者の同意は、まさに何をしようとしているかによって決まる。ロビンフッド株式トークンの場合、原株を裏付けとした別の事業体によって発行され、トークン化された証券であるが、自動的に発行者の同意を必要とするべきではない。」と付け加えた。
このコメントは、トークン化されたAMC株式を含むロビンフッドのトークン化株式に対するAMC CEOのアダム・アーロン氏の激しい批判に続いて出た。アーロン氏は、ますます一般的になっているトークン化の手法により、発行会社の関与なしに証券会社がAMC株へのエクスポージャーを生み出すことが可能となり、企業と株主との間の伝統的な関係が損なわれていると述べた。
テネフ氏は、普通株主とは異なり、株式トークンの保有者は基礎となる企業の議決権を受け取らないことを認めた。トークンは原株を裏付けとする債券として構成されているが、テネフもロビンフッドがこれらの株に付随する議決権をどのように行使する予定であるかについては言及を避けた。
ロビンフッドがこれらの原株について議決権を行使するかとの質問に対し、同氏は同社が「議決権の面での計画は実際には発表していない」と述べた。`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/09/09/robinhood-ceo-says-companies-cant-control-how-their-stock-is-tokenized-as-amc-clash-escalates.html",
    publishedAt: "2026-09-09T14:38:32+00:00",
    category: "テクノロジー",
    imageUrl: "https://images.unsplash.com/photo-1518770660439-4636190af475?w=800&q=80",
    readTime: 3,
  },
...
旅行計画が中断されましたか?あなたの経験を共有してください。`,
  ...
  },
  {
    ...
    summaryJa: "シンガポール人男性、米国で大規模暗号通貨強盗の罪を認める- 公開されました",
    bodyOriginal: `Singaporean man pleads guilty in US to massive crypto heist
- Published
...
Other items that the DOJ said the proceeds were spent on included high-end watches worth up to $500,000, luxury clothing valued in the tens of thousands of dollars, rental homes in Los Angeles, the Hamptons, and Miami, private jet rentals for travel and a team of private security guards.`,
    bodyJa: `シンガポール人男性、米国で大規模暗号通貨強盗の罪を認める
- 公開されました
シンガポール人男性が火曜日、史上最大規模の仮想通貨窃盗を組織したとして米国での恐喝共謀罪で有罪を認めた。
マローン・ラム容疑者は、友人らと組んで2億4,500万ドル（約1億8,100万ポンド）のビットコインを盗み、その収益を洗浄していたことを認めた。
米国司法省（DOJ）によると、22歳の彼とその仲間たちは、そのお金を使ってナイトクラブへの訪問に最大50万ドルを費やしたという。また、彼らは10万ドルから380万ドルの価値を持つ珍しい車を購入したとも述べた。
林鄭氏には最高で懲役20年の刑が言い渡される可能性がある。米国地方判事のコリーン・コラー＝コテリー氏は、同氏に対する量刑公聴会の予定をすぐには立てなかった。
ジャニーン・ピロ連邦検事は「もしあなたがサイバー犯罪帝国を築くなら、我々はあなたを探し出し、その活動を解体し、責任を追及するだろう」と述べた。
「この被告は国際ネットワークを率いており、詐欺によって被害者を食い物にし、プライバシーを侵害し、数億ドルの仮想通貨を盗んだ」と付け加えた。
法廷文書によると、陰謀は遅くとも2023年10月までに始まり、少なくとも2025年5月まで続いた。
共謀者らはカリフォルニア、コネチカット、ニューヨーク、フロリダなど米国外出身で、オンラインゲームプラットフォームを通じて知り合った。
司法省は、ラム氏（アン・ハサウェイ、$$$、キング・グリービーの別名でも知られる）が犯罪計画の首謀者であり、被害者を特定し、さまざまな共謀者の役割を調整したと述べた。
彼らは人々をだまして機密情報を漏らしたり、被害者の仮想通貨ウォレットを吸い出すための詳細を入手するために時折家に侵入したりしたと司法省は述べた。
司法省によると、盗まれた仮想通貨は数万ドル相当のエルメス・バーキンのハンドバッグの購入にも使用され、ナイトクラブのパーティーで群衆に投げ込まれたという。
司法省がその収益が使われたとしている他の品物には、最大50万ドル相当の高級時計、数万ドル相当の高級衣料品、ロサンゼルス、ハンプトンズ、マイアミの賃貸住宅、旅行用のプライベートジェットレンタル、民間警備員チームなどが含まれていた。`,
    source: "BBC",
    sourceUrl: "https://www.bbc.co.uk/news/articles/crl6z03pr0do?at_medium=RSS&at_campaign=rss",
    publishedAt: "2026-09-09T03:40:48+00:00",
    category: "マクロ経済",
    imageUrl: "https://ichef.bbci.co.uk/ace/standard/240/cpsprodpb/7c7a/live/c2fc9470-abfb-11f1-8c98-1196ec471ea3.jpg",
    readTime: 2,
  },
  {
    id: "how-asia-s-ultra-rich-are-investing-and-b8109f20",
    title: "How Asia’s ultra-rich are investing and where wealthy Chinese are migrating, according to Maybank Singapore CEO",
    titleJa: "Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.",
    summaryJa: "Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.",
    bodyOriginal: `Asia's ultra-rich are increasingly willing to tap into new asset classes, gold is leaving Dubai for Singapore and wealthy Chinese are flocking to Malaysia, the Singapore CEO of Malayan Bank Bhd said.
...
"We see more Chinese buying up real estate for personal use as well as for their businesses in Malaysia, Kuala Lumpur is a beneficiary to that. I think Malacca is as well. Penang has always been quite appealing to the Chinese," Lee said, referring to cities and regions in Malaysia.`,
    bodyJa: `Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/09/09/asia-ultra-rich-investing-wealthy-chinese-migrating-maybank.html",
    publishedAt: "2026-09-09T03:08:15+00:00",
    category: "金融政策",
    imageUrl: "https://images.unsplash.com/photo-1611974789855-9c2a0a7236a3?w=800&q=80",
    readTime: 2,
  },
  {
    id: "china-s-wholesale-inflation-tops-estimat-76c5372d",
    title: "China's wholesale inflation tops estimates in August on commodity costs, tech demand as consumer price increases meet forecast",
    titleJa: "Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.",
    summaryJa: "Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.",
    bodyOriginal: `China's consumer and wholesale inflation rebounded in August, as higher global commodity costs and surging high-tech demand cushioned persistently tepid domestic consumption.
...
The factory-gate inflation was largely concentrated in energy-related sectors, while that for consumer goods continued to fall, in a sign of soft demand and persistent overcapacity across industries, said Nguyen Hoang Nam, an economist at Capital Economics.
Notably, electronics price inflation climbed to a fresh high last month on the back of global memory-chip shortages, Nam said.
Both consumer and producer price inflation are likely to ease should energy flows in the Gulf region normalize over the coming months, Nam noted. He expects producer prices to fall back into deflation next year.
Tianchen Xu, senior economist at the Economist Intelligence Unit, pointed to the muted performance in the services industry. "There wasn't a seasonal uptick in service prices as in previous years," he said, reflecting weaker-than-usual summer tourism.
...
The youth unemployment rate in urban areas climbed to 17.9% in July, official data showed, the worst reading since August 2025.`,
    bodyJa: `Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/09/09/china-cpi-ppi-august-oil-prices-tech-manufacturing-.html",
    publishedAt: "2026-09-09T03:07:32+00:00",
    category: "エネルギー",
    imageUrl: "https://images.unsplash.com/photo-1473172367879-2dca04a4dca4?w=800&q=80",
    readTime: 2,
  },
  {
    id: "us-slaps-import-ban-on-canadian-alcohol-12ba57db",
    title: "US slaps import ban on Canadian alcohol, motorbikes and other goods",
    titleJa: "米国、カナダのアルコール、バイク、その他の商品の輸入禁止を決定",
    summaryJa: "米国、カナダのアルコール、バイク、その他の商品の輸入禁止を決定- 公開されました",
    bodyOriginal: `US slaps import ban on Canadian alcohol, motorbikes and other goods
- Published
...
Related topics
- Published22 August`,
    bodyJa: `米国、カナダのアルコール、バイク、その他の商品の輸入禁止を決定
- 公開されました
隣国の米国製品に対する報復関税の発効に伴い、米国はアルコール蒸留酒、乳製品、オートバイなどのカナダ製品の多数を禁止している。
ドナルド・トランプ米大統領は火曜日の一連の大統領令の中で、カナダは米国を「差別」していると述べ、9月29日から始まる輸入禁止措置の概要を述べた。
火曜日初め、カナダのマーク・カーニー首相はビデオ演説で、最大の貿易相手国である米国からの離脱には「代償が伴う」と述べた。
米国とカナダの当局者は双方とも貿易協定を締結したいと述べているが、8月下旬に交渉が決裂して以来、新たな交渉は予定されていない。
BBCはカーニー氏の事務所にコメントを求めた。
ホワイトハウスの新たな制裁は、米国とカナダの間で数カ月間続いている貿易戦争における最新の攻撃となる。両者は歴史的に緊密な同盟関係にあり、お互いにとって重要なビジネスパートナーであった。
通常、カナダの総輸出量の 3 分の 2 以上が隣国に向けられています。
一方、カナダはメキシコに次ぐ米国の第二位の貿易相手国であるが、その輸出ははるかに多様化している。
国境の両側の企業経営者らは貿易戦争の余波に懸念を表明している。多くの人は、商品の価格は上昇し、顧客数は減少すると予想しています。
ホワイトハウスは先月、数回の交渉決裂を受けて約200億ドル（約148億ポンド）のカナダ製品に50％の関税を課した。
これらの関税は、カナダの家具やワイン産業のほか、一部のスポーツや釣り用具の企業などの分野に打撃を与えた。
カナダは鉄鋼、衣料品、家具などの米国製品に対するドル対ドルの関税で対抗した。この対抗義務は火曜日の深夜過ぎに発効した。
カナダ人とアメリカ人に実際にかかる関税はどれくらいか
- 16 時間前に公開
5つのグラフで見る米国とカナダの貿易戦争
- 8 月 31 日公開
ホワイトハウスは火曜日に新たな輸入制限を発表した際、カナダは米国製品を制限する一方、他国の同じ製品には同様の措置を講じないことで米国企業を「差別」していると述べた。
ホエーやノンアルコールビールなど一部の製品は輸入が全面禁止され、チーズやモーターボートなど他の製品については関税がさらに引き上げられた。
月曜日、トランプ大統領はさらなる貿易制限を示唆し、カナダの航空機会社ボンバルディアに対し、製造拠点を米国に移さなければ製品を米国で販売できなくなると警告した。
トランプ大統領は長年、関税が米国と他国の間の貿易不均衡の縮小に役立つと信じてきたが、同氏の広範な関税は米国の伝統的な同盟国の多くを動揺させている。
一部のカナダ人はアルコールなどの米国製品の大規模なボイコットを主導しており、トランプ大統領が昨年世界的な関税キャンペーンを開始した後、一部の店の棚から製品が消えた。
ヒンリッヒ財団の貿易専門家デボラ・エルムズ氏はBBCに対し、輸入禁止措置は米国のバイヤーとのカナダのビジネスに「強い」影響を与える可能性があるが、初期の試算では約10億ドル相当の商品に影響を与える「軽度の影響」を示していると語った。
エルムズ氏は、カナダは「当面は方針を堅持」し、米国の最近の動きを考慮して企業支援策を調整する可能性が高いと述べた。
「より大きな問題は、双方が再び一緒に座るには何が必要かということだ。一例として、これらの宣言の文言は、交渉のテーブルに着くのに役立たない」と付け加えた。
ホワイトハウスによって禁止されているカナダ製品のリストには次のものが含まれます。
ホエーなどの乳製品
サトウキビ糖蜜
ノンアルコールビール
ワイン、ラム酒、ウォッカ製品の長いリスト
麦芽から作られたビール
オートバイ（モペットを含む）
より高い輸入税に直面しているのは次のとおりです。
いろいろな種類のチーズ
生の皮と皮
紙
一部の家具とマットレス
...
釣り竿のパーツとアクセサリー
配電盤
カーニー氏は火曜日、カナダの対抗関税の発効に際し、「行動には常に代償が伴う。しかし、それは立ち止まることの代償には及ばない」と語った。
米国とカナダの間の緊張も関税を超えたものになっている。
8月、トランプ大統領はオンタリオ湖の名前をアメリカ湖に変更するよう命令し、その結果カナダ人や米国の一部から反発が起きた。
関連トピック
- 8 月 22 日発行`,
    source: "BBC",
    sourceUrl: "https://www.bbc.co.uk/news/articles/c99dm1000p7o?at_medium=RSS&at_campaign=rss",
    publishedAt: "2026-09-09T03:03:32+00:00",
    category: "貿易",
  ...
  },
  {
    ...
    publishedAt: "2026-09-09T02:20:00+00:00",
    category: "金融政策",
    imageUrl: "https://images.mktw.net/im-65749290",
    readTime: 2,
  },
  {
    id: "hit-tv-show-south-park-becomes-south-ame-5628c934",
    title: "Hit TV show 'South Park' becomes 'South America' in apparent reference to Trump's geographic name changes",
    titleJa: "人気テレビ番組「サウスパーク」が「南アメリカ」に変更 トランプ大統領の地理的名称変更に言及",
    summaryJa: "Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.",
    bodyOriginal: `Television comedy series "South Park" has announced it is changing its name to "South America" as the show is set to begin its 29th season on Sept. 16.
...
Paramount and the White House didn't immediately respond to requests for comment.`,
    bodyJa: `Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/09/09/tv-show-south-park-changes-show-name-south-america-trump.html",
    publishedAt: "2026-09-09T01:52:10+00:00",
    category: "テクノロジー",
    imageUrl: "https://images.unsplash.com/photo-1518770660439-4636190af475?w=800&q=80",
    readTime: 2,
  },
  {
    id: "should-promotion-depend-on-how-workers-u-b11c7f61",
    title: "Should promotion depend on how workers use AI?",
    titleJa: "昇進は従業員の AI の使い方に依存するべきでしょうか?",
    summaryJa: "Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.",
    bodyOriginal: `Should promotion depend on how workers use AI?
- Published
...
- Published28 July`,
    bodyJa: `Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.
「そして、AI によって従業員の効率が向上したために、従業員が効果的により多くの仕事をこなしている場合、別の方法で報酬を与えるべきでしょうか? それとも、従業員は事実上自分自身を余らせて、生産性の阻害要因となっているのでしょうか?」
チャンダー氏は企業に対し、明確なポリシー、トレーニング、境界線を設けるようアドバイスしている。そうしないと、公平性、パフォーマンスの期待、雇用の安全に関して従業員が紛争を引き起こす危険がある。
実際、2027年1月から英国の従業員は不当解雇の申し立てを提出できる期間が現在の3か月から6か月となり、現在の2年間ではなくわずか6か月の勤務後に提出できるようになる。
しかし、人事コンサルタントのティナ・ラーマン氏は、雇用主は現在、なぜAIを人々の仕事の一部にしたいのか、その最終目的は何なのかを従業員に伝えるのに十分な透明性を持っていないと述べ、コストと時間を節約するだけでなく、アウトソーシングを削減することにも同意する。
ロンドンを拠点とするコンサルティング会社HRハビタットを経営するラーマン氏は、「彼らが誤解しているため、このことが従業員に反映されていない」と話す。
AIの利用に関する明確性の欠如が、パメラ氏の会社に不満を引き起こしているのは確かだ。
「リーダーシップは意図的に一貫性がなく、曖昧になっています。企業は、破壊的なストーリーを自分のものにすることなく、生産性の向上を望んでいます」と彼女は言います。
「何か問題が起こったら、彼らは『そんなことするように言ったんじゃない。どこからそんなものを手に入れたの？』と言うだろう。」それで、AI を使って何かをやって、それがうまくいったとしたら、それは素晴らしいことです。」
職場での AI 使用の義務化は、実際にプラスの効果をもたらすというよりは、純粋にパフォーマンス重視になる可能性があると、応用 AI 研究者でありヘンリー ビジネス スクールの講師を務めるカミラ ミラー氏は警告します。
「AI の利用状況を KPI (重要業績評価指標) にすれば、人々は指標を達成するために対話を記録し、必要のなかった作業をチャットボットにルーティングし、ダッシュボード上で生産的に見える AI 風味の出力を生成するでしょう。採用を測定することになります。判断力、学習、またはより良い意思決定を測定することはありません」と、レディングに拠点を置くミラー氏は述べています。
「あなたは人々をより熟練させたのではなく、彼らをより従順にさせたのです。」
一部の企業はこうした主張を認めている。
Duolingoの最高経営責任者（CEO）、ルイス・フォン・アン氏は4月、社外向けのポッドキャスト「Silicon Valley Girl」に対し、同社の語学学習会社は業績評価の一環としてAIの利用をやめたと語った。
「私たちは、人々が『AIのためにAIを使ってほしいですか？』と尋ねていることに気づきました。
「結局、私たちは撤回し、こう言いました。『ほら、あなたのパフォーマンスにとって最も重要なことは、どんな仕事であっても、できる限り最善を尽くすことだ。多くの場合、AI がそれを助けてくれます。でもそれができないなら、私はあなたにそれを強制するつもりはありません。」
一方、5月にフィナンシャル・タイムズ紙は、アマゾンが従業員のAI利用状況を追跡する社内リーダーボードを閉鎖したと社外向けに報じた。報告書によると、従業員はAIに不必要なタスクを設定することでランキングを上昇させようとしていたという。
こうした注目度の高い動きにもかかわらず、一部のスタッフは依然として AI の熟練度を示す必要があり、パメラもその 1 人です。
50代半ばの彼女は10年以内に退職する予定で、年金や健康保険を失うリスクを冒さないために仕事を続けたいと考えています。彼女は、新しい顧客の獲得に AI を活用する方法を目に見えて強化しており、その功績が確実に認められるようにしています。
ダンカン・トレビシックに関しては、彼は多くのサイドプロジェクトで将来の自分自身を証明するために最善を尽くしています。
「AI があなたよりもうまく仕事ができるのであれば、企業があなたに取って代わるのは理にかなっています。それが資本主義モデルの仕組みです。つまり、AI を活用できる資産を所有する立場にどう移行して利益を得ることができるかということです」と Trevithick 氏は言います。
- 7 月 3 日発行
- 7 月 30 日発行
- 7 月 28 日発行`,
    source: "BBC",
    sourceUrl: "https://www.bbc.co.uk/news/articles/c1j1896e973o?at_medium=RSS&at_campaign=rss",
    publishedAt: "2026-09-08T23:05:23+00:00",
    category: "テクノロジー",
    imageUrl: "https://ichef.bbci.co.uk/ace/standard/240/cpsprodpb/bb6c/live/d0ef5870-900c-11f1-aabc-c3c7aa714117.jpg",
    readTime: 5,
  },
  {
    id: "i-m-27-and-i-ve-already-written-my-will-df18d2e0",
    title: "I'm 27 and I've already written my will - here's why",
    titleJa: "私は 27 歳で、すでに遺言書を書いています - これがその理由です",
    summaryJa: "私は 27 歳で、すでに遺言書を書いています - これがその理由です- 公開されました",
    bodyOriginal: `I'm 27 and I've already written my will - here's why
- Published
...
- Published24 July 2023`,
    bodyJa: `私は 27 歳で、すでに遺言書を書いています - これがその理由です
- 公開されました
おそらく、ほとんどの 27 歳のやるべきことリストに遺言書を書くことは入っていないでしょう。
しかし、エリン・アトキンソンさんは、自分が死んだときに自分のお金と持ち物をどうするかをすでに決めています。
「遺言書というと高齢者を連想するので、最初はかなり現実離れした感じがしました」と彼女は言う。
エリンはロンドンの大学で心理学の研究に携わっており、4年前にブリストルからロンドンに移住しました。
彼女は現在賃貸に住んでおり、正確な給料を明かしたくなかったものの、自分が特に裕福だとは思っていません。それでも、彼女は自分のもののいくつかをどこに置くべきかをすでに決めています。
彼女の7,000ポンドの車は妹のものになります。パートナーから贈られた金のネックレスは彼に返すことになります。そして彼女は、彼女にとって非常に重要な目的のために資金の一部を寄付するよう求めました。
「私にとって心に残っていることの一つは、子宮内膜症に対する慈善活動です」と彼女は言います。
「X額寄付してほしいと紙に書いてもらうことができて、本当に力づけられたと感じました。」
しかし、多くの若者にとって、特に残すべきものがほとんどないと感じている場合には、遺言書を作成する必要はないと思われるかもしれません。
2025 年の国民遺言報告書によると、18 ～ 24 歳の 5 人に 1 人しか遺言書を持っていないことがわかりました。これは22～34歳では33％に上昇するのに対し、55歳以上では56％となっている。
オンラインで遺言書を作成できるアプリ「Morby」の創設者であるソフィア・マスリン氏は、遺言書を作成する前に多くの財産を所有する必要があるという考えは、彼女が遭遇する最大の誤解の1つだと語る。
「人々は、自分には十分な財産がないと信じています。しかし、実際には、何らかの貯蓄、投資、年金、ソーシャルメディアのアカウントがある場合、ペットを飼っている場合、さらには葬儀の希望さえも、これらすべてを考慮する必要があります」と彼女は言います。
エリンさんにとって、遺言書を作成するという考えは、友人が家を購入したときに初めて思いつきました。
それから彼女は、マスリンがTikTokで遺言について話しているのを見るようになった。マスリンさんは、遺言書もなく若くして亡くなったいとことの話をし、家族にとって状況がいかに複雑になったかを語った。
彼女の物語を見て、エリンは自分用に何かを作ることをもっと真剣に考えるようになりましたが、同時に自分の祖母の遺言が家族に与えた影響を見て影響を受けました。
「祖母が亡くなり、彼女は遺言書を持っていました。私たちは大家族なので、とても複雑でした。非常に指示的な方法で書かれた遺言書を見て、家族から大きなプレッシャーを取り除くことができることがわかりました」と彼女は言います。
このプロセスにより、エリンさんはプレミアム債など、自分が思っているよりも多くの金融資産を持っていることにも気づきました。
たとえ若くても遺言書が重要である理由
Crombie Wilkinson Solicitors の Eleanor Hodgson 氏は、それほど多くの資産を持っていない場合でも、遺言書を作成する実際的な理由がある可能性があると述べています。
「これが役立つのはあなたの資産だけではありません。なぜなら、あなたの銀行口座やあなたが抱えているあらゆる借金を処理しなければならない人がまだいるからです。そして、難しい手続きを飛び越えることなく、法的にそれを処理できる人を指名することができるのです」と彼女は言う。
遺言書がないことの難しさは、その時が来るまで理解するのが難しいかもしれない、とホジソン氏は付け加えた。
マスリン氏は、若い人たちは、遺言書は将来必要になるものだと思い込み、遺言書の作成を先延ばしにしたくなる可能性があると言う。
「現実には、人生のあらゆる段階で予期せぬことが起こります」と彼女は言います。
価値はお金だけではありません
エリンにとって、遺言書の中には経済的よりも感情的に価値のあるものもあります。
彼女の遺書には、葬儀で読んでもらいたい詩から、出してほしい飲み物まで、家族に知ってもらいたい細かい詳細もいくつか書かれている。
それらの詳細について考えることは、彼女にとって病的なものとは感じませんでした。
「私にとって、遺書を書くということは最悪の事態を予想することではありませんでした。それは責任を負い、私が大切にしている人々の生活を楽にすることでした」と彼女は言う。
遺言はどうやって作るのですか？
遺言書を書くのは気が遠くなり、費用がかかるように思えるかもしれません。しかし、無料または低コストで作成してもらう方法があります。
たとえば、ウィル・エイドは毎年 11 月に外部の弁護士と協力しており、ボランティアで時間を割いて基本的な遺言書の作成手数料を免除しています。
弁護士に依頼したら、次のことを考慮する必要があります。
受益者を選択する: 家族、友人、慈善団体など、お金や財産を誰に残すかを決めます。 18 歳未満の子供がいる場合は、保護者を指名することもできます。
遺言執行者を選択する: 遺言執行者はあなたの願いを確実に実現する人です。信頼できる家族や弁護士かもしれませんが、手数料がかかるかどうかを確認してください。
ペットについて考えてみましょう。自分が死んだ後、誰にペットの世話をしてもらいたいかを言うことができます。
葬儀の希望を残す: 埋葬か火葬のどちらを希望するか、音楽、朗読、花などの希望を含めることができます。
遺言書は安全な場所に保管し、信頼できる人に遺言書がどこにあるかを知らせてください。遺言書が見つからない場合、遅れが生じたり、遺言書が守られなかったりする可能性があります。
関連トピック
- 2025 年 11 月 1 日発行
- 5 月 8 日公開
- 2023 年 7 月 24 日公開`,
    ...
    publishedAt: "2026-09-08T23:04:17+00:00",
    category: "金融政策",
