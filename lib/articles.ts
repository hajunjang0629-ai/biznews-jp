...
ここ数日、新規定期取引の金利を引き上げた多くの金融機関には、ハイストリート銀行の大手５行が含まれる。
...
金融情報サービスのマネーファクトによると、新規２年固定契約の平均金利は５．５９％。
ここ数日一貫して上昇しており、６月１９日以来の高水準となっているが、依然としてイラン戦争のピークだった４月の５．９％を下回っている。
５年固定契約の平均金利は５．６１％で、前回６月７日の水準となっている。
HSBCも月曜日に住宅ローン金利を引き上げると発表した。
...
あなたの住宅ローンは今後 6 か月以内に更新されますか?連絡してください。`,
    ...
    publishedAt: "2026-07-24T09:44:53+00:00",
    category: "エネルギー",
