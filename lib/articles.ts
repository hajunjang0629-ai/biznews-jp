...
- 10 時間前に公開`,
  ...
  },
  {
    ...
    summaryJa: "ニューヨーク市のフェデラル プラザ 26 番地を示す Google マップ。出典: Google Earth",
    bodyOriginal: `Google Map showing 26 Federal Plaza in New York City.
Source: Google Earth
An individual is in custody after setting off "an incendiary device" outside an immigration court building in lower Manhattan on Monday morning, the FBI told CNBC.
The FBI's New York Joint Terrorism Task Force is investigating the incident, which took place outside of 26 Federal Plaza, the agency said in a statement.
The New York Police Department's public information office told CNBC that "somebody set off fireworks" outside the building, which contains a U.S. Immigration and Customs Enforcement field office.
This is breaking news. Please refresh for updates.`,
    bodyJa: `ニューヨーク市のフェデラル プラザ 26 番地を示す Google マップ。
出典: Google Earth
FBIはCNBCに対し、月曜朝、ロウアー・マンハッタンの移民裁判所の建物の外で「焼夷装置」を作動させた人物が拘留されていると語った。
FBIのニューヨーク統合テロ対策特別委員会は、フェデラルプラザ26番地外で起きたこの事件を捜査していると同局は声明で述べた。
ニューヨーク市警察広報室はＣＮＢＣに対し、米国移民関税執行局の現地事務所が入っている建物の外で「何者かが花火を打ち上げた」と語った。
これは速報です。更新を確認するには更新してください。`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/07/20/new-york-nyc-fbi-incendiary-device.html",
    publishedAt: "2026-07-20T14:25:11+00:00",
    category: "テクノロジー",
    imageUrl: "https://images.unsplash.com/photo-1518770660439-4636190af475?w=800&q=80",
    readTime: 2,
  },
  {
    id: "spacex-gave-investors-intense-fomo-now-t-0d55cd62",
    title: "SpaceX gave investors intense FOMO. Now the decade’s hottest IPO represents a brutal reality check.",
    titleJa: "SpaceXは投資家に激しいFOMOを与えた。この 10 年間で最も注目を集めた IPO は、残酷な現実の検証を表しています。",
    summaryJa: "誇大宣伝された新規株式公開を追いかけることに隠れた危険性?細かい部分は省略します。",
    bodyOriginal: `The hidden danger of chasing hyped initial public offerings? Skipping the fine print.`,
    bodyJa: `誇大宣伝された新規株式公開を追いかけることに隠れた危険性?細かい部分は省略します。`,
    source: "MarketWatch",
    sourceUrl: "https://www.marketwatch.com/story/spacex-gave-investors-intense-fomo-now-the-decades-hottest-ipo-represents-a-brutal-reality-check-54f878cb?mod=mw_rss_topstories",
    publishedAt: "2026-07-20T14:21:00+00:00",
    category: "金融政策",
    imageUrl: "https://images.mktw.net/im-83720149",
    readTime: 2,
  },
  {
    id: "amd-launches-helios-its-first-rack-ai-sy-a99c3696",
    title: "AMD launches Helios, its first rack AI system to rival Nvidia, adding Microsoft as newest buyer",
    titleJa: "AMD、Nvidiaに匹敵する初のラックAIシステムHeliosを発売、Microsoftを最新の買い手として追加",
    summaryJa: "AMDは、同社初のAIラックシステムであるHeliosでNvidiaを狙っており、Meta、OpenAI、Oracleに加わり、Microsoftを新規顧客として獲得した。",
    bodyOriginal: `After a decade-long comeback, chip giant Advanced Micro Devices is preparing to ship its first rack-scale system for artificial intelligence, called Helios, to a growing list of customers that now includes Microsoft.
...
WATCH: First look at Vera Rubin, Nvidia's AI system that's 10 times more efficient than Grace Blackwell
— CNBC's Jordan Novet contributed to this report.`,
    bodyJa: `10年ぶりの復活を経て、半導体大手アドバンスト・マイクロ・デバイセズ社は、ヘリオスと呼ばれる同社初の人工知能用ラックスケールシステムを、現在マイクロソフトを含む増え続ける顧客リストに出荷する準備を進めている。
これは、Nvidia の絶大な人気を誇る Grace Blackwell および Vera Rubin システムの最初のライバルであり、世界で最も価値のあるチップメーカーに数年ぶりの本格的な競争をもたらすことを目指しています。
Microsoftは月曜日、自社のデータセンターでHeliosシステムを使用し、Meta、OpenAI、Oracleなどとともにできるだけ多くのコンピューティングを獲得する競争に参加すると発表した。
AMDは今年後半にMicrosoftを含む顧客への出荷を開始する予定だ。
金銭的条件やコンピューティング能力の量に関する詳細は明らかにされていない。
Microsoft CEOのSatya Nadella氏はプレスリリースで「当社はAMD HeliosでAzureインフラストラクチャのポートフォリオを拡張し、次世代AIアプリケーションの構築と実行に必要なパフォーマンス、規模、選択肢を顧客に提供している」と述べた。
新しい Helios システムは、Microsoft とその AI 顧客のフロンティア モデル推論を強化し、Azure AI サービスをサポートします。 Microsoftはまた、AMDの最新の「Venice」中央処理装置（CPU）上で動作する2つの新しいコンピューティングインスタンスを追加する予定で、1つはエージェントAIとデータパイプライン用、もう1つは半導体設計用だ。
これは、AMD チップが長年にわたって Microsoft の Surface PC や Xbox ゲーム コンソールに搭載されてきた長年にわたるパートナーシップの継続です。マイクロソフトは2023年に、エヌビディアのAIチップに匹敵するAMDのMI300Xグラフィックスプロセッシングユニット（GPU）を初めて採用した。 Microsoft はまた、自社のデータセンターに独自の Maia チップを導入しています。
競合他社と同様、Microsoft も、特に独自のモデル開発を強化し、より多くのコンピューティング能力を研究開発に割り当てているため、できるだけ多くのコンピューティングを必要としています。 6月には自社製7モデルを発表した。 365 Copilot AI アシスタントから GitHub Copilot コーディング エージェントに至るまで、これまでの Microsoft の AI への取り組みはさまざまな結果をもたらしてきました。今年これまでのところ「マグニフィセント・セブン」銘柄の中で最もパフォーマンスが悪い銘柄となっている。
Microsoft は、AI の高速化のために AMD に注目する大企業が増えてきていますが、その一部です。 AMDによると、AI企業上位10社のうち8社が同社のInstinct GPUでワークロードを実行しており、これにはOpenAI、Cohere、SpaceXの一部であるイーロン・マスク氏のSpaceXAIが含まれるという。
Meta は 2 月に、今年後半に Helios ラックに導入される 1 ギガワットから始めて、長期的に最大 6 ギガワットの AMD GPU を使用すると発表しました。 OpenAIとOracleも今年Heliosの導入に大きくコミットし、インド最大のIT企業タタ・コンサルタンシー・サービシズもHeliosの使用を約束した。
CNBC は、Helios システムの開発とテストが行​​われているテキサスのデータセンターのラボから、Helios システムの内部を世界で初めて詳細に観察しました。
「トークンあたりの最低コスト」
Helios は、4 頭の馬の助けを借りて空に太陽を引き寄せる古代ギリシャの神にちなんで名付けられました。Helios は、AMD が社内で行っている 4 つの機能 (GPU、CPU、ネットワーキング、ソフトウェア) をまとめたものです。
データセンター責任者のフォレスト・ノロッド氏はCNBCに対し、AMDの第1世代システムについて「私たちは最高の総所有コスト、最低のトークンあたりのコストをすべて提供することに非常に重点を置いている」と語った。 「そして私たちの顧客は、私たちがそれを達成していると言ってくれています。」
5月、AMDの最高経営責任者（CEO）リサ・スー氏はCNBCのジム・クレイマーに対し、「推論に関しても、メモリ帯域幅やメモリ機能に関しても」HeliosにはNvidiaのラックスケールシステムに比べて「重大な利点」があると語った。
AMDはコストについてコメントを控えているが、Futurum GroupはHeliosのコストが500万〜550万ドルになると見積もっている。これは、Futurum が Nvidia の第 2 世代ラックスケール システムである Vera Rubin に対して 350 万ドルから 400 万ドルと見積もっているのと比較されます。
最大 7,000 ポンドの Helios は、Nvidia の Vera Rubin よりも幅が広く、重いです。
Futurum Group によると、Nvidia はデータセンター GPU 市場の 95% 以上を支配しています。 AMDは市場の約4.5％しか保有していないが、Heliosがそれを変える可能性がある。
Futurum Groupのアナリスト兼最高経営責任者（CEO）のダニエル・ニューマン氏は、「AMDの業績が好調で20％や25％に達する可能性がある深刻なケースがあると思う。ちなみに、これは数千億ドルの収益となる」と述べた。
2026 年の第 1 四半期には、データセンターが AMD の収益の大部分を占め、前年比 57% 増加しました。 AMDはCNBCに対し、2027年から数百億ドルのデータセンターAI収益を計上する計画であり、その大部分はHeliosからのものであると語った。
データセンター CPU の市場シェアでは、Intel が依然として断然のリーダーですが、AMD が着実に地位を高めています。この CPU のリーダーシップにより、AMD は、2021 年に最初のサーバー CPU を発売し、今年再びチップに重点を置く戦略に転換した Nvidia とは一線を画しています。
「まったく異なるAMD」
ノロッド氏はCNBCにシステムのコアチップを見せながら、ヘリオスを「私たちの赤ちゃん」と呼んだ。 18 個のコンピューティング トレイのそれぞれには、単一の EPYC 中央処理装置を搭載した 4 つの Instinct GPU が搭載されています。
これらの EPYC データセンター CPU は、AMD がデータセンター市場で 10 年間失ったリーダーシップを取り戻すのに役立ちました。
2003 年、AMD は画期的なデータセンター CPU を開発し、急速に市場の 4 分の 1 近くを獲得することに貢献しましたが、一連の遅延と失敗によりその一部は衰退し、スー氏が指揮を執るまでに大規模な人員削減と収益の縮小につながりました。
「過去 12 年間、Lisa のリーダーシップの下で、AMD は大きく変わってきました」と Norrod 氏は述べています。
2017 年に同社が最初の EPYC サーバー CPU をステージ上で発表した後、事態は好転しました。
「私たちがやったことの一つは、3世代にわたって詳細なロードマップを策定したことだが、これは非常に異例なことだ」と同氏は語った。 「そして私たちは、言ったことを正確に実行しました。」
AMD のロードマップの一部には、現在の MI400 シリーズ GPU を搭載した Helios を発売する計画が含まれていました。
各Heliosトレイには、AMDが2022年にPensandoを買収したときに取得したテクノロジーで作られた最大12個のネットワーキングチップも搭載されています。
これは、過去数年間に Helios の開発を可能にするのに役立ったいくつかの買収のうちの 1 つです。
AMDのこれまでの最大の買収は、2022年にプログラマブルチップ企業ザイリンクスを500億ドル近くで買収した。また、AMDは2025年にサーバーメーカーのZTシステムズを50億ドル近くで買収し、NVIDIAが広く採用しているCUDAソフトウェアエコシステムに代わるオープンソースのROCmの開発に協力した一連のソフトウェア企業も買収した。
Counterpoint Researchのアナリスト、ニール・シャー氏は、AMDのHeliosチップはNvidiaのGPUやCPUと「同等」だが、「秘密のソースはソフトウェアと最適化にある」と述べた。
「CUDA のおかげで、Nvidia はより大きなエコシステムを持ち、AMD よりもかなり進んでいると思います」と彼は言いました。
Helios により、AMD は初期の展開がどれだけうまくいくかに応じて、大幅な進歩を遂げる機会を得ることができます。
「問題はこうなるだろう。AMDが勝つのは、技術的に優れているからだろうか？それともAMDが勝つのは、生産能力に非常に制約があり、開発できれば誰かがそれを買ってしまうからだろうか？」ニューマン氏は語った。
注目: グレース ブラックウェルより 10 倍効率的な Nvidia の AI システム、Vera Rubin を初紹介
— CNBC の Jordan Novet がこのレポートに寄稿しました。`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/07/20/amd-helios-microsoft-ai-nvidia.html",
    publishedAt: "2026-07-20T14:07:29+00:00",
    category: "テクノロジー",
    imageUrl: "https://images.unsplash.com/photo-1518770660439-4636190af475?w=800&q=80",
    readTime: 10,
  },
  {
    id: "global-oil-prices-reverse-to-below-87-a-2e71b3ff",
    title: "Global oil prices reverse to below $87 a barrel after report of new Iran cease-fire proposal",
    titleJa: "イランの新たな停戦提案の報道を受け、世界の原油価格は1バレル当たり87ドル以下に反転",
    summaryJa: "週末に中東で新たな集中攻撃があったにもかかわらず、米国とイランの間の10日間の停戦案に関する報道がエネルギー価格の急落を引き起こした後、原油価格は月曜朝、それまでの急騰を反転させ、赤字に転落した。",
    bodyOriginal: `Oil prices took a dive into the red on Monday morning, reversing an earlier sharp rally, after a report of a 10-day cease-fire proposal between the U.S. and Iran sparked a sharp decline in energy prices despite a fresh barrage of strikes in the Middle East over the weekend.`,
    bodyJa: `週末に中東で新たな集中攻撃があったにもかかわらず、米国とイランの間の10日間の停戦案に関する報道がエネルギー価格の急落を引き起こした後、原油価格は月曜朝、それまでの急騰を反転させ、赤字に転落した。`,
    source: "MarketWatch",
    ...
    publishedAt: "2026-07-20T14:04:00+00:00",
    category: "エネルギー",
    imageUrl: "https://images.mktw.net/im-64703426",
    readTime: 2,
  },
  {
    id: "alphabet-stock-pops-on-report-it-s-devel-428d813a",
    title: "Alphabet stock pops on report it's developing a more efficient AI chip",
    titleJa: "より効率的なAIチップを開発中との報道でアルファベット株が急上昇",
    summaryJa: "The Informationが同社がGeminiモデルをより効率的に実行するために社内で「Frozen v2」と呼ばれる新しいサーバーチップを開発していると報じた後、月曜日のAlphabet株は3%上昇した。同報道によれば、このチップはジェミニのアーキテクチャの一部をシリコンに直接永久的に埋め込み、クエリに答えるために必要な計算数とデータ移動量を削減するという。",
    bodyOriginal: `Alphabet shares climbed 3% on Monday after The Information reported the company is developing a new server chip, internally dubbed "Frozen v2," designed to run Gemini models more efficiently.
...
Read the full story from The Information here.`,
    bodyJa: `The Informationが同社がGeminiモデルをより効率的に実行するために社内で「Frozen v2」と呼ばれる新しいサーバーチップを開発していると報じた後、月曜日のAlphabet株は3%上昇した。
同報道によれば、このチップはジェミニのアーキテクチャの一部をシリコンに直接永久的に埋め込み、クエリに答えるために必要な計算数とデータ移動量を削減するという。
Googleのエンジニアらは、同社のTPU（テンソル処理装置）と呼ばれる最新のAIチップに比べ、電力単位あたり6倍から10倍のトークンを供給できると予測している、とThe Informationが伝えた。 Frozenは、汎用TPUを置き換えるのではなく、Googleのカスタムチップポートフォリオのより特化した部門となるだろう。
報告書によると、同社は2028年の導入を目標としている。このプロジェクトは、緊張を煽り、Google Cloud が社外のビジネスを断らざるを得なかったと言われている社内の大幅なコンピューティング不足を緩和することを目的としています。
つい先月、Googleはこのギャップを埋め、エンタープライズコンピューティングのコミットメントを達成するために、SpaceXに月額10億ドル近くを支払うことに同意した。
トレードオフは柔軟性です。 The Information によると、このチップは、Google が同じ基盤アーキテクチャに固執する場合にのみ、将来の Gemini モデルで動作する予定です。伝えられるところによると、Google は現在、Frozen v2 を部分的には試験運用とみなしており、TPU と同じ規模で生産する予定はないとのことです。
アルファベットはコメント要請に応じていない。
The Information の全文はこちらからお読みください。`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/07/20/alphabet-googl-stock-ai-chip-report.html",
    publishedAt: "2026-07-20T14:00:10+00:00",
    category: "テクノロジー",
    imageUrl: "https://images.unsplash.com/photo-1518770660439-4636190af475?w=800&q=80",
    readTime: 2,
  },
  {
    id: "aliexpress-fined-record-550m-by-eu-for-a-39b1e624",
    title: "AliExpress fined record €550m by EU for allowing sale of illegal goods",
    titleJa: "AliExpressに違法商品販売許可でEUから5億5000万ユーロの罰金記録",
    summaryJa: "AliExpressに違法商品販売許可でEUから5億5000万ユーロの罰金記録- 公開されました",
    bodyOriginal: `AliExpress fined record €550m by EU for allowing sale of illegal goods
- Published
...
AliExpress said: "We disagree with today's decision and the disproportionate fine, which does not adequately reflect our established framework and the significant, proactive enhancements we have made.
"We are carefully reviewing the decision and considering all available options."
The company now has to pay the penalty and present a plan to the EU by 20 October that includes what action it will take to tackle the breaches.
...
And Elon Musk's X was fined €120m last year, after the commission said allowing users to pay for its blue tick badges was deceptive because the social media platform was not "meaningfully verifying" who was behind the account and exposed users to scams.`,
    bodyJa: `AliExpressに違法商品販売許可でEUから5億5000万ユーロの罰金記録
- 公開されました
中国のオンライン小売大手アリエクスプレスは、安全でないおもちゃや偽物の衣類などの違法商品の販売を許可したとして、EUから過去最高となる5億5,000万ユーロ（4億6,700万ポンド）の罰金を科された。
欧州委員会は、アリエクスプレスがプラットフォーム上の違法、危険、または偽造品のリスクを「熱心に評価する」法的義務を怠っていると述べた。
EUの技術責任者ヘナ・ヴィルクネン氏は、「偽造衣料品、安全でないおもちゃ、危険な化粧品、その他の違法で有害な製品の蔓延は、オンラインショッピングで避けられないコストではない。これはアリエクスプレスによる義務の不履行だ」と述べた。
AliExpressは、罰金は不釣り合いであり、システムを変更したと述べた。
2年間にわたる調査では、アリエクスプレスの検出システムが「適切に機能していなかった」ことが判明し、多くの違法商品は報告されなかったが、特定された他の商品は数週間サイト上に留まったことが判明した。
欧州委員会はまた、同社が違法商品を販売する業者に対する罰則を適切に執行していないと認定した。
さらに、製品の適合性チェックは「簡単に回避」される可能性がある。
中国のテクノロジー複合企業アリババが所有する AliExpress は、ヨーロッパに 1 億 9,300 万人のユーザーを抱えており、これは中国のオンライン小売業者である Shein や Temu よりも多いです。
この罰金はデジタルサービス法に基づいて課せられる最高額の罰金であり、テクノロジー大手に対し違法で有害なコンテンツに対抗するためのさらなる努力を義務付けるものである。
同法では企業収益の最大6％の罰金が認められているが、アリババの昨年の世界売上高は1220億ユーロだったため、罰金はそれには遠く及ばない。
AliExpressは「我々は本日の決定と不釣り合いな罰金に同意しない。これは我々が確立した枠組みと我々が行った重要かつ積極的な機能強化を適切に反映していない。」と述べた。
「私たちはこの決定を慎重に検討し、利用可能なすべての選択肢を検討しています。」
同社は今後、罰金を支払い、違反に対処するためにどのような措置を講じるかを含む計画を10月20日までにEUに提示する必要がある。
今年初め、テム氏は危険な乳児用おもちゃなどの違法商品の販売を許可したとして２億ユーロの罰金を言い渡された。
そして、イーロン・マスク氏のX社は昨年、ソーシャルメディアプラットフォームがアカウントの背後に誰がいるのかを「意味のある検証」しておらず、ユーザーを詐欺にさらしているため、ユーザーに青色のチェックバッジの支払いを許可するのは欺瞞的であると委員会が主張し、1億2000万ユーロの罰金を科せられた。`,
    source: "BBC",
    sourceUrl: "https://www.bbc.co.uk/news/articles/cp8714286dpo?at_medium=RSS&at_campaign=rss",
    publishedAt: "2026-07-20T13:44:55+00:00",
    category: "テクノロジー",
    imageUrl: "https://ichef.bbci.co.uk/ace/standard/240/cpsprodpb/00ee/live/51afee90-843a-11f1-9dde-1165f12cfa4b.jpg",
    readTime: 3,
  },
  {
    id: "voters-wary-of-government-ownership-in-c-ae32781f",
    title: "Voters wary of government ownership in companies as Trump administration takes equity stakes",
    titleJa: "トランプ政権が株式を取得する中、有権者は政府による企業所有に警戒",
    summaryJa: "CNBCの新しい全米経済調査によると、アメリカ人の約半数が、アメリカ政府がアメリカに本拠を置く企業の所有権を握るのは適切ではないと考えていることがわかった。超党派のシンクタンクである外交問題評議会によると、この発見は、トランプ政権が総額270億ドル近く相当の30件の取引を交渉している中で得られたものである。さらに増えるかもしれません。 CNBCの報道によると、政権は影響力のある人工知能の新興企業OpenAIと、上場時の政府出資の可能性について協議したという。",
    bodyOriginal: `About half of Americans believe it isn't appropriate for the U.S. government to take ownership in U.S.-based companies, CNBC's new All-America Economic Survey found.
...
Even among President Donald Trump's most ardent supporters, skepticism is high, the poll found. Self-identified MAGA Republicans split evenly between 31% who said such ownership is appropriate and 31% who said it's not appropriate. Another 38% said they had no opinion on the matter.
...
— CNBC's Emily Wilkins contributed to this report.`,
    bodyJa: `CNBCの新しい全米経済調査によると、アメリカ人の約半数が、アメリカ政府がアメリカに本拠を置く企業の所有権を握るのは適切ではないと考えていることがわかった。
超党派のシンクタンクである外交問題評議会によると、この発見は、トランプ政権が総額270億ドル近く相当の30件の取引を交渉している中で得られたものである。さらに増えるかもしれません。 CNBCの報道によると、政権は影響力のある人工知能の新興企業OpenAIと、上場時の政府出資の可能性について協議したという。
オール・アメリカの世論調査結果によると、連邦政府が米国に本拠を置く企業の一部を所有することが適切だと答えたのは有権者のわずか19％で、49％は適切ではないと答えた。しかし、有権者のほぼ3分の1に当たる32％が未定で、政権が計画を進める上で説得の余地があることを示唆している。
CNBCの全米世論調査は7月8日から12日にかけて、全国の登録有権者1,000人を対象に実施された。プラスまたはマイナス 3.1 パーセント ポイントの誤差が許容されます。この世論調査は、Hart Research Associates および Public Opinion Strategies と協力して実施されました。結果は金曜日に発表された。
米国の株式保有の一部は日和見的であったが、その他はより広範な経済戦略の一部であった。最大のものは、米国政府が半導体メーカーインテルの株式の10％を取得した8月に発生した。米政府はバイデン政権下で可決された法案に基づき、インテルに89億ドルの補助金を提供することで合意していた。トランプ政権は、納税者が潜在的な上振れを共有できるとして、引き換えに株式を求めると決定した。
当初89億ドルだった米国のインテル株はその後372％増加し、木曜日の取引終了時点で420億ドル相当となった。
ハワード・ラトニック商務長官は先週の政策昼食会で上院共和党議員とインテル株について話し合った。
ジョン・ホーベン上院議員（共和党、ノースダコタ州）は会談後、「その点については注意しなければならない」と語った。 「彼がそこに納税者やその他のことに対する価値を見出していることは理解しています。私はこの分野では慎重になりたいと思っています。」
ジョン・ハステッド上院議員（共和党、オハイオ州）も、米国政府が株式を取得する傾向を懸念していると述べた。 「国家安全保障の観点や納税者の観点から見て、それが理にかなっている場合があることは理解しています」とハステッド氏は語った。しかし、それは「永続的であるべきではない」とも付け加えた。
ハステッド氏は、米国政府が国家安全保障上の理由で企業に投資することを最長8年間に限り認める法案を支持している。
他の政府の利害は、米国が国防に必要な資源と技術に確実にアクセスできるようにするため、連邦政府による協調的な取り組みを通じて行われてきた。国防総省は、米国内でレアアースを採掘するMPマテリアルズという会社を支援している。中国は近年、レアアース採掘に対する管理を強化し、先進的な戦闘機や無人機、その他の技術の製造に必要な重要部品を中国に握らせている。
米国の民間企業への関与を批判する人々は、政府の好意により一時的に企業は株主にとって魅力的になるかもしれないが、長期的には政府が大きく管理する企業は競争力が低下すると主張している。米国の鉄鋼産業は、その重要な例としてよく引用されます。長年にわたり、関税やその他の政府措置によって厳重に保護されてきました。 2025年、USスチールは日本企業によって非公開化された。米国政府には、特定のビジネス上の決定に拒否権を行使できる、いわゆる黄金の株が与えられました。
国家安全保障に関わる企業を支援するために財政力を利用する米国のキャンペーンは、大統領とつながりのある個人投資家らの注目を集めている。プロパブリカは５月、ホワイトハウスが国防総省に対し、大統領の長男ドナルド・トランプ・ジュニアに関連する企業から投資を受けていた防衛新興企業バルカン・エレメンツを支援するよう要請したと報じた。国防総省は非公開のバルカン社に6億2000万ドルの融資を発行した。
ホワイトハウス当局者は、バルカンへの政権関与に関するプロパブリカの報道を「ステロイドを使ったフェイクニュース」と表現した。ドナルド・トランプ・ジュニア氏の広報担当者は、同氏はこの取引に個人的に関与しておらず、連邦政府当局者らと自身の投資について話し合っていないと述べた。
民主党は共和党よりも米国政府の利害を懸念する可能性が高い。 ＣＮＢＣの世論調査によると、民主党支持者の６６％が米国が米国企業の株式を取得することは適切でないと考えているのに対し、共和党支持者の同意は３４％にとどまった。
ドナルド・トランプ大統領の最も熱烈な支持者の間でも懐疑的な見方が高いことが世論調査で判明した。 MAGA共和党支持者を自認する人は、そのような所有権が適切であるとの回答が31％、不適切であるとの回答が31％に真っ二つに分かれた。さらに 38% はこの件については意見がないと答えた。
新しい世論調査結果は、有権者の56％が米国政府が民間企業の一部を所有するのは適切ではないと回答した2025年10月の全米経済調査からの変化を示した。当時、有権者の13％はそのような所有権が適切であると答え、31％は意見がないと答えた。
— CNBC のエミリー・ウィルキンスがこのレポートに貢献しました。`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/07/20/trump-government-company-ownership-americans-wary-cnbc-poll.html",
    publishedAt: "2026-07-20T13:14:52+00:00",
    category: "テクノロジー",
    imageUrl: "https://images.unsplash.com/photo-1518770660439-4636190af475?w=800&q=80",
    readTime: 6,
  },
  {
    id: "burnham-promises-help-with-your-money-ho-ef237a92",
    title: "Burnham promises help with your money. How could it affect you?",
    titleJa: "バーナムはあなたのお金を援助することを約束します。それはあなたにどのような影響を与える可能性がありますか?",
    summaryJa: "バーナムはあなたのお金を援助することを約束します。それはあなたにどのような影響を与える可能性がありますか?- 公開されました",
    bodyOriginal: `Burnham promises help with your money. How could it affect you?
- Published
In his first speech as prime minister, Andy Burnham has promised to give people more "breathing space" to help with the cost of living.
Policies will be announced on Tuesday - his first full day in the job.
...
And his chancellor will often be the one who has to deliver any changes, and outline how to pay for them.
...
However, these words weren't spoken by the incoming PM and chancellor, but by Sir Keir Starmer and Rachel Reeves - and only in January this year.
...
Burnham has previously hinted at allowing people to earn more before they start paying income tax, shifting the so-called personal allowance.
...
He has also said he is willing to tackle access to social care - again, a complex and potentially expensive policy which others have tried, and failed, to tackle.
...
Are you affected by the above issues? Do you have a unique story to share?`,
    bodyJa: `バーナムはあなたのお金を援助することを約束します。それはあなたにどのような影響を与える可能性がありますか?
- 公開されました
アンディ・バーナムは首相としての最初の演説で、生活費を助けるために人々にもっと「息抜きのスペース」を与えると約束した。
方針は火曜日、つまり同氏が丸一日勤務して初めて発表される予定だ。
バーナムにとって生活費は重要な問題である。同氏は以前、経済的圧迫のため多くの人が金曜日にビールを飲みに出かけることも、子供たちを連れて出かけることもできず、休暇にも行けないと述べていた。
近年、生活費が人々の生活を支配しており、ある程度、私たちの政治も支配しています。そのプレッシャーを和らげるのは簡単ではありませんでした。
したがって、もしバーナムが光熱費や交通費などの問題で人々を支援し、税金が課される前に人々がもっと稼げるようにし、介護や住む場所をより手頃な価格にすることを選択した場合、彼はそれらの動きに資金を提供し、それに伴うトレードオフを管理するという難しい選択に直面することになるだろう。
そして多くの場合、首相が何らかの変更を発表し、その費用の支払い方法を説明しなければならない。
これを聞いたことがありませんか?
首相は、生活費について話さないのは「無駄な1分」だと言っている。首相はそれが「第一の焦点」だと言っている。
しかし、これらの言葉は次期首相や首相によってではなく、キーア・スターマー卿とレイチェル・リーブスによって語られたものであり、それも今年1月にのみ行われた。
彼らは一部の賦課金を削減し、その他を課税に移すことで、4月に一般的な国内の年間エネルギー料金から150ポンドを削減した。
しかし、米国とイスラエルによるイラン攻撃の影響で、これらの請求書はすぐに再び上昇し、食料や住宅ローンのコストも上昇した。イベントは、綿密に練られた計画に即座に大きな影響を与える可能性があります。
「より不安定な世界はより高価な世界だ」と金融情報サービスMoneyfactsのアダム・フレンチ氏は言う。
税金は下がりますか（それとも上がりますか）？
バーナム氏は以前、人々が所得税の支払いを開始する前に、より多くの収入を得られるようにして、いわゆる個人手当をシフトすることを示唆していた。
現在の政府の政策により、イングランド、ウェールズ、北アイルランドでは所得税と国民保険の基準額が2031年4月まで凍結される。つまり、収入が増えれば増えるほど、収入のより多くの割合が課税されることになります。
これは政府にとって大幅な歳入増加となるが、政策を部分的に撤回すると、この資金を他から調達するか借りなければならないことになる。バーナム氏はまた、一部の人々に税金を「もう少し求める」ことをほのめかした。
同氏は所得税、国民保険、付加価値税の主要３税を引き上げないという労働党のマニフェストを堅持する。しかし、家族経営の農場に影響を与える相続税の変更など、他の税も変更される可能性があることを選挙以来すでに目にしており、しばしば激しい反応を引き起こしている。
可能性としては次のようなものがあります。
印紙税と市税を代替固定資産税に置き換える
キャピタルゲイン税は、本拠地外の不動産や一部の株式などの資産を売却した際の利益に対して支払うもので、所得税率と一致させるための税率の引き上げ
このような改革には時間がかかり、勝者と敗者が生まれるだろう。リーブス氏とスターマー氏が大きな変化を起こそうとしたとき、たとえ大多数を占めていたとしても、多くの場合は自身の党から強制されて、何度も方向転換が続いた。
バーナム氏と首相はまた、政府の税と支出の決定に関する一連の選択肢である、政府が自主的に課した財政規則を堅持するとみられている。
これらが生活水準の向上を可能にする経済にとって賢明な構成要素なのか、それとも「機能不全に陥った」経済的制約なのかについては意見が分かれている。
投資プラットフォームAJベルの公共政策責任者レイチェル・ベイヘイ氏は、「小銭を求めてソファの後ろをあさる（その結果）ことが個人の財政に大きな打撃を与え、税金の状況を変え、人々が将来に備えて貯蓄することをより困難にしている」と語る。
エネルギーやその他の必需品は安くなるでしょうか?
2030年までに家庭の光熱費を300ポンド削減するという総選挙で大いに議論された労働党の公約は依然として厳しい監視下にあることを忘れないでください。
バーナム氏はダウニング街で、生活必需品をより手頃な価格にするために「公的管理下に置く」と述べた。
エネルギー料金の削減については、これまでにも示唆があったが、料金は依然として主にガスの卸売コストによって設定されており、これは政府の制御が及ばない部分が大きい。
慈善団体や規制当局が支持する選択肢の一つは、社会的料金の導入だ。これにより、最も弱い立場の人々に割引料金が提供され、より裕福な人々からのより高い請求書や税金を通じて支払われることになります。
将来の請求も心配ですが、過去の請求の未払いも大きな懸念です。顧客がエネルギー供給業者に負っている金額は、1年間で15％増加し、過去最高の47億9000万ポンドに達している。
債務慈善団体シチズンズ・アドバイスは、「平均請求額はピーク時からは下がったが、それでも5年前に比べればはるかに高い」と述べている。
「しかし、収入と料金補助の仕組みは追いついていません。世帯は増大するエネルギー負債を抱えたままになっており、暖房か食事かの選択を迫られています。」
食料や水や食料などのその他の費用が負担をさらに増している、と同報告書は述べている。
マンチェスターのように交通費が優先されますか?
バーナムの政治資本の多くは、グレーター・マンチェスター市長としての変化、特にバス網の変化によるものである。
バス料金に関する発表は今週行われる予定だが、権限移譲により、同氏が実際にコントロールできるのはイングランドで何が起こるかだけだということになる。
ロンドン以外のイングランドのバス料金の上限３ポンドは来年３月まで適用される。ただし、この制度は任意であり、すべてのバス会社が加入しているわけではありません。
英国の鉄道運賃も政府によって同日まで３０年ぶりに凍結された。
これは、2027 年 3 月までのほとんどの通勤ルートをカバーするシーズン券、長距離旅行の一部のオフピーク往復航空券、および主要都市およびその周辺の旅行用のフレキシブル航空券に適用されます。
初めての購入者や住居費の補助はありますか？
バーナム氏はタイムズ紙に対し、「余裕のある人々に十分な住宅がなければ、民間賃貸部門の福利厚生制度を通じて家賃を追い求めることになる」と語った。
そのため、最初の演説で発表された市営住宅をさらに建設するという同氏の計画は、政府の既存の​​野心的な住宅建設目標と並行するものだが、すでに予定より遅れている。
もちろん、家を建てるだけで安くなるわけではありません。
一部の金融機関は、初めての購入者に少額の頭金で住宅ローンを組む機会を提供していますが、パパとママの銀行は依然として最大の金融機関の 1 つです。
特に建設業協会は、誰にどれだけ融資できるかについて、それほど厳格ではない規則を求めることが予想されている。
結局のところ、住宅ローンのコストは市場がバーナム氏と新首相の計画をどう考えるかによって決まるかもしれない。
新しい首相は他に何に直面しているのでしょうか?
バーナム市は、若者の就労促進だけでなく、誰が傷病手当金を受け取るのか、またその額はいくらなのかという大規模な決定を迫られている。詳細については、こちらをご覧ください。
同氏はまた、社会的養護へのアクセスに取り組む意欲があるとも述べた。これもまた、他の人が挑戦して失敗してきた複雑で、潜在的に高額な費用がかかる政策である。
同氏は現行の労働党マニフェストを堅持することで、インフレ率、平均賃金、または毎年2.5％の最高値に合わせて年金が増加するという公的年金のトリプルロックにもこだわるつもりだ。
最後に、これまでのすべての政権と同様、バーナム率いる政府が制御不能な出来事にどのように反応するかが、人々の懐の中にあるお金に最大の影響を与える可能性がある。
連絡する
上記の問題の影響を受けていますか?共有したいユニークなストーリーはありますか?`,
    source: "BBC",
    sourceUrl: "https://www.bbc.co.uk/news/articles/cp9ezldrkkgo?at_medium=RSS&at_campaign=rss",
    publishedAt: "2026-07-20T13:03:23+00:00",
    category: "エネルギー",
    imageUrl: "https://ichef.bbci.co.uk/ace/standard/240/cpsprodpb/ea7b/live/acd4de30-8439-11f1-b976-0b9c15b0ccfc.jpg",
    readTime: 9,
  },
];
