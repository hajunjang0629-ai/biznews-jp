...
export const articles: Article[] = [
  {
    id: "u-s-budget-deficit-surged-in-july-to-hig-1ea59f18",
    title: "U.S. budget deficit surged in July to highest level since March 2021",
    titleJa: "7月の米財政赤字は2021年3月以来の高水準に急増",
    summaryJa: "財務省は水曜、メディケア費用の高騰と連邦債務の金利が国の財政状況を圧迫し続ける中、米国の財政赤字が月次で過去５年以上で最高水準に急増したと報告した。単月の大幅な増加に加え、政府会計年度の最初の 10 か月間の赤字総額は 1 兆 8,000 億ドル近くに増加し、2025 年の同時期を上回りました。",
    bodyOriginal: `The U.S. budget deficit soared to its highest monthly level in more than five years amid a surge in Medicare costs and as interest on the federal debt continued to weigh on the nation's fiscal picture, the Treasury Department reported Wednesday.
...
Until recently, markets had been looking for the Fed to raise rates to control inflation that has been running above the central bank's 2% target for more than five years. However, recent benign inflation data and a soft payroll reports have tempered those expectations, though futures traders aren't pricing in any chance of a rate cut for the next five years.`,
    bodyJa: `財務省は水曜、メディケア費用の高騰と連邦債務の金利が国の財政状況を圧迫し続ける中、米国の財政赤字が月次で過去５年以上で最高水準に急増したと報告した。
単月の大幅な増加に加え、政府会計年度の最初の 10 か月間の赤字総額は 1 兆 8,000 億ドル近くに増加し、2025 年の同時期を上回りました。
７月の不足額は総額４３２３億ドルで、前年同期比約４８％増加し、月間赤字としては２０２１年３月以来の大きさとなった。
同月のメディケア費用は総額1,740億ドルと、6月の1,030億ドルから増加し、通年では9,550億ドルとなった。これは７月の単独支出としては最大で、社会保障費の１４１０億ドルや国債の純利息の１０４０億ドルを大きく上回った。
政府が最高裁判所が違法と判断した賦課金に対するリベートを提供し続けているため、関税還付も予算に打撃を与え、330億ドルの費用がかかった。さらに、月初が休業日だったために予算は990億ドルの打撃を受け、追加保障収入やメディケアの支払いだけでなく、さまざまな給付金の支出も加速した。
通期の国債による資金調達は、政府支出に占める割合としては社会保障とメディケアのみを下回っている。これまでの会計年度において、米国は39.9兆ドルの国債に対して1.17兆ドルを返済しており、そのうち32.1兆ドルは国民が保有している。前年同期の債務返済費は総額１兆０１００億ドルだった。純利子、つまり財務省の総利子から受け取った利子を引いた総額は９３１０億ドルとなった。
ドナルド・トランプ大統領は何年にもわたって、債務コストを削減する方法として連邦準備制度理事会に基準金利を引き下げるよう圧力をかけてきた。同氏は、5月に自身の候補者であるケビン・ウォーシュ氏が議長に就任して以来、中銀批判を控えている。
市場は最近まで、５年以上にわたり中銀の目標である２％を上回って推移しているインフレを抑制するため、ＦＲＢが利上げを行うことを期待していた。しかし、先物トレーダーらは今後５年間の利下げの可能性を織り込んでいないものの、最近の良好なインフレ統計や軟調な雇用統計がこうした期待を和らげている。`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/08/12/us-budget-deficit-surged-in-july-to-highest-level-since-march-2021.html",
    publishedAt: "2026-08-12T18:56:15+00:00",
    category: "金融政策",
    imageUrl: "https://images.unsplash.com/photo-1611974789855-9c2a0a7236a3?w=800&q=80",
    readTime: 2,
  },
  {
    id: "spacex-short-sellers-are-running-out-of-7c62839c",
    title: "SpaceX short sellers are running out of bullets as stock rebounds more than 40% off low",
    titleJa: "株価が安値から40％以上反発する中、スペースXの空売り業者は弾切れを起こしている",
    summaryJa: "新規公開株がIPO後の低迷から立ち直るのと同じように、スペースXに賭けていた空売り家は急速に取引から撤退している。S3パートナーズによると、スペースXへの空売り金利は水曜日、同社の上場株式の約11％に低下し、先週のピークの34％から大幅に低下した。この下落は、弱気の投資家がポジションを手仕舞いしたことと、最初の大型ロックアップ期限切れ後の株式の取引可能株数の大幅な拡大を反映している。",
    bodyOriginal: `Short sellers betting against SpaceX are rapidly retreating from the trade, just as the newly public stock rebounds from its post-IPO slump.
...
The additional shares could create fresh volatility by giving employees and early investors more opportunities to sell. At the same time, the larger float would make it easier for investors to establish new short positions if bearish sentiment returns.`,
    bodyJa: `新規公開株がIPO後の低迷から立ち直るのと同じように、スペースXに賭けていた空売り家は急速に取引から撤退している。
S3パートナーズによると、スペースXへの空売り金利は水曜日、同社の上場株式の約11％に低下し、先週のピークの34％から大幅に低下した。この下落は、弱気の投資家がポジションを手仕舞いしたことと、最初の大型ロックアップ期限切れ後の株式の取引可能株数の大幅な拡大を反映している。
S3パートナーズの予測分析担当マネジングディレクター、イホル・ドゥサニウスキー氏は「ショートを希望していたショートは弾切れだ」と語った。 「取引に投入できる金額は限られている。」
この流出は、スペースX株が決算後の急落から急反発を示し、ショートカバーが上昇に拍車をかける可能性がある中で起こった。弱気ポジションを解消した投資家は自社株を買い戻さなければならず、株価がすでに上昇しているときに買い戻しを行うと上昇の動きがさらに増幅される可能性がある。
水曜日の株価は11％上昇して約148ドルとなり、初公開価格の135ドルを約10％上回り、8月3日の安値を約41％上回った。
スペースXは上場以来、ジェットコースターのような状況に耐えてきた。ロケット・人工衛星会社が先週の最初の決算報告で、設備投資が売上高の2倍以上であることを明らかにし、その野望に資金を提供するために必要な巨額の支出に対する懸念が高まった後、株価は当初下落した。
この下落により空売りの波が集まり、株式の限られた公開株と比較して空売り金利が異常に上昇した。空売りでは、株式を借りて、後で低い価格で買い戻すことを期待して売却します。
この力関係は先週の木曜日に大きく変わり、最初のロックアップ期間の終了後、9億1,100万株強のSpaceX株が取引適格になった。新たにロックが解除されたトランシェは同社の発行済み株式の約7％に相当し、IPOで販売された6億3,900万株を上回った。
浮動株が大きくなると、取引可能な株式の割合として空売り金利が機械的に減少します。しかし、S3によれば、スペースXに賭けていた投資家がポジションを解消するために株を買い戻したため、ショートカバーも下落の一因となったという。
さらに多くの供給が来ています。目論見書によると、8月20日にはさらに3億1,900万株がロック解除され、9月には約7億株、10月にはその数に近づく可能性があるという。
株式の追加により、従業員や初期の投資家にさらなる売却機会が与えられ、新たなボラティリティが生じる可能性がある。同時に、浮動株が大きくなったことで、弱気なセンチメントが戻った場合、投資家は新たなショートポジションを確立しやすくなるだろう。`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/08/12/spacex-short-sellers-are-running-out-of-bullets-as-stock-rebounds-38percent-off-low.html",
    publishedAt: "2026-08-12T18:36:37+00:00",
    category: "貿易",
    imageUrl: "https://images.unsplash.com/photo-1526304640581-d334cdbbf45e?w=800&q=80",
    readTime: 3,
  },
  {
    id: "nobody-wants-it-lettuce-prices-see-reco-e371f069",
    title: "'Nobody wants it': Lettuce prices see record-setting plunge as cyclospora spooks consumers",
    titleJa: "「誰も望んでいない」：サイクロスポラが消費者を恐怖に陥れ、レタス価格が記録的な急落",
    summaryJa: "複数の州でのシクロスポラの発生により、飲食店が葉物野菜を避けるようになり、7月にレタスの価格が急騰した。米労働統計局が水曜日に発表した季節調整済みデータによると、野菜の価格は6月から16.4％下落し、1カ月としては過去最大の下落となった。レタスもまた、7月に消費者物価指数の食品カテゴリー内で前月比で最も急激な下落を記録し、期間中に全体の価格が0.1％上昇した。",
    bodyOriginal: `Lettuce prices cratered in July as the multistate cyclospora outbreak pushed diners to shun the leafy green.
...
— CNBC's Amelia Lucas contributed reporting.`,
    bodyJa: `複数の州でのシクロスポラの発生により、飲食店が葉物野菜を避けるようになり、7月にレタスの価格が急騰した。
米労働統計局が水曜日に発表した季節調整済みデータによると、野菜の価格は6月から16.4％下落し、1カ月としては過去最大の下落となった。レタスもまた、7月に消費者物価指数の食品カテゴリー内で前月比で最も急激な下落を記録し、期間中に全体の価格が0.1％上昇した。
セントラル・アーカンソー大学の経済学准教授、ジェレミー・ホーペダール氏は、「円胞子虫の発生と消費者が今はレタスを買いたがらないことが原因である可能性が非常に高い」と述べた。 「消費者はこの製品から距離を置きたいだけです。」
7月の下落により、レタスの価格は今夏の史上最高値から下がった。しかし、7月のレタス価格は依然として1年前と比べて約7.5％上昇しており、これは直近のCPIバスケット全体で見られる価格上昇ペースの2倍以上である。
今月以前のレタスの高騰は、イラン戦争による肥料価格の高騰とドナルド・トランプ大統領の大量国外追放により米国農場の人件費が上昇したことが要因だった。
最近の好不況の価格サイクルは、消費者に近年の卵の価格変動を思い出させるかもしれない、とホルペダール氏は述べた。当初は鳥インフルエンザの影響で供給が減少したため価格が急騰したが、今年に入ってコストは大幅に低下した。
食品医薬品局は、メキシコ中部にあるテイラー・ファームズの施設で加工されたアイスバーグ・レタスが、この水系寄生虫の最近の蔓延の震源地である可能性が高いと指摘した。テイラー・ファームズは、その場所で生産された製品を自主的に回収した。
メニュー項目にレタスを含むいくつかのチェーン店は、たとえ汚染された供給品を持っていなかったとしても、流行に対する消費者の懸念により客足が減少したと報告した。
Cavaの最高経営責任者（CEO）ブレット・シュルマン氏は水曜日、CNBCに対し、葉物野菜や生鮮食品に関して「広範な消費者の懸念」があり、第2四半期末ごろの短期的な売上に影響を与えたと語った。しかし、このファストカジュアルチェーンのメディテラニアン幹部は、売上傾向が回復し始めていると語った。
スイートグリーンは先週、感染拡大の影響で需要が減少しており、いつ回復するかは不透明だと述べた。サラダチェーンは通年の見通しを下方修正し、報道を受けて投資家が株を売った。
チポトレ氏は、シクロスポラが7月後半に約2パーセントポイントの売上に影響を与えたと述べた。幹部らは先月下旬の電話会議で、レタスの供給には影響はなく、ブリトーチェーンには食品の安全性について「非常に強力な」プログラムがあるとアナリストを安心させた。
ヤム・ブランズの最高経営責任者（CEO）クリス・ターナー氏は7月下旬、今回の感染拡大（食品医薬品局が最初に同社のタコベル・チェーンで提供するレタスに関係したもの）が「短期的には売上に重大な影響」をもたらしたと述べた。しかしターナー氏は、売り上げは「着実に改善している」と述べた。
ニールセンIQによると、7月25日までの4週間で、包装済みサラダのドル建て売上高は前年同期比で14％減少した。
ホルペダール氏は、レタスの価格急落は、長年にわたって望ましいインフレ水準を上回っていて苦戦している買い物客にとって、表面上は朗報とみなされるだろうと述べた。しかし同氏は、数千人が病気になっている感染拡大の中で食品の安全性をめぐる懸念が続いていることを踏まえると、消費者はコスト削減を最大限に活用しない可能性が高いと述べた。
「消費者は、安いからといって今すぐこれを急いで買うつもりはない」とホーペダール氏は語った。 「誰も望んでいないから落ちてしまったのです。」
— CNBC のアメリア・ルーカスが報道に貢献しました。`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/08/12/lettuce-prices-cyclospora-cpi.html",
    publishedAt: "2026-08-12T17:57:44+00:00",
    category: "金融政策",
    imageUrl: "https://images.unsplash.com/photo-1611974789855-9c2a0a7236a3?w=800&q=80",
    readTime: 4,
  },
  {
    id: "here-s-the-inflation-breakdown-for-july-126e3227",
    title: "Here's the inflation breakdown for July 2026 — in one chart",
    titleJa: "2026 年 7 月のインフレの内訳を 1 つのグラフで示します",
    summaryJa: "7 月の消費者物価は 6 月の反動で上昇しましたが、エネルギーが 1 年前より大幅に高かったにもかかわらず、インフレは概ね鈍化していることが示されました。労働統計局が水曜日に発表したところによると、インフレのバロメーターである消費者物価指数は12カ月前に比べて3.4％上昇した。",
    bodyOriginal: `Consumer prices rose in July — a reversal of the pullback in June — but showed inflation broadly moderating, even as energy remained sharply higher than a year ago.
...
"After more than five years of above-target inflation, policymakers want to see a clear and lasting trend before acting. Until then, this is a Fed in wait-and-see mode," Karen Manna, fixed income investment director at Federated Hermes, said in an email.`,
    bodyJa: `7 月の消費者物価は 6 月の反動で上昇しましたが、エネルギーが 1 年前より大幅に高かったにもかかわらず、インフレは概ね鈍化していることが示されました。
労働統計局が水曜日に発表したところによると、インフレのバロメーターである消費者物価指数は12カ月前に比べて3.4％上昇した。
これは、米国とイランの間の戦争が2月28日に勃発する前の1月以来、初めて年間インフレ率の低下を記録した6月の3.5％からわずかに低下した。
ムーディーズの首席エコノミスト、マーク・ザンディ氏は「ストライクゾーンのすぐ下で、非常に良性の報告書だと思った」と述べた。同氏は、「イラン戦争が背景に消えれば、インフレは依然として高いが、正しい方向に進んでいる」と述べた。
米国とイランが紛争の広範な解決に到達できるかどうか疑問が残る中、エネルギー価格は７月までの１２カ月で１４．７％上昇した。
この結果、原油から精製されるガソリンやその他の燃料、エネルギー製品の価格も上昇した。水曜日に発表されたインフレデータによると、ガソリン価格は年間で24.6％上昇し、燃料油は39.1％上昇した。
AAAによると、水曜日の時点で消費者が支払った全国平均は1ガロン当たり4.04ドルで、1年前の約3.14ドルから​​増加した。
ＣＰＩデータによると、航空運賃も過去１２カ月で２５．５％上昇した。
それでも、エコノミストらによると、石油ショックは食料品価格にそれほど大きな圧力をかけなかったが、食料品価格は米国のほとんどの家計にとって特に悩みの種だった。
CPIデータによると、食品価格は昨年3%上昇し、家庭用食品価格は2.7%上昇した。
ボストン大学の経済学教授ブライアン・ベスーン氏は、「食品価格はそれほど悪くないようだが、かなりのばらつきがある」と述べた。 「肉は大幅に上昇し、鶏肉はわずかに下落し、卵の価格はついに下落した。そして今、レタスに問題がある」と同氏は語った。
進行中のシクロスポラの発生に対する懸念により、レタスに対する消費者の需要が減退し、果物と野菜の指数を圧迫した。
全体として、肉、家禽、魚、卵の指数は7月までの12か月間で1.9％上昇したが、乳製品の指数は年間で0.5％低下した。
食品とエネルギーを除いたコアCPIは前年比2.5%上昇し、新車、衣料品、住居の指数はすべて小幅な上昇を記録した。
ザンディ氏は、「価格の手頃さは依然として深刻な問題だ」としながらも、「以前よりはずっと良くなっている」と語った。
こうした傾向が続けば、「エネルギー価格が戻らないと仮定すると、インフレ率はFRBの目標にわずかに近づくだろう」と同氏は述べた。
FRBは「様子見モード」にある
インフレ率は、連邦準備制度が金利決定の指針として使用する重要な経済指標の 1 つです。
中銀は先月、基準金利を３．５─３．７５％の範囲に維持することを決議したが、政策当局者らは借入コストの上昇が近い将来に起こる可能性を示唆している。
インフレ率が依然としてFRBの目標である2％を上回っているため、今回のCPIの統計では9月利上げの可能性は残っているが、10月利上げの可能性の方が高いと専門家は指摘する。
フェデレーテッド・ヘルメスの債券投資ディレクター、カレン・マナ氏は電子メールで「インフレ率が５年以上目標を上回っているため、政策当局者らは行動する前に明確で持続的な傾向を確認したいと考えている。それまではＦＲＢは様子見モードだ」と述べた。`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/08/12/inflation-breakdown-for-july-2026-cpi-in-one-chart.html",
    publishedAt: "2026-08-12T17:51:16+00:00",
    category: "エネルギー",
    imageUrl: "https://images.unsplash.com/photo-1473172367879-2dca04a4dca4?w=800&q=80",
    readTime: 4,
  },
  {
    id: "trump-sued-over-truth-social-s-100-000-e-cbdffa24",
    title: "Trump sued over Truth Social's $100,000 early access service",
    titleJa: "トランプ大統領、Truth Socialの10万ドルの早期アクセスサービスを巡って訴訟",
    summaryJa: "トランプ大統領、Truth Socialの10万ドルの早期アクセスサービスを巡って訴訟- 公開されました",
    bodyOriginal: `Trump sued over Truth Social's $100,000 early access service
- Published
...
The spokesperson also accused the Freedom of the Press Foundation of violating Truth Social's terms of service.`,
    bodyJa: `トランプ大統領、Truth Socialの10万ドルの早期アクセスサービスを巡って訴訟
- 公開されました
ドナルド・トランプ氏は、自身の投稿への早期アクセスに月額最大10万ドルを請求する新しいTruth Socialサービスをめぐって、米国の2つのメディアグループから訴訟を起こされている。
この訴訟は水曜日、報道傍受と自由財団によってニューヨーク連邦裁判所に起こされた。
訴訟では、大統領のメッセージへの優先アクセスを販売することは対外的に深刻な懸念を引き起こすと主張し、これを「異例で腐敗し憲法違反」と表現している。
トランプ・メディア＆テクノロジー・グループ（TMTG）は、この訴訟は大統領の検閲を求める「左翼活動家」によって起こされたと述べた。
BBCはホワイトハウスにコメントを求めた。 TMTGは以前、有料サービスに関する懸念を否定していた。
有料の Truth Social サービスでは、加入者にトランプ氏の投稿がほぼ即時に配信され、一般公開される数秒前に配信されます。原告らは、トランプ大統領がイラン戦争中など、金融市場を動かす可能性のある重大な展開を発表するためにこのプラットフォームを頻繁に利用しているため、その瞬間が重要だと主張している。
彼らは、この設定が余裕のある人々に不当な利益を与え、市場に敏感な情報が最初にお金を払っている顧客に届くシステムを作り出していると主張している。
現在、10 社以上の企業が、Truth Social の投稿への迅速なアクセスに月額最大 10 万ドルを支払っています。
トランプ・メディア・アンド・テクノロジー・グループは、この製品はより高速なデータフィードを求める企業をターゲットにしていると述べ、情報がどのように利用されるかについての懸念を否定した。
同社は7月中旬に「Truth API」と呼ばれるこのサービスを発表し、トランプ氏やその他の著名なアカウントからの投稿を数ミリ秒で配信すると発表した。
トランプ氏は同プラットフォームで最もフォロワー数が多く、フォロワー数は約1300万人で、約750万人の長男ドナルド・トランプ・ジュニア氏を上回っている。
フリーダム・オブ・ザ・プレス財団の擁護責任者セス・スターン氏は、トランプ大統領が自らが管理する民間企業の利益のために、自らが生成するニュースへの優先アクセスを販売することは「あまりにも露骨な腐敗で憲法違反であり、ほんの数年前には想像することさえ難しかっただろう」と語った。
また、インターセプト社の最高法務責任者デビッド・ブラロウ氏は、「大統領が自らの公表内容への早期アクセスを要求することほど、自由で独立した報道機関に対抗するものはない」と述べた。
訴訟ではTruth APIを「計画」であり金儲けの機会であると述べ、トランプ大統領がTMTGの株式の約41％を所有する取り消し可能な信託を通じてTMTGの最大株式を保有しており、その株式の価値は10億ドルを超えると指摘した。彼は信託の唯一の受益者です。
この訴訟に対してTMTGの広報担当者は、「トランプ大統領からの情報は無数のプラットフォームや報道機関によって拡散されており、その多くはサブスクリプションAPIを提供している。
「それらのチャンネルの 1 つが Truth Social で、大統領が不当にプラットフォームから排除された後、言論の自由のためのキャンセル不可能な避難所として設立されました。
「現在、左翼活動家たちは法廷を不当に武器にして彼を再び検閲し、我々の株主に損害を与えようとしている。」
広報担当者はまた、報道の自由財団がTruth Socialの利用規約に違反していると非難した。`,
    source: "BBC",
    sourceUrl: "https://www.bbc.co.uk/news/articles/cq6dpm5y0yyo?at_medium=RSS&at_campaign=rss",
    publishedAt: "2026-08-12T17:48:56+00:00",
    category: "マクロ経済",
    imageUrl: "https://ichef.bbci.co.uk/ace/standard/240/cpsprodpb/00fb/live/14a782c0-966d-11f1-a6eb-474cf36e6c34.jpg",
    readTime: 4,
  },
  {
    id: "discord-ordered-to-suspend-livestreams-i-5cedb330",
    title: "Discord ordered to suspend livestreams in Brazil",
    titleJa: "Discord、ブラジルでライブ配信停止命令",
    summaryJa: "Discord、ブラジルでライブ配信停止命令- 公開されました",
    bodyOriginal: `Discord ordered to suspend livestreams in Brazil
- Published
...
- Published18 February`,
    bodyJa: `Discord、ブラジルでライブ配信停止命令
- 公開されました
ブラジルのデータ保護当局（ANPD）は、10代の少女がプラットフォーム上の放送中に自殺を勧められたとされる問題を受けて、Discordにライブストリーミング機能を停止するよう命令した。
このメッセージング サービスを使用すると、ユーザーは興味に基づいてグループを作成したり参加したりでき、ユーザーは Discord の「Go Live」機能を通じてリアルタイムで音声通話またはビデオ通話に参加できるようになります。
ANPDによる捜査は、13歳の少女が死亡したことを受けて8月7日に始まった。この少女は、所属していたDiscordサーバー（またはグループ）の他者から命を絶つよう圧力をかけられたと伝えられている。
DiscordはBBCに対し、ANPDの命令を「慎重に検討」しており、「ユーザーの安全に全力で取り組んでいる」と語った。
広報担当者は「暴力を助長、奨励する団体や個人はDiscordに居場所はない」と述べた。
「私たちは迅速に調査を行い、関与した招待専用サーバーを作成直後に閉鎖し、引き続き法執行機関の捜査に協力していきます。」
外部のロイター通信によると、ＡＮＰＤは、Ｄｉｓｃｏｒｄにはライブストリームコンテンツへのリアルタイムアクセスがなく、違反の自動検出ができないことが判明したと発表した。
このサイトはデスクトップまたはモバイル アプリとしてアクセスでき、月間アクティブ ユーザー数は 2 億人を超え、ゲーマーに人気があります。
Discordの広報担当者は、調査の中で、犯罪行為が「Discordサーバーが作成される前に他のプラットフォームで調整されていた」だけでなく、「関係者がDiscordから追放された後も」継続していたという証拠が見つかったと述べた。
伝えられるところによると、10代の少女の死に関連して5人のティーンエイジャーが逮捕された。
Discordは現在、停止に従うまでに3日間の猶予が与えられており、10営業日以内に決定に対して異議を申し立てることができる。
同プラットフォームには違反ごとに最大5000万レアル（967万ドル）の罰金が科せられる可能性がある。
ANPDは、Discordが年齢確認チェックを含む「未成年者に対する適切な保護措置」を講じていることを証明するまで、停止は継続されると述べた。
2024年8月、ソーシャルメディアプラットフォームXは、既存の罰金を支払わず、最高裁判所判事が国内で新たな法定代理人を任命するために設定した期限を守らなかったため、ブラジルで禁止された。
裁判所の命令に従い総額2,800万レアル（510万ドル、380万ポンド）の罰金を支払い、ブラジルの法律で義務付けられている現地代表を任命することに同意したため、2024年10月に最高裁判所によって禁止が解除された。
...
- 2 月 18 日公開`,
    ...
    publishedAt: "2026-08-12T17:10:31+00:00",
    category: "テクノロジー",
    imageUrl: "https://ichef.bbci.co.uk/ace/standard/240/cpsprodpb/da43/live/d62cadd0-966d-11f1-a6eb-474cf36e6c34.jpg",
    readTime: 3,
  },
  {
    id: "strait-of-hormuz-ship-traffic-near-three-8d73cd57",
    title: "Strait of Hormuz ship traffic near three-month low as U.S.-Iran deal in doubt",
    titleJa: "米国とイランの合意に疑問が生じ、ホルムズ海峡の船舶交通量が3カ月ぶりに減少",
    summaryJa: "米国とイランが重要な中東石油輸出回廊の全面開通に向けた合意に達するかどうかの疑念が高まる中、ホルムズ海峡を通過する船舶の交通量は３カ月ぶりの低水準に近づいている。貿易情報会社Kplerが提供したデータをCNBCが分析したところによると、火曜日の船舶の通過回数は5日間平均約13回で、5月12日以来ほぼ最低水準となった。これには、貨物船から石油タンカーまで、あらゆる種類の船舶が含まれます。",
    bodyOriginal: `Ship traffic through the Strait of Hormuz is near a three-month low as doubt grows that the U.S. and Iran will reach an agreement to fully open the key Middle East oil export corridor.
...
A week ago, Treasury Secretary Scott Bessent told CNBC that a deal could come soon to open Hormuz with freedom of movement for ships. Bessent's comments helped drive an oil sell-off last week, but an agreement between the U.S. and Iran still has not materialized.
The U.S. and Iran signed an interim deal on June 17 to open Hormuz, with ship crossings surging to a five-day average of about 60 on June 26. But the agreement subsequently collapsed as Washington and Tehran started fighting over shipping routes, which were left undefined in the deal.
Iran attacked tankers that used the U.S.-protected route along Oman's coast. The Trump administration launched more than a dozen waves of strikes against Iran and reimposed its naval blocade in retaliation.
President Donald Trump has pivoted back to diplomacy this month, though it is unclear how much progress has been made. Traffic on Tuesday was about 80% below the post-deal peak.`,
    bodyJa: `米国とイランが重要な中東石油輸出回廊の全面開通に向けた合意に達するかどうかの疑念が高まる中、ホルムズ海峡を通過する船舶の交通量は３カ月ぶりの低水準に近づいている。
...
しかし、クリス・ライト・エネルギー長官は火曜日、米国の軍事援助を受けてタンカーが海峡を通過しているため、ホルムズ経由の石油輸出は7日間平均で日量900万バレル近くに達していると述べた。超大型タンカー 1 隻で約 200 万バレルを輸送できます。
ライト氏によると、湾岸諸国からの原油総輸出量は、パイプラインを含めると平均で日量約１５００万バレルだという。戦前、ホルムズ経由で日量約２０００万バレルの原油と製品が輸出されていた。
同エネルギー長官はソーシャルメディアへの投稿で、「多くの民間企業はホルムズ海峡を出港する船舶の数を過小評価している。船舶が水路を秘密裏に移動しているためだ」と述べた。
国営通信社プレスTVによると、イラン国家安全保障高官のモーセン・レザエイ氏は火曜日、米国がテヘランの要求に同意するまでホルムズは完全開放しないと述べた。
1週間前、スコット・ベッセント財務長官はCNBCに対し、ホルムズ島に船舶の移動の自由を与える協定が間もなく締結される可能性があると語った。ベッセント氏の発言は先週の原油売りにつながったが、米国とイランの合意はまだ実現していない。
米国とイランは6月17日にホルムズ港を開放するための暫定合意に署名し、6月26日には船舶の航行回数が5日間平均約60回に急増した。しかし、合意に未定義のまま残された航路をめぐって米国とイランが争いを始めたため、合意はその後崩壊した。
イランは、オマーン沿岸に沿って米国が保護する航路を利用していたタンカーを攻撃した。トランプ政権はイランに対して十数回の波状攻撃を開始し、報復として海軍の封鎖を再発動した。
ドナルド・トランプ大統領は今月、外交に軸足を戻したが、どれだけ進展があったのかは不明だ。火曜日のトラフィックは合意後のピークを約80％下回った。`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/08/12/strait-hormuz-ship-traffic-iran-war-deal.html",
    publishedAt: "2026-08-12T16:33:35+00:00",
    category: "エネルギー",
    imageUrl: "https://images.unsplash.com/photo-1473172367879-2dca04a4dca4?w=800&q=80",
    readTime: 3,
  },
  {
    id: "trump-sued-over-truth-social-advance-acc-1fd5d50d",
    title: "Trump sued over Truth Social advance access sale",
    titleJa: "トランプ大統領、Truth Socialの事前アクセス販売を巡って訴訟",
    summaryJa: "ドナルド・トランプ大統領は水曜日、Truth Socialでの自身の投稿の事前通知を販売する物議を醸している新サービスの阻止を求めるメディアと非営利団体から訴訟を起こされた。マンハッタンの連邦地方裁判所に起こされたこの訴訟は、トランプ氏自身のソーシャルメディアサイトへの投稿が、政府の政策や軍事行動、その他の決定に関する発表で金融市場を動かすことが多いと指摘している。",
    bodyOriginal: `President Donald Trump was sued on Wednesday by a media outlet and a non-profit group seeking to block a controversial new service that sells advance notifications of his posts on Truth Social.
...
— CNBC's Megan Cassella contributed to this report.`,
    bodyJa: `ドナルド・トランプ大統領は水曜日、Truth Socialでの自身の投稿の事前通知を販売する物議を醸している新サービスの阻止を求めるメディアと非営利団体から訴訟を起こされた。
マンハッタンの連邦地方裁判所に起こされたこの訴訟は、トランプ氏自身のソーシャルメディアサイトへの投稿が、政府の政策や軍事行動、その他の決定に関する発表で金融市場を動かすことが多いと指摘している。
民事訴訟では、「ドナルド・トランプ大統領は、自身が所有するソーシャルメディア・プラットフォームであるTruth Socialでの政府の公式発表への事前アクセスに月額10万ドルを請求している」としている。
「この計画は異常で腐敗しており、憲法違反であり、原告らはそれを阻止するためにこの訴訟を起こした」と訴訟は述べている。 「トランプ大統領が政府情報を販売して利益を得ることには、正当な利益はなく、ましてや重大な利益はない。」
この訴訟は、報道機関であるインターセプト・メディアと非営利団体である自由報道協会によって起こされた。
告訴状では、Truth APIとして知られるこの新サービスは、加入者に「不当な金額」でトランプ大統領の公表内容への優先アクセスを与えるもので、合衆国憲法修正第1条と第5条に違反していると主張している。
トゥルース・ソーシャルの親会社トランプ・メディアは7月、毎月最大10万ドルを支払った購読者に、トランプ氏や同プラットフォームを利用する他の人々による「市場を動かす」投稿への早期アクセスを提供すると発表した。トランプ氏は、ドナルド・J・トランプ取消可能信託を通じてトランプ・メディアの筆頭株主である。
訴状によると、現在、Truth APIは購読者にTruth Socialで最も人気のある10のアカウントの投稿へのより迅速なアクセスを提供している。トランプ大統領以降、これらのアカウントには、ホワイトハウスそのもの、JD・バンス副大統領、カッシュ・パテルFBI長官、キャロライン・リービット大統領報道官、ショーン・ダフィー運輸長官、ロバート・ケネディ保健福祉長官が含まれる。
「この計画はひどく腐敗している」と訴状は述べている。 「大統領は、自分の会社にお金を払う意欲と能力のある人々に『市場を動かす』政府情報を提供することで、経済的に利益を得ようとしている。
訴状によると、2025年1月に大統領に復帰して以来、トランプ氏はTruth Socialに9,000～11,000件の投稿を投稿したという。
「彼の投稿には、ホワイトハウスからの即時の対応発表がないことが多い」と訴状は述べている。 「言い換えれば、トランプ大統領の投稿が政府の公式ニュースを入手する唯一の方法だということだ。」
CNBCはこの訴訟についてホワイトハウスにコメントを求めた。
トランプ・メディアのケビン・マクガーン最高経営責任者（CEO）は月曜日の四半期決算会見で、Truth APIは「プラットフォームのトップアカウントから公開されているTruth投稿の機械可読フィードをミリ秒単位で提供する」と述べた。
「当社の顧客は、ほんの少し早く公開され、公開された投稿を入手できるようになるだろう」とマクガーン氏は語った。
マクガーン氏はまた、その電話の中で、トランプ・メディアがこれまでにTruth APIの顧客契約を10件以上締結しており、その金額は「通常月額6万ドルから10万ドルの範囲」であると述べた。
マクガーン氏は、同社がハイパースケーラーや一部の大手報道機関、大規模な言語モデルの開発者らとこのサービスについて活発な議論を行っていると述べた。
「将来を見据えて、API の次のフェーズには、ニュースフィード、金融データ端末、専門出版物など、より広範なサードパーティ配信が含まれると予想しています。これにより、時間の経過とともにこのビジネスの認知度がさらに高まると考えています」と同氏は述べた。
訴訟ではトランプ氏に加え、大統領首席補佐官ナタリー・ハープ氏とホワイトハウス副首席補佐官ダン・スカビーノ氏も被告として名指しされており、両氏はそれぞれ大統領に代わってトゥルース・ソーシャルに投稿していることが知られている。大統領執行部;そしてホワイトハウスオフィス。
— CNBC の Megan Cassella がこのレポートに寄稿しました。`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/08/12/trump-truth-social-lawsuit.html",
    publishedAt: "2026-08-12T16:25:58+00:00",
    category: "テクノロジー",
