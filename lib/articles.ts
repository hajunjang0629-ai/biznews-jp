...
記事は、「ワンダーマインドには将来の計画がなかった。ましてや数十億ドルの評価額を達成する計画などなかった」と訴訟では主張している。`,
  ...
  },
  {
    ...
    summaryJa: "英国の右翼政党「改革英国」の党首ナイジェル・ファラージ氏が、財政をめぐる論争のさなか辞任し、先月自ら引き起こした投票で議会に再選を果たした。ファラージ氏はこれまでドナルド・トランプ米大統領から称賛され、欧州連合（EU）離脱を求める英国の運動の旗手でもあったが、2024年の選挙を前にタイを拠点とする仮想通貨投資家からの500万ポンド（670万ドル）の寄付を申告しなかったとして議会の捜査に直面している。",
    bodyOriginal: `Nigel Farage, leader of Britain's right-wing Reform UK party, has won re-election to parliament in a vote he triggered himself last month by stepping down amid controversy over his finances.
...
The probe was suspended following his resignation on July 7. Farage has said the gift was a personal gift intended to contribute to his security costs.
...
Farage did not attend the vote count overnight, instead speaking with supporters at an event elsewhere in the constituency.
...
The governing Labour party suffered bad results in local elections in May, though polls suggest the party has become more popular since the installation of Andy Burnham as prime minister in July following the ouster of Keir Starmer.`,
    bodyJa: `英国の右翼政党「改革英国」の党首ナイジェル・ファラージ氏が、財政をめぐる論争のさなか辞任し、先月自ら引き起こした投票で議会に再選を果たした。
ファラージ氏はこれまでドナルド・トランプ米大統領から称賛され、欧州連合（EU）離脱を求める英国の運動の旗手でもあったが、2024年の選挙を前にタイを拠点とする仮想通貨投資家からの500万ポンド（670万ドル）の寄付を申告しなかったとして議会の捜査に直面している。
ファラージ氏は7月7日の辞任を受けて捜査は中断されたが、ファラージ氏はこの贈り物は自分の警備費に充てることを目的とした個人的な贈り物だったと述べている。
BBCの報道によると、改革英国は「容認できない」政党献金に関連して警察の捜査に直面している。
ファラージ氏が補欠選挙を「体制側」との戦いを問う国民投票と位置付けようとしたことを受け、主流政党は補欠選挙への立候補をボイコットすると表明した。つまり、彼の主な対戦相手は、コスチュームを着た連載候補者「カウント・ビンフェイス」であり、2位となった。
ファラージ氏は一晩の開票作業には出席せず、選挙区の別の場所で行われたイベントで支持者らと話をした。
エセックス州のクラクトン市にはファラージ氏の政党を支援してきた実績がある。英国独立党は、ファラージ氏が率いる2014年の選挙で初勝利を収めた。
「大勝利を勝ち取り、自分が戦おうとしてきたすべてのことへの熱烈な支持を勝ち取ってステージに立つのに、誰にも貶められ、屈辱を与えられるなんて、本当に最悪だ」と彼は観衆に語った。
ファラージ氏は英国政界では長らくよく知られた人物だったが、2024年に初めて議会に選出された。改革英国は2021年にファラージ氏の前のEU離脱党から誕生し、その綱領を拡大して移民とビザの規則に対するより厳しい姿勢を取り、気候変動目標の撤回と一部の減税を掲げた。
英国の２大政党である労働党と保守党が世論調査で苦戦する中、同党は支持率を高め、緑の党などの代替政党に勢いを与えている。
与党労働党は5月の地方選挙で悪い結果に見舞われたが、世論調査によると、キア・スターマー氏の追放を受けて7月にアンディ・バーナム氏が首相に就任して以来、同党の人気が高まっている。`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/08/14/nigel-farage-reform-uk-parliament-re-election.html",
    publishedAt: "2026-08-14T07:17:43+00:00",
    category: "テクノロジー",
    imageUrl: "https://images.unsplash.com/photo-1518770660439-4636190af475?w=800&q=80",
    readTime: 2,
  },
  {
    id: "unprecedented-rains-in-japan-kill-six-p-94b22131",
    title: "'Unprecedented' rains in Japan kill six people",
    titleJa: "日本で「前例のない」豪雨で6人死亡",
    summaryJa: "日本で「前例のない」豪雨で6人死亡- 公開されました",
    bodyOriginal: `'Unprecedented' rains in Japan kill six people
- Published
At least six people have died and five others are wounded in eastern Japan as record rainfall pummelled the Chiba prefecture near the capital Tokyo.
The rains, which authorities have described as "unprecedented", cut power to more than 20,000 households while 7,000 travellers were stranded overnight at Tokyo's Narita airport.
...
Chiba, which sits right next to the capital city of Tokyo, has logged more than 100mm of rain per hour since Thursday afternoon, authorities say.
...
At lest six people have died, according to reports from public broadcaster NHK, Kyodo news agency and Asahi newspaper.
...
All flights are scheduled to operate normally on Friday, a spokesperson from Narita airport said. Flag carrier Japan Airlines said some of its flights may be delayed but that it does not expect any cancellations.
...
Over the weekend, Chinese authorities evacuated more than a million people from their homes as Dolphin, the strongest typhoon to hit China so far this year, made landfall in the country's east.`,
    bodyJa: `日本で「前例のない」豪雨で6人死亡
- 公開されました
首都東京近郊の千葉県を記録的な豪雨が襲い、東日本では少なくとも６人が死亡、５人が負傷した。
当局が「前例のない」と表現するこの豪雨により、2万世帯以上が停電し、7,000人の旅行者が東京の成田空港で一晩足止めされた。
地元当局は木曜日、最高警戒レベル５の緊急警報を発令した。金曜朝までにレベル４に引き下げられたが、政府は引き続き地滑りや洪水の危険を警告している。
この大洪水は、異常に活発な台風シーズンになると予想されている今週、一連の嵐が日本と近隣諸国を襲った後に発生した。
日本の気象庁は、今回の洪水は日本の東に流れ込む暖かく湿った空気が上空の冷たい空気と結びついて大気の状態が極めて不安定になったことによってもたらされたと述べた。
雨は金曜日遅くまで続く見込みです。
千葉県の熊谷俊人知事は金曜朝、記者団に対し「今回の件は日本の歴史的気象基準から見ても極めて異例の事態だ」と語った。
「これまで多くの災害に対応してきましたが、このようなケースは初めてです。」
首都東京のすぐ隣に位置する千葉では、木曜午後以来、1時間に100ミリを超える雨が降ったと当局が発表した。
これは8月の平均降水量の約3倍で、国内で観測史上最高の降水量となった。
当局は人命救助を優先し、救助活動を継続するだろうと熊谷氏は付け加えた。
公共放送NHK、共同通信社、朝日新聞の報道によると、少なくとも6人が死亡した。
当局によると、死亡者の中には冠水した道路で車の中で死亡した女性も含まれていた。他の2人は路上で倒れ、その後死亡した。
気象庁は先に、この状況を「これまでにないレベルの大雨」と表現した。
金曜朝も複数の鉄道が運休しており、一部の主要高速道路も通行止めとなっている。
木曜日には雨による土砂崩れや停電が発生し、10万世帯以上に避難が求められている。
成田空港の広報担当者によると、金曜日はすべての便が通常通り運航する予定だという。フラッグキャリアである日本航空は、一部の便が遅延する可能性があるが、欠航は予想されていないと述べた。
乗客は地下鉄駅で足止めされ、約１８００人が千葉県庁舎で一夜を過ごした。
千葉県市川市の女性はNHKの取材に、雨は「突然降ったので本当にびっくりした」と語った。
「停電しているので、数日以内に営業できるか心配です」と彼女は語った。
一方、フィリピンでは、洪水の恐れを理由に、当局が再び学校を閉鎖し、北部のほとんどの地域で政府機関が再び閉鎖された。
今週初め、日本、フィリピン、中国は、この地域を同時に襲うドルフィン、チャンハム、ペイロウという連続した嵐に見舞われた。
イルカは日本の沖縄島に大雨をもたらし、数万棟の建物が停電し、木が倒れ、航空便が欠航した。
今年これまでに中国を襲った中で最も強い台風「ドルフィン」が同国の東部に上陸したため、先週末、中国当局は100万人以上を自宅から避難させた。`,
    source: "BBC",
    sourceUrl: "https://www.bbc.co.uk/news/articles/cq561gpen8lo?at_medium=RSS&at_campaign=rss",
    publishedAt: "2026-08-14T07:00:56+00:00",
    category: "自動車",
    imageUrl: "https://ichef.bbci.co.uk/ace/standard/240/cpsprodpb/3fc8/live/6099c440-9794-11f1-8c8f-61df390540c2.jpg",
    readTime: 3,
  },
  {
    id: "china-built-robots-that-can-do-backflips-ee50f927",
    title: "China built robots that can do backflips – but can they make money?",
    titleJa: "中国はバク転ができるロボットを開発したが、儲かるのだろうか?",
    summaryJa: "中国で最も有名なヒューマノイドメーカー、ユニツリー・ロボティクスの上場を巡る小売店の興奮が最高潮に達する中、懐疑論者らは、これらのロボットがランニングやアクロバットを超えて、真に有用な作業を実行できるようになるまでどれくらいの時間がかかるのか疑問を抱いている。杭州に本拠を置くこの新興企業は、IPOの価格を1株当たり150.8元（22.4ドル）とし、9億ドルを調達し、企業価値は610億元（約90億ドル）となった。",
    bodyOriginal: `As retail excitement around the listing of China's best-known humanoid maker, Unitree Robotics, reaches fever pitch, skeptics are questioning how long it will take before these robots can move beyond running and acrobatics to perform genuinely useful work.
...
Some researchers argue Unitree isn't just a humanoid bet. Humanoids are Unitree's largest business, but quadruped robots still account for a sizable share. Purpose-built robots can be cheaper and more reliable in repetitive industrial settings, while humanoids are best-suited for unpredictable and less structured environments, they say.`,
    bodyJa: `中国で最も有名なヒューマノイドメーカー、ユニツリー・ロボティクスの上場を巡る小売店の興奮が最高潮に達する中、懐疑論者らは、これらのロボットがランニングやアクロバットを超えて、真に有用な作業を実行できるようになるまでどれくらいの時間がかかるのか疑問を抱いている。
杭州に本拠を置くこの新興企業は、IPOの価格を1株当たり150.8元（22.4ドル）とし、9億ドルを調達し、企業価値は610億元（約90億ドル）となった。
投資家らは、今月後半に上海のSTAR市場で同社株の取引が開始され、本土で上場する初の人型ロボット企業となるユニツリーの初日からの大きなヒットを期待している。
Unitree の商品は上海の STAR 市場で記録的な小売需要を記録し、オンライン トランシェは 5,000 倍以上の申し込みがあり、0.018% という歴史的に低い当選率となりました。同社の IPO には、AI スタートアップの DeepSeek などの戦略的投資家も集まりました。
投資家が取引開始前に株式に賭けるため仮想通貨デリバティブ取引所に目を向けているため、ユニツリーにリンクされたハイパーリキッドのプレIPO無期限契約は金曜日の時点でIPO価格の約4倍で取引されている。
カンフーキックを放ったり、ダウンから立ち直ることで有名なユニツリーのロボットは、AIとソフトウェアの制約が未解決で、この技術が商業的に拡張できるかどうかという疑問に依然として直面している。
ロータス・アセット・マネジメントのマネジング・パートナー、ハオ・ホン氏は「これらの人型ロボットは、正直に言って魅力的だ。ダンスなどもできるが、実際に家事をしているところは見たことがない」と語った。
ユニツリーは目論見書の中で、ロボットハンドは依然として持続可能な使用に十分な精度や耐久性を備えていないため、大規模な商業導入の進展は予想よりも遅い可能性があると述べた。
ホン氏は、個人投資家が殺到しているのは、投資対象となる人型ロボット企業が非常に少ないことが一因だと指摘した。
VP Bank の株式アナリスト、ドミニク・プロス氏は、高度な人型ロボットでさえ、通常は少数のタスクしか処理できず、バッテリーを再充電するまでの時間はわずか数時間であると述べています。ほとんどの人型モデルは、アイドル状態で最大 4 時間動作します。
同氏は、「ロボットは、たとえ最も単純なタスクであっても、任されたあらゆるタスクに合わせて特別に訓練される必要がある」と述べ、複雑な日常活動にはまだ手が届かないと付け加えた。
さらに多くのロボットのリストが今後も予定されています。 UnitreeのライバルであるAgiBotとLeju Roboticsは、それぞれ香港と深センでの株式公開を目指している。 LimX Dynamicsの創設者ウィル・チャン氏は先月CNBCに対し、「上場は必須だ」と語った。
ヒューマノイド経済学
低コストの製造により、中国はロボット工学分野で世界のライバルに先んじることができた。
ウッド・マッケンジー氏は、世界の人型ロボット群が2035年まで毎年90％以上増加し、1000万台を超えると予想している。それまでに年間出荷台数は400万台に達すると予想されている。調査会社によると、中国はすでに主要なプレーヤーであり、世界の産業用ロボット導入の70％以上、昨年導入されたヒューマノイド全体の90％近くを占めている。
ウッド・マッケンジー氏によると、人型ロボットの平均価格は2020年から2025年の間に93％下落し、5万8000ドルとなった。同社は、Unitreeの1万6000ドルの主力G1モデルを1日8時間稼働させるのにかかる電気代は年間わずか82ドルになると予測しているが、普及が広がればすでにAIデータセンターで逼迫している電力システムへの圧力が高まる可能性があると述べている。
セミアナリシス社は、Unitree が G1 EDU モデル（研究用に構築されたカスタマイズ可能なモデル）の税引き前価格を、67% の粗利を維持しながら、昨年より 45% 以上値下げして 27,300 ドルにしたと推定しています。
調査会社スマート・アナリティクス・グローバルの創設者、リンダ・スイ氏は、ロボットの価格下落と、国内メーカーの労働集約型作業から自動化への移行への投資を含む中国政府の支援が、新興分野への関心を高め、資金を呼び込むことに貢献していると述べた。生産量の増加によりコストの削減には貢献したが、ロボットの投資収益率をテストするには時間がかかるだろうとスイ氏は述べた。
アナリストらは、ユニツリーの強みは製造規模とコスト構造にあると指摘する。ユニツリーの昨年の収益は4倍以上に増加したが、研究開発とマーケティングへの支出が増加したため、第1四半期の調整後利益は52％以上減少した。
懐疑論者らは、ユニツリーの現在の需要の多くは依然として研究と実証に集中していると指摘する。同社のヒューマノイド収益の4分の3近くは、2025年最初の9か月間で研究と教育によるものであり、企業ツアーがまだ小規模な工業事業の半分以上を占めていたことが、同社の提出書類で明らかになった。
CoinExの首席アナリスト、ジェフ・コー氏は「多くの初期段階のロボット企業とは異なり、Unitreeのストーリーは実質収益の伸びに裏付けられている」と述べた。それでも同氏は、ユニツリーの90億ドルという高額な評価額（昨年の収益の200倍以上）が仮想通貨市場ではさらに高騰していると述べ、投機的な要素を指摘した。
ロボット政治
米国が先月、中国のテクノロジー製品を標的にしたとみられる外国製の人型ロボットや四足歩行ロボットの輸入禁止に踏み切った後も、IPOの熱狂は続いた。
SAGによると、ユニツリーは昨年の収益の13％を米国から得ており、「特に危険にさらされている」可能性がある。
ユニツリーの低コストロボットは、米国の大学におけるヒューマノイド研究用の有力な選択肢となっているが、試験や開発のための小ロット輸入は依然として免除されているため、新たな規制に動じない研究者もいる。中国に関する下院特別委員会によると、ユニツリーの四足ロボットは米国の州矯正システムや軍事施設でも使用されており、国家安全保障上の懸念が高まっている。
もう一つの大きな地政学的リスクは、中国のロボット企業がエヌビディアのハードウェアおよびソフトウェアスタックへのアクセスを失う可能性である、とSAGのスイ氏は述べた。中国の業界リーダーは、ロボットに電力を供給するための Nvidia プラットフォームの初期ユーザーの 1 人です。
「中国のロボットメーカーはまだ、西側の部品を完全に抜きにしてやっていける立場にはない」とVPバンクのプロス氏は語った。
しかし、バーンスタインのアナリスト、ディエン・ワン氏は、人型ロボットのアクチュエーターやモーターに使用されるレアアースにおける中国の優位性により、同国のプレーヤーは世界の同業者に対して大きな影響力を得ることができると述べた。
人型ロボット産業の発展には長い道のりがあるが、潜在的な市場機会により、テスラの最高経営責任者イーロン・マスク氏はロボット工学の開発に力を入れ、同社のフリーモント工場のEV生産ラインをオプティマス人型ロボットの製造に転換した。生産は今年後半に開始される予定だ。
研究者の中には、Unitree は単なる人型の賭けではないと主張する人もいます。ヒューマノイドは Unitree の最大の事業ですが、四足ロボットが依然として大きなシェアを占めています。専用のロボットは繰り返しの多い産業環境では安価で信頼性が高いが、ヒューマノイドは予測不可能で構造化されていない環境に最適である、と彼らは言う。`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/08/14/china-humanoid-robots-unitree-ipo-tesla-optimus.html",
    publishedAt: "2026-08-14T05:00:47+00:00",
    category: "金融政策",
    imageUrl: "https://images.unsplash.com/photo-1611974789855-9c2a0a7236a3?w=800&q=80",
    readTime: 8,
  },
  {
    id: "how-a-niche-copper-trade-became-a-real-t-bbe97654",
    title: "How a niche copper trade became a real-time gauge of Trump’s next tariff move",
    titleJa: "ニッチな銅取引がどのようにしてトランプ大統領の次の関税措置のリアルタイムの尺度になったのか",
    summaryJa: "金属商品に関するある専門的な裁定取引は、米国の関税リスクをリアルタイムに測る手段へと進化しつつある。工業用金属が建設、エレクトロニクス、輸送の主要な構成要素であることから、より広範な経済のバロメーターと見なされている銅は1年以上下落しており、先週は先物相場が1ポンド当たり約6.90ドルという過去最高値に達した。",
    bodyOriginal: `One specialist arbitrage trade on a metal commodity is evolving into a real-time gauge of U.S. tariff risk.
...
"We remain constructive on copper, although tariff uncertainty means volatility is likely to stay elevated," she added.`,
    bodyJa: `金属商品に関するある専門的な裁定取引は、米国の関税リスクをリアルタイムに測る手段へと進化しつつある。
工業用金属が建設、エレクトロニクス、輸送の主要な構成要素であることから、より広範な経済のバロメーターと見なされている銅は1年以上下落しており、先週は先物相場が1ポンド当たり約6.90ドルという過去最高値に達した。
米国のCOMEX先物とロンドン金属取引所の価格間のスプレッドは、歴史的に現物トレーダー、銀行、ヘッジファンド、生産者、消費者が一時的な価格差から利益を得て、2つの市場間の価格リスクをヘッジするために利用されてきました。
裁定取引は歴史的に、中国の需要ショックや南米での供給混乱などの要因によって引き起こされてきた。
しかし現在、ソシエテ・ジェネラルのアナリストらは、ホワイトハウスの調査を待っている精錬銅に対する第232条の新たな関税の見通しによって取引が一変しており、投資家が追加関税の目安としてCOMEXプレミアムを利用することが増えていると述べている。
米国はすでに、銅半製品および銅で作られた他の特定製品の輸入に50％の関税を課している。商務省は、精製銅に対して2027年1月1日から15％の段階的な普遍関税を適用し、2028年1月1日には30％に引き上げることを勧告した。
「ＣＯＭＥＸとＬＭＥのスプレッドは米国の関税予想を測る尺度としてますます高まっており、プレミアムの拡大は関税リスクがより大きく認識されていることを示しており、金属を米国に引き込み続けている」とＩＮＧの商品戦略担当エワ・マンセイ氏は電子メールでＣＮＢＣに語った。
米国は7月に20万トン以上の銅を輸入したが、これは12年ぶりの高水準である。
FIC・商品調査責任者のマイク・ヘイグ氏率いるSocGenのアナリストらは、米国の政策立案者らは、AIインフラ、送電網の近代化、世界需要を加速させる防衛支出として輸入精銅に依存していることへの懸念を強めていると述べた。
同氏は、同法第232条の調査は「経済成長と国家安全保障の両方にとって重要とみなされる資料へのアクセスを確保する」という広範な目的を反映していると述べた。
銅料金の予測
スプレッドを関税オッズに変換するために、SocGen は、LME グレードの銅をヨーロッパの倉庫から米国東海岸に移動するコストをモデル化し、そのオールイン引き渡し価格を COMEX 先物と比較しました。アナリストらは、完全に引き渡されたLME金属に対する現在のCOMEXプレミアムは、2027年1月までに商務長官が推奨する15％の段階的普遍関税が達成される可能性が14.6％であることを示唆していると述べた。
2028年1月までに30％の関税が課される確率は37％に上昇する。
ストーンＸ社のシニア金属需要ストラテジスト、ナタリー・スコット・グレイ氏は、精錬銅に関する米国第２３２条の期限切れの決定が現在、銅市場が直面している「唯一最大の触媒」となっていると述べた。スコットグレイ氏は最近の市場解説で、包括的な関税は米国外の供給を圧迫するだろうが、対照的に、関税がなければCOMEXとLMEの裁定取引は巻き戻されないと述べた。
マンタイ氏は、「特に鉱山の供給が依然として逼迫しており、米国と中国の間で入手可能な金属をめぐる競争が激化しているため」、プレミアム幅の拡大が当面の銅価格を引き続き支援していると述べた。
同氏は「銅に関しては引き続き前向きだが、関税の不確実性によりボラティリティは高止まりする可能性が高い」と付け加えた。`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/08/14/copper-trump-tariffs-metal-commodities-trade-war.html",
    publishedAt: "2026-08-14T05:00:01+00:00",
    category: "テクノロジー",
    imageUrl: "https://images.unsplash.com/photo-1518770660439-4636190af475?w=800&q=80",
    readTime: 4,
  },
  {
    id: "us-says-dozens-of-countries-helped-china-1eeb261b",
    title: "US says dozens of countries helped China dodge Trump's tariffs",
    titleJa: "米国、数十カ国が中国によるトランプ大統領の関税回避に協力したと発表",
    summaryJa: "米国、数十カ国が中国によるトランプ大統領の関税回避に協力したと発表- 公開されました",
    bodyOriginal: `US says dozens of countries helped China dodge Trump's tariffs
- Published
...
Related topics
- Published5 August`,
    bodyJa: `米国、数十カ国が中国によるトランプ大統領の関税回避に協力したと発表
- 公開されました
ホワイトハウスは木曜日の報告書で、40カ国以上が米国の輸入関税が低い国を経由して輸出することで中国が米国の関税を回避するのを支援していると述べた。
名前の挙がった国にはカナダ、インド、メキシコ、日本、韓国が含まれており、ホワイトハウスはこれらの国々が中国による商品輸入企業に課せられる数百億ドルの関税回避に貢献したと主張した。
ホワイトハウス通商顧問ピーター・ナバロ氏は、これにより「米国の雇用と数十億ドルの歳入」が失われたと述べた。
ワシントンの中国大使館の報道官はBBCの質問に答え、「貿易戦争に勝者はない」とし、米国の関税措置や中国企業を標的にする国家権力の行使に反対すると述べた。
広報担当者は、「積み替えられた商品に関する一方的な行動や合意は、第三者の利益を標的にしたり、第三者の利益を害したりしてはならない」と付け加えた。
BBCは、報告書に記載されているカナダ、インド、メキシコ、日本、韓国、その他の貿易相手国の米国大使館にコメントを求めた。
この報告書は米国と中国間の制裁の波を受けてのもので、ドナルド・トランプ米大統領がワシントンで中国の指導者習近平と会談する数週間前に発表された。
ホワイトハウスが引用した政府および民間部門の推計によると、300億ドル（222億ポンド）から約3,000億ドルの物品が、関税の高い国から低い国を経由して移動されている。
このプロセスは積み替えとして知られており、最終目的地に向かう途中で別の国を経由して貨物を転送する行為を指します。
米国は中国が輸入関税の低い国を経由して商品を輸送することでこの慣行を「利用」していると非難した。
ホワイトハウスは報告書の中で、中国が第三国を中継地として利用し、関税を下げるために本当の原産地を隠すために商品を再梱包してきたと述べ、この過程を「書類に隠れた詐欺」だと述べた。
「今日の大積み替え詐欺で変化したのは、単にこの現代形態の密輸の速度と規模だけではなく、中国の関税回避が現在このネットワークを経由して行われている世界的な影の積み替えネットワークの広さ、深さ、そして洗練さだ」とホワイトハウスは書いた。
米国は積み替え作業を把握するために人工知能（AI）ツールを導入したと付け加えた。
トランプ大統領と習近平国家主席が9月に米国での会談を準備する中、この報告書は両国間の重要な対立点をさらに深めると予想されている。
2025年5月の協議後、ほとんどの関税は一時停止されたにもかかわらず、米中両国は米国に出荷される人型ロボットの制限や中国のドローン輸出規制の強化など、制裁のやりとりを続けている。
2025年4月、トランプ大統領は、関税が米国の雇用と経済の促進に役立つという長年の信念に基づいて、数十の米国貿易相手国に対する包括的な課税を発表した。
その後、これらの制裁は米国最高裁判所によって取り消されたが、トランプ大統領は自らの特徴的な政策を継続するために、代替の法的手段を用いて新たな関税を繰り返し導入してきた。
関連トピック
- 8 月 5 日発行`,
    source: "BBC",
    sourceUrl: "https://www.bbc.co.uk/news/articles/c78gy6ep3n5o?at_medium=RSS&at_campaign=rss",
    publishedAt: "2026-08-14T03:09:48+00:00",
    category: "テクノロジー",
