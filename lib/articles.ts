...
ムーア氏は、TipRanks が追跡する 12,300 人以上のアナリストの中で 148 位にランクされています。彼の評価は 60% の確率で成功し、平均 25.5% のリターンをもたらしました。 TipRanks の Broadcom インサイダー取引活動を参照してください。`,
  ...
  {
    id: "israeli-settlers-set-fire-to-mosques-car-e14f2b4d",
    title: "Israeli settlers set fire to mosques, cars and farm land in West Bank, Palestinians say",
    titleJa: "イスラエル人入植者がヨルダン川西岸のモスク、車、農地に放火、パレスチナ人が発表",
    summaryJa: "イスラエル人入植者がヨルダン川西岸のモスク、車、農地に放火、パレスチナ人が発表- 公開されました",
    bodyOriginal: `Israeli settlers set fire to mosques, cars and farm land in West Bank, Palestinians say
- Published
...
- Published1 day ago`,
    bodyJa: `イスラエル人入植者がヨルダン川西岸のモスク、車、農地に放火、パレスチナ人が発表
- 公開されました
パレスチナ当局者らによると、領土内の緊張が高まり続ける中、イスラエル人入植者らが占領下のヨルダン川西岸地区で２つのモスクのほか、車や農地に放火した。
今回の攻撃は、タル村近くで入植者とパレスチナ人が衝突し、パレスチナ人４人とイスラエル人２人が死亡した２日後に発生した。
双方とも相手が暴力を誘発したと非難した。
この対立はヨルダン川西岸の状況をさらに悪化させており、現イスラエル政府の極右分子の煽りを受けて、過激派入植者によるパレスチナ人に対する暴力が激化し続けている。
パレスチナ側の報告によると、占領下のヨルダン川西岸の2つの村が一夜にして入植者らの攻撃にさらされ、車が破壊され、財産が盗まれ、スプレーで壁に憎悪の落書きが描かれたという。
クスラ市長は、入植者らが建設中のモスクに放火したと発表した。
アブドゥル・アジム・ワディ氏は、入植者らがモスクの壁に「復讐」という言葉を含む落書きをスプレーで描いたと語った。
イスラエル軍はクスラに部隊を派遣し、警察が捜査して証拠を収集すると発表した。
パレスチナ当局者らによると、別の事件では入植者らがクール村の別のモスクに放火し、壁にスローガンをスプレーしたという。
金曜日のタルでの致命的な衝突以来、パレスチナ人らは、ヨルダン川西岸全域の村々に対する入植者による襲撃が複数発生していると述べている。
イスラエル国防軍（IDF）は「対テロ」作戦と称して急襲を実施し、数十人のパレスチナ人を逮捕した。
イスラエルのベンヤミン・ネタニヤフ首相はタルでの事件に反応し、「強力な行動」を取ると誓った。
これには、関与したとされるパレスチナ人２人の自宅が取り壊される可能性も含まれている。
ヨルダン川西岸ではここ数カ月、入植者への襲撃が急増している。
これは国際的な非難を集めているが、覆される兆しはほとんど、あるいはまったく見られない。
2023年10月7日にハマス主導のイスラエル攻撃が行われる前に、状況はすでに悪化していた。
しかし、その後イスラエルがガザ地区のハマスに対して行った戦争が勃発して以来、ヨルダン川西岸における入植者の暴力は激化した。
国連は、ヨルダン川西岸でパレスチナ人1,114人が殺害され、その大部分がIDFによって殺害されたと発表した。死者のうち少なくとも35人は入植者による襲撃に関係しているという。
同報告書によると、ガザ戦争開始以来、パレスチナ側の攻撃やヨルダン川西岸でのイスラエル軍の作戦中に、民間人や治安要員を含むイスラエル人41人が死亡したという。
...
- 1 日前に公開`,
    ...
    publishedAt: "2026-07-26T10:26:05+00:00",
    category: "金融政策",
