...
- 8 時間前に公開`,
  ...
  },
  {
    ...
    titleJa: "Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.",
    summaryJa: "Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.",
    bodyOriginal: `Huawei and Xiaomi this week rolled out their latest foldable phones as the Chinese tech giants look to steal a lead on rival Apple, which is rumored to launch its first foldable iPhone on Wednesday.
Xiaomi, the world's third-largest smartphone player, launched the Xiaomi 18 Fold on Monday, a passport-sized device similar to Samsung's Galaxy Z Fold8, which was released earlier this year. Huawei on Monday unveiled the Mate XT2, the third generation of its trifold smartphone, which it pioneered.
Those launches are no coincidence. Apple is holding an event on Wednesday, where it is rumored to be unveiling the first foldable iPhone, a major new product under new CEO John Ternus.
"There is significant pent-up demand for a foldable iPhone within the Apple community," Neil Shah, partner at Counterpoint Research, told CNBC on Tuesday. "Many have refrained from switching to Samsung. Some have switched, but they might come back if there is an amazing foldable iPhone."
Apple could ship 6 million foldable iPhones this year, giving it a 25% share of the global market, according to Counterpoint Research. This share could grow to 40% in 2027, Counterpoint said.
Foldable smartphones continue to see strong growth, even though they are some of the most expensive handsets on the market.
Globally, Samsung, which pioneered the foldable category with its first such device in 2019, will be Apple's main rival.
But in China, Apple will compete against a host of players, led by Huawei, which accounts for more than two-thirds of the foldable market in the country.
Shah said "aspiring Chinese consumers" are likely to want Apple's latest device.
"We will see lots of upgrades from the existing install base in China happening toward the foldable iPhone," Shah said.
After Samsung's latest foldable release in July, there will be plenty of options for consumers to pick from.
"This is not an innocent decision by these vendors," Francisco Jeronimo, a vice president at IDC covering mobile devices, told CNBC.
"They knew Apple was coming up with a foldable, so they're trying to get ahead and, more importantly, trying to make sure that when the Apple products hit the stores, their product is there so consumers can compare."
Huawei and Xiaomi chips
Huawei and Xiaomi this week touted their own self-designed chips in their foldables.
Xiaomi said the Xiaomi 18 Fold is powered by the XRing O3, its latest smartphone processor, manufactured on an advanced process.
Huawei said its Mate XT2 is the first device to feature a new semiconductor technique it calls LogicFolding, which is designed to move electrical signals on a chip.`,
    bodyJa: `Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/09/08/xiaomi-huawei-apple-foldable-iphone.html",
    publishedAt: "2026-09-08T16:11:25+00:00",
    category: "テクノロジー",
    imageUrl: "https://images.unsplash.com/photo-1518770660439-4636190af475?w=800&q=80",
    readTime: 2,
  },
  {
    id: "heathrow-and-gatwick-among-airports-hit-64ef8477",
    title: "Heathrow and Gatwick among airports hit by air traffic control problems",
    titleJa: "航空管制の問題に見舞われた空港の中にヒースロー空港とガトウィック空港がある",
    summaryJa: "航空管制の問題に見舞われた空港の中にヒースロー空港とガトウィック空港がある- 公開されました",
    bodyOriginal: `Heathrow and Gatwick among airports hit by air traffic control problems
- Published
Flights from airports in the UK and Ireland are being heavily disrupted by a technical problem affecting the air traffic control provider Nats.
Around 300 flights have been cancelled, according to tracking website FlightRadar24. British Airways and Ryanair have both confirmed cancellations.
Nats said just before 17:00 BST that its flight systems were starting to recover.
...
At Heathrow, departures were initially paused around lunchtime. Traffic then resumed, before facing further disruption in the afternoon. It is understood that very few flights are currently taking off.
Gatwick said it was currently being affected by the issue, along with other airports. Easyjet, the airport's largest carrier, confirmed it was being affected, and while the situation was fluid cancellations were to be expected.
Passengers have been advised to contact their airlines to check the status of their flights.
East Midlands has also been affected by the issue, while Manchester Airport warned that some departing flights could be delayed. Passengers have been advised to contact their airlines to check the status of their flights.
Belfast's two airports have both advised passengers to check flight information. The City of Derry Airport said it had experienced some cancellations and delays.
In a statement, Nats said it was investigating an issue in its flight processing system, which it said was causing some disruption to flight departures.
Engineers were on site, it said, and it was "working urgently to resume normal operations as quickly as possible".
The organisation apologised for the delays caused and advised passengers to check the status of their flight with their airline. Nats said it would provide updates on www.nats.aero and X.
Transport Secretary Heidi Alexander said she was aware of the situation., and realised it would be frustrating for passengers.
Phil White from Bexhill told BBC Your Voice that his flight to Lanzarote boarded on time but has been sitting on the tarmac at Gatwick for hours.
...
Edinburgh Airport said in a post on X that the issue might affect its operations, while Dublin and Cork airports in Ireland are also experiencing delays.
British Airways said in a statement on its website that passengers should travel to the airport as normal if they have not been contacted by the airline directly. It added that the situation was "entirely out of our control".
Ryanair said affected passengers would be notified.
Get in touch
Have your travel plans been disrupted? Share your experience.`,
    bodyJa: `航空管制の問題に見舞われた空港の中にヒースロー空港とガトウィック空港がある
- 公開されました
英国とアイルランドの空港からのフライトは、航空交通管制プロバイダーである Nats に影響を与える技術的問題により、大幅な混乱が発生しています。
追跡ウェブサイトFlightRadar24によると、約300便が欠航となった。ブリティッシュ・エアウェイズとライアンエアーはいずれも欠航を認めた。
ナッツは、英国標準時17時直前に、航空システムが回復し始めていると発表した。
離陸できる航空機が少なく、着陸が制限され、海外の空港から出発できない便も出ているとみられる。
ヒースロー空港では当初、昼休みの頃に出発が一時停止されていた。その後交通は再開したが、午後にはさらなる混乱に見舞われた。現在離陸している便は非常に少ないと思われます。
ガトウィック航空は、他の空港同様、現在この問題の影響を受けていると述べた。空港最大の航空会社イージージェットは影響を受けていることを認めており、状況は流動的だが欠航も予想される。
乗客は航空会社に問い合わせてフライトの運航状況を確認するよう勧められている。
イースト・ミッドランズもこの問題の影響を受けており、マンチェスター空港は一部の出発便が遅延する可能性があると警告した。乗客は航空会社に問い合わせてフライトの運航状況を確認するよう勧められている。
ベルファストの2つの空港はどちらも乗客にフライト情報を確認するよう勧告している。デリー市空港は、欠航や遅延が発生したと発表した。
ナスは声明で、フライト処理システムに問題があり、出発便に多少の混乱を引き起こしているとして調査を行っていると述べた。
エンジニアが現場におり、「できるだけ早く通常業務を再開するために緊急に作業している」と述べた。
同団体は遅延が生じたことを謝罪し、乗客に対し航空会社にフライト状況を確認するよう勧告した。 Nats は、www.nats.aero と X に関するアップデートを提供すると述べた。
ハイジ・アレクサンダー運輸長官は、この状況は承知しており、乗客にとってはイライラするだろうと認識していたと述べた。
ベクスヒルのフィル・ホワイトさんはBBC Your Voiceに対し、ランサローテ島行きの飛行機は定刻に搭乗したが、ガトウィック空港の駐機場で何時間も座ったままだと語った。
「レーダーが作動していないので離陸できないと言われました」とフィル氏は語った。
「十分快適だが、パイロットたちは20分ごとに、管制からの情報を待っているので、何か発見したら知らせてくれると言っていた。」
エディンバラ空港はＸへの投稿で、この問題が空港の運航に影響を与える可能性があると述べ、アイルランドのダブリン空港とコーク空港でも遅延が発生していると述べた。
ブリティッシュ・エアウェイズはウェブサイト上の声明で、乗客が航空会社から直接連絡を受けていない場合は通常通り空港に行くべきだと述べた。状況は「完全に制御不能」だと付け加えた。
ライアンエアは、影響を受ける乗客には通知すると述べた。
連絡する
旅行計画が中断されましたか?あなたの経験を共有してください。`,
    source: "BBC",
    sourceUrl: "https://www.bbc.co.uk/news/articles/ce8x3dp1zpxo?at_medium=RSS&at_campaign=rss",
    publishedAt: "2026-09-08T16:02:38+00:00",
    category: "マクロ経済",
    imageUrl: "https://ichef.bbci.co.uk/ace/standard/240/cpsprodpb/09a1/live/58e34b40-ab8f-11f1-aa04-efbf6a882854.jpg",
    readTime: 3,
  },
  {
    id: "u-s-sanctions-iranian-airlines-in-aim-to-ed20f94b",
    title: "U.S. sanctions Iranian airlines in aim to tighten economic squeeze as war spreads, oil rises",
    titleJa: "Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.",
    summaryJa: "Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.",
    bodyOriginal: `The Treasury Department on Tuesday sanctioned 27 Iranian airlines and a handful of other entities as part of its ongoing effort to isolate Iran's economy.
...
When CNBC asked on Tuesday's press call for evidence in the Iranian economy to show the pressure campaign is working, the Treasury official said there is anecdotal evidence and other information that can't be publicly shared but did not provide specifics.`,
    bodyJa: `Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/09/08/us-sanctions-iran-airlines-oil-economy-war.html",
    publishedAt: "2026-09-08T15:58:36+00:00",
    category: "エネルギー",
    imageUrl: "https://images.unsplash.com/photo-1473172367879-2dca04a4dca4?w=800&q=80",
    readTime: 2,
  },
  {
    id: "qualcomm-issues-amazon-warrants-to-acqui-921698a5",
    title: "Qualcomm issues Amazon warrants to acquire $4 billion worth of chipmaker's stock as part of AI infrastructure deal",
    titleJa: "Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.",
    summaryJa: "Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.",
    bodyOriginal: `Qualcomm shares rose 4% on Tuesday after the company announced a data center infrastructure partnership with Amazon Web Services, a major win as the chipmaker tries to take on Nvidia in the artificial intelligence market.
As part of the agreement, Qualcomm said in a filing with the Securities and Exchange Commission that it issued Amazon warrants to acquire 25 million shares in the company at $161.26 apiece for a total investment of $4 billion.
...
WATCH: Qualcomm partners with AWS`,
    bodyJa: `Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/09/08/qualcomm-amazon-data-center-infrastructure-deal.html",
    publishedAt: "2026-09-08T15:56:46+00:00",
    category: "エネルギー",
    imageUrl: "https://images.unsplash.com/photo-1473172367879-2dca04a4dca4?w=800&q=80",
    readTime: 2,
  },
  {
    id: "borrowers-expecting-mortgage-rates-to-dr-025ae087",
    title: "Borrowers expecting mortgage rates to drop have hopes dashed",
    titleJa: "住宅ローン金利の低下を期待していた借り手の期待は打ち砕かれた",
    summaryJa: "住宅ローン金利の低下を期待していた借り手の期待は打ち砕かれた- 公開されました",
    bodyOriginal: `Borrowers expecting mortgage rates to drop have hopes dashed
- Published
...
Someone on a typical two-year deal, and borrowing £250,000 is likely to pay £120 more a month in mortgage repayments than they would have had they secured the deal at the start of March when the US-Israeli strikes began, according to Moneyfacts.
...
Related topics
- Published1 day ago`,
    bodyJa: `住宅ローン金利の低下を期待していた借り手の期待は打ち砕かれた
- 公開されました
英国のほぼすべての主要な住宅ローン貸し手は、ここ数日で住宅ローンコストの値上げを発表した。
アナリストらは、今後さらなる取引があるかどうかについては不透明だが、新たな取引を見つける必要がある人々には今すぐ行動を起こすよう呼び掛けている。
5年契約が終了に近づいている人は、同じ金額を借りた場合、通常の金利で次の契約で年間5,000ポンド以上多く支払うことになる。
多くの金融機関は、現在の契約が終了する6か月前に新しい契約を固定することを許可しており、契約が開始される前にコストが下がった場合には切り替える機会が与えられます。
金融情報サービス、マネーファクトのレイチェル・スプリングオール氏は「住宅ローン金利が今後数週間で低下すると予想していた借り手は、その期待を打ち砕かれた」と述べた。
「住宅ローンの迷路を乗り越えるためには、借り手が遅滞なくアドバイスを求めることが依然として重要である。」
借り手にとって、固定住宅ローンの金利は、通常 2 年または 5 年後の期限が切れ、代わりに新しい住宅ローンが選択されるまで変わりません。住宅所有者と購入者の大多数はこの種の住宅ローンを組んでいます。
イラン戦争が始まって以来、世界経済の不確実性により取引コストが上昇している。
イングランド銀行のアンドリュー・ベイリー総裁は財務委員会の議員らに対し、紛争が始まって以来、日本を除けば英国の借り手は主要経済大国のG7グループの他の国々よりも住宅ローン金利の最大の上昇を経験していると述べた。
Moneyfactsによると、典型的な2年契約で25万ポンドを借りている人は、米国とイスラエルのストライキが始まった3月初めに契約を結んでいた場合よりも、月に120ポンド多く住宅ローン返済を支払うことになる可能性が高いという。
最近では英国政府の借入コストが上昇しており、住宅ローン金利に波及的な影響を及ぼしている。
この圧力は、火曜日に行われた英国による最新の国債売却でも維持された。英国が発行した３０年債は利回り（金利）５．８２％で売却され、１９９８年以来の高水準となった。
この状況を受けて、いくつかの大手金融機関がここ数日で金利を引き上げた。
ブローカーＬ＆Ｃのデビッド・ホリングワース氏は「難しいのは、これが終わりなのか、それとも単なる第１弾の値上げなのかを知ることだ」と述べた。
証券会社トリニティ・ファイナンシャルのアーロン・ストラット氏は、「これで利上げがしばらく終息することを願うが、確かに保証はない。
「住宅ローン価格の小規模な値上がりが複数重なり、最終的には人々の住宅購入を思いとどまらせることになる。」
潜在的な買い手と借り手は、早めにアドバイスを求め、計画を立てることが求められています。
イングランド銀行の最新外部データは、より多くの買い手が少額の預金でローンを利用しており、金利変動の影響をより受けていることを示しています。
ローンが住宅価格の90％を超える住宅ローンの割合は、18年間で最高水準に達した。
住宅ローン金利に関する最近の動きは、はるかに安い5年契約を結んでいる人々にとってはさらなる打撃となるだろう。
しかし、金利は近年のピークにはまだ程遠く、人々がどれくらいの金額を、どのような金利で借りられるかは、その人の状況によって大きく異なります。
マネーファクトによると、火曜日の時点で、新規２年契約の平均金利は５．６５％だった。 5 年間の製品では、平均は 5.70% でした。
連絡する
今後数か月以内に住宅ローンの借り換えを検討していますか?
関連トピック
- 1 日前に公開`,
    source: "BBC",
    sourceUrl: "https://www.bbc.co.uk/news/articles/c770v7y63r0o?at_medium=RSS&at_campaign=rss",
    publishedAt: "2026-09-08T15:19:43+00:00",
    category: "金融政策",
    imageUrl: "https://ichef.bbci.co.uk/ace/standard/240/cpsprodpb/f1d8/live/c8999ac0-ab71-11f1-9712-a14d469bace4.jpg",
    readTime: 4,
  },
  {
    id: "here-s-where-rental-demand-is-heading-an-a0a0bcb9",
...
分譲住宅市場の価格は低迷する兆しが見えず、購入を控える賃貸人が増えている。そして、家賃も再び上昇し始めており、より多くのテナントがより安価な市場に移転している。
ニューヨーク州バッファロー。シカゴ;不動産掲載サイトによると、Zillowでの市外検索数が最も伸びているのはヒューストンで、次いでニューオーリンズとダラスだという。ソルトレイクシティのようにすでに大幅な人口流入が見られる市場では。ノースカロライナ州ローリー。コネチカット州ハートフォード。そしてテネシー州ナッシュビル。 Zillowによると、市外の検索数が地元の検索数を上回っていることが判明した。
賃貸需要は通常、住宅販売の先行指標となります。
Zillowの首席エコノミスト、ミーシャ・フィッシャー氏はリリースで「賃貸は、人々が契約する前に新しいコミュニティを試してみる方法であることが多い。地下鉄以外からの賃貸検索の割合が増加している市場を見ると、パイプラインが発展していることを示唆している」とリリースで述べた。 「バッファローやシカゴなどの市外での閲覧数が前年比で急増していることから、新規参入者の波が遠くない可能性があることがわかります。」
賃貸人の関心が最も高い市場では、住宅価格も下がっています。全米不動産業者協会によると、7月に販売された中古住宅の全国価格中央値は43万4100ドルだった。
Realtor.comによると、バッファロー、シカゴ、ヒューストンはいずれも中央値が低いという。
ほとんどの市場での供給の増加により、賃料はここ数年低下傾向にありましたが、現在は再び上昇傾向にあります。アパートメントリストによると、8月の賃料は4年ぶりに前月比プラスに転じたが、それでも2025年8月よりはわずかに低かった。
Zillow での市外の賃貸検索のほとんどは近隣の州からのものですが、唯一の例外はニューヨーク市です。 Zillowによると、当地の賃貸人は引き続きサンベルト地区の物件を探しており、ローリーやフロリダ州のマイアミ、オーランド、タンパの都市で閲覧数の大きなシェアを占めているという。
「市外からの強い関心が小規模市場に流入しているのを見ると、それはしばしば手頃な価格の話である。そのため、より高価な場所の賃貸人は、新しい場所でより多くのお金が得られることを選択または発見している」とフィッシャー氏は述べた。 「流れが反対方向、つまり大都市圏に向かうとき、それは多くの場合、地域の吸引力であり、人々は大都市の雇用市場や近くの機会に引き寄せられます。」
パンデミック中およびパンデミック後に南部への大規模な移住にもかかわらず、これらの市場は依然として東海岸や西海岸よりも手頃な価格であるため、その流れは続いています。ライフスタイルと手頃な価格の両方が決定に影響します。
実際、RentCafe の「賃貸人に最適な都市」の上位 50 都市のうち 37 都市が南部にあります。上位 3 都市はテキサス州マッキーニーです。アラバマ州ハンツビル。そしてテキサス州オースティン。このランキングは、とりわけ生活費、賃貸収入の伸び、雇用の伸びなどを考慮しています。`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/09/08/rental-demand-home-sales-zillow-report.html",
    publishedAt: "2026-09-08T15:19:43+00:00",
    category: "マクロ経済",
  ...
  {
    id: "astrazeneca-s-copd-drug-scores-two-late-b8ddec91",
    title: "AstraZeneca's COPD drug scores two late-stage trial wins as full data boosts blockbuster hopes",
    titleJa: "Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.",
    summaryJa: "完全なデータは、この薬が画期的なCOPD治療薬となり、アストラゼネカのピーク時の年間売上高予測である50億ドル以上を達成できるという期待を裏付けるものとなった。",
    bodyOriginal: `AstraZeneca on Tuesday released full results from two successful late-stage trials on its experimental drug for chronic obstructive pulmonary disease, boosting hopes that it could generate multibillion-dollar sales for the company.
...
The treatment reduced moderate and severe COPD flare-ups in the primary population of former smokers by 29% and 34%, respectively, compared with a placebo on top of the current inhaled standard of care. The drug also reduced moderate and severe flare-ups in a larger overall population of current and former smokers by 30% and 29%, respectively, compared with the placebo group.
...
Dobber said the drug is currently under regulatory review for the treatment of COPD in major markets, including the European Union and China. It is also being studied in a Phase 2 trial in severe asthma and Phase 3 study in severe viral lower respiratory tract disease.
...
He said he hopes the attention around the new data will help raise awareness of COPD as a serious disease and spur broader efforts to reduce the factors that contribute to it.`,
    bodyJa: `アストラゼネカは火曜日、慢性閉塞性肺疾患の治験薬に関する2つの成功した後期試験の完全な結果を発表し、同社に数十億ドルの売上を生み出す可能性があるとの期待が高まった。
生物学的製剤であるトゾラキマブは食品医薬品局による優先審査中であり、米国での承認は2027年第1四半期に予定されている。この薬は4週間に1回投与され、この症状を患う幅広い人々の再燃を軽減するのに役立った。
アストラゼネカのバイオ医薬品事業部門の社長、ルート・ドバー氏はインタビューで、「多くのCOPD患者がこの新薬の恩恵を受けられると心から信じている」と語った。
この治療法は、現在の吸入標準治療に加えてプラセボを投与した場合と比較して、元喫煙者の主要集団における中等度および重度のCOPDの再燃をそれぞれ29%および34%減少させた。この薬はまた、プラセボ群と比較して、現在および元喫煙者のより大きな集団全体における中等度および重度の再発をそれぞれ30%および29%減少させた。
詳細なデータは、この製品が気流を遮断して呼吸困難を引き起こす進行性の肺疾患であるCOPDの画期的な治療法となる可能性があるという期待を裏付けるものである。アストラゼネカによると、診断されている人も診断されていない人も含めて推定1,600万人から2,600万人のアメリカ人がCOPDを患っており、この疾患は米国の死因の第5位となっている。
アストラゼネカは最近、この薬のピーク時の年間売上高予測を50億ドル以上に引き上げ、これにより同社は2030年までに全体の収益目標である800億ドルを達成できる可能性がある。最高経営責任者（CEO）のパスカル・ソリオ氏はCNBCとのインタビューで、この薬には幅広い患者グループを獲得する機会があると語った。
「満たされていないニーズが非常に大きいという理由だけで、その額は50億を超える可能性があると考えています」とソリオ氏は語った。 「患者の診断は過小評価されており、より適切な診断が必要であり、このクラスの生物学的製剤はまったく使用されていません。おそらく患者の 10% が生物学的製剤を受けています。喘息は国によって異なりますが 30% から 40% です。したがって、成長の可能性が非常に大きいことが想像できます。」
この薬に対する楽観的な見通しは、好酸球と呼ばれる白血球のレベルが高い患者に限定されている現在利用可能なCOPD用生物学的製剤であるデュピクセントとヌーカラよりも多くの患者にこの薬が投与できる可能性があるという事実によってもたらされている。
RegeneronとSanofiのDupixentは世界で最も売れている医薬品の1つであり、GSKのNucalaは昨年COPD市場に参入した。
ミシガン保健大学の呼吸器・救命救急部門の責任者であり、この研究の研究者の一人であるメイラン・ハン博士は、「現在承認されている2つの薬剤の生物学的製剤の候補ではない患者が依然として膨大な数に存在する」と述べた。
ドバー氏は、アストラゼネカの薬は「幅広い用途があるため、治療パラダイムを大きく変える可能性がある」と付け加えた。
アストラゼネカのトゾラキマブに関する2件の試験には、元喫煙者と現在の喫煙者の両方、そしてすべての血中好酸球数と肺機能の重症度のすべての段階の患者が参加した。
現在、血中好酸球数が150未満の患者に利用できる生物学的COPD薬はない、とドバー氏は述べた。主要な臨床ガイドラインでは、好酸球数が低い患者、特に 100 ～ 150 未満の患者は、一般に吸入療法に反応する可能性が低いことを示していると述べています。
分析によると、この薬は、その一部の患者では中等度および重度の再燃を23％、血中好酸球数が150以上の人々では34％、300以上の人々では43％減少させた。
アストラゼネカの薬は、COPDの根本的な疾患要因の2つである炎症と粘液生成を促進するIL-33と呼ばれるタンパク質をブロックすることによって作用する。いくつかの企業がIL-33治療法を追求しましたが、成功は限られており、一部の投資家や研究者はその可能性に疑問を抱いています。
「トゾラキマブは誰も効果があるとは考えていなかった製品だ。われわれ自身も成功の可能性は非常に低かった」とソリオ氏は同社の第２四半期決算会見で述べた。 「誰もが失敗すると思っていた。決算発表前のコンセンサスを見てみると、コンセンサスの予想はほぼゼロだったが、実際はうまくいった。」
Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/09/08/astrazeneca-copd-drug-tozorakimab-shows-positive-late-stage-trial-results.html",
    publishedAt: "2026-09-08T15:09:35+00:00",
    category: "マクロ経済",
    imageUrl: "https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?w=800&q=80",
    readTime: 5,
  },
  {
    id: "argentina-to-file-criminal-case-against-8c1f9de7",
    title: "Argentina to file criminal case against oil company operating in Falklands",
    titleJa: "アルゼンチン、フォークランドで操業する石油会社を刑事告訴へ",
    summaryJa: "アルゼンチン、フォークランドで操業する石油会社を刑事告訴へ- 公開されました",
    bodyOriginal: `Argentina to file criminal case against oil company operating in Falklands
- Published
...
Related topics
- Published3 days ago`,
    bodyJa: `アルゼンチン、フォークランドで操業する石油会社を刑事告訴へ
- 公開されました
アルゼンチン政府は、フォークランド諸島沖で操業している石油会社ナビタス・ペトロリアムを刑事告発すると発表した。
この動きは、アルゼンチンのハビエル・ミレイ大統領が、大西洋南西部の英国の海外領土で掘削を行っている石油会社を制裁すると発表した数日後に行われた。
このニュースを受けて、カースティ・マクニール外務大臣は、英国政府のフォークランド諸島住民に対する取り組みに「疑いの余地はない」と主張した。
この諸島の主権は、1982年にこの領土に侵入したアルゼンチン軍を英国軍事機動部隊が排除してから40年以上経った今でも英国とアルゼンチンの間で係争が続いている。
マクニール氏は火曜日に下院で演説し、「炭化水素の生産を追求するというフォークランド諸島政府の決定は、関係する営利企業とともに彼らがとるべき商業的決定である」と述べた。
彼女は「フォークランド諸島の将来はフォークランド諸島民が決めることだ」と付け加えた。
フォークランド諸島をめぐって英国とアルゼンチンの間でくすぶっていた論争は先週、ミレイ氏が国民向けの演説で「変化の風」がアルゼンチンのフォークランド諸島に対する領有権を支持していると述べ、さらに激化した。
ミレイさんは過去に、アルゼンチン人がラス・マルビナスと呼ぶフォークランド諸島に対して「甘すぎる」と1982年の紛争のアルゼンチン退役軍人らから批判されてきた。
現地時間木曜夜の演説でミレイ氏は、「マルビナス家は歴史的にも法的にもアルゼンチン人である…それについては議論の余地はない」と述べ、この領土に関する政府の立場を改めて述べた。
大統領は、列島での石油掘削はアルゼンチンの主権に対する「明白かつ差し迫った危険」であると述べた。
同氏はまた、島民の99.8％がフォークランド諸島が英国の管轄区域に残ることに賛成票を投じた2013年の住民投票の結果を否定した。
ミレイさんは、自分たちはイギリス人に「強奪」された土地に住んでおり、したがって「正当な民族自決権はない」と主張した。
英国政府はミレイ氏の演説を却下し、フォークランド諸島に対する英国の立場は「揺るぎない」と強調した。
ミレイ氏のゴールデンタイムのスピーチは失敗だったのではないか、英国との外交関係を強化するという以前の姿勢に戻るのではないかという期待は月曜日に打ち砕かれた。しかし月曜日、同氏の事務所がナビタス・ペトロリアムとその子会社数社、およびその幹部らを刑事告発すると発表した。
テルアビブに上場しているナビタスは、2028年に北フォークランド盆地で生産開始予定の海洋石油プロジェクトであるシーライオンの株式の65％を保有している。
フォークランド諸島から約 130 マイル (209 km) の場所にあるシーライオン油田には、推定 17 億バレルの石油が埋蔵されています。
ミレイ氏は月曜の声明で、この地域での掘削はアルゼンチン当局の承認なしで資源開発を禁止するアルゼンチンの法律に違反すると主張した。
「国家はアルゼンチン共和国の主権を侵害するあらゆる行為に対抗するために必要と思われる行動を追求し続ける」と声明は主張した。
ナビタス社はこの最新の声明に対してまだ返答していないが、先週、ミレイ氏の発言は「プロジェクトの開発完了までのスケジュールを含め、アシカ・プロジェクトの開発活動に重大な影響を与えることは予想されない」と述べた。
アシカプロジェクトの株式の一部を所有するロックホッパーも、ミレイの声明についてはまだコメントしていない。
両社は過去に、シーライオンがフォークランド諸島からの有効なライセンスを保有していると強調していた。
関連トピック
- 3 日前に公開`,
    source: "BBC",
    sourceUrl: "https://www.bbc.co.uk/news/articles/c8jd14glvneo?at_medium=RSS&at_campaign=rss",
    publishedAt: "2026-09-08T11:09:54+00:00",
    category: "エネルギー",
    imageUrl: "https://ichef.bbci.co.uk/ace/standard/240/cpsprodpb/f822/live/55e4d820-ab6a-11f1-9712-a14d469bace4.jpg",
    readTime: 4,
  },
];
