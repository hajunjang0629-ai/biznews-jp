...
— CNBC の Anniek Bao がこのレポートに寄稿しました。`,
  ...
  {
    id: "overcooked-why-robotic-pizza-makers-are-70783737",
    title: "Overcooked? Why robotic pizza makers are failing",
    titleJa: "加熱しすぎですか？ロボットピザメーカーが失敗する理由",
    summaryJa: "Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.",
    bodyOriginal: `Overcooked? Why robotic pizza makers are failing
- Published
...
- Published12 June
- Published26 June`,
    bodyJa: `加熱しすぎですか？ロボットピザメーカーが失敗する理由
- 公開されました
「生地フィーダー」。ソースとチーズのモジュール、ペパロニスプリンクラーも。全員がじっと横たわっていた。
今はなきロボットの二人組が、シアトルのモト・ピザ・レストランでピザを量産していたはずだった。
しかし、5月にサプライヤーのピクニック社が突然閉鎖され、このペアは「基本的に役に立たなくなった」。その瞬間、ロボットに対する外部の技術サポートは消滅した、とモト・ピザの創設者兼最高経営責任者、リー・キンデル氏は語る。
彼は、16 万ドル (11 万 8,000 ポンド) のキャビネットのような機械をどうするか、ピザボットを購入する価値があるのか​​どうか疑問に思いました。
「失敗したので、もう一度パートナーシップをやりたいかどうかわかりません」と彼は言う。
ロボットピザ製造ビジネスには、行き過ぎた約束や財産を溶かすという残念な話が散りばめられているのは事実だ。 Picnic 以外に栄えては消えていった企業には、ピザの組み立てに外部ロボット アームを使用した Zume (external) や Pazzi のほか、ピザの自動販売機を提供する Basil Street (external) などがあります。
いわゆるファストフードは自動化のターゲットになりやすいように思えるかもしれませんが、多くの予想よりも難しいことが証明されています。さらに、ピザレストランにロボットを導入すると、接客業の初心者レベルの仕事が奪われる可能性があります。未来は本当にロボットピザで満たされるのでしょうか?
バンク・オブ・アメリカのシニア・レストラン・アナリスト、サラ・セナトーレ氏は「一部の人々が期待していたような成功事例が現実化した例はまだ見ていない」と認める。彼女の雇用主は、パパ・ジョンズやドミノ・ピザを含む複数のハイストリート・ピザ・チェーンに経済的利権を持っている。
食事準備ボットは時々不器用で、材料を間違った場所にドロップしてしまうこともあると彼女は説明します。逆に言えば、「人間はピザを作るのに非常に効率的です。」
しかし、キンデルはピクニックに対する不満にもかかわらず、驚くほどひるまない。彼は完全自動化のファンです。 「たとえば、ある種のキオスクまで歩いて行き、注文を入れると、焼きたてのピザが作られるようにしたいのです」と彼は BBC に語った。
キンデルさんは、かつては生地をすべて手作業で作っていたが、肘の腱を負傷して代わりに機械を使って研究することになったが、現在は独自バージョンのピザ作りロボットの開発に取り組んでいる。
同氏は詳細については明かすことを拒否したが、この装置は四角いパン型のパイを作るもので、この機械は3Dプリンターの仕組みからインスピレーションを得たものだという。順調に行けば、2027年の夏までにこの装置の完全運用バージョンが完成する可能性があると同氏は言う。
彼がロボット工学に「経験がない」と認めていることを考えると、なぜ彼がそのような危険なビジネスに投資したいのか疑問です。キンデル氏は、失敗したピザロボット会社はそれでも有益なデータを生成し、技術開発で進歩を遂げたと述べた。誰かがこれらのことを実現させるのは時間の問題だと彼は主張する。
仕事に関しては、「完全自律型」のピザロボットでも労働者を脅かすことはないと主張する。キンデル氏は以前、野球チーム、シアトル・マリナーズの本拠地であるTモバイル・パークでピクニックのロボットを使用していた。
通常、このような設備でピザを作るには約 10 人が必要です。ロボットの場合、その数はわずか 2 つに減りました。しかし、残りの8人はまだ雇用されており、顧客と交流したり、スタジアム周辺でピザを宣伝したりする役割を担っていた、と彼は言う。
「ピザを配れる人がもっとたくさんいました」とキンデルさんは言います。 「とても速かったです。」
一部のピザロボットエンジニアにとって、スピードは確かにモチベーションの源です。昨年、オハイオ州のジョン・グレン・コロンバス国際空港に、カナダ企業アペトロニクスがドナトスピザチェーン向けに年中無休のロボットピザユニットを設置した。
Appetronix は、猛烈なスピードでピザを組み立てると主張するテクノロジーの新しいバージョンに取り組んでいます。共同創設者兼最高経営責任者のニプン・シャルマ氏は、最終的にはそのような機械からピザが「毎分」滑り出てくるようにするのが目標だと語る。
この目的を達成するために、彼のチームは、現在必要とされている 9.5 秒よりもはるかに速く、ピザのベースにソースを塗布する方法を研究しています。 「1.5秒でソースを噴射するシャワーヘッドだと考えてください」とシャルマ氏は言う。
同社は、ピザをスライスする従来のナイフの刃よりも高速な方法として、レーザーと超音波の研究も行っています。
しかし、多くの人は手作りのピザを楽しんでいると思います。夕食を作る機械は、私たちが食べ物に対して感じる人間的なつながりを奪い去ってしまうのではありませんか? 「私たちが狙っているのはチェーン市場です」とシャルマ氏は答える。 「ピザはいつでも同じ味にしたいですよね。」
Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.`,
    source: "BBC",
    sourceUrl: "https://www.bbc.co.uk/news/articles/czxq0wgkkdjo?at_medium=RSS&at_campaign=rss",
    publishedAt: "2026-08-27T23:16:02+00:00",
    category: "金融政策",
    imageUrl: "https://ichef.bbci.co.uk/ace/standard/240/cpsprodpb/fd79/live/5ce07230-8f43-11f1-b8ee-9b3c26ad07bb.jpg",
    readTime: 6,
  },
  {
    id: "military-veterans-told-they-owe-thousand-f7609d9c",
    title: "Military veterans told they owe thousands of pounds over clerical error",
    titleJa: "退役軍人らは事務上のミスで数千ポンドの借金があると語る",
    summaryJa: "退役軍人らは事務上のミスで数千ポンドの借金があると語る- 公開されました",
    bodyOriginal: `Military veterans told they owe thousands of pounds over clerical error
- Published
...
- Published3 days ago`,
    bodyJa: `退役軍人らは事務上のミスで数千ポンドの借金があると語る
- 公開されました
数百人の元軍人が、事務上のミスを理由に数千ポンドの返済を求める手紙を受け取り、年金を減額された。
国防省（MoD）はBBCに対し、1000人以上の退役軍人が債務の追及を受けていることを認めた。大半の退役軍人335人は、国民保険の誤った計算の結果、総額510万ポンドの過大な支払いを受けていた。
軍人年金協会は、正式な苦情を申し立てた後に借金が帳消しになった少数の退役軍人を把握していると述べた。
レイ・ロートンさん（70歳）は、6年間の過払いの末、7月に8,000ポンドの借金があると告げられた。数日後、彼の月額軍人年金は550ポンドから365ポンドに減額された。
「支払える8,000ポンドがない」と王立砲兵隊で16年間勤務したロートン氏は語った。
「少しは取っておきましたが、それほど多くはありません。」
ポーツマスを拠点とする退役軍人はBBCに対し、「私は退役したときもずっと軍を信頼しており、自分の年金も適切なものになると信じていた。その後この手紙が来て、すべてが吹き飛ばされた」と語った。
ロートン氏の書簡は、国防省に代わって年金制度を管理するエクイニティという会社から送られてきた。
システムのエラーにより、何年にもわたって過大な報酬が支払われていたと同社は述べた。
ロートンさんは、借りていることを知らなかったお金を要求する手紙を突然受け取った後、英国全土からBBC Your Voiceに連絡した多くの退役軍人の1人です。
退役軍人を支援する非営利団体である軍人年金協会は、数万ポンドに達する過払い事件が多数あることを認識していると述べた。
少数の退役軍人は6桁の借金を負っていると言われている。
国防省は、国民保険の調整、年金共有命令（PSO）、早期出発支払い（EDP）および州年金受給年齢（SPA）に関する誤りを確認した。問題をケースバイケースで調査しているとしている。
同報告書は、国民保険の誤りで影響を受けた退役軍人335人のうち、3分の1が借金を全額返済し、52人が合意された返済計画を立てていると付け加えた。これまでに510万ポンドのうち30万4000ポンドが返済されている。
退役軍人らは、債務とその計算方法についてもっと明確にしてほしいと述べた。消去するよう求める声もある。
政府は資金を回収する責任があると述べた。
国防省の広報担当者はBBCに対し、年金支払いの誤りが「不確実性を引き起こす可能性がある」と認識していると述べ、退役軍人に連絡し、「支援を必要とする人には支援を提供している」と付け加えた。
「支払いが真の誤りで行われた場合、我々には納税者の資金を回収する責任があり、常に慎重かつ適切な方法で回収するよう努める」と広報担当者は付け加えた。
しかし、元保守党国防長官ペニー・モーダント氏は、「公的機関には財政的に合理的であれば、そのような費用を回収する義務があるが、これらのケースではそのような評価は行われていない」と述べた。
「多くの場合、債務を帳消しにしなければならないやむを得ないケースがある。」
「まったく壊滅的だ」
ロートン氏は納税者にツケを巻き上げてほしくない。年金が本来あるべき水準まで減額されることには満足しているが、民間企業は自分たちの間違いだと考えている請求額を返金すべきだと考えている。
「私のせいではないので、彼らが責任を取るべきだと思います。」
トゥルーロでは、アンドリュー・ソーバーンも同意する。
彼はイギリス海軍に 36 年間勤務し、26,438 ポンドの借金があると言われています。その結果、彼の年金は月額約650ポンド削減された。
「彼らが今『はい、私たちはこの間違いを犯しましたが、あなたはその代償を払うつもりです』と言っているのは卑劣なことだと思います。どうして政府を許せるでしょうか？」
同氏は「金融ショックは完全に壊滅的であり、今も続いている」と語った。
「闘争」
イギリス空軍退役軍人バリー・グッドウィン氏は6年前、予想よりも高額な報酬を受け取った後、エクイニティに連絡を取った。
変更の理由は国民年金受給年齢に達したためだと言われた。その後、彼は32,188ポンドを払いすぎたので返さなければならないと通告された。
「確認したところ、すべて正しいので返済しなければならないと言われました」と彼は語った。 「私はすでに贅沢品を減らしています。私は孫の一人を保育園で手伝っていましたが、それは変わらなければなりませんでした。
「借金が免除されないと、本当に困ります。」
エクイニティはBBCに対し、個別の事件については議論できないが、年金受給者に懸念を与えていることは認識していると語った。
広報担当者は、納税者の​​資金を取り戻す決定には責任はないが、「この規模の計画の管理には、長年にわたる複数の組織、システム、プロセスが関与する」と述べた。
テクノロジー企業のソプラ・ステリアは2023年から退役軍人年金制度を担当しており、その管理をエクイニティに下請けしていた。
ソプラ・ステリアの広報担当者はBBCに対し、「不正確な年金支払いにつながる誤りは、ソプラ・ステリアが契約を引き継ぐ10年以上前に発生した」と語った。
同社は「長期にわたって堅牢な安全策が確実に実施されるよう、国防省およびエクイニティと緊密に連携している」と述べた。
軍年金協会は、過払い通知書を受け取った人に対し、その信憑性を確認し、エクイニティに詳細情報を要求し、内部紛争手続きを通じて苦情を申し立てる権利を利用するようアドバイスしている。
追加レポート: アダム・クラークソンとエレイン・ドーラン
連絡する
...
- 3 日前に公開`,
    ...
    publishedAt: "2026-08-27T23:06:22+00:00",
    category: "マクロ経済",
    imageUrl: "https://ichef.bbci.co.uk/ace/standard/240/cpsprodpb/2a26/live/e0fbfd20-a2bf-11f1-a291-b542ee92de7c.png",
    readTime: 6,
  },
  {
