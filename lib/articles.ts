...
export const articles: Article[] = [
  {
    ...
    summaryJa: "Dell Technologiesの株価は、このコンピュータメーカーがウォール街の予想を容易に上回る決算と予測を発表したことを受け、火曜日の時間外取引で8%上昇した。LSEGコンセンサスに対する同社の業績は次のとおりです。",
    bodyOriginal: `Dell Technologies shares moved 8% higher in extended trading on Tuesday after the computer maker reported results and a forecast that easily cleared Wall Street expectations.
...
"We are seeing a growing trend of customers that require meaningful CPU compute capacity to support AI and agentic workflows," Jeff Clarke, Dell's operating chief, said on a conference call with analysts. "These workloads are creating incremental demand for traditional servers."
...
WATCH: Piper Sandler's James Fish looks ahead to Dell earnings Tuesday`,
    bodyJa: `Dell Technologiesの株価は、このコンピュータメーカーがウォール街の予想を容易に上回る決算と予測を発表したことを受け、火曜日の時間外取引で8%上昇した。
LSEGコンセンサスに対する同社の業績は次のとおりです。
- 1 株当たり利益: 調整後 7.04 ドル、予想 4.92 ドル
- 収益: 469 億 7000 万ドル対予想 449 億 2000 万ドル
声明によると、7月31日に終了した会計年度第2四半期の売上高はあらゆる予想を上回り、前年同期比約58％増加した。純利益は41億3000万ドル（1株当たり6.34ドル）で、前年同期の11億6000万ドル（1株当たり1.70ドル）から増加した。調整後の利益には株式ベースの報酬の影響は含まれていません。
会計年度第 3 四半期について、デルは売上高 490 億ドルに対して調整後 1 株当たり利益を 6.50 ドルと見積もっていました。これは 81% の成長を意味します。 LSEGがまとめたアナリスト予想は1株当たり4.49ドル、売上高が414億2000万ドルだった。
デルは通期の見通しを少しずつ引き上げた。同社は現在、売上高1,920億ドルに対し、調整後の1株当たり利益は25.50ドルになると見込んでいる。 LSEGが実施したアナリスト調査では、1株利益が18.92ドル、売上高が1726億7000万ドルと予想されていた。 5月時点での同社の2027年のガイダンスには、調整後1株当たり利益が17.90ドル、売上高が1,650億～1,690億ドルとされていた。
火曜日の終値の時点で、デルの株価は年初から236％上昇しており、S&P500指数全体は同期間で11％上昇している。この株は、人工知能インフラストラクチャの継続的な成長に賭けたい投資家にとって人気の選択肢となっています。昨年大統領に復帰して以来、デル株を購入してきたトランプ大統領は7月、再びデル製コンピュータの購入を推奨した。
ブルームバーグの計算によると、同社の創設者、会長兼最高経営責任者（CEO）であるマイケル・デル氏は現在、世界で5番目に裕福な人物である。
データセンターハードウェアを対象とする同社のインフラストラクチャソリューショングループの第2四半期決算の売上高は317億8000万ドルで、89％増となり、StreetAccountが調査したアナリストのコンセンサスである296億1000万ドルを上回った。この部門では、デルは AI に最適化されたサーバーから 164 億ドルの収益を上げました。この金額はストリートアカウントのコンセンサスである160億7000万ドルを上回った。
ストレージ収益は 48 億 5,000 万ドルで、ほぼ 26% 増加しました。従来のサーバーおよびネットワーク機器からの収益は 122% 増加して 105 億 3000 万ドルになりました。
デルの執行責任者ジェフ・クラーク氏はアナリストとの電話会議で、「AIやエージェントワークフローをサポートするために有意義なCPUコンピューティング能力を必要とする顧客が増加傾向にあると見ている」と述べた。 「これらのワークロードにより、従来のサーバーに対する需要が増加しています。」
消費者および法人顧客に PC および付属品を販売する Dell のクライアント ソリューション グループは、150 億 3000 万ドルの収益に貢献しました。この数字は20％増加したが、StreetAccountのコンセンサスである150億8000万ドルをわずかに下回った。
同四半期中、デルは米軍にソフトウェアを提供する97億ドルの契約を受け取り、AI中心のクラウドインフラプロバイダーであるアイレンは、Nvidiaチップを搭載したサーバーを含むデルのハードウェアを16億ドルで購入することに同意したと発表した。
デルは現在、会計年度の AI に最適化されたサーバーの売上高が 200% 増となる 740 億ドルになると予測しています。わずか 6 か月前、同社は 103% の成長を予測していました。
注目: パイパー・サンドラー氏のジェームス・フィッシュ氏が火曜日のデルの決算を展望`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/09/01/dell-q2-earnings-report-2027.html",
    publishedAt: "2026-09-01T20:53:33+00:00",
    category: "テクノロジー",
    imageUrl: "https://images.unsplash.com/photo-1518770660439-4636190af475?w=800&q=80",
    readTime: 4,
  },
  {
    id: "palo-alto-networks-beats-quarterly-estim-c943c88d",
    title: "Palo Alto Networks beats quarterly estimates on AI demand, continues acquisition spree",
    titleJa: "パロアルトネットワークス、AI需要で四半期予測を上回り、買収騒動が続く",
    summaryJa: "Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.",
    bodyOriginal: `Palo Alto Networks surpassed fiscal fourth-quarter estimates as mounting artificial intelligence risks boost demand for its cybersecurity tools.
Shares added about 2% in extended trading, following a 5% drop during regular trading.
...
Palo Alto also announced the acquisition of AI startup Console as it deepens its AI security offerings. In just over a year, Arora has accelerated an aggressive dealmaking push, which included a mega $25 billion deal for identity security firm CyberArk and the acquisition of Chronosphere for $3.4 billion.
...
For the full year, the company forecasted between $14.10 billion and $14.20 billion in revenue and adjusted EPS of $4.16 to $4.19. That surpassed the $13.79 billion revenue and $4.11 EPS forecast.`,
    bodyJa: `人工知能リスクの高まりにより、サイバーセキュリティ ツールへの需要が高まる中、パロアルトネットワークスは第 4 四半期会計年度の予想を上回りました。
株価は通常取引で５％下落した後、延長取引で約２％上昇した。
LSEG の見積もりに対する同社の実績は次のとおりです。
- 1 株当たり利益: 調整後 1.02 ドル、予想 98 セント
- 収益: 予想 33 億 5,000 万ドルに対し 34 億 1,000 万ドル。
同社によると、同四半期の売上高は前年同期の25億4000万ドルから34％増加した。パロアルトは、純損失が2億8,200万ドル（1株あたり35セント）となり、1年前の純利益2億5,400万ドル（1株あたり36セント）から減少しました。
AI攻撃の加速により、顧客はより優れた、より迅速なサイバー防御の構築を余儀なくされているとCEOのニケシュ・アローラ氏はCNBCに語った。こうした懸念はすでに大きく変化していますが、長期的な成長の滑走路はまだ初期段階にあります。
「これは長期的な追い風だ」と同氏は語った。 「それは 1 四半期で起こることも、2 四半期で起こることもありません。これは、当社のビジネスの成長率の観点から、長期的な期間を裏付けるものにすぎません。」
Anthropic の Mythos のような高機能 AI モデルの台頭により、エージェントによるサイバー攻撃を検出して対応するための新しいセキュリティ ツールの需要が高まり、パロ アルト ネットワークスの株価は今年 2 倍近くになりました。
OpenAI-Hugging Face ハッキングのような侵害により、エージェントが自律的に攻撃を計画し調整できることが増えていることが証明され、エージェント AI への懸念が加速しています。
しかし、AIセキュリティ競争の恩恵を受けるのはパロアルトだけではない。先週、顧客がより多くのサイバーツールに支出する中、クラウドストライクとオクタは好調な収益とガイダンスを受けて両社とも急騰した。
アローラ氏によると、パロアルトはAnthropic Mythosの立ち上げを受けて、前四半期に開示した約1,200件から増加し、2,000件以上の顧客説明会を開催したという。
パロアルトはまた、AIセキュリティ製品の深化に向けて、AIスタートアップのConsoleの買収も発表した。アローラはわずか 1 年余りで、アイデンティティ セキュリティ企業サイバーアークとの 250 億ドルという巨額の取引や、34 億ドルでのクロノスフィアの買収など、積極的な取引推進を加速させた。
「私はサイバースタートアップのエコシステムを、人々がさまざまなことを試している大規模な実験室だと考えている」とアローラ氏は述べ、パロの内部アプローチがうまくいかない場合は、この分野から買収することも検討できると付け加えた。
パロアルトは、第1四半期の売上高が33億～33億1000万ドルとアナリスト予想の32億2000万ドルを上回ると予想する明るい見通しを発表した。
通期については、売上高が141億ドルから142億ドル、調整後EPSが4.16ドルから4.19ドルになると予想している。これは売上高137億9000万ドル、EPS4.11ドルの予想を上回った。`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/09/01/palo-alto-networks-panw-q4-2026-earnings.html",
    publishedAt: "2026-09-01T20:53:23+00:00",
    category: "金融政策",
    imageUrl: "https://images.unsplash.com/photo-1611974789855-9c2a0a7236a3?w=800&q=80",
    readTime: 3,
  },
  {
    id: "palo-alto-networks-stock-climbs-as-deman-8825a2af",
    title: "Palo Alto Networks’ stock climbs as demand for AI cybersecurity powers an earnings beat",
    titleJa: "AIサイバーセキュリティへの需要が収益を押し上げる中、パロアルトネットワークスの株価は上昇",
    summaryJa: "CEO ニケシュ・アローラ氏によると、企業のサイバー脅威と AI の導入がパロアルトネットワークスに「永続的な追い風」を与えている",
    bodyOriginal: `Enterprise cyber threats and AI adoption are giving Palo Alto Networks ‘durable tailwinds,’ according to CEO Nikesh Arora`,
    bodyJa: `CEO ニケシュ・アローラ氏によると、企業のサイバー脅威と AI の導入がパロアルトネットワークスに「永続的な追い風」を与えている`,
    source: "MarketWatch",
    sourceUrl: "https://www.marketwatch.com/story/palo-alto-networks-stock-climbs-as-demand-for-ai-cybersecurity-powers-an-earnings-beat-4b39578c?mod=mw_rss_topstories",
    publishedAt: "2026-09-01T20:46:00+00:00",
    category: "テクノロジー",
    imageUrl: "https://images.mktw.net/im-839193",
    readTime: 2,
  },
  {
    id: "this-could-be-the-10-year-treasury-s-tip-bcdf393a",
    title: "This could be the 10-year Treasury’s tipping point into the danger zone",
    titleJa: "これは10年物財務省が危険地帯に入る転換点となる可能性がある",
    summaryJa: "容赦ない暴落により、世界の債券利回りは2008年以来の最高水準に達し、家計、企業、世界政府の借入コストが上昇している。",
    bodyOriginal: `An unrelenting rout has global bond yields touching their highest levels since 2008, driving up borrowing costs for households, businesses and world governments.`,
    bodyJa: `容赦ない暴落により、世界の債券利回りは2008年以来の最高水準に達し、家計、企業、世界政府の借入コストが上昇している。`,
    source: "MarketWatch",
    sourceUrl: "https://www.marketwatch.com/story/this-could-be-the-10-year-treasurys-tipping-point-into-the-danger-zone-891cd45d?mod=mw_rss_topstories",
    publishedAt: "2026-09-01T20:36:00+00:00",
    category: "金融政策",
    imageUrl: "https://images.mktw.net/im-78245009",
    readTime: 2,
  },
  {
    id: "u-s-house-votes-to-avoid-government-shut-a49788cc",
    ...
    summaryJa: "Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.",
    bodyOriginal: `The U.S. House on Tuesday voted, 370-48, in favor of a stopgap spending measure that is expected to avert a government shutdown this fall ahead of the 2026 midterm election, despite objections from GOP hard-liners.
The legislation, which the Senate passed in August before breaking for its summer recess, would keep the government funded through Dec. 11.
The measure now heads to President Donald Trump's desk for his signature.
Without passage, government funding is set to lapse at the end of the federal fiscal year, Sept. 30. That's a prospect neither party was keen on as lawmakers hope to quickly return to their districts and continue campaigning ahead of the midterms.
House leadership brought the bill to the floor using a process known as "suspension of the rules," which allows consensus measures to circumvent certain procedural hurdles but requires a two-thirds vote. That meant Democratic votes were needed in the narrowly divided chamber. The package ultimately got broad, bipartisan support. Just 19 Republicans and 29 Democrats voted against the measure.
"Thanks to the House Republicans' leadership and the foresight back in July, we began the necessary processes to ensure that the government would not be shut down," House Speaker Mike Johnson, R-La., said after the vote. "We are not going to have our troops in harm's way without getting paychecks."
But before the vote, members of the hard-right House Freedom Caucus raised concerns about both the bill and the process. The lawmakers threatened to hold up what Johnson expected would be a quick vote to pass the measure, which extends current government funding levels.
Rep. Chip Roy, R-Texas, sent a letter on Monday to House Appropriations Committee Chair Tom Cole, R-Okla., and House Budget Committee Chair Jodey Arrington, R-Texas, outlining his concerns with the stopgap spending measure, among them its funding for Planned Parenthood and the absence of a ban on hemp products that contain THC, the psychoactive chemical in marijuana.
"I have serious concerns about simply extending the status quo. Members should be clear about what passage of this legislation would mean: Congress would once again affirmatively fund policies we have spent months fighting to change," Roy wrote.
And Rep. Andy Harris, R-Md., who chairs the Freedom Caucus, told Punchbowl News he would vote to block the rest of the GOP's agenda for the week over his objection to the spending measure.
But their opposition was not enough to hinder the vote. With Democratic support, Johnson passed the funding measure even with some GOP defections.
Most lawmakers will be eager to get back to their districts this election season, as Republicans strive to overcome Trump's low approval rating and hold on to narrow majorities in the House and Senate. Polling shows Democrats are largely expected to win control of the House, while the GOP is favored in the Senate.
Senate Appropriations Committee Chair Patty Murray, D-Wash., applauded the spending bills' passage in a statement on Tuesday, but said more work is needed to be done to curb the Trump administration.
"We have a lot of work ahead in the coming months to negotiate spending bills that invest in families instead of President Trump's war budget, and I will be pushing at every step of the way to invest in making life more affordable and rein in the corrupt abuses of this administration," Murray said.`,
    bodyJa: `Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/09/01/congress-government-shutdown-vote.html",
    publishedAt: "2026-09-01T20:34:47+00:00",
    category: "テクノロジー",
    imageUrl: "https://images.unsplash.com/photo-1518770660439-4636190af475?w=800&q=80",
    readTime: 2,
  },
  {
    id: "house-to-vote-on-measure-condemning-soci-5748c0e2",
    title: "House to vote on measure condemning socialism ahead of November election",
    titleJa: "下院、11月の選挙に向けて社会主義非難法案を採決へ",
    summaryJa: "下院は早ければ火曜日にも社会主義を非難するメッセージ決議案を採決する予定だが、これは選挙年に行われる作戦で、全国各地で極左候補が民主党予備選で勝利する中、民主党に不愉快な投票を強要することを目的としている。一部の民主党議員は社会主義を非難する姿勢を表明しているが、共和党もまた、「SAVE America Act」として知られる非常に物議を醸している有権者ID法案の可決を決議案に盛り込んだ。この動きは、社会主義を非難するために投票したい穏健派の民主党議員ですら反発する可能性が高い。",
    bodyOriginal: `The House of Representatives will vote on a messaging resolution to condemn socialism as early as Tuesday, an election-year gambit intended to force an uncomfortable vote for Democrats as far-left candidates win Democratic primaries across the country.
While some Democrats have expressed openness to condemning socialism, Republicans also inserted a call to pass the highly controversial voter-ID bill known as the SAVE America Act into the resolution — a move likely to repel even moderate Democrats who want to vote to condemn socialism.
...
"We're going to draw another contrast this week with a vote on the House floor to say not only do we denounce socialism, but also the idea of people that aren't American citizens voting in our elections," House Majority Leader Steve Scalise, R-La., said in a Tuesday press conference. "All of that is on the ballot this November."
Democrats, meanwhile, have excoriated the measure as an election-year stunt intended to manufacture talking points on the campaign trail. The resolution itself is non-binding and does not carry the force of law.
"What Republicans are advocating also has the SAVE Act, and that's why Democrats carry forward an alternate resolution," Rep. Pete Aguilar, of California who is the chair of the House Democratic Caucus, said Tuesday. "What Republicans are seeking to do here is to just add another talking point."
The measure nearly failed in a preliminary rule vote earlier Tuesday after some conservative Republicans rebelled. It was saved, however, after Democratic Reps. Jared Golden, of Maine, and Marie Gluesenkamp-Perez, of Washington, voted to advance the rule — which also contained a measure advantageous to the lobster fishing industry.`,
    bodyJa: `下院は早ければ火曜日にも社会主義を非難するメッセージ決議案を採決する予定だが、これは選挙年に行われる作戦で、全国各地で極左候補が民主党予備選で勝利する中、民主党に不愉快な投票を強要することを目的としている。
一部の民主党議員は社会主義を非難する姿勢を表明しているが、共和党もまた、「SAVE America Act」として知られる非常に物議を醸している有権者ID法案の可決を決議案に盛り込んだ。この動きは、社会主義を非難するために投票したい穏健派の民主党議員ですら反発する可能性が高い。
アメリカ民主社会主義者が支持する多くの候補者が今期の予備選で穏健派の民主党を破っており、共和党は自身のブランドが世論調査で低迷する中、民主党の左傾化に乗じようとしている。
スティーブ・スカリース下院院内総務（共和党、ルイジアナ州）は火曜日の記者会見で、「今週、社会主義を非難するだけでなく、アメリカ国民ではない人々が選挙に投票するという考えも非難するという下院議場での投票で、新たなコントラストを描くつもりだ」と述べた。 「そのすべてが今年11月の投票に含まれる。」
一方、民主党はこの法案を、選挙戦での話題作りを目的とした選挙年のスタントだと非難している。決議自体には拘束力はなく、法的強制力はありません。
下院民主党議員団の議長であるカリフォルニア州選出のピート・アギラール下院議員は火曜日、「共和党が主張していることにはSAVE法もあり、それが民主党が代替決議案を提出する理由だ」と述べた。 「共和党がここでやろうとしているのは、単に別の論点を追加することだ。」
この法案は、一部の保守共和党議員の反発を受け、火曜日初めの予備規則投票で否決されそうになった。しかし、民主党のジャレッド・ゴールデン下院議員（メイン州）とマリー・グルーゼンカンプ・ペレス下院議員（ワシントン）がこの規則の推進に賛成票を投じたため、この規則は救われた。この規則にはロブスター漁業に有利な措置も含まれていた。`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/09/01/congress-vote-condemning-socialism-election.html",
    publishedAt: "2026-09-01T20:29:10+00:00",
    category: "テクノロジー",
    imageUrl: "https://images.unsplash.com/photo-1518770660439-4636190af475?w=800&q=80",
    readTime: 2,
  },
  {
    id: "dell-s-ai-servers-drive-a-stellar-earnin-f4e69a13",
    title: "Dell’s AI servers drive a stellar earnings performance, and a raised outlook",
    titleJa: "デルの AI サーバーが優れた収益パフォーマンスと見通しの向上を推進",
    summaryJa: "AIサーバーの需要が加速し、同社の受注残は950億ドルに達した",
    bodyOriginal: `The company’s backlog has reached $95 billion as demand accelerates for its AI servers`,
    bodyJa: `AIサーバーの需要が加速し、同社の受注残は950億ドルに達した`,
    source: "MarketWatch",
    sourceUrl: "https://www.marketwatch.com/story/dells-ai-servers-drive-a-stellar-earnings-performance-and-a-raised-outlook-86476ace?mod=mw_rss_topstories",
    publishedAt: "2026-09-01T20:16:00+00:00",
    category: "テクノロジー",
    imageUrl: "https://images.mktw.net/im-49882740",
    readTime: 2,
  },
  {
    id: "bessent-touts-bond-market-as-10-year-tre-328f1e36",
    title: "Bessent touts bond market as 10-year Treasury yield spikes",
    titleJa: "ベッセント氏、債券市場は10年国債利回りが急上昇していると宣伝",
    summaryJa: "スコット・ベッセント財務長官は火曜日、ドナルド・トランプ大統領が大統領に復帰して以来、米国の債券市場は世界の他の国々をアウトパフォームしていると自慢した。しかし同氏は、1997年のアジア金融危機の再現への懸念が高まる世界的な債券下落のさなか、10年米国債利回りが約20カ月ぶりの高水準に上昇した中での発言だった。ベッセント氏はノースカロライナ州アッシュビルで開催された20カ国・地域（G20）財務会合でフォックス・ビジネスの司会者との「炉辺談話」の中で、「債券市場は世界の主要国の中で最も好調な債券市場だ」と主張した。",
...
— CNBC's Megan Cassella contributed to this report.`,
    bodyJa: `スコット・ベッセント財務長官は火曜日、ドナルド・トランプ大統領が大統領に復帰して以来、米国の債券市場は世界の他の国々をアウトパフォームしていると自慢した。しかし同氏は、1997年のアジア金融危機の再現への懸念が高まる世界的な債券下落のさなか、10年米国債利回りが約20カ月ぶりの高水準に上昇した中での発言だった。
ベッセント氏はノースカロライナ州アッシュビルで開催された20カ国・地域（G20）財務会合でフォックス・ビジネスの司会者との「炉辺談話」の中で、「債券市場は世界の主要国の中で最も好調な債券市場だ」と主張した。
ヘッジファンドのベテランで内閣官房長官でもある同氏は、トランプ大統領就任に対する債券市場の反応を軽視する分析の出発点を選んだ。市場は将来の出来事を予想しており、トランプ大統領勝利の可能性を織り込み始めた投資家は、2025年1月20日のトランプ大統領就任式のかなり前から米国債の売却を始めた。そのような状況を考慮すると、米国の債券市場は過去 2 年間、市場の中ほどで推移してきました。
ベッセント氏とトランプ氏は市場の動向や米国経済について、真実を回避するか、理性に反する主張を繰り返してきた。トランプ大統領は月曜日、記者団に対し、高すぎる金利の妨げがなければ、米国経済は20％もの高い成長率で成長する可能性があると述べた。しかし、このような数字に達したのは第二次世界大戦後、一度だけであり、それは歴史的な経済縮小に続く新型コロナウイルス感染症後の回復期であった。
月曜、ベッセント氏はCNBCのサラ・アイゼンに対し、基準となる10年債利回りは「トランプ大統領の登場以来横ばい」であり、市場の安定の表れであると語った。実際には、トランプ大統領の２度目の就任以来、１０年物は約１８ベーシスポイント上昇している。
ベッセント氏は2日間のG20会合を通じて同様のコメントをしており、同氏と連邦準備制度理事会のケビン・ウォーシュ議長は経済成長を促進する方法を見つけることに重点を置いてきた。
CNBCの分析によると、確かに、米国10年債利回りの変動は、G7加盟国を含む他の主要国が2025年1月以降に経験した変動よりも小さい。
しかし、将来の出来事を予想して取引される米国債の利回りは、2024年の選挙前からすでに上昇していた。トレーダーらが成長加速、インフレ上昇、債務拡大の可能性を織り込む中、１０年米国債は２０２４年９月中旬の安値から就任式当日までほぼ１％ポイント上昇した。 1 ベーシス ポイントは 0.01%、つまり 1% の 100 分の 1 に相当し、利回りと価格は相互に反比例します。
ベッセン氏は火曜日の発言で、米国市場を宣伝する一方で「1カ月で何が起こるかは問題ではない」と述べ、短期債の動向を軽視した。
「もし米国の債券市場に問題があれば…人々は米国の債券を売って他国の債券を買うだろう」とベッセント氏は月曜日にCNBCに語った。 「しかし、私たちは最もパフォーマンスの高い市場です。」
火曜日の世界市場では国債利回りが幅広く上昇し、一部の国では借入コストが数十年来の高水準に達していると見られている。
FRBの政策方向性をめぐる不確実性は、地政学的な混乱の増大と重なった。特にイランでは、ホルムズ海峡周辺での米軍による攻撃が休止を経て最近再開された。この紛争により原油価格が上昇し、インフレ懸念が高まり、債券利回りに上昇圧力が加わった。
火曜午前遅くの記者会見で日本の10年債利回りの急上昇について質問されたベッセント氏は、「金融市場は非常に多様な市場であるため、金融市場の動きの背後にあるすべての側面を分解するのは難しい」と述べた。
同氏は、「私たちは世界的に利回りが上昇するのを目の当たりにしてきた」と付け加えた。しかし同氏は、ここ数日日本の財務当局者らと会談したことを指摘し、「日本側は正しい措置を講じていると思う」と述べた。
ベッセント氏は、米１０年債利回りの上昇に関する怒鳴る質問に答えなかった。
— CNBC の Megan Cassella がこのレポートに寄稿しました。`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/09/01/bessent-trump-bond-yields-g20.html",
    publishedAt: "2026-09-01T18:53:45+00:00",
    category: "エネルギー",
