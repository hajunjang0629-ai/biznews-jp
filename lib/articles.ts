...
GMの報告によると、この合弁会社は中国で設立されて以来、2,000万台以上の車両を生産、納入したという。`,
  ...
  },
  {
    ...
    summaryJa: "堅調な企業収益と原油価格の緩和を受けて米国の主要株価指数が最高値を更新したことを受け、昨晩のウォール街の力強い上昇を受けて、アジアのハイテク株は水曜日に急騰した。ソフトバンクグループの株価は10％以上上昇し、半導体装置メーカーの東京エレクトロンも3.64％上昇した。アドバンテストは７％上昇し、日本のメモリチップメーカーキオクシアは６．３４％上昇した。",
    bodyOriginal: `Asian technology stocks surged Wednesday after a strong Wall Street rally overnight that saw robust corporate earnings and easing oil prices push major U.S. indexes to fresh records.
...
U.S. Treasury Secretary Scott Bessent told CNBC's "Squawk Box" on Tuesday that Washington and Tehran could reach a deal within days to reopen the Strait of Hormuz, easing concerns over global energy supplies.`,
    bodyJa: `堅調な企業収益と原油価格の緩和を受けて米国の主要株価指数が最高値を更新したことを受け、昨晩のウォール街の力強い上昇を受けて、アジアのハイテク株は水曜日に急騰した。
ソフトバンクグループの株価は10％以上上昇し、半導体装置メーカーの東京エレクトロンも3.64％上昇した。アドバンテストは７％上昇し、日本のメモリチップメーカーキオクシアは６．３４％上昇した。
韓国ではSKハイニックスが6.9％上昇し、サムスン電子は4％以上上昇した。ソウル半導体は７．６％急騰した。
最近の取引では、韓国の半導体比率の高い市場が大幅な下落と記録的な上昇の間で揺れ動いており、ハイテク株のボラティリティが高まっている。
オルタス・アドバイザーズのストラテジスト、アンドリュー・ジャクソン氏は水曜日のメモで、米国の半導体株の最近の上昇はアジアのAI銘柄に対する強気の見通しを強化し、一夜にしてチップメーカーやインフラサプライヤーの急騰を指摘した。
ジャクソン氏は、ソフトバンクが過半数を保有するチップ設計子会社アーム・ホールディングスがAI関連のデータセンター・ロイヤルティの高騰や中央処理装置の開発計画に対する楽観的な見方から一夜にして急騰したことを受け、ソフトバンクの利益がさらに拡大すると予想している。
火曜日の米国株は好調な決算と、ホルムズ海峡が間もなく再開されるとの期待による原油価格のさらなる下落のおかげで、S&P500種とダウ工業株30種平均が過去最高値を更新する絶好の日となった。
パランティア・テクノロジーズが２９％以上上昇したことを受け、ナスダック総合指数は２．５９％急騰し２万６５８４．９９で取引を終えた。
スコット・ベッセント米財務長官は火曜日、CNBCの「スコーク・ボックス」に対し、米国とイランは数日以内にホルムズ海峡の再開で合意に達し、世界のエネルギー供給をめぐる懸念が和らぐ可能性があると語った。`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/08/05/softbank-samsung-sk-hynix-samsung-tech-rally.html",
    publishedAt: "2026-08-05T01:27:06+00:00",
    category: "エネルギー",
    imageUrl: "https://images.unsplash.com/photo-1473172367879-2dca04a4dca4?w=800&q=80",
    readTime: 2,
  },
  {
    id: "u-s-says-strait-of-hormuz-is-free-and-op-34942fa4",
    title: "U.S. says Strait of Hormuz is 'free and open' as Bessent says deal with Iran is close",
    titleJa: "米国、ベッセント氏がイランとの合意は近いと発言、ホルムズ海峡は「自由で開かれた」と発言",
    summaryJa: "スコット・ベッセント財務長官がイランとの合意は近いと主張したことを受け、米軍はホルムズ海峡がすべての商船の通行に開放されていると発表した。米中央軍はＸへの投稿で「ホルムズ海峡の南航路は依然として自由で開かれている」と述べ、イランの「不当な」侵略にも関わらず同水路を通過する船舶１０００隻以上を支援したことを強調した。",
    bodyOriginal: `The U.S. military said the Strait of Hormuz was open for all commercial vessels to transit, after Treasury Secretary Scott Bessent claimed that an Iran deal is close.
U.S. Central Command said the "southern route of the Strait of Hormuz remains free and open" in a post on X, highlighting that it had assisted more than 1,000 vessels in transiting the waterway despite "unwarranted" Iranian aggression.
...
Brent, the international oil benchmark, climbed 0.43% on Wednesday to $79.7 per barrel after sliding 5.3% the day before. West Texas Intermediate futures inched up 0.21% to trade at $75.95, after falling 5.7% the day before.
...
The source, who didn't want to be identified because of the sensitive nature of the topic, added that the talks were being held between Iran and Oman whilst being mediated by Pakistan - with the U.S involved "indirectly."
U.S. missile shortage
Earlier on Tuesday, the White House and Pentagon insisted that U.S. forces had "more than enough" munitions, after reports that the U.S. military had used "virtually all" of its long-range precision missiles during the Iran war.
Reuters said the Army has depleted most of its stockpile of Army Tactical Missile Systems and Precision Strike Missiles, and CNN reported that the the US military has exhausted nearly 80% of its interceptors for its THAAD missile defense system, used to defend against ballistic missile strikes.
In response, U.S. President Donald Trump said that Washington has "far more munitions than anyone in the world, and far more than we need," also claiming that U.S. defense companies were "making more munitions than they have ever made before, in addition to expanding their plants and equipment at record levels."
White House deputy press secretary Anna Kelly said that "the United States Military has more than enough munitions, ammo, and stockpiles to serve all of President Trump's strategic goals and beyond, and Operation Epic Fury has exposed what happens when you mess with the United States."`,
    bodyJa: `スコット・ベッセント財務長官がイランとの合意は近いと主張したことを受け、米軍はホルムズ海峡がすべての商船の通行に開放されていると発表した。
米中央軍はＸへの投稿で「ホルムズ海峡の南航路は依然として自由で開かれている」と述べ、イランの「不当な」侵略にも関わらず同水路を通過する船舶１０００隻以上を支援したことを強調した。
南ルートはイランに近い部分ではなく、オマーンの領海を通過する。
この発表は、今週中にもホルムズ海峡を開放する合意が得られる可能性があるとのスコット・ベッセント米財務長官の発言を受けて、火曜日に原油価格も急落した中で行われた。
「我々はイラン側と交渉中だ」とベッセント氏はCNBCの番組「スコークボックス」に語った。 「今日か明日、海峡を開いてこの紛争におけるより正常化された立場に向けて合意に達する可能性がある。」
国際石油指標であるブレントは、前日に5.3％下落した後、水曜日には0.43％上昇して1バレル当たり79.7ドルとなった。ウエスト・テキサス・インターミディエイト先物は、前日に5.7％下落した後、0.21％上昇して75.95ドルで取引された。
ベッセント氏の発言後、イランとオマーンの会談を直接知る中東外交官幹部はMS NOWに対し、ホルムズ海峡再開に向けたイランとの暫定合意を受け入れるよう米国と欧州諸国からオマーンに対して多大な圧力がかかっていると語った。
MS NOWはまた、パキスタン政府高官から、ホルムズ海峡の再開に関する文書が「完成に近づいている」と聞いた。
デリケートな話題であるため匿名を避けたこの関係者は、会談はパキスタンの仲介の下、イランとオマーンの間で行われており、米国も「間接的に」関与していると付け加えた。
米国のミサイル不足
火曜日初め、米軍がイラン戦争中に長距離精密ミサイルの「事実上すべて」を使用したとの報道を受け、ホワイトハウスと国防総省は米軍が「十分すぎる」弾薬を保有していると主張した。
ロイター通信は、陸軍が陸軍戦術ミサイルシステムと精密打撃ミサイルの備蓄のほとんどを使い果たしたと伝え、CNNは米軍が弾道ミサイル攻撃に対する防衛に使用するTHAADミサイル防衛システム用の迎撃ミサイルの80％近くを使い果たしたと報じた。
これに対し、ドナルド・トランプ米大統領は、ワシントンは「世界の誰よりもはるかに多くの軍需品を保有しており、我々が必要としているものをはるかに上回っている」と述べ、また、米国の防衛企業は「工場や装備を記録的なレベルで拡張していることに加えて、これまでよりも多くの軍需品を生産している」とも主張した。
ホワイトハウスのアンナ・ケリー副報道官は、「米軍はトランプ大統領のすべての戦略目標とそれを超えた戦略目標を達成するのに十分以上の弾薬、弾薬、備蓄を保有しており、エピック・フューリー作戦は米国に手を出したら何が起こるかを暴露した」と述べた。`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/08/05/us-iran-war-trump-hormuz-bessent-iran-deal-close.html",
    publishedAt: "2026-08-05T01:26:27+00:00",
    category: "エネルギー",
    imageUrl: "https://images.unsplash.com/photo-1473172367879-2dca04a4dca4?w=800&q=80",
    readTime: 3,
  },
  {
    id: "ai-used-new-levels-of-autonomy-and-decep-7ff67625",
    title: "AI used new levels of 'autonomy and deception' to trick people in safety test",
    titleJa: "AIは安全テストで人々を騙すために新たなレベルの「自律性と欺瞞」を利用した",
    summaryJa: "AIは安全テストで人々を騙すために新たなレベルの「自律性と欺瞞」を利用した- 公開されました",
    bodyOriginal: `AI used new levels of 'autonomy and deception' to trick people in safety test
- Published
...
GitHub was notified by AISI of the attempted breach of its system. Microsoft has been contacted by the BBC for comment.`,
    bodyJa: `AIは安全テストで人々を騙すために新たなレベルの「自律性と欺瞞」を利用した
- 公開されました
Anthropic と OpenAI の最新の人工知能 (AI) ツールは、英国の AI セキュリティ研究所によるテスト中に、人気のあるプラットフォームを弱体化させようとする新たな極限状態に陥りました。
AISIは火曜日、AnthropicのMythosとOpenAIのSolモデルがこれまでに見たことのないレベルの「自律性と欺瞞」を行っていたと発表した。
定期的な AI 安全性テスト中に、Anthropic エージェントが本物の人の偽のプロフィールを作成し、間に立つ人を騙して、技術開発者がソフトウェア コードを保存する大規模なプラットフォームである GitHub にアクセスしようとしました。
Anthropic と OpenAI は、AISI の報告書に応えて、そのテストにより通常の安全装置が削減または削除されたと指摘した。
AISIの評価者は、テスト中に「研究システムからの異常なデータ転送」に最初に気づき、その後「テスト対象のエージェントの一部が、現実の人々や組織を対象とした持続的で潜在的に有害な活動に従事していた」ことを発見した。
Mythos エージェントが「悪意のあるコード」を作成し、GitHub のシステムに挿入しようとしたことが判明しました。
Mythos エージェントは、GitHub を維持している人々を特定して調査し、それらの本物の人々に基づいて一連の「偽のオンライン ID」を作成しました。これは、実際の人々に圧力をかけ、騙して悪意のあるコードを承認させる取り組みの一環として行われました。
このエージェントは、調査した実際の人物を装ったダイレクト メッセージを人々に送信することさえありました。
「エージェントのプルリクエストが公の場で異議を申し立てられたとき、エージェントは以前のアクティビティを無害に見えるように編集し、継続するために新しいアイデンティティを採用することを検討した」とAISIは述べた。
試行全体を通して、エージェントが悪意のあるコードを GitHub に配信することを阻止できたのは人間によるレビューでした。
AISIは、ミトスのエージェントがそのような行動を回避したり実行したりするように特別に指示されていなかったと述べたが、「自律性と欺瞞に関わるリスクが、具体的な指示なしに現実世界でこれを明確に示したのを初めて見た」と述べた。
株式市場への上場を控えているライバルのAI企業は、ここ数週間で、自社のツールがいくつかのサイバーハッキング事件の原因であると発表した。
アンスロピック社は、AISIのテストパラメータは「当社のどの量産モデルも代表していない」と公式声明で述べた。
同社は「行動の原因を特定する」ために、この事件について独自の調査を行っていると付け加えた。
OpenAIの広報担当者は、AISIのテスト条件は「通常の使用を反映していない」とし、同社は「モデルの機能が向上するにつれて、評価を安全に実施するための共通慣行を強化するために業界全体の評価者やその他の関係者と引き続き協力する」と述べた。
AISIは火曜日、こうした安全装置をオフにしてAIモデルをテストすることは日常的であり、そのようなツールにオープンなインターネットへのアクセスを許可していると述べた。
さらに、問題となっているモデルの動作は「非常に特殊な条件下での少数のイベント」に相当すると付け加えた。
それにもかかわらず、簡単なタスクに応じてミトスとソルが行動した方法は、AIツールが実行するように促されたことの範囲外であったと述べています。
AISIは「このエージェントが行った活動は、新たな、潜在的に欺瞞的な行為の兆候を示しており、その程度と深刻さは我々が予想していなかった」と述べた。
AISI が報告した悪意のあるエージェントの行為のほとんどは、Anthropic の Mythos によって行われました。 OpenAI の Sol が非難されたのは、注目された行為のうち 2 つだけでした。
この中心的な問題は先週、AISIの評価者が各モデルに対し、Microsoftが所有するソフトウェアコードリポジトリであるGitHubに関わる「サイバーセキュリティ上の課題を解決する」よう依頼したテストの一環として発生した。
GitHub は AISI からシステム侵害の試みについて通知を受けました。 Microsoft は BBC からコメントを求められています。`,
    source: "BBC",
    sourceUrl: "https://www.bbc.co.uk/news/articles/c1w1lvn7d9go?at_medium=RSS&at_campaign=rss",
    publishedAt: "2026-08-05T00:02:18+00:00",
    category: "テクノロジー",
