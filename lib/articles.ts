...
- Published15 March`,
  ...
  {
    id: "visa-and-mastercard-stocks-hit-fresh-rec-5becb8e2",
    title: "Visa and Mastercard stocks hit fresh records, underscoring a resilient U.S. consumer",
    titleJa: "ビザとマスターカードの株価は新記録を更新、米国の消費者の回復力を裏付けた",
    summaryJa: "Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.",
    bodyOriginal: `Aggregate spending has been strong, even if American shoppers are getting choosier about what they buy.`,
    bodyJa: `Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.`,
    source: "MarketWatch",
    sourceUrl: "https://www.marketwatch.com/story/visa-and-mastercard-shares-hit-fresh-records-underscoring-a-resilient-u-s-consumer-ef328548?mod=mw_rss_topstories",
    publishedAt: "2026-08-24T21:55:00+00:00",
    category: "金融政策",
    imageUrl: "https://images.mktw.net/im-45897466",
    readTime: 2,
  },
  {
    id: "spacex-plans-to-put-nvidia-powered-ai-sa-add2a41a",
    title: "SpaceX plans to put Nvidia-powered AI satellites in orbit next year",
    titleJa: "SpaceXは来年、Nvidiaを搭載したAI衛星を軌道上に投入する予定",
    summaryJa: "Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.",
    bodyOriginal: `Elon Musk’s company now plans to launch orbital data centers by the end of next year.`,
    bodyJa: `イーロン・マスク氏の会社は現在、来年末までに軌道上データセンターを立ち上げる計画を立てている。`,
    source: "MarketWatch",
    sourceUrl: "https://www.marketwatch.com/story/spacex-plans-to-put-nvidia-powered-ai-satellites-in-orbit-next-year-ab57083c?mod=mw_rss_topstories",
    publishedAt: "2026-08-24T21:26:00+00:00",
    category: "テクノロジー",
    imageUrl: "https://images.mktw.net/im-63188887",
    readTime: 2,
  },
  {
    id: "here-s-how-overvalued-the-stock-market-r-0c0b7324",
    title: "Here’s how overvalued the stock market really is",
    titleJa: "株式市場が実際にどれほど過大評価されているかがわかります",
    summaryJa: "今日のバリュエーションは非常に高騰しているため、ラクダの背中を折るのにこれ以上のわらは必要ないかもしれません。",
    bodyOriginal: `Valuations today are so stretched that it may not take much more straw to break the camel’s back.`,
    bodyJa: `今日のバリュエーションは非常に高騰しているため、ラクダの背中を折るのにこれ以上のわらは必要ないかもしれません。`,
    source: "MarketWatch",
    sourceUrl: "https://www.marketwatch.com/story/heres-how-overvalued-the-stock-market-really-is-f26540c5?mod=mw_rss_topstories",
