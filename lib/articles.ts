...
- 7 月 21 日発行`,
  ...
  {
    id: "dick-s-sporting-goods-epic-drop-hits-oth-85fbb466",
    title: "Dick’s Sporting Goods’ epic drop hits other footwear giants, as shoppers sour on retro sneakers",
    titleJa: "Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.",
    summaryJa: "Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.",
    bodyOriginal: `Shares of the sporting-goods retailer suffering a record selloff as profit and sales missed expectations and the full-year outlook was slashed.`,
    bodyJa: `Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.`,
    source: "MarketWatch",
    sourceUrl: "https://www.marketwatch.com/story/dicks-sporting-goods-stock-is-having-its-worst-day-ever-as-sneakers-arent-selling-without-deeper-discounts-5a868358?mod=mw_rss_topstories",
    publishedAt: "2026-08-25T22:57:00+00:00",
    category: "金融政策",
    imageUrl: "https://images.mktw.net/im-53047310",
    readTime: 2,
  },
  {
    id: "canada-announces-dollar-for-dollar-retal-ccf1632a",
    title: "Canada announces 'dollar-for-dollar' retaliatory tariffs on US as high as 50%",
    titleJa: "Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.",
    summaryJa: "Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.",
    bodyOriginal: `Canada announces 'dollar-for-dollar' retaliatory tariffs on US as high as 50%
- Published
...
Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.`,
    ...
    publishedAt: "2026-08-25T19:50:57+00:00",
    category: "貿易",
  ...
  },
  {
    ...
    summaryJa: "イーロン・マスク氏は、彼の航空宇宙・技術複合企業スペースXとともに米国南部への進出を続けており、ルイジアナ州に1000億ドル規模の新しい打ち上げ施設を計画している。ルイジアナ州経済開発局は共同声明の中で、スペースXが「年間数千回の打ち上げを支援する」ため、ルイジアナ州バーミリオン教区にスターベースを設立すると述べた。",
    bodyOriginal: `Elon Musk is continuing his push into the Southern U.S. with SpaceX, his aerospace and tech conglomerate, planning a $100 billion new launch facility in Louisiana.
In a joint statement, the Louisiana Economic Development office said that SpaceX will establish its Starbase, Louisiana in Vermillion Parish to, "support thousands of launches annually."
Shares of SpaceX rose about 2.5% on Tuesday after the announcement.
Once built, Starbase, LA will serve as the main launch facility for Starship, SpaceX's in-development rocket that is the largest ever built or flown, and which is designed to be fully re-usable.
Musk has ambitions to massively expand SpaceX's Starlink satellite network, to launch orbital data centers, and someday colonize Mars. Those ambitions, and justification for SpaceX's nearly $2 trillion market cap, hinge on the success of Starship.
SpaceX said, in a video posted to its website on Tuesday, that the search for a site to build launch pads and have access to ample fuel for its operations took about 7 years. Musk said in the video that the company would bring "probably 10,000 really exciting jobs" to Louisiana with the spaceport.
In the Tuesday announcement, SpaceX said it would work on a "historic coastal restoration" in Louisiana, in partnership with the state to "bring the marsh back" and ensure the wetlands around its new facility will have "storm protection."
Previously, SpaceX has faced community backlash, lawsuits and fines following environmental violations at its first Starbase facility in Boca Chica, Texas, in the company town now known as Starbase.
In its first test flight of Starship in April 2023 in Texas, energy from the rocket caused SpaceX's concrete launchpad to explode, and its spacecraft to blow up in mid-air. Chunks of concrete were flung into a nesting and migration site important to some endangered species nearby and a fire chewed through around 4 acres of Boca Chica State Park Land south of the Texas launchpad.
In 2024, SpaceX was also found to have violated the Clean Water Act at the Texas launch facility by repeatedly releasing pollutants into or near bodies of water in Texas, a state agency said in a notice of violation focused on its water deluge system.
SpaceX's work in Louisiana follows Musk's move from California into Texas, Tennessee and Mississippi. The company said Louisiana was its fourth launch site.
Musk's AI venture, now known as SpaceXAI, built out its Colossus data centers and a power plant in Greater Memphis. Before that, Musk relocated the headquarters of his automaker, Tesla, from California to Austin, Texas. Tesla now operates a massive vehicle assembly plant in Austin and is testing its driverless, Robotaxi service and Cybercab vehicles in the region.
Tesla and SpaceX, in partnership with Intel, also plan to build a massive AI chip factory in Grimes County, Texas.
CNBC's Kif Leswing contributed to this story.`,
    bodyJa: `イーロン・マスク氏は、彼の航空宇宙・技術複合企業スペースXとともに米国南部への進出を続けており、ルイジアナ州に1000億ドル規模の新しい打ち上げ施設を計画している。
ルイジアナ州経済開発局は共同声明の中で、スペースXが「年間数千回の打ち上げを支援する」ため、ルイジアナ州バーミリオン教区にスターベースを設立すると述べた。
この発表を受けてスペースXの株価は火曜日に約2.5％上昇した。
ロサンゼルスのスターベースが建設されると、スターシップの主要な打ち上げ施設として機能します。スターシップは、これまでに建造または飛行された中で最大の、完全に再利用できるように設計されたスペースXの開発中のロケットです。
マスク氏は、スペースXのスターリンク衛星ネットワークを大規模に拡張し、軌道上データセンターを立ち上げ、いつかは火星に植民地化するという野望を抱いている。こうした野心と、スペースX社の2兆ドル近い時価総額の正当性は、スターシップの成功にかかっている。
スペースXは火曜日にウェブサイトに投稿したビデオの中で、発射台を建設し、運用に必要な十分な燃料を入手できる場所の探索には約7年かかったと述べた。マスク氏はビデオの中で、同社は宇宙港によってルイジアナ州に「おそらく1万人の本当に刺激的な雇用」をもたらすだろうと語った。
火曜日の発表でスペースXは、州と協力してルイジアナ州の「歴史的な海岸修復」に取り組み、「湿地を取り戻し」、新施設周辺の湿地が「暴風雨から守る」ことを確保すると発表した。
スペースXはこれまで、テキサス州ボカチカにある同社初のスターベース施設（現在はスターベースとして知られる企業街）での環境違反を受けて、地域社会の反発、訴訟、罰金に直面していた。
2023年4月にテキサス州で行われたスターシップの最初の試験飛行では、ロケットからのエネルギーによりスペースX社のコンクリート発射台が爆発し、宇宙船は空中で爆発した。近くのいくつかの絶滅危惧種にとって重要な営巣地と移動地にコンクリートの塊が投げ込まれ、火災はテキサス州発射台の南にあるボカチカ州立公園の土地約4エーカーを焼き尽くした。
2024年には、スペースX社がテキサス州の水域内またはその近くに汚染物質を繰り返し放出し、テキサス州の打ち上げ施設で浄水法に違反したことも判明したと、州当局は水氾濫システムに焦点を当てた違反通告の中で述べた。
スペースXのルイジアナでの取り組みは、マスク氏がカリフォルニアからテキサス、テネシー、ミシシッピに移ったことに続くものである。同社は、ルイジアナ州が4番目の発射場であると述べた。
現在SpaceXAIとして知られるマスク氏のAIベンチャーは、グレーターメンフィスにColossusデータセンターと発電所を建設した。その前に、マスク氏は自動車メーカー、テスラの本社をカリフォルニアからテキサス州オースティンに移転した。テスラは現在、オースティンで大規模な車両組立工場を運営しており、同地域で無人運転車、ロボタクシーサービス、サイバーキャブ車両をテストしている。
テスラとスペースXはインテルと提携し、テキサス州グライムズ郡に大規模なAIチップ工場を建設する計画もある。
CNBC のキフ・レスウィングがこの記事に寄稿しました。`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/08/25/spacex-louisiana-spaceport.html",
    publishedAt: "2026-08-25T18:48:33+00:00",
    category: "エネルギー",
    imageUrl: "https://images.unsplash.com/photo-1473172367879-2dca04a4dca4?w=800&q=80",
    readTime: 3,
  },
  {
    id: "iran-and-oman-discuss-joint-shipping-rou-52b6d586",
    title: "Iran and Oman discuss joint shipping route in Strait of Hormuz and mine clearing mission",
    titleJa: "Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.",
    summaryJa: "Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.",
    bodyOriginal: `Iran and Oman on Tuesday discussed a proposal to establish a temporary joint shipping route through the Strait of Hormuz as well as a mission to clear mines from the key oil export corridor.
Oman's Foreign Minister Sayyid Badr bin Hamad Albusaidi said he was hopeful a corridor through Hormuz and "practical arrangements to restore safe navigation" will be announced soon. He described talks with Iran's top diplomat Seyed Abbas Araghchi in Tehran as constructive.
"Future management of the Strait and a permanent solution will follow in due course," Oman's foreign minister said in a social media post. "Discussions with regional partners will be conducted in support of peace and cooperation, stability and freedom of navigation."
The proposed framework with Iran includes a joint project to clear the strait of mines, Oman's Foreign Ministry said in a social media post after the diplomats' meeting. Muscat and Tehran would continue talks to reach an agreement on a permanent corridor and administration system for the strait, the ministry said.
Oman's reference to a mine clearing mission appeared to contradict President Donald Trump's statement earlier Tuesday that the U.S. Navy informed him all mines had been removed from international waters in Hormuz.
Oman's discussions with Iran come a day after Treasury Secretary Scott Bessent said the U.S. will sanction any entity that does business with the Islamic Republic. Trump threatened to bomb Oman earlier this month when Fox News asked him about Muscat's talks with Tehran on Hormuz.
Iran and Oman are holding talks under a provision in the memorandum of understanding signed by Washington and Tehran on June 17. The interim deal said Iran and Oman would hold talks to "define the future administration and maritime services" in Hormuz.
But the MOU quickly collapsed as the U.S. and Iran started fighting over shipping lanes. The U.S. military protects ships that use a southern route along Oman's coast. U.S. Central Command has said more than 660 million barrels of crude oil have exited Hormuz under its protection since May.
Iran demands that ships use a northern route through its territorial waters to transit the strait or risk coming under attack.
An oil tanker was struck by an unknown projectile and disabled near Oman on Monday, according to an incident report from the United Kingdom Maritime Trade Operations Centre. Two cargo ships came under attack in Hormuz last week resulting in the deaths of two sailors.`,
    bodyJa: `Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/08/25/iran-oman-strait-hormuz-oil.html",
    publishedAt: "2026-08-25T18:41:05+00:00",
    category: "エネルギー",
    imageUrl: "https://images.unsplash.com/photo-1473172367879-2dca04a4dca4?w=800&q=80",
    readTime: 2,
  },
  {
    id: "is-the-k-shaped-economy-ending-finance-p-02fcc1c8",
    title: "Is the K-shaped economy ending? Finance pros weigh in",
    titleJa: "K字型経済は終わるのか？金融の専門家が意見を言う",
    summaryJa: "K 字型経済は、拡大する永続的な経済格差の略語となっています。つまり、高所得のアメリカ人が富、支出、経済的安全の面でさらに先を行っている一方で、多くの低所得世帯が追いつくのに苦労しています。今、その形は変わりつつあるのかもしれない。",
    bodyOriginal: `The K-shaped economy has become shorthand for a widening, persistent economic divide: higher-income Americans pulling further ahead — in wealth, spending, and financial security — while many lower-income households struggle to keep up.
Now, that shape may be shifting.
"I got sick of hearing about this K-shaped economy," Treasury Secretary Scott Bessent told CNBC's "Squawk Box" earlier this month. "I can say here definitively, the K-shaped economy is over."
"We're seeing more of a 'C' economy where the lower end of wage earners are finally clawing it back," Bessent said.
What is a K-shaped economy?
The "shape" of the economy refers to the shape of the letter.
In a K-shaped economy, for example — a term that emerged during the Covid-19 pandemic — the arm and leg of the K widen, representing divergent experiences for low- and high-earning households.
Some recent data shows wage and spending gaps between most higher-income and lower-income households are beginning to close. In other words, they are starting to converge, like the ends of the letter "C."
That matters because it could signal a meaningful change in the distribution of economic strength, some experts said. Instead of growth being concentrated at the top, gains may be becoming more broadly shared.
For example, lower-income households saw their after-tax wages grow at an average 5.2% annual pace in July, surpassing growth for higher-income households for the first time since December 2024, according to data published this month by the Bank of America Institute.
Debit and credit card spending also converged across income groups last month, according to the think tank.
Lower-income households' spending grew 5.4% year-over-year in July, supported by stronger after-tax wage growth, outpacing spending growth among middle-income households, according to the Bank of America Institute.
Why all households are under financial pressure
But lower-income consumers are not necessarily gaining ground, economists said — challenging the notion of a shift away from a K-shaped economy.
For example, borrowers with low FICO scores — a barometer of consumer credit scores — are showing greater signs of stress.
"For those lowest-scoring consumers, we are seeing slight upticks in the 90-plus delinquency rate for mortgage and auto loans," said Ethan Dornhelm, FICO's vice president of scores and predictive analytics, referring to consumers who are 90 days or more past due on their required payments.
I got sick of hearing about this K-shaped economy. I can say here definitively, the K-shaped economy is over.Scott BessentTreasury Secretary
Many Americans at all income levels are still under pressure, economists said.
Even higher earners "are dialing back some of their spending and being more cautious with how they spend, where they spend their money," said EY-Parthenon chief economist Gregory Daco.
While consumers' concerns about gas prices are easing, housing affordability has emerged as a large source of financial pressure, according to a new report from J.D. Power. Worries over housing costs have nearly eclipsed gasoline prices as the second-largest source of financial stress, behind groceries, it found.
The average first-time homebuyer's monthly mortgage payment hit $2,563, up 57% since April 2019 and far ahead of the 30% general inflation rate over that period, according to FICO's latest Credit Insights report.
Forty-three percent of homeowners said their total monthly housing costs have made it harder to keep up with other expenses, said FICO, which surveyed 2,078 U.S. adults ages 18 and older in July.
The ability to afford a home has declined since the beginning of the year, according to data from the Federal Reserve Bank of Atlanta. Affordability has broadly been depressed since 2022, when mortgage rates started increasing significantly, according to Atlanta Fed data.
Student-loan repayment is another source of strain: 56% of borrowers said it caused them to rely more heavily on credit cards or other loans to stay on top of bills over the past year, according to the FICO report.
Could an X-shaped economy be on the horizon?
Other economists said the economy may be taking on different shapes beyond a "K" or a "C."
For example, an E-shape describes three economic tiers: high-income households, a squeezed middle and a struggling bottom.
An X shape could be next, if lower-income spending growth persistently exceeds that of higher-income spending growth, economists said.
"There is a slight risk of an X developing here," said David Tinsley, senior economist at the Bank of America Institute.
"It seems that lower-income household spending growth could accelerate past higher-income households for a time, and so we could actually be talking about a crossover," he said.
A downturn in the stock market could cause higher-income households, which are more likely to own stocks, to pull back on spending, experts said.
Such a dynamic "could become a key catalyst to slower consumer spending growth and an economy that might be stalling," said Daco of EY-Parthenon.
The alphabet soup of economic labels may have its limits, economists said.
For example, age and life stage may be a more useful way to understand who is feeling the most economic pressure in the months ahead, they said.
Struggling Gen Z consumers in their 20s are very different from Gen X, the mid-career cohort roughly in their mid-40s to early 60s, who are also feeling a financial squeeze, experts said.
Housing costs remain a particular pressure point for younger Gen Z consumers, especially renters, they said.
Meanwhile, "Gen X consumers are supporting their children while also perhaps supporting and helping their parents while also trying to save for retirement," said FICO's Dornhelm.
...
SIGN UP: Money 101 is an 8-week learning course on financial freedom, delivered weekly to your inbox. Sign up here. It is also available in Spanish.`,
    bodyJa: `K 字型経済は、拡大する永続的な経済格差の略語となっています。つまり、高所得のアメリカ人が富、支出、経済的安全の面でさらに先を行っている一方で、多くの低所得世帯が追いつくのに苦労しています。
今、その形は変わりつつあるのかもしれない。
「このK字型経済については聞き飽きた」とスコット・ベッセント財務長官は今月初め、CNBCの「スコークボックス」で語った。 「ここではっきりと言えるのは、K字型経済は終わったということです。」
「我々は、下位の賃金労働者が最終的にそれを取り戻しつつある『C』経済の状況をさらに見ている」とベッセント氏は語った。
K字型経済とは何ですか？
経済の「形」とは文字の形を指します。
たとえば、K字型経済（新型コロナウイルス感染症のパンデミック中に登場した用語）では、Kの腕と脚が広がり、低所得世帯と高所得世帯の異なる経験を表している。
一部の最近のデータは、大部分の高所得世帯と低所得世帯の間の賃金と支出の差が縮まり始めていることを示しています。つまり、文字「C」の両端のように、収束し始めています。
一部の専門家は、経済力の分布に意味のある変化を示す可能性があるため、これは重要だと述べた。成長がトップに集中するのではなく、利益はより広範囲に共有されるようになるかもしれない。
例えば、バンク・オブ・アメリカ研究所が今月発表したデータによると、低所得世帯の税引後賃金は7月に年平均5.2％のペースで伸び、2024年12月以来初めて高所得世帯の伸びを上回った。
同シンクタンクによると、デビットカードとクレジットカードの支出も先月、所得階層全体で集中したという。
バンク・オブ・アメリカ研究所によると、7月の低所得世帯の支出は、税引後賃金の伸びの堅調に支えられ前年同月比5.4％増加し、中間所得世帯の支出の伸びを上回った。
なぜすべての世帯が経済的プレッシャーにさらされているのか
しかし、経済学者らは、低所得の消費者が必ずしも支持を得ているわけではなく、K字型経済からの転換という概念に異議を唱えていると述べた。
たとえば、消費者信用スコアのバロメーターである FICO スコアが低い借り手は、より大きなストレスの兆候を示しています。
FICOのスコアおよび予測分析担当バイスプレジデント、イーサン・ドーンヘルム氏は、必要な支払い期限を90日以上過ぎている消費者について言及し、「最もスコアの低い消費者については、住宅ローンや自動車ローンの90年以上の延滞率がわずかに上昇しているのが見られる」と述べた。
このK字型経済の話は聞き飽きた。ここではっきりと言えるのは、K字型経済は終わったことだ。スコット・ベッセント財務長官
エコノミストらによると、多くの米国人はあらゆる所得水準において依然として圧力にさらされているという。
EYパルテノンの首席エコノミスト、グレゴリー・ダコ氏は、高所得者でも「支出の一部を減らし、お金の使い方やお金の使い方にさらに慎重になっている」と述べた。
J.D.パワーの新しいレポートによると、ガソリン価格に対する消費者の懸念は和らぎつつあるものの、住宅の手頃な価格が大きな経済的圧力の原因となっているという。住宅費を巡る懸念が、食料品に次ぐ財政ストレスの第２位の原因として、ガソリン価格をほぼ上回っていることが判明した。
FICOの最新のCredit Insightsレポートによると、初めて住宅を購入する人の平均月々の住宅ローン支払額は2,563ドルに達し、2019年4月以来57％増加し、同期間の一般的なインフレ率30％を大きく上回っている。
7月に18歳以上の米国成人2,078人を対象に調査を行ったFICOによると、住宅所有者の43％が、月々の住宅費の合計により、他の出費を維持するのが困難になったと回答したという。
アトランタ連邦準備銀行のデータによると、住宅を購入する能力は年初以来低下している。アトランタ連銀のデータによると、住宅ローン金利が大幅に上昇し始めた2022年以降、住宅価格の手頃な価格は全般的に低迷している。
学生ローンの返済も負担の原因となっている。FICOの報告書によると、借り手の56％は、そのせいで過去1年間、生活費をやりくりするためにクレジットカードやその他のローンにもっと依存するようになったと答えている。
X字型の経済が到来する可能性はあるでしょうか?
他のエコノミストは、経済は「K」や「C」を超えて異なる形をとっている可能性があると述べた。
たとえば、E 字型は、高所得世帯、圧迫された中間層、苦境にある底辺という 3 つの経済層を表します。
エコノミストらによると、低所得層の支出の伸びが高所得層の支出の伸びを継続的に上回れば、次はＸ字型になる可能性があるという。
バンク・オブ・アメリカ研究所のシニアエコノミスト、デビッド・ティンズリー氏は「ここでXが発展するリスクはわずかにある」と述べた。
同氏は「低所得世帯の支出の伸びが一時的に高所得世帯を上回るペースで加速する可能性があり、実際にクロスオーバーについて話している可能性がある」と述べた。
専門家らによると、株式市場の低迷により、株式を保有する可能性が高い高所得世帯が支出を控える可能性がある。
ＥＹパルテノンのダコ氏は、こうした動きは「個人消費の伸びを鈍化させ、経済を失速させる重要な触媒となる可能性がある」と述べた。
エコノミストらは、経済ラベルのアルファベットスープには限界があるかもしれないと述べた。
たとえば、今後数か月間で誰が最も経済的プレッシャーを感じているかを理解するには、年齢とライフステージのほうが役立つかもしれない、と研究者らは述べた。
専門家らによると、苦境に立たされている20代のZ世代の消費者は、同じく経済的逼迫を感じているおよそ40代半ばから60代前半の中堅層であるX世代とは大きく異なるという。
Z世代の若い消費者、特に賃貸人にとって住宅費は依然として特別なプレッシャーとなっている、と彼らは述べた。
一方、FICOのドーンヘルム氏は、「X世代の消費者は、子供たちをサポートすると同時に、おそらく両親をサポートし援助しながら、退職後の資金を貯めようとしている」と述べた。
「議論には年齢の要素が含まれる可能性があると思います。」ティンズリー氏は、「アルファベットについてはほぼ完成したと思う」と語った。
サインアップ: Money 101 は経済的自由に関する 8 週間の学習コースで、毎週あなたの受信箱に配信されます。ここからサインアップしてください。スペイン語でも利用可能です。`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/08/25/k-shaped-economy-c-shaped-economy-may-be-changing.html",
    publishedAt: "2026-08-25T18:39:14+00:00",
    category: "エネルギー",
    imageUrl: "https://images.unsplash.com/photo-1473172367879-2dca04a4dca4?w=800&q=80",
    readTime: 7,
  },
  {
    id: "trump-goes-all-in-on-sen-darline-graham-09c48159",
    title: "Trump goes all in on Sen. Darline Graham in South Carolina, as primary losses pile up",
    titleJa: "Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.",
    summaryJa: "ドナルド・トランプ大統領は火曜日、サウスカロライナ州共和党のダーリン・グラハム上院議員が、亡き弟のリンゼー・グラハム氏の後任として上院議員任期6年を目指して特別共和党予備選決選投票でラルフ・ノーマン下院議員と対決する中、自身の支持力を試すことになる。この選挙戦ではトランプ氏の同盟者２人が互いに争う。ノーマンは下院自由議員団の強硬派メンバー。しかし、2024年の共和党大統領予備選で同氏が当初サウスカロライナ州知事ニッキー・ヘイリー氏を支持していたことや、大統領の優先事項の一部について財政上の懸念を表明する傾向があったため、トランプ氏との関係は時折緊張した。大統領はこの選挙サイクルを通じて、自分や彼の政策に反対する共和党議員をターゲットにしてきた。",
    bodyOriginal: `President Donald Trump on Tuesday will test his endorsement power as South Carolina GOP Sen. Darline Graham squares off against Rep. Ralph Norman in a special Republican primary runoff election in her bid to replace her late brother Lindsey Graham for a full six-year Senate term.
The race pits two Trump allies against each other. Norman is a hard-line member of the House Freedom Caucus. But his initial support for former South Carolina Gov. Nikki Haley in the 2024 GOP presidential primaries and his tendency to raise fiscal concerns about some of the president's priorities have at times strained his relationship with Trump. The president throughout this election cycle has targeted fellow Republican lawmakers who have opposed him or his policies.
Graham, who has a brief political track record, has enjoyed Trump's enthusiastic support since the days after her brother died unexpectedly in July. Trump, who had a close relationship with Lindsey Graham, traveled to South Carolina to campaign with Graham last week and held a tele-rally for her on Monday.
The winner of Tuesday's runoff will face Democrat Annie Andrews in November's general election. The Cook Political Report with Amy Walter labels the race "Solid R." Lindsey Graham was favored to win reelection before his death.
"[T]here is nobody better to honor the legacy of her beloved brother, Lindsey. Darline, who comes from an absolutely incredible family, has been a WINNER all of her life, and has my Complete and Total Endorsement in the Special Election for U.S. Senate in South Carolina," Trump posted to TruthSocial on Monday.
Trump's full-throated support of Graham, however, could prove risky for the president, who is the de facto head of the party and who has traditionally played kingmaker, but has suffered a series of recent losses.
Graham, who has never been elected to office but was appointed by South Carolina Gov. Henry McMaster in July to serve out the remainder of her brother's term, suffered an embarrassing moment in a debate with Norman last week.
Asked to comment on the importance of Taiwan to U.S. interests, Graham copped that she was "not that informed on national security," raising questions about her fitness for the job. Graham has since defended her performance, arguing during an appearance on Fox News that she doesn't "speak politician."
Norman, who launched an unsuccessful bid for South Carolina governor earlier this year, seized on the moment, casting himself as the proven conservative in the race.
"My opponent is unknown. She's being backed by the Washington establishment," Norman said in a recent appearance on Fox News. "She's a propped-up candidate. You could tell that during the debates. This is an important job. There is no training on the job that you can effectively do."
The stakes are high for Trump, some of whose picks in South Carolina, as well as other parts of the country, have fallen short of late.
Trump in May endorsed South Carolina Lt. Gov. Pamela Evette in the GOP primary for governor, though he eventually co-endorsed state Attorney General Alan Wilson, who bested Evette in a runoff in June. GOP lawmakers in the South Carolina legislature also dealt a blow to Trump in May when they scuttled his push for partisan mid-decade redistricting.
Elsewhere, too, Trump's once-powerful endorsement has come up short. Rep. Randy Feenstra, R-Iowa, in June lost to Zach Lahn in the state's GOP gubernatorial primary, despite notching support from Trump.
A Trump-endorsed candidate lost this month in Wyoming's Republican gubernatorial primary. And two candidates Trump had backed for the House in Florida — Rep. Cory Mills and Catalina Lauf — lost their respective primaries earlier this month.
In total, 10 Trump-endorsed candidates have lost their races this election cycle, equal to the total number of Trump-backed candidates who lost in 2018, 2020 and 2024 primaries combined, according to a CNN analysis.`,
    bodyJa: `ドナルド・トランプ大統領は火曜日、サウスカロライナ州共和党のダーリン・グラハム上院議員が、亡き弟のリンゼー・グラハム氏の後任として上院議員任期6年を目指して特別共和党予備選決選投票でラルフ・ノーマン下院議員と対決する中、自身の支持力を試すことになる。
この選挙戦ではトランプ氏の同盟者２人が互いに争う。ノーマンは下院自由議員団の強硬派メンバー。しかし、2024年の共和党大統領予備選で同氏が当初サウスカロライナ州知事ニッキー・ヘイリー氏を支持していたことや、大統領の優先事項の一部について財政上の懸念を表明する傾向があったため、トランプ氏との関係は時折緊張した。大統領はこの選挙サイクルを通じて、自分や彼の政策に反対する共和党議員をターゲットにしてきた。
グラハム氏は短期間の政治的実績しかないが、7月に弟が急死して以来、トランプ氏の熱狂的な支持を享受してきた。リンジー・グラハム氏と親密な関係にあったトランプ氏は先週、グラハム氏との選挙運動のためサウスカロライナ州を訪れ、月曜日には彼女のために電話集会を開催した。
火曜日の決選投票の勝者は11月の本選挙で民主党のアニー・アンドリュースと対戦することになる。エイミー・ウォルターとのクック・ポリティカル・レポートでは、この人種を「ソリッドR」と名付けている。リンジー・グラハムは生前に再選が有力視されていた。
トランプ大統領は月曜、トゥルースソーシャルに「最愛の兄リンジーの功績を讃えるのにこれ以上の人はいない。ダーリンは本当に素晴らしい家族の出身で、生涯ずっと勝者であり、サウスカロライナ州の上院特別選挙で私が完全かつ全面的に支持している」と投稿した。
しかし、トランプ大統領がグラハム氏を全力で支持することは、事実上の党首であり、伝統的にキングメーカーの役割を果たしてきたが、最近一連の敗北を喫している大統領にとっては危険であると判明する可能性がある。
グラハム氏はこれまで一度も議員に選出されたことがないが、7月にサウスカロライナ州知事ヘンリー・マクマスター氏によって兄の残りの任期を務めるために任命されたが、先週のノーマン氏との討論会で恥ずかしい瞬間を迎えた。
米国の国益にとっての台湾の重要性についてコメントを求められたグラハム氏は、「国家安全保障についてはあまり知識がない」と答え、その職への適性について疑問が生じた。それ以来、グラハムは自身のパフォーマンスを擁護し、FOXニュース出演中に彼女は「政治家の言葉を話さない」と主張した。
ノーマン氏は今年初めにサウスカロライナ州知事に立候補したが失敗に終わったが、この機を捉えて自らを選挙戦で実証済みの保守派に据えた。
ノーマン氏は最近出演したFOXニュースで、「私の対戦相手は不明だ。彼女はワシントン支配層の支援を受けている」と語った。 「彼女はしっかりとした候補者だ。討論会中にそれがわかるだろう。これは重要な仕事だ。効果的に実行できる職務訓練はない。」
トランプ氏にとって賭け金は高く、サウスカロライナ州や国内の他の地域での候補者の一部が最近及ばなかった。
トランプ大統領は5月、サウスカロライナ州知事選の共和党予備選でサウスカロライナ州副知事のパメラ・エヴェット氏を支持したが、最終的には6月の決選投票でエヴェット氏を破ったアラン・ウィルソン州司法長官と共同支持した。サウスカロライナ州議会の共和党議員らも5月、党派による10年半ばの選挙区再編推進を阻止し、トランプ大統領に打撃を与えた。
他の地域でも、かつては強力だったトランプ氏の支持は失墜している。ランディ・フェーンストラ下院議員（共和党、アイオワ州）は6月、トランプ大統領からの支持を集めたにもかかわらず、同州の共和党知事予備選でザック・ラーン氏に敗れた。
今月行われたワイオミング州の共和党知事予備選で、トランプ大統領が推薦した候補者が敗れた。そしてトランプ氏がフロリダ州下院で支援した２人の候補者、コリー・ミルズ下院議員とカタリナ・ラウフ下院議員は今月初め、それぞれの予備選で敗れた。
CNNの分析によると、今回の選挙サイクルでトランプ支持の候補者が落選したのは合計10人で、これは2018年、2020年、2024年の予備選で敗退したトランプ支持の候補者の総数に等しい。`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/08/25/trump-darline-graham-south-carolina-primary.html",
    publishedAt: "2026-08-25T18:31:31+00:00",
    category: "テクノロジー",
    imageUrl: "https://images.unsplash.com/photo-1518770660439-4636190af475?w=800&q=80",
    readTime: 4,
  },
  {
    id: "why-amd-can-beat-rivals-intel-and-nvidia-6db5ddad",
    title: "Why AMD can beat rivals Intel and Nvidia in the market for data-center CPUs",
    titleJa: "AMDがデータセンターCPU市場でライバルのIntelやNvidiaに勝てる理由",
    summaryJa: "Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.",
    bodyOriginal: `The chip maker is strongly positioned to gain share in the market for data-center CPUs and to see profit from revenue, a Raymond James analyst says.`,
    bodyJa: `Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.`,
    source: "MarketWatch",
    sourceUrl: "https://www.marketwatch.com/story/why-amd-can-beat-rivals-intel-and-nvidia-in-the-market-for-data-center-cpus-e49a53f1?mod=mw_rss_topstories",
    publishedAt: "2026-08-25T18:29:00+00:00",
    category: "テクノロジー",
    imageUrl: "https://images.mktw.net/im-34746867",
    readTime: 2,
  },
  {
    id: "stanley-druckenmiller-leads-doubters-who-d9cad7d0",
    title: "Stanley Druckenmiller leads doubters who think Bessent's bond ploys will fail",
    titleJa: "Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.",
    summaryJa: "Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.他の一部の人々と同様、スウィフト氏は最近の利回り上昇についてそれほど憂慮すべきことは何も考えておらず、インフレ、失業、市場のボラティリティに加え、FRBの指標金利や中央銀行への期待に基づくと、30年債は「ファンダメンタルズ公正価値」に近いと述べた。",
    bodyOriginal: `Treasury Secretary Scott Bessent's bond market interventions have generated a modest decline in yields along with a growing chorus of derision from those who think they won't work over the long haul and could have dangerous repercussions.
...
The latest critic to pile on: Stanley Druckenmiller, the prominent head of Duquesne Family Office and, perhaps more significantly, Bessent's investing mentor. The two, along with George Soros, famously orchestrated the bet against the U.K. pound in the early 1990s.
Druckenmiller warned that without fiscal discipline, efforts to tamp down yields are dangerous for markets — and also for the Treasury Department's credibility.
...
Correction: This story has been revised to reflect that the fixed income market saw some $4.8 trillion in debt issued in 2025. A previous version misstated the amount of debt issued.`,
    bodyJa: `Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.
他の一部の人々と同様、スウィフト氏は最近の利回り上昇についてそれほど憂慮すべきことは何も考えておらず、インフレ、失業、市場のボラティリティに加え、FRBの指標金利や中央銀行への期待に基づくと、30年債は「ファンダメンタルズ公正価値」に近いと述べた。
３０年債は５０年債平均の約５．１６％をわずかに上回っているだけだ。火曜日朝の時点で指標となる10年債は実際、1960年代初頭まで遡る歴史的平均の4.64％と全く同じ水準で取引されている。
シタデル・セキュリティーズの欧州・中東・アフリカ債券セールス責任者、ノーシャド・シャー氏は「債券市場のメッセージは単純明快だ。財政政策あるいは金融政策をより引き締めるべきだ」と述べた。 「米国債が低価格で決済されるのを阻止しても、その圧力は排除されない。圧力が他の場所に移されるだけだ。」
ＣＭＥグループの試算によると、ＦＲＢが次に発言権を得るのは９月１５─１６日の会合で、市場は利上げの可能性を約４０％織り込んでいる。ウォーシュ氏は金曜日にワイオミング州ジャクソンホール連銀のシンポジウムで講演する予定で、その際に財務省問題に言及する可能性がある。
エバーコアＩＳＩの経済・中央銀行政策責任者のクリシュナ・グハ氏は、議長が関与を避けようとする可能性があると述べた。
「ウォーシュ氏が、ベッセント氏の型破りな行動との矛盾を避けながら、市場に安心感を与える形で利回りについてコメントするのは容易ではないだろう。ウォーシュ氏は見送る決断を下すかもしれない」とグハ氏は書いた。
訂正: この記事は、2025 年に債券市場で約 4 兆 8,000 億ドルの債券が発行されたことを反映して修正されました。以前のバージョンでは、債券発行額が誤って記載されていました。`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/08/25/stanley-druckenmiller-leads-doubters-who-think-bessents-bond-ploys-will-fail.html",
    publishedAt: "2026-08-25T17:15:50+00:00",
    category: "金融政策",
    imageUrl: "https://images.unsplash.com/photo-1611974789855-9c2a0a7236a3?w=800&q=80",
    readTime: 2,
  },
  {
    id: "hhs-plans-new-fda-deputy-commissioner-ro-6989cfd5",
    title: "HHS plans new FDA deputy commissioner roles for technology and drugs, sources say",
    titleJa: "HHSはテクノロジーと医薬品分野でFDA副長官の役割を新たに計画していると関係者が語る",
    summaryJa: "CNBCの報道によると、保健福祉省は食品医薬品局に新たに2つの副局長職を創設する予定で、そのうちの1つはテクノロジーと健康と人工知能の交差点に焦点を当てることになるという。この計画に詳しい関係者２人によると、もう１つの新たなポストは麻薬担当副長官だという。同庁にはすでに食料担当副長官代理を含む複数の副長官がいるが、誰がその役割に恒久的に就任するかは不明だ。",
    bodyOriginal: `The Department of Health and Human Services is planning to create two new deputy commissioner roles at the Food and Drug Administration, one of which would focus on technology and the intersection of health and artificial intelligence, CNBC has learned.
...
The new deputy commissioner for technology would oversee both the agency's own internal use of AI and its review of AI-enabled products, according to the people familiar with the matter.`,
    bodyJa: `CNBCの報道によると、保健福祉省は食品医薬品局に新たに2つの副局長職を創設する予定で、そのうちの1つはテクノロジーと健康と人工知能の交差点に焦点を当てることになるという。
この計画に詳しい関係者２人によると、もう１つの新たなポストは麻薬担当副長官だという。同庁にはすでに食料担当副長官代理を含む複数の副長官がいるが、誰がその役割に恒久的に就任するかは不明だ。
関係者らによると、HHS当局者らは公の場で発言する権限がないため匿名を条件に、トランプ政権の一部が同局に対する影響力を拡大する狙いがあると見ており、新指導者を任命することになるという。
関係者によると、新しい役割に関する最終決定や正式な発表はまだ行われていない。
事情に詳しい関係者3人によると、FDAの上級顧問で医療機器業界のベテランであるジャレッド・シーハーファー氏が、この技術職の最有力候補だという。 Seehafer 氏は、ライフ サイエンスのコンプライアンス ソフトウェア会社である Enzyme の共同創設者兼元 CEO であり、昨年 8 月に FDA の顧問の役割に就く前は、最近までサンフランシスコのベンチャー キャピタル会社で働いていました。
カイル・ディアマンタス氏は、つい最近まで食品担当副長官を務めていたが、フルーツ風味の電子タバコの認可をめぐるマーティ・マカリー氏の辞任を受けて5月にFDA長官代理に就任した。ディアマンタスがその役割に戻るかどうかは不明だ。
CNBCは麻薬担当副長官の具体的な候補者については知ることができなかった。
この計画に詳しい関係者２人によると、この２つの新たな役職は、ドナルド・トランプ大統領がＦＤＡ長官に指名したハイディ・オヴァートン氏の直属となるが、同氏はまだ上院の承認を必要としている。
HHSは複数のコメント要請に応じなかった。
新しい指導体制は、FDAにとって波瀾万丈の期間を経て誕生することになる。
同庁は、アイスバーグレタスに関連した複数の州で発生したシクロスポラの発生への対応をめぐって厳しい監視にさらされており、連邦予算と人員削減により食品由来の発生を抑制する当局の能力が妨げられているという広範な懸念がさらに高まっている。
FDAは、特定の新薬製品に関する一連の決定でも注目を集めている。
例えば、FDAは今月初め、レプリミューンとの注目を集めた規制上の争いと、これまでの2回の治療薬拒否を受けて、レプリミューンの黒色腫治療薬「トゥドリゲフ」の早期承認を認めた。
FDAは3月にも、ユニキュア社の実験的なハンチントン病治療薬について、偽のまたは「偽」脳手術用プラセボを含む追加の臨床試験を要求し、バイオテクノロジー業界からの激しい反発も招いた。その後、当局は立場を転換し、UniQure が中間段階のデータに基づいて早期承認を申請することにゴーサインを出した。
そして月曜日、FDAは、Capricor Therapeuticsの実験用デュシェンヌ型筋ジストロフィー薬について、追加データを検討するため3か月の審査延長を認めた。これは、FDAの諮問委員会が同製品の承認推奨に9対3で反対票を投じたことを受けてのことだった。
一方、FDA は従業員の内部業務を支援するために人工知能の利用をますます増やしており、その中には、同庁が文書の要約や草案作成などのタスクに使用している Elsa 生成 AI ツールも含まれます。同時に、FDA 規制当局は AI を組み込んだ医療製品の安全性と有効性を評価する責任があります。
先週、FDAは生成型AI対応医療機器を規制するための潜在的なアプローチを概説したディスカッションペーパーを発表した。同庁は正式なガイダンスを発行する代わりに、患者、臨床医、開発者、その他の関係者からの意見を求めている。
関係者によると、新たな技術担当副長官は、同庁自身の内部でのAI利用とAI対応製品の審査の両方を監督することになる。`,
    source: "CNBC",
    sourceUrl: "https://www.cnbc.com/2026/08/25/hhs-fda-leadership-roles-technology-drugs.html",
    publishedAt: "2026-08-25T17:00:01+00:00",
    category: "テクノロジー",
    imageUrl: "https://images.unsplash.com/photo-1518770660439-4636190af475?w=800&q=80",
    readTime: 4,
  },
  {
    id: "who-does-iran-trade-with-and-what-could-19679563",
    title: "Who does Iran trade with and what could Trump's 'economic D-Day' mean?",
    titleJa: "Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.",
    summaryJa: "Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.",
    bodyOriginal: `Who does Iran trade with and what could Trump's 'economic D-Day' mean?
- Published
...
Error 500 (Server Error)!!1500.That’s an error.There was an error. Please try again later.That’s all we know.`,
    ...
    publishedAt: "2026-08-25T15:04:52+00:00",
    category: "エネルギー",
    imageUrl: "https://ichef.bbci.co.uk/ace/standard/240/cpsprodpb/6358/live/a03a3710-a09f-11f1-84a9-276d1a8e5a22.jpg",
    readTime: 2,
  },
  {
