...
GitHub Actions が **1日4回**（日本時間 3時・9時・15時・21時頃）自動で：

1. 世界のビジネスニュース（BBC / CNBC / MarketWatch など）を取得
2. 日本語に翻訳・要約
3. サイトを更新して公開

まで行います。**パソコンがオフでも更新されます。**

手動で今すぐ更新する場合：
- GitHub → Actions → 「Auto Update News」→ Run workflow
