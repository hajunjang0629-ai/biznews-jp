const ARTICLES = [
  ...
  },
  {
    ...
    "summaryJa": "欧州連合と米国は貿易協定の大枠で合意し、相互に課していた関税を10%に引き下げることになりました。自動車、鉄鋼、農産物をめぐる紛争が緩和され、両地域の企業にとって見通しが改善しました。欧州の自動車メーカーは米国市場への輸出コストの低下を歓迎しており、フォルクスワーゲンやメルセデス・ベンツの株価が上昇しました。ただし、合意の詳細は今後数週間で詰める必要があり、各国議会の承認も必要です。世界貿易の不確実性が一段落したことで、グローバル株式市場は全体的に上昇しました。日本企業にとっても、欧米間の貿易摩擦緩和はサプライチェーンの安定に寄与すると期待されています。",
